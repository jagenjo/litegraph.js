var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(n,v,w){n!=Array.prototype&&n!=Object.prototype&&(n[v]=w.value)};$jscomp.getGlobal=function(n){return"undefined"!=typeof window&&window===n?n:"undefined"!=typeof global&&null!=global?global:n};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(n,v,w,l){if(v){w=$jscomp.global;n=n.split(".");for(l=0;l<n.length-1;l++){var x=n[l];x in w||(w[x]={});w=w[x]}n=n[n.length-1];l=w[n];v=v(l);v!=l&&null!=v&&$jscomp.defineProperty(w,n,{configurable:!0,writable:!0,value:v})}};$jscomp.polyfill("Object.is",function(n){return n?n:function(v,n){return v===n?0!==v||1/v===1/n:v!==v&&n!==n}},"es6","es3");
$jscomp.polyfill("Array.prototype.includes",function(n){return n?n:function(v,n){var l=this;l instanceof String&&(l=String(l));var w=l.length;for(n=n||0;n<w;n++)if(l[n]==v||Object.is(l[n],v))return!0;return!1}},"es7","es3");
$jscomp.checkStringArgs=function(n,v,w){if(null==n)throw new TypeError("The 'this' value for String.prototype."+w+" must not be null or undefined");if(v instanceof RegExp)throw new TypeError("First argument to String.prototype."+w+" must not be a regular expression");return n+""};$jscomp.polyfill("String.prototype.includes",function(n){return n?n:function(v,n){return-1!==$jscomp.checkStringArgs(this,v,"includes").indexOf(v,n||0)}},"es6","es3");
$jscomp.owns=function(n,v){return Object.prototype.hasOwnProperty.call(n,v)};$jscomp.polyfill("Object.assign",function(n){return n?n:function(v,n){for(var l=1;l<arguments.length;l++){var w=arguments[l];if(w)for(var z in w)$jscomp.owns(w,z)&&(v[z]=w[z])}return v}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
$jscomp.Symbol=function(){var n=0;return function(v){return $jscomp.SYMBOL_PREFIX+(v||"")+n++}}();$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var n=$jscomp.global.Symbol.iterator;n||(n=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[n]&&$jscomp.defineProperty(Array.prototype,n,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};
$jscomp.arrayIterator=function(n){var v=0;return $jscomp.iteratorPrototype(function(){return v<n.length?{done:!1,value:n[v++]}:{done:!0}})};$jscomp.iteratorPrototype=function(n){$jscomp.initSymbolIterator();n={next:n};n[$jscomp.global.Symbol.iterator]=function(){return this};return n};
$jscomp.iteratorFromArray=function(n,v){$jscomp.initSymbolIterator();n instanceof String&&(n+="");var w=0,l={next:function(){if(w<n.length){var x=w++;return{value:v(x,n[x]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};$jscomp.polyfill("Array.prototype.keys",function(n){return n?n:function(){return $jscomp.iteratorFromArray(this,function(v){return v})}},"es6","es3");
$jscomp.polyfill("Array.prototype.fill",function(n){return n?n:function(v,n,l){var w=this.length||0;0>n&&(n=Math.max(0,w+n));if(null==l||l>w)l=w;l=Number(l);0>l&&(l=Math.max(0,w+l));for(n=Number(n||0);n<l;n++)this[n]=v;return this}},"es6","es3");$jscomp.polyfill("Array.prototype.values",function(n){return n?n:function(){return $jscomp.iteratorFromArray(this,function(v,n){return n})}},"es8","es3");
$jscomp.polyfill("Object.values",function(n){return n?n:function(v){var n=[],l;for(l in v)$jscomp.owns(v,l)&&n.push(v[l]);return n}},"es8","es3");$jscomp.polyfill("String.prototype.startsWith",function(n){return n?n:function(v,n){var l=$jscomp.checkStringArgs(this,v,"startsWith");v+="";var w=l.length,z=v.length;n=Math.max(0,Math.min(n|0,l.length));for(var m=0;m<z&&n<w;)if(l[n++]!=v[m++])return!1;return m>=z}},"es6","es3");
$jscomp.findInternal=function(n,v,w){n instanceof String&&(n=String(n));for(var l=n.length,x=0;x<l;x++){var z=n[x];if(v.call(w,z,x,n))return{i:x,v:z}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.findIndex",function(n){return n?n:function(n,w){return $jscomp.findInternal(this,n,w).i}},"es6","es3");
(function(n){function v(a){g.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function w(a,b,c,d,e,f){this.id=a;this.type=b;this.origin_id=c;this.origin_slot=d;this.target_id=e;this.target_slot=f;this._data=null;this._pos=new Float32Array(2)}function l(a){this._ctor(a)}function x(a){this._ctor(a)}function z(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
[0,0];this.element=null;this.visible_area=new Float32Array(4);a&&(this.element=a,b||this.bindEvents(a))}function m(a,b,c){this.options=c=c||{};this.background_image=m.DEFAULT_BACKGROUND_IMAGE;a&&a.constructor===String&&(a=document.querySelector(a));this.ds=new z;this.zoom_modify_alpha=!0;this.title_text_font=""+g.NODE_TEXT_SIZE+"px Arial";this.inner_text_font="normal "+g.NODE_SUBTEXT_SIZE+"px Arial";this.node_title_color=g.NODE_TITLE_COLOR;this.default_link_color=g.LINK_COLOR;this.default_connection_color=
...
"undefined"!=typeof process?function(){var a=process.hrtime();return.001*a[0]+1E-6*a[1]}:function(){return(new Date).getTime()};n.LGraph=g.LGraph=v;v.supported_types=["number","string","boolean"];v.prototype.getSupportedTypes=function(){return this.supported_types||v.supported_types};v.STATUS_STOPPED=1;v.STATUS_RUNNING=2;v.prototype.clear=function(){this.stop();this.status=v.STATUS_STOPPED;this.last_link_id=this.last_node_id=0;this._version=-1;if(this._nodes)for(var a=0;a<this._nodes.length;++a){var b=
...
[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};v.prototype.computeExecutionOrder=function(a,b){for(var c=[],d=[],e={},f={},h={},k=0,p=this._nodes.length;k<p;++k){var q=this._nodes[k];if(!a||q.onExecute){e[q.id]=q;var u=0;if(q.inputs)for(var r=0,m=q.inputs.length;r<m;r++)q.inputs[r]&&null!=q.inputs[r].link&&(u+=1);0==u?(d.push(q),b&&(q._level=1)):(b&&(q._level=0),h[q.id]=u)}}for(;0!=d.length;)if(q=d.shift(),
c.push(q),delete e[q.id],q.outputs)for(k=0;k<q.outputs.length;k++)if(a=q.outputs[k],null!=a&&null!=a.links&&0!=a.links.length)for(r=0;r<a.links.length;r++)(p=this.links[a.links[r]])&&!f[p.id]&&(u=this.getNodeById(p.target_id),null==u?f[p.id]=!0:(b&&(!u._level||u._level<=q._level)&&(u._level=q._level+1),f[p.id]=!0,--h[u.id],0==h[u.id]&&d.push(u)));for(k in e)c.push(e[k]);c.length!=this._nodes.length&&g.debug&&console.warn("something went wrong, nodes missing");p=c.length;for(k=0;k<p;++k)c[k].order=
k;c=c.sort(function(a,b){var c=a.constructor.priority||a.priority||0,d=b.constructor.priority||b.priority||0;return c==d?a.order-b.order:c-d});for(k=0;k<p;++k)c[k].order=k;return c};v.prototype.getAncestors=function(a){for(var b=[],c=[a],d={};c.length;){var e=c.shift();if(e.inputs){d[e.id]||e==a||(d[e.id]=!0,b.push(e));for(var f=0;f<e.inputs.length;++f){var h=e.getInputNode(f);h&&-1==b.indexOf(h)&&c.push(h)}}}b.sort(function(a,b){return a.order-b.order});return b};v.prototype.arrange=function(a){a=
a||100;for(var b=this.computeExecutionOrder(!1,!0),c=[],d=0;d<b.length;++d){var e=b[d],f=e._level||1;c[f]||(c[f]=[]);c[f].push(e)}b=a;for(d=0;d<c.length;++d)if(f=c[d]){for(var h=100,k=a+g.NODE_TITLE_HEIGHT,p=0;p<f.length;++p)e=f[p],e.pos[0]=b,e.pos[1]=k,e.size[0]>h&&(h=e.size[0]),k+=e.size[1]+a+g.NODE_TITLE_HEIGHT;b+=h+a}this.setDirtyCanvas(!0,!0)};v.prototype.getTime=function(){return this.globaltime};v.prototype.getFixedTime=function(){return this.fixedtime};v.prototype.getElapsedTime=function(){return this.elapsed_time};
...
n.LGraphNode=g.LGraphNode=l;l.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[g.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};l.prototype.configure=function(a){this.graph&&this.graph._version++;
...
this.inputs.length:1,this.outputs?this.outputs.length:1);a=a||new Float32Array([0,0]);c=Math.max(c,1);var d=g.NODE_TEXT_SIZE,e=b(this.title),f=0,h=0;if(this.inputs)for(var k=0,p=this.inputs.length;k<p;++k){var q=this.inputs[k];q=q.label||q.name||"";q=b(q);f<q&&(f=q)}if(this.outputs)for(k=0,p=this.outputs.length;k<p;++k)q=this.outputs[k],q=q.label||q.name||"",q=b(q),h<q&&(h=q);a[0]=Math.max(f+h+10,e);a[0]=Math.max(a[0],g.NODE_WIDTH);this.widgets&&this.widgets.length&&(a[0]=Math.max(a[0],1.5*g.NODE_WIDTH));
a[1]=(this.constructor.slot_start_y||0)+c*g.NODE_SLOT_HEIGHT;c=0;if(this.widgets&&this.widgets.length){k=0;for(p=this.widgets.length;k<p;++k)c=this.widgets[k].computeSize?c+(this.widgets[k].computeSize(a[0])[1]+4):c+(g.NODE_WIDGET_HEIGHT+4);c+=8}a[1]=this.widgets_up?Math.max(a[1],c):null!=this.widgets_start_y?Math.max(a[1],c+this.widgets_start_y):a[1]+c;this.constructor.min_height&&a[1]<this.constructor.min_height&&(a[1]=this.constructor.min_height);a[1]+=6;return a};l.prototype.getPropertyInfo=function(a){var b=
...
"size",{set:function(a){!a||2>a.length||(this._size[0]=Math.max(140,a[0]),this._size[1]=Math.max(80,a[1]))},get:function(){return this._size},enumerable:!0})};x.prototype.configure=function(a){this.title=a.title;this._bounding.set(a.bounding);this.color=a.color;this.font=a.font};x.prototype.serialize=function(){var a=this._bounding;return{title:this.title,bounding:[Math.round(a[0]),Math.round(a[1]),Math.round(a[2]),Math.round(a[3])],color:this.color,font:this.font}};x.prototype.move=function(a,b,
c){this._pos[0]+=a;this._pos[1]+=b;if(!c)for(c=0;c<this._nodes.length;++c){var d=this._nodes[c];d.pos[0]+=a;d.pos[1]+=b}};x.prototype.recomputeInsideNodes=function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),c=0;c<a.length;++c){var d=a[c];d.getBounding(b);F(this._bounding,b)&&this._nodes.push(d)}};x.prototype.isPointInside=l.prototype.isPointInside;x.prototype.setDirtyCanvas=l.prototype.setDirtyCanvas;g.DragAndScale=z;z.prototype.bindEvents=function(a){this.last_mouse=
new Float32Array(2);this._binded_mouse_callback=this.onMouse.bind(this);g.pointerListenerAdd(a,"down",this._binded_mouse_callback);g.pointerListenerAdd(a,"move",this._binded_mouse_callback);g.pointerListenerAdd(a,"up",this._binded_mouse_callback);a.addEventListener("mousewheel",this._binded_mouse_callback,!1);a.addEventListener("wheel",this._binded_mouse_callback,!1)};z.prototype.computeVisibleArea=function(a){if(this.element){var b=this.element.width,c=this.element.height,d=-this.offset[0],e=-this.offset[1];
...
1!=this.onMouse(a)){if(1!=a.which||this.pointer_is_double)if(2==a.which){if(g.middle_click_slot_add_default_node&&f&&this.allow_interaction&&!d&&!this.read_only&&!this.connecting_node&&!f.flags.collapsed&&!this.live_mode){e=d=h=!1;if(f.outputs)for(u=0,k=f.outputs.length;u<k;++u)if(p=f.outputs[u],q=f.getConnectionPos(!1,u),C(a.canvasX,a.canvasY,q[0]-15,q[1]-10,30,20)){h=p;d=u;e=!0;break}if(f.inputs)for(u=0,k=f.inputs.length;u<k;++u)if(p=f.inputs[u],q=f.getConnectionPos(!0,u),C(a.canvasX,a.canvasY,
q[0]-15,q[1]-10,30,20)){h=p;d=u;e=!1;break}h&&!1!==d&&(u=.5-(d+1)/(e?f.outputs.length:f.inputs.length),h=f.getBounding(),this.createDefaultNodeForSlot({nodeFrom:e?f:null,slotFrom:e?d:null,nodeTo:e?null:f,slotTo:e?null:d,position:[e?h[0]+h[2]:h[0],a.canvasY-80],nodeType:"AUTO",posAdd:[e?30:-30,130*-u],posSizeFix:[e?0:-1,0]}))}}else 3!=a.which&&!this.pointer_is_double||!this.allow_interaction||d||this.read_only||(f&&(Object.keys(this.selected_nodes).length&&(this.selected_nodes[f.id]||a.shiftKey||a.ctrlKey||
...
0;for(var k=f.outputs.length;u<k;++u){var p=f.outputs[u],q=f.getConnectionPos(!1,u);if(C(a.canvasX,a.canvasY,q[0]-15,q[1]-10,30,20)){this.connecting_node=f;this.connecting_output=p;this.connecting_output.slot_index=u;this.connecting_pos=f.getConnectionPos(!1,u);this.connecting_slot=u;g.shift_click_do_break_link_from&&a.shiftKey&&f.disconnectOutput(u);if(e){if(f.onOutputDblClick)f.onOutputDblClick(u,a)}else if(f.onOutputClick)f.onOutputClick(u,a);d=!0;break}}}if(f.inputs)for(u=0,k=f.inputs.length;u<
k;++u)if(p=f.inputs[u],q=f.getConnectionPos(!0,u),C(a.canvasX,a.canvasY,q[0]-15,q[1]-10,30,20)){if(e){if(f.onInputDblClick)f.onInputDblClick(u,a)}else if(f.onInputClick)f.onInputClick(u,a);null!==p.link&&(q=this.graph.links[p.link],g.click_do_break_link_to&&(f.disconnectInput(u),d=this.dirty_bgcanvas=!0),this.allow_reconnect_links||a.shiftKey)&&(g.click_do_break_link_to||f.disconnectInput(u),this.connecting_node=this.graph._nodes_by_id[q.origin_id],this.connecting_slot=q.origin_slot,this.connecting_output=
...
else{d=50;c.font="14px Arial";if(b.outputs)for(var h=0;h<b.outputs.length;++h){var k=b.outputs[h];if(!k.not_subgraph_input){if(this.drawButton(e-200,d+2,180,f-2)){var p=b.constructor.output_node_type||"graph/output";this.graph.beforeChange();var q=g.createNode(p);q?(a.add(q),this.block_click=!1,this.last_click_position=null,this.selectNodes([q]),this.node_dragged=q,this.dragging_canvas=!1,q.setProperty("name",k.name),q.setProperty("type",k.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=
...
var q=b+g.NODE_TITLE_HEIGHT+2,u=this.mouse,r=g.isInsideRectangle(u[0],u[1],a,q,c,d);q=(u=this.last_click_position)&&g.isInsideRectangle(u[0],u[1],a,q,c,d);p.fillStyle=r?h:f;q&&(p.fillStyle="#AAA");p.beginPath();p.roundRect(a,b,c,d,[4]);p.fill();null!=e&&e.constructor==String&&(p.fillStyle=k,p.textAlign="center",p.font=(.65*d|0)+"px Arial",p.fillText(e,a+.5*c,b+.75*d),p.textAlign="left");a=q&&!this.block_click;q&&this.blockClick();return a};m.prototype.isAreaClicked=function(a,b,c,d,e){var f=this.mouse;
...
b.roundRect(0,0,B[0],B[1],[10]):h==g.CIRCLE_SHAPE&&b.arc(.5*B[0],.5*B[1],.5*B[0],0,2*Math.PI),b.clip());a.has_errors&&(d="red");this.drawNodeShape(a,b,B,c,d,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=k?"center":"left";b.font=this.inner_text_font;d=!e;var q=this.connecting_output;h=this.connecting_input;b.lineWidth=1;p=0;var u=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(c=0;c<a.inputs.length;c++){var r=
a.inputs[c],m=r.type,l=r.shape;b.globalAlpha=f;this.connecting_output&&!g.isValidConnection(r.type,q.type)&&(b.globalAlpha=.4*f);b.fillStyle=null!=r.link?r.color_on||this.default_connection_color_byType[m]||this.default_connection_color.input_on:r.color_off||this.default_connection_color_byTypeOff[m]||this.default_connection_color_byType[m]||this.default_connection_color.input_off;var t=a.getConnectionPos(!0,c,u);t[0]-=a.pos[0];t[1]-=a.pos[1];p<t[1]+.5*g.NODE_SLOT_HEIGHT&&(p=t[1]+.5*g.NODE_SLOT_HEIGHT);
...
2,t[1]+2,2,2)):e?b.rect(t[0]-4,t[1]-4,8,8):b.arc(t[0],t[1],4,0,2*Math.PI);b.fill();d&&(m=null!=r.label?r.label:r.name)&&(b.fillStyle=g.NODE_TEXT_COLOR,k||r.dir==g.UP?b.fillText(m,t[0],t[1]-10):b.fillText(m,t[0]+10,t[1]+5))}b.textAlign=k?"center":"right";b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(r=a.outputs[c],m=r.type,l=r.shape,this.connecting_input&&!g.isValidConnection(m,h.type)&&(b.globalAlpha=.4*f),t=a.getConnectionPos(!1,c,u),t[0]-=a.pos[0],t[1]-=a.pos[1],p<t[1]+.5*
g.NODE_SLOT_HEIGHT&&(p=t[1]+.5*g.NODE_SLOT_HEIGHT),b.fillStyle=r.links&&r.links.length?r.color_on||this.default_connection_color_byType[m]||this.default_connection_color.output_on:r.color_off||this.default_connection_color_byTypeOff[m]||this.default_connection_color_byType[m]||this.default_connection_color.output_off,b.beginPath(),"array"==m&&(l=g.GRID_SHAPE),q=!0,m===g.EVENT||l===g.BOX_SHAPE?k?b.rect(t[0]-5+.5,t[1]-8+.5,10,14):b.rect(t[0]-6+.5,t[1]-5+.5,14,10):l===g.ARROW_SHAPE?(b.moveTo(t[0]+8,
...
function(a,b,c,d,e,f,h){b.strokeStyle=d;b.fillStyle=e;e=g.NODE_TITLE_HEIGHT;var k=.5>this.ds.scale,p=a._shape||a.constructor.shape||g.ROUND_SHAPE,q=a.constructor.title_mode,u=!0;q==g.TRANSPARENT_TITLE||q==g.NO_TITLE?u=!1:q==g.AUTOHIDE_TITLE&&h&&(u=!0);y[0]=0;y[1]=u?-e:0;y[2]=c[0]+1;y[3]=u?c[1]+e:c[1];h=b.globalAlpha;b.beginPath();p==g.BOX_SHAPE||k?b.fillRect(y[0],y[1],y[2],y[3]):p==g.ROUND_SHAPE||p==g.CARD_SHAPE?b.roundRect(y[0],y[1],y[2],y[3],p==g.CARD_SHAPE?[this.round_radius,this.round_radius,
0,0]:[this.round_radius]):p==g.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0],0,2*Math.PI);b.fill();!a.flags.collapsed&&u&&(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,y[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas,this.graph_mouse);if(u||q==g.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,e,c,this.ds.scale,d);else if(q!=g.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){u=a.constructor.title_color||
d;a.flags.collapsed&&(b.shadowColor=g.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var r=m.gradients[u];r||(r=m.gradients[u]=b.createLinearGradient(0,0,400,0),r.addColorStop(0,u),r.addColorStop(1,"#000"));b.fillStyle=r}else b.fillStyle=u;b.beginPath();p==g.BOX_SHAPE||k?b.rect(0,-e,c[0]+1,e):(p==g.ROUND_SHAPE||p==g.CARD_SHAPE)&&b.roundRect(0,-e,c[0]+1,e,a.flags.collapsed?[this.round_radius]:[this.round_radius,this.round_radius,0,0]);b.fill();b.shadowColor="transparent"}u=!1;g.node_box_coloured_by_mode&&
g.NODE_MODES_COLORS[a.mode]&&(u=g.NODE_MODES_COLORS[a.mode]);g.node_box_coloured_when_on&&(u=a.action_triggered?"#FFF":a.execute_triggered?"#AAA":u);if(a.onDrawTitleBox)a.onDrawTitleBox(b,e,c,this.ds.scale);else p==g.ROUND_SHAPE||p==g.CIRCLE_SHAPE||p==g.CARD_SHAPE?(k&&(b.fillStyle="black",b.beginPath(),b.arc(.5*e,-.5*e,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||u||g.NODE_DEFAULT_BOXCOLOR,k?b.fillRect(.5*e-5,-.5*e-5,10,10):(b.beginPath(),b.arc(.5*e,-.5*e,5,0,2*Math.PI),b.fill())):(k&&(b.fillStyle=
...
b.textAlign="left"):(b.textAlign="left",b.fillText(h,e,g.NODE_TITLE_TEXT_Y-e)));a.flags.collapsed||!a.subgraph||a.skip_subgraph_button||(h=g.NODE_TITLE_HEIGHT,u=a.size[0]-h,r=g.isInsideRectangle(this.graph_mouse[0]-a.pos[0],this.graph_mouse[1]-a.pos[1],u+2,-h+2,h-4,h-4),b.fillStyle=r?"#888":"#555",p==g.BOX_SHAPE||k?b.fillRect(u+2,-h+2,h-4,h-4):(b.beginPath(),b.roundRect(u+2,-h+2,h-4,h-4,[4]),b.fill()),b.fillStyle="#333",b.beginPath(),b.moveTo(u+.2*h,.6*-h),b.lineTo(u+.8*h,.6*-h),b.lineTo(u+.5*h,.3*
-h),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(f){if(a.onBounding)a.onBounding(y);q==g.TRANSPARENT_TITLE&&(y[1]-=e,y[3]+=e);b.lineWidth=1;b.globalAlpha=.8;b.beginPath();p==g.BOX_SHAPE?b.rect(-6+y[0],-6+y[1],12+y[2],12+y[3]):p==g.ROUND_SHAPE||p==g.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+y[0],-6+y[1],12+y[2],12+y[3],[2*this.round_radius]):p==g.CARD_SHAPE?b.roundRect(-6+y[0],-6+y[1],12+y[2],12+y[3],[2*this.round_radius,2,2*this.round_radius,2]):p==g.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0]+
...
c=this.graph._nodes;for(var d=0,e=c.length;d<e;++d){var f=c[d];if(f.inputs&&f.inputs.length)for(var h=0;h<f.inputs.length;++h){var k=f.inputs[h];if(k&&null!=k.link&&(k=this.graph.links[k.link])){var p=this.graph.getNodeById(k.origin_id);if(null!=p){var q=k.origin_slot;var u=-1==q?[p.pos[0]+10,p.pos[1]+10]:p.getConnectionPos(!1,q,J);var r=f.getConnectionPos(!0,h,K);A[0]=u[0];A[1]=u[1];A[2]=r[0]-u[0];A[3]=r[1]-u[1];0>A[2]&&(A[0]+=A[2],A[2]=Math.abs(A[2]));0>A[3]&&(A[1]+=A[3],A[3]=Math.abs(A[3]));if(F(A,
G)){var m=p.outputs[q];q=f.inputs[h];if(m&&q&&(p=m.dir||(p.horizontal?g.DOWN:g.RIGHT),q=q.dir||(f.horizontal?g.UP:g.LEFT),this.renderLink(a,u,r,k,!1,0,null,p,q),k&&k._last_time&&1E3>b-k._last_time)){m=2-.002*(b-k._last_time);var l=a.globalAlpha;a.globalAlpha=l*m;this.renderLink(a,u,r,k,!0,m,"white",p,q);a.globalAlpha=l}}}}}}a.globalAlpha=1};m.prototype.renderLink=function(a,b,c,d,e,f,h,k,p,q){d&&this.visible_links.push(d);!h&&d&&(h=d.color||m.link_type_colors[d.type]);h||(h=this.default_link_color);
null!=d&&this.highlighted_links[d.id]&&(h="#FFF");k=k||g.RIGHT;p=p||g.LEFT;var u=H(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";q=q||1;1<q&&(a.lineWidth=.5);a.beginPath();for(var r=0;r<q;r+=1){var l=5*(r-.5*(q-1));if(this.links_render_mode==g.SPLINE_LINK){a.moveTo(b[0],b[1]+l);var n=0,t=0,v=0,w=0;switch(k){case g.LEFT:n=-.25*u;break;case g.RIGHT:n=.25*u;break;case g.UP:t=-.25*u;break;case g.DOWN:t=.25*u}switch(p){case g.LEFT:v=-.25*
u;break;case g.RIGHT:v=.25*u;break;case g.UP:w=-.25*u;break;case g.DOWN:w=.25*u}a.bezierCurveTo(b[0]+n,b[1]+t+l,c[0]+v,c[1]+w+l,c[0],c[1]+l)}else if(this.links_render_mode==g.LINEAR_LINK){a.moveTo(b[0],b[1]+l);w=v=t=n=0;switch(k){case g.LEFT:n=-1;break;case g.RIGHT:n=1;break;case g.UP:t=-1;break;case g.DOWN:t=1}switch(p){case g.LEFT:v=-1;break;case g.RIGHT:v=1;break;case g.UP:w=-1;break;case g.DOWN:w=1}a.lineTo(b[0]+15*n,b[1]+15*t+l);a.lineTo(c[0]+15*v,c[1]+15*w+l);a.lineTo(c[0],c[1]+l)}else if(this.links_render_mode==
g.STRAIGHT_LINK)a.moveTo(b[0],b[1]),l=b[0],n=b[1],t=c[0],v=c[1],k==g.RIGHT?l+=10:n+=10,p==g.LEFT?t-=10:v-=10,a.lineTo(l,n),a.lineTo(.5*(l+t),n),a.lineTo(.5*(l+t),v),a.lineTo(t,v),a.lineTo(c[0],c[1]);else return}this.render_connections_border&&.6<this.ds.scale&&!e&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=h;a.stroke();e=this.computeConnectionPoint(b,c,.5,k,p);d&&d._pos&&(d._pos[0]=e[0],d._pos[1]=e[1]);.6<=this.ds.scale&&this.highquality_render&&
p!=g.CENTER&&(this.render_connection_arrows&&(r=this.computeConnectionPoint(b,c,.25,k,p),u=this.computeConnectionPoint(b,c,.26,k,p),d=this.computeConnectionPoint(b,c,.75,k,p),q=this.computeConnectionPoint(b,c,.76,k,p),this.render_curved_connections?(u=-Math.atan2(u[0]-r[0],u[1]-r[1]),q=-Math.atan2(q[0]-d[0],q[1]-d[1])):q=u=c[1]>b[1]?0:Math.PI,a.save(),a.translate(r[0],r[1]),a.rotate(u),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(d[0],d[1]),
...
this.ds.scale;c.save();c.globalAlpha=this.editor_alpha;for(var p=g.WIDGET_OUTLINE_COLOR,q=g.WIDGET_BGCOLOR,u=g.WIDGET_TEXT_COLOR,r=g.WIDGET_SECONDARY_TEXT_COLOR,m=0;m<f.length;++m){var l=f[m],t=b;l.y&&(t=l.y);l.last_y=t;c.strokeStyle=p;c.fillStyle="#222";c.textAlign="left";l.disabled&&(c.globalAlpha*=.5);var n=l.width||e;switch(l.type){case "button":l.clicked&&(c.fillStyle="#AAA",l.clicked=!1,this.dirty_canvas=!0);c.fillRect(15,t,n-30,h);k&&!l.disabled&&c.strokeRect(15,t,n-30,h);k&&(c.textAlign="center",
c.fillStyle=u,c.fillText(l.name,.5*n,t+.7*h));break;case "toggle":c.textAlign="left";c.strokeStyle=p;c.fillStyle=q;c.beginPath();k?c.roundRect(15,t,n-30,h,[.5*h]):c.rect(15,t,n-30,h);c.fill();k&&!l.disabled&&c.stroke();c.fillStyle=l.value?"#89A":"#333";c.beginPath();c.arc(n-30,t+.5*h,.36*h,0,2*Math.PI);c.fill();k&&(c.fillStyle=r,null!=l.name&&c.fillText(l.name,30,t+.7*h),c.fillStyle=l.value?u:r,c.textAlign="right",c.fillText(l.value?l.options.on||"true":l.options.off||"false",n-40,t+.7*h));break;
case "slider":c.fillStyle=q;c.fillRect(15,t,n-30,h);var v=l.options.max-l.options.min,w=(l.value-l.options.min)/v;c.fillStyle=d==l?"#89A":"#678";c.fillRect(15,t,w*(n-30),h);k&&!l.disabled&&c.strokeRect(15,t,n-30,h);l.marker&&(v=(l.marker-l.options.min)/v,c.fillStyle="#AA9",c.fillRect(15+v*(n-30),t,2,h));k&&(c.textAlign="center",c.fillStyle=u,c.fillText(l.name+"  "+Number(l.value).toFixed(3),.5*n,t+.7*h));break;case "number":case "combo":c.textAlign="left";c.strokeStyle=p;c.fillStyle=q;c.beginPath();
k?c.roundRect(15,t,n-30,h,[.5*h]):c.rect(15,t,n-30,h);c.fill();k&&(l.disabled||c.stroke(),c.fillStyle=u,l.disabled||(c.beginPath(),c.moveTo(31,t+5),c.lineTo(21,t+.5*h),c.lineTo(31,t+h-5),c.fill(),c.beginPath(),c.moveTo(n-15-16,t+5),c.lineTo(n-15-6,t+.5*h),c.lineTo(n-15-16,t+h-5),c.fill()),c.fillStyle=r,c.fillText(l.name,35,t+.7*h),c.fillStyle=u,c.textAlign="right","number"==l.type?c.fillText(Number(l.value).toFixed(void 0!==l.options.precision?l.options.precision:3),n-30-20,t+.7*h):(v=l.value,l.options.values&&
(w=l.options.values,w.constructor===Function&&(w=w()),w&&w.constructor!==Array&&(v=w[l.value])),c.fillText(v,n-30-20,t+.7*h)));break;case "string":case "text":c.textAlign="left";c.strokeStyle=p;c.fillStyle=q;c.beginPath();k?c.roundRect(15,t,n-30,h,[.5*h]):c.rect(15,t,n-30,h);c.fill();k&&(l.disabled||c.stroke(),c.save(),c.beginPath(),c.rect(15,t,n-30,h),c.clip(),c.fillStyle=r,null!=l.name&&c.fillText(l.name,30,t+.7*h),c.fillStyle=u,c.textAlign="right",c.fillText(String(l.value).substr(0,30),n-30,t+
.7*h),c.restore());break;default:l.draw&&l.draw(c,a,n,t,h)}b+=(l.computeSize?l.computeSize(n)[1]:h)+4;c.globalAlpha=this.editor_alpha}c.restore();c.textAlign="left"};m.prototype.processNodeWidgets=function(a,b,c,d){function e(d,e){d.value=e;d.options&&d.options.property&&void 0!==a.properties[d.options.property]&&a.setProperty(d.options.property,e);d.callback&&d.callback(d.value,p,a,b,c)}if(!a.widgets||!a.widgets.length)return null;for(var f=b[0]-a.pos[0],h=b[1]-a.pos[1],k=a.size[0],p=this,q=this.getCanvasWindow(),
...
function(a,b,c,d,e){if(e){var f=this;a=m.active_canvas.getCanvasWindow();b=e.optional_inputs;e.onGetInputs&&(b=e.onGetInputs());var h=[];if(b)for(var k=0;k<b.length;k++){var p=b[k];if(p){var q=p[0];p[2]||(p[2]={});p[2].label&&(q=p[2].label);p[2].removable=!0;q={content:q,value:p};p[1]==g.ACTION&&(q.className="event");h.push(q)}else h.push(null)}e.onMenuNodeInputs&&(b=e.onMenuNodeInputs(h))&&(h=b);if(h.length)return new g.ContextMenu(h,{event:c,callback:function(a,b,c){if(e&&(a.callback&&a.callback.call(f,
...
if(e.onNodeOutputAdd)e.onNodeOutputAdd(a.value);e.setDirtyCanvas(!0,!0);e.graph.afterChange()}else{a=[];for(var k in c)a.push({content:k,value:c[k]});new g.ContextMenu(a,{event:b,callback:f,parentMenu:d,node:e});return!1}}if(e){var h=this;a=m.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var k=[];if(b)for(var p=0;p<b.length;p++){var q=b[p];if(!q)k.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(q[0])){var u=q[0];q[2]||(q[2]=
...
g.pointerListenerAdd(h,"enter",function(a){g.dialog_close_on_mouse_leave&&k&&clearTimeout(k)});var q=h.querySelectorAll("select");q&&q.forEach(function(a){a.addEventListener("click",function(a){p++});a.addEventListener("blur",function(a){p=0});a.addEventListener("change",function(a){p=-1})});f.prompt_box&&f.prompt_box.close();f.prompt_box=h;h.querySelector(".name").innerText=a;var l=h.querySelector(".value");l.value=b;l.addEventListener("keydown",function(a){h.is_modified=!0;if(27==a.keyCode)h.close();
...
if(r&&e&&g.registered_slot_out_types[e]&&g.registered_slot_out_types[e].nodes&&(e=g.registered_slot_out_types[e].nodes.includes(a),!1===e))return!1}return!0};var p=0;d=d.toLowerCase();var q=h.filter||h.graph.filter;if(b.do_type_filter&&f.search_box)var l=f.search_box.querySelector(".slot_in_type_filter"),r=f.search_box.querySelector(".slot_out_type_filter");else r=l=!1;for(k in g.searchbox_extras){var u=g.searchbox_extras[k];if(b.show_all_if_empty&&!d||-1!==u.desc.toLowerCase().indexOf(d)){var n=
g.registered_node_types[u.type];if((!n||n.filter==q)&&e(u.type)&&(a(u.desc,"searchbox_extra"),-1!==m.search_limit&&p++>m.search_limit))break}}u=null;if(Array.prototype.filter)u=Object.keys(g.registered_node_types).filter(e);else for(k in u=[],g.registered_node_types)e(k)&&u.push(k);for(k=0;k<u.length&&!(a(u[k]),-1!==m.search_limit&&p++>m.search_limit);k++);if(b.show_general_after_typefiltered&&(l.value||r.value)){filtered_extra=[];for(k in g.registered_node_types)e(k,{inTypeOverride:l&&l.value?"*":
!1,outTypeOverride:r&&r.value?"*":!1})&&filtered_extra.push(k);for(k=0;k<filtered_extra.length&&!(a(filtered_extra[k],"generic_type"),-1!==m.search_limit&&p++>m.search_limit);k++);}if((l.value||r.value)&&0==t.childNodes.length&&b.show_general_if_none_on_typefilter){filtered_extra=[];for(k in g.registered_node_types)e(k,{skipFilter:!0})&&filtered_extra.push(k);for(k=0;k<filtered_extra.length&&!(a(filtered_extra[k],"not_in_filter"),-1!==m.search_limit&&p++>m.search_limit);k++);}}}def_options={slot_from:null,
node_from:null,node_to:null,do_type_filter:g.search_filter_enabled,type_filter_in:!1,type_filter_out:!1,show_general_if_none_on_typefilter:!0,show_general_after_typefiltered:!0,hide_on_mouse_leave:g.search_hide_on_mouse_leave,show_all_if_empty:!0,show_all_on_open:g.search_show_all_on_open};b=Object.assign(def_options,b||{});var f=this,h=m.active_canvas,k=h.canvas,p=k.ownerDocument||document,q=document.createElement("div");q.className="litegraph litesearchbox graphdialog rounded";q.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/>";
b.do_type_filter&&(q.innerHTML+="<select class='slot_in_type_filter'><option value=''></option></select>",q.innerHTML+="<select class='slot_out_type_filter'><option value=''></option></select>");q.innerHTML+="<div class='helper'></div>";p.fullscreenElement?p.fullscreenElement.appendChild(q):(p.body.appendChild(q),p.body.style.overflow="hidden");if(b.do_type_filter)var l=q.querySelector(".slot_in_type_filter"),r=q.querySelector(".slot_out_type_filter");q.close=function(){f.search_box=null;this.blur();
p.body.style.overflow="";setTimeout(function(){f.canvas.focus()},20);q.parentNode&&q.parentNode.removeChild(q)};1<this.ds.scale&&(q.style.transform="scale("+this.ds.scale+")");if(b.hide_on_mouse_leave){var n=!1,v=null;g.pointerListenerAdd(q,"enter",function(a){v&&(clearTimeout(v),v=null)});g.pointerListenerAdd(q,"leave",function(a){n||(v=setTimeout(function(){q.close()},500))});b.do_type_filter&&(l.addEventListener("click",function(a){n++}),l.addEventListener("blur",function(a){n=0}),l.addEventListener("change",
function(a){n=-1}),r.addEventListener("click",function(a){n++}),r.addEventListener("blur",function(a){n=0}),r.addEventListener("change",function(a){n=-1}))}f.search_box&&f.search_box.close();f.search_box=q;var t=q.querySelector(".helper"),w=null,y=null,x=null,z=q.querySelector("input");z&&(z.addEventListener("blur",function(a){this.focus()}),z.addEventListener("keydown",function(a){if(38==a.keyCode)d(!1);else if(40==a.keyCode)d(!0);else if(27==a.keyCode)q.close();else if(13==a.keyCode)x?c(x.innerHTML):
...
l.className="property";l.innerHTML="<span class='property_name'></span><span class='property_value'></span>";l.querySelector(".property_name").innerText=k.label||b;var n=l.querySelector(".property_value");n.innerText=f;l.dataset.property=b;l.dataset.type=k.type||a;l.options=k;l.value=h;if("code"==a)l.addEventListener("click",function(a){d.inner_showCodePad(this.dataset.property)});else if("boolean"==a)l.classList.add("boolean"),h&&l.classList.add("bool-on"),l.addEventListener("click",function(){var a=
this.dataset.property;this.value=!this.value;this.classList.toggle("bool-on");this.querySelector(".property_value").innerText=this.value?"true":"false";e(a,this.value)});else if("string"==a||"number"==a)n.setAttribute("contenteditable",!0),n.addEventListener("keydown",function(b){"Enter"!=b.code||"string"==a&&b.shiftKey||(b.preventDefault(),this.blur())}),n.addEventListener("blur",function(){var a=this.innerText,b=this.parentNode.dataset.property;"number"==this.parentNode.dataset.type&&(a=Number(a));
e(b,a)});else if("enum"==a||"combo"==a)f=m.getPropertyPrintableValue(h,k.values),n.innerText=f,n.addEventListener("click",function(a){var b=this.parentNode.dataset.property,d=this;new g.ContextMenu(k.values||[],{event:a,className:"dark",callback:function(a,c,f){d.innerText=a;e(b,a);return!1}},c)});d.content.appendChild(l);return l};if(d.onOpen&&"function"==typeof d.onOpen)d.onOpen();return d};m.getPropertyPrintableValue=function(a,b){if(!b||b.constructor===Array)return String(a);if(b.constructor===
