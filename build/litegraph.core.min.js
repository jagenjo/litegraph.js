...
(function(q){function l(a){f.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function v(a,b,c,d,e,g){this.id=a;this.type=b;this.origin_id=c;this.origin_slot=d;this.target_id=e;this.target_slot=g;this._data=null;this._pos=new Float32Array(2)}function r(a){this._ctor(a)}function x(a){this._ctor(a)}function y(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));var e=null;b.event&&(e=b.event.constructor.name);"MouseEvent"!==e&&"CustomEvent"!==e&&"PointerEvent"!==e&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it. ("+e+")"),b.event=null);var g=document.createElement("div");g.className="litegraph litecontextmenu litemenubar-panel";b.className&&(g.className+=" "+b.className);g.style.minWidth=100;g.style.minHeight=
100;g.style.pointerEvents="none";setTimeout(function(){g.style.pointerEvents="auto"},100);f.pointerListenerAdd(g,"up",function(a){a.preventDefault();return!0},!0);g.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);f.pointerListenerAdd(g,"down",function(a){if(2==a.button)return d.close(),a.preventDefault(),!0},!0);b.scroll_speed||(b.scroll_speed=.1);g.addEventListener("wheel",c,!0);g.addEventListener("mousewheel",c,!0);this.root=g;b.title&&(e=document.createElement("div"),
e.className="litemenu-title",e.innerHTML=b.title,g.appendChild(e));for(var h=e=0;h<a.length;h++){var k=a.constructor==Array?a[h]:h;null!=k&&k.constructor!==String&&(k=void 0===k.content?String(k):k.content);this.addItem(k,a[h],b);e++}f.pointerListenerAdd(g,"enter",function(a){g.closing_timer&&clearTimeout(g.closing_timer)});a=document;b.event&&(a=b.event.target.ownerDocument);a||(a=document);a.fullscreenElement?a.fullscreenElement.appendChild(g):a.body.appendChild(g);e=b.left||0;a=b.top||0;b.event&&
(e=b.event.clientX-10,a=b.event.clientY-10,b.title&&(a-=20),b.parentMenu&&(e=b.parentMenu.root.getBoundingClientRect(),e=e.left+e.width),h=document.body.getBoundingClientRect(),k=g.getBoundingClientRect(),0==h.height&&console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"),h.width&&e>h.width-k.width-10&&(e=h.width-k.width-10),h.height&&a>h.height-k.height-10&&(a=h.height-k.height-10));g.style.left=e+"px";g.style.top=a+"px";b.scale&&(g.style.transform="scale("+
b.scale+")")}function G(a){this.points=a;this.nearest=this.selected=-1;this.size=null;this.must_update=!0;this.margin=5}var f=q.LiteGraph={VERSION:.4,CANVAS_GRID_SIZE:10,NODE_TITLE_HEIGHT:30,NODE_TITLE_TEXT_Y:20,NODE_SLOT_HEIGHT:20,NODE_WIDGET_HEIGHT:20,NODE_WIDTH:140,NODE_MIN_WIDTH:50,NODE_COLLAPSED_RADIUS:10,NODE_COLLAPSED_WIDTH:80,NODE_TITLE_COLOR:"#999",NODE_SELECTED_TITLE_COLOR:"#FFF",NODE_TEXT_SIZE:14,NODE_TEXT_COLOR:"#AAA",NODE_SUBTEXT_SIZE:12,NODE_DEFAULT_COLOR:"#333",NODE_DEFAULT_BGCOLOR:"#353535",
...
b.type=a;f.debug&&console.log("Node registered: "+a);a.split("/");var c=b.name,d=a.lastIndexOf("/");b.category=a.substr(0,d);b.title||(b.title=c);if(b.prototype)for(var e in r.prototype)b.prototype[e]||(b.prototype[e]=r.prototype[e]);if(d=this.registered_node_types[a])console.log("replacing node type: "+a);else if(Object.hasOwnProperty(b.prototype,"shape")||Object.defineProperty(b.prototype,"shape",{set:function(a){switch(a){case "default":delete this._shape;break;case "box":this._shape=f.BOX_SHAPE;
...
f.getTime="undefined"!=typeof performance?performance.now.bind(performance):"undefined"!=typeof Date&&Date.now?Date.now.bind(Date):"undefined"!=typeof process?function(){var a=process.hrtime();return.001*a[0]+1E-6*a[1]}:function(){return(new Date).getTime()};q.LGraph=f.LGraph=l;l.supported_types=["number","string","boolean"];l.prototype.getSupportedTypes=function(){return this.supported_types||l.supported_types};l.STATUS_STOPPED=1;l.STATUS_RUNNING=2;l.prototype.clear=function(){this.stop();this.status=
...
!0;this.inputs={};this.outputs={};this.change();this.sendActionToCanvas("clear")};l.prototype.attachCanvas=function(a){if(a.constructor!=n)throw"attachCanvas expects a LGraphCanvas instance";a.graph&&a.graph!=this&&a.graph.detachCanvas(a);a.graph=this;this.list_of_graphcanvas||(this.list_of_graphcanvas=[]);this.list_of_graphcanvas.push(a)};l.prototype.detachCanvas=function(a){if(this.list_of_graphcanvas){var b=this.list_of_graphcanvas.indexOf(a);-1!=b&&(a.graph=null,this.list_of_graphcanvas.splice(b,
1))}};l.prototype.start=function(a){if(this.status!=l.STATUS_RUNNING){this.status=l.STATUS_RUNNING;if(this.onPlayEvent)this.onPlayEvent();this.sendEventToAllNodes("onStart");this.last_update_time=this.starttime=f.getTime();a=a||0;var b=this;if(0==a&&"undefined"!=typeof window&&window.requestAnimationFrame){var c=function(){if(-1==b.execution_timer_id){window.requestAnimationFrame(c);if(b.onBeforeStep)b.onBeforeStep();b.runStep(1,!b.catch_errors);if(b.onAfterStep)b.onAfterStep()}};this.execution_timer_id=
-1;c()}else this.execution_timer_id=setInterval(function(){if(b.onBeforeStep)b.onBeforeStep();b.runStep(1,!b.catch_errors);if(b.onAfterStep)b.onAfterStep()},a)}};l.prototype.stop=function(){if(this.status!=l.STATUS_STOPPED){this.status=l.STATUS_STOPPED;if(this.onStopEvent)this.onStopEvent();null!=this.execution_timer_id&&(-1!=this.execution_timer_id&&clearInterval(this.execution_timer_id),this.execution_timer_id=null);this.sendEventToAllNodes("onStop")}};l.prototype.runStep=function(a,b,c){a=a||1;
var d=f.getTime();this.globaltime=.001*(d-this.starttime);var e=this._nodes_executable?this._nodes_executable:this._nodes;if(e){c=c||e.length;if(b){for(var g=0;g<a;g++){for(var h=0;h<c;++h){var k=e[h];if(k.mode==f.ALWAYS&&k.onExecute)k.onExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(g=0;g<a;g++){for(h=0;h<c;++h)if(k=e[h],k.mode==f.ALWAYS&&k.onExecute)k.onExecute();this.fixedtime+=this.fixedtime_lapse;
if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute();this.errors_in_execution=!1}catch(m){this.errors_in_execution=!0;if(f.throw_errors)throw m;f.debug&&console.log("Error during execution: "+m);this.stop()}a=f.getTime();d=a-d;0==d&&(d=1);this.execution_time=.001*d;this.globaltime+=.001*d;this.iteration+=1;this.elapsed_time=.001*(a-this.last_update_time);this.last_update_time=a}};l.prototype.updateExecutionOrder=function(){this._nodes_in_order=this.computeExecutionOrder(!1);
this._nodes_executable=[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};l.prototype.computeExecutionOrder=function(a,b){for(var c=[],d=[],e={},g={},h={},k=0,m=this._nodes.length;k<m;++k){var u=this._nodes[k];if(!a||u.onExecute){e[u.id]=u;var t=0;if(u.inputs)for(var p=0,n=u.inputs.length;p<n;p++)u.inputs[p]&&null!=u.inputs[p].link&&(t+=1);0==t?(d.push(u),b&&(u._level=1)):(b&&(u._level=0),h[u.id]=t)}}for(;0!=d.length;)if(u=
d.shift(),c.push(u),delete e[u.id],u.outputs)for(k=0;k<u.outputs.length;k++)if(a=u.outputs[k],null!=a&&null!=a.links&&0!=a.links.length)for(p=0;p<a.links.length;p++)(m=this.links[a.links[p]])&&!g[m.id]&&(t=this.getNodeById(m.target_id),null==t?g[m.id]=!0:(b&&(!t._level||t._level<=u._level)&&(t._level=u._level+1),g[m.id]=!0,--h[t.id],0==h[t.id]&&d.push(t)));for(k in e)c.push(e[k]);c.length!=this._nodes.length&&f.debug&&console.warn("something went wrong, nodes missing");m=c.length;for(k=0;k<m;++k)c[k].order=
k;c=c.sort(function(a,b){var c=a.constructor.priority||a.priority||0,d=b.constructor.priority||b.priority||0;return c==d?a.order-b.order:c-d});for(k=0;k<m;++k)c[k].order=k;return c};l.prototype.getAncestors=function(a){for(var b=[],c=[a],d={};c.length;){var e=c.shift();if(e.inputs){d[e.id]||e==a||(d[e.id]=!0,b.push(e));for(var g=0;g<e.inputs.length;++g){var h=e.getInputNode(g);h&&-1==b.indexOf(h)&&c.push(h)}}}b.sort(function(a,b){return a.order-b.order});return b};l.prototype.arrange=function(a){a=
a||100;for(var b=this.computeExecutionOrder(!1,!0),c=[],d=0;d<b.length;++d){var e=b[d],g=e._level||1;c[g]||(c[g]=[]);c[g].push(e)}b=a;for(d=0;d<c.length;++d)if(g=c[d]){for(var h=100,k=a+f.NODE_TITLE_HEIGHT,m=0;m<g.length;++m)e=g[m],e.pos[0]=b,e.pos[1]=k,e.size[0]>h&&(h=e.size[0]),k+=e.size[1]+a+f.NODE_TITLE_HEIGHT;b+=h+a}this.setDirtyCanvas(!0,!0)};l.prototype.getTime=function(){return this.globaltime};l.prototype.getFixedTime=function(){return this.fixedtime};l.prototype.getElapsedTime=function(){return this.elapsed_time};
l.prototype.sendEventToAllNodes=function(a,b,c){c=c||f.ALWAYS;var d=this._nodes_in_order?this._nodes_in_order:this._nodes;if(d)for(var e=0,g=d.length;e<g;++e){var h=d[e];if(h.constructor===f.Subgraph&&"onExecute"!=a)h.mode==c&&h.sendEventToAllNodes(a,b,c);else if(h[a]&&h.mode==c)if(void 0===b)h[a]();else if(b&&b.constructor===Array)h[a].apply(h,b);else h[a](b)}};l.prototype.sendActionToCanvas=function(a,b){if(this.list_of_graphcanvas)for(var c=0;c<this.list_of_graphcanvas.length;++c){var d=this.list_of_graphcanvas[c];
d[a]&&d[a].apply(d,b)}};l.prototype.add=function(a,b){if(a)if(a.constructor===x)this._groups.push(a),this.setDirtyCanvas(!0),this.change(),a.graph=this,this._version++;else{-1!=a.id&&null!=this._nodes_by_id[a.id]&&(console.warn("LiteGraph: there is already a node with this ID, changing it"),a.id=++this.last_node_id);if(this._nodes.length>=f.MAX_NUMBER_OF_NODES)throw"LiteGraph: max number of nodes in a graph reached";null==a.id||-1==a.id?a.id=++this.last_node_id:this.last_node_id<a.id&&(this.last_node_id=
...
a)}}};l.prototype.onNodeTrace=function(a,b,c){};v.prototype.configure=function(a){a.constructor===Array?(this.id=a[0],this.origin_id=a[1],this.origin_slot=a[2],this.target_id=a[3],this.target_slot=a[4],this.type=a[5]):(this.id=a.id,this.type=a.type,this.origin_id=a.origin_id,this.origin_slot=a.origin_slot,this.target_id=a.target_id,this.target_slot=a.target_slot)};v.prototype.serialize=function(){return[this.id,this.origin_id,this.origin_slot,this.target_id,this.target_slot,this.type]};f.LLink=v;
q.LGraphNode=f.LGraphNode=r;r.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[f.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};r.prototype.configure=function(a){this.graph&&this.graph._version++;
...
(this.widgets[c].value=a.widgets_values[c])}if(this.onConfigure)this.onConfigure(a)};r.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,size:this.size,flags:f.cloneObject(this.flags),order:this.order,mode:this.mode};if(this.constructor===r&&this.last_serialization)return this.last_serialization;this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;a.outputs=this.outputs}this.title&&this.title!=this.constructor.title&&
...
if(!a.links||0==a.links.length)return null;for(var b=[],c=0;c<a.links.length;c++){var d=this.graph.links[a.links[c]];d&&(d=this.graph.getNodeById(d.target_id))&&b.push(d)}return b};r.prototype.trigger=function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=f.getTime());for(var c=0;c<this.outputs.length;++c){var d=this.outputs[c];!d||d.type!==f.EVENT||a&&d.name!=a||this.triggerSlot(c,b)}}};r.prototype.triggerSlot=function(a,b,c){if(this.outputs&&(a=this.outputs[a])&&
(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=f.getTime());for(var d=0;d<a.length;++d){var e=a[d];if(null==c||c==e){var g=this.graph.links[a[d]];if(g&&(g._last_time=f.getTime(),e=this.graph.getNodeById(g.target_id)))if(g=e.inputs[g.target_slot],e.mode===f.ON_TRIGGER){if(e.onExecute)e.onExecute(b)}else if(e.onAction)e.onAction(g.name,b)}}}};r.prototype.clearTriggeredSlot=function(a,b){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length)for(var c=0;c<a.length;++c){var d=
...
c;++b)if(a==this.outputs[b].name)return b;return-1};r.prototype.connect=function(a,b,c){c=c||0;if(!this.graph)return console.log("Connect: Error, node doesn't belong to any graph. Nodes must be added first to a graph before connecting them."),null;if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return f.debug&&console.log("Connect: Error, no slot of name "+a),null}else if(!this.outputs||a>=this.outputs.length)return f.debug&&console.log("Connect: Error, slot number not found"),null;b&&
...
c,!0,h,g);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(f.INPUT,b,c,this,a),this.graph.onNodeConnectionChange(f.OUTPUT,this,a,b,c));this.setDirtyCanvas(!1,!0);this.graph.afterChange();this.graph.connectionChange(this,h);return h};r.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return f.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return f.debug&&
...
!0);this.graph.connectionChange(this);return!0};r.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return f.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||a>=this.inputs.length)return f.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var c=this.inputs[a].link;if(null!=c){this.inputs[a].link=null;var d=this.graph.links[c];if(d){var e=this.graph.getNodeById(d.origin_id);
...
function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),c=0;c<a.length;++c){var d=a[c];d.getBounding(b);H(this._bounding,b)&&this._nodes.push(d)}};x.prototype.isPointInside=r.prototype.isPointInside;x.prototype.setDirtyCanvas=r.prototype.setDirtyCanvas;f.DragAndScale=y;y.prototype.bindEvents=function(a){this.last_mouse=new Float32Array(2);this._binded_mouse_callback=this.onMouse.bind(this);f.pointerListenerAdd(a,"down",this._binded_mouse_callback);f.pointerListenerAdd(a,
"move",this._binded_mouse_callback);f.pointerListenerAdd(a,"up",this._binded_mouse_callback);a.addEventListener("mousewheel",this._binded_mouse_callback,!1);a.addEventListener("wheel",this._binded_mouse_callback,!1)};y.prototype.computeVisibleArea=function(a){if(this.element){var b=this.element.width,c=this.element.height,d=-this.offset[0],e=-this.offset[1];a&&(d+=a[0]/this.scale,e+=a[1]/this.scale,b=a[2],c=a[3]);a=d+b/this.scale;c=e+c/this.scale;this.visible_area[0]=d;this.visible_area[1]=e;this.visible_area[2]=
a-d;this.visible_area[3]=c-e}else this.visible_area[0]=this.visible_area[1]=this.visible_area[2]=this.visible_area[3]=0};y.prototype.onMouse=function(a){if(this.enabled){var b=this.element,c=b.getBoundingClientRect(),d=a.clientX-c.left;c=a.clientY-c.top;a.canvasx=d;a.canvasy=c;a.dragging=this.dragging;var e=!this.viewport||this.viewport&&d>=this.viewport[0]&&d<this.viewport[0]+this.viewport[2]&&c>=this.viewport[1]&&c<this.viewport[1]+this.viewport[3],g=!1;this.onmouse&&(g=this.onmouse(a));a.type==
...
!g.flags.collapsed&&!this.live_mode)if(!e&&!1!==g.resizable&&C(a.canvasX,a.canvasY,g.pos[0]+g.size[0]-5,g.pos[1]+g.size[1]-5,10,10))this.graph.beforeChange(),this.resizing_node=g,this.canvas.style.cursor="se-resize",e=!0;else{if(g.outputs)for(var k=0,m=g.outputs.length;k<m;++k){var u=g.outputs[k],t=g.getConnectionPos(!1,k);if(C(a.canvasX,a.canvasY,t[0]-15,t[1]-10,30,20)){this.connecting_node=g;this.connecting_output=u;this.connecting_pos=g.getConnectionPos(!1,k);this.connecting_slot=k;a.shiftKey&&
g.disconnectOutput(k);if(d){if(g.onOutputDblClick)g.onOutputDblClick(k,a)}else if(g.onOutputClick)g.onOutputClick(k,a);e=!0;break}}if(g.inputs)for(k=0,m=g.inputs.length;k<m;++k)if(u=g.inputs[k],t=g.getConnectionPos(!0,k),C(a.canvasX,a.canvasY,t[0]-15,t[1]-10,30,20)){if(d){if(g.onInputDblClick)g.onInputDblClick(k,a)}else if(g.onInputClick)g.onInputClick(k,a);if(null!==u.link){e=this.graph.links[u.link];g.disconnectInput(k);if(this.allow_reconnect_links||a.shiftKey)this.connecting_node=this.graph._nodes_by_id[e.origin_id],
this.connecting_slot=e.origin_slot,this.connecting_output=this.connecting_node.outputs[this.connecting_slot],this.connecting_pos=this.connecting_node.getConnectionPos(!1,this.connecting_slot);e=this.dirty_bgcanvas=!0}}}if(!e){k=!1;m=[a.canvasX-g.pos[0],a.canvasY-g.pos[1]];if(t=this.processNodeWidgets(g,this.graph_mouse,a))k=!0,this.node_widget=[g,t];if(d&&this.selected_nodes[g.id]){if(g.onDblClick)g.onDblClick(a,m,this);this.processNodeDblClicked(g);k=!0}g.onMouseDown&&g.onMouseDown(a,m,this)?k=!0:
(g.subgraph&&!g.skip_subgraph_button&&!g.flags.collapsed&&m[0]>g.size[0]-f.NODE_TITLE_HEIGHT&&0>m[1]&&(c=this,setTimeout(function(){c.openSubgraph(g.subgraph)},10)),this.live_mode&&(k=h=!0));k||(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=g),this.selected_nodes[g.id]||this.processNodeSelected(g,a));this.dirty_canvas=!0}}else{if(!this.read_only)for(k=0;k<this.visible_links.length;++k)if(h=this.visible_links[k],m=h._pos,!(!m||a.canvasX<m[0]-4||a.canvasX>m[0]+4||a.canvasY<m[1]-
4||a.canvasY>m[1]+4)){this.showLinkMenu(h,a);this.over_link_center=null;break}this.selected_group=this.graph.getGroupOnPos(a.canvasX,a.canvasY);this.selected_group_resizing=!1;this.selected_group&&!this.read_only&&(a.ctrlKey&&(this.dragging_rectangle=null),10>J([a.canvasX,a.canvasY],[this.selected_group.pos[0]+this.selected_group.size[0],this.selected_group.pos[1]+this.selected_group.size[1]])*this.ds.scale?this.selected_group_resizing=!0:this.selected_group.recomputeInsideNodes());d&&!this.read_only&&
this.allow_searchbox&&this.showSearchBox(a);h=!0}!e&&h&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}this.last_mouse[0]=a.clientX;this.last_mouse[1]=a.clientY;this.last_mouseclick=f.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&a.preventDefault();a.stopPropagation();if(this.onMouseDown)this.onMouseDown(a);return!1}}}};n.prototype.processMouseMove=
function(a){this.autoresize&&this.resize();this.set_canvas_dirty_on_mouse_event&&(this.dirty_canvas=!0);if(this.graph){n.active_canvas=this;this.adjustMouseEvent(a);var b=[a.clientX,a.clientY];this.mouse[0]=b[0];this.mouse[1]=b[1];var c=[b[0]-this.last_mouse[0],b[1]-this.last_mouse[1]];this.last_mouse=b;this.graph_mouse[0]=a.canvasX;this.graph_mouse[1]=a.canvasY;if(this.block_click)return a.preventDefault(),!1;a.dragging=this.last_mouse_dragging;this.node_widget&&(this.processNodeWidgets(this.node_widget[0],
...
f.isValidConnection(this.connecting_output.type,d.inputs[g].type)&&(this._highlight_input=e,this._highlight_input_slot=d.inputs[g]):this._highlight_input_slot=this._highlight_input=null}this.canvas&&(C(a.canvasX,a.canvasY,d.pos[0]+d.size[0]-5,d.pos[1]+d.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor="crosshair")}else{e=null;for(b=0;b<this.visible_links.length;++b){g=this.visible_links[b];var h=g._pos;if(!(!h||a.canvasX<h[0]-4||a.canvasX>h[0]+4||a.canvasY<h[1]-4||a.canvasY>
h[1]+4)){e=g;break}}e!=this.over_link_center&&(this.over_link_center=e,this.dirty_canvas=!0);this.canvas&&(this.canvas.style.cursor="")}if(this.node_capturing_input&&this.node_capturing_input!=d&&this.node_capturing_input.onMouseMove)this.node_capturing_input.onMouseMove(a,[a.canvasX-this.node_capturing_input.pos[0],a.canvasY-this.node_capturing_input.pos[1]],this);if(this.node_dragged&&!this.live_mode){for(b in this.selected_nodes)d=this.selected_nodes[b],d.pos[0]+=c[0]/this.ds.scale,d.pos[1]+=c[1]/
this.ds.scale;this.dirty_bgcanvas=this.dirty_canvas=!0}this.resizing_node&&!this.live_mode&&(c=[a.canvasX-this.resizing_node.pos[0],a.canvasY-this.resizing_node.pos[1]],b=this.resizing_node.computeSize(),c[0]=Math.max(b[0],c[0]),c[1]=Math.max(b[1],c[1]),this.resizing_node.setSize(c),this.canvas.style.cursor="se-resize",this.dirty_bgcanvas=this.dirty_canvas=!0)}a.preventDefault();return!1}};n.prototype.processMouseUp=function(a){if(void 0!==a.isPrimary&&!a.isPrimary)return!1;this.set_canvas_dirty_on_mouse_event&&
...
!1,this.dragging_rectangle){if(this.graph){b=this.graph._nodes;var c=new Float32Array(4);this.deselectAllNodes();var d=Math.abs(this.dragging_rectangle[2]),e=Math.abs(this.dragging_rectangle[3]),g=0>this.dragging_rectangle[3]?this.dragging_rectangle[1]-e:this.dragging_rectangle[1];this.dragging_rectangle[0]=0>this.dragging_rectangle[2]?this.dragging_rectangle[0]-d:this.dragging_rectangle[0];this.dragging_rectangle[1]=g;this.dragging_rectangle[2]=d;this.dragging_rectangle[3]=e;e=[];for(g=0;g<b.length;++g)d=
b[g],d.getBounding(c),H(this.dragging_rectangle,c)&&e.push(d);e.length&&this.selectNodes(e)}this.dragging_rectangle=null}else if(this.connecting_node){this.dirty_bgcanvas=this.dirty_canvas=!0;if(d=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes))this.connecting_output.type==f.EVENT&&this.isOverNodeBox(d,a.canvasX,a.canvasY)?this.connecting_node.connect(this.connecting_slot,d,f.EVENT):(b=this.isOverNodeInput(d,a.canvasX,a.canvasY),-1!=b?this.connecting_node.connect(this.connecting_slot,
...
c<this.viewport[0]+this.viewport[2]&&d>=this.viewport[1]&&d<this.viewport[1]+this.viewport[3])return c=this.ds.scale,0<b?c*=1.1:0>b&&(c*=1/1.1),this.ds.changeScale(c,[a.clientX,a.clientY]),this.graph.change(),a.preventDefault(),!1}};n.prototype.isOverNodeBox=function(a,b,c){var d=f.NODE_TITLE_HEIGHT;return C(b,c,a.pos[0]+2,a.pos[1]+2-d,d-4,d-4)?!0:!1};n.prototype.isOverNodeInput=function(a,b,c,d){if(a.inputs)for(var e=0,g=a.inputs.length;e<g;++e){var h=a.getConnectionPos(!0,e);if(a.horizontal?C(b,
c,h[0]-5,h[1]-10,10,20):C(b,c,h[0]-10,h[1]-5,40,10))return d&&(d[0]=h[0],d[1]=h[1]),e}return-1};n.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==a.keyCode&&(b=this.dragging_canvas=!0),65==a.keyCode&&a.ctrlKey&&(this.selectNodes(),b=!0),"KeyC"==a.code&&(a.metaKey||a.ctrlKey)&&!a.shiftKey&&this.selected_nodes&&(this.copyToClipboard(),b=!0),"KeyV"!=a.code||!a.metaKey&&!a.ctrlKey||a.shiftKey||this.pasteFromClipboard(),46!=a.keyCode&&
...
var m=f.createNode(k);m?(a.add(m),this.block_click=!1,this.last_click_position=null,this.selectNodes([m]),this.node_dragged=m,this.dragging_canvas=!1,m.setProperty("name",h.name),m.setProperty("type",h.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",k)}c.fillStyle="#9C9";c.beginPath();c.arc(184,d+.5*e,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(h.name,30,d+.75*e);c.fillStyle=
"#777";c.fillText(h.type,130,d+.75*e);d+=e}}this.drawButton(20,d+2,180,e-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialog(b)}};n.prototype.drawSubgraphPanelRight=function(a,b,c){var d=b.outputs?b.outputs.length:0,e=this.bgcanvas.width,g=Math.floor(1.6*f.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(e-200-10,10,200,(d+1)*g+50,[8]);c.fill();c.globalAlpha=1;c.fillStyle="#888";c.font="14px Arial";c.textAlign="left";d=c.measureText("Graph Outputs").width;c.fillText("Graph Outputs",
e-d-20,34);if(this.drawButton(e-200,20,20,20,"X","#151515"))this.closeSubgraph();else{d=50;c.font="14px Arial";if(b.outputs)for(var h=0;h<b.outputs.length;++h){var k=b.outputs[h];if(!k.not_subgraph_input){if(this.drawButton(e-200,d+2,180,g-2)){var m=b.constructor.output_node_type||"graph/output";this.graph.beforeChange();var u=f.createNode(m);u?(a.add(u),this.block_click=!1,this.last_click_position=null,this.selectNodes([u]),this.node_dragged=u,this.dragging_canvas=!1,u.setProperty("name",k.name),
u.setProperty("type",k.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",m)}c.fillStyle="#9C9";c.beginPath();c.arc(e-200+16,d+.5*g,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(k.name,e-200+30,d+.75*g);c.fillStyle="#777";c.fillText(k.type,e-200+130,d+.75*g);d+=g}}this.drawButton(e-200,d+2,180,g-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialogRight(b)}};n.prototype.drawButton=
function(a,b,c,d,e,g,h,k){var m=this.ctx;g=g||f.NODE_DEFAULT_COLOR;h=h||"#555";k=k||f.NODE_TEXT_COLOR;var u=this.mouse,t=f.isInsideRectangle(u[0],u[1],a,b,c,d);u=(u=this.last_click_position)&&f.isInsideRectangle(u[0],u[1],a,b,c,d);m.fillStyle=t?h:g;u&&(m.fillStyle="#AAA");m.beginPath();m.roundRect(a,b,c,d,[4]);m.fill();null!=e&&e.constructor==String&&(m.fillStyle=k,m.textAlign="center",m.font=(.65*d|0)+"px Arial",m.fillText(e,a+.5*c,b+.75*d),m.textAlign="left");a=u&&!this.block_click;u&&this.blockClick();
return a};n.prototype.isAreaClicked=function(a,b,c,d,e){var g=this.mouse;f.isInsideRectangle(g[0],g[1],a,b,c,d);b=(a=(g=this.last_click_position)&&f.isInsideRectangle(g[0],g[1],a,b,c,d))&&!this.block_click;a&&e&&this.blockClick();return b};n.prototype.renderInfo=function(a,b,c){b=b||10;c=c||this.canvas.height-80;a.save();a.translate(b,c);a.font="10px Arial";a.fillStyle="#888";a.textAlign="left";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,
...
this.background_image;this._bg_img.src=this.background_image;var g=this;this._bg_img.onload=function(){g.draw(!0,!0)}}c=null;null==this._pattern&&0<this._bg_img.width?(c=b.createPattern(this._bg_img,"repeat"),this._pattern_img=this._bg_img,this._pattern=c):c=this._pattern;c&&(b.fillStyle=c,b.fillRect(this.visible_area[0],this.visible_area[1],this.visible_area[2],this.visible_area[3]),b.fillStyle="transparent");b.globalAlpha=1;b.imageSmoothingEnabled=b.mozImageSmoothingEnabled=b.imageSmoothingEnabled=
...
2*f.NODE_TITLE_HEIGHT),D[0]=a._collapsed_width,D[1]=0)}a.clip_area&&(b.save(),b.beginPath(),h==f.BOX_SHAPE?b.rect(0,0,D[0],D[1]):h==f.ROUND_SHAPE?b.roundRect(0,0,D[0],D[1],[10]):h==f.CIRCLE_SHAPE&&b.arc(.5*D[0],.5*D[1],.5*D[0],0,2*Math.PI),b.clip());a.has_errors&&(d="red");this.drawNodeShape(a,b,D,c,d,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=k?"center":"left";b.font=this.inner_text_font;d=!e;h=this.connecting_output;
b.lineWidth=1;m=0;var u=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(c=0;c<a.inputs.length;c++){var t=a.inputs[c];b.globalAlpha=g;this.connecting_node&&!f.isValidConnection(t.type,h.type)&&(b.globalAlpha=.4*g);b.fillStyle=null!=t.link?t.color_on||this.default_connection_color.input_on:t.color_off||this.default_connection_color.input_off;var p=a.getConnectionPos(!0,c,u);p[0]-=a.pos[0];p[1]-=a.pos[1];m<p[1]+.5*f.NODE_SLOT_HEIGHT&&(m=p[1]+.5*f.NODE_SLOT_HEIGHT);b.beginPath();t.type===f.EVENT||
t.shape===f.BOX_SHAPE?k?b.rect(p[0]-5+.5,p[1]-8+.5,10,14):b.rect(p[0]-6+.5,p[1]-5+.5,14,10):t.shape===f.ARROW_SHAPE?(b.moveTo(p[0]+8,p[1]+.5),b.lineTo(p[0]-4,p[1]+6+.5),b.lineTo(p[0]-4,p[1]-6+.5),b.closePath()):e?b.rect(p[0]-4,p[1]-4,8,8):b.arc(p[0],p[1],4,0,2*Math.PI);b.fill();if(d){var n=null!=t.label?t.label:t.name;n&&(b.fillStyle=f.NODE_TEXT_COLOR,k||t.dir==f.UP?b.fillText(n,p[0],p[1]-10):b.fillText(n,p[0]+10,p[1]+5))}}this.connecting_node&&(b.globalAlpha=.4*g);b.textAlign=k?"center":"right";
b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(t=a.outputs[c],p=a.getConnectionPos(!1,c,u),p[0]-=a.pos[0],p[1]-=a.pos[1],m<p[1]+.5*f.NODE_SLOT_HEIGHT&&(m=p[1]+.5*f.NODE_SLOT_HEIGHT),b.fillStyle=t.links&&t.links.length?t.color_on||this.default_connection_color.output_on:t.color_off||this.default_connection_color.output_off,b.beginPath(),t.type===f.EVENT||t.shape===f.BOX_SHAPE?k?b.rect(p[0]-5+.5,p[1]-8+.5,10,14):b.rect(p[0]-6+.5,p[1]-5+.5,14,10):t.shape===f.ARROW_SHAPE?(b.moveTo(p[0]+
8,p[1]+.5),b.lineTo(p[0]-4,p[1]+6+.5),b.lineTo(p[0]-4,p[1]-6+.5),b.closePath()):e?b.rect(p[0]-4,p[1]-4,8,8):b.arc(p[0],p[1],4,0,2*Math.PI),b.fill(),e||b.stroke(),d&&(n=null!=t.label?t.label:t.name))b.fillStyle=f.NODE_TEXT_COLOR,k||t.dir==f.DOWN?b.fillText(n,p[0],p[1]-8):b.fillText(n,p[0]-10,p[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){t=m;if(k||a.widgets_up)t=2;null!=a.widgets_start_y&&(t=a.widgets_start_y);this.drawNodeWidgets(a,t,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:
null)}}else if(this.render_collapsed_slots){e=g=null;if(a.inputs)for(c=0;c<a.inputs.length;c++)if(t=a.inputs[c],null!=t.link){g=t;break}if(a.outputs)for(c=0;c<a.outputs.length;c++)t=a.outputs[c],t.links&&t.links.length&&(e=t);g&&(g=0,c=-.5*f.NODE_TITLE_HEIGHT,k&&(g=.5*a._collapsed_width,c=-f.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),t.type===f.EVENT||t.shape===f.BOX_SHAPE?b.rect(g-7+.5,c-4,14,8):t.shape===f.ARROW_SHAPE?(b.moveTo(g+8,c),b.lineTo(g+-4,c-4),b.lineTo(g+-4,c+4),b.closePath()):
b.arc(g,c,4,0,2*Math.PI),b.fill());e&&(g=a._collapsed_width,c=-.5*f.NODE_TITLE_HEIGHT,k&&(g=.5*a._collapsed_width,c=0),b.fillStyle="#686",b.strokeStyle="black",b.beginPath(),t.type===f.EVENT||t.shape===f.BOX_SHAPE?b.rect(g-7+.5,c-4,14,8):t.shape===f.ARROW_SHAPE?(b.moveTo(g+6,c),b.lineTo(g-6,c-4),b.lineTo(g-6,c+4),b.closePath()):b.arc(g,c,4,0,2*Math.PI),b.fill())}a.clip_area&&b.restore();b.globalAlpha=1}}};n.prototype.drawLinkTooltip=function(a,b){var c=b._pos;a.fillStyle="black";a.beginPath();a.arc(c[0],
...
d,24,[3]);a.moveTo(c[0]-10,c[1]-15);a.lineTo(c[0]+10,c[1]-15);a.lineTo(c[0],c[1]-5);a.fill();a.shadowColor="transparent";a.textAlign="center";a.fillStyle="#CEC";a.fillText(b,c[0],c[1]-15-24*.3)}};var w=new Float32Array(4);n.prototype.drawNodeShape=function(a,b,c,d,e,g,h){b.strokeStyle=d;b.fillStyle=e;e=f.NODE_TITLE_HEIGHT;var k=.5>this.ds.scale,m=a._shape||a.constructor.shape||f.ROUND_SHAPE,u=a.constructor.title_mode,t=!0;u==f.TRANSPARENT_TITLE||u==f.NO_TITLE?t=!1:u==f.AUTOHIDE_TITLE&&h&&(t=!0);w[0]=
0;w[1]=t?-e:0;w[2]=c[0]+1;w[3]=t?c[1]+e:c[1];h=b.globalAlpha;b.beginPath();m==f.BOX_SHAPE||k?b.fillRect(w[0],w[1],w[2],w[3]):m==f.ROUND_SHAPE||m==f.CARD_SHAPE?b.roundRect(w[0],w[1],w[2],w[3],m==f.CARD_SHAPE?[this.round_radius,this.round_radius,0,0]:[this.round_radius]):m==f.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0],0,2*Math.PI);b.fill();!a.flags.collapsed&&t&&(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,w[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,
this,this.canvas,this.graph_mouse);if(t||u==f.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,e,c,this.ds.scale,d);else if(u!=f.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){t=a.constructor.title_color||d;a.flags.collapsed&&(b.shadowColor=f.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var p=n.gradients[t];p||(p=n.gradients[t]=b.createLinearGradient(0,0,400,0),p.addColorStop(0,t),p.addColorStop(1,"#000"));b.fillStyle=p}else b.fillStyle=t;b.beginPath();m==f.BOX_SHAPE||
k?b.rect(0,-e,c[0]+1,e):(m==f.ROUND_SHAPE||m==f.CARD_SHAPE)&&b.roundRect(0,-e,c[0]+1,e,a.flags.collapsed?[this.round_radius]:[this.round_radius,this.round_radius,0,0]);b.fill();b.shadowColor="transparent"}if(a.onDrawTitleBox)a.onDrawTitleBox(b,e,c,this.ds.scale);else m==f.ROUND_SHAPE||m==f.CIRCLE_SHAPE||m==f.CARD_SHAPE?(k&&(b.fillStyle="black",b.beginPath(),b.arc(.5*e,-.5*e,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||f.NODE_DEFAULT_BOXCOLOR,k?b.fillRect(.5*e-5,-.5*e-5,10,10):(b.beginPath(),b.arc(.5*
e,-.5*e,5,0,2*Math.PI),b.fill())):(k&&(b.fillStyle="black",b.fillRect(.5*(e-10)-1,-.5*(e+10)-1,12,12)),b.fillStyle=a.boxcolor||f.NODE_DEFAULT_BOXCOLOR,b.fillRect(.5*(e-10),-.5*(e+10),10,10));b.globalAlpha=h;if(a.onDrawTitleText)a.onDrawTitleText(b,e,c,this.ds.scale,this.title_text_font,g);!k&&(b.font=this.title_text_font,h=String(a.getTitle()))&&(b.fillStyle=g?f.NODE_SELECTED_TITLE_COLOR:a.constructor.title_text_color||this.node_title_color,a.flags.collapsed?(b.textAlign="left",b.measureText(h),b.fillText(h.substr(0,
...
e;++d){var g=c[d];if(g.inputs&&g.inputs.length)for(var h=0;h<g.inputs.length;++h){var k=g.inputs[h];if(k&&null!=k.link&&(k=this.graph.links[k.link])){var m=this.graph.getNodeById(k.origin_id);if(null!=m){var u=k.origin_slot;var t=-1==u?[m.pos[0]+10,m.pos[1]+10]:m.getConnectionPos(!1,u,L);var p=g.getConnectionPos(!0,h,M);A[0]=t[0];A[1]=t[1];A[2]=p[0]-t[0];A[3]=p[1]-t[1];0>A[2]&&(A[0]+=A[2],A[2]=Math.abs(A[2]));0>A[3]&&(A[1]+=A[3],A[3]=Math.abs(A[3]));if(H(A,I)){var n=m.outputs[u];u=g.inputs[h];if(n&&
u&&(m=n.dir||(m.horizontal?f.DOWN:f.RIGHT),u=u.dir||(g.horizontal?f.UP:f.LEFT),this.renderLink(a,t,p,k,!1,0,null,m,u),k&&k._last_time&&1E3>b-k._last_time)){n=2-.002*(b-k._last_time);var B=a.globalAlpha;a.globalAlpha=B*n;this.renderLink(a,t,p,k,!0,n,"white",m,u);a.globalAlpha=B}}}}}}a.globalAlpha=1};n.prototype.renderLink=function(a,b,c,d,e,g,h,k,m,u){d&&this.visible_links.push(d);!h&&d&&(h=d.color||n.link_type_colors[d.type]);h||(h=this.default_link_color);null!=d&&this.highlighted_links[d.id]&&(h=
"#FFF");k=k||f.RIGHT;m=m||f.LEFT;var t=J(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";u=u||1;1<u&&(a.lineWidth=.5);a.beginPath();for(var p=0;p<u;p+=1){var l=5*(p-.5*(u-1));if(this.links_render_mode==f.SPLINE_LINK){a.moveTo(b[0],b[1]+l);var B=0,r=0,q=0,z=0;switch(k){case f.LEFT:B=-.25*t;break;case f.RIGHT:B=.25*t;break;case f.UP:r=-.25*t;break;case f.DOWN:r=.25*t}switch(m){case f.LEFT:q=-.25*t;break;case f.RIGHT:q=.25*t;break;case f.UP:z=
-.25*t;break;case f.DOWN:z=.25*t}a.bezierCurveTo(b[0]+B,b[1]+r+l,c[0]+q,c[1]+z+l,c[0],c[1]+l)}else if(this.links_render_mode==f.LINEAR_LINK){a.moveTo(b[0],b[1]+l);z=q=r=B=0;switch(k){case f.LEFT:B=-1;break;case f.RIGHT:B=1;break;case f.UP:r=-1;break;case f.DOWN:r=1}switch(m){case f.LEFT:q=-1;break;case f.RIGHT:q=1;break;case f.UP:z=-1;break;case f.DOWN:z=1}a.lineTo(b[0]+15*B,b[1]+15*r+l);a.lineTo(c[0]+15*q,c[1]+15*z+l);a.lineTo(c[0],c[1]+l)}else if(this.links_render_mode==f.STRAIGHT_LINK)a.moveTo(b[0],
b[1]),l=b[0],B=b[1],r=c[0],q=c[1],k==f.RIGHT?l+=10:B+=10,m==f.LEFT?r-=10:q-=10,a.lineTo(l,B),a.lineTo(.5*(l+r),B),a.lineTo(.5*(l+r),q),a.lineTo(r,q),a.lineTo(c[0],c[1]);else return}this.render_connections_border&&.6<this.ds.scale&&!e&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=h;a.stroke();e=this.computeConnectionPoint(b,c,.5,k,m);d&&d._pos&&(d._pos[0]=e[0],d._pos[1]=e[1]);.6<=this.ds.scale&&this.highquality_render&&m!=f.CENTER&&(this.render_connection_arrows&&
(p=this.computeConnectionPoint(b,c,.25,k,m),t=this.computeConnectionPoint(b,c,.26,k,m),d=this.computeConnectionPoint(b,c,.75,k,m),u=this.computeConnectionPoint(b,c,.76,k,m),this.render_curved_connections?(t=-Math.atan2(t[0]-p[0],t[1]-p[1]),u=-Math.atan2(u[0]-d[0],u[1]-d[1])):u=t=c[1]>b[1]?0:Math.PI,a.save(),a.translate(p[0],p[1]),a.rotate(t),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(d[0],d[1]),a.rotate(u),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,
7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill());if(g)for(a.fillStyle=h,p=0;5>p;++p)g=(.001*f.getTime()+.2*p)%1,e=this.computeConnectionPoint(b,c,g,k,m),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill()};n.prototype.computeConnectionPoint=function(a,b,c,d,e){d=d||f.RIGHT;e=e||f.LEFT;var g=J(a,b),h=[a[0],a[1]],k=[b[0],b[1]];switch(d){case f.LEFT:h[0]+=-.25*g;break;case f.RIGHT:h[0]+=.25*g;break;case f.UP:h[1]+=-.25*g;break;case f.DOWN:h[1]+=.25*g}switch(e){case f.LEFT:k[0]+=
-.25*g;break;case f.RIGHT:k[0]+=.25*g;break;case f.UP:k[1]+=-.25*g;break;case f.DOWN:k[1]+=.25*g}d=(1-c)*(1-c)*(1-c);e=3*(1-c)*(1-c)*c;g=3*(1-c)*c*c;c*=c*c;return[d*a[0]+e*h[0]+g*k[0]+c*b[0],d*a[1]+e*h[1]+g*k[1]+c*b[1]]};n.prototype.drawExecutionOrder=function(a){a.shadowColor="transparent";a.globalAlpha=.25;a.textAlign="center";a.strokeStyle="white";a.globalAlpha=.75;for(var b=this.visible_nodes,c=0;c<b.length;++c){var d=b[c];a.fillStyle="black";a.fillRect(d.pos[0]-f.NODE_TITLE_HEIGHT,d.pos[1]-f.NODE_TITLE_HEIGHT,
f.NODE_TITLE_HEIGHT,f.NODE_TITLE_HEIGHT);0==d.order&&a.strokeRect(d.pos[0]-f.NODE_TITLE_HEIGHT+.5,d.pos[1]-f.NODE_TITLE_HEIGHT+.5,f.NODE_TITLE_HEIGHT,f.NODE_TITLE_HEIGHT);a.fillStyle="#FFF";a.fillText(d.order,d.pos[0]+-.5*f.NODE_TITLE_HEIGHT,d.pos[1]-6)}a.globalAlpha=1};n.prototype.drawNodeWidgets=function(a,b,c,d){if(!a.widgets||!a.widgets.length)return 0;var e=a.size[0],g=a.widgets;b+=2;var h=f.NODE_WIDGET_HEIGHT,k=.5<this.ds.scale;c.save();c.globalAlpha=this.editor_alpha;for(var m=f.WIDGET_OUTLINE_COLOR,
u=f.WIDGET_BGCOLOR,t=f.WIDGET_TEXT_COLOR,p=f.WIDGET_SECONDARY_TEXT_COLOR,n=0;n<g.length;++n){var l=g[n],r=b;l.y&&(r=l.y);l.last_y=r;c.strokeStyle=m;c.fillStyle="#222";c.textAlign="left";l.disabled&&(c.globalAlpha*=.5);var q=l.width||e;switch(l.type){case "button":l.clicked&&(c.fillStyle="#AAA",l.clicked=!1,this.dirty_canvas=!0);c.fillRect(15,r,q-30,h);k&&!l.disabled&&c.strokeRect(15,r,q-30,h);k&&(c.textAlign="center",c.fillStyle=t,c.fillText(l.name,.5*q,r+.7*h));break;case "toggle":c.textAlign="left";
c.strokeStyle=m;c.fillStyle=u;c.beginPath();k?c.roundRect(15,b,q-30,h,[.5*h]):c.rect(15,b,q-30,h);c.fill();k&&!l.disabled&&c.stroke();c.fillStyle=l.value?"#89A":"#333";c.beginPath();c.arc(q-30,r+.5*h,.36*h,0,2*Math.PI);c.fill();k&&(c.fillStyle=p,null!=l.name&&c.fillText(l.name,30,r+.7*h),c.fillStyle=l.value?t:p,c.textAlign="right",c.fillText(l.value?l.options.on||"true":l.options.off||"false",q-40,r+.7*h));break;case "slider":c.fillStyle=u;c.fillRect(15,r,q-30,h);var z=l.options.max-l.options.min,
F=(l.value-l.options.min)/z;c.fillStyle=d==l?"#89A":"#678";c.fillRect(15,r,F*(q-30),h);k&&!l.disabled&&c.strokeRect(15,r,q-30,h);l.marker&&(z=(l.marker-l.options.min)/z,c.fillStyle="#AA9",c.fillRect(15+z*(q-30),r,2,h));k&&(c.textAlign="center",c.fillStyle=t,c.fillText(l.name+"  "+Number(l.value).toFixed(3),.5*q,r+.7*h));break;case "number":case "combo":c.textAlign="left";c.strokeStyle=m;c.fillStyle=u;c.beginPath();k?c.roundRect(15,b,q-30,h,[.5*h]):c.rect(15,b,q-30,h);c.fill();k&&(l.disabled||c.stroke(),
c.fillStyle=t,l.disabled||(c.beginPath(),c.moveTo(31,b+5),c.lineTo(21,b+.5*h),c.lineTo(31,b+h-5),c.fill(),c.beginPath(),c.moveTo(q-15-16,b+5),c.lineTo(q-15-6,b+.5*h),c.lineTo(q-15-16,b+h-5),c.fill()),c.fillStyle=p,c.fillText(l.name,35,r+.7*h),c.fillStyle=t,c.textAlign="right","number"==l.type?c.fillText(Number(l.value).toFixed(void 0!==l.options.precision?l.options.precision:3),q-30-20,r+.7*h):(z=l.value,l.options.values&&(F=l.options.values,F.constructor===Function&&(F=F()),F&&F.constructor!==Array&&
(z=F[l.value])),c.fillText(z,q-30-20,r+.7*h)));break;case "string":case "text":c.textAlign="left";c.strokeStyle=m;c.fillStyle=u;c.beginPath();k?c.roundRect(15,b,q-30,h,[.5*h]):c.rect(15,b,q-30,h);c.fill();k&&(l.disabled||c.stroke(),c.save(),c.beginPath(),c.rect(15,b,q-30,h),c.clip(),c.fillStyle=p,null!=l.name&&c.fillText(l.name,30,r+.7*h),c.fillStyle=t,c.textAlign="right",c.fillText(String(l.value).substr(0,30),q-30,r+.7*h),c.restore());break;default:l.draw&&l.draw(c,a,q,r,h)}b+=(l.computeSize?l.computeSize(q)[1]:
h)+4;c.globalAlpha=this.editor_alpha}c.restore();c.textAlign="left"};n.prototype.processNodeWidgets=function(a,b,c,d){function e(d,e){d.value=e;d.options&&d.options.property&&void 0!==a.properties[d.options.property]&&a.setProperty(d.options.property,e);d.callback&&d.callback(d.value,m,a,b,c)}if(!a.widgets||!a.widgets.length)return null;for(var g=b[0]-a.pos[0],h=b[1]-a.pos[1],k=a.size[0],m=this,n=this.getCanvasWindow(),t=0;t<a.widgets.length;++t){var p=a.widgets[t];if(p&&!p.disabled){var l=p.computeSize?
p.computeSize(k)[1]:f.NODE_WIDGET_HEIGHT,q=p.width||k;if(p==d||!(6>g||g>q-12||h<p.last_y||h>p.last_y+l||void 0===p.last_y)){d=p.value;switch(p.type){case "button":c.type===f.pointerevents_method+"down"&&(p.callback&&setTimeout(function(){p.callback(p,m,a,b,c)},20),this.dirty_canvas=p.clicked=!0);break;case "slider":n=Math.clamp((g-15)/(q-30),0,1);p.value=p.options.min+(p.options.max-p.options.min)*n;p.callback&&setTimeout(function(){e(p,p.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":d=
p.value;if(c.type==f.pointerevents_method+"move"&&"number"==p.type)p.value+=.1*c.deltaX*(p.options.step||1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if(c.type==f.pointerevents_method+"down"){var r=p.options.values;r&&r.constructor===Function&&(r=p.options.values(p,a));var v=null;"number"!=p.type&&(v=r.constructor===Array?r:Object.keys(r));g=40>g?-1:g>q-40?1:0;if("number"==p.type)p.value+=.1*g*(p.options.step||
1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if(g)n=-1,this.last_mouseclick=0,n=r.constructor===Object?v.indexOf(String(p.value))+g:v.indexOf(p.value)+g,n>=v.length&&(n=v.length-1),0>n&&(n=0),p.value=r.constructor===Array?r[n]:n;else{var z=r!=v?Object.values(r):r;new f.ContextMenu(z,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){r!=v&&(a=z.indexOf(a));this.value=a;
e(this,a);m.dirty_canvas=!0;return!1}.bind(p)},n)}}else c.type==f.pointerevents_method+"up"&&"number"==p.type&&(g=40>g?-1:g>q-40?1:0,200>c.click_time&&0==g&&this.prompt("Value",p.value,function(a){this.value=Number(a);e(this,this.value)}.bind(p),c));d!=p.value&&setTimeout(function(){e(this,this.value)}.bind(p),20);this.dirty_canvas=!0;break;case "toggle":c.type==f.pointerevents_method+"down"&&(p.value=!p.value,setTimeout(function(){e(p,p.value)},20));break;case "string":case "text":c.type==f.pointerevents_method+
"down"&&this.prompt("Value",p.value,function(a){this.value=a;e(this,a)}.bind(p),c,p.options?p.options.multiline:!1);break;default:p.mouse&&(this.dirty_canvas=p.mouse(c,[g,h],a))}if(d!=p.value){if(a.onWidgetChanged)a.onWidgetChanged(p.name,p.value,d,p);a.graph._version++}return p}}}return null};n.prototype.drawGroups=function(a,b){if(this.graph){a=this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var d=a[c];if(H(this.visible_area,d._bounding)){b.fillStyle=d.color||
"#335";b.strokeStyle=d.color||"#335";var e=d._pos,g=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,g[0],g[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+g[0],e[1]+g[1]);b.lineTo(e[0]+g[0]-10,e[1]+g[1]);b.lineTo(e[0]+g[0],e[1]+g[1]-10);b.fill();g=d.font_size||f.DEFAULT_GROUP_FONT_SIZE;b.font=g+"px Arial";b.textAlign="left";b.fillText(d.title,e[0]+4,e[1]+g)}}b.restore()}};n.prototype.adjustNodesSize=function(){for(var a=this.graph._nodes,
...
this;a=n.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var k=[];if(b)for(var m=0;m<b.length;m++){var l=b[m];if(!l)k.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(l[0])){var t=l[0];l[2]||(l[2]={});l[2].label&&(t=l[2].label);l[2].removable=!0;t={content:t,value:l};l[1]==f.EVENT&&(t.className="event");k.push(t)}}this.onMenuNodeOutputs&&(k=this.onMenuNodeOutputs(k));if(k.length)return new f.ContextMenu(k,{event:c,callback:g,
parentMenu:d,node:e},a),!1}};n.onShowMenuNodeProperties=function(a,b,c,d,e){if(e&&e.properties){var g=n.active_canvas;b=g.getCanvasWindow();var h=[],k;for(k in e.properties){a=void 0!==e.properties[k]?e.properties[k]:" ";"object"==typeof a&&(a=JSON.stringify(a));var m=e.getPropertyInfo(k);if("enum"==m.type||"combo"==m.type)a=n.getPropertyPrintableValue(a,m.values);a=n.decodeHTML(a);h.push({content:"<span class='property_name'>"+(m.label?m.label:k)+"</span><span class='property_value'>"+a+"</span>",
...
var d=new f.ContextMenu(["Add Node",null,"Delete"],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b,g,h){switch(b){case "Add Node":n.onMenuAdd(null,null,h,d,function(b){console.log("node autoconnect");var d=c.graph.getNodeById(a.origin_id),e=c.graph.getNodeById(a.target_id);b.inputs&&b.inputs.length&&b.outputs&&b.outputs.length&&d.outputs[a.origin_slot].type==b.inputs[0].type&&b.outputs[0].type==e.inputs[0].type&&(d.connect(a.origin_slot,b,0),b.connect(0,e,a.target_slot),
b.pos[0]-=.5*b.size[0])});break;case "Delete":c.graph.removeLink(a.id)}}});return!1};n.onShowPropertyEditor=function(a,b,c,d,e){function g(){var b=m.value;"Number"==a.type?b=Number(b):"Boolean"==a.type&&(b=!!b);e[h]=b;f.parentNode&&f.parentNode.removeChild(f);e.setDirtyCanvas(!0,!0)}var h=a.property||"title";b=e[h];var f=document.createElement("div");f.className="graphdialog";f.innerHTML="<span class='name'></span><input autofocus type='text' class='value'/><button>OK</button>";f.querySelector(".name").innerText=
h;var m=f.querySelector(".value");m&&(m.value=b,m.addEventListener("blur",function(a){this.focus()}),m.addEventListener("keydown",function(a){if(13==a.keyCode||"textarea"==a.target.localName)g(),a.preventDefault(),a.stopPropagation()}));b=n.active_canvas.canvas;c=b.getBoundingClientRect();var l=d=-20;c&&(d-=c.left,l-=c.top);event?(f.style.left=event.clientX+d+"px",f.style.top=event.clientY+l+"px"):(f.style.left=.5*b.width+d+"px",f.style.top=.5*b.height+l+"px");f.querySelector("button").addEventListener("click",
g);b.parentNode.appendChild(f)};n.prototype.prompt=function(a,b,c,d,e){var g=this;a=a||"";var h=!1,k=document.createElement("div");k.className="graphdialog rounded";k.innerHTML=e?"<span class='name'></span> <textarea autofocus class='value'></textarea><button class='rounded'>OK</button>":"<span class='name'></span> <input autofocus type='text' class='value'/><button class='rounded'>OK</button>";k.close=function(){g.prompt_box=null;k.parentNode&&k.parentNode.removeChild(k)};1<this.ds.scale&&(k.style.transform=
"scale("+this.ds.scale+")");f.pointerListenerAdd(k,"leave",function(a){h||k.close()});g.prompt_box&&g.prompt_box.close();g.prompt_box=k;k.querySelector(".name").innerText=a;var m=k.querySelector(".value");m.value=b;m.addEventListener("keydown",function(a){h=!0;if(27==a.keyCode)k.close();else if(13==a.keyCode&&"textarea"!=a.target.localName)c&&c(this.value),k.close();else return;a.preventDefault();a.stopPropagation()});k.querySelector("button").addEventListener("click",function(a){c&&c(m.value);g.setDirty(!0);
k.close()});a=n.active_canvas.canvas;b=a.getBoundingClientRect();var l=e=-20;b&&(e-=b.left,l-=b.top);d?(k.style.left=d.clientX+e+"px",k.style.top=d.clientY+l+"px"):(k.style.left=.5*a.width+e+"px",k.style.top=.5*a.height+l+"px");a.parentNode.appendChild(k);setTimeout(function(){m.focus()},10);return k};n.search_limit=-1;n.prototype.showSearchBox=function(a){function b(b){if(b)if(e.onSearchBoxSelection)e.onSearchBoxSelection(b,a,g);else{var c=f.searchbox_extras[b.toLowerCase()];c&&(b=c.type);g.graph.beforeChange();
if(b=f.createNode(b))b.pos=g.convertEventToCanvasOffset(a),g.graph.add(b);if(c&&c.data){if(c.data.properties)for(var d in c.data.properties)b.addProperty(d,c.data.properties[d]);if(c.data.inputs)for(d in b.inputs=[],c.data.inputs)b.addOutput(c.data.inputs[d][0],c.data.inputs[d][1]);if(c.data.outputs)for(d in b.outputs=[],c.data.outputs)b.addOutput(c.data.outputs[d][0],c.data.outputs[d][1]);c.data.title&&(b.title=c.data.title);c.data.json&&b.configure(c.data.json);g.graph.afterChange()}}m.close()}
...
r=null;var c=v.value;p=null;t.innerHTML="";if(c)if(e.onSearchBox){var d=e.onSearchBox(t,c,g);if(d)for(var h=0;h<d.length;++h)a(d[h])}else{d=function(a){var b=f.registered_node_types[a];return m&&b.filter!=m?!1:-1!==a.toLowerCase().indexOf(c)};var k=0;c=c.toLowerCase();var m=g.filter||g.graph.filter;for(h in f.searchbox_extras){var l=f.searchbox_extras[h];if(-1!==l.desc.toLowerCase().indexOf(c)){var q=f.registered_node_types[l.type];if(!q||q.filter==m)if(a(l.desc,"searchbox_extra"),-1!==n.search_limit&&
k++>n.search_limit)break}}l=null;if(Array.prototype.filter)l=Object.keys(f.registered_node_types).filter(d);else for(h in l=[],f.registered_node_types)d(h)&&l.push(h);for(h=0;h<l.length&&!(a(l[h]),-1!==n.search_limit&&k++>n.search_limit);h++);}}var e=this,g=n.active_canvas,h=g.canvas,k=h.ownerDocument||document,m=document.createElement("div");m.className="litegraph litesearchbox graphdialog rounded";m.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";
m.close=function(){e.search_box=null;k.body.focus();k.body.style.overflow="";setTimeout(function(){e.canvas.focus()},20);m.parentNode&&m.parentNode.removeChild(m)};var l=null;1<this.ds.scale&&(m.style.transform="scale("+this.ds.scale+")");f.pointerListenerAdd(m,"enter",function(a){l&&(clearTimeout(l),l=null)});f.pointerListenerAdd(m,"leave",function(a){l=setTimeout(function(){m.close()},500)});e.search_box&&e.search_box.close();e.search_box=m;var t=m.querySelector(".helper"),p=null,r=null,q=null,
v=m.querySelector("input");v&&(v.addEventListener("blur",function(a){this.focus()}),v.addEventListener("keydown",function(a){if(38==a.keyCode)c(!1);else if(40==a.keyCode)c(!0);else if(27==a.keyCode)m.close();else if(13==a.keyCode)q?b(q.innerHTML):p?b(p):m.close();else{r&&clearInterval(r);r=setTimeout(d,10);return}a.preventDefault();a.stopPropagation();a.stopImmediatePropagation();return!0}));k.fullscreenElement?k.fullscreenElement.appendChild(m):(k.body.appendChild(m),k.body.style.overflow="hidden");
h=h.getBoundingClientRect();var w=(a?a.clientY:h.top+.5*h.height)-20;m.style.left=(a?a.clientX:h.left+.5*h.width)-80+"px";m.style.top=w+"px";a.layerY>h.height-200&&(t.style.maxHeight=h.height-a.layerY-20+"px");v.focus();return m};n.prototype.showEditPropertyValue=function(a,b,c){function d(){e(p.value)}function e(d){g&&g.values&&g.values.constructor===Object&&void 0!=g.values[d]&&(d=g.values[d]);"number"==typeof a.properties[b]&&(d=Number(d));if("array"==h||"object"==h)d=JSON.parse(d);a.properties[b]=
d;a.graph&&a.graph._version++;if(a.onPropertyChanged)a.onPropertyChanged(b,d);if(c.onclose)c.onclose();n.close();a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){c=c||{};var g=a.getPropertyInfo(b),h=g.type,f="";if("string"==h||"number"==h||"array"==h||"object"==h)f="<input autofocus type='text' class='value'/>";else if("enum"!=h&&"combo"!=h||!g.values)if("boolean"==h)f="<input autofocus type='checkbox' class='value' "+(a.properties[b]?"checked":"")+"/>";else{console.warn("unknown type: "+h);
return}else{f="<select autofocus type='text' class='value'>";for(var m in g.values){var l=m;g.values.constructor===Array&&(l=g.values[m]);f+="<option value='"+l+"' "+(l==a.properties[b]?"selected":"")+">"+g.values[m]+"</option>"}f+="</select>"}var n=this.createDialog("<span class='name'>"+(g.label?g.label:b)+"</span>"+f+"<button>OK</button>",c);if("enum"!=h&&"combo"!=h||!g.values)if("boolean"==h)(p=n.querySelector("input"))&&p.addEventListener("click",function(a){e(!!p.checked)});else{if(p=n.querySelector("input"))p.addEventListener("blur",
function(a){this.focus()}),l=void 0!==a.properties[b]?a.properties[b]:"","string"!==h&&(l=JSON.stringify(l)),p.value=l,p.addEventListener("keydown",function(a){13==a.keyCode&&(d(),a.preventDefault(),a.stopPropagation())})}else{var p=n.querySelector("select");p.addEventListener("change",function(a){e(a.target.value)})}n.querySelector("button").addEventListener("click",d);return n}};n.prototype.createDialog=function(a,b){b=b||{};var c=document.createElement("div");c.className="graphdialog";c.innerHTML=
...
!0})}b.addSeparator();if(a.onShowCustomPanelInfo)a.onShowCustomPanelInfo(b);b.addButton("Delete",function(){a.block_delete||(a.graph.remove(a),b.close())}).classList.add("delete")})();this.canvas.parentNode.appendChild(b)};n.prototype.showSubgraphPropertiesDialog=function(a){function b(){d.clear();if(a.inputs)for(var c=0;c<a.inputs.length;++c){var g=a.inputs[c];if(!g.not_subgraph_input){var f=d.addHTML("<button>&#10005;</button> <span class='bullet_icon'></span><span class='name'></span><span class='type'></span>",
...
"subgraph_property extra",!0);d.querySelector(".name").addEventListener("keydown",function(a){13==a.keyCode&&c.apply(this)});d.querySelector("button").addEventListener("click",function(a){c.apply(this)});b();this.canvas.parentNode.appendChild(e);return e};n.prototype.checkPanels=function(){if(this.canvas)for(var a=this.canvas.parentNode.querySelectorAll(".litegraph.dialog"),b=0;b<a.length;++b){var c=a[b];c.node&&(c.node.graph&&c.graph==this.graph||c.close())}};n.onMenuNodeCollapse=function(a,b,c,
d,e){e.graph.beforeChange(e);e.collapse();e.graph.afterChange(e)};n.onMenuNodePin=function(a,b,c,d,e){e.pin()};n.onMenuNodeMode=function(a,b,c,d,e){new f.ContextMenu(["Always","On Event","On Trigger","Never"],{event:c,callback:function(a){if(e)switch(a){case "On Event":e.mode=f.ON_EVENT;break;case "On Trigger":e.mode=f.ON_TRIGGER;break;case "Never":e.mode=f.NEVER;break;default:e.mode=f.ALWAYS}},parentMenu:d,node:e});return!1};n.onMenuNodeColors=function(a,b,c,d,e){if(!e)throw"no node for color";b=
[];b.push({value:null,content:"<span style='display: block; padding-left: 4px;'>No color</span>"});for(var g in n.node_colors)a=n.node_colors[g],a={value:g,content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid "+a.color+"; background-color:"+a.bgcolor+"'>"+g+"</span>"},b.push(a);new f.ContextMenu(b,{event:c,callback:function(a){e&&((a=a.value?n.node_colors[a.value]:null)?e.constructor===f.LGraphGroup?e.color=a.groupcolor:(e.color=a.color,e.bgcolor=a.bgcolor):
(delete e.color,delete e.bgcolor),e.setDirtyCanvas(!0,!0))},parentMenu:d,node:e});return!1};n.onMenuNodeShapes=function(a,b,c,d,e){if(!e)throw"no node passed";new f.ContextMenu(f.VALID_SHAPES,{event:c,callback:function(a){e&&(e.graph.beforeChange(e),e.shape=a,e.graph.afterChange(e),e.setDirtyCanvas(!0))},parentMenu:d,node:e});return!1};n.onMenuNodeRemove=function(a,b,c,d,e){if(!e)throw"no node passed";!1!==e.removable&&(a=e.graph,a.beforeChange(),a.remove(e),a.afterChange(),e.setDirtyCanvas(!0,!0))};
n.onMenuNodeToSubgraph=function(a,b,c,d,e){a=e.graph;if(b=n.active_canvas)c=Object.values(b.selected_nodes||{}),c.length||(c=[e]),d=f.createNode("graph/subgraph"),d.pos=e.pos.concat(),a.add(d),d.buildFromNodes(c),b.deselectAllNodes(),e.setDirtyCanvas(!0,!0)};n.onMenuNodeClone=function(a,b,c,d,e){0!=e.clonable&&(a=e.clone())&&(a.pos=[e.pos[0]+5,e.pos[1]+5],e.graph.beforeChange(),e.graph.add(a),e.graph.afterChange(),e.setDirtyCanvas(!0,!0))};n.node_colors={red:{color:"#322",bgcolor:"#533",groupcolor:"#A88"},
brown:{color:"#332922",bgcolor:"#593930",groupcolor:"#b06634"},green:{color:"#232",bgcolor:"#353",groupcolor:"#8A8"},blue:{color:"#223",bgcolor:"#335",groupcolor:"#88A"},pale_blue:{color:"#2a363b",bgcolor:"#3f5159",groupcolor:"#3f789e"},cyan:{color:"#233",bgcolor:"#355",groupcolor:"#8AA"},purple:{color:"#323",bgcolor:"#535",groupcolor:"#a1309b"},yellow:{color:"#432",bgcolor:"#653",groupcolor:"#b58b2a"},black:{color:"#222",bgcolor:"#000",groupcolor:"#444"}};n.prototype.getCanvasMenuOptions=function(){if(this.getMenuOptions)var a=
this.getMenuOptions();else a=[{content:"Add Node",has_submenu:!0,callback:n.onMenuAdd},{content:"Add Group",callback:n.onGroupAdd}],this._graph_stack&&0<this._graph_stack.length&&a.push(null,{content:"Close subgraph",callback:this.closeSubgraph.bind(this)});if(this.getExtraMenuOptions){var b=this.getExtraMenuOptions(this,a);b&&(a=a.concat(b))}return a};n.prototype.getNodeMenuOptions=function(a){var b=null;b=a.getMenuOptions?a.getMenuOptions(this):[{content:"Inputs",has_submenu:!0,disabled:!0,callback:n.showMenuNodeOptionalInputs},
{content:"Outputs",has_submenu:!0,disabled:!0,callback:n.showMenuNodeOptionalOutputs},null,{content:"Properties",has_submenu:!0,callback:n.onShowMenuNodeProperties},null,{content:"Title",callback:n.onShowPropertyEditor},{content:"Mode",has_submenu:!0,callback:n.onMenuNodeMode},{content:"Resize",callback:function(){if(a.resizable)return n.onResizeNode}},{content:"Collapse",callback:n.onMenuNodeCollapse},{content:"Pin",callback:n.onMenuNodePin},{content:"Colors",has_submenu:!0,callback:n.onMenuNodeColors},
{content:"Shapes",has_submenu:!0,callback:n.onMenuNodeShapes},null];if(a.onGetInputs){var c=a.onGetInputs();c&&c.length&&(b[0].disabled=!1)}a.onGetOutputs&&(c=a.onGetOutputs())&&c.length&&(b[1].disabled=!1);a.getExtraMenuOptions&&(c=a.getExtraMenuOptions(this,b))&&(c.push(null),b=c.concat(b));!1!==a.clonable&&b.push({content:"Clone",callback:n.onMenuNodeClone});b.push(null,{content:"Remove",disabled:!(!1!==a.removable&&!a.block_delete),callback:n.onMenuNodeRemove});if(a.graph&&a.graph.onGetNodeMenuOptions)a.graph.onGetNodeMenuOptions(b,
a);return b};n.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:n.onShowPropertyEditor},{content:"Color",has_submenu:!0,callback:n.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:n.onShowPropertyEditor},null,{content:"Remove",callback:n.onMenuNodeRemove}]};n.prototype.processContextMenu=function(a,b){var c=this,d=n.active_canvas.getCanvasWindow(),e=null,g={event:b,callback:function(b,d,e){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?
a.removeInput(b.slot):b.output&&a.removeOutput(b.slot);else if("Disconnect Links"==b.content)b=b.slot,b.output?a.disconnectOutput(b.slot):b.input&&a.disconnectInput(b.slot);else if("Rename Slot"==b.content){b=b.slot;var g=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),f=c.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",d),h=f.querySelector("input");h&&g&&(h.value=g.label||"");f.querySelector("button").addEventListener("click",function(a){h.value&&
(g&&(g.label=h.value),c.setDirty(!0));f.close()})}},extra:a};a&&(g.title=a.type);var h=null;a&&(h=a.getSlotInPosition(b.canvasX,b.canvasY),n.active_node=a);h?(e=[],a.getSlotMenuOptions?e=a.getSlotMenuOptions(h):(h&&h.output&&h.output.links&&h.output.links.length&&e.push({content:"Disconnect Links",slot:h}),b=h.input||h.output,e.push(b.locked||!b.removable?"Cannot remove":{content:"Remove Slot",slot:h}),e.push(b.nameLocked?"Cannot rename":{content:"Rename Slot",slot:h})),g.title=(h.input?h.input.type:
h.output.type)||"*",h.input&&h.input.type==f.ACTION&&(g.title="Action"),h.output&&h.output.type==f.EVENT&&(g.title="Event")):a?e=this.getNodeMenuOptions(a):(e=this.getCanvasMenuOptions(),(h=this.graph.getGroupOnPos(b.canvasX,b.canvasY))&&e.push(null,{content:"Edit Group",has_submenu:!0,submenu:{title:"Group",extra:h,options:this.getGroupMenuOptions(h)}}));e&&new f.ContextMenu(e,g,d)};"undefined"!=typeof window&&window.CanvasRenderingContext2D&&!window.CanvasRenderingContext2D.prototype.roundRect&&
(window.CanvasRenderingContext2D.prototype.roundRect=function(a,b,c,d,e,g){var f,k;if(0===e)this.rect(a,b,c,d);else{void 0===g&&(g=e);if(null!=e&&e.constructor===Array)if(1==e.length)var m=f=k=g=e[0];else if(2==e.length)m=g=e[0],f=k=e[1];else if(4==e.length)m=e[0],f=e[1],k=e[2],g=e[3];else return;else m=e||0,f=e||0,k=g||0,g=g||0;this.moveTo(a+m,b);this.lineTo(a+c-f,b);this.quadraticCurveTo(a+c,b,a+c,b+f);this.lineTo(a+c,b+d-g);this.quadraticCurveTo(a+c,b+d,a+c-g,b+d);this.lineTo(a+g,b+d);this.quadraticCurveTo(a,
...
b[0][0]||a[1]<b[0][1]||a[0]>b[1][0]||a[1]>b[1][1]?!1:!0};f.overlapBounding=H;f.hex2num=function(a){"#"==a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();for(var b=Array(3),c=0,d,e,f=0;6>f;f+=2)d="0123456789ABCDEF".indexOf(a.charAt(f)),e="0123456789ABCDEF".indexOf(a.charAt(f+1)),b[c]=16*d+e,c++;return b};f.num2hex=function(a){for(var b="#",c,d,e=0;3>e;e++)c=a[e]/16,d=a[e]%16,b+="0123456789ABCDEF".charAt(c)+"0123456789ABCDEF".charAt(d);return b};E.prototype.addItem=function(a,b,c){function d(a){var b=
