...
e.autoresize}function w(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function B(a,b,e,r,h,c){return e<a&&e+h>a&&r<b&&r+c>b?!0:!1}function z(a,b){var e=a[0]+a[2],r=a[1]+a[3],h=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>h||e<b[0]||r<b[1]?!1:!0}function y(a,b){function e(a){var e=parseInt(h.style.top);h.style.top=(e+a.deltaY*b.scroll_speed).toFixed()+"px";a.preventDefault();return!0}this.options=b=b||{};var r=this;b.parentMenu&&(b.parentMenu.constructor!==this.constructor?(console.error("parentMenu must be of class ContextMenu, ignoring it"),
b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));b.event&&b.event.constructor!==MouseEvent&&b.event.constructor!==CustomEvent&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it."),b.event=null);var h=document.createElement("div");h.className="litegraph litecontextmenu litemenubar-panel";b.className&&(h.className+=" "+b.className);h.style.minWidth=100;h.style.minHeight=100;h.style.pointerEvents=
"none";setTimeout(function(){h.style.pointerEvents="auto"},100);h.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);h.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);h.addEventListener("mousedown",function(a){if(2==a.button)return r.close(),a.preventDefault(),!0},!0);b.scroll_speed||(b.scroll_speed=0.1);h.addEventListener("wheel",e,!0);h.addEventListener("mousewheel",e,!0);this.root=h;if(b.title){var c=document.createElement("div");
c.className="litemenu-title";c.innerHTML=b.title;h.appendChild(c)}var c=0,f;for(f in a){var k=a.constructor==Array?a[f]:f;null!=k&&k.constructor!==String&&(k=void 0===k.content?String(k):k.content);this.addItem(k,a[f],b);c++}h.addEventListener("mouseleave",function(a){r.lock||(h.closing_timer&&clearTimeout(h.closing_timer),h.closing_timer=setTimeout(r.close.bind(r,a),500))});h.addEventListener("mouseenter",function(a){h.closing_timer&&clearTimeout(h.closing_timer)});f=document;b.event&&(f=b.event.target.ownerDocument);
f||(f=document);f.body.appendChild(h);c=b.left||0;f=b.top||0;if(b.event){c=b.event.clientX-10;f=b.event.clientY-10;b.title&&(f-=20);b.parentMenu&&(c=b.parentMenu.root.getBoundingClientRect(),c=c.left+c.width);var k=document.body.getBoundingClientRect(),d=h.getBoundingClientRect();c>k.width-d.width-10&&(c=k.width-d.width-10);f>k.height-d.height-10&&(f=k.height-d.height-10)}h.style.left=c+"px";h.style.top=f+"px";b.scale&&(h.style.transform="scale("+b.scale+")")}var c=u.LiteGraph={VERSION:0.4,CANVAS_GRID_SIZE:10,
...
Nodes:{},searchbox_extras:{},registerNodeType:function(a,b){if(!b.prototype)throw"Cannot register a simple object, it must be a class with a prototype";b.type=a;c.debug&&console.log("Node registered: "+a);a.split("/");var e=b.name,r=a.lastIndexOf("/");b.category=a.substr(0,r);b.title||(b.title=e);if(b.prototype)for(var h in q.prototype)b.prototype[h]||(b.prototype[h]=q.prototype[h]);Object.defineProperty(b.prototype,"shape",{set:function(a){switch(a){case "default":delete this._shape;break;case "box":this._shape=
...
b},wrapFunctionAsNode:function(a,b,e,r){for(var h=Array(b.length),f="",k=c.getParameterNames(b),d=0;d<k.length;++d)f+="this.addInput('"+k[d]+"',"+(e&&e[d]?"'"+e[d]+"'":"0")+");\n";e=Function(f+("this.addOutput('out',"+(r?"'"+r+"'":0)+");\n"));e.title=a.split("/").pop();e.desc="Generated from "+b.name;e.prototype.onExecute=function(){for(var a=0;a<h.length;++a)h[a]=this.getInputData(a);a=b.apply(this,h);this.setOutputData(0,a)};this.registerNodeType(a,e)},addNodeMethod:function(a,b){q.prototype[a]=
b;for(var e in this.registered_node_types){var r=this.registered_node_types[e];r.prototype[a]&&(r.prototype["_"+a]=r.prototype[a]);r.prototype[a]=b}},createNode:function(a,b,e){var r=this.registered_node_types[a];if(!r)return c.debug&&console.log('GraphNode type "'+a+'" not registered.'),null;b=b||r.title||a;var h=null;if(c.catch_exceptions)try{h=new r(b)}catch(f){return console.error(f),null}else h=new r(b);h.type=a;!h.title&&b&&(h.title=b);h.properties||(h.properties={});h.properties_info||(h.properties_info=
[]);h.flags||(h.flags={});h.size||(h.size=h.computeSize());h.pos||(h.pos=c.DEFAULT_POSITION.concat());h.mode||(h.mode=c.ALWAYS);if(e)for(var k in e)h[k]=e[k];return h},getNodeType:function(a){return this.registered_node_types[a]},getNodeTypesInCategory:function(a,b){var e=[],r;for(r in this.registered_node_types){var h=this.registered_node_types[r];b&&h.filter&&h.filter!=b||(""==a?null==h.category&&e.push(h):h.category==a&&e.push(h))}return e},getNodeTypesCategories:function(){var a={"":1},b;for(b in this.registered_node_types)this.registered_node_types[b].category&&
!this.registered_node_types[b].skip_list&&(a[this.registered_node_types[b].category]=1);var e=[];for(b in a)e.push(b);return e},reloadNodes:function(a){var b=document.getElementsByTagName("script"),e=[],r;for(r in b)e.push(b[r]);b=document.getElementsByTagName("head")[0];a=document.location.href+a;for(r in e){var h=e[r].src;if(h&&h.substr(0,a.length)==a)try{c.debug&&console.log("Reloading: "+h);var f=document.createElement("script");f.type="text/javascript";f.src=h;b.appendChild(f);b.removeChild(e[r])}catch(k){if(c.throw_errors)throw k;
c.debug&&console.log("Error while reloading "+h)}}c.debug&&console.log("Nodes reloaded")},cloneObject:function(a,b){if(null==a)return null;var e=JSON.parse(JSON.stringify(a));if(!b)return e;for(var r in e)b[r]=e[r];return b},isValidConnection:function(a,b){if(!a||!b||a==b||a==c.EVENT&&b==c.ACTION)return!0;a=String(a);b=String(b);a=a.toLowerCase();b=b.toLowerCase();if(-1==a.indexOf(",")&&-1==b.indexOf(","))return a==b;for(var e=a.split(","),r=b.split(","),h=0;h<e.length;++h)for(var f=0;f<r.length;++f)if(e[h]==
r[f])return!0;return!1},registerSearchboxExtra:function(a,b,e){this.searchbox_extras[b]={type:a,desc:b,data:e}}};c.getTime="undefined"!=typeof performance?performance.now.bind(performance):"undefined"!=typeof Date&&Date.now?Date.now.bind(Date):"undefined"!=typeof process?function(){var a=process.hrtime();return 0.001*a[0]+1E-6*a[1]}:function(){return(new Date).getTime()};u.LGraph=c.LGraph=d;d.supported_types=["number","string","boolean"];d.prototype.getSupportedTypes=function(){return this.supported_types||
...
this.fixedtime_lapse=0.01;this.starttime=this.last_update_time=0;this.catch_errors=!0;this.global_inputs={};this.global_outputs={};this.change();this.sendActionToCanvas("clear")};d.prototype.attachCanvas=function(a){if(a.constructor!=m)throw"attachCanvas expects a LGraphCanvas instance";a.graph&&a.graph!=this&&a.graph.detachCanvas(a);a.graph=this;this.list_of_graphcanvas||(this.list_of_graphcanvas=[]);this.list_of_graphcanvas.push(a)};d.prototype.detachCanvas=function(a){if(this.list_of_graphcanvas){var b=
this.list_of_graphcanvas.indexOf(a);-1!=b&&(a.graph=null,this.list_of_graphcanvas.splice(b,1))}};d.prototype.start=function(a){if(this.status!=d.STATUS_RUNNING){this.status=d.STATUS_RUNNING;if(this.onPlayEvent)this.onPlayEvent();this.sendEventToAllNodes("onStart");this.last_update_time=this.starttime=c.getTime();a=a||0;var b=this;if(0==a&&"undefined"!=typeof window&&window.requestAnimationFrame){var e=function(){-1==b.execution_timer_id&&(window.requestAnimationFrame(e),b.runStep(1,!this.catch_errors))};
...
this.starttime);var r=this._nodes_executable?this._nodes_executable:this._nodes;if(r){if(b){for(var h=0;h<a;h++){for(var f=0,k=r.length;f<k;++f){var d=r[f];if(d.mode==c.ALWAYS&&d.onExecute)d.onExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(h=0;h<a;h++){f=0;for(k=r.length;f<k;++f)if(d=r[f],d.mode==c.ALWAYS&&d.onExecute)d.onExecute();this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute();
this.errors_in_execution=!1}catch(m){this.errors_in_execution=!0;if(c.throw_errors)throw m;c.debug&&console.log("Error during execution: "+m);this.stop()}r=c.getTime();e=r-e;0==e&&(e=1);this.execution_time=0.001*e;this.globaltime+=0.001*e;this.iteration+=1;this.elapsed_time=0.001*(r-this.last_update_time);this.last_update_time=r}};d.prototype.updateExecutionOrder=function(){this._nodes_in_order=this.computeExecutionOrder(!1);this._nodes_executable=[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&
this._nodes_executable.push(this._nodes_in_order[a])};d.prototype.computeExecutionOrder=function(a,b){for(var e=[],r=[],h={},f={},k={},d=0,m=this._nodes.length;d<m;++d){var n=this._nodes[d];if(!a||n.onExecute){h[n.id]=n;var p=0;if(n.inputs)for(var C=0,D=n.inputs.length;C<D;C++)n.inputs[C]&&null!=n.inputs[C].link&&(p+=1);0==p?(r.push(n),b&&(n._level=1)):(b&&(n._level=0),k[n.id]=p)}}for(;0!=r.length;)if(n=r.shift(),e.push(n),delete h[n.id],n.outputs)for(d=0;d<n.outputs.length;d++)if(m=n.outputs[d],
null!=m&&null!=m.links&&0!=m.links.length)for(C=0;C<m.links.length;C++)(p=this.links[m.links[C]])&&!f[p.id]&&(D=this.getNodeById(p.target_id),null==D?f[p.id]=!0:(b&&(!D._level||D._level<=n._level)&&(D._level=n._level+1),f[p.id]=!0,k[D.id]-=1,0==k[D.id]&&r.push(D)));for(d in h)e.push(h[d]);e.length!=this._nodes.length&&c.debug&&console.warn("something went wrong, nodes missing");m=e.length;for(d=0;d<m;++d)e[d].order=d;e=e.sort(function(a,b){var e=a.constructor.priority||a.priority||0,p=b.constructor.priority||
b.priority||0;return e==p?a.order-b.order:e-p});for(d=0;d<m;++d)e[d].order=d;return e};d.prototype.getAncestors=function(a){for(var b=[],e=[a],r={};e.length;){var h=e.shift();if(h.inputs){r[h.id]||h==a||(r[h.id]=!0,b.push(h));for(var c=0;c<h.inputs.length;++c){var f=h.getInputNode(c);f&&-1==b.indexOf(f)&&e.push(f)}}}b.sort(function(a,b){return a.order-b.order});return b};d.prototype.arrange=function(a){a=a||40;for(var b=this.computeExecutionOrder(!1,!0),e=[],r=0;r<b.length;++r){var h=b[r],c=h._level||
1;e[c]||(e[c]=[]);e[c].push(h)}b=a;for(r=0;r<e.length;++r)if(c=e[r]){for(var f=100,k=a,d=0;d<c.length;++d)h=c[d],h.pos[0]=b,h.pos[1]=k,h.size[0]>f&&(f=h.size[0]),k+=h.size[1]+a;b+=f+a}this.setDirtyCanvas(!0,!0)};d.prototype.getTime=function(){return this.globaltime};d.prototype.getFixedTime=function(){return this.fixedtime};d.prototype.getElapsedTime=function(){return this.elapsed_time};d.prototype.sendEventToAllNodes=function(a,b,e){e=e||c.ALWAYS;var r=this._nodes_in_order?this._nodes_in_order:this._nodes;
if(r)for(var h=0,f=r.length;h<f;++h){var k=r[h];if(k[a]&&k.mode==e)if(void 0===b)k[a]();else if(b&&b.constructor===Array)k[a].apply(k,b);else k[a](b)}};d.prototype.sendActionToCanvas=function(a,b){if(this.list_of_graphcanvas)for(var e=0;e<this.list_of_graphcanvas.length;++e){var c=this.list_of_graphcanvas[e];c[a]&&c[a].apply(c,b)}};d.prototype.add=function(a,b){if(a)if(a.constructor===g)this._groups.push(a),this.setDirtyCanvas(!0),this.change(),a.graph=this,this._version++;else{-1!=a.id&&null!=this._nodes_by_id[a.id]&&
(console.warn("LiteGraph: there is already a node with this ID, changing it"),a.id=++this.last_node_id);if(this._nodes.length>=c.MAX_NUMBER_OF_NODES)throw"LiteGraph: max number of nodes in a graph reached";null==a.id||-1==a.id?a.id=++this.last_node_id:this.last_node_id<a.id&&(this.last_node_id=a.id);a.graph=this;this._version++;this._nodes.push(a);this._nodes_by_id[a.id]=a;if(a.onAdded)a.onAdded(this);this.config.align_to_grid&&a.alignToGrid();b||this.updateExecutionOrder();if(this.onNodeAdded)this.onNodeAdded(a);
this.setDirtyCanvas(!0);this.change();return a}};d.prototype.remove=function(a){if(a.constructor===c.LGraphGroup){var b=this._groups.indexOf(a);-1!=b&&this._groups.splice(b,1);a.graph=null;this._version++;this.setDirtyCanvas(!0,!0);this.change()}else if(null!=this._nodes_by_id[a.id]&&!a.ignore_remove){if(a.inputs)for(b=0;b<a.inputs.length;b++){var e=a.inputs[b];null!=e.link&&a.disconnectInput(b)}if(a.outputs)for(b=0;b<a.outputs.length;b++)e=a.outputs[b],null!=e.links&&e.links.length&&a.disconnectOutput(b);
...
a?null:this._nodes_by_id[a]};d.prototype.findNodesByClass=function(a){for(var b=[],e=0,c=this._nodes.length;e<c;++e)this._nodes[e].constructor===a&&b.push(this._nodes[e]);return b};d.prototype.findNodesByType=function(a){a=a.toLowerCase();for(var b=[],e=0,c=this._nodes.length;e<c;++e)this._nodes[e].type.toLowerCase()==a&&b.push(this._nodes[e]);return b};d.prototype.findNodesByTitle=function(a){for(var b=[],e=0,c=this._nodes.length;e<c;++e)this._nodes[e].title==a&&b.push(this._nodes[e]);return b};
d.prototype.getNodeOnPos=function(a,b,e,c){e=e||this._nodes;for(var h=e.length-1;0<=h;h--){var f=e[h];if(f.isPointInside(a,b,c))return f}return null};d.prototype.getGroupOnPos=function(a,b){for(var e=this._groups.length-1;0<=e;e--){var c=this._groups[e];if(c.isPointInside(a,b,2,!0))return c}return null};d.prototype.addGlobalInput=function(a,b,e){this.global_inputs[a]={name:a,type:b,value:e};this._version++;if(this.onGlobalInputAdded)this.onGlobalInputAdded(a,b);if(this.onGlobalsChange)this.onGlobalsChange()};
d.prototype.setGlobalInputData=function(a,b){var e=this.global_inputs[a];e&&(e.value=b)};d.prototype.setInputData=d.prototype.setGlobalInputData;d.prototype.getGlobalInputData=function(a){return(a=this.global_inputs[a])?a.value:null};d.prototype.renameGlobalInput=function(a,b){if(b!=a){if(!this.global_inputs[a])return!1;if(this.global_inputs[b])return console.error("there is already one input with that name"),!1;this.global_inputs[b]=this.global_inputs[a];delete this.global_inputs[a];this._version++;
...
this._version++;if(this.onGlobalInputRemoved)this.onGlobalInputRemoved(a);if(this.onGlobalsChange)this.onGlobalsChange();return!0};d.prototype.addGlobalOutput=function(a,b,e){this.global_outputs[a]={name:a,type:b,value:e};this._version++;if(this.onGlobalOutputAdded)this.onGlobalOutputAdded(a,b);if(this.onGlobalsChange)this.onGlobalsChange()};d.prototype.setGlobalOutputData=function(a,b){var e=this.global_outputs[a];e&&(e.value=b)};d.prototype.getGlobalOutputData=function(a){return(a=this.global_outputs[a])?
...
function(){for(var a=[],b=0,e=this._nodes.length;b<e;++b)a.push(this._nodes[b].serialize());e=[];for(b in this.links){var r=this.links[b];e.push([r.id,r.origin_id,r.origin_slot,r.target_id,r.target_slot,r.type])}r=[];for(b=0;b<this._groups.length;++b)r.push(this._groups[b].serialize());return{last_node_id:this.last_node_id,last_link_id:this.last_link_id,nodes:a,links:e,groups:r,config:this.config,version:c.VERSION}};d.prototype.configure=function(a,b){if(a){b||this.clear();var e=a.nodes;if(a.links&&
a.links.constructor===Array){for(var r=[],h=0;h<a.links.length;++h){var f=a.links[h],k=new l;k.configure(f);r[k.id]=k}a.links=r}for(h in a)this[h]=a[h];r=!1;this._nodes=[];if(e){h=0;for(f=e.length;h<f;++h){var k=e[h],d=c.createNode(k.type,k.title);d||(c.debug&&console.log("Node not found or has errors: "+k.type),d=new q,d.last_serialization=k,r=d.has_errors=!0);d.id=k.id;this.add(d,!0)}h=0;for(f=e.length;h<f;++h)k=e[h],(d=this.getNodeById(k.id))&&d.configure(k)}this._groups.length=0;if(a.groups)for(h=
0;h<a.groups.length;++h)e=new c.LGraphGroup,e.configure(a.groups[h]),this.add(e);this.updateExecutionOrder();this._version++;this.setDirtyCanvas(!0,!0);return r}};d.prototype.load=function(a){var b=this,e=new XMLHttpRequest;e.open("GET",a,!0);e.send(null);e.onload=function(a){200!==e.status?console.error("Error loading graph:",e.status,e.response):(a=JSON.parse(e.response),b.configure(a))};e.onerror=function(a){console.error("Error loading graph:",a)}};d.prototype.onNodeTrace=function(a,b,e){};l.prototype.configure=
function(a){a.constructor===Array?(this.id=a[0],this.origin_id=a[1],this.origin_slot=a[2],this.target_id=a[3],this.target_slot=a[4],this.type=a[5]):(this.id=a.id,this.type=a.type,this.origin_id=a.origin_id,this.origin_slot=a.origin_slot,this.target_id=a.target_id,this.target_slot=a.target_slot)};l.prototype.serialize=function(){return[this.id,this.type,this.origin_id,this.origin_slot,this.target_id,this.target_slot]};c.LLink=l;u.LGraphNode=c.LGraphNode=q;q.prototype._ctor=function(a){this.title=a||
"Unnamed";this.size=[c.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};q.prototype.configure=function(a){this.graph&&this.graph._version++;for(var b in a)if("properties"==b)for(var e in a.properties){if(this.properties[e]=
a.properties[e],this.onPropertyChanged)this.onPropertyChanged(e,a.properties[e])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?this[b].configure(a[b]):this[b]=c.cloneObject(a[b],this[b]):this[b]=a[b]);a.title||(this.title=this.constructor.title);if(this.onConnectionsChange){if(this.inputs)for(e=0;e<this.inputs.length;++e){b=this.inputs[e];var r=this.graph?this.graph.links[b.link]:null;this.onConnectionsChange(c.INPUT,e,!0,r,b)}if(this.outputs)for(e=0;e<this.outputs.length;++e){var h=
this.outputs[e];if(h.links)for(b=0;b<h.links.length;++b)r=this.graph?this.graph.links[h.links[b]]:null,this.onConnectionsChange(c.OUTPUT,e,!0,r,h)}}if(this.onConfigure)this.onConfigure(a)};q.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,size:this.size,flags:c.cloneObject(this.flags),mode:this.mode};if(this.constructor===q&&this.last_serialization)return this.last_serialization;this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;
a.outputs=this.outputs}this.title&&this.title!=this.constructor.title&&(a.title=this.title);this.properties&&(a.properties=c.cloneObject(this.properties));a.type||(a.type=this.constructor.type);this.color&&(a.color=this.color);this.bgcolor&&(a.bgcolor=this.bgcolor);this.boxcolor&&(a.boxcolor=this.boxcolor);this.shape&&(a.shape=this.shape);this.onSerialize&&this.onSerialize(a)&&console.warn("node onSerialize shouldnt return anything, data should be stored in the object pass in the first parameter");
return a};q.prototype.clone=function(){var a=c.createNode(this.type);if(!a)return null;var b=c.cloneObject(this.serialize());if(b.inputs)for(var e=0;e<b.inputs.length;++e)b.inputs[e].link=null;if(b.outputs)for(e=0;e<b.outputs.length;++e)b.outputs[e].links&&(b.outputs[e].links.length=0);delete b.id;a.configure(b);return a};q.prototype.toString=function(){return JSON.stringify(this.serialize())};q.prototype.getTitle=function(){return this.title||this.constructor.title};q.prototype.setOutputData=function(a,
b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var e=this.outputs[a];if(e&&(e._data=b,this.outputs[a].links))for(e=0;e<this.outputs[a].links.length;e++)this.graph.links[this.outputs[a].links[e]].data=b}};q.prototype.setOutputDataType=function(a,b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var e=this.outputs[a];if(e&&(e.type=b,this.outputs[a].links))for(e=0;e<this.outputs[a].links.length;e++)this.graph.links[this.outputs[a].links[e]].type=b}};q.prototype.getInputData=function(a,b){if(this.inputs&&
!(a>=this.inputs.length||null==this.inputs[a].link)){var e=this.graph.links[this.inputs[a].link];if(!e)return null;if(!b)return e.data;var c=this.graph.getNodeById(e.origin_id);if(!c)return e.data;if(c.updateOutputData)c.updateOutputData(e.origin_slot);else if(c.onExecute)c.onExecute();return e.data}};q.prototype.getInputDataType=function(a){if(!this.inputs||a>=this.inputs.length||null==this.inputs[a].link)return null;a=this.graph.links[this.inputs[a].link];if(!a)return null;var b=this.graph.getNodeById(a.origin_id);
return b?(a=b.outputs[a.origin_slot])?a.type:null:a.type};q.prototype.getInputDataByName=function(a,b){var e=this.findInputSlot(a);return-1==e?null:this.getInputData(e,b)};q.prototype.isInputConnected=function(a){return this.inputs?a<this.inputs.length&&null!=this.inputs[a].link:!1};q.prototype.getInputInfo=function(a){return this.inputs?a<this.inputs.length?this.inputs[a]:null:null};q.prototype.getInputNode=function(a){if(!this.inputs||a>=this.inputs.length)return null;a=this.inputs[a];return a&&
null!==a.link?(a=this.graph.links[a.link])?this.graph.getNodeById(a.origin_id):null:null};q.prototype.getInputOrProperty=function(a){if(!this.inputs||!this.inputs.length)return this.properties?this.properties[a]:null;for(var b=0,e=this.inputs.length;b<e;++b){var c=this.inputs[b];if(a==c.name&&null!=c.link&&(c=this.graph.links[c.link]))return c.data}return this.properties[a]};q.prototype.getOutputData=function(a){return!this.outputs||a>=this.outputs.length?null:this.outputs[a]._data};q.prototype.getOutputInfo=
function(a){return this.outputs?a<this.outputs.length?this.outputs[a]:null:null};q.prototype.isOutputConnected=function(a){return this.outputs?a<this.outputs.length&&this.outputs[a].links&&this.outputs[a].links.length:!1};q.prototype.isAnyOutputConnected=function(){if(!this.outputs)return!1;for(var a=0;a<this.outputs.length;++a)if(this.outputs[a].links&&this.outputs[a].links.length)return!0;return!1};q.prototype.getOutputNodes=function(a){if(!this.outputs||0==this.outputs.length||a>=this.outputs.length)return null;
a=this.outputs[a];if(!a.links||0==a.links.length)return null;for(var b=[],e=0;e<a.links.length;e++){var c=this.graph.links[a.links[e]];c&&(c=this.graph.getNodeById(c.target_id))&&b.push(c)}return b};q.prototype.trigger=function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=c.getTime());for(var e=0;e<this.outputs.length;++e){var r=this.outputs[e];!r||r.type!==c.EVENT||a&&r.name!=a||this.triggerSlot(e,b)}}};q.prototype.triggerSlot=function(a,b,e){if(this.outputs&&
(a=this.outputs[a])&&(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=c.getTime());for(var r=0;r<a.length;++r){var h=a[r];if(null==e||e==h){var f=this.graph.links[a[r]];if(f&&(f._last_time=c.getTime(),h=this.graph.getNodeById(f.target_id)))if(f=h.inputs[f.target_slot],h.onAction)h.onAction(f.name,b);else if(h.mode===c.ON_TRIGGER&&h.onExecute)h.onExecute(b)}}}};q.prototype.clearTriggeredSlot=function(a,b){if(this.outputs){var e=this.outputs[a];if(e&&(e=e.links)&&e.length)for(var c=
0;c<e.length;++c){var h=e[c];if(null==b||b==h)if(h=this.graph.links[e[c]])h._last_time=0}}};q.prototype.addProperty=function(a,b,e,c){e={name:a,type:e,default_value:b};if(c)for(var h in c)e[h]=c[h];this.properties_info||(this.properties_info=[]);this.properties_info.push(e);this.properties||(this.properties={});this.properties[a]=b;return e};q.prototype.addOutput=function(a,b,e){a={name:a,type:b,links:null};if(e)for(var c in e)a[c]=e[c];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);
this.size=this.computeSize();this.setDirtyCanvas(!0,!0);return a};q.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var e=a[b],c={name:e[0],type:e[1],link:null};if(a[2])for(var h in e[2])c[h]=e[2][h];this.outputs||(this.outputs=[]);this.outputs.push(c);if(this.onOutputAdded)this.onOutputAdded(c)}this.size=this.computeSize();this.setDirtyCanvas(!0,!0)};q.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);for(var b=a;b<this.outputs.length;++b)if(this.outputs[b]&&
this.outputs[b].links)for(var e=this.outputs[b].links,c=0;c<e.length;++c){var h=this.graph.links[e[c]];h&&(h.origin_slot-=1)}this.size=this.computeSize();if(this.onOutputRemoved)this.onOutputRemoved(a);this.setDirtyCanvas(!0,!0)};q.prototype.addInput=function(a,b,e){a={name:a,type:b||0,link:null};if(e)for(var c in e)a[c]=e[c];this.inputs||(this.inputs=[]);this.inputs.push(a);this.size=this.computeSize();if(this.onInputAdded)this.onInputAdded(a);this.setDirtyCanvas(!0,!0);return a};q.prototype.addInputs=
function(a){for(var b=0;b<a.length;++b){var e=a[b],c={name:e[0],type:e[1],link:null};if(a[2])for(var h in e[2])c[h]=e[2][h];this.inputs||(this.inputs=[]);this.inputs.push(c);if(this.onInputAdded)this.onInputAdded(c)}this.size=this.computeSize();this.setDirtyCanvas(!0,!0)};q.prototype.removeInput=function(a){this.disconnectInput(a);this.inputs.splice(a,1);for(var b=a;b<this.inputs.length;++b)if(this.inputs[b]){var e=this.graph.links[this.inputs[b].link];e&&(e.target_slot-=1)}this.size=this.computeSize();
if(this.onInputRemoved)this.onInputRemoved(a);this.setDirtyCanvas(!0,!0)};q.prototype.addConnection=function(a,b,e,c){a={name:a,type:b,pos:e,direction:c,links:null};this.connections.push(a);return a};q.prototype.computeSize=function(a,b){function e(a){return a?f*a.length*0.6:0}if(this.constructor.size)return this.constructor.size.concat();var r=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1),h=b||new Float32Array([0,0]),r=Math.max(r,1),f=c.NODE_TEXT_SIZE;h[1]=(this.constructor.slot_start_y||
0)+r*c.NODE_SLOT_HEIGHT;this.widgets&&this.widgets.length&&(h[1]+=this.widgets.length*(c.NODE_WIDGET_HEIGHT+4)+8);var r=e(this.title),k=0,d=0;if(this.inputs)for(var n=0,m=this.inputs.length;n<m;++n){var p=this.inputs[n],p=p.label||p.name||"",p=e(p);k<p&&(k=p)}if(this.outputs)for(n=0,m=this.outputs.length;n<m;++n)p=this.outputs[n],p=p.label||p.name||"",p=e(p),d<p&&(d=p);h[0]=Math.max(k+d+10,r);h[0]=Math.max(h[0],c.NODE_WIDTH);this.widgets&&this.widgets.length&&(h[0]=Math.max(h[0],1.5*c.NODE_WIDTH));
if(this.onResize)this.onResize(h);this.constructor.min_height&&h[1]<this.constructor.min_height&&(h[1]=this.constructor.min_height);h[1]+=6;return h};q.prototype.addWidget=function(a,b,e,c,h){this.widgets||(this.widgets=[]);b={type:a.toLowerCase(),name:b,value:e,callback:c,options:h||{}};void 0!==b.options.y&&(b.y=b.options.y);c||console.warn("LiteGraph addWidget('button',...) without a callback");if("combo"==a&&!b.options.values)throw"LiteGraph addWidget('combo',...) requires to pass values in options: { values:['red','blue'] }";
this.widgets.push(b);return b};q.prototype.addCustomWidget=function(a){this.widgets||(this.widgets=[]);this.widgets.push(a);return a};q.prototype.getBounding=function(a){a=a||new Float32Array(4);a[0]=this.pos[0]-4;a[1]=this.pos[1]-c.NODE_TITLE_HEIGHT;a[2]=this.size[0]+4;a[3]=this.size[1]+c.NODE_TITLE_HEIGHT;if(this.onBounding)this.onBounding(a);return a};q.prototype.isPointInside=function(a,b,e,r){e=e||0;var h=this.graph&&this.graph.isLive()?0:20;r&&(h=0);if(this.flags&&this.flags.collapsed){if(B(a,
b,this.pos[0]-e,this.pos[1]-c.NODE_TITLE_HEIGHT-e,(this._collapsed_width||c.NODE_COLLAPSED_WIDTH)+2*e,c.NODE_TITLE_HEIGHT+2*e))return!0}else if(this.pos[0]-4-e<a&&this.pos[0]+this.size[0]+4+e>a&&this.pos[1]-h-e<b&&this.pos[1]+this.size[1]+e>b)return!0;return!1};q.prototype.getSlotInPosition=function(a,b){var e=new Float32Array(2);if(this.inputs)for(var c=0,h=this.inputs.length;c<h;++c){var f=this.inputs[c];this.getConnectionPos(!0,c,e);if(B(a,b,e[0]-10,e[1]-5,20,10))return{input:f,slot:c,link_pos:e,
locked:f.locked}}if(this.outputs)for(c=0,h=this.outputs.length;c<h;++c)if(f=this.outputs[c],this.getConnectionPos(!1,c,e),B(a,b,e[0]-10,e[1]-5,20,10))return{output:f,slot:c,link_pos:e,locked:f.locked};return null};q.prototype.findInputSlot=function(a){if(!this.inputs)return-1;for(var b=0,e=this.inputs.length;b<e;++b)if(a==this.inputs[b].name)return b;return-1};q.prototype.findOutputSlot=function(a){if(!this.outputs)return-1;for(var b=0,e=this.outputs.length;b<e;++b)if(a==this.outputs[b].name)return b;
return-1};q.prototype.connect=function(a,b,e){e=e||0;if(!this.graph)return console.log("Connect: Error, node doesnt belong to any graph. Nodes must be added first to a graph before connecting them."),null;if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return c.debug&&console.log("Connect: Error, no slot of name "+a),null}else if(!this.outputs||a>=this.outputs.length)return c.debug&&console.log("Connect: Error, slot number not found"),null;b&&b.constructor===Number&&(b=this.graph.getNodeById(b));
...
h.type)){f=new l(this.graph.last_link_id++,h.type,this.id,a,b.id,e);this.graph.links[f.id]=f;null==r.links&&(r.links=[]);r.links.push(f.id);b.inputs[e].link=f.id;this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(c.OUTPUT,a,!0,f,r);if(b.onConnectionsChange)b.onConnectionsChange(c.INPUT,e,!0,f,h);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(c.INPUT,b,e,this,a),this.graph.onNodeConnectionChange(c.OUTPUT,this,a,b,e))}this.setDirtyCanvas(!1,
!0);this.graph.connectionChange(this,f);return f};q.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return c.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return c.debug&&console.log("Connect: Error, slot number not found"),!1;var e=this.outputs[a];if(!e||!e.links||0==e.links.length)return!1;if(b){b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Target Node not found";
for(var r=0,h=e.links.length;r<h;r++){var f=e.links[r],k=this.graph.links[f];if(k.target_id==b.id){e.links.splice(r,1);var d=b.inputs[k.target_slot];d.link=null;delete this.graph.links[f];this.graph&&this.graph._version++;if(b.onConnectionsChange)b.onConnectionsChange(c.INPUT,k.target_slot,!1,k,d);if(this.onConnectionsChange)this.onConnectionsChange(c.OUTPUT,a,!1,k,e);if(this.graph&&this.graph.onNodeConnectionChange)this.graph.onNodeConnectionChange(c.OUTPUT,this,a);this.graph&&this.graph.onNodeConnectionChange&&
(this.graph.onNodeConnectionChange(c.OUTPUT,this,a),this.graph.onNodeConnectionChange(c.INPUT,b,k.target_slot));break}}}else{r=0;for(h=e.links.length;r<h;r++)if(f=e.links[r],k=this.graph.links[f]){b=this.graph.getNodeById(k.target_id);this.graph&&this.graph._version++;if(b){d=b.inputs[k.target_slot];d.link=null;if(b.onConnectionsChange)b.onConnectionsChange(c.INPUT,k.target_slot,!1,k,d);if(this.graph&&this.graph.onNodeConnectionChange)this.graph.onNodeConnectionChange(c.INPUT,b,k.target_slot)}delete this.graph.links[f];
if(this.onConnectionsChange)this.onConnectionsChange(c.OUTPUT,a,!1,k,e);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(c.OUTPUT,this,a),this.graph.onNodeConnectionChange(c.INPUT,b,k.target_slot))}e.links=null}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};q.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return c.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||
a>=this.inputs.length)return c.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var e=this.inputs[a].link;this.inputs[a].link=null;var r=this.graph.links[e];if(r){var h=this.graph.getNodeById(r.origin_id);if(!h)return!1;var f=h.outputs[r.origin_slot];if(!f||!f.links||0==f.links.length)return!1;for(var k=0,d=f.links.length;k<d;k++)if(f.links[k]==e){f.links.splice(k,1);break}delete this.graph.links[e];this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(c.INPUT,
a,!1,r,b);if(h.onConnectionsChange)h.onConnectionsChange(c.OUTPUT,k,!1,r,f);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(c.OUTPUT,h,k),this.graph.onNodeConnectionChange(c.INPUT,this,a))}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};q.prototype.getConnectionPos=function(a,b,e){e=e||new Float32Array(2);var r=0;a&&this.inputs&&(r=this.inputs.length);!a&&this.outputs&&(r=this.outputs.length);var h=0.5*c.NODE_SLOT_HEIGHT;if(this.flags.collapsed)return b=
this._collapsed_width||c.NODE_COLLAPSED_WIDTH,this.horizontal?(e[0]=this.pos[0]+0.5*b,e[1]=a?this.pos[1]-c.NODE_TITLE_HEIGHT:this.pos[1]):(e[0]=a?this.pos[0]:this.pos[0]+b,e[1]=this.pos[1]-0.5*c.NODE_TITLE_HEIGHT),e;if(a&&-1==b)return e[0]=this.pos[0]+0.5*c.NODE_TITLE_HEIGHT,e[1]=this.pos[1]+0.5*c.NODE_TITLE_HEIGHT,e;if(a&&r>b&&this.inputs[b].pos)return e[0]=this.pos[0]+this.inputs[b].pos[0],e[1]=this.pos[1]+this.inputs[b].pos[1],e;if(!a&&r>b&&this.outputs[b].pos)return e[0]=this.pos[0]+this.outputs[b].pos[0],
e[1]=this.pos[1]+this.outputs[b].pos[1],e;if(this.horizontal)return e[0]=this.pos[0]+this.size[0]/r*(b+0.5),e[1]=a?this.pos[1]-c.NODE_TITLE_HEIGHT:this.pos[1]+this.size[1],e;e[0]=a?this.pos[0]+h:this.pos[0]+this.size[0]+1-h;e[1]=this.pos[1]+(b+0.7)*c.NODE_SLOT_HEIGHT+(this.constructor.slot_start_y||0);return e};q.prototype.alignToGrid=function(){this.pos[0]=c.CANVAS_GRID_SIZE*Math.round(this.pos[0]/c.CANVAS_GRID_SIZE);this.pos[1]=c.CANVAS_GRID_SIZE*Math.round(this.pos[1]/c.CANVAS_GRID_SIZE)};q.prototype.trace=
...
Object.defineProperty(this,"size",{set:function(a){!a||2>a.length||(this._size[0]=Math.max(140,a[0]),this._size[1]=Math.max(80,a[1]))},get:function(){return this._size},enumerable:!0})};g.prototype.configure=function(a){this.title=a.title;this._bounding.set(a.bounding);this.color=a.color;this.font=a.font};g.prototype.serialize=function(){var a=this._bounding;return{title:this.title,bounding:[Math.round(a[0]),Math.round(a[1]),Math.round(a[2]),Math.round(a[3])],color:this.color,font:this.font}};g.prototype.move=
function(a,b,e){this._pos[0]+=a;this._pos[1]+=b;if(!e)for(e=0;e<this._nodes.length;++e){var c=this._nodes[e];c.pos[0]+=a;c.pos[1]+=b}};g.prototype.recomputeInsideNodes=function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),e=0;e<a.length;++e){var c=a[e];c.getBounding(b);z(this._bounding,b)&&this._nodes.push(c)}};g.prototype.isPointInside=q.prototype.isPointInside;g.prototype.setDirtyCanvas=q.prototype.setDirtyCanvas;c.DragAndScale=s;s.prototype.bindEvents=function(a){this.last_mouse=
new Float32Array(2);this._binded_mouse_callback=this.onMouse.bind(this);a.addEventListener("mousedown",this._binded_mouse_callback);a.addEventListener("mousemove",this._binded_mouse_callback);a.addEventListener("mousewheel",this._binded_mouse_callback,!1);a.addEventListener("wheel",this._binded_mouse_callback,!1)};s.prototype.computeVisibleArea=function(){if(this.element){var a=-this.offset[0],b=-this.offset[1],e=a+this.element.width/this.scale,c=b+this.element.height/this.scale;this.visible_area[0]=
a;this.visible_area[1]=b;this.visible_area[2]=e-a;this.visible_area[3]=c-b}else this.visible_area[0]=this.visible_area[1]=this.visible_area[2]=this.visible_area[3]=0};s.prototype.onMouse=function(a){if(this.enabled){var b=this.element,e=b.getBoundingClientRect(),c=a.clientX-e.left,e=a.clientY-e.top;a.canvasx=c;a.canvasy=e;a.dragging=this.dragging;var h=!1;this.onmouse&&(h=this.onmouse(a));if("mousedown"==a.type)this.dragging=!0,b.removeEventListener("mousemove",this._binded_mouse_callback),document.body.addEventListener("mousemove",
this._binded_mouse_callback),document.body.addEventListener("mouseup",this._binded_mouse_callback);else if("mousemove"==a.type)h||(b=c-this.last_mouse[0],h=e-this.last_mouse[1],this.dragging&&this.mouseDrag(b,h));else if("mouseup"==a.type)this.dragging=!1,document.body.removeEventListener("mousemove",this._binded_mouse_callback),document.body.removeEventListener("mouseup",this._binded_mouse_callback),b.addEventListener("mousemove",this._binded_mouse_callback);else if("mousewheel"==a.type||"wheel"==
a.type||"DOMMouseScroll"==a.type)a.eventType="mousewheel",a.wheel="wheel"==a.type?-a.deltaY:null!=a.wheelDeltaY?a.wheelDeltaY:-60*a.detail,a.delta=a.wheelDelta?a.wheelDelta/40:a.deltaY?-a.deltaY/3:0,this.changeDeltaScale(1+0.05*a.delta);this.last_mouse[0]=c;this.last_mouse[1]=e;a.preventDefault();a.stopPropagation();return!1}};s.prototype.toCanvasContext=function(a){a.scale(this.scale,this.scale);a.translate(this.offset[0],this.offset[1])};s.prototype.convertOffsetToCanvas=function(a){return[(a[0]+
this.offset[0])*this.scale,(a[1]+this.offset[1])*this.scale]};s.prototype.convertCanvasToOffset=function(a,b){b=b||[0,0];b[0]=a[0]/this.scale-this.offset[0];b[1]=a[1]/this.scale-this.offset[1];return b};s.prototype.mouseDrag=function(a,b){this.offset[0]+=a/this.scale;this.offset[1]+=b/this.scale;if(this.onredraw)this.onredraw(this)};s.prototype.changeScale=function(a,b){a<this.min_scale?a=this.min_scale:a>this.max_scale&&(a=this.max_scale);if(a!=this.scale&&this.element){var e=this.element.getBoundingClientRect();
if(e){b=b||[0.5*e.width,0.5*e.height];e=this.convertCanvasToOffset(b);this.scale=a;0.01>Math.abs(this.scale-1)&&(this.scale=1);var c=this.convertCanvasToOffset(b),e=[c[0]-e[0],c[1]-e[1]];this.offset[0]+=e[0];this.offset[1]+=e[1];if(this.onredraw)this.onredraw(this)}}};s.prototype.changeDeltaScale=function(a,b){this.changeScale(this.scale*a,b)};s.prototype.reset=function(){this.scale=1;this.offset[0]=0;this.offset[1]=0};u.LGraphCanvas=c.LGraphCanvas=m;m.link_type_colors={"-1":c.EVENT_LINK_COLOR,number:"#AAA",
node:"#DCA"};m.gradients={};m.prototype.clear=function(){this.fps=this.render_time=this.last_draw_time=this.frame=0;this.dragging_rectangle=null;this.selected_nodes={};this.selected_group=null;this.visible_nodes=[];this.connecting_node=this.node_capturing_input=this.node_over=this.node_dragged=null;this.highlighted_links={};this.dirty_bgcanvas=this.dirty_canvas=!0;this.node_widget=this.node_in_panel=this.dirty_area=null;this.last_mouse=[0,0];this.last_mouseclick=0;this.visible_area.set([0,0,0,0]);
if(this.onClear)this.onClear()};m.prototype.setGraph=function(a,b){this.graph!=a&&(b||this.clear(),!a&&this.graph?this.graph.detachCanvas(this):(a.attachCanvas(this),this.setDirty(!0,!0)))};m.prototype.openSubgraph=function(a){if(!a)throw"graph cannot be null";if(this.graph==a)throw"graph cannot be the same";this.clear();this.graph&&(this._graph_stack||(this._graph_stack=[]),this._graph_stack.push(this.graph));a.attachCanvas(this);this.setDirty(!0,!0)};m.prototype.closeSubgraph=function(){if(this._graph_stack&&
0!=this._graph_stack.length){var a=this.graph._subgraph_node,b=this._graph_stack.pop();this.selected_nodes={};this.highlighted_links={};b.attachCanvas(this);this.setDirty(!0,!0);a&&(this.centerOnNode(a),this.selectNodes([a]))}};m.prototype.setCanvas=function(a,b){if(a&&a.constructor===String&&(a=document.getElementById(a),!a))throw"Error creating LiteGraph canvas: Canvas not found";if(a!==this.canvas&&(!a&&this.canvas&&(b||this.unbindEvents()),this.canvas=a,this.ds.element=a)){a.className+=" lgraphcanvas";
a.data=this;a.tabindex="1";this.bgcanvas=null;this.bgcanvas||(this.bgcanvas=document.createElement("canvas"),this.bgcanvas.width=this.canvas.width,this.bgcanvas.height=this.canvas.height);if(null==a.getContext){if("canvas"!=a.localName)throw"Element supplied for LGraphCanvas must be a <canvas> element, you passed a "+a.localName;throw"This browser doesnt support Canvas";}null==(this.ctx=a.getContext("2d"))&&(a.webgl_enabled||console.warn("This canvas seems to be WebGL, enabling WebGL renderer"),this.enableWebGL());
this._mousemove_callback=this.processMouseMove.bind(this);this._mouseup_callback=this.processMouseUp.bind(this);b||this.bindEvents()}};m.prototype._doNothing=function(a){a.preventDefault();return!1};m.prototype._doReturnTrue=function(a){a.preventDefault();return!0};m.prototype.bindEvents=function(){if(this._events_binded)console.warn("LGraphCanvas: events already binded");else{var a=this.canvas,b=this.getCanvasWindow().document;this._mousedown_callback=this.processMouseDown.bind(this);this._mousewheel_callback=
this.processMouseWheel.bind(this);a.addEventListener("mousedown",this._mousedown_callback,!0);a.addEventListener("mousemove",this._mousemove_callback);a.addEventListener("mousewheel",this._mousewheel_callback,!1);a.addEventListener("contextmenu",this._doNothing);a.addEventListener("DOMMouseScroll",this._mousewheel_callback,!1);a.addEventListener("touchstart",this.touchHandler,!0);a.addEventListener("touchmove",this.touchHandler,!0);a.addEventListener("touchend",this.touchHandler,!0);a.addEventListener("touchcancel",
this.touchHandler,!0);this._key_callback=this.processKey.bind(this);a.addEventListener("keydown",this._key_callback,!0);b.addEventListener("keyup",this._key_callback,!0);this._ondrop_callback=this.processDrop.bind(this);a.addEventListener("dragover",this._doNothing,!1);a.addEventListener("dragend",this._doNothing,!1);a.addEventListener("drop",this._ondrop_callback,!1);a.addEventListener("dragenter",this._doReturnTrue,!1);this._events_binded=!0}};m.prototype.unbindEvents=function(){if(this._events_binded){var a=
...
this._doReturnTrue);this.canvas.removeEventListener("touchstart",this.touchHandler);this.canvas.removeEventListener("touchmove",this.touchHandler);this.canvas.removeEventListener("touchend",this.touchHandler);this.canvas.removeEventListener("touchcancel",this.touchHandler);this._ondrop_callback=this._key_callback=this._mousewheel_callback=this._mousedown_callback=null;this._events_binded=!1}else console.warn("LGraphCanvas: no events binded")};m.getFileExtension=function(a){var b=a.indexOf("?");-1!=
b&&(a=a.substr(0,b));b=a.lastIndexOf(".");return-1==b?"":a.substr(b+1).toLowerCase()};m.prototype.enableWebGL=function(){if(void 0===typeof GL)throw"litegl.js must be included to use a WebGL canvas";if(void 0===typeof enableWebGLCanvas)throw"webglCanvas.js must be included to use this feature";this.gl=this.ctx=enableWebGLCanvas(this.canvas);this.ctx.webgl=!0;this.bgcanvas=this.canvas;this.bgctx=this.gl;this.canvas.webgl_enabled=!0};m.prototype.setDirty=function(a,b){a&&(this.dirty_canvas=!0);b&&(this.dirty_bgcanvas=
...
a.which){a.ctrlKey&&(this.dragging_rectangle=new Float32Array(4),this.dragging_rectangle[0]=a.canvasX,this.dragging_rectangle[1]=a.canvasY,this.dragging_rectangle[2]=1,this.dragging_rectangle[3]=1,f=!0);var k=!1;if(e&&this.allow_interaction&&!f){this.live_mode||e.flags.pinned||this.bringToFront(e);if(!this.connecting_node&&!e.flags.collapsed&&!this.live_mode)if(!f&&!1!==e.resizable&&B(a.canvasX,a.canvasY,e.pos[0]+e.size[0]-5,e.pos[1]+e.size[1]-5,10,10))this.resizing_node=e,this.canvas.style.cursor=
"se-resize",f=!0;else{if(e.outputs)for(var d=0,n=e.outputs.length;d<n;++d){var t=e.outputs[d],g=e.getConnectionPos(!1,d);if(B(a.canvasX,a.canvasY,g[0]-15,g[1]-10,30,20)){this.connecting_node=e;this.connecting_output=t;this.connecting_pos=e.getConnectionPos(!1,d);this.connecting_slot=d;a.shiftKey&&e.disconnectOutput(d);if(h){if(e.onOutputDblClick)e.onOutputDblClick(d,a)}else if(e.onOutputClick)e.onOutputClick(d,a);f=!0;break}}if(e.inputs)for(d=0,n=e.inputs.length;d<n;++d)if(t=e.inputs[d],g=e.getConnectionPos(!0,
d),B(a.canvasX,a.canvasY,g[0]-15,g[1]-10,30,20)){if(h){if(e.onInputDblClick)e.onInputDblClick(d,a)}else if(e.onInputClick)e.onInputClick(d,a);if(null!==t.link){f=this.graph.links[t.link];e.disconnectInput(d);if(this.allow_reconnect_links||a.shiftKey)this.connecting_node=this.graph._nodes_by_id[f.origin_id],this.connecting_slot=f.origin_slot,this.connecting_output=this.connecting_node.outputs[this.connecting_slot],this.connecting_pos=this.connecting_node.getConnectionPos(!1,this.connecting_slot);f=
this.dirty_bgcanvas=!0}}}if(!f){d=!1;if(n=this.processNodeWidgets(e,this.canvas_mouse,a))d=!0,this.node_widget=[e,n];if(h&&this.selected_nodes[e.id]){if(e.onDblClick)e.onDblClick(a,[a.canvasX-e.pos[0],a.canvasY-e.pos[1]],this);this.processNodeDblClicked(e);d=!0}e.onMouseDown&&e.onMouseDown(a,[a.canvasX-e.pos[0],a.canvasY-e.pos[1]],this)?d=!0:this.live_mode&&(d=k=!0);d||(this.allow_dragnodes&&(this.node_dragged=e),this.selected_nodes[e.id]||this.processNodeSelected(e,a));this.dirty_canvas=!0}}else{for(d=
0;d<this.visible_links.length;++d)if(e=this.visible_links[d],(k=e._pos)&&!(a.canvasX<k[0]-4||a.canvasX>k[0]+4||a.canvasY<k[1]-4||a.canvasY>k[1]+4)){this.showLinkMenu(e,a);break}this.selected_group=this.graph.getGroupOnPos(a.canvasX,a.canvasY);this.selected_group_resizing=!1;this.selected_group&&(a.ctrlKey&&(this.dragging_rectangle=null),10>w([a.canvasX,a.canvasY],[this.selected_group.pos[0]+this.selected_group.size[0],this.selected_group.pos[1]+this.selected_group.size[1]])*this.ds.scale?this.selected_group_resizing=
!0:this.selected_group.recomputeInsideNodes());h&&this.showSearchBox(a);k=!0}!f&&k&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&this.processContextMenu(e,a);this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=c.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&a.preventDefault();a.stopPropagation();
...
e[0]/this.ds.scale,this.ds.offset[1]+=e[1]/this.ds.scale,this.dirty_bgcanvas=this.dirty_canvas=!0;else if(this.allow_interaction){this.connecting_node&&(this.dirty_canvas=!0);for(var f=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes),b=0,h=this.graph._nodes.length;b<h;++b)if(this.graph._nodes[b].mouseOver&&f!=this.graph._nodes[b]){this.graph._nodes[b].mouseOver=!1;if(this.node_over&&this.node_over.onMouseLeave)this.node_over.onMouseLeave(a);this.node_over=null;this.dirty_canvas=!0}if(f){if(!f.mouseOver&&
(f.mouseOver=!0,this.node_over=f,this.dirty_canvas=!0,f.onMouseEnter))f.onMouseEnter(a);if(f.onMouseMove)f.onMouseMove(a,[a.canvasX-f.pos[0],a.canvasY-f.pos[1]],this);if(this.connecting_node&&(h=this._highlight_input||[0,0],!this.isOverNodeBox(f,a.canvasX,a.canvasY))){var k=this.isOverNodeInput(f,a.canvasX,a.canvasY,h);-1!=k&&f.inputs[k]?c.isValidConnection(this.connecting_output.type,f.inputs[k].type)&&(this._highlight_input=h):this._highlight_input=null}this.canvas&&(B(a.canvasX,a.canvasY,f.pos[0]+
f.size[0]-5,f.pos[1]+f.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor="crosshair")}else this.canvas&&(this.canvas.style.cursor="");if(this.node_capturing_input&&this.node_capturing_input!=f&&this.node_capturing_input.onMouseMove)this.node_capturing_input.onMouseMove(a);if(this.node_dragged&&!this.live_mode){for(b in this.selected_nodes)f=this.selected_nodes[b],f.pos[0]+=e[0]/this.ds.scale,f.pos[1]+=e[1]/this.ds.scale;this.dirty_bgcanvas=this.dirty_canvas=!0}this.resizing_node&&
!this.live_mode&&(this.resizing_node.size[0]=a.canvasX-this.resizing_node.pos[0],this.resizing_node.size[1]=a.canvasY-this.resizing_node.pos[1],e=Math.max(this.resizing_node.inputs?this.resizing_node.inputs.length:0,this.resizing_node.outputs?this.resizing_node.outputs.length:0)*c.NODE_SLOT_HEIGHT+(this.resizing_node.widgets?this.resizing_node.widgets.length:0)*(c.NODE_WIDGET_HEIGHT+4)+4,this.resizing_node.size[1]<e&&(this.resizing_node.size[1]=e),this.resizing_node.size[0]<c.NODE_MIN_WIDTH&&(this.resizing_node.size[0]=
c.NODE_MIN_WIDTH),this.canvas.style.cursor="se-resize",this.dirty_bgcanvas=this.dirty_canvas=!0)}a.preventDefault();return!1}};m.prototype.processMouseUp=function(a){if(this.graph){var b=this.getCanvasWindow().document;m.active_canvas=this;b.removeEventListener("mousemove",this._mousemove_callback,!0);this.canvas.addEventListener("mousemove",this._mousemove_callback,!0);b.removeEventListener("mouseup",this._mouseup_callback,!0);this.adjustMouseEvent(a);b=c.getTime();a.click_time=b-this.last_mouseclick;
this.last_mouse_dragging=!1;if(1==a.which){this.node_widget=null;if(this.selected_group){var b=this.selected_group.pos[0]-Math.round(this.selected_group.pos[0]),e=this.selected_group.pos[1]-Math.round(this.selected_group.pos[1]);this.selected_group.move(b,e,a.ctrlKey);this.selected_group.pos[0]=Math.round(this.selected_group.pos[0]);this.selected_group.pos[1]=Math.round(this.selected_group.pos[1]);this.selected_group._nodes.length&&(this.dirty_canvas=!0);this.selected_group=null}this.selected_group_resizing=
!1;if(this.dragging_rectangle){if(this.graph){b=this.graph._nodes;e=new Float32Array(4);this.deselectAllNodes();var f=Math.abs(this.dragging_rectangle[2]),h=Math.abs(this.dragging_rectangle[3]),k=0>this.dragging_rectangle[3]?this.dragging_rectangle[1]-h:this.dragging_rectangle[1];this.dragging_rectangle[0]=0>this.dragging_rectangle[2]?this.dragging_rectangle[0]-f:this.dragging_rectangle[0];this.dragging_rectangle[1]=k;this.dragging_rectangle[2]=f;this.dragging_rectangle[3]=h;h=[];for(k=0;k<b.length;++k)f=
b[k],f.getBounding(e),z(this.dragging_rectangle,e)&&h.push(f);h.length&&this.selectNodes(h)}this.dragging_rectangle=null}else if(this.connecting_node){this.dirty_bgcanvas=this.dirty_canvas=!0;if(f=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes))this.connecting_output.type==c.EVENT&&this.isOverNodeBox(f,a.canvasX,a.canvasY)?this.connecting_node.connect(this.connecting_slot,f,c.EVENT):(b=this.isOverNodeInput(f,a.canvasX,a.canvasY),-1!=b?this.connecting_node.connect(this.connecting_slot,
f,b):(b=f.getInputInfo(0),this.connecting_output.type==c.EVENT?this.connecting_node.connect(this.connecting_slot,f,c.EVENT):b&&!b.link&&c.isValidConnection(b.type&&this.connecting_output.type)&&this.connecting_node.connect(this.connecting_slot,f,0)));this.connecting_node=this.connecting_pos=this.connecting_output=null;this.connecting_slot=-1}else if(this.resizing_node)this.dirty_bgcanvas=this.dirty_canvas=!0,this.resizing_node=null;else if(this.node_dragged)(f=this.node_dragged)&&300>a.click_time&&
B(a.canvasX,a.canvasY,f.pos[0],f.pos[1]-c.NODE_TITLE_HEIGHT,c.NODE_TITLE_HEIGHT,c.NODE_TITLE_HEIGHT)&&f.collapse(),this.dirty_bgcanvas=this.dirty_canvas=!0,this.node_dragged.pos[0]=Math.round(this.node_dragged.pos[0]),this.node_dragged.pos[1]=Math.round(this.node_dragged.pos[1]),this.graph.config.align_to_grid&&this.node_dragged.alignToGrid(),this.node_dragged=null;else{f=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes);!f&&300>a.click_time&&this.deselectAllNodes();this.dirty_canvas=
...
a.stopPropagation();a.preventDefault();return!1}};m.prototype.processMouseWheel=function(a){if(this.graph&&this.allow_dragcanvas){var b=null!=a.wheelDeltaY?a.wheelDeltaY:-60*a.detail;this.adjustMouseEvent(a);var e=this.ds.scale;0<b?e*=1.1:0>b&&(e*=1/1.1);this.ds.changeScale(e,[a.localX,a.localY]);this.graph.change();a.preventDefault();return!1}};m.prototype.isOverNodeBox=function(a,b,e){var f=c.NODE_TITLE_HEIGHT;return B(b,e,a.pos[0]+2,a.pos[1]+2-f,f-4,f-4)?!0:!1};m.prototype.isOverNodeInput=function(a,
b,e,c){if(a.inputs)for(var h=0,f=a.inputs.length;h<f;++h){var k=a.getConnectionPos(!0,h),d=!1;if(d=a.horizontal?B(b,e,k[0]-5,k[1]-10,10,20):B(b,e,k[0]-10,k[1]-5,40,10))return c&&(c[0]=k[0],c[1]=k[1]),h}return-1};m.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==a.keyCode&&(b=this.dragging_canvas=!0),65==a.keyCode&&a.ctrlKey&&(this.selectNodes(),b=!0),"KeyC"==a.code&&(a.metaKey||a.ctrlKey)&&!a.shiftKey&&this.selected_nodes&&(this.copyToClipboard(),
b=!0),"KeyV"!=a.code||!a.metaKey&&!a.ctrlKey||a.shiftKey||this.pasteFromClipboard(),46!=a.keyCode&&8!=a.keyCode||"input"==a.target.localName||"textarea"==a.target.localName||(this.deleteSelectedNodes(),b=!0),this.selected_nodes)for(var e in this.selected_nodes)if(this.selected_nodes[e].onKeyDown)this.selected_nodes[e].onKeyDown(a)}else if("keyup"==a.type&&(32==a.keyCode&&(this.dragging_canvas=!1),this.selected_nodes))for(e in this.selected_nodes)if(this.selected_nodes[e].onKeyUp)this.selected_nodes[e].onKeyUp(a);
this.graph.change();if(b)return a.preventDefault(),a.stopImmediatePropagation(),!1}}};m.prototype.copyToClipboard=function(){var a={nodes:[],links:[]},b=0,e=[],c;for(c in this.selected_nodes){var h=this.selected_nodes[c];h._relative_id=b;e.push(h);b+=1}for(c=0;c<e.length;++c)if(h=e[c],a.nodes.push(h.clone().serialize()),h.inputs&&h.inputs.length)for(b=0;b<h.inputs.length;++b){var f=h.inputs[b];if(f&&null!=f.link&&(f=this.graph.links[f.link])){var k=this.graph.getNodeById(f.origin_id);k&&this.selected_nodes[k.id]&&
a.links.push([k._relative_id,b,h._relative_id,f.target_slot])}}localStorage.setItem("litegrapheditor_clipboard",JSON.stringify(a))};m.prototype.pasteFromClipboard=function(){var a=localStorage.getItem("litegrapheditor_clipboard");if(a){for(var a=JSON.parse(a),b=[],e=0;e<a.nodes.length;++e){var f=a.nodes[e],h=c.createNode(f.type);h&&(h.configure(f),h.pos[0]+=5,h.pos[1]+=5,this.graph.add(h),b.push(h))}for(e=0;e<a.links.length;++e)f=a.links[e],b[f[0]].connect(f[1],b[f[2]],f[3]);this.selectNodes(b)}};
m.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=[a.canvasX,a.canvasY],e=this.graph.getNodeOnPos(b[0],b[1]);if(e){if((e.onDropFile||e.onDropData)&&(b=a.dataTransfer.files)&&b.length)for(var c=0;c<b.length;c++){var h=a.dataTransfer.files[0],f=h.name;m.getFileExtension(f);if(e.onDropFile)e.onDropFile(h);if(e.onDropData){var k=new FileReader;k.onload=function(a){e.onDropData(a.target.result,f,h)};var d=h.type.split("/")[0];"text"==d||""==d?k.readAsText(h):"image"==
d?k.readAsDataURL(h):k.readAsArrayBuffer(h)}}return e.onDropItem&&e.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;this.onDropItem&&(b=this.onDropItem(event));b||this.checkDropItem(a)};m.prototype.checkDropItem=function(a){if(a.dataTransfer.files.length){var b=a.dataTransfer.files[0],e=m.getFileExtension(b.name).toLowerCase();if(e=c.node_types_by_file_extension[e])if(e=c.createNode(e.type),e.pos=[a.canvasX,a.canvasY],this.graph.add(e),e.onDropFile)e.onDropFile(b)}};m.prototype.processNodeDblClicked=
...
b){b||this.deselectAllNodes();a=a||this.graph._nodes;for(var e=0;e<a.length;++e){var c=a[e];if(!c.is_selected){if(!c.is_selected&&c.onSelected)c.onSelected();c.is_selected=!0;this.selected_nodes[c.id]=c;if(c.inputs)for(var h=0;h<c.inputs.length;++h)this.highlighted_links[c.inputs[h].link]=!0;if(c.outputs)for(h=0;h<c.outputs.length;++h){var f=c.outputs[h];if(f.links)for(var k=0;k<f.links.length;++k)this.highlighted_links[f.links[k]]=!0}}}this.setDirty(!0)};m.prototype.deselectNode=function(a){if(a.is_selected){if(a.onDeselected)a.onDeselected();
...
-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.unshift(a))};var x=new Float32Array(4);m.prototype.computeVisibleNodes=function(a,b){var e=b||[];e.length=0;a=a||this.graph._nodes;for(var c=0,h=a.length;c<h;++c){var f=a[c];(!this.live_mode||f.onDrawBackground||f.onDrawForeground)&&z(this.visible_area,f.getBounding(x))&&e.push(f)}return e};m.prototype.draw=function(a,b){if(this.canvas){var e=c.getTime();this.render_time=0.001*(e-this.last_draw_time);this.last_draw_time=e;this.graph&&this.ds.computeVisibleArea();
...
c.NODE_DEFAULT_COLOR,f=a.bgcolor||a.constructor.bgcolor||c.NODE_DEFAULT_BGCOLOR;if(this.live_mode){if(!a.flags.collapsed&&(b.shadowColor="transparent",a.onDrawForeground))a.onDrawForeground(b,this,this.canvas)}else{var h=this.editor_alpha;b.globalAlpha=h;this.render_shadows?(b.shadowColor=c.DEFAULT_SHADOW_COLOR,b.shadowOffsetX=2*this.ds.scale,b.shadowOffsetY=2*this.ds.scale,b.shadowBlur=3*this.ds.scale):b.shadowColor="transparent";if(!a.flags.collapsed||!a.onDrawCollaped||!0!=a.onDrawCollapsed(b,
this)){var k=a._shape||c.BOX_SHAPE;n.set(a.size);var d=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var m=a.getTitle?a.getTitle():a.title;null!=m&&(a._collapsed_width=Math.min(a.size[0],b.measureText(m).width+2*c.NODE_TITLE_HEIGHT),n[0]=a._collapsed_width,n[1]=0)}a.clip_area&&(b.save(),b.beginPath(),k==c.BOX_SHAPE?b.rect(0,0,n[0],n[1]):k==c.ROUND_SHAPE?b.roundRect(0,0,n[0],n[1],10):k==c.CIRCLE_SHAPE&&b.arc(0.5*n[0],0.5*n[1],0.5*n[0],0,2*Math.PI),b.clip());a.has_errors&&(f="red");
this.drawNodeShape(a,b,n,e,f,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=d?"center":"left";b.font=this.inner_text_font;f=0.6<this.ds.scale;k=this.connecting_output;b.lineWidth=1;var m=0,t=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(e=0;e<a.inputs.length;e++){var g=a.inputs[e];b.globalAlpha=h;this.connecting_node&&c.isValidConnection(g.type&&k.type)&&(b.globalAlpha=0.4*h);b.fillStyle=null!=g.link?g.color_on||
this.default_connection_color.input_on:g.color_off||this.default_connection_color.input_off;var p=a.getConnectionPos(!0,e,t);p[0]-=a.pos[0];p[1]-=a.pos[1];m<p[1]+0.5*c.NODE_SLOT_HEIGHT&&(m=p[1]+0.5*c.NODE_SLOT_HEIGHT);b.beginPath();g.type===c.EVENT||g.shape===c.BOX_SHAPE?d?b.rect(p[0]-5+0.5,p[1]-8+0.5,10,14):b.rect(p[0]-6+0.5,p[1]-5+0.5,14,10):g.shape===c.ARROW_SHAPE?(b.moveTo(p[0]+8,p[1]+0.5),b.lineTo(p[0]-4,p[1]+6+0.5),b.lineTo(p[0]-4,p[1]-6+0.5),b.closePath()):b.arc(p[0],p[1],4,0,2*Math.PI);b.fill();
if(f){var C=null!=g.label?g.label:g.name;C&&(b.fillStyle=c.NODE_TEXT_COLOR,d||g.dir==c.UP?b.fillText(C,p[0],p[1]-10):b.fillText(C,p[0]+10,p[1]+5))}}this.connecting_node&&(b.globalAlpha=0.4*h);b.textAlign=d?"center":"right";b.strokeStyle="black";if(a.outputs)for(e=0;e<a.outputs.length;e++)if(g=a.outputs[e],p=a.getConnectionPos(!1,e,t),p[0]-=a.pos[0],p[1]-=a.pos[1],m<p[1]+0.5*c.NODE_SLOT_HEIGHT&&(m=p[1]+0.5*c.NODE_SLOT_HEIGHT),b.fillStyle=g.links&&g.links.length?g.color_on||this.default_connection_color.output_on:
g.color_off||this.default_connection_color.output_off,b.beginPath(),g.type===c.EVENT||g.shape===c.BOX_SHAPE?d?b.rect(p[0]-5+0.5,p[1]-8+0.5,10,14):b.rect(p[0]-6+0.5,p[1]-5+0.5,14,10):g.shape===c.ARROW_SHAPE?(b.moveTo(p[0]+8,p[1]+0.5),b.lineTo(p[0]-4,p[1]+6+0.5),b.lineTo(p[0]-4,p[1]-6+0.5),b.closePath()):b.arc(p[0],p[1],4,0,2*Math.PI),b.fill(),b.stroke(),f&&(C=null!=g.label?g.label:g.name))b.fillStyle=c.NODE_TEXT_COLOR,d||g.dir==c.DOWN?b.fillText(C,p[0],p[1]-8):b.fillText(C,p[0]-10,p[1]+5);b.textAlign=
"left";b.globalAlpha=1;if(a.widgets){if(d||a.widgets_up)m=2;this.drawNodeWidgets(a,m,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){h=f=null;if(a.inputs)for(e=0;e<a.inputs.length;e++)if(g=a.inputs[e],null!=g.link){f=g;break}if(a.outputs)for(e=0;e<a.outputs.length;e++)g=a.outputs[e],g.links&&g.links.length&&(h=g);f&&(e=0,f=-0.5*c.NODE_TITLE_HEIGHT,d&&(e=0.5*a._collapsed_width,f=-c.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),g.type===
c.EVENT||g.shape===c.BOX_SHAPE?b.rect(e-7+0.5,f-4,14,8):g.shape===c.ARROW_SHAPE?(b.moveTo(e+8,f),b.lineTo(e+-4,f-4),b.lineTo(e+-4,f+4),b.closePath()):b.arc(e,f,4,0,2*Math.PI),b.fill());h&&(e=a._collapsed_width,f=-0.5*c.NODE_TITLE_HEIGHT,d&&(e=0.5*a._collapsed_width,f=0),b.fillStyle="#686",b.strokeStyle="black",b.beginPath(),g.type===c.EVENT||g.shape===c.BOX_SHAPE?b.rect(e-7+0.5,f-4,14,8):g.shape===c.ARROW_SHAPE?(b.moveTo(e+6,f),b.lineTo(e-6,f-4),b.lineTo(e-6,f+4),b.closePath()):b.arc(e,f,4,0,2*Math.PI),
b.fill())}a.clip_area&&b.restore();b.globalAlpha=1}}};var f=new Float32Array(4);m.prototype.drawNodeShape=function(a,b,e,k,h,d,n){b.strokeStyle=k;b.fillStyle=h;h=c.NODE_TITLE_HEIGHT;var g=0.5>this.ds.scale,t=a._shape||a.constructor.shape||c.ROUND_SHAPE,l=a.constructor.title_mode,p=!0;l==c.TRANSPARENT_TITLE?p=!1:l==c.AUTOHIDE_TITLE&&n&&(p=!0);f[0]=0;f[1]=p?-h:0;f[2]=e[0]+1;f[3]=p?e[1]+h:e[1];n=b.globalAlpha;b.beginPath();t==c.BOX_SHAPE||g?b.fillRect(f[0],f[1],f[2],f[3]):t==c.ROUND_SHAPE||t==c.CARD_SHAPE?
b.roundRect(f[0],f[1],f[2],f[3],this.round_radius,t==c.CARD_SHAPE?0:this.round_radius):t==c.CIRCLE_SHAPE&&b.arc(0.5*e[0],0.5*e[1],0.5*e[0],0,2*Math.PI);b.fill();b.shadowColor="transparent";b.fillStyle="rgba(0,0,0,0.2)";b.fillRect(0,-1,f[2],2);b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas);if(p||l==c.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,h,e,this.ds.scale,k);else if(l!=c.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){p=
a.constructor.title_color||k;a.flags.collapsed&&(b.shadowColor=c.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var C=m.gradients[p];C||(C=m.gradients[p]=b.createLinearGradient(0,0,400,0),C.addColorStop(0,p),C.addColorStop(1,"#000"));b.fillStyle=C}else b.fillStyle=p;b.beginPath();t==c.BOX_SHAPE||g?b.rect(0,-h,e[0]+1,h):t!=c.ROUND_SHAPE&&t!=c.CARD_SHAPE||b.roundRect(0,-h,e[0]+1,h,this.round_radius,a.flags.collapsed?this.round_radius:0);b.fill();b.shadowColor="transparent"}if(a.onDrawTitleBox)a.onDrawTitleBox(b,
h,e,this.ds.scale);else t==c.ROUND_SHAPE||t==c.CIRCLE_SHAPE||t==c.CARD_SHAPE?(g&&(b.fillStyle="black",b.beginPath(),b.arc(0.5*h,-0.5*h,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||c.NODE_DEFAULT_BOXCOLOR,b.beginPath(),b.arc(0.5*h,-0.5*h,5,0,2*Math.PI),b.fill()):(g&&(b.fillStyle="black",b.fillRect(0.5*(h-10)-1,-0.5*(h+10)-1,12,12)),b.fillStyle=a.boxcolor||c.NODE_DEFAULT_BOXCOLOR,b.fillRect(0.5*(h-10),-0.5*(h+10),10,10));b.globalAlpha=n;if(a.onDrawTitleText)a.onDrawTitleText(b,h,e,this.ds.scale,
this.title_text_font,d);!g&&(b.font=this.title_text_font,g=a.getTitle())&&(b.fillStyle=d?"white":a.constructor.title_text_color||this.node_title_color,a.flags.collapsed?(b.textAlign="center",n=b.measureText(g),b.fillText(g,h+0.5*n.width,c.NODE_TITLE_TEXT_Y-h),b.textAlign="left"):(b.textAlign="left",b.fillText(g,h,c.NODE_TITLE_TEXT_Y-h)));if(a.onDrawTitle)a.onDrawTitle(b)}if(d){if(a.onBounding)a.onBounding(f);l==c.TRANSPARENT_TITLE&&(f[1]-=h,f[3]+=h);b.lineWidth=1;b.globalAlpha=0.8;b.beginPath();t==
c.BOX_SHAPE?b.rect(-6+f[0],-6+f[1],12+f[2],12+f[3]):t==c.ROUND_SHAPE||t==c.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+f[0],-6+f[1],12+f[2],12+f[3],2*this.round_radius):t==c.CARD_SHAPE?b.roundRect(-6+f[0],-6+f[1],12+f[2],12+f[3],2*this.round_radius,2):t==c.CIRCLE_SHAPE&&b.arc(0.5*e[0],0.5*e[1],0.5*e[0]+6,0,2*Math.PI);b.strokeStyle="#FFF";b.stroke();b.strokeStyle=k;b.globalAlpha=1}};var A=new Float32Array(4),k=new Float32Array(4),t=new Float32Array(2),v=new Float32Array(2);m.prototype.drawConnections=
function(a){var b=c.getTime(),e=this.visible_area;A[0]=e[0]-20;A[1]=e[1]-20;A[2]=e[2]+40;A[3]=e[3]+40;a.lineWidth=this.connections_width;a.fillStyle="#AAA";a.strokeStyle="#AAA";a.globalAlpha=this.editor_alpha;for(var e=this.graph._nodes,f=0,h=e.length;f<h;++f){var d=e[f];if(d.inputs&&d.inputs.length)for(var n=0;n<d.inputs.length;++n){var m=d.inputs[n];if(m&&null!=m.link&&(m=this.graph.links[m.link])){var g=this.graph.getNodeById(m.origin_id);if(null!=g){var l=m.origin_slot,p=null,p=-1==l?[g.pos[0]+
10,g.pos[1]+10]:g.getConnectionPos(!1,l,t),C=d.getConnectionPos(!0,n,v);k[0]=p[0];k[1]=p[1];k[2]=C[0]-p[0];k[3]=C[1]-p[1];0>k[2]&&(k[0]+=k[2],k[2]=Math.abs(k[2]));0>k[3]&&(k[1]+=k[3],k[3]=Math.abs(k[3]));if(z(k,A)){var D=g.outputs[l],l=d.inputs[n];if(D&&l&&(g=D.dir||(g.horizontal?c.DOWN:c.RIGHT),l=l.dir||(d.horizontal?c.UP:c.LEFT),this.renderLink(a,p,C,m,!1,0,null,g,l),m&&m._last_time&&1E3>b-m._last_time)){var D=2-0.002*(b-m._last_time),E=a.globalAlpha;a.globalAlpha=E*D;this.renderLink(a,p,C,m,!0,
D,"white",g,l);a.globalAlpha=E}}}}}}a.globalAlpha=1};m.prototype.renderLink=function(a,b,e,f,h,k,d,n,g,t){f&&this.visible_links.push(f);!d&&f&&(d=f.color||m.link_type_colors[f.type]);d||(d=this.default_link_color);null!=f&&this.highlighted_links[f.id]&&(d="#FFF");n=n||c.RIGHT;g=g||c.LEFT;var p=w(b,e);this.render_connections_border&&0.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";t=t||1;1<t&&(a.lineWidth=0.5);a.beginPath();for(var C=0;C<t;C+=1){var D=5*(C-0.5*(t-1));if(this.links_render_mode==
c.SPLINE_LINK){a.moveTo(b[0],b[1]+D);var E=0,l=0,q=0,A=0;switch(n){case c.LEFT:E=-0.25*p;break;case c.RIGHT:E=0.25*p;break;case c.UP:l=-0.25*p;break;case c.DOWN:l=0.25*p}switch(g){case c.LEFT:q=-0.25*p;break;case c.RIGHT:q=0.25*p;break;case c.UP:A=-0.25*p;break;case c.DOWN:A=0.25*p}a.bezierCurveTo(b[0]+E,b[1]+l+D,e[0]+q,e[1]+A+D,e[0],e[1]+D)}else if(this.links_render_mode==c.LINEAR_LINK){a.moveTo(b[0],b[1]+D);A=q=l=E=0;switch(n){case c.LEFT:E=-1;break;case c.RIGHT:E=1;break;case c.UP:l=-1;break;case c.DOWN:l=
1}switch(g){case c.LEFT:q=-1;break;case c.RIGHT:q=1;break;case c.UP:A=-1;break;case c.DOWN:A=1}a.lineTo(b[0]+15*E,b[1]+15*l+D);a.lineTo(e[0]+15*q,e[1]+15*A+D);a.lineTo(e[0],e[1]+D)}else if(this.links_render_mode==c.STRAIGHT_LINK)a.moveTo(b[0],b[1]),D=b[0],E=b[1],l=e[0],q=e[1],n==c.RIGHT?D+=10:E+=10,g==c.LEFT?l-=10:q-=10,a.lineTo(D,E),a.lineTo(0.5*(D+l),E),a.lineTo(0.5*(D+l),q),a.lineTo(l,q),a.lineTo(e[0],e[1]);else return}this.render_connections_border&&0.6<this.ds.scale&&!h&&(a.strokeStyle="rgba(0,0,0,0.5)",
a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=d;a.stroke();h=this.computeConnectionPoint(b,e,0.5,n,g);f&&f._pos&&(f._pos[0]=h[0],f._pos[1]=h[1]);0.6<=this.ds.scale&&this.highquality_render&&g!=c.CENTER&&(this.render_connection_arrows&&(C=this.computeConnectionPoint(b,e,0.25,n,g),f=this.computeConnectionPoint(b,e,0.26,n,g),t=this.computeConnectionPoint(b,e,0.75,n,g),p=this.computeConnectionPoint(b,e,0.76,n,g),E=D=0,this.render_curved_connections?(D=-Math.atan2(f[0]-C[0],
f[1]-C[1]),E=-Math.atan2(p[0]-t[0],p[1]-t[1])):E=D=e[1]>b[1]?0:Math.PI,a.save(),a.translate(C[0],C[1]),a.rotate(D),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(t[0],t[1]),a.rotate(E),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(h[0],h[1],5,0,2*Math.PI),a.fill());if(k)for(a.fillStyle=d,C=0;5>C;++C)k=(0.001*c.getTime()+0.2*C)%1,h=this.computeConnectionPoint(b,e,k,n,g),a.beginPath(),a.arc(h[0],
h[1],5,0,2*Math.PI),a.fill()};m.prototype.computeConnectionPoint=function(a,b,e,f,h){f=f||c.RIGHT;h=h||c.LEFT;var k=w(a,b),d=[a[0],a[1]],n=[b[0],b[1]];switch(f){case c.LEFT:d[0]+=-0.25*k;break;case c.RIGHT:d[0]+=0.25*k;break;case c.UP:d[1]+=-0.25*k;break;case c.DOWN:d[1]+=0.25*k}switch(h){case c.LEFT:n[0]+=-0.25*k;break;case c.RIGHT:n[0]+=0.25*k;break;case c.UP:n[1]+=-0.25*k;break;case c.DOWN:n[1]+=0.25*k}f=(1-e)*(1-e)*(1-e);h=3*(1-e)*(1-e)*e;k=3*(1-e)*e*e;e*=e*e;return[f*a[0]+h*d[0]+k*n[0]+e*b[0],
f*a[1]+h*d[1]+k*n[1]+e*b[1]]};m.prototype.drawExecutionOrder=function(a){a.shadowColor="transparent";a.globalAlpha=0.25;a.textAlign="center";a.strokeStyle="white";a.globalAlpha=0.75;for(var b=this.visible_nodes,e=0;e<b.length;++e){var f=b[e];a.fillStyle="black";a.fillRect(f.pos[0]-c.NODE_TITLE_HEIGHT,f.pos[1]-c.NODE_TITLE_HEIGHT,c.NODE_TITLE_HEIGHT,c.NODE_TITLE_HEIGHT);0==f.order&&a.strokeRect(f.pos[0]-c.NODE_TITLE_HEIGHT+0.5,f.pos[1]-c.NODE_TITLE_HEIGHT+0.5,c.NODE_TITLE_HEIGHT,c.NODE_TITLE_HEIGHT);
a.fillStyle="#FFF";a.fillText(f.order,f.pos[0]+-0.5*c.NODE_TITLE_HEIGHT,f.pos[1]-6)}a.globalAlpha=1};m.prototype.drawNodeWidgets=function(a,b,e,f){if(!a.widgets||!a.widgets.length)return 0;var h=a.size[0],k=a.widgets;b+=2;var d=c.NODE_WIDGET_HEIGHT,n=0.5<this.ds.scale;e.save();e.globalAlpha=this.editor_alpha;for(var m=0;m<k.length;++m){var g=k[m],p=b;g.y&&(p=g.y);g.last_y=p;e.strokeStyle="#666";e.fillStyle="#222";e.textAlign="left";switch(g.type){case "button":g.clicked&&(e.fillStyle="#AAA",g.clicked=
!1,this.dirty_canvas=!0);e.fillRect(15,p,h-30,d);e.strokeRect(15,p,h-30,d);n&&(e.textAlign="center",e.fillStyle="#AAA",e.fillText(g.name,0.5*h,p+0.7*d));break;case "toggle":e.textAlign="left";e.strokeStyle="#666";e.fillStyle="#222";e.beginPath();e.roundRect(15,b,h-30,d,0.5*d);e.fill();e.stroke();e.fillStyle=g.value?"#89A":"#333";e.beginPath();e.arc(h-30,p+0.5*d,0.36*d,0,2*Math.PI);e.fill();n&&(e.fillStyle="#999",null!=g.name&&e.fillText(g.name,30,p+0.7*d),e.fillStyle=g.value?"#DDD":"#888",e.textAlign=
"right",e.fillText(g.value?g.options.on||"true":g.options.off||"false",h-40,p+0.7*d));break;case "slider":e.fillStyle="#222";e.fillRect(15,p,h-30,d);var C=g.options.max-g.options.min,D=(g.value-g.options.min)/C;e.fillStyle=f==g?"#89A":"#678";e.fillRect(15,p,D*(h-30),d);e.strokeRect(15,p,h-30,d);g.marker&&(C=(g.marker-g.options.min)/C,e.fillStyle="#AA9",e.fillRect(15+C*(h-30),p,2,d));n&&(e.textAlign="center",e.fillStyle="#DDD",e.fillText(g.name+"  "+Number(g.value).toFixed(3),0.5*h,p+0.7*d));break;
case "number":case "combo":e.textAlign="left";e.strokeStyle="#666";e.fillStyle="#222";e.beginPath();e.roundRect(15,b,h-30,d,0.5*d);e.fill();e.stroke();n&&(e.fillStyle="#AAA",e.beginPath(),e.moveTo(31,b+5),e.lineTo(21,b+0.5*d),e.lineTo(31,b+d-5),e.moveTo(h-15-16,b+5),e.lineTo(h-15-6,b+0.5*d),e.lineTo(h-15-16,b+d-5),e.fill(),e.fillStyle="#999",e.fillText(g.name,35,p+0.7*d),e.fillStyle="#DDD",e.textAlign="right","number"==g.type?e.fillText(Number(g.value).toFixed(void 0!==g.options.precision?g.options.precision:
3),h-30-20,p+0.7*d):e.fillText(g.value,h-30-20,p+0.7*d));break;case "string":case "text":e.textAlign="left";e.strokeStyle="#666";e.fillStyle="#222";e.beginPath();e.roundRect(15,b,h-30,d,0.5*d);e.fill();e.stroke();n&&(e.fillStyle="#999",null!=g.name&&e.fillText(g.name,30,p+0.7*d),e.fillStyle="#DDD",e.textAlign="right",e.fillText(g.value,h-30,p+0.7*d));break;default:g.draw&&g.draw(e,a,g,p,d)}b+=d+4}e.restore()};m.prototype.processNodeWidgets=function(a,b,e,f){if(!a.widgets||!a.widgets.length)return null;
for(var h=b[0]-a.pos[0],d=b[1]-a.pos[1],k=a.size[0],n=this,g=this.getCanvasWindow(),m=0;m<a.widgets.length;++m){var p=a.widgets[m];if(p==f||6<h&&h<k-12&&d>p.last_y&&d<p.last_y+c.NODE_WIDGET_HEIGHT){switch(p.type){case "button":p.callback&&setTimeout(function(){p.callback(p,n,a,b)},20);this.dirty_canvas=p.clicked=!0;break;case "slider":e=Math.clamp((h-10)/(k-20),0,1);p.value=p.options.min+(p.options.max-p.options.min)*e;p.callback&&setTimeout(function(){p.callback(p.value,n,a,b)},20);this.dirty_canvas=
!0;break;case "number":case "combo":if("mousemove"==e.type&&"number"==p.type)p.value+=0.1*e.deltaX*(p.options.step||1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if("mousedown"==e.type)if((f=p.options.values)&&f.constructor===Function&&(f=p.options.values(p,a)),h=40>h?-1:h>k-40?1:0,"number"==p.type)p.value+=0.1*h*(p.options.step||1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),
null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if(h)e=f.indexOf(p.value)+h,e>=f.length&&(e=0),0>e&&(e=f.length-1),p.value=f[e];else{new c.ContextMenu(f,{scale:Math.max(1,this.ds.scale),event:e,className:"dark",callback:C.bind(p)},g);var C=function(a,b,e){this.value=a;n.dirty_canvas=!0;return!1}}p.callback&&setTimeout(function(){this.callback(this.value,n,a,b)}.bind(p),20);this.dirty_canvas=!0;break;case "toggle":"mousedown"==e.type&&(p.value=!p.value,p.callback&&setTimeout(function(){p.callback(p.value,
n,a,b)},20));break;case "string":case "text":"mousedown"==e.type&&this.prompt("Value",p.value,function(b){this.value=b;p.callback&&p.callback(b,n,a)}.bind(p),e);break;default:p.mouse&&p.mouse(ctx,e,[h,d],a)}return p}}return null};m.prototype.drawGroups=function(a,b){if(this.graph){var e=this.graph._groups;b.save();b.globalAlpha=0.5*this.editor_alpha;for(var f=0;f<e.length;++f){var h=e[f];if(z(this.visible_area,h._bounding)){b.fillStyle=h.color||"#335";b.strokeStyle=h.color||"#335";var d=h._pos,k=
h._size;b.globalAlpha=0.25*this.editor_alpha;b.beginPath();b.rect(d[0]+0.5,d[1]+0.5,k[0],k[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(d[0]+k[0],d[1]+k[1]);b.lineTo(d[0]+k[0]-10,d[1]+k[1]);b.lineTo(d[0]+k[0],d[1]+k[1]-10);b.fill();k=h.font_size||c.DEFAULT_GROUP_FONT_SIZE;b.font=k+"px Arial";b.fillText(h.title,d[0]+4,d[1]+k)}}b.restore()}};m.prototype.adjustNodesSize=function(){for(var a=this.graph._nodes,b=0;b<a.length;++b)a[b].size=a[b].computeSize();this.setDirty(!0,
...
f=c.document.createEvent("MouseEvent");f.initMouseEvent(e,!0,!0,c,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,!1,!1,!1,0,null);b.target.dispatchEvent(f);a.preventDefault()};m.onGroupAdd=function(a,b,e){a=m.active_canvas;a.getCanvasWindow();b=new c.LGraphGroup;b.pos=a.convertEventToCanvasOffset(e);a.graph.add(b)};m.onMenuAdd=function(a,b,e,f){function h(a,b){var e=f.getFirstEvent(),h=c.createNode(a.value);h&&(h.pos=d.convertEventToCanvasOffset(e),d.graph.add(h))}var d=m.active_canvas,k=d.getCanvasWindow();
a=c.getNodeTypesCategories();b=[];for(var n in a)a[n]&&b.push({value:a[n],content:a[n],has_submenu:!0});var g=new c.ContextMenu(b,{event:e,callback:function(a,b,e){a=c.getNodeTypesInCategory(a.value,d.filter);b=[];for(var f in a)a[f].skip_list||b.push({content:a[f].title,value:a[f].type});new c.ContextMenu(b,{event:e,callback:h,parentMenu:g},k);return!1},parentMenu:f},k);return!1};m.onMenuCollapseAll=function(){};m.onMenuNodeEdit=function(){};m.showMenuNodeOptionalInputs=function(a,b,e,f,h){function d(a,
b,e){h&&(a.callback&&a.callback.call(k,h,a,b,e),a.value&&(h.addInput(a.value[0],a.value[1],a.value[2]),h.setDirtyCanvas(!0,!0)))}if(h){var k=this;a=m.active_canvas.getCanvasWindow();b=h.optional_inputs;h.onGetInputs&&(b=h.onGetInputs());var n=[];if(b)for(var g in b){var t=b[g];if(t){var p=t[0];t[2]&&t[2].label&&(p=t[2].label);p={content:p,value:t};t[1]==c.ACTION&&(p.className="event");n.push(p)}else n.push(null)}this.onMenuNodeInputs&&(n=this.onMenuNodeInputs(n));if(n.length)return new c.ContextMenu(n,
{event:e,callback:d,parentMenu:f,node:h},a),!1}};m.showMenuNodeOptionalOutputs=function(a,b,e,f,h){function d(a,b,e){if(h&&(a.callback&&a.callback.call(k,h,a,b,e),a.value))if(e=a.value[1],!e||e.constructor!==Object&&e.constructor!==Array)h.addOutput(a.value[0],a.value[1],a.value[2]),h.setDirtyCanvas(!0,!0);else{a=[];for(var p in e)a.push({content:p,value:e[p]});new c.ContextMenu(a,{event:b,callback:d,parentMenu:f,node:h});return!1}}if(h){var k=this;a=m.active_canvas.getCanvasWindow();b=h.optional_outputs;
h.onGetOutputs&&(b=h.onGetOutputs());var n=[];if(b)for(var g in b){var t=b[g];if(!t)n.push(null);else if(!h.flags||!h.flags.skip_repeated_outputs||-1==h.findOutputSlot(t[0])){var p=t[0];t[2]&&t[2].label&&(p=t[2].label);p={content:p,value:t};t[1]==c.EVENT&&(p.className="event");n.push(p)}}this.onMenuNodeOutputs&&(n=this.onMenuNodeOutputs(n));if(n.length)return new c.ContextMenu(n,{event:e,callback:d,parentMenu:f,node:h},a),!1}};m.onShowMenuNodeProperties=function(a,b,e,f,h){function d(a,b,e,c){h&&
(b=this.getBoundingClientRect(),k.showEditPropertyValue(h,a.value,{position:[b.left,b.top]}))}if(h&&h.properties){var k=m.active_canvas;b=k.getCanvasWindow();var n=[],g;for(g in h.properties)a=void 0!==h.properties[g]?h.properties[g]:" ",a=m.decodeHTML(a),n.push({content:"<span class='property_name'>"+g+"</span><span class='property_value'>"+a+"</span>",value:g});if(n.length)return new c.ContextMenu(n,{event:e,callback:d,parentMenu:f,allow_html:!0,node:h},b),!1}};m.decodeHTML=function(a){var b=document.createElement("div");
b.innerText=a;return b.innerHTML};m.onResizeNode=function(a,b,e,c,f){f&&(f.size=f.computeSize(),f.setDirtyCanvas(!0,!0))};m.prototype.showLinkMenu=function(a,b){var e=this;new c.ContextMenu(["Delete"],{event:b,callback:function(b){switch(b){case "Delete":e.graph.removeLink(a.id)}}});return!1};m.onShowPropertyEditor=function(a,b,e,c,f){function d(){var b=g.value;"Number"==a.type?b=Number(b):"Boolean"==a.type&&(b=Boolean(b));f[k]=b;n.parentNode&&n.parentNode.removeChild(n);f.setDirtyCanvas(!0,!0)}var k=
a.property||"title";b=f[k];var n=document.createElement("div");n.className="graphdialog";n.innerHTML="<span class='name'></span><input autofocus type='text' class='value'/><button>OK</button>";n.querySelector(".name").innerText=k;var g=n.querySelector("input");g&&(g.value=b,g.addEventListener("blur",function(a){this.focus()}),g.addEventListener("keydown",function(a){13==a.keyCode&&(d(),a.preventDefault(),a.stopPropagation())}));b=m.active_canvas.canvas;e=b.getBoundingClientRect();var t=c=-20;e&&(c-=
e.left,t-=e.top);event?(n.style.left=event.clientX+c+"px",n.style.top=event.clientY+t+"px"):(n.style.left=0.5*b.width+c+"px",n.style.top=0.5*b.height+t+"px");n.querySelector("button").addEventListener("click",d);b.parentNode.appendChild(n)};m.prototype.prompt=function(a,b,e,c){var f=this;a=a||"";var d=document.createElement("div");d.className="graphdialog rounded";d.innerHTML="<span class='name'></span> <input autofocus type='text' class='value'/><button class='rounded'>OK</button>";d.close=function(){f.prompt_box=
null;d.parentNode&&d.parentNode.removeChild(d)};1<this.ds.scale&&(d.style.transform="scale("+this.ds.scale+")");d.addEventListener("mouseleave",function(a){d.close()});f.prompt_box&&f.prompt_box.close();f.prompt_box=d;d.querySelector(".name").innerText=a;d.querySelector(".value").value=b;var k=d.querySelector("input");k.addEventListener("keydown",function(a){if(27==a.keyCode)d.close();else if(13==a.keyCode)e&&e(this.value),d.close();else return;a.preventDefault();a.stopPropagation()});d.querySelector("button").addEventListener("click",
function(a){e&&e(k.value);f.setDirty(!0);d.close()});a=m.active_canvas.canvas;b=a.getBoundingClientRect();var n=-20,g=-20;b&&(n-=b.left,g-=b.top);c?(d.style.left=c.clientX+n+"px",d.style.top=c.clientY+g+"px"):(d.style.left=0.5*a.width+n+"px",d.style.top=0.5*a.height+g+"px");a.parentNode.appendChild(d);setTimeout(function(){k.focus()},10);return d};m.search_limit=-1;m.prototype.showSearchBox=function(a){function b(b){if(b)if(h.onSearchBoxSelection)h.onSearchBoxSelection(b,a,D);else{var e=c.searchbox_extras[b];
e&&(b=e.type);if(b=c.createNode(b))b.pos=D.convertEventToCanvasOffset(a),D.graph.add(b);if(e&&e.data){if(e.data.properties)for(var f in e.data.properties)b.addProperty(e.data.properties[f][0],e.data.properties[f][0]);if(e.data.inputs)for(f in b.inputs=[],e.data.inputs)b.addOutput(e.data.inputs[f][0],e.data.inputs[f][1]);if(e.data.outputs)for(f in b.outputs=[],e.data.outputs)b.addOutput(e.data.outputs[f][0],e.data.outputs[f][1]);e.data.title&&(b.title=e.data.title);e.data.json&&b.configure(e.data.json)}}d.close()}
function e(a){var b=p;p&&p.classList.remove("selected");p?(p=a?p.nextSibling:p.previousSibling)||(p=b):p=a?n.childNodes[0]:n.childNodes[n.childNodes.length];p&&(p.classList.add("selected"),p.scrollIntoView())}function f(){function a(e,c){var f=document.createElement("div");g||(g=e);f.innerText=e;f.dataset.type=escape(e);f.className="litegraph lite-search-item";c&&(f.className+=" "+c);f.addEventListener("click",function(a){b(unescape(this.dataset.type))});n.appendChild(f)}t=null;var e=C.value;g=null;
n.innerHTML="";if(e)if(h.onSearchBox){var p=h.onSearchBox(help,e,D);if(p)for(var d=0;d<p.length;++d)a(p[d])}else{p=0;e=e.toLowerCase();for(d in c.searchbox_extras){var k=c.searchbox_extras[d];if(-1!==k.desc.toLowerCase().indexOf(e)&&(a(k.desc,"searchbox_extra"),-1!==m.search_limit&&p++>m.search_limit))break}if(Array.prototype.filter)for(k=Object.keys(c.registered_node_types).filter(function(a){return-1!==a.toLowerCase().indexOf(e)}),d=0;d<k.length&&!(a(k[d]),-1!==m.search_limit&&p++>m.search_limit);d++);
else for(d in c.registered_node_types)if(-1!=d.indexOf(e)&&(a(d),-1!==m.search_limit&&p++>m.search_limit))break}}var h=this,d=document.createElement("div");d.className="litegraph litesearchbox graphdialog rounded";d.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";d.close=function(){h.search_box=null;document.body.focus();setTimeout(function(){h.canvas.focus()},20);d.parentNode&&d.parentNode.removeChild(d)};var k=null;1<this.ds.scale&&
(d.style.transform="scale("+this.ds.scale+")");d.addEventListener("mouseenter",function(a){k&&(clearTimeout(k),k=null)});d.addEventListener("mouseleave",function(a){k=setTimeout(function(){d.close()},500)});h.search_box&&h.search_box.close();h.search_box=d;var n=d.querySelector(".helper"),g=null,t=null,p=null,C=d.querySelector("input");C&&(C.addEventListener("blur",function(a){this.focus()}),C.addEventListener("keydown",function(a){if(38==a.keyCode)e(!1);else if(40==a.keyCode)e(!0);else if(27==a.keyCode)d.close();
else if(13==a.keyCode)p?b(p.innerHTML):g?b(g):d.close();else{t&&clearInterval(t);t=setTimeout(f,10);return}a.preventDefault();a.stopPropagation()}));var D=m.active_canvas,l=D.canvas,q=l.getBoundingClientRect(),A=-20,v=-20;q&&(A-=q.left,v-=q.top);a?(d.style.left=a.clientX+A+"px",d.style.top=a.clientY+v+"px"):(d.style.left=0.5*l.width+A+"px",d.style.top=0.5*l.height+v+"px");l.parentNode.appendChild(d);C.focus();return d};m.prototype.showEditPropertyValue=function(a,b,e){function c(){f(C.value)}function f(e){"number"==
typeof a.properties[b]&&(e=Number(e));"array"==d&&(e=e.split(",").map(Number));a.properties[b]=e;a._graph&&a._graph._version++;if(a.onPropertyChanged)a.onPropertyChanged(b,e);p.close();a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){e=e||{};var d="string";null!==a.properties[b]&&(d=typeof a.properties[b]);"object"==d&&a.properties[b].length&&(d="array");var k=null;a.getPropertyInfo&&(k=a.getPropertyInfo(b));if(a.properties_info)for(var n=0;n<a.properties_info.length;++n)if(a.properties_info[n].name==
b){k=a.properties_info[n];break}void 0!==k&&null!==k&&k.type&&(d=k.type);var g="";if("string"==d||"number"==d||"array"==d)g="<input autofocus type='text' class='value'/>";else if("enum"==d&&k.values){g="<select autofocus type='text' class='value'>";for(n in k.values)var m=k.values.constructor===Array?k.values[n]:n,g=g+("<option value='"+m+"' "+(m==a.properties[b]?"selected":"")+">"+k.values[n]+"</option>");g+="</select>"}else if("boolean"==d)g="<input autofocus type='checkbox' class='value' "+(a.properties[b]?
"checked":"")+"/>";else{console.warn("unknown type: "+d);return}var p=this.createDialog("<span class='name'>"+b+"</span>"+g+"<button>OK</button>",e);if("enum"==d&&k.values){var C=p.querySelector("select");C.addEventListener("change",function(a){f(a.target.value)})}else if("boolean"==d)(C=p.querySelector("input"))&&C.addEventListener("click",function(a){f(!!C.checked)});else if(C=p.querySelector("input"))C.addEventListener("blur",function(a){this.focus()}),C.value=void 0!==a.properties[b]?a.properties[b]:
"",C.addEventListener("keydown",function(a){13==a.keyCode&&(c(),a.preventDefault(),a.stopPropagation())});p.querySelector("button").addEventListener("click",c)}};m.prototype.createDialog=function(a,b){b=b||{};var e=document.createElement("div");e.className="graphdialog";e.innerHTML=a;var c=this.canvas.getBoundingClientRect(),f=-20,d=-20;c&&(f-=c.left,d-=c.top);b.position?(f+=b.position[0],d+=b.position[1]):b.event?(f+=b.event.clientX,d+=b.event.clientY):(f+=0.5*this.canvas.width,d+=0.5*this.canvas.height);
e.style.left=f+"px";e.style.top=d+"px";this.canvas.parentNode.appendChild(e);e.close=function(){this.parentNode&&this.parentNode.removeChild(this)};return e};m.onMenuNodeCollapse=function(a,b,e,c,f){f.collapse()};m.onMenuNodePin=function(a,b,e,c,f){f.pin()};m.onMenuNodeMode=function(a,b,e,f,d){new c.ContextMenu(["Always","On Event","On Trigger","Never"],{event:e,callback:function(a){if(d)switch(a){case "On Event":d.mode=c.ON_EVENT;break;case "On Trigger":d.mode=c.ON_TRIGGER;break;case "Never":d.mode=
c.NEVER;break;default:d.mode=c.ALWAYS}},parentMenu:f,node:d});return!1};m.onMenuNodeColors=function(a,b,e,f,d){if(!d)throw"no node for color";b=[];b.push({value:null,content:"<span style='display: block; padding-left: 4px;'>No color</span>"});for(var k in m.node_colors)a=m.node_colors[k],a={value:k,content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid "+a.color+"; background-color:"+a.bgcolor+"'>"+k+"</span>"},b.push(a);new c.ContextMenu(b,{event:e,callback:function(a){d&&
((a=a.value?m.node_colors[a.value]:null)?d.constructor===c.LGraphGroup?d.color=a.groupcolor:(d.color=a.color,d.bgcolor=a.bgcolor):(delete d.color,delete d.bgcolor),d.setDirtyCanvas(!0,!0))},parentMenu:f,node:d});return!1};m.onMenuNodeShapes=function(a,b,e,f,d){if(!d)throw"no node passed";new c.ContextMenu(c.VALID_SHAPES,{event:e,callback:function(a){d&&(d.shape=a,d.setDirtyCanvas(!0))},parentMenu:f,node:d});return!1};m.onMenuNodeRemove=function(a,b,e,c,f){if(!f)throw"no node passed";!1!==f.removable&&
(f.graph.remove(f),f.setDirtyCanvas(!0,!0))};m.onMenuNodeClone=function(a,b,e,c,f){!1!=f.clonable&&(a=f.clone())&&(a.pos=[f.pos[0]+5,f.pos[1]+5],f.graph.add(a),f.setDirtyCanvas(!0,!0))};m.node_colors={red:{color:"#322",bgcolor:"#533",groupcolor:"#A88"},brown:{color:"#332922",bgcolor:"#593930",groupcolor:"#b06634"},green:{color:"#232",bgcolor:"#353",groupcolor:"#8A8"},blue:{color:"#223",bgcolor:"#335",groupcolor:"#88A"},pale_blue:{color:"#2a363b",bgcolor:"#3f5159",groupcolor:"#3f789e"},cyan:{color:"#233",
bgcolor:"#355",groupcolor:"#8AA"},purple:{color:"#323",bgcolor:"#535",groupcolor:"#a1309b"},yellow:{color:"#432",bgcolor:"#653",groupcolor:"#b58b2a"},black:{color:"#222",bgcolor:"#000",groupcolor:"#444"}};m.prototype.getCanvasMenuOptions=function(){var a=null;this.getMenuOptions?a=this.getMenuOptions():(a=[{content:"Add Node",has_submenu:!0,callback:m.onMenuAdd},{content:"Add Group",callback:m.onGroupAdd}],this._graph_stack&&0<this._graph_stack.length&&a.push(null,{content:"Close subgraph",callback:this.closeSubgraph.bind(this)}));
if(this.getExtraMenuOptions){var b=this.getExtraMenuOptions(this,a);b&&(a=a.concat(b))}return a};m.prototype.getNodeMenuOptions=function(a){var b=null,b=a.getMenuOptions?a.getMenuOptions(this):[{content:"Inputs",has_submenu:!0,disabled:!0,callback:m.showMenuNodeOptionalInputs},{content:"Outputs",has_submenu:!0,disabled:!0,callback:m.showMenuNodeOptionalOutputs},null,{content:"Properties",has_submenu:!0,callback:m.onShowMenuNodeProperties},null,{content:"Title",callback:m.onShowPropertyEditor},{content:"Mode",
has_submenu:!0,callback:m.onMenuNodeMode},{content:"Resize",callback:m.onResizeNode},{content:"Collapse",callback:m.onMenuNodeCollapse},{content:"Pin",callback:m.onMenuNodePin},{content:"Colors",has_submenu:!0,callback:m.onMenuNodeColors},{content:"Shapes",has_submenu:!0,callback:m.onMenuNodeShapes},null];if(a.onGetInputs){var e=a.onGetInputs();e&&e.length&&(b[0].disabled=!1)}a.onGetOutputs&&(e=a.onGetOutputs())&&e.length&&(b[1].disabled=!1);a.getExtraMenuOptions&&(e=a.getExtraMenuOptions(this))&&
(e.push(null),b=e.concat(b));!1!==a.clonable&&b.push({content:"Clone",callback:m.onMenuNodeClone});!1!==a.removable&&b.push(null,{content:"Remove",callback:m.onMenuNodeRemove});if(a.graph&&a.graph.onGetNodeMenuOptions)a.graph.onGetNodeMenuOptions(b,a);return b};m.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:m.onShowPropertyEditor},{content:"Color",has_submenu:!0,callback:m.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:m.onShowPropertyEditor},
null,{content:"Remove",callback:m.onMenuNodeRemove}]};m.prototype.processContextMenu=function(a,b){var e=this,f=m.active_canvas.getCanvasWindow(),d=null,k={event:b,callback:function(b,c,f){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?a.removeInput(b.slot):b.output&&a.removeOutput(b.slot);else if("Disconnect Links"==b.content)b=b.slot,b.output?a.disconnectOutput(b.slot):b.input&&a.disconnectInput(b.slot);else if("Rename Slot"==b.content){b=b.slot;var p=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),
d=e.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",c),k=d.querySelector("input");k&&p&&(k.value=p.label);d.querySelector("button").addEventListener("click",function(a){k.value&&(p&&(p.label=k.value),e.setDirty(!0));d.close()})}},extra:a},n=null;a&&(n=a.getSlotInPosition(b.canvasX,b.canvasY),m.active_node=a);n?(d=[],n&&n.output&&n.output.links&&n.output.links.length&&d.push({content:"Disconnect Links",slot:n}),d.push(n.locked?"Cannot remove":{content:"Remove Slot",
slot:n}),d.push(n.nameLocked?"Cannot rename":{content:"Rename Slot",slot:n}),k.title=(n.input?n.input.type:n.output.type)||"*",n.input&&n.input.type==c.ACTION&&(k.title="Action"),n.output&&n.output.type==c.EVENT&&(k.title="Event")):a?d=this.getNodeMenuOptions(a):(d=this.getCanvasMenuOptions(),(n=this.graph.getGroupOnPos(b.canvasX,b.canvasY))&&d.push(null,{content:"Edit Group",has_submenu:!0,submenu:{title:"Group",extra:n,options:this.getGroupMenuOptions(n)}}));d&&new c.ContextMenu(d,k,f)};this.CanvasRenderingContext2D&&
(CanvasRenderingContext2D.prototype.roundRect=function(a,b,e,c,f,d){void 0===f&&(f=5);void 0===d&&(d=f);this.moveTo(a+f,b);this.lineTo(a+e-f,b);this.quadraticCurveTo(a+e,b,a+e,b+f);this.lineTo(a+e,b+c-d);this.quadraticCurveTo(a+e,b+c,a+e-d,b+c);this.lineTo(a+d,b+c);this.quadraticCurveTo(a,b+c,a,b+c-d);this.lineTo(a,b+f);this.quadraticCurveTo(a,b,a+f,b)});c.compareObjects=function(a,b){for(var e in a)if(a[e]!=b[e])return!1;return!0};c.distance=w;c.colorToString=function(a){return"rgba("+Math.round(255*
a[0]).toFixed()+","+Math.round(255*a[1]).toFixed()+","+Math.round(255*a[2]).toFixed()+","+(4==a.length?a[3].toFixed(2):"1.0")+")"};c.isInsideRectangle=B;c.growBounding=function(a,b,e){b<a[0]?a[0]=b:b>a[2]&&(a[2]=b);e<a[1]?a[1]=e:e>a[3]&&(a[3]=e)};c.isInsideBounding=function(a,b){return a[0]<b[0][0]||a[1]<b[0][1]||a[0]>b[1][0]||a[1]>b[1][1]?!1:!0};c.overlapBounding=z;c.hex2num=function(a){"#"==a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();for(var b=Array(3),e=0,c,f,d=0;6>d;d+=2)c="0123456789ABCDEF".indexOf(a.charAt(d)),
f="0123456789ABCDEF".indexOf(a.charAt(d+1)),b[e]=16*c+f,e++;return b};c.num2hex=function(a){for(var b="#",e,c,f=0;3>f;f++)e=a[f]/16,c=a[f]%16,b+="0123456789ABCDEF".charAt(e)+"0123456789ABCDEF".charAt(c);return b};y.prototype.addItem=function(a,b,e){function c(a){var b=this.value;b&&b.has_submenu&&f.call(this,a)}function f(a){var b=this.value,c=!0;d.current_submenu&&d.current_submenu.close(a);if(e.callback){var k=e.callback.call(this,b,e,a,d,e.node);!0===k&&(c=!1)}if(b&&(b.callback&&!e.ignore_item_callbacks&&
!0!==b.disabled&&(k=b.callback.call(this,b,e,a,d,e.extra),!0===k&&(c=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new d.constructor(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:d,ignore_item_callbacks:b.submenu.ignore_item_callbacks,title:b.submenu.title,extra:b.submenu.extra,autoopen:e.autoopen});c=!1}c&&!d.lock&&d.close()}var d=this;e=e||{};var k=document.createElement("div");k.className="litemenu-entry submenu";var n=!1;if(null===b)k.classList.add("separator");
else{k.innerHTML=b&&b.title?b.title:a;if(k.value=b)b.disabled&&(n=!0,k.classList.add("disabled")),(b.submenu||b.has_submenu)&&k.classList.add("has_submenu");"function"==typeof b?(k.dataset.value=a,k.onclick_callback=b):k.dataset.value=b;b.className&&(k.className+=" "+b.className)}this.root.appendChild(k);n||k.addEventListener("click",f);e.autoopen&&k.addEventListener("mouseenter",c);return k};y.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&
!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!y.isCursorOverElement(a,this.parentMenu.root)&&y.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&clearTimeout(this.root.closing_timer)};y.trigger=function(a,b,e,c){var f=document.createEvent("CustomEvent");f.initCustomEvent(b,!0,!0,e);f.srcElement=c;a.dispatchEvent?a.dispatchEvent(f):a.__events&&a.__events.dispatchEvent(f);
return f};y.prototype.getTopMenu=function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};y.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};y.isCursorOverElement=function(a,b){var e=a.clientX,c=a.clientY,f=b.getBoundingClientRect();return f?c>f.top&&c<f.top+f.height&&e>f.left&&e<f.left+f.width?!0:!1:!1};c.ContextMenu=y;c.closeAllContextMenus=function(a){a=a||window;a=a.document.querySelectorAll(".litecontextmenu");
if(a.length){for(var b=[],e=0;e<a.length;e++)b.push(a[e]);for(e in b)b[e].close?b[e].close():b[e].parentNode&&b[e].parentNode.removeChild(b[e])}};c.extendClass=function(a,b){for(var e in b)a.hasOwnProperty(e)||(a[e]=b[e]);if(b.prototype)for(e in b.prototype)b.prototype.hasOwnProperty(e)&&!a.prototype.hasOwnProperty(e)&&(b.prototype.__lookupGetter__(e)?a.prototype.__defineGetter__(e,b.prototype.__lookupGetter__(e)):a.prototype[e]=b.prototype[e],b.prototype.__lookupSetter__(e)&&a.prototype.__defineSetter__(e,
...
(function(u){function d(){this.addOutput("in ms","number");this.addOutput("in sec","number")}function l(){this.size=[140,80];this.subgraph=new LGraph;this.subgraph._subgraph_node=this;this.subgraph._is_subgraph=!0;this.subgraph.onGlobalInputAdded=this.onSubgraphNewGlobalInput.bind(this);this.subgraph.onGlobalInputRenamed=this.onSubgraphRenamedGlobalInput.bind(this);this.subgraph.onGlobalInputTypeChanged=this.onSubgraphTypeChangeGlobalInput.bind(this);this.subgraph.onGlobalOutputAdded=this.onSubgraphNewGlobalOutput.bind(this);
this.subgraph.onGlobalOutputRenamed=this.onSubgraphRenamedGlobalOutput.bind(this);this.subgraph.onGlobalOutputTypeChanged=this.onSubgraphTypeChangeGlobalOutput.bind(this)}function q(){var c="input_"+(1E3*Math.random()).toFixed();this.addOutput(c,null);this.properties={name:c,type:null};var d=this;Object.defineProperty(this.properties,"name",{get:function(){return c},set:function(k){if(""!=k){var n=d.getOutputInfo(0);n.name!=k&&(n.name=k,d.graph&&d.graph.renameGlobalInput(c,k),c=k)}},enumerable:!0});
Object.defineProperty(this.properties,"type",{get:function(){return d.outputs[0].type},set:function(k){d.outputs[0].type=k;d.graph&&d.graph.changeGlobalInputType(c,d.outputs[0].type)},enumerable:!0})}function g(){var c="output_"+(1E3*Math.random()).toFixed();this.addInput(c,null);this._value=null;this.properties={name:c,type:null};var d=this;Object.defineProperty(this.properties,"name",{get:function(){return c},set:function(k){if(""!=k){var n=d.getInputInfo(0);n.name!=k&&(n.name=k,d.graph&&d.graph.renameGlobalOutput(c,
k),c=k)}},enumerable:!0});Object.defineProperty(this.properties,"type",{get:function(){return d.inputs[0].type},set:function(k){d.inputs[0].type=k;d.graph&&d.graph.changeGlobalInputType(c,d.inputs[0].type)},enumerable:!0})}function s(){this.addOutput("value","number");this.addProperty("value",1)}function m(){this.addOutput("","string");this.addProperty("value","");this.widget=this.addWidget("text","value","",this.setValue.bind(this));this.widgets_up=!0;this.size=[100,30]}function w(){this.addOutput("",
"");this.addProperty("value","");this.widget=this.addWidget("text","json","",this.setValue.bind(this));this.widgets_up=!0;this.size=[140,30];this._value=null}function B(){this.addInput("obj","");this.addOutput("","");this.addProperty("value","");this.widget=this.addWidget("text","prop.","",this.setValue.bind(this));this.widgets_up=!0;this.size=[140,30];this._value=null}function z(){this.size=[60,20];this.addInput("value",0,{label:""});this.value=0}function y(){this.addInput("in",0);this.addOutput("out",
0);this.size=[40,20]}function c(){this.mode=n.ON_EVENT;this.size=[60,20];this.addProperty("msg","");this.addInput("log",n.EVENT);this.addInput("msg",0)}function x(){this.size=[60,20];this.addProperty("onExecute","return A;");this.addInput("A","");this.addInput("B","");this.addOutput("out","");this._func=null;this.data={}}var n=u.LiteGraph;d.title="Time";d.desc="Time";d.prototype.onExecute=function(){this.setOutputData(0,1E3*this.graph.globaltime);this.setOutputData(1,this.graph.globaltime)};n.registerNodeType("basic/time",
d);l.title="Subgraph";l.desc="Graph inside a node";l.title_color="#334";l.prototype.onDrawTitle=function(c){if(!this.flags.collapsed){c.fillStyle="#555";var d=n.NODE_TITLE_HEIGHT,k=this.size[0]-d;c.fillRect(k,-d,d,d);c.fillStyle="#333";c.beginPath();c.moveTo(k+0.2*d,0.6*-d);c.lineTo(k+0.8*d,0.6*-d);c.lineTo(k+0.5*d,0.3*-d);c.fill()}};l.prototype.onDblClick=function(c,d,k){var n=this;setTimeout(function(){k.openSubgraph(n.subgraph)},10)};l.prototype.onMouseDown=function(c,d,k){if(!this.flags.collapsed&&
d[0]>this.size[0]-n.NODE_TITLE_HEIGHT&&0>d[1]){var g=this;setTimeout(function(){k.openSubgraph(g.subgraph)},10)}};l.prototype.onSubgraphNewGlobalInput=function(c,d){this.addInput(c,d)};l.prototype.onSubgraphRenamedGlobalInput=function(c,d){var k=this.findInputSlot(c);-1!=k&&(this.getInputInfo(k).name=d)};l.prototype.onSubgraphTypeChangeGlobalInput=function(c,d){var k=this.findInputSlot(c);-1!=k&&(this.getInputInfo(k).type=d)};l.prototype.onSubgraphNewGlobalOutput=function(c,d){this.addOutput(c,d)};
l.prototype.onSubgraphRenamedGlobalOutput=function(c,d){var k=this.findOutputSlot(c);-1!=k&&(this.getOutputInfo(k).name=d)};l.prototype.onSubgraphTypeChangeGlobalOutput=function(c,d){var k=this.findOutputSlot(c);-1!=k&&(this.getOutputInfo(k).type=d)};l.prototype.getExtraMenuOptions=function(c){var d=this;return[{content:"Open",callback:function(){c.openSubgraph(d.subgraph)}}]};l.prototype.onResize=function(c){c[1]+=20};l.prototype.onExecute=function(){if(this.inputs)for(var c=0;c<this.inputs.length;c++){var d=
this.inputs[c],k=this.getInputData(c);this.subgraph.setGlobalInputData(d.name,k)}this.subgraph.runStep();if(this.outputs)for(c=0;c<this.outputs.length;c++)k=this.subgraph.getGlobalOutputData(this.outputs[c].name),this.setOutputData(c,k)};l.prototype.configure=function(c){LGraphNode.prototype.configure.call(this,c)};l.prototype.serialize=function(){var c=LGraphNode.prototype.serialize.call(this);c.subgraph=this.subgraph.serialize();return c};l.prototype.clone=function(){var c=n.createNode(this.type),
d=this.serialize();delete d.id;delete d.inputs;delete d.outputs;c.configure(d);return c};n.registerNodeType("graph/subgraph",l);q.title="Input";q.desc="Input of the graph";q.prototype.onAdded=function(){this.graph.addGlobalInput(this.properties.name,this.properties.type)};q.prototype.onExecute=function(){var c=this.graph.global_inputs[this.properties.name];c&&this.setOutputData(0,c.value)};n.registerNodeType("graph/input",q);g.title="Output";g.desc="Output of the graph";g.prototype.onAdded=function(){this.graph.addGlobalOutput(this.properties.name,
this.properties.type)};g.prototype.getValue=function(){return this._value};g.prototype.onExecute=function(){this._value=this.getInputData(0);this.graph.setGlobalOutputData(this.properties.name,this._value)};n.registerNodeType("graph/output",g);s.title="Const Number";s.desc="Constant number";s.prototype.onExecute=function(){this.setOutputData(0,parseFloat(this.properties.value))};s.prototype.getTitle=function(){return this.flags.collapsed?this.properties.value:this.title};s.prototype.setValue=function(c){this.properties.value=
c};s.prototype.onDrawBackground=function(c){this.outputs[0].label=this.properties.value.toFixed(3)};n.registerNodeType("basic/const",s);m.title="Const String";m.desc="Constant string";m.prototype.setValue=function(c){this.properties.value=c};m.prototype.onPropertyChanged=function(c,d){this.widget.value=d};m.prototype.getTitle=s.prototype.getTitle;m.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};n.registerNodeType("basic/string",m);w.title="Const Data";w.desc="Constant Data";
w.prototype.setValue=function(c){this.properties.value=c;this.onPropertyChanged("value",c)};w.prototype.onPropertyChanged=function(c,d){this.widget.value=d;if(null!=d&&""!=d)try{this._value=JSON.parse(d),this.boxcolor="#AEA"}catch(k){this.boxcolor="red"}};w.prototype.onExecute=function(){this.setOutputData(0,this._value)};n.registerNodeType("basic/data",w);B.title="Object property";B.desc="Outputs the property of an object";B.prototype.setValue=function(c){this.properties.value=c;this.widget.value=
...
this.inputs[0].label:this.title};z.toString=function(c){if(null==c)return"null";if(c.constructor===Number)return c.toFixed(3);if(c.constructor===Array){for(var d="[",k=0;k<c.length;++k)d+=z.toString(c[k])+(k+1!=c.length?",":"");return d+"]"}return String(c)};z.prototype.onDrawBackground=function(c){this.inputs[0].label=z.toString(this.value)};n.registerNodeType("basic/watch",z);y.title="Cast";y.desc="Allows to connect different types";y.prototype.onExecute=function(){this.setOutputData(0,this.getInputData(0))};
n.registerNodeType("basic/cast",y);c.title="Console";c.desc="Show value inside the console";c.prototype.onAction=function(c,d){"log"==c?console.log(d):"warn"==c?console.warn(d):"error"==c&&console.error(d)};c.prototype.onExecute=function(){var c=this.getInputData(1);null!==c&&(this.properties.msg=c);console.log(c)};c.prototype.onGetInputs=function(){return[["log",n.ACTION],["warn",n.ACTION],["error",n.ACTION]]};n.registerNodeType("basic/console",c);x.prototype.onConfigure=function(c){c.properties.onExecute&&
this.compileCode(c.properties.onExecute)};x.title="Script";x.desc="executes a code (max 100 characters)";x.widgets_info={onExecute:{type:"code"}};x.prototype.onPropertyChanged=function(c,d){"onExecute"==c&&n.allow_scripts&&this.compileCode(d)};x.prototype.compileCode=function(c){this._func=null;if(100<c.length)console.warn("Script too long, max 100 chars");else{for(var d=c.toLowerCase(),k="script body document eval nodescript function".split(" "),n=0;n<k.length;++n)if(-1!=d.indexOf(k[n])){console.warn("invalid script");
return}try{this._func=new Function("A","B","C","DATA","node",c)}catch(g){console.error("Error parsing script"),console.error(g)}}};x.prototype.onExecute=function(){if(this._func)try{var c=this.getInputData(0),d=this.getInputData(1),k=this.getInputData(2);this.setOutputData(0,this._func(c,d,k,this.data,this))}catch(n){console.error("Error in script"),console.error(n)}};x.prototype.onGetOutputs=function(){return[["C",""]]};n.registerNodeType("basic/script",x)})(this);
(function(u){function d(){this.size=[60,20];this.addInput("event",w.ACTION)}function l(){this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.size=[120,30];this.flags={horizontal:!0,render_box:!1}}function q(){this.size=[60,20];
this.addInput("event",w.ACTION);this.addOutput("event",w.EVENT);this.properties={equal_to:"",has_property:"",property_equal_to:""}}function g(){this.addInput("inc",w.ACTION);this.addInput("dec",w.ACTION);this.addInput("reset",w.ACTION);this.addOutput("change",w.EVENT);this.addOutput("num","number");this.num=0}function s(){this.size=[60,20];this.addProperty("time_in_ms",1E3);this.addInput("event",w.ACTION);this.addOutput("on_time",w.EVENT);this._pending=[]}function m(){this.addProperty("interval",
1E3);this.addProperty("event","tick");this.addOutput("on_tick",w.EVENT);this.time=0;this.last_interval=1E3;this.triggered=!1}var w=u.LiteGraph;d.title="Log Event";d.desc="Log event in console";d.prototype.onAction=function(d,g){console.log(d,g)};w.registerNodeType("events/log",d);l.title="Sequencer";l.desc="Trigger events when an event arrives";l.prototype.getTitle=function(){return""};l.prototype.onAction=function(d,g){if(this.outputs)for(var m=0;m<this.outputs.length;++m)this.triggerSlot(m,g)};
w.registerNodeType("events/sequencer",l);q.title="Filter Event";q.desc="Blocks events that do not match the filter";q.prototype.onAction=function(d,g){if(null!=g&&(!this.properties.equal_to||this.properties.equal_to==g)){if(this.properties.has_property){var m=g[this.properties.has_property];if(null==m||this.properties.property_equal_to&&this.properties.property_equal_to!=m)return}this.triggerSlot(0,g)}};w.registerNodeType("events/filter",q);g.title="Counter";g.desc="Counts events";g.prototype.onAction=
function(d,g){var m=this.num;"inc"==d?this.num+=1:"dec"==d?this.num-=1:"reset"==d&&(this.num=0);this.num!=m&&this.trigger("change",this.num)};g.prototype.onDrawBackground=function(d){this.flags.collapsed||(d.fillStyle="#AAA",d.font="20px Arial",d.textAlign="center",d.fillText(this.num,0.5*this.size[0],0.5*this.size[1]))};g.prototype.onExecute=function(){this.setOutputData(1,this.num)};w.registerNodeType("events/counter",g);s.title="Delay";s.desc="Delays one event";s.prototype.onAction=function(d,
g){var m=this.properties.time_in_ms;0>=m?this.trigger(null,g):this._pending.push([m,g])};s.prototype.onExecute=function(){var d=1E3*this.graph.elapsed_time;this.isInputConnected(1)&&(this.properties.time_in_ms=this.getInputData(1));for(var g=0;g<this._pending.length;++g){var m=this._pending[g];m[0]-=d;0<m[0]||(this._pending.splice(g,1),--g,this.trigger(null,m[1]))}};s.prototype.onGetInputs=function(){return[["event",w.ACTION],["time_in_ms","number"]]};w.registerNodeType("events/delay",s);m.title=
...
(function(u){function d(){this.addOutput("",y.EVENT);this.addProperty("text","click me");this.addProperty("font_size",30);this.addProperty("message","");this.size=[164,84]}function l(){this.addInput("","boolean");this.addInput("e",y.ACTION);this.addOutput("v","boolean");this.addOutput("e",y.EVENT);this.properties={font:"",value:!1};this.size=[124,64]}function q(){this.addOutput("","number");this.size=[74,54];this.properties={min:-1E3,max:1E3,value:1,step:1};this.old_y=-1;this._precision=this._remainder=
0;this.mouse_captured=!1}function g(){this.addOutput("","number");this.size=[64,84];this.properties={min:0,max:1,value:0.5,color:"#7AF",precision:2};this.value=-1}function s(){this.addOutput("","number");this.properties={value:0.5,min:0,max:1,text:"V"};var c=this;this.size=[80,60];this.slider=this.addWidget("slider","V",this.properties.value,function(d){c.properties.value=d},this.properties)}function m(){this.size=[160,26];this.addOutput("","number");this.properties={color:"#7AF",min:0,max:1,value:0.5};
...
0.5*this.size[1]+0.3*g);c.textAlign="left"}};d.prototype.onMouseDown=function(c,d){if(1<d[0]&&1<d[1]&&d[0]<this.size[0]-2&&d[1]<this.size[1]-2)return this.clicked=!0,this.trigger("clicked",this.properties.message),!0};d.prototype.onMouseUp=function(c){this.clicked=!1};y.registerNodeType("widget/button",d);l.title="Toggle";l.desc="Toggles between true or false";l.prototype.onDrawForeground=function(c){if(!this.flags.collapsed){var d=0.5*this.size[1],n=0.8*this.size[1];c.fillStyle="#AAA";c.fillRect(10,
n-d,d,d);c.fillStyle=this.properties.value?"#AEF":"#000";c.fillRect(10+0.25*d,n-d+0.25*d,0.5*d,0.5*d);c.textAlign="left";c.font=this.properties.font||(0.8*d).toFixed(0)+"px Arial";c.fillStyle="#AAA";c.fillText(this.title,d+20,0.85*n);c.textAlign="left"}};l.prototype.onAction=function(c){this.properties.value=!this.properties.value;this.trigger("e",this.properties.value)};l.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.properties.value=c);this.setOutputData(0,this.properties.value)};
l.prototype.onMouseDown=function(c,d){if(1<d[0]&&1<d[1]&&d[0]<this.size[0]-2&&d[1]<this.size[1]-2)return this.properties.value=!this.properties.value,this.graph._version++,this.trigger("e",this.properties.value),!0};y.registerNodeType("widget/toggle",l);q.title="Number";q.desc="Widget to select number value";q.pixels_threshold=10;q.markers_color="#666";q.prototype.onDrawForeground=function(c){var d=0.5*this.size[0],n=this.size[1];30<n?(c.fillStyle=q.markers_color,c.beginPath(),c.moveTo(d,0.1*n),c.lineTo(d+
0.1*n,0.2*n),c.lineTo(d+-0.1*n,0.2*n),c.fill(),c.beginPath(),c.moveTo(d,0.9*n),c.lineTo(d+0.1*n,0.8*n),c.lineTo(d+-0.1*n,0.8*n),c.fill(),c.font=(0.7*n).toFixed(1)+"px Arial"):c.font=(0.8*n).toFixed(1)+"px Arial";c.textAlign="center";c.font=(0.7*n).toFixed(1)+"px Arial";c.fillStyle="#EEE";c.fillText(this.properties.value.toFixed(this._precision),d,0.75*n)};q.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};q.prototype.onPropertyChanged=function(c,d){var n=(this.properties.step+
"").split(".");this._precision=1<n.length?n[1].length:0};q.prototype.onMouseDown=function(c,d){if(!(0>d[1]))return this.old_y=c.canvasY,this.captureInput(!0),this.mouse_captured=!0};q.prototype.onMouseMove=function(c){if(this.mouse_captured){var d=this.old_y-c.canvasY;c.shiftKey&&(d*=10);if(c.metaKey||c.altKey)d*=0.1;this.old_y=c.canvasY;c=this._remainder+d/q.pixels_threshold;this._remainder=c%1;c=Math.clamp(this.properties.value+(c|0)*this.properties.step,this.properties.min,this.properties.max);
this.properties.value=c;this.graph._version++;this.setDirtyCanvas(!0)}};q.prototype.onMouseUp=function(c,d){200>c.click_time&&(this.properties.value=Math.clamp(this.properties.value+(d[1]>0.5*this.size[1]?-1:1)*this.properties.step,this.properties.min,this.properties.max),this.graph._version++,this.setDirtyCanvas(!0));this.mouse_captured&&(this.mouse_captured=!1,this.captureInput(!1))};y.registerNodeType("widget/number",q);g.title="Knob";g.desc="Circular controller";g.size=[80,100];g.prototype.onDrawForeground=
function(c){if(!this.flags.collapsed){-1==this.value&&(this.value=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min));var d=0.5*this.size[0],n=0.5*this.size[1],f=0.5*Math.min(this.size[0],this.size[1])-5;c.globalAlpha=1;c.save();c.translate(d,n);c.rotate(0.75*Math.PI);c.fillStyle="rgba(0,0,0,0.5)";c.beginPath();c.moveTo(0,0);c.arc(0,0,f,0,1.5*Math.PI);c.fill();c.strokeStyle="black";c.fillStyle=this.properties.color;c.lineWidth=2;c.beginPath();c.moveTo(0,0);c.arc(0,
0,f-4,0,1.5*Math.PI*Math.max(0.01,this.value));c.closePath();c.fill();c.lineWidth=1;c.globalAlpha=1;c.restore();c.fillStyle="black";c.beginPath();c.arc(d,n,0.75*f,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":this.properties.color;c.beginPath();var g=this.value*Math.PI*1.5+0.75*Math.PI;c.arc(d+Math.cos(g)*f*0.65,n+Math.sin(g)*f*0.65,0.05*f,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":"#AAA";c.font=Math.floor(0.5*f)+"px Arial";c.textAlign="center";c.fillText(this.properties.value.toFixed(this.properties.precision),
d,n+0.15*f)}};g.prototype.onExecute=function(){this.setOutputData(0,this.properties.value);this.boxcolor=y.colorToString([this.value,this.value,this.value])};g.prototype.onMouseDown=function(c){this.center=[0.5*this.size[0],0.5*this.size[1]+20];this.radius=0.5*this.size[0];if(20>c.canvasY-this.pos[1]||y.distance([c.canvasX,c.canvasY],[this.pos[0]+this.center[0],this.pos[1]+this.center[1]])>this.radius)return!1;this.oldmouse=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];this.captureInput(!0);return!0};
g.prototype.onMouseMove=function(c){if(this.oldmouse){c=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];var d=this.value,d=d-0.01*(c[1]-this.oldmouse[1]);1<d?d=1:0>d&&(d=0);this.value=d;this.properties.value=this.properties.min+(this.properties.max-this.properties.min)*this.value;this.oldmouse=c;this.setDirtyCanvas(!0)}};g.prototype.onMouseUp=function(c){this.oldmouse&&(this.oldmouse=null,this.captureInput(!1))};g.prototype.onPropertyChanged=function(c,d){if("min"==c||"max"==c||"value"==c)return this.properties[c]=
parseFloat(d),!0};y.registerNodeType("widget/knob",g);s.title="Internal Slider";s.prototype.onPropertyChanged=function(c,d){"value"==c&&(this.slider.value=d)};s.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};y.registerNodeType("widget/internal_slider",s);m.title="H.Slider";m.desc="Linear slider controller";m.prototype.onDrawForeground=function(c){-1==this.value&&(this.value=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min));c.globalAlpha=
1;c.lineWidth=1;c.fillStyle="#000";c.fillRect(2,2,this.size[0]-4,this.size[1]-4);c.fillStyle=this.properties.color;c.beginPath();c.rect(4,4,(this.size[0]-8)*this.value,this.size[1]-8);c.fill()};m.prototype.onExecute=function(){this.properties.value=this.properties.min+(this.properties.max-this.properties.min)*this.value;this.setOutputData(0,this.properties.value);this.boxcolor=y.colorToString([this.value,this.value,this.value])};m.prototype.onMouseDown=function(c){if(0>c.canvasY-this.pos[1])return!1;
this.oldmouse=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];this.captureInput(!0);return!0};m.prototype.onMouseMove=function(c){if(this.oldmouse){c=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];var d=this.value,d=d+(c[0]-this.oldmouse[0])/this.size[0];1<d?d=1:0>d&&(d=0);this.value=d;this.oldmouse=c;this.setDirtyCanvas(!0)}};m.prototype.onMouseUp=function(c){this.oldmouse=null;this.captureInput(!1)};m.prototype.onMouseLeave=function(c){};y.registerNodeType("widget/hslider",m);w.title="Progress";w.desc=
"Shows data in linear progress";w.prototype.onExecute=function(){var c=this.getInputData(0);void 0!=c&&(this.properties.value=c)};w.prototype.onDrawForeground=function(c){c.lineWidth=1;c.fillStyle=this.properties.color;var d=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min),d=Math.min(1,d),d=Math.max(0,d);c.fillRect(2,2,(this.size[0]-4)*d,this.size[1]-4)};y.registerNodeType("widget/progress",w);B.title="Text";B.desc="Shows the input value";B.widgets=[{name:"resize",
text:"Resize box",type:"button"},{name:"led_text",text:"LED",type:"minibutton"},{name:"normal_text",text:"Normal",type:"minibutton"}];B.prototype.onDrawForeground=function(c){c.fillStyle=this.properties.color;var d=this.properties.value;this.properties.glowSize?(c.shadowColor=this.properties.color,c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=this.properties.glowSize):c.shadowColor="transparent";var n=this.properties.fontsize;c.textAlign=this.properties.align;c.font=n.toString()+"px "+this.properties.font;
this.str="number"==typeof d?d.toFixed(this.properties.decimals):d;if("string"==typeof this.str){var d=this.str.split("\\n"),f;for(f in d)c.fillText(d[f],"left"==this.properties.align?15:this.size[0]-15,-0.15*n+n*(parseInt(f)+1))}c.shadowColor="transparent";this.last_ctx=c;c.textAlign="left"};B.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.properties.value=c)};B.prototype.resize=function(){if(this.last_ctx){var c=this.str.split("\\n");this.last_ctx.font=this.properties.fontsize+
"px "+this.properties.font;var d=0,n;for(n in c){var f=this.last_ctx.measureText(c[n]).width;d<f&&(d=f)}this.size[0]=d+20;this.size[1]=4+c.length*this.properties.fontsize;this.setDirtyCanvas(!0)}};B.prototype.onPropertyChanged=function(c,d){this.properties[c]=d;this.str="number"==typeof d?d.toFixed(3):d;return!0};y.registerNodeType("widget/text",B);z.title="Panel";z.desc="Non interactive panel";z.widgets=[{name:"update",text:"Update",type:"button"}];z.prototype.createGradient=function(c){""==this.properties.bgcolorTop||
""==this.properties.bgcolorBottom?this.lineargradient=0:(this.lineargradient=c.createLinearGradient(0,0,0,this.size[1]),this.lineargradient.addColorStop(0,this.properties.bgcolorTop),this.lineargradient.addColorStop(1,this.properties.bgcolorBottom))};z.prototype.onDrawForeground=function(c){null==this.lineargradient&&this.createGradient(c);this.lineargradient&&(c.lineWidth=1,c.strokeStyle=this.properties.borderColor,c.fillStyle=this.lineargradient,this.properties.shadowSize?(c.shadowColor="#000",
c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=this.properties.shadowSize):c.shadowColor="transparent",c.roundRect(0,0,this.size[0]-1,this.size[1]-1,this.properties.shadowSize),c.fill(),c.shadowColor="transparent",c.stroke())};y.registerNodeType("widget/panel",z)})(this);
(function(u){function d(){this.addOutput("left_x_axis","number");this.addOutput("left_y_axis","number");this.addOutput("button_pressed",l.EVENT);this.properties={gamepad_index:0,threshold:0.1};this._left_axis=new Float32Array(2);this._right_axis=new Float32Array(2);this._triggers=new Float32Array(2);this._previous_buttons=new Uint8Array(17);this._current_buttons=new Uint8Array(17)}var l=u.LiteGraph;d.title="Gamepad";d.desc="gets the input of the gamepad";d.CENTER=0;d.LEFT=1;d.RIGHT=2;d.UP=4;d.DOWN=
8;d.zero=new Float32Array(2);d.buttons="a b x y lb rb lt rt back start ls rs home".split(" ");d.prototype.onExecute=function(){var l=this.getGamepad(),g=this.properties.threshold||0;l&&(this._left_axis[0]=Math.abs(l.xbox.axes.lx)>g?l.xbox.axes.lx:0,this._left_axis[1]=Math.abs(l.xbox.axes.ly)>g?l.xbox.axes.ly:0,this._right_axis[0]=Math.abs(l.xbox.axes.rx)>g?l.xbox.axes.rx:0,this._right_axis[1]=Math.abs(l.xbox.axes.ry)>g?l.xbox.axes.ry:0,this._triggers[0]=Math.abs(l.xbox.axes.ltrigger)>g?l.xbox.axes.ltrigger:
0,this._triggers[1]=Math.abs(l.xbox.axes.rtrigger)>g?l.xbox.axes.rtrigger:0);if(this.outputs)for(g=0;g<this.outputs.length;g++){var s=this.outputs[g];if(s.links&&s.links.length){var m=null;if(l)switch(s.name){case "left_axis":m=this._left_axis;break;case "right_axis":m=this._right_axis;break;case "left_x_axis":m=this._left_axis[0];break;case "left_y_axis":m=this._left_axis[1];break;case "right_x_axis":m=this._right_axis[0];break;case "right_y_axis":m=this._right_axis[1];break;case "trigger_left":m=
this._triggers[0];break;case "trigger_right":m=this._triggers[1];break;case "a_button":m=l.xbox.buttons.a?1:0;break;case "b_button":m=l.xbox.buttons.b?1:0;break;case "x_button":m=l.xbox.buttons.x?1:0;break;case "y_button":m=l.xbox.buttons.y?1:0;break;case "lb_button":m=l.xbox.buttons.lb?1:0;break;case "rb_button":m=l.xbox.buttons.rb?1:0;break;case "ls_button":m=l.xbox.buttons.ls?1:0;break;case "rs_button":m=l.xbox.buttons.rs?1:0;break;case "hat_left":m=l.xbox.hatmap&d.LEFT;break;case "hat_right":m=
l.xbox.hatmap&d.RIGHT;break;case "hat_up":m=l.xbox.hatmap&d.UP;break;case "hat_down":m=l.xbox.hatmap&d.DOWN;break;case "hat":m=l.xbox.hatmap;break;case "start_button":m=l.xbox.buttons.start?1:0;break;case "back_button":m=l.xbox.buttons.back?1:0;break;case "button_pressed":for(s=0;s<this._current_buttons.length;++s)this._current_buttons[s]&&!this._previous_buttons[s]&&this.triggerSlot(g,d.buttons[s])}else switch(s.name){case "button_pressed":break;case "left_axis":case "right_axis":m=d.zero;break;
default:m=0}this.setOutputData(g,m)}}};d.prototype.getGamepad=function(){var l=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!l)return null;var g=l.call(navigator),l=null;this._previous_buttons.set(this._current_buttons);for(l=this.properties.gamepad_index;4>l;l++)if(g[l]){l=g[l];g=this.xbox_mapping;g||(g=this.xbox_mapping={axes:[],buttons:{},hat:"",hatmap:d.CENTER});g.axes.lx=l.axes[0];g.axes.ly=l.axes[1];g.axes.rx=l.axes[2];g.axes.ry=l.axes[3];g.axes.ltrigger=l.buttons[6].value;
g.axes.rtrigger=l.buttons[7].value;g.hat="";g.hatmap=d.CENTER;for(var s=0;s<l.buttons.length;s++)switch(this._current_buttons[s]=l.buttons[s].pressed,s){case 0:g.buttons.a=l.buttons[s].pressed;break;case 1:g.buttons.b=l.buttons[s].pressed;break;case 2:g.buttons.x=l.buttons[s].pressed;break;case 3:g.buttons.y=l.buttons[s].pressed;break;case 4:g.buttons.lb=l.buttons[s].pressed;break;case 5:g.buttons.rb=l.buttons[s].pressed;break;case 6:g.buttons.lt=l.buttons[s].pressed;break;case 7:g.buttons.rt=l.buttons[s].pressed;
break;case 8:g.buttons.back=l.buttons[s].pressed;break;case 9:g.buttons.start=l.buttons[s].pressed;break;case 10:g.buttons.ls=l.buttons[s].pressed;break;case 11:g.buttons.rs=l.buttons[s].pressed;break;case 12:l.buttons[s].pressed&&(g.hat+="up",g.hatmap|=d.UP);break;case 13:l.buttons[s].pressed&&(g.hat+="down",g.hatmap|=d.DOWN);break;case 14:l.buttons[s].pressed&&(g.hat+="left",g.hatmap|=d.LEFT);break;case 15:l.buttons[s].pressed&&(g.hat+="right",g.hatmap|=d.RIGHT);break;case 16:g.buttons.home=l.buttons[s].pressed}l.xbox=
g;return l}};d.prototype.onDrawBackground=function(d){if(!this.flags.collapsed){var g=this._left_axis,l=this._right_axis;d.strokeStyle="#88A";d.strokeRect(0.5*(g[0]+1)*this.size[0]-4,0.5*(g[1]+1)*this.size[1]-4,8,8);d.strokeStyle="#8A8";d.strokeRect(0.5*(l[0]+1)*this.size[0]-4,0.5*(l[1]+1)*this.size[1]-4,8,8);g=this.size[1]/this._current_buttons.length;d.fillStyle="#AEB";for(l=0;l<this._current_buttons.length;++l)this._current_buttons[l]&&d.fillRect(0,g*l,6,g)}};d.prototype.onGetOutputs=function(){return[["left_axis",
...
(function(u){function d(){this.addInput("in","*");this.size=[60,20]}function l(){this.addInput("in");this.addOutput("out");this.size=[60,20]}function q(){this.addInput("in");this.addOutput("out")}function g(){this.addInput("in","number",{locked:!0});this.addOutput("out","number",{locked:!0});this.addProperty("in",0);this.addProperty("in_min",0);this.addProperty("in_max",1);this.addProperty("out_min",0);this.addProperty("out_max",1);this.size=[80,20]}function s(){this.addOutput("value","number");this.addProperty("min",
...
20];this.addProperty("min",0);this.addProperty("max",1)}function z(){this.properties={f:0.5};this.addInput("A","number");this.addInput("B","number");this.addOutput("out","number")}function y(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20]}function c(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20]}function x(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20]}function n(){this.addInput("in","number");this.addOutput("out",
"number");this.size=[60,20];this.properties={A:0,B:1}}function f(){this.addInput("in","number",{label:""});this.addOutput("out","number",{label:""});this.size=[60,20];this.addProperty("factor",1)}function A(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20];this.addProperty("samples",10);this._values=new Float32Array(10);this._current=0}function k(){this.addInput("in","number");this.addOutput("out","number");this.addProperty("factor",0.1);this.size=[60,20];this._value=
null}function t(){this.addInput("A","number");this.addInput("B","number");this.addOutput("=","number");this.addProperty("A",1);this.addProperty("B",1);this.addProperty("OP","+","enum",{values:t.values})}function v(){this.addInput("A","number");this.addInput("B","number");this.addOutput("A==B","boolean");this.addOutput("A!=B","boolean");this.addProperty("A",0);this.addProperty("B",0)}function a(){this.addInput("A","number");this.addInput("B","number");this.addOutput("out","boolean");this.addProperty("A",
1);this.addProperty("B",1);this.addProperty("OP",">","string",{values:a.values});this.size=[60,40]}function b(){this.addInput("inc","number");this.addOutput("total","number");this.addProperty("increment",1);this.addProperty("value",0)}function e(){this.addInput("v","number");this.addOutput("sin","number");this.addProperty("amplitude",1);this.addProperty("offset",0);this.bgImageUrl="nodes/imgs/icon-sin.png"}function r(){this.addInput("x","number");this.addInput("y","number");this.addOutput("","number");
this.properties={x:1,y:1,formula:"x+y"};this.code_widget=this.addWidget("text","F(x,y)",this.properties.formula,function(a,b,e){e.properties.formula=a});this.addWidget("toggle","allow",p.allow_scripts,function(a){p.allow_scripts=a});this._func=null}function h(){this.addInput("vec2","vec2");this.addOutput("x","number");this.addOutput("y","number")}function G(){this.addInputs([["x","number"],["y","number"]]);this.addOutput("vec2","vec2");this.properties={x:0,y:0};this._data=new Float32Array(2)}function J(){this.addInput("vec3",
...
break;case "vec4":c=4}c=new Float32Array(c);if(a.length)for(e=0;e<a.length&&e<c.length;e++)c[e]=a[e];else c[0]=parseFloat(a)}this.setOutputData(b,c)}}};d.prototype.onGetOutputs=function(){return[["number","number"],["vec2","vec2"],["vec3","vec3"],["vec4","vec4"]]};p.registerNodeType("math/converter",d);l.title="Bypass";l.desc="removes the type";l.prototype.onExecute=function(){var a=this.getInputData(0);this.setOutputData(0,a)};p.registerNodeType("math/bypass",l);q.title="to Number";q.desc="Cast to number";
...
"COS()",{outputs:[["cos","number"]],title:"COS()"});p.registerSearchboxExtra("math/trigonometry","TAN()",{outputs:[["tan","number"]],title:"TAN()"});r.title="Formula";r.desc="Compute formula";r.size=[160,100];A.prototype.onPropertyChanged=function(a,b){"formula"==a&&(this.code_widget.value=b)};r.prototype.onExecute=function(){if(p.allow_scripts){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.x=a:a=this.properties.x;null!=b?this.properties.y=b:b=this.properties.y;var e;try{this._func&&
this._func_code==this.properties.formula||(this._func=new Function("x","y","TIME","return "+this.properties.formula),this._func_code=this.properties.formula),e=this._func(a,b,this.graph.globaltime),this.boxcolor=null}catch(c){this.boxcolor="red"}this.setOutputData(0,e)}};r.prototype.getTitle=function(){return this._func_code||"Formula"};r.prototype.onDrawBackground=function(){var a=this.properties.formula;this.outputs&&this.outputs.length&&(this.outputs[0].label=a)};p.registerNodeType("math/formula",
r);h.title="Vec2->XY";h.desc="vector 2 to components";h.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]))};p.registerNodeType("math3d/vec2-to-xyz",h);G.title="XY->Vec2";G.desc="components to vector2";G.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var e=this._data;e[0]=a;e[1]=b;this.setOutputData(0,e)};p.registerNodeType("math3d/xy-to-vec2",
...
"Vec2->XY";d.desc="vector 2 to components";d.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.setOutputData(0,c[0]),this.setOutputData(1,c[1]))};x.registerNodeType("math3d/vec2-to-xyz",d);l.title="XY->Vec2";l.desc="components to vector2";l.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.x);var d=this.getInputData(1);null==d&&(d=this.properties.y);var g=this._data;g[0]=c;g[1]=d;this.setOutputData(0,g)};x.registerNodeType("math3d/xy-to-vec2",
...
var k=this._data;k[0]=c;k[1]=d;k[2]=g;this.setOutputData(0,k)};x.registerNodeType("math3d/xyz-to-vec3",g);s.title="Vec4->XYZW";s.desc="vector 4 to components";s.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.setOutputData(0,c[0]),this.setOutputData(1,c[1]),this.setOutputData(2,c[2]),this.setOutputData(3,c[3]))};x.registerNodeType("math3d/vec4-to-xyzw",s);m.title="XYZW->Vec4";m.desc="components to vector4";m.prototype.onExecute=function(){var c=this.getInputData(0);null==
c&&(c=this.properties.x);var d=this.getInputData(1);null==d&&(d=this.properties.y);var g=this.getInputData(2);null==g&&(g=this.properties.z);var k=this.getInputData(3);null==k&&(k=this.properties.w);var m=this._data;m[0]=c;m[1]=d;m[2]=g;m[3]=k;this.setOutputData(0,m)};x.registerNodeType("math3d/xyzw-to-vec4",m);w.title="vec3_scale";w.desc="scales the components of a vec3";w.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var d=this.getInputData(1);null==d&&(d=this.properties.f);
...
Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),g=this._data;g[0]=c[0]/d;g[1]=c[1]/d;g[2]=c[2]/d;this.setOutputData(0,g)}};x.registerNodeType("math3d/vec3-normalize",z);y.title="vec3_lerp";y.desc="returns the interpolated vector";y.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var d=this.getInputData(1);if(null!=d){var g=this.getInputOrProperty("f"),k=this._data;k[0]=c[0]*(1-g)+d[0]*g;k[1]=c[1]*(1-g)+d[1]*g;k[2]=c[2]*(1-g)+d[2]*g;this.setOutputData(0,k)}}};x.registerNodeType("math3d/vec3-lerp",
...
(function(u){function d(d,g){return d==g}function l(d){return null!=d&&d.constructor===String?d.toUpperCase():d}u=u.LiteGraph;u.wrapFunctionAsNode("string/toString",d,["*"],"String");u.wrapFunctionAsNode("string/compare",d,["String","String"],"Boolean");u.wrapFunctionAsNode("string/concatenate",function(d,g){return void 0===d?g:void 0===g?d:d+g},["String","String"],"String");u.wrapFunctionAsNode("string/contains",function(d,g){return void 0===d||void 0===g?!1:-1!=d.indexOf(g)},["String","String"],
"Boolean");u.wrapFunctionAsNode("string/toUpperCase",l,["String"],"String");u.wrapFunctionAsNode("string/split",l,["String","String"],"Array")})(this);
...
var l=(this.selected+1)*q.NODE_SLOT_HEIGHT+6;d.beginPath();d.moveTo(50,l);d.lineTo(50,l+q.NODE_SLOT_HEIGHT);d.lineTo(34,l+0.5*q.NODE_SLOT_HEIGHT);d.fill()}};d.prototype.onExecute=function(){var d=this.getInputData(0);null==d&&(d=0);this.selected=d=Math.round(d)%(this.inputs.length-1);d=this.getInputData(d+1);void 0!==d&&this.setOutputData(0,d)};d.prototype.onGetInputs=function(){return[["E",0],["F",0],["G",0],["H",0]]};q.registerNodeType("logic/selector",d);l.title="Sequence";l.desc="select one element from a sequence from a string";
l.prototype.onPropertyChanged=function(d,l){"sequence"==d&&(this.values=l.split(","))};l.prototype.onExecute=function(){var d=this.getInputData(1);d&&d!=this.current_sequence&&(this.values=d.split(","),this.current_sequence=d);d=this.getInputData(0);null==d&&(d=0);this.index=d=Math.round(d)%this.values.length;this.setOutputData(0,this.values[d])};q.registerNodeType("logic/sequence",l)})(this);
...
this.properties.scale,k=d.colors,m=0.5*f[1];c.fillStyle="#000";c.fillRect(0,0,f[0],f[1]);c.strokeStyle="#555";c.beginPath();c.moveTo(0,m);c.lineTo(f[0],m);c.stroke();if(this.inputs)for(var l=0;4>l;++l){var a=this.values[l];if(this.inputs[l]&&this.inputs[l].link){c.strokeStyle=k[l];c.beginPath();var b=a[0]*g*-1+m;c.moveTo(0,Math.clamp(b,0,f[1]));for(var e=1;e<a.length&&e<f[0];++e)b=a[e]*g*-1+m,c.lineTo(e,Math.clamp(b,0,f[1]));c.stroke()}}}};x.registerNodeType("graphics/plot",d);l.title="Image";l.desc=
"Image loader";l.widgets=[{name:"load",text:"Load",type:"button"}];l.supported_extensions=["jpg","jpeg","png","gif"];l.prototype.onAdded=function(){""!=this.properties.url&&null==this.img&&this.loadImage(this.properties.url)};l.prototype.onDrawBackground=function(c){this.flags.collapsed||this.img&&5<this.size[0]&&5<this.size[1]&&c.drawImage(this.img,0,0,this.size[0],this.size[1])};l.prototype.onExecute=function(){this.img||(this.boxcolor="#000");this.img&&this.img.width?this.setOutputData(0,this.img):
this.setOutputData(0,null);this.img&&this.img.dirty&&(this.img.dirty=!1)};l.prototype.onPropertyChanged=function(c,d){this.properties[c]=d;"url"==c&&""!=d&&this.loadImage(d);return!0};l.prototype.loadImage=function(c,d){if(""==c)this.img=null;else{this.img=document.createElement("img");"http"==c.substr(0,4)&&x.proxy&&(c=x.proxy+c.substr(c.indexOf(":")+3));this.img.src=c;this.boxcolor="#F95";var g=this;this.img.onload=function(){d&&d(this);g.trace("Image loaded, size: "+g.img.width+"x"+g.img.height);
this.dirty=!0;g.boxcolor="#9F9";g.setDirtyCanvas(!0)}}};l.prototype.onWidget=function(c,d){"load"==d.name&&this.loadImage(this.properties.url)};l.prototype.onDropFile=function(c){var d=this;this._url&&URL.revokeObjectURL(this._url);this._url=URL.createObjectURL(c);this.properties.url=this._url;this.loadImage(this._url,function(c){d.size[1]=c.height/c.width*d.size[0]})};x.registerNodeType("graphics/image",l);q.title="Palette";q.desc="Generates a color";q.prototype.onExecute=function(){var c=[];null!=
this.properties.colorA&&c.push(hex2num(this.properties.colorA));null!=this.properties.colorB&&c.push(hex2num(this.properties.colorB));null!=this.properties.colorC&&c.push(hex2num(this.properties.colorC));null!=this.properties.colorD&&c.push(hex2num(this.properties.colorD));var d=this.getInputData(0);null==d&&(d=0.5);1<d?d=1:0>d&&(d=0);if(0!=c.length){var g=[0,0,0];if(0==d)g=c[0];else if(1==d)g=c[c.length-1];else{var k=(c.length-1)*d,d=c[Math.floor(k)],c=c[Math.floor(k)+1],k=k-Math.floor(k);g[0]=d[0]*
...
type:"button"},{name:"resizeB",text:"Resize to B",type:"button"}];s.prototype.onAdded=function(){this.createCanvas();var c=this.canvas.getContext("2d");c.fillStyle="#000";c.fillRect(0,0,this.properties.width,this.properties.height)};s.prototype.createCanvas=function(){this.canvas=document.createElement("canvas");this.canvas.width=this.properties.width;this.canvas.height=this.properties.height};s.prototype.onExecute=function(){var c=this.canvas.getContext("2d");this.canvas.width=this.canvas.width;
var d=this.getInputData(0);null!=d&&c.drawImage(d,0,0,this.canvas.width,this.canvas.height);d=this.getInputData(2);null==d?d=this.properties.fade:this.properties.fade=d;c.globalAlpha=d;d=this.getInputData(1);null!=d&&c.drawImage(d,0,0,this.canvas.width,this.canvas.height);c.globalAlpha=1;this.setOutputData(0,this.canvas);this.setDirtyCanvas(!0)};x.registerNodeType("graphics/imagefade",s);m.title="Crop";m.desc="Crop Image";m.prototype.onAdded=function(){this.createCanvas()};m.prototype.createCanvas=
...
0;c.width!=d&&(c.width=d);c.height!=g&&(c.height=g);this.properties.autoclear&&this.ctx.clearRect(0,0,c.width,c.height);this.setOutputData(0,c)};w.prototype.onAction=function(c,d){"clear"==c&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)};x.registerNodeType("graphics/canvas",w);B.title="DrawImage";B.desc="Draws image into a canvas";B.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var d=this.getInputOrProperty("img");if(d){var g=this.getInputOrProperty("x"),k=this.getInputOrProperty("y");
c.getContext("2d").drawImage(d,g,k)}}};x.registerNodeType("graphics/drawImage",B);z.title="DrawRectangle";z.desc="Draws rectangle in canvas";z.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var d=this.getInputOrProperty("x"),g=this.getInputOrProperty("y"),k=this.getInputOrProperty("w"),m=this.getInputOrProperty("h");c.getContext("2d").fillRect(d,g,k,m)}};x.registerNodeType("graphics/drawRectangle",z);y.title="Video";y.desc="Video playback";y.widgets=[{name:"play",text:"PLAY",type:"minibutton"},
...
2;l.MODE_VALUES={"pass through":l.PASS_THROUGH,copy:l.COPY,low:l.LOW,high:l.HIGH,reuse:l.REUSE,"default":l.DEFAULT};l.getTexturesContainer=function(){return gl.textures};l.loadTexture=function(a,b){b=b||{};var e=a;"http://"==e.substr(0,7)&&d.proxy&&(e=d.proxy+e.substr(7));return l.getTexturesContainer()[a]=GL.Texture.fromURL(e,b)};l.getTexture=function(a){var b=this.getTexturesContainer();if(!b)throw"Cannot load texture, container of textures not found";b=b[a];return!b&&a&&":"!=a[0]?this.loadTexture(a):
b};l.getTargetTexture=function(a,b,e){if(!a)throw"LGraphTexture.getTargetTexture expects a reference texture";var c=null;switch(e){case l.LOW:c=gl.UNSIGNED_BYTE;break;case l.HIGH:c=gl.HIGH_PRECISION_FORMAT;break;case l.REUSE:return a;default:c=a?a.type:gl.UNSIGNED_BYTE}b&&b.width==a.width&&b.height==a.height&&b.type==c||(b=new GL.Texture(a.width,a.height,{type:c,format:gl.RGBA,filter:gl.LINEAR}));return b};l.getTextureType=function(a,b){var e=b?b.type:gl.UNSIGNED_BYTE;switch(a){case l.HIGH:e=gl.HIGH_PRECISION_FORMAT;
break;case l.LOW:e=gl.UNSIGNED_BYTE}return e};l.getWhiteTexture=function(){return this._white_texture?this._white_texture:this._white_texture=GL.Texture.fromMemory(1,1,[255,255,255,255],{format:gl.RGBA,wrap:gl.REPEAT,filter:gl.NEAREST})};l.getNoiseTexture=function(){if(this._noise_texture)return this._noise_texture;for(var a=new Uint8Array(1048576),b=0;1048576>b;++b)a[b]=255*Math.random();return this._noise_texture=a=GL.Texture.fromMemory(512,512,a,{format:gl.RGBA,wrap:gl.REPEAT,filter:gl.NEAREST})};
l.prototype.onDropFile=function(a,b,e){if(a){var c=null;"string"==typeof a?c=GL.Texture.fromURL(a):-1!=b.toLowerCase().indexOf(".dds")?c=GL.Texture.fromDDSInMemory(a):(a=new Blob([e]),a=URL.createObjectURL(a),c=GL.Texture.fromURL(a));this._drop_texture=c;this.properties.name=b}else this._drop_texture=null,this.properties.name=""};l.prototype.getExtraMenuOptions=function(a){var b=this;if(this._drop_texture)return[{content:"Clear",callback:function(){b._drop_texture=null;b.properties.name=""}}]};l.prototype.onExecute=
function(){var a=null;this.isOutputConnected(1)&&(a=this.getInputData(0));!a&&this._drop_texture&&(a=this._drop_texture);!a&&this.properties.name&&(a=l.getTexture(this.properties.name));if(a){this._last_tex=a;!1===this.properties.filter?a.setParameter(gl.TEXTURE_MAG_FILTER,gl.NEAREST):a.setParameter(gl.TEXTURE_MAG_FILTER,gl.LINEAR);this.setOutputData(0,a);for(var b=1;b<this.outputs.length;b++){var e=this.outputs[b];if(e){var c=null;"width"==e.name?c=a.width:"height"==e.name?c=a.height:"aspect"==e.name&&
(c=a.width/a.height);this.setOutputData(b,c)}}}};l.prototype.onResourceRenamed=function(a,b){this.properties.name==a&&(this.properties.name=b)};l.prototype.onDrawBackground=function(a){if(!(this.flags.collapsed||20>=this.size[1]))if(this._drop_texture&&a.webgl)a.drawImage(this._drop_texture,0,0,this.size[0],this.size[1]);else{if(this._last_preview_tex!=this._last_tex)if(a.webgl)this._canvas=this._last_tex;else{var b=l.generateLowResTexturePreview(this._last_tex);if(!b)return;this._last_preview_tex=
this._last_tex;this._canvas=cloneCanvas(b)}this._canvas&&(a.save(),a.webgl||(a.translate(0,this.size[1]),a.scale(1,-1)),a.drawImage(this._canvas,0,0,this.size[0],this.size[1]),a.restore())}};l.generateLowResTexturePreview=function(a){if(!a)return null;var b=l.image_preview_size,e=a;if(a.format==gl.DEPTH_COMPONENT)return null;if(a.width>b||a.height>b)e=this._preview_temp_tex,this._preview_temp_tex||(this._preview_temp_tex=e=new GL.Texture(b,b,{minFilter:gl.NEAREST})),a.copyTo(e);a=this._preview_canvas;
a||(this._preview_canvas=a=createCanvas(b,b));e&&e.toCanvas(a);return a};l.prototype.getResources=function(a){a[this.properties.name]=GL.Texture;return a};l.prototype.onGetInputs=function(){return[["in","Texture"]]};l.prototype.onGetOutputs=function(){return[["width","number"],["height","number"],["aspect","number"]]};d.registerNodeType("texture/texture",l);var q=function(){this.addInput("Texture","Texture");this.properties={flipY:!1};this.size=[l.image_preview_size,l.image_preview_size]};q.title=
...
"Texture");this.properties={name:""}};g.title="Save";g.desc="Save a texture in the repository";g.prototype.onExecute=function(){var a=this.getInputData(0);a&&(this.properties.name&&(l.storeTexture?l.storeTexture(this.properties.name,a):l.getTexturesContainer()[this.properties.name]=a),this.setOutputData(0,a))};d.registerNodeType("texture/save",g);var s=function(){this.addInput("Texture","Texture");this.addInput("TextureB","Texture");this.addInput("value","number");this.addOutput("Texture","Texture");
this.help="<p>pixelcode must be vec3</p>\t\t\t<p>uvcode must be vec2, is optional</p>\t\t\t<p><strong>uv:</strong> tex. coords</p><p><strong>color:</strong> texture</p><p><strong>colorB:</strong> textureB</p><p><strong>time:</strong> scene time</p><p><strong>value:</strong> input value</p>";this.properties={value:1,uvcode:"",pixelcode:"color + colorB * value",precision:l.DEFAULT}};s.widgets_info={uvcode:{widget:"textarea",height:100},pixelcode:{widget:"textarea",height:100},precision:{widget:"combo",
...
this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,a);else{var b=this.getInputData(1);if(this.properties.uvcode||this.properties.pixelcode){var e=512,c=512;a?(e=a.width,c=a.height):b&&(e=b.width,c=b.height);var d=l.getTextureType(this.properties.precision,a);this._tex=a||this._tex?l.getTargetTexture(a||this._tex,this._tex,this.properties.precision):new GL.Texture(e,c,{type:d,format:gl.RGBA,filter:gl.LINEAR});d="";this.properties.uvcode&&
(d="uv = "+this.properties.uvcode,-1!=this.properties.uvcode.indexOf(";")&&(d=this.properties.uvcode));var k="";this.properties.pixelcode&&(k="result = "+this.properties.pixelcode,-1!=this.properties.pixelcode.indexOf(";")&&(k=this.properties.pixelcode));var f=this._shader;if(!f||this._shader_code!=d+"|"+k){try{this._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,s.pixel_shader,{UV_CODE:d,PIXEL_CODE:k}),this.boxcolor="#00FF00"}catch(g){console.log("Error compiling shader: ",g);this.boxcolor="#FF0000";
return}this.boxcolor="#FF0000";this._shader_code=d+"|"+k;f=this._shader}if(f){this.boxcolor="green";var h=this.getInputData(2);null!=h?this.properties.value=h:h=parseFloat(this.properties.value);var m=this.graph.getTime();this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a&&a.bind(0);b&&b.bind(1);var d=Mesh.getScreenQuad();f.uniforms({u_texture:0,u_textureB:1,value:h,texSize:[e,c],time:m}).draw(d)});this.setOutputData(0,this._tex)}else this.boxcolor=
"red"}}};s.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform vec2 texSize;\n\t\t\tuniform float time;\n\t\t\tuniform float value;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tUV_CODE;\n\t\t\t\tvec4 color4 = texture2D(u_texture, uv);\n\t\t\t\tvec3 color = color4.rgb;\n\t\t\t\tvec4 color4B = texture2D(u_textureB, uv);\n\t\t\t\tvec3 colorB = color4B.rgb;\n\t\t\t\tvec3 result = color;\n\t\t\t\tfloat alpha = 1.0;\n\t\t\t\tPIXEL_CODE;\n\t\t\t\tgl_FragColor = vec4(result, alpha);\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/operation",s);var m=function(){this.addOutput("out","Texture");this.properties={code:"",width:512,height:512,precision:l.DEFAULT};this.properties.code="\nvoid main() {\n  vec2 uv = v_coord;\n  vec3 color = vec3(0.0);\n//your code here\n\ngl_FragColor = vec4(color, 1.0);\n}\n";this._uniforms={in_texture:0,texSize:vec2.create(),time:0}};m.title="Shader";m.desc="Texture shader";m.widgets_info={code:{type:"code"},precision:{widget:"combo",values:l.MODE_VALUES}};m.prototype.onPropertyChanged=
function(a,b){if("code"==a){var e=this.getShader();if(e){var c=e.uniformInfo;if(this.inputs)for(var d={},k=0;k<this.inputs.length;++k){var f=this.getInputInfo(k);f&&(c[f.name]&&!d[f.name]?d[f.name]=!0:(this.removeInput(k),k--))}for(k in c)if(f=e.uniformInfo[k],null!==f.loc&&"time"!=k){c="number";if(this._shader.samplers[k])c="texture";else switch(f.size){case 1:c="number";break;case 2:c="vec2";break;case 3:c="vec3";break;case 4:c="vec4";break;case 9:c="mat3";break;case 16:c="mat4";break;default:continue}f=
this.findInputSlot(k);-1==f?this.addInput(k,c):(d=this.getInputInfo(f),d)?d.type!=c&&(this.removeInput(f,c),this.addInput(k,c)):this.addInput(k,c)}}}};m.prototype.getShader=function(){if(this._shader&&this._shader_code==this.properties.code)return this._shader;this._shader_code=this.properties.code;if(this._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,m.pixel_shader+this.properties.code))this.boxcolor="green";else return this.boxcolor="red",null;return this._shader};m.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=
this.getShader();if(a){for(var b=0,e=null,c=0;c<this.inputs.length;++c){var d=this.getInputInfo(c),k=this.getInputData(c);null!=k&&(k.constructor===GL.Texture&&(k.bind(b),e||(e=k),k=b,b++),a.setUniform(d.name,k))}var f=this._uniforms,b=l.getTextureType(this.properties.precision,e),c=this.properties.width|0,d=this.properties.height|0;0==c&&(c=e?e.width:gl.canvas.width);0==d&&(d=e?e.height:gl.canvas.height);f.texSize[0]=c;f.texSize[1]=d;f.time=this.graph.getTime();this._tex&&this._tex.type==b&&this._tex.width==
c&&this._tex.height==d||(this._tex=new GL.Texture(c,d,{type:b,format:gl.RGBA,filter:gl.LINEAR}));this._tex.drawTo(function(){a.uniforms(f).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._tex)}}};m.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float time;\n\t";d.registerNodeType("texture/shader",m);var w=function(){this.addInput("in","Texture");this.addInput("scale","vec2");this.addInput("offset","vec2");this.addOutput("out","Texture");this.properties=
{offset:vec2.fromValues(0,0),scale:vec2.fromValues(1,1),precision:l.DEFAULT}};w.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};w.title="Scale/Offset";w.desc="Applies an scaling and offseting";w.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0)&&a)if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,a);else{var b=a.width,e=a.height,c=this.precision===l.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT;this.precision===l.DEFAULT&&(c=a.type);
this._tex&&this._tex.width==b&&this._tex.height==e&&this._tex.type==c||(this._tex=new GL.Texture(b,e,{type:c,format:gl.RGBA,filter:gl.LINEAR}));var d=this._shader;d||(d=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,w.pixel_shader));var k=this.getInputData(1);k?(this.properties.scale[0]=k[0],this.properties.scale[1]=k[1]):k=this.properties.scale;var f=this.getInputData(2);f?(this.properties.offset[0]=f[0],this.properties.offset[1]=f[1]):f=this.properties.offset;this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);
gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a.bind(0);var b=Mesh.getScreenQuad();d.uniforms({u_texture:0,u_scale:k,u_offset:f}).draw(b)});this.setOutputData(0,this._tex)}};w.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform vec2 u_scale;\n\t\t\tuniform vec2 u_offset;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tuv = uv / u_scale - u_offset;\n\t\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/scaleOffset",w);var B=function(){this.addInput("in","Texture");this.addInput("warp","Texture");this.addInput("factor","number");this.addOutput("out","Texture");this.properties={factor:0.01,precision:l.DEFAULT}};B.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};B.title="Warp";B.desc="Texture warp operation";B.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,
a);else{var b=this.getInputData(1),e=512,c=512;a?(e=a.width,c=a.height):b&&(e=b.width,c=b.height);this._tex=a||this._tex?l.getTargetTexture(a||this._tex,this._tex,this.properties.precision):new GL.Texture(e,c,{type:this.precision===l.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT,format:gl.RGBA,filter:gl.LINEAR});var d=this._shader;d||(d=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,B.pixel_shader));var k=this.getInputData(2);null!=k?this.properties.factor=k:k=parseFloat(this.properties.factor);this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);
gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a&&a.bind(0);b&&b.bind(1);var e=Mesh.getScreenQuad();d.uniforms({u_texture:0,u_textureB:1,u_factor:k}).draw(e)});this.setOutputData(0,this._tex)}};B.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float u_factor;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor;\n\t\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t\t}\n\t\t\t";
...
Math.clamp(b[2],0,1))+")";this.flags.collapsed?this.boxcolor=a.fillStyle:a.fillRect(0,0,this.size[0],this.size[1])};g.prototype.onExecute=function(){var a=this.properties.precision==l.HIGH?l.HIGH_PRECISION_FORMAT:gl.UNSIGNED_BYTE;this._tex&&this._tex.type==a||(this._tex=new GL.Texture(1,1,{format:gl.RGBA,type:a,minFilter:gl.NEAREST}));a=this.properties.color;if(this.inputs)for(var b=0;b<this.inputs.length;b++){var e=this.inputs[b],c=this.getInputData(b);if(void 0!==c)switch(e.name){case "RGB":case "RGBA":a.set(c);
break;case "R":a[0]=c;break;case "G":a[1]=c;break;case "B":a[2]=c;break;case "A":a[3]=c}}0.001<vec4.sqrDist(this._tex_color,a)&&(this._tex_color.set(a),this._tex.fill(a));this.setOutputData(0,this._tex)};g.prototype.onGetInputs=function(){return[["RGB","vec3"],["RGBA","vec4"],["R","number"],["G","number"],["B","number"],["A","number"]]};d.registerNodeType("texture/color",g);var k=function(){this.addInput("A","color");this.addInput("B","color");this.addOutput("Texture","Texture");this.properties={angle:0,
scale:1,A:[0,0,0],B:[1,1,1],texture_size:32};k._shader||(k._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,k.pixel_shader));this._uniforms={u_angle:0,u_colorA:vec3.create(),u_colorB:vec3.create()}};k.title="Gradient";k.desc="Generates a gradient";k["@A"]={type:"color"};k["@B"]={type:"color"};k["@texture_size"]={type:"enum",values:[32,64,128,256,512]};k.prototype.onExecute=function(){gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var a=GL.Mesh.getScreenQuad(),b=k._shader,e=this.getInputData(0);e||
(e=this.properties.A);var c=this.getInputData(1);c||(c=this.properties.B);for(var d=2;d<this.inputs.length;d++){var f=this.inputs[d],g=this.getInputData(d);void 0!==g&&(this.properties[f.name]=g)}var h=this._uniforms;this._uniforms.u_angle=this.properties.angle*DEG2RAD;this._uniforms.u_scale=this.properties.scale;vec3.copy(h.u_colorA,e);vec3.copy(h.u_colorB,c);e=parseInt(this.properties.texture_size);this._tex&&this._tex.width==e||(this._tex=new GL.Texture(e,e,{format:gl.RGB,filter:gl.LINEAR}));this._tex.drawTo(function(){b.uniforms(h).draw(a)});
this.setOutputData(0,this._tex)};k.prototype.onGetInputs=function(){return[["angle","number"],["scale","number"]]};k.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float u_angle;\n\t\t\tuniform float u_scale;\n\t\t\tuniform vec3 u_colorA;\n\t\t\tuniform vec3 u_colorB;\n\t\t\t\n\t\t\tvec2 rotate(vec2 v, float angle)\n\t\t\t{\n\t\t\t\tvec2 result;\n\t\t\t\tfloat _cos = cos(angle);\n\t\t\t\tfloat _sin = sin(angle);\n\t\t\t\tresult.x = v.x * _cos - v.y * _sin;\n\t\t\t\tresult.y = v.x * _sin + v.y * _cos;\n\t\t\t\treturn result;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tfloat f = (rotate(u_scale * (v_coord - vec2(0.5)), u_angle) + vec2(0.5)).x;\n\t\t\t\tvec3 color = mix(u_colorA,u_colorB,clamp(f,0.0,1.0));\n\t\t\t   gl_FragColor = vec4(color,1.0);\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/gradient",k);var t=function(){this.addInput("A","Texture");this.addInput("B","Texture");this.addInput("Mixer","Texture");this.addOutput("Texture","Texture");this.properties={factor:0.5,precision:l.DEFAULT};this._uniforms={u_textureA:0,u_textureB:1,u_textureMix:2,u_mix:vec4.create()}};t.title="Mix";t.desc="Generates a texture mixing two textures";t.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};t.prototype.onExecute=function(){var a=this.getInputData(0);
if(this.isOutputConnected(0))if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,a);else{var b=this.getInputData(1);if(a&&b){var e=this.getInputData(2),c=this.getInputData(3);this._tex=l.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var d=Mesh.getScreenQuad(),k=null,f=this._uniforms;e?(k=t._shader_tex,k||(k=t._shader_tex=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,t.pixel_shader,{MIX_TEX:""}))):(k=t._shader_factor,k||(k=t._shader_factor=
new GL.Shader(Shader.SCREEN_VERTEX_SHADER,t.pixel_shader)),c=null==c?this.properties.factor:c,f.u_mix.set([c,c,c,c]));this._tex.drawTo(function(){a.bind(0);b.bind(1);e&&e.bind(2);k.uniforms(f).draw(d)});this.setOutputData(0,this._tex)}}};t.prototype.onGetInputs=function(){return[["factor","number"]]};t.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_textureA;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\t#ifdef MIX_TEX\n\t\t\t\tuniform sampler2D u_textureMix;\n\t\t\t#else\n\t\t\t\tuniform vec4 u_mix;\n\t\t\t#endif\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\t#ifdef MIX_TEX\n\t\t\t\t   vec4 f = texture2D(u_textureMix, v_coord);\n\t\t\t\t#else\n\t\t\t\t   vec4 f = u_mix;\n\t\t\t\t#endif\n\t\t\t   gl_FragColor = mix( texture2D(u_textureA, v_coord), texture2D(u_textureB, v_coord), f );\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/mix",t);var v=function(){this.addInput("Tex.","Texture");this.addOutput("Edges","Texture");this.properties={invert:!0,threshold:!1,factor:1,precision:l.DEFAULT};v._shader||(v._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,v.pixel_shader))};v.title="Edges";v.desc="Detects edges";v.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};v.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,
a);else if(a){this._tex=l.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var b=Mesh.getScreenQuad(),e=v._shader,c=this.properties.invert,d=this.properties.factor,k=this.properties.threshold?1:0;this._tex.drawTo(function(){a.bind(0);e.uniforms({u_texture:0,u_isize:[1/a.width,1/a.height],u_factor:d,u_threshold:k,u_invert:c?1:0}).draw(b)});this.setOutputData(0,this._tex)}}};v.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_isize;\n\t\t\tuniform int u_invert;\n\t\t\tuniform float u_factor;\n\t\t\tuniform float u_threshold;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 center = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 up = texture2D(u_texture, v_coord + u_isize * vec2(0.0,1.0) );\n\t\t\t\tvec4 down = texture2D(u_texture, v_coord + u_isize * vec2(0.0,-1.0) );\n\t\t\t\tvec4 left = texture2D(u_texture, v_coord + u_isize * vec2(1.0,0.0) );\n\t\t\t\tvec4 right = texture2D(u_texture, v_coord + u_isize * vec2(-1.0,0.0) );\n\t\t\t\tvec4 diff = abs(center - up) + abs(center - down) + abs(center - left) + abs(center - right);\n\t\t\t\tdiff *= u_factor;\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tdiff.xyz = vec3(1.0) - diff.xyz;\n\t\t\t\tif( u_threshold == 0.0 )\n\t\t\t\t\tgl_FragColor = vec4( diff.xyz, center.a );\n\t\t\t\telse\n\t\t\t\t\tgl_FragColor = vec4( diff.x > 0.5 ? 1.0 : 0.0, diff.y > 0.5 ? 1.0 : 0.0, diff.z > 0.5 ? 1.0 : 0.0, center.a );\n\t\t\t}\n\t\t\t";
...
wrap:gl.CLAMP_TO_EDGE},k=l.getTextureType(this.properties.precision,a),f=this._uniforms,g=this._textures,h=e._cut_shader;h||(h=e._cut_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,e.cut_pixel_shader));gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);f.u_threshold=this.getInputOrProperty("threshold");var m=g[0]=GL.Texture.getTemporary(b,c,d);a.blit(m,h.uniforms(f));var t=m,n=this.getInputOrProperty("iterations"),n=Math.clamp(n,1,16)|0,r=f.u_texel_size,v=this.getInputOrProperty("intensity");f.u_intensity=
1;f.u_delta=this.properties.scale;h=e._shader;h||(h=e._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,e.scale_pixel_shader));for(var q=1;q<n;q++){b>>=1;1<(c|0)&&(c>>=1);if(2>b)break;m=g[q]=GL.Texture.getTemporary(b,c,d);r[0]=1/t.width;r[1]=1/t.height;t.blit(m,h.uniforms(f));t=m}this.isOutputConnected(2)&&(b=this._average_texture,b&&b.type==a.type&&b.format==a.format||(b=this._average_texture=new GL.Texture(1,1,{type:a.type,format:a.format,filter:gl.LINEAR})),r[0]=1/t.width,r[1]=1/t.height,f.u_intensity=
v,f.u_delta=1,t.blit(b,h.uniforms(f)),this.setOutputData(2,b));gl.enable(gl.BLEND);gl.blendFunc(gl.ONE,gl.ONE);f.u_intensity=this.getInputOrProperty("persistence");f.u_delta=0.5;for(q-=2;0<=q;q--)m=g[q],g[q]=null,r[0]=1/t.width,r[1]=1/t.height,t.blit(m,h.uniforms(f)),GL.Texture.releaseTemporary(t),t=m;gl.disable(gl.BLEND);this.isOutputConnected(1)&&(g=this._glow_texture,g&&g.width==a.width&&g.height==a.height&&g.type==k&&g.format==a.format||(g=this._glow_texture=new GL.Texture(a.width,a.height,{type:k,
format:a.format,filter:gl.LINEAR})),t.blit(g),this.setOutputData(1,g));if(this.isOutputConnected(0)){g=this._final_texture;g&&g.width==a.width&&g.height==a.height&&g.type==k&&g.format==a.format||(g=this._final_texture=new GL.Texture(a.width,a.height,{type:k,format:a.format,filter:gl.LINEAR}));var s=this.getInputData(1),w=this.getInputOrProperty("dirt_factor");f.u_intensity=v;h=s?e._dirt_final_shader:e._final_shader;h||(h=s?e._dirt_final_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,e.final_pixel_shader,
{USE_DIRT:""}):e._final_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,e.final_pixel_shader));g.drawTo(function(){a.bind(0);t.bind(1);s&&(h.setUniform("u_dirt_factor",w),h.setUniform("u_dirt_texture",s.bind(2)));h.toViewport(f)});this.setOutputData(0,g)}GL.Texture.releaseTemporary(t)}};e.cut_pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_threshold;\n\t\tvoid main() {\n\t\t\tgl_FragColor = max( texture2D( u_texture, v_coord ) - vec4( u_threshold ), vec4(0.0) );\n\t\t}";
...
filter:gl.LINEAR}));this._video_texture.uploadImage(this._video);this._video_texture.version=++this.version;this.properties.texture_name&&(l.getTexturesContainer()[this.properties.texture_name]=this._video_texture);this.setOutputData(0,this._video_texture);for(a=1;a<this.outputs.length;++a)if(this.outputs[a])switch(this.outputs[a].name){case "width":this.setOutputData(a,this._video.videoWidth);break;case "height":this.setOutputData(a,this._video.videoHeight)}}};h.prototype.onGetOutputs=function(){return[["width",
"number"],["height","number"],["stream_ready",d.EVENT],["stream_closed",d.EVENT],["stream_error",d.EVENT]]};d.registerNodeType("texture/webcam",h);var G=function(){this.addInput("in","Texture");this.addInput("f","number");this.addOutput("out","Texture");this.properties={enabled:!0,factor:1,precision:l.LOW};this._uniforms={u_texture:0,u_factor:1}};G.title="Lens FX";G.desc="distortion and chromatic aberration";G.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};G.prototype.onGetInputs=
function(){return[["enabled","boolean"]]};G.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0))if(this.properties.precision===l.PASS_THROUGH||!1===this.getInputOrProperty("enabled"))this.setOutputData(0,a);else{var b=this._temp_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var e=G._shader;e||(e=G._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,
...
d.registerNodeType("texture/lensfx",G);var J=function(){this.addInput("in","Texture");this.addInput("exp","number");this.addOutput("out","Texture");this.properties={exposition:1,precision:l.LOW};this._uniforms={u_texture:0,u_exposition:1}};J.title="Exposition";J.desc="Controls texture exposition";J.widgets_info={exposition:{widget:"slider",min:0,max:3},precision:{widget:"combo",values:l.MODE_VALUES}};J.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0)){var b=
...
lum_white:1,precision:l.LOW};this._uniforms={u_texture:0,u_lumwhite2:1,u_igamma:1,u_scale:1,u_average_lum:1}};F.title="Tone Mapping";F.desc="Applies Tone Mapping to convert from high to low";F.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES}};F.prototype.onGetInputs=function(){return[["enabled","boolean"]]};F.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0))if(this.properties.precision===l.PASS_THROUGH||!1===this.getInputOrProperty("enabled"))this.setOutputData(0,
...
d.registerNodeType("texture/tonemapping",F);var H=function(){this.addOutput("out","Texture");this.properties={width:512,height:512,seed:0,persistence:0.1,octaves:8,scale:1,offset:[0,0],amplitude:1,precision:l.DEFAULT};this._key=0;this._texture=null;this._uniforms={u_persistence:0.1,u_seed:0,u_offset:vec2.create(),u_scale:1,u_viewport:vec2.create()}};H.title="Perlin";H.desc="Generates a perlin noise texture";H.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES},width:{type:"Number",precision:0,
step:1},height:{type:"Number",precision:0,step:1},octaves:{type:"Number",precision:0,step:1,min:1,max:50}};H.prototype.onGetInputs=function(){return[["seed","Number"],["persistence","Number"],["octaves","Number"],["scale","Number"],["amplitude","Number"],["offset","vec2"]]};H.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.properties.width|0,b=this.properties.height|0;0==a&&(a=gl.viewport_data[2]);0==b&&(b=gl.viewport_data[3]);var e=l.getTextureType(this.properties.precision),
c=this._texture;c&&c.width==a&&c.height==b&&c.type==e||(c=this._texture=new GL.Texture(a,b,{type:e,format:gl.RGB,filter:gl.LINEAR}));var d=this.getInputOrProperty("persistence"),k=this.getInputOrProperty("octaves"),f=this.getInputOrProperty("offset"),g=this.getInputOrProperty("scale"),h=this.getInputOrProperty("amplitude"),m=this.getInputOrProperty("seed"),e=""+a+b+e+d+k+g+m+f[0]+f[1]+h;if(e!=this._key){this._key=e;var t=this._uniforms;t.u_persistence=d;t.u_octaves=k;t.u_offset.set(f);t.u_scale=g;
t.u_amplitude=h;t.u_seed=128*m;t.u_viewport[0]=a;t.u_viewport[1]=b;var n=H._shader;n||(n=H._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,H.pixel_shader));gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);c.drawTo(function(){n.uniforms(t).draw(GL.Mesh.getScreenQuad())})}this.setOutputData(0,c)}};H.pixel_shader="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform vec2 u_offset;\n\t\t\tuniform float u_scale;\n\t\t\tuniform float u_persistence;\n\t\t\tuniform int u_octaves;\n\t\t\tuniform float u_amplitude;\n\t\t\tuniform vec2 u_viewport;\n\t\t\tuniform float u_seed;\n\t\t\t#define M_PI 3.14159265358979323846\n\t\t\t\n\t\t\tfloat rand(vec2 c){\treturn fract(sin(dot(c.xy ,vec2( 12.9898 + u_seed,78.233 + u_seed))) * 43758.5453); }\n\t\t\t\n\t\t\tfloat noise(vec2 p, float freq ){\n\t\t\t\tfloat unit = u_viewport.x/freq;\n\t\t\t\tvec2 ij = floor(p/unit);\n\t\t\t\tvec2 xy = mod(p,unit)/unit;\n\t\t\t\t//xy = 3.*xy*xy-2.*xy*xy*xy;\n\t\t\t\txy = .5*(1.-cos(M_PI*xy));\n\t\t\t\tfloat a = rand((ij+vec2(0.,0.)));\n\t\t\t\tfloat b = rand((ij+vec2(1.,0.)));\n\t\t\t\tfloat c = rand((ij+vec2(0.,1.)));\n\t\t\t\tfloat d = rand((ij+vec2(1.,1.)));\n\t\t\t\tfloat x1 = mix(a, b, xy.x);\n\t\t\t\tfloat x2 = mix(c, d, xy.x);\n\t\t\t\treturn mix(x1, x2, xy.y);\n\t\t\t}\n\t\t\t\n\t\t\tfloat pNoise(vec2 p, int res){\n\t\t\t\tfloat persistance = u_persistence;\n\t\t\t\tfloat n = 0.;\n\t\t\t\tfloat normK = 0.;\n\t\t\t\tfloat f = 4.;\n\t\t\t\tfloat amp = 1.0;\n\t\t\t\tint iCount = 0;\n\t\t\t\tfor (int i = 0; i<50; i++){\n\t\t\t\t\tn+=amp*noise(p, f);\n\t\t\t\t\tf*=2.;\n\t\t\t\t\tnormK+=amp;\n\t\t\t\t\tamp*=persistance;\n\t\t\t\t\tif (iCount >= res)\n\t\t\t\t\t\tbreak;\n\t\t\t\t\tiCount++;\n\t\t\t\t}\n\t\t\t\tfloat nf = n/normK;\n\t\t\t\treturn nf*nf*nf*nf;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord * u_scale * u_viewport + u_offset * u_scale;\n\t\t\t\tvec4 color = vec4( pNoise( uv, u_octaves ) * u_amplitude );\n\t\t\t\tgl_FragColor = color;\n\t\t\t}";
d.registerNodeType("texture/perlin",H);g=function(){this.addOutput("out","Texture");this.properties={code:"",width:512,height:512,precision:l.DEFAULT};this._temp_texture=this._func=null};g.title="Canvas2D";g.desc="Executes Canvas2D code inside a texture or the viewport";g.widgets_info={precision:{widget:"combo",values:l.MODE_VALUES},code:{type:"code"},width:{type:"Number",precision:0,step:1},height:{type:"Number",precision:0,step:1}};g.prototype.onPropertyChanged=function(a,b){if("code"==a&&d.allow_scripts){this._func=
...
var d=this,k=this.graph.getTime();c.drawTo(function(){gl.start2D();try{a.draw?a.draw.call(d,gl.canvas,gl,k,a):a.call(d,gl.canvas,gl,k,a),d.boxcolor="#00FF00"}catch(b){d.boxcolor="#FF0000",console.error("Error executing script"),console.error(b)}gl.finish2D()});this.setOutputData(0,c)}else console.warn("cannot use LGraphTextureCanvas2D if Canvas2DtoWebGL is not included")};d.registerNodeType("texture/canvas2D",g);var I=function(){this.addInput("in","Texture");this.addOutput("out","Texture");this.properties=
{key_color:vec3.fromValues(0,1,0),threshold:0.8,slope:0.2,precision:l.DEFAULT}};I.title="Matte";I.desc="Extracts background";I.widgets_info={key_color:{widget:"color"},precision:{widget:"combo",values:l.MODE_VALUES}};I.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);if(this.properties.precision===l.PASS_THROUGH)this.setOutputData(0,a);else if(a){this._tex=l.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);
...
d.registerNodeType("texture/matte",I);g=function(){this.addOutput("Cubemap","Cubemap");this.properties={name:""};this.size=[l.image_preview_size,l.image_preview_size]};g.title="Cubemap";g.prototype.onDropFile=function(a,b,e){a?(this._drop_texture="string"==typeof a?GL.Texture.fromURL(a):GL.Texture.fromDDSInMemory(a),this.properties.name=b):(this._drop_texture=null,this.properties.name="")};g.prototype.onExecute=function(){if(this._drop_texture)this.setOutputData(0,this._drop_texture);else if(this.properties.name){var a=
l.getTexture(this.properties.name);a&&(this._last_tex=a,this.setOutputData(0,a))}};g.prototype.onDrawBackground=function(a){this.flags.collapsed||20>=this.size[1]||a.webgl&&(gl.meshes.cube||(gl.meshes.cube=GL.Mesh.cube({size:1})))};d.registerNodeType("texture/cubemap",g)}})(this);
...
d.registerNodeType("fx/lens",l);u.LGraphFXLens=l;var q=function(){this.addInput("Texture","Texture");this.addInput("Blurred","Texture");this.addInput("Mask","Texture");this.addInput("Threshold","number");this.addOutput("Texture","Texture");this.properties={shape:"",size:10,alpha:1,threshold:1,high_precision:!1}};q.title="Bokeh";q.desc="applies an Bokeh effect";q.widgets_info={shape:{widget:"texture"}};q.prototype.onExecute=function(){var d=this.getInputData(0),g=this.getInputData(1),l=this.getInputData(2);
if(d&&l&&this.properties.shape){g||(g=d);var s=LGraphTexture.getTexture(this.properties.shape);if(s){var u=this.properties.threshold;this.isInputConnected(3)&&(u=this.getInputData(3),this.properties.threshold=u);var c=gl.UNSIGNED_BYTE;this.properties.high_precision&&(c=gl.half_float_ext?gl.HALF_FLOAT_OES:gl.FLOAT);this._temp_texture&&this._temp_texture.type==c&&this._temp_texture.width==d.width&&this._temp_texture.height==d.height||(this._temp_texture=new GL.Texture(d.width,d.height,{type:c,format:gl.RGBA,
filter:gl.LINEAR}));var x=q._first_shader;x||(x=q._first_shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,q._first_pixel_shader));var n=q._second_shader;n||(n=q._second_shader=new GL.Shader(q._second_vertex_shader,q._second_pixel_shader));var f=this._points_mesh;f&&f._width==d.width&&f._height==d.height&&2==f._spacing||(f=this.createPointsMesh(d.width,d.height,2));var A=Mesh.getScreenQuad(),k=this.properties.size,t=this.properties.alpha;gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);this._temp_texture.drawTo(function(){d.bind(0);
g.bind(1);l.bind(2);x.uniforms({u_texture:0,u_texture_blur:1,u_mask:2,u_texsize:[d.width,d.height]}).draw(A)});this._temp_texture.drawTo(function(){gl.enable(gl.BLEND);gl.blendFunc(gl.ONE,gl.ONE);d.bind(0);s.bind(3);n.uniforms({u_texture:0,u_mask:2,u_shape:3,u_alpha:t,u_threshold:u,u_pointSize:k,u_itexsize:[1/d.width,1/d.height]}).draw(f,gl.POINTS)});this.setOutputData(0,this._temp_texture)}}else this.setOutputData(0,d)};q.prototype.createPointsMesh=function(d,g,l){for(var q=Math.round(d/l),s=Math.round(g/
l),c=new Float32Array(q*s*2),u=-1,n=2/d*l,f=2/g*l,A=0;A<s;++A){for(var k=-1,t=0;t<q;++t){var v=A*q*2+2*t;c[v]=k;c[v+1]=u;k+=n}u+=f}this._points_mesh=GL.Mesh.load({vertices2D:c});this._points_mesh._width=d;this._points_mesh._height=g;this._points_mesh._spacing=l;return this._points_mesh};q._first_pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_texture_blur;\n\t\t\tuniform sampler2D u_mask;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 blurred_color = texture2D(u_texture_blur, v_coord);\n\t\t\t\tfloat mask = texture2D(u_mask, v_coord).x;\n\t\t\t   gl_FragColor = mix(color, blurred_color, mask);\n\t\t\t}\n\t\t\t";
...
LGraphTexture.getTargetTexture(d,this._tex,this.properties.precision);var l=this.properties.value1;this.isInputConnected(1)&&(l=this.getInputData(1),this.properties.value1=l);var q=this.properties.value2;this.isInputConnected(2)&&(q=this.getInputData(2),this.properties.value2=q);var s=this.properties.fx,y=g.shaders[s];if(!y){var c=g["pixel_shader_"+s];if(!c)return;y=g.shaders[s]=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,c)}gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var x=Mesh.getScreenQuad();
camera_planes=u.LS&&LS.Renderer._current_camera?[LS.Renderer._current_camera.near,LS.Renderer._current_camera.far]:[1,100];var n=null;"noise"==s&&(n=LGraphTexture.getNoiseTexture());this._tex.drawTo(function(){d.bind(0);"noise"==s&&n.bind(1);y.uniforms({u_texture:0,u_noise:1,u_size:[d.width,d.height],u_rand:[Math.random(),Math.random()],u_value1:l,u_value2:q,u_camera_planes:camera_planes}).draw(x)});this.setOutputData(0,this._tex)}}};g.pixel_shader_halftone="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform vec2 u_size;\n\t\t\tuniform float u_value1;\n\t\t\tuniform float u_value2;\n\t\t\t\n\t\t\tfloat pattern() {\n\t\t\t\tfloat s = sin(u_value1 * 3.1415), c = cos(u_value1 * 3.1415);\n\t\t\t\tvec2 tex = v_coord * u_size.xy;\n\t\t\t\tvec2 point = vec2(\n\t\t\t\t   c * tex.x - s * tex.y ,\n\t\t\t\t   s * tex.x + c * tex.y \n\t\t\t\t) * u_value2;\n\t\t\t\treturn (sin(point.x) * sin(point.y)) * 4.0;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat average = (color.r + color.g + color.b) / 3.0;\n\t\t\t\tgl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);\n\t\t\t}\n";
...
g.pixel_shader_gamma="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_value1;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat gamma = 1.0 / u_value1;\n\t\t\t\tgl_FragColor = vec4( pow( color.xyz, vec3(gamma) ), color.a );\n\t\t\t}\n";d.registerNodeType("fx/generic",g);u.LGraphFXGeneric=g;var s=function(){this.addInput("Tex.","Texture");this.addInput("intensity","number");this.addOutput("Texture",
...
var g=this.properties.intensity;this.isInputConnected(1)&&(g=this.getInputData(1),this.properties.intensity=g);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var l=Mesh.getScreenQuad(),q=s._shader,u=this.properties.invert;this._tex.drawTo(function(){d.bind(0);q.uniforms({u_texture:0,u_intensity:g,u_isize:[1/d.width,1/d.height],u_invert:u?1:0}).draw(l)});this.setOutputData(0,this._tex)}};s.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_intensity;\n\t\t\tuniform int u_invert;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat luminance = 1.0 - length( v_coord - vec2(0.5) ) * 1.414;\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tluminance = 1.0 - luminance;\n\t\t\t\tluminance = mix(1.0, luminance, u_intensity);\n\t\t\t   gl_FragColor = vec4( luminance * color.xyz, color.a);\n\t\t\t}\n\t\t\t";
d.registerNodeType("fx/vigneting",s);u.LGraphFXVigneting=s}})(this);
(function(u){function d(c){this.cmd=this.channel=0;this.data=new Uint32Array(3);c&&this.setup(c)}function l(c,d){navigator.requestMIDIAccess?(this.on_ready=c,this.state={note:[],cc:[]},navigator.requestMIDIAccess().then(this.onMIDISuccess.bind(this),this.onMIDIFailure.bind(this))):(this.error="not suppoorted",d?d("Not supported"):console.error("MIDI NOT SUPPORTED, enable by chrome://flags"))}function q(){this.addOutput("on_midi",f.EVENT);this.addOutput("out","midi");this.properties={port:0};this._current_midi_event=
this._last_midi_event=null;this.boxcolor="#AAA";this._last_time=0;var c=this;new l(function(d){c._midi=d;if(c._waiting)c.onStart();c._waiting=!1})}function g(){this.addInput("send",f.EVENT);this.properties={port:0};var c=this;new l(function(d){c._midi=d})}function s(){this.addInput("on_midi",f.EVENT);this._str="";this.size=[200,40]}function m(){this.properties={channel:-1,cmd:-1,min_value:-1,max_value:-1};var c=this;this._learning=!1;this.addWidget("button","Learn","",function(){c._learning=!0;c.boxcolor=
...
224:"pitch bend",240:"system",242:"Song pos",243:"Song select",246:"Tune request",248:"time tick",250:"Start Song",251:"Continue Song",252:"Stop Song",254:"Sensing",255:"Reset"};d.commands_short={128:"NOTEOFF",144:"NOTEOFF",160:"KEYP",176:"CC",192:"PC",208:"CP",224:"PB",240:"SYS",242:"POS",243:"SELECT",246:"TUNEREQ",248:"TT",250:"START",251:"CONTINUE",252:"STOP",254:"SENS",255:"RESET"};d.commands_reversed={};for(var A in d.commands)d.commands_reversed[d.commands[A]]=A;l.input=null;l.MIDIEvent=d;l.prototype.onMIDISuccess=
function(c){console.log("MIDI ready!");console.log(c);this.midi=c;this.updatePorts();if(this.on_ready)this.on_ready(this)};l.prototype.updatePorts=function(){var c=this.midi;this.input_ports=c.inputs;for(var d=0,f=this.input_ports.values(),a=f.next();a&&!1===a.done;)a=a.value,console.log("Input port [type:'"+a.type+"'] id:'"+a.id+"' manufacturer:'"+a.manufacturer+"' name:'"+a.name+"' version:'"+a.version+"'"),d++,a=f.next();this.num_input_ports=d;d=0;this.output_ports=c.outputs;f=this.output_ports.values();
for(a=f.next();a&&!1===a.done;)a=a.value,console.log("Output port [type:'"+a.type+"'] id:'"+a.id+"' manufacturer:'"+a.manufacturer+"' name:'"+a.name+"' version:'"+a.version+"'"),d++,a=f.next();this.num_output_ports=d};l.prototype.onMIDIFailure=function(c){console.error("Failed to get MIDI access - "+c)};l.prototype.openInputPort=function(c,f){var g=this.input_ports.get("input-"+c);if(!g)return!1;l.input=this;var a=this;g.onmidimessage=function(b){var c=new d(b.data);a.updateState(c);f&&f(b.data,c);
if(l.on_message)l.on_message(b.data,c)};console.log("port open: ",g);return!0};l.parseMsg=function(c){};l.prototype.updateState=function(c){switch(c.cmd){case d.NOTEON:this.state.note[c.value1|0]=c.value2;break;case d.NOTEOFF:this.state.note[c.value1|0]=0;break;case d.CONTROLLERCHANGE:this.state.cc[c.getCC()]=c.getCCValue()}};l.prototype.sendMIDI=function(c,f){if(f){var g=this.output_ports.get("output-"+c);g&&(l.output=this,f.constructor===d?g.send(f.data):g.send(f))}};q.MIDIInterface=l;q.title="MIDI Input";
...
["on_cc",f.EVENT],["on_pc",f.EVENT],["on_pitchbend",f.EVENT]]};f.registerNodeType("midi/input",q);g.MIDIInterface=l;g.title="MIDI Output";g.desc="Sends MIDI to output channel";g.color="#243";g.prototype.getPropertyInfo=function(c){if(this._midi&&"port"==c){c={};for(var d=0;d<this._midi.output_ports.size;++d){var f=this._midi.output_ports.get(d);c[d]=d+".- "+f.name+" version:"+f.version}return{type:"enum",values:c}}};g.prototype.onAction=function(c,d){this._midi&&("send"==c&&this._midi.sendMIDI(this.port,
d),this.trigger("midi",d))};g.prototype.onGetInputs=function(){return[["send",f.ACTION]]};g.prototype.onGetOutputs=function(){return[["on_midi",f.EVENT]]};f.registerNodeType("midi/output",g);s.title="MIDI Show";s.desc="Shows MIDI in the graph";s.color="#243";s.prototype.getTitle=function(){return this.flags.collapsed?this._str:this.title};s.prototype.onAction=function(c,f){f&&(this._str=f.constructor===d?f.toString():"???")};s.prototype.onDrawForeground=function(c){this._str&&!this.flags.collapsed&&
(c.font="30px Arial",c.fillText(this._str,10,0.8*this.size[1]))};s.prototype.onGetInputs=function(){return[["in",f.ACTION]]};s.prototype.onGetOutputs=function(){return[["on_midi",f.EVENT]]};f.registerNodeType("midi/show",s);m.title="MIDI Filter";m.desc="Filters MIDI messages";m.color="#243";m["@cmd"]={type:"enum",title:"Command",values:d.commands_reversed};m.prototype.getTitle=function(){var c=null,c=-1==this.properties.cmd?"Nothing":d.commands_short[this.properties.cmd]||"Unknown";-1!=this.properties.min_value&&
...
w.prototype.onGetInputs=function(){return[["note","number"]]};w.prototype.onGetOutputs=function(){return[["midi","midi"],["on_midi",f.EVENT],["command","number"],["note","number"],["velocity","number"],["cc","number"],["cc_value","number"],["pitch","number"],["gate","bool"],["pitchbend","number"]]};f.registerNodeType("midi/event",w);B.title="MIDICC";B.desc="gets a Controller Change";B.color="#243";B.prototype.onExecute=function(){l.input&&(this.properties.value=l.input.state.cc[this.properties.cc]);
this.setOutputData(0,this.properties.value)};f.registerNodeType("midi/cc",B);z.title="MIDI Generator";z.desc="Generates a random MIDI note";z.color="#243";z.processScale=function(c){c=c.split(",");for(var g=0;g<c.length;++g){var l=c[g];c[g]=2==l.length&&"#"!=l[1]||2<l.length?-f.MIDIEvent.NoteStringToPitch(l):d.note_to_index[l]||0}return c};z.prototype.onPropertyChanged=function(c,d){"notes"==c&&(this.notes_pitches=z.processScale(d))};z.prototype.onExecute=function(){var c=this.getInputData(2);null!=
...
0;c<a.inputs.length;++c){var d=a.graph.links[a.inputs[c].link];if(d){var f=a.graph.getNodeById(d.origin_id),g=null,g=f.getAudioNodeInOutputSlot?f.getAudioNodeInOutputSlot(d.origin_slot):f.audionode,d=null,d=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(c):a.audionode;b?v.connect(g,d):v.disconnect(g,d)}}if(a.outputs)for(c=0;c<a.outputs.length;++c)for(var f=a.outputs[c],k=0;k<f.links.length;++k)if(d=a.graph.links[f.links[k]]){var g=a.getAudioNodeInOutputSlot?a.getAudioNodeInOutputSlot(c):a.audionode,
l=a.graph.getNodeById(d.target_id),d=l.getAudioNodeInInputSlot?l.getAudioNodeInInputSlot(d.target_slot):l.audionode;b?v.connect(g,d):v.disconnect(g,d)}};v.onConnectionsChange=function(a,b,c,d){if(a==t.OUTPUT&&(a=null,d&&(a=this.graph.getNodeById(d.target_id)),a)){var f=null,f=this.getAudioNodeInOutputSlot?this.getAudioNodeInOutputSlot(b):this.audionode;b=null;b=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(d.target_slot):a.audionode;c?v.connect(f,b):v.disconnect(f,b)}};v.createAudioNodeWrapper=
...
1;a<this.inputs.length;++a){var b=this.inputs[a];null!=b.link&&"audio"!=b.type&&(b=this.getInputData(a),void 0!==b&&(1==a?this.audionode1.gain.value=b:3==a&&(this.audionode2.gain.value=b)))}};v.createAudioNodeWrapper(B);B.title="Mixer";B.desc="Audio mixer";t.registerNodeType("audio/mixer",B);z.prototype.onExecute=function(){var a=v.getAudioContext().currentTime,b=this.audionode.gain,c=this.getInputData(1),d=this.getInputOrProperty("A"),f=this.getInputOrProperty("D"),g=this.getInputOrProperty("S"),
k=this.getInputOrProperty("R");!this.gate&&c?(b.cancelScheduledValues(0),b.setValueAtTime(0,a),b.linearRampToValueAtTime(1,a+d),b.linearRampToValueAtTime(g,a+d+f)):this.gate&&!c&&(b.cancelScheduledValues(0),b.setValueAtTime(b.value,a),b.linearRampToValueAtTime(0,a+k));this.gate=c};z.prototype.onGetInputs=function(){return[["A","number"],["D","number"],["S","number"],["R","number"]]};v.createAudioNodeWrapper(z);z.title="ADSR";z.desc="Audio envelope";t.registerNodeType("audio/adsr",z);v.createAudioNodeWrapper(y);
y.prototype.onExecute=function(){var a=this.getInputData(1);void 0!==a&&(this.audionode.delayTime.value=a)};y.title="Delay";y.desc="Audio delay";t.registerNodeType("audio/delay",y);c.prototype.onExecute=function(){if(this.inputs&&this.inputs.length)for(var a=1;a<this.inputs.length;++a){var b=this.inputs[a];if(null!=b.link){var c=this.getInputData(a);void 0!==c&&(this.audionode[b.name].value=c)}}};c.prototype.onGetInputs=function(){return[["frequency","number"],["detune","number"],["Q","number"]]};
v.createAudioNodeWrapper(c);c.title="BiquadFilter";c.desc="Audio filter";t.registerNodeType("audio/biquadfilter",c);x.prototype.onStart=function(){if(!this.audionode.started){this.audionode.started=!0;try{this.audionode.start()}catch(a){}}};x.prototype.onStop=function(){this.audionode.started&&(this.audionode.started=!1,this.audionode.stop())};x.prototype.onPause=function(){this.onStop()};x.prototype.onUnpause=function(){this.onStart()};x.prototype.onExecute=function(){if(this.inputs&&this.inputs.length)for(var a=
0;a<this.inputs.length;++a){var b=this.inputs[a];if(null!=b.link){var c=this.getInputData(a);void 0!==c&&(this.audionode[b.name].value=c)}}};x.prototype.onGetInputs=function(){return[["frequency","number"],["detune","number"],["type","string"]]};v.createAudioNodeWrapper(x);x.title="Oscillator";x.desc="Oscillator";t.registerNodeType("audio/oscillator",x);n.prototype.onExecute=function(){this._last_buffer=this.getInputData(0);var a=this.getInputData(1);void 0!==a&&(this.properties.mark=a);this.setDirtyCanvas(!0,
...
b.getChannelData(c),f=a.getChannelData(c),g=0;g<b.length;g++)f[g]=d[g]}};v.createAudioNodeWrapper(A);A.title="Script";A.desc="apply script to signal";t.registerNodeType("audio/script",A);k.title="Destination";k.desc="Audio output";t.registerNodeType("audio/destination",k)})(this);
(function(u){function d(){this.size=[60,20];this.addInput("send",q.ACTION);this.addOutput("received",q.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"",room:"lgraph",only_send_changes:!0};this._ws=null;this._last_sent_data=[];this._last_received_data=[]}function l(){this.room_widget=this.addWidget("text","Room","lgraph",this.setRoom.bind(this));this.addWidget("button","Reconnect",null,this.connectSocket.bind(this));this.addInput("send",q.ACTION);this.addOutput("received",
q.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"tamats.com:55000",room:"lgraph",only_send_changes:!0};this._server=null;this.connectSocket();this._last_sent_data=[];this._last_received_data=[]}var q=u.LiteGraph;d.title="WebSocket";d.desc="Send data through a websocket";d.prototype.onPropertyChanged=function(d,l){"url"==d&&this.connectSocket()};d.prototype.onExecute=function(){!this._ws&&this.properties.url&&this.connectSocket();if(this._ws&&this._ws.readyState==WebSocket.OPEN){for(var d=
this.properties.room,l=this.properties.only_send_changes,m=1;m<this.inputs.length;++m){var q=this.getInputData(m);if(null!=q){var u;try{u=JSON.stringify({type:0,room:d,channel:m,data:q})}catch(z){continue}l&&this._last_sent_data[m]==u||(this._last_sent_data[m]=u,this._ws.send(u))}}for(m=1;m<this.outputs.length;++m)this.setOutputData(m,this._last_received_data[m]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};d.prototype.connectSocket=function(){var d=this,l=this.properties.url;"ws"!=l.substr(0,
2)&&(l="ws://"+l);this._ws=new WebSocket(l);this._ws.onopen=function(){console.log("ready");d.boxcolor="#6C6"};this._ws.onmessage=function(l){d.boxcolor="#AFA";var s=JSON.parse(l.data);if(!s.room||s.room==this.properties.room)if(1==l.data.type)if(s.data.object_class&&q[s.data.object_class]){l=null;try{l=new q[s.data.object_class](s.data),d.triggerSlot(0,l)}catch(u){}}else d.triggerSlot(0,s.data);else d._last_received_data[l.data.channel||0]=s.data};this._ws.onerror=function(l){console.log("couldnt connect to websocket");
d.boxcolor="#E88"};this._ws.onclose=function(l){console.log("connection closed");d.boxcolor="#000"}};d.prototype.send=function(d){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send(JSON.stringify({type:1,msg:d}))};d.prototype.onAction=function(d,l){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send({type:1,room:this.properties.room,action:d,data:l})};d.prototype.onGetInputs=function(){return[["in",0]]};d.prototype.onGetOutputs=function(){return[["out",0]]};q.registerNodeType("network/websocket",
d);l.title="SillyClient";l.desc="Connects to SillyServer to broadcast messages";l.prototype.onPropertyChanged=function(d,l){"room"==d&&(this.room_widget.value=l);this.connectSocket()};l.prototype.setRoom=function(d){this.properties.room=d;this.room_widget.value=d;this.connectSocket()};l.prototype.onDrawForeground=function(){for(var d=1;d<this.inputs.length;++d){var l=this.inputs[d];l.label="in_"+d}for(d=1;d<this.outputs.length;++d)l=this.outputs[d],l.label="out_"+d};l.prototype.onExecute=function(){if(this._server&&
this._server.is_connected){for(var d=this.properties.only_send_changes,l=1;l<this.inputs.length;++l){var m=this.getInputData(l);null==m||d&&this._last_sent_data[l]==m||(this._server.sendMessage({type:0,channel:l,data:m}),this._last_sent_data[l]=m)}for(l=1;l<this.outputs.length;++l)this.setOutputData(l,this._last_received_data[l]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};l.prototype.connectSocket=function(){var d=this;if("undefined"==typeof SillyClient)this._error||console.error("SillyClient node cannot be used, you must include SillyServer.js"),
this._error=!0;else if(this._server=new SillyClient,this._server.on_ready=function(){console.log("ready");d.boxcolor="#6C6"},this._server.on_message=function(l,s){var u=null;try{u=JSON.parse(s)}catch(z){return}if(1==u.type)if(u.data.object_class&&q[u.data.object_class]){var y=null;try{y=new q[u.data.object_class](u.data),d.triggerSlot(0,y)}catch(c){return}}else d.triggerSlot(0,u.data);else d._last_received_data[u.channel||0]=u.data;d.boxcolor="#AFA"},this._server.on_error=function(l){console.log("couldnt connect to websocket");
d.boxcolor="#E88"},this._server.on_close=function(l){console.log("connection closed");d.boxcolor="#000"},this.properties.url&&this.properties.room){try{this._server.connect(this.properties.url,this.properties.room)}catch(l){console.error("SillyServer error: "+l);this._server=null;return}this._final_url=this.properties.url+"/"+this.properties.room}};l.prototype.send=function(d){this._server&&this._server.is_connected&&this._server.sendMessage({type:1,data:d})};l.prototype.onAction=function(d,l){this._server&&
this._server.is_connected&&this._server.sendMessage({type:1,action:d,data:l})};l.prototype.onGetInputs=function(){return[["in",0]]};l.prototype.onGetOutputs=function(){return[["out",0]]};q.registerNodeType("network/sillyclient",l)})(this);
