...
b.name;c.prototype.onExecute=function(){for(var a=0;a<h.length;++a)h[a]=this.getInputData(a);a=b.apply(this,h);this.setOutputData(0,a)};this.registerNodeType(a,c)},addNodeMethod:function(a,b){f.prototype[a]=b;for(var c in this.registered_node_types){var n=this.registered_node_types[c];n.prototype[a]&&(n.prototype["_"+a]=n.prototype[a]);n.prototype[a]=b}},createNode:function(a,b,c){var n=this.registered_node_types[a];if(!n)return l.debug&&console.log('GraphNode type "'+a+'" not registered.'),null;
b=b||n.title||a;n=new n(b);n.type=a;!n.title&&b&&(n.title=b);n.properties||(n.properties={});n.properties_info||(n.properties_info=[]);n.flags||(n.flags={});n.size||(n.size=n.computeSize());n.pos||(n.pos=l.DEFAULT_POSITION.concat());n.mode||(n.mode=l.ALWAYS);if(c)for(var h in c)n[h]=c[h];return n},getNodeType:function(a){return this.registered_node_types[a]},getNodeTypesInCategory:function(a){var b=[],c;for(c in this.registered_node_types)""==a?null==this.registered_node_types[c].category&&b.push(this.registered_node_types[c]):
this.registered_node_types[c].category==a&&b.push(this.registered_node_types[c]);return b},getNodeTypesCategories:function(){var a={"":1},b;for(b in this.registered_node_types)this.registered_node_types[b].category&&!this.registered_node_types[b].skip_list&&(a[this.registered_node_types[b].category]=1);var c=[];for(b in a)c.push(b);return c},reloadNodes:function(a){var b=document.getElementsByTagName("script"),c=[],n;for(n in b)c.push(b[n]);b=document.getElementsByTagName("head")[0];a=document.location.href+
a;for(n in c){var h=c[n].src;if(h&&h.substr(0,a.length)==a)try{l.debug&&console.log("Reloading: "+h);var d=document.createElement("script");d.type="text/javascript";d.src=h;b.appendChild(d);b.removeChild(c[n])}catch(k){if(l.throw_errors)throw k;l.debug&&console.log("Error while reloading "+h)}}l.debug&&console.log("Nodes reloaded")},cloneObject:function(a,b){if(null==a)return null;var c=JSON.parse(JSON.stringify(a));if(!b)return c;for(var n in c)b[n]=c[n];return b},isValidConnection:function(a,b){if(!a||
!b||a==b||a==l.EVENT&&b==l.ACTION)return!0;a=String(a);b=String(b);a=a.toLowerCase();b=b.toLowerCase();if(-1==a.indexOf(",")&&-1==b.indexOf(","))return a==b;for(var c=a.split(","),n=b.split(","),h=0;h<c.length;++h)for(var d=0;d<n.length;++d)if(c[h]==n[d])return!0;return!1}};l.getTime="undefined"!=typeof performance?performance.now.bind(performance):"undefined"!=typeof Date&&Date.now?Date.now.bind(Date):"undefined"!=typeof process?function(){var a=process.hrtime();return 0.001*a[0]+1E-6*a[1]}:function(){return(new Date).getTime()};
r.LGraph=l.LGraph=g;g.supported_types=["number","string","boolean"];g.prototype.getSupportedTypes=function(){return this.supported_types||g.supported_types};g.STATUS_STOPPED=1;g.STATUS_RUNNING=2;g.prototype.clear=function(){this.stop();this.status=g.STATUS_STOPPED;this.last_node_id=0;this._nodes=[];this._nodes_by_id={};this._nodes_executable=this._nodes_in_order=null;this.last_link_id=0;this.links={};this.iteration=0;this.config={};this.fixedtime=this.runningtime=this.globaltime=0;this.elapsed_time=
this.fixedtime_lapse=0.01;this.starttime=0;this.catch_errors=!0;this.global_inputs={};this.global_outputs={};this.debug=!0;this.change();this.sendActionToCanvas("clear")};g.prototype.attachCanvas=function(a){if(a.constructor!=e)throw"attachCanvas expects a LGraphCanvas instance";a.graph&&a.graph!=this&&a.graph.detachCanvas(a);a.graph=this;this.list_of_graphcanvas||(this.list_of_graphcanvas=[]);this.list_of_graphcanvas.push(a)};g.prototype.detachCanvas=function(a){if(this.list_of_graphcanvas){var b=
...
null!=this.execution_timer_id&&clearInterval(this.execution_timer_id);this.execution_timer_id=null;this.sendEventToAllNodes("onStop")}};g.prototype.runStep=function(a,b){a=a||1;var c=l.getTime();this.globaltime=0.001*(c-this.starttime);var n=this._nodes_executable?this._nodes_executable:this._nodes;if(n){if(b){for(var h=0;h<a;h++){for(var d=0,k=n.length;d<k;++d){var v=n[d];if(v.mode==l.ALWAYS&&v.onExecute)v.onExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(h=
0;h<a;h++){d=0;for(k=n.length;d<k;++d)if(v=n[d],v.mode==l.ALWAYS&&v.onExecute)v.onExecute();this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute();this.errors_in_execution=!1}catch(e){this.errors_in_execution=!0;if(l.throw_errors)throw e;l.debug&&console.log("Error during execution: "+e);this.stop()}c=l.getTime()-c;0==c&&(c=1);this.elapsed_time=0.001*c;this.globaltime+=0.001*c;this.iteration+=1}};g.prototype.updateExecutionOrder=
function(){this._nodes_in_order=this.computeExecutionOrder(!1);this._nodes_executable=[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};g.prototype.computeExecutionOrder=function(a,b){for(var c=[],n=[],h={},d={},k={},v=0,e=this._nodes.length;v<e;++v){var f=this._nodes[v];if(!a||f.onExecute){h[f.id]=f;var m=0;if(f.inputs)for(var g=0,p=f.inputs.length;g<p;g++)f.inputs[g]&&null!=f.inputs[g].link&&(m+=1);0==m?(n.push(f),
b&&(f._level=1)):(b&&(f._level=0),k[f.id]=m)}}for(;0!=n.length;)if(f=n.shift(),c.push(f),delete h[f.id],f.outputs)for(v=0;v<f.outputs.length;v++)if(e=f.outputs[v],null!=e&&null!=e.links&&0!=e.links.length)for(g=0;g<e.links.length;g++)(m=this.links[e.links[g]])&&!d[m.id]&&(p=this.getNodeById(m.target_id),null==p?d[m.id]=!0:(b&&(!p._level||p._level<=f._level)&&(p._level=f._level+1),d[m.id]=!0,k[p.id]-=1,0==k[p.id]&&n.push(p)));for(v in h)c.push(h[v]);c.length!=this._nodes.length&&l.debug&&console.warn("something went wrong, nodes missing");
e=c.length;for(v=0;v<e;++v)c[v].order=v;c=c.sort(function(a,b){var c=a.constructor.priority||a.priority||0,n=b.constructor.priority||b.priority||0;return c==n?a.order-b.order:c-n});for(v=0;v<e;++v)c[v].order=v;return c};g.prototype.arrange=function(a){a=a||40;for(var b=this.computeExecutionOrder(!1,!0),c=[],n=0;n<b.length;++n){var h=b[n],d=h._level||1;c[d]||(c[d]=[]);c[d].push(h)}b=a;for(n=0;n<c.length;++n)if(d=c[n]){for(var k=100,e=a,f=0;f<d.length;++f)h=d[f],h.pos[0]=b,h.pos[1]=e,h.size[0]>k&&(k=
h.size[0]),e+=h.size[1]+a;b+=k+a}this.setDirtyCanvas(!0,!0)};g.prototype.getTime=function(){return this.globaltime};g.prototype.getFixedTime=function(){return this.fixedtime};g.prototype.getElapsedTime=function(){return this.elapsed_time};g.prototype.sendEventToAllNodes=function(a,b,c){c=c||l.ALWAYS;var n=this._nodes_in_order?this._nodes_in_order:this._nodes;if(n)for(var h=0,d=n.length;h<d;++h){var k=n[h];if(k[a]&&k.mode==c)if(void 0===b)k[a]();else if(b&&b.constructor===Array)k[a].apply(k,b);else k[a](b)}};
g.prototype.sendActionToCanvas=function(a,b){if(this.list_of_graphcanvas)for(var c=0;c<this.list_of_graphcanvas.length;++c){var n=this.list_of_graphcanvas[c];n[a]&&n[a].apply(n,b)}};g.prototype.add=function(a,b){if(a){-1!=a.id&&null!=this._nodes_by_id[a.id]&&(console.warn("LiteGraph: there is already a node with this ID, changing it"),a.id=++this.last_node_id);if(this._nodes.length>=l.MAX_NUMBER_OF_NODES)throw"LiteGraph: max number of nodes in a graph reached";null==a.id||-1==a.id?a.id=++this.last_node_id:
this.last_node_id<a.id&&(this.last_node_id=a.id);a.graph=this;this._nodes.push(a);this._nodes_by_id[a.id]=a;if(a.onAdded)a.onAdded(this);this.config.align_to_grid&&a.alignToGrid();b||this.updateExecutionOrder();if(this.onNodeAdded)this.onNodeAdded(a);this.setDirtyCanvas(!0);this.change();return a}};g.prototype.remove=function(a){if(null!=this._nodes_by_id[a.id]&&!a.ignore_remove){if(a.inputs)for(var b=0;b<a.inputs.length;b++){var c=a.inputs[b];null!=c.link&&a.disconnectInput(b)}if(a.outputs)for(b=
0;b<a.outputs.length;b++)c=a.outputs[b],null!=c.links&&c.links.length&&a.disconnectOutput(b);if(a.onRemoved)a.onRemoved();a.graph=null;if(this.list_of_graphcanvas)for(b=0;b<this.list_of_graphcanvas.length;++b)c=this.list_of_graphcanvas[b],c.selected_nodes[a.id]&&delete c.selected_nodes[a.id],c.node_dragged==a&&(c.node_dragged=null);b=this._nodes.indexOf(a);-1!=b&&this._nodes.splice(b,1);delete this._nodes_by_id[a.id];if(this.onNodeRemoved)this.onNodeRemoved(a);this.setDirtyCanvas(!0,!0);this.change();
this.updateExecutionOrder()}};g.prototype.getNodeById=function(a){return null==a?null:this._nodes_by_id[a]};g.prototype.findNodesByClass=function(a){for(var b=[],c=0,n=this._nodes.length;c<n;++c)this._nodes[c].constructor===a&&b.push(this._nodes[c]);return b};g.prototype.findNodesByType=function(a){a=a.toLowerCase();for(var b=[],c=0,n=this._nodes.length;c<n;++c)this._nodes[c].type.toLowerCase()==a&&b.push(this._nodes[c]);return b};g.prototype.findNodesByTitle=function(a){for(var b=[],c=0,n=this._nodes.length;c<
n;++c)this._nodes[c].title==a&&b.push(this._nodes[c]);return b};g.prototype.getNodeOnPos=function(a,b,c){c=c||this._nodes;for(var n=c.length-1;0<=n;n--){var h=c[n];if(h.isPointInsideNode(a,b,2))return h}return null};g.prototype.addGlobalInput=function(a,b,c){this.global_inputs[a]={name:a,type:b,value:c};if(this.onGlobalInputAdded)this.onGlobalInputAdded(a,b);if(this.onGlobalsChange)this.onGlobalsChange()};g.prototype.setGlobalInputData=function(a,b){var c=this.global_inputs[a];c&&(c.value=b)};g.prototype.setInputData=
...
delete this.global_outputs[a];if(this.onGlobalOutputRemoved)this.onGlobalOutputRemoved(a);if(this.onGlobalsChange)this.onGlobalsChange();return!0};g.prototype.triggerInput=function(a,b){for(var c=this.findNodesByTitle(a),n=0;n<c.length;++n)c[n].onTrigger(b)};g.prototype.setCallback=function(a,b){for(var c=this.findNodesByTitle(a),n=0;n<c.length;++n)c[n].setTrigger(b)};g.prototype.connectionChange=function(a){this.updateExecutionOrder();if(this.onConnectionChange)this.onConnectionChange(a);this.sendActionToCanvas("onConnectionChange")};
...
c=[];for(b in this.links){var n=this.links[b];c.push([n.id,n.origin_id,n.origin_slot,n.target_id,n.target_slot,n.type])}return{iteration:this.iteration,frame:this.frame,last_node_id:this.last_node_id,last_link_id:this.last_link_id,links:c,config:this.config,nodes:a}};g.prototype.configure=function(a,b){b||this.clear();var c=a.nodes;if(a.links&&a.links.constructor===Array){for(var n={},h=0;h<a.links.length;++h){var d=a.links[h];n[d[0]]={id:d[0],origin_id:d[1],origin_slot:d[2],target_id:d[3],target_slot:d[4],
type:d[5]}}a.links=n}for(h in a)this[h]=a[h];n=!1;this._nodes=[];h=0;for(d=c.length;h<d;++h){var k=c[h],e=l.createNode(k.type,k.title);e?(e.id=k.id,this.add(e,!0)):(l.debug&&console.log("Node not found: "+k.type),n=!0)}h=0;for(d=c.length;h<d;++h)k=c[h],(e=this.getNodeById(k.id))&&e.configure(k);this.updateExecutionOrder();this.setDirtyCanvas(!0,!0);return n};g.prototype.load=function(a){var b=this,c=new XMLHttpRequest;c.open("GET",a,!0);c.send(null);c.onload=function(a){200!==c.status?console.error("Error loading graph:",
c.status,c.response):(a=JSON.parse(c.response),b.configure(a))};c.onerror=function(a){console.error("Error loading graph:",a)}};g.prototype.onNodeTrace=function(a,b,c){};r.LGraphNode=l.LGraphNode=f;f.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[l.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>!a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=
null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.data=null;this.flags={}};f.prototype.configure=function(a){for(var b in a)if("console"!=b)if("properties"==b)for(var c in a.properties){if(this.properties[c]=a.properties[c],this.onPropertyChanged)this.onPropertyChanged(c,a.properties[c])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?this[b].configure(a[b]):this[b]=l.cloneObject(a[b],this[b]):this[b]=a[b]);a.title||(this.title=
this.constructor.title);if(this.onConnectionsChange){if(this.inputs)for(var n=0;n<this.inputs.length;++n){c=this.inputs[n];var d=this.graph.links[c.link];this.onConnectionsChange(l.INPUT,n,!0,d,c)}if(this.outputs)for(n=0;n<this.outputs.length;++n)if(c=this.outputs[n],c.links)for(b=0;b<c.links.length;++b)d=this.graph.links[c.links[b]],this.onConnectionsChange(l.OUTPUT,n,!0,d,c)}for(n in this.inputs)c=this.inputs[n],c.link&&c.link.length&&(d=c.link,"object"==typeof d&&(c.link=d[0],this.graph.links[d[0]]=
{id:d[0],origin_id:d[1],origin_slot:d[2],target_id:d[3],target_slot:d[4]}));for(n in this.outputs)if(c=this.outputs[n],c.links&&0!=c.links.length)for(b in c.links)d=c.links[b],"object"==typeof d&&(c.links[b]=d[0]);if(this.onConfigure)this.onConfigure(a)};f.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,size:this.size,data:this.data,flags:l.cloneObject(this.flags),mode:this.mode};this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;
...
0;c<b.inputs.length;++c)b.inputs[c].link=null;if(b.outputs)for(c=0;c<b.outputs.length;++c)b.outputs[c].links&&(b.outputs[c].links.length=0);delete b.id;a.configure(b);return a};f.prototype.toString=function(){return JSON.stringify(this.serialize())};f.prototype.getTitle=function(){return this.title||this.constructor.title};f.prototype.setOutputData=function(a,b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var c=this.outputs[a];if(c&&(c._data=b,this.outputs[a].links))for(c=0;c<this.outputs[a].links.length;c++)this.graph.links[this.outputs[a].links[c]].data=
b}};f.prototype.getInputData=function(a,b){if(this.inputs&&!(a>=this.inputs.length||null==this.inputs[a].link)){var c=this.graph.links[this.inputs[a].link];if(!c)return null;if(!b)return c.data;var n=this.graph.getNodeById(c.origin_id);if(!n)return c.data;if(n.updateOutputData)n.updateOutputData(c.origin_slot);else if(n.onExecute)n.onExecute();return c.data}};f.prototype.getInputDataByName=function(a,b){var c=this.findInputSlot(a);return-1==c?null:this.getInputData(c,b)};f.prototype.isInputConnected=
function(a){return this.inputs?a<this.inputs.length&&null!=this.inputs[a].link:!1};f.prototype.getInputInfo=function(a){return this.inputs?a<this.inputs.length?this.inputs[a]:null:null};f.prototype.getInputNode=function(a){if(!this.inputs||a>=this.inputs.length)return null;a=this.inputs[a];return a&&a.link?(a=this.graph.links[a.link])?this.graph.getNodeById(a.origin_id):null:null};f.prototype.getInputOrProperty=function(a){if(!this.inputs||!this.inputs.length)return this.properties?this.properties[a]:
null;for(var b=0,c=this.inputs.length;b<c;++b)if(a==this.inputs[b].name)return(a=this.graph.links[this.inputs[b].link])?a.data:null;return this.properties[a]};f.prototype.getOutputData=function(a){return!this.outputs||a>=this.outputs.length?null:this.outputs[a]._data};f.prototype.getOutputInfo=function(a){return this.outputs?a<this.outputs.length?this.outputs[a]:null:null};f.prototype.isOutputConnected=function(a){return this.outputs?a<this.outputs.length&&this.outputs[a].links&&this.outputs[a].links.length:
!1};f.prototype.isAnyOutputConnected=function(){if(!this.outputs)return!1;for(var a=0;a<this.outputs.length;++a)if(this.outputs[a].links&&this.outputs[a].links.length)return!0;return!1};f.prototype.getOutputNodes=function(a){if(!this.outputs||0==this.outputs.length||a>=this.outputs.length)return null;a=this.outputs[a];if(!a.links||0==a.links.length)return null;for(var b=[],c=0;c<a.links.length;c++){var n=this.graph.links[a.links[c]];n&&(n=this.graph.getNodeById(n.target_id))&&b.push(n)}return b};
f.prototype.trigger=function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=l.getTime());for(var c=0;c<this.outputs.length;++c){var n=this.outputs[c];!n||n.type!==l.EVENT||a&&n.name!=a||this.triggerSlot(c,b)}}};f.prototype.triggerSlot=function(a,b){if(this.outputs){var c=this.outputs[a];if(c&&(c=c.links)&&c.length){this.graph&&(this.graph._last_trigger_time=l.getTime());for(var n=0;n<c.length;++n){var d=this.graph.links[c[n]];if(d){var e=this.graph.getNodeById(d.target_id);
if(e)if(d._last_time=l.getTime(),d=e.inputs[d.target_slot],e.onAction)e.onAction(d.name,b);else if(e.mode===l.ON_TRIGGER&&e.onExecute)e.onExecute(b)}}}}};f.prototype.addProperty=function(a,b,c,d){c={name:a,type:c,default_value:b};if(d)for(var h in d)c[h]=d[h];this.properties_info||(this.properties_info=[]);this.properties_info.push(c);this.properties||(this.properties={});this.properties[a]=b;return c};f.prototype.addOutput=function(a,b,c){a={name:a,type:b,links:null};if(c)for(var d in c)a[d]=c[d];
this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);this.size=this.computeSize();return a};f.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],d={name:c[0],type:c[1],link:null};if(a[2])for(var h in c[2])d[h]=c[2][h];this.outputs||(this.outputs=[]);this.outputs.push(d);if(this.onOutputAdded)this.onOutputAdded(d)}this.size=this.computeSize()};f.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);this.size=
this.computeSize();if(this.onOutputRemoved)this.onOutputRemoved(a)};f.prototype.addInput=function(a,b,c){a={name:a,type:b||0,link:null};if(c)for(var d in c)a[d]=c[d];this.inputs||(this.inputs=[]);this.inputs.push(a);this.size=this.computeSize();if(this.onInputAdded)this.onInputAdded(a);return a};f.prototype.addInputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],d={name:c[0],type:c[1],link:null};if(a[2])for(var h in c[2])d[h]=c[2][h];this.inputs||(this.inputs=[]);this.inputs.push(d);if(this.onInputAdded)this.onInputAdded(d)}this.size=
this.computeSize()};f.prototype.removeInput=function(a){this.disconnectInput(a);this.inputs.splice(a,1);this.size=this.computeSize();if(this.onInputRemoved)this.onInputRemoved(a)};f.prototype.addConnection=function(a,b,c,d){a={name:a,type:b,pos:c,direction:d,links:null};this.connections.push(a);return a};f.prototype.computeSize=function(a,b){function c(a){return a?e*a.length*0.6:0}var d=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1),h=b||new Float32Array([0,0]),d=Math.max(d,
1);h[1]=14*d+6;var e=14,d=c(this.title),k=0,f=0;if(this.inputs)for(var m=0,g=this.inputs.length;m<g;++m){var p=this.inputs[m],p=p.label||p.name||"",p=c(p);k<p&&(k=p)}if(this.outputs)for(m=0,g=this.outputs.length;m<g;++m)p=this.outputs[m],p=p.label||p.name||"",p=c(p),f<p&&(f=p);h[0]=Math.max(k+f+10,d);h[0]=Math.max(h[0],l.NODE_WIDTH);return h};f.prototype.getBounding=function(a){a=a||new Float32Array(4);a[0]=this.pos[0]-4;a[1]=this.pos[1]-l.NODE_TITLE_HEIGHT;a[2]=this.size[0]+4;a[3]=this.size[1]+l.NODE_TITLE_HEIGHT;
return a};f.prototype.isPointInsideNode=function(a,b,c){c=c||0;var d=this.graph&&this.graph.isLive()?0:20;if(this.flags.collapsed){if(q(a,b,this.pos[0]-c,this.pos[1]-l.NODE_TITLE_HEIGHT-c,l.NODE_COLLAPSED_WIDTH+2*c,l.NODE_TITLE_HEIGHT+2*c))return!0}else if(this.pos[0]-4-c<a&&this.pos[0]+this.size[0]+4+c>a&&this.pos[1]-d-c<b&&this.pos[1]+this.size[1]+c>b)return!0;return!1};f.prototype.getSlotInPosition=function(a,b){if(this.inputs)for(var c=0,d=this.inputs.length;c<d;++c){var h=this.inputs[c],e=this.getConnectionPos(!0,
c);if(q(a,b,e[0]-10,e[1]-5,20,10))return{input:h,slot:c,link_pos:e,locked:h.locked}}if(this.outputs)for(c=0,d=this.outputs.length;c<d;++c)if(h=this.outputs[c],e=this.getConnectionPos(!1,c),q(a,b,e[0]-10,e[1]-5,20,10))return{output:h,slot:c,link_pos:e,locked:h.locked};return null};f.prototype.findInputSlot=function(a){if(!this.inputs)return-1;for(var b=0,c=this.inputs.length;b<c;++b)if(a==this.inputs[b].name)return b;return-1};f.prototype.findOutputSlot=function(a){if(!this.outputs)return-1;for(var b=
0,c=this.outputs.length;b<c;++b)if(a==this.outputs[b].name)return b;return-1};f.prototype.connect=function(a,b,c){c=c||0;if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return l.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return l.debug&&console.log("Connect: Error, slot number not found"),!1;b&&b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Node not found";if(b==this)return!1;if(c.constructor===String){if(c=
b.findInputSlot(c),-1==c)return l.debug&&console.log("Connect: Error, no slot of name "+c),!1}else{if(c===l.EVENT)return!1;if(!b.inputs||c>=b.inputs.length)return l.debug&&console.log("Connect: Error, slot number not found"),!1}null!=b.inputs[c].link&&b.disconnectInput(c);this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);var d=this.outputs[a];if(b.onConnectInput&&!1===b.onConnectInput(c,d.type,d))return!1;var h=b.inputs[c];if(l.isValidConnection(d.type,h.type)){var e={id:this.graph.last_link_id++,
type:h.type,origin_id:this.id,origin_slot:a,target_id:b.id,target_slot:c};this.graph.links[e.id]=e;null==d.links&&(d.links=[]);d.links.push(e.id);b.inputs[c].link=e.id;if(this.onConnectionsChange)this.onConnectionsChange(l.OUTPUT,a,!0,e,d);if(b.onConnectionsChange)b.onConnectionsChange(l.INPUT,c,!0,e,h)}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};f.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return l.debug&&console.log("Connect: Error, no slot of name "+
a),!1}else if(!this.outputs||a>=this.outputs.length)return l.debug&&console.log("Connect: Error, slot number not found"),!1;var c=this.outputs[a];if(!c.links||0==c.links.length)return!1;if(b){b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Target Node not found";for(var d=0,h=c.links.length;d<h;d++){var e=c.links[d],k=this.graph.links[e];if(k.target_id==b.id){c.links.splice(d,1);var f=b.inputs[k.target_slot];f.link=null;delete this.graph.links[e];if(b.onConnectionsChange)b.onConnectionsChange(l.INPUT,
k.target_slot,!1,k,f);if(this.onConnectionsChange)this.onConnectionsChange(l.OUTPUT,a,!1,k,c);break}}}else{d=0;for(h=c.links.length;d<h;d++)if(e=c.links[d],k=this.graph.links[e]){if(b=this.graph.getNodeById(k.target_id))if(f=b.inputs[k.target_slot],f.link=null,b.onConnectionsChange)b.onConnectionsChange(l.INPUT,k.target_slot,!1,k,f);delete this.graph.links[e];if(this.onConnectionsChange)this.onConnectionsChange(l.OUTPUT,a,!1,k,c)}c.links=null}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);
return!0};f.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return l.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||a>=this.inputs.length)return l.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var c=this.inputs[a].link;this.inputs[a].link=null;var d=this.graph.links[c];if(d){var h=this.graph.getNodeById(d.origin_id);if(!h)return!1;var e=h.outputs[d.origin_slot];
if(!e||!e.links||0==e.links.length)return!1;for(var k=0,f=e.links.length;k<f;k++)if(e.links[k]==c){e.links.splice(k,1);break}delete this.graph.links[c];if(this.onConnectionsChange)this.onConnectionsChange(l.INPUT,a,!1,d,b);if(h.onConnectionsChange)h.onConnectionsChange(l.OUTPUT,k,!1,d,e)}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};f.prototype.getConnectionPos=function(a,b){return this.flags.collapsed?a?[this.pos[0],this.pos[1]-0.5*l.NODE_TITLE_HEIGHT]:[this.pos[0]+l.NODE_COLLAPSED_WIDTH,
...
c.setDirtyCanvas(!0)};return b};f.prototype.captureInput=function(a){if(this.graph&&this.graph.list_of_graphcanvas)for(var b=this.graph.list_of_graphcanvas,c=0;c<b.length;++c){var d=b[c];if(a||d.node_capturing_input==this)d.node_capturing_input=a?this:null}};f.prototype.collapse=function(){this.flags.collapsed=this.flags.collapsed?!1:!0;this.setDirtyCanvas(!0,!0)};f.prototype.pin=function(a){this.flags.pinned=void 0===a?!this.flags.pinned:a};f.prototype.localToScreen=function(a,b,c){return[(a+this.pos[0])*
c.scale+c.offset[0],(b+this.pos[1])*c.scale+c.offset[1]]};r.LGraphCanvas=l.LGraphCanvas=e;e.link_type_colors={"-1":"#F85",number:"#AAC",node:"#DCA"};e.prototype.clear=function(){this.fps=this.render_time=this.last_draw_time=this.frame=0;this.scale=1;this.offset=[0,0];this.dragging_rectangle=null;this.selected_nodes={};this.visible_nodes=[];this.connecting_node=this.node_capturing_input=this.node_over=this.node_dragged=null;this.highlighted_links={};this.dirty_bgcanvas=this.dirty_canvas=!0;this.node_in_panel=
this.dirty_area=null;this.last_mouse=[0,0];this.last_mouseclick=0;if(this.onClear)this.onClear()};e.prototype.setGraph=function(a,b){this.graph!=a&&(b||this.clear(),!a&&this.graph?this.graph.detachCanvas(this):(a.attachCanvas(this),this.setDirty(!0,!0)))};e.prototype.openSubgraph=function(a){if(!a)throw"graph cannot be null";if(this.graph==a)throw"graph cannot be the same";this.clear();this.graph&&(this._graph_stack||(this._graph_stack=[]),this._graph_stack.push(this.graph));a.attachCanvas(this);
this.setDirty(!0,!0)};e.prototype.closeSubgraph=function(){if(this._graph_stack&&0!=this._graph_stack.length){var a=this._graph_stack.pop();this.selected_nodes={};this.highlighted_links={};a.attachCanvas(this);this.setDirty(!0,!0)}};e.prototype.setCanvas=function(a,b){if(a&&a.constructor===String&&(a=document.getElementById(a),!a))throw"Error creating LiteGraph canvas: Canvas not found";if(a!==this.canvas&&(!a&&this.canvas&&(b||this.unbindEvents()),this.canvas=a)){a.className+=" lgraphcanvas";a.data=
...
this.canvas.removeEventListener("touchstart",this.touchHandler);this.canvas.removeEventListener("touchmove",this.touchHandler);this.canvas.removeEventListener("touchend",this.touchHandler);this.canvas.removeEventListener("touchcancel",this.touchHandler);this._ondrop_callback=this._key_callback=this._mousewheel_callback=this._mousedown_callback=null;this._events_binded=!1}else console.warn("LGraphCanvas: no events binded")};e.getFileExtension=function(a){var b=a.indexOf("?");-1!=b&&(a=a.substr(0,b));
b=a.lastIndexOf(".");return-1==b?"":a.substr(b+1).toLowerCase()};e.prototype.enableWebGL=function(){if(void 0===typeof GL)throw"litegl.js must be included to use a WebGL canvas";if(void 0===typeof enableWebGLCanvas)throw"webglCanvas.js must be included to use this feature";this.gl=this.ctx=enableWebGLCanvas(this.canvas);this.ctx.webgl=!0;this.bgcanvas=this.canvas;this.bgctx=this.gl};e.prototype.setDirty=function(a,b){a&&(this.dirty_canvas=!0);b&&(this.dirty_bgcanvas=!0)};e.prototype.getCanvasWindow=
...
e.active_canvas=this;this.canvas.removeEventListener("mousemove",this._mousemove_callback);b.document.addEventListener("mousemove",this._mousemove_callback,!0);b.document.addEventListener("mouseup",this._mouseup_callback,!0);var c=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes),d=!1;l.closeAllContextMenus(b);if(1==a.which){a.ctrlKey&&(this.dragging_rectangle=new Float32Array(4),this.dragging_rectangle[0]=a.canvasX,this.dragging_rectangle[1]=a.canvasY,this.dragging_rectangle[2]=1,this.dragging_rectangle[3]=
1,d=!0);var h=!1;if(c&&this.allow_interaction&&!d){this.live_mode||c.flags.pinned||this.bringToFront(c);if(!this.connecting_node&&!c.flags.collapsed&&!this.live_mode){if(c.outputs)for(var f=0,k=c.outputs.length;f<k;++f){var m=c.outputs[f],g=c.getConnectionPos(!1,f);if(q(a.canvasX,a.canvasY,g[0]-10,g[1]-5,20,10)){this.connecting_node=c;this.connecting_output=m;this.connecting_pos=c.getConnectionPos(!1,f);this.connecting_slot=f;d=!0;break}}if(c.inputs)for(f=0,k=c.inputs.length;f<k;++f)m=c.inputs[f],
g=c.getConnectionPos(!0,f),q(a.canvasX,a.canvasY,g[0]-10,g[1]-5,20,10)&&null!==m.link&&(c.disconnectInput(f),d=this.dirty_bgcanvas=!0);!d&&q(a.canvasX,a.canvasY,c.pos[0]+c.size[0]-5,c.pos[1]+c.size[1]-5,5,5)&&(this.resizing_node=c,this.canvas.style.cursor="se-resize",d=!0)}!d&&q(a.canvasX,a.canvasY,c.pos[0],c.pos[1]-l.NODE_TITLE_HEIGHT,l.NODE_TITLE_HEIGHT,l.NODE_TITLE_HEIGHT)&&(c.collapse(),d=!0);if(!d){f=!1;if(300>l.getTime()-this.last_mouseclick&&this.selected_nodes[c.id]){if(c.onDblClick)c.onDblClick(a);
this.processNodeDblClicked(c);f=!0}c.onMouseDown&&c.onMouseDown(a,[a.canvasX-c.pos[0],a.canvasY-c.pos[1]])?f=!0:this.live_mode&&(f=h=!0);f||(this.allow_dragnodes&&(this.node_dragged=c),this.selected_nodes[c.id]||this.processNodeSelected(c,a));this.dirty_canvas=!0}}else h=!0;!d&&h&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&this.processContextMenu(c,a);this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=l.getTime();this.canvas_mouse=[a.canvasX,
...
[a.canvasX,a.canvasY];if(this.dragging_rectangle)this.dragging_rectangle[2]=a.canvasX-this.dragging_rectangle[0],this.dragging_rectangle[3]=a.canvasY-this.dragging_rectangle[1],this.dirty_canvas=!0;else if(this.dragging_canvas)this.offset[0]+=c[0]/this.scale,this.offset[1]+=c[1]/this.scale,this.dirty_bgcanvas=this.dirty_canvas=!0;else if(this.allow_interaction){this.connecting_node&&(this.dirty_canvas=!0);for(var b=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes),d=0,h=this.graph._nodes.length;d<
h;++d)if(this.graph._nodes[d].mouseOver&&b!=this.graph._nodes[d]){this.graph._nodes[d].mouseOver=!1;if(this.node_over&&this.node_over.onMouseLeave)this.node_over.onMouseLeave(a);this.node_over=null;this.dirty_canvas=!0}if(b){if(!b.mouseOver&&(b.mouseOver=!0,this.node_over=b,this.dirty_canvas=!0,b.onMouseEnter))b.onMouseEnter(a);if(b.onMouseMove)b.onMouseMove(a);if(this.connecting_node&&(h=this._highlight_input||[0,0],!this.isOverNodeBox(b,a.canvasX,a.canvasY))){var f=this.isOverNodeInput(b,a.canvasX,
a.canvasY,h);-1!=f&&b.inputs[f]?l.isValidConnection(this.connecting_output.type,b.inputs[f].type)&&(this._highlight_input=h):this._highlight_input=null}q(a.canvasX,a.canvasY,b.pos[0]+b.size[0]-5,b.pos[1]+b.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor=null}else this.canvas.style.cursor=null;if(this.node_capturing_input&&this.node_capturing_input!=b&&this.node_capturing_input.onMouseMove)this.node_capturing_input.onMouseMove(a);if(this.node_dragged&&!this.live_mode){for(d in this.selected_nodes)b=
this.selected_nodes[d],b.pos[0]+=c[0]/this.scale,b.pos[1]+=c[1]/this.scale;this.dirty_bgcanvas=this.dirty_canvas=!0}this.resizing_node&&!this.live_mode&&(this.resizing_node.size[0]+=c[0]/this.scale,this.resizing_node.size[1]+=c[1]/this.scale,c=Math.max(this.resizing_node.inputs?this.resizing_node.inputs.length:0,this.resizing_node.outputs?this.resizing_node.outputs.length:0),this.resizing_node.size[1]<c*l.NODE_SLOT_HEIGHT+4&&(this.resizing_node.size[1]=c*l.NODE_SLOT_HEIGHT+4),this.resizing_node.size[0]<
...
if(1==a.which)if(this.dragging_rectangle){if(this.graph){var c=this.graph._nodes,d=new Float32Array(4);this.deselectAllNodes();0>this.dragging_rectangle[2]&&(this.dragging_rectangle[0]+=this.dragging_rectangle[2]);0>this.dragging_rectangle[3]&&(this.dragging_rectangle[1]+=this.dragging_rectangle[3]);this.dragging_rectangle[2]=Math.abs(this.dragging_rectangle[2]*this.scale);this.dragging_rectangle[3]=Math.abs(this.dragging_rectangle[3]*this.scale);for(var h=0;h<c.length;++h)b=c[h],b.getBounding(d),
s(this.dragging_rectangle,d)&&this.selectNode(b,!0)}this.dragging_rectangle=null}else if(this.connecting_node){this.dirty_bgcanvas=this.dirty_canvas=!0;if(b=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes))this.connecting_output.type==l.EVENT&&this.isOverNodeBox(b,a.canvasX,a.canvasY)?this.connecting_node.connect(this.connecting_slot,b,l.EVENT):(c=this.isOverNodeInput(b,a.canvasX,a.canvasY),-1!=c?this.connecting_node.connect(this.connecting_slot,b,c):(c=b.getInputInfo(0),this.connecting_output.type==
...
this.node_dragged.pos[1]=Math.round(this.node_dragged.pos[1]),this.graph.config.align_to_grid&&this.node_dragged.alignToGrid(),this.node_dragged=null;else{b=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes);c=l.getTime();!b&&300>c-this.last_mouseclick&&this.deselectAllNodes();this.dirty_canvas=!0;this.dragging_canvas=!1;if(this.node_over&&this.node_over.onMouseUp)this.node_over.onMouseUp(a,[a.canvasX-this.node_over.pos[0],a.canvasY-this.node_over.pos[1]]);if(this.node_capturing_input&&
this.node_capturing_input.onMouseUp)this.node_capturing_input.onMouseUp(a,[a.canvasX-this.node_capturing_input.pos[0],a.canvasY-this.node_capturing_input.pos[1]])}else 2==a.which?(this.dirty_canvas=!0,this.dragging_canvas=!1):3==a.which&&(this.dirty_canvas=!0,this.dragging_canvas=!1);this.graph.change();a.stopPropagation();a.preventDefault();return!1}};e.prototype.processMouseWheel=function(a){if(this.graph&&this.allow_dragcanvas){var b=null!=a.wheelDeltaY?a.wheelDeltaY:-60*a.detail;this.adjustMouseEvent(a);
var c=this.scale;0<b?c*=1.1:0>b&&(c*=1/1.1);this.setZoom(c,[a.localX,a.localY]);this.graph.change();a.preventDefault();return!1}};e.prototype.isOverNodeBox=function(a,b,c){var d=l.NODE_TITLE_HEIGHT;return q(b,c,a.pos[0]+2,a.pos[1]+2-d,d-4,d-4)?!0:!1};e.prototype.isOverNodeInput=function(a,b,c,d){if(a.inputs)for(var h=0,e=a.inputs.length;h<e;++h){var k=a.getConnectionPos(!0,h);if(q(b,c,k[0]-10,k[1]-5,20,10))return d&&(d[0]=k[0],d[1]=k[1]),h}return-1};e.prototype.processKey=function(a){if(this.graph){var b=
!1;if("input"!=a.target.localName){if("keydown"==a.type){32==a.keyCode&&(b=this.dragging_canvas=!0);65==a.keyCode&&a.ctrlKey&&(this.selectNodes(),b=!0);"KeyC"==a.code&&(a.metaKey||a.ctrlKey)&&!a.shiftKey&&this.selected_nodes&&(this.copyToClipboard(),b=!0);"KeyV"!=a.code||!a.metaKey&&!a.ctrlKey||a.shiftKey||this.pasteFromClipboard();if(46==a.keyCode||8==a.keyCode)this.deleteSelectedNodes(),b=!0;if(this.selected_nodes)for(var c in this.selected_nodes)if(this.selected_nodes[c].onKeyDown)this.selected_nodes[c].onKeyDown(a)}else if("keyup"==
a.type&&(32==a.keyCode&&(this.dragging_canvas=!1),this.selected_nodes))for(c in this.selected_nodes)if(this.selected_nodes[c].onKeyUp)this.selected_nodes[c].onKeyUp(a);this.graph.change();if(b)return a.preventDefault(),!1}}};e.prototype.copyToClipboard=function(){var a={nodes:[],links:[]},b=0,c=[],d;for(d in this.selected_nodes){var h=this.selected_nodes[d];h._relative_id=b;c.push(h);b+=1}for(d=0;d<c.length;++d)if(h=c[d],a.nodes.push(h.clone().serialize()),h.inputs&&h.inputs.length)for(b=0;b<h.inputs.length;++b){var e=
h.inputs[b];if(e&&null!=e.link&&(e=this.graph.links[e.link])){var k=this.graph.getNodeById(e.origin_id);k&&this.selected_nodes[k.id]&&a.links.push([k._relative_id,b,h._relative_id,e.target_slot])}}localStorage.setItem("litegrapheditor_clipboard",JSON.stringify(a))};e.prototype.pasteFromClipboard=function(){var a=localStorage.getItem("litegrapheditor_clipboard");if(a){for(var a=JSON.parse(a),b=[],c=0;c<a.nodes.length;++c){var d=a.nodes[c],h=l.createNode(d.type);h&&(h.configure(d),h.pos[0]+=5,h.pos[1]+=
5,this.graph.add(h),b.push(h))}for(c=0;c<a.links.length;++c)d=a.links[c],b[d[0]].connect(d[1],b[d[2]],d[3]);this.selectNodes(b)}};e.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=[a.canvasX,a.canvasY],c=this.graph.getNodeOnPos(b[0],b[1]);if(c){if((c.onDropFile||c.onDropData)&&(b=a.dataTransfer.files)&&b.length)for(var d=0;d<b.length;d++){var h=a.dataTransfer.files[0],f=h.name;e.getFileExtension(f);if(c.onDropFile)c.onDropFile(h);if(c.onDropData){var k=new FileReader;
k.onload=function(a){c.onDropData(a.target.result,f,h)};var m=h.type.split("/")[0];"text"==m||""==m?k.readAsText(h):"image"==m?k.readAsDataURL(h):k.readAsArrayBuffer(h)}}return c.onDropItem&&c.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;this.onDropItem&&(b=this.onDropItem(event));b||this.checkDropItem(a)};e.prototype.checkDropItem=function(a){if(a.dataTransfer.files.length){var b=a.dataTransfer.files[0],c=e.getFileExtension(b.name).toLowerCase();if(c=l.node_types_by_file_extension[c])if(c=
l.createNode(c.type),c.pos=[a.canvasX,a.canvasY],this.graph.add(c),c.onDropFile)c.onDropFile(b)}};e.prototype.processNodeDblClicked=function(a){if(this.onShowNodePanel)this.onShowNodePanel(a);if(this.onNodeDblClicked)this.onNodeDblClicked(a);this.setDirty(!0)};e.prototype.processNodeSelected=function(a,b){this.selectNode(a,b&&b.shiftKey);if(this.onNodeSelected)this.onNodeSelected(a)};e.prototype.processNodeDeselected=function(a){this.deselectNode(a);if(this.onNodeDeselected)this.onNodeDeselected(a)};
e.prototype.selectNode=function(a,b){null==a?this.deselectAllNodes():this.selectNodes([a],b)};e.prototype.selectNodes=function(a,b){b||this.deselectAllNodes();a=a||this.graph._nodes;for(var c=0;c<a.length;++c){var d=a[c];if(!d.selected){if(!d.selected&&d.onSelected)d.onSelected();d.selected=!0;this.selected_nodes[d.id]=d;if(d.inputs)for(c=0;c<d.inputs.length;++c)this.highlighted_links[d.inputs[c].link]=!0;if(d.outputs)for(c=0;c<d.outputs.length;++c){var h=d.outputs[c];if(h.links)for(var e=0;e<h.links.length;++e)this.highlighted_links[h.links[e]]=
!0}}}this.setDirty(!0)};e.prototype.deselectNode=function(a){if(a.selected){if(a.onDeselected)a.onDeselected();a.selected=!1;if(a.inputs)for(var b=0;b<a.inputs.length;++b)delete this.highlighted_links[a.inputs[b].link];if(a.outputs)for(b=0;b<a.outputs.length;++b){var c=a.outputs[b];if(c.links)for(var d=0;d<c.links.length;++d)delete this.highlighted_links[c.links[d]]}}};e.prototype.deselectAllNodes=function(){if(this.graph){for(var a=this.graph._nodes,b=0,c=a.length;b<c;++b){var d=a[b];if(d.selected){if(d.onDeselected)d.onDeselected();
...
e.prototype.bringToFront=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.push(a))};e.prototype.sendToBack=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.unshift(a))};var m=new Float32Array(4);e.prototype.computeVisibleNodes=function(a,b){var c=b||[];c.length=0;a=a||this.graph._nodes;for(var d=0,h=a.length;d<h;++d){var e=a[d];(!this.live_mode||e.onDrawBackground||e.onDrawForeground)&&s(this.visible_area,
e.getBounding(m))&&c.push(e)}return c};e.prototype.draw=function(a,b){if(this.canvas){var c=l.getTime();this.render_time=0.001*(c-this.last_draw_time);this.last_draw_time=c;if(this.graph){var d=[-this.offset[0],-this.offset[1]],h=[d[0]+this.canvas.width/this.scale,d[1]+this.canvas.height/this.scale];this.visible_area=new Float32Array([d[0],d[1],h[0]-d[0],h[1]-d[1]])}(this.dirty_bgcanvas||b||this.always_render_background||this.graph&&this.graph._last_trigger_time&&1E3>c-this.graph._last_trigger_time)&&
...
function(){var a=this.getInputData(1);null!==a&&(this.properties.msg=a);console.log(a)};l.prototype.onGetInputs=function(){return[["log",d.ACTION],["warn",d.ACTION],["error",d.ACTION]]};d.registerNodeType("basic/console",l);m.title="Script";m.desc="executes a code";m.widgets_info={onExecute:{type:"code"}};m.prototype.onPropertyChanged=function(a,b){if("onExecute"==a&&d.allow_scripts){this._func=null;try{this._func=new Function(b)}catch(c){console.error("Error parsing script"),console.error(c)}}};
m.prototype.onExecute=function(){if(this._func)try{this._func.call(this)}catch(a){console.error("Error in script"),console.error(a)}};d.registerNodeType("basic/script",m)})(this);
...
"number");this.addOutput("out","number");this.size=[60,20];this.addProperty("min",0);this.addProperty("max",1)}function s(){this.properties={f:0.5};this.addInput("A","number");this.addInput("B","number");this.addOutput("out","number")}function u(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20]}function l(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,20]}function m(){this.addInput("in","number");this.addOutput("out","number");this.size=[60,
...
this.addProperty("factor",0.1);this.size=[60,20];this._value=null}function n(){this.addInput("A","number");this.addInput("B","number");this.addOutput("=","number");this.addProperty("A",1);this.addProperty("B",1);this.addProperty("OP","+","string",{values:n.values})}function h(){this.addInput("A","number");this.addInput("B","number");this.addOutput("A==B","boolean");this.addOutput("A!=B","boolean");this.addProperty("A",0);this.addProperty("B",0)}function t(){this.addInput("A","number");this.addInput("B",
"number");this.addOutput("out","boolean");this.addProperty("A",1);this.addProperty("B",1);this.addProperty("OP",">","string",{values:t.values});this.size=[60,40]}function k(){this.addInput("inc","number");this.addOutput("total","number");this.addProperty("increment",1);this.addProperty("value",0)}function v(){this.addInput("v","number");this.addOutput("sin","number");this.addProperty("amplitude",1);this.addProperty("offset",0);this.bgImageUrl="nodes/imgs/icon-sin.png"}function x(){this.addInput("vec2",
"vec2");this.addOutput("x","number");this.addOutput("y","number")}function y(){this.addInputs([["x","number"],["y","number"]]);this.addOutput("vec2","vec2");this.properties={x:0,y:0};this._data=new Float32Array(2)}function z(){this.addInput("vec3","vec3");this.addOutput("x","number");this.addOutput("y","number");this.addOutput("z","number")}function B(){this.addInputs([["x","number"],["y","number"],["z","number"]]);this.addOutput("vec3","vec3");this.properties={x:0,y:0,z:0};this._data=new Float32Array(3)}
function A(){this.addInput("vec4","vec4");this.addOutput("x","number");this.addOutput("y","number");this.addOutput("z","number");this.addOutput("w","number")}function C(){this.addInputs([["x","number"],["y","number"],["z","number"],["w","number"]]);this.addOutput("vec4","vec4");this.properties={x:0,y:0,z:0,w:0};this._data=new Float32Array(4)}var w=r.LiteGraph;g.title="Converter";g.desc="type A to type B";g.prototype.onExecute=function(){var a=this.getInputData(0);if(null!=a&&this.outputs)for(var b=
...
"vec4"]]};w.registerNodeType("math/converter",g);f.title="Bypass";f.desc="removes the type";f.prototype.onExecute=function(){var a=this.getInputData(0);this.setOutputData(0,a)};w.registerNodeType("math/bypass",f);e.title="Range";e.desc="Convert a number from one range to another";e.prototype.onExecute=function(){if(this.inputs)for(var a=0;a<this.inputs.length;a++){var b=this.inputs[a],c=this.getInputData(a);void 0!==c&&(this.properties[b.name]=c)}c=this.properties["in"];if(void 0===c||null===c||c.constructor!==
Number)c=0;a=this.properties.in_min;b=this.properties.out_min;this._last_v=(c-a)/(this.properties.in_max-a)*(this.properties.out_max-b)+b;this.setOutputData(0,this._last_v)};e.prototype.onDrawBackground=function(a){this.outputs[0].label=this._last_v?this._last_v.toFixed(3):"?"};e.prototype.onGetInputs=function(){return[["in_min","number"],["in_max","number"],["out_min","number"],["out_max","number"]]};w.registerNodeType("math/range",e);p.title="Rand";p.desc="Random number";p.prototype.onExecute=function(){if(this.inputs)for(var a=
...
null==b&&(b=0);var c=this.properties.f,d=this.getInputData(2);void 0!==d&&(c=d);this.setOutputData(0,a*(1-c)+b*c)};s.prototype.onGetInputs=function(){return[["f","number"]]};w.registerNodeType("math/lerp",s);u.title="Abs";u.desc="Absolute";u.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,Math.abs(a))};w.registerNodeType("math/abs",u);l.title="Floor";l.desc="Floor number to remove fractional part";l.prototype.onExecute=function(){var a=this.getInputData(0);
null!=a&&this.setOutputData(0,Math.floor(a))};w.registerNodeType("math/floor",l);m.title="Frac";m.desc="Returns fractional part";m.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a%1)};w.registerNodeType("math/frac",m);d.title="Smoothstep";d.desc="Smoothstep";d.prototype.onExecute=function(){var a=this.getInputData(0);if(void 0!==a){var b=this.properties.A,a=Math.clamp((a-b)/(this.properties.B-b),0,1);this.setOutputData(0,a*a*(3-2*a))}};w.registerNodeType("math/smoothstep",
d);a.title="Scale";a.desc="v * factor";a.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a*this.properties.factor)};w.registerNodeType("math/scale",a);b.title="Average";b.desc="Average Filter";b.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this._values.length;this._values[this._current%b]=a;this._current+=1;this._current>b&&(this._current=0);for(var c=a=0;c<b;++c)a+=this._values[c];this.setOutputData(0,a/b)};b.prototype.onPropertyChanged=
...
(1-b)+a*b;this.setOutputData(0,this._value)};w.registerNodeType("math/tendTo",c);n.values="+-*/%^".split("");n.title="Operation";n.desc="Easy math operators";n["@OP"]={type:"enum",title:"operation",values:n.values};n.prototype.setValue=function(a){"string"==typeof a&&(a=parseFloat(a));this.properties.value=a};n.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.A=a:a=this.properties.A;null!=b?this.properties.B=b:b=this.properties.B;var c=0;switch(this.properties.OP){case "+":c=
a+b;break;case "-":c=a-b;break;case "x":case "X":case "*":c=a*b;break;case "/":c=a/b;break;case "%":c=a%b;break;case "^":c=Math.pow(a,b);break;default:console.warn("Unknown operation: "+this.properties.OP)}this.setOutputData(0,c)};n.prototype.onDrawBackground=function(a){this.flags.collapsed||(a.font="40px Arial",a.fillStyle="black",a.textAlign="center",a.fillText(this.properties.OP,0.5*this.size[0],0.5*this.size[1]+w.NODE_TITLE_HEIGHT),a.textAlign="left")};w.registerNodeType("math/operation",n);
h.title="Compare";h.desc="compares between two values";h.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1);void 0!==a?this.properties.A=a:a=this.properties.A;void 0!==b?this.properties.B=b:b=this.properties.B;for(var c=0,d=this.outputs.length;c<d;++c){var e=this.outputs[c];if(e.links&&e.links.length){switch(e.name){case "A==B":value=a==b;break;case "A!=B":value=a!=b;break;case "A>B":value=a>b;break;case "A<B":value=a<b;break;case "A<=B":value=a<=b;break;case "A>=B":value=
a>=b}this.setOutputData(c,value)}}};h.prototype.onGetOutputs=function(){return[["A==B","boolean"],["A!=B","boolean"],["A>B","boolean"],["A<B","boolean"],["A>=B","boolean"],["A<=B","boolean"]]};w.registerNodeType("math/compare",h);t.values="> < == != <= >=".split(" ");t["@OP"]={type:"enum",title:"operation",values:t.values};t.title="Condition";t.desc="evaluates condition between A and B";t.prototype.onExecute=function(){var a=this.getInputData(0);void 0===a?a=this.properties.A:this.properties.A=a;
var b=this.getInputData(1);void 0===b?b=this.properties.B:this.properties.B=b;var c=!0;switch(this.properties.OP){case ">":c=a>b;break;case "<":c=a<b;break;case "==":c=a==b;break;case "!=":c=a!=b;break;case "<=":c=a<=b;break;case ">=":c=a>=b}this.setOutputData(0,c)};w.registerNodeType("math/condition",t);k.title="Accumulate";k.desc="Increments a value every time";k.prototype.onExecute=function(){null===this.properties.value&&(this.properties.value=0);var a=this.getInputData(0);this.properties.value=
null!==a?this.properties.value+a:this.properties.value+this.properties.increment;this.setOutputData(0,this.properties.value)};w.registerNodeType("math/accumulate",k);v.title="Trigonometry";v.desc="Sin Cos Tan";v.filter="shader";v.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.properties.amplitude,c=this.findInputSlot("amplitude");-1!=c&&(b=this.getInputData(c));var d=this.properties.offset,c=this.findInputSlot("offset");-1!=c&&(d=this.getInputData(c));for(var c=
0,e=this.outputs.length;c<e;++c){switch(this.outputs[c].name){case "sin":value=Math.sin(a);break;case "cos":value=Math.cos(a);break;case "tan":value=Math.tan(a);break;case "asin":value=Math.asin(a);break;case "acos":value=Math.acos(a);break;case "atan":value=Math.atan(a)}this.setOutputData(c,b*value+d)}};v.prototype.onGetInputs=function(){return[["v","number"],["amplitude","number"],["offset","number"]]};v.prototype.onGetOutputs=function(){return[["sin","number"],["cos","number"],["tan","number"],
["asin","number"],["acos","number"],["atan","number"]]};w.registerNodeType("math/trigonometry",v);if(void 0!=typeof math){var D=function(){this.addInputs("x","number");this.addInputs("y","number");this.addOutputs("","number");this.properties={x:1,y:1,formula:"x+y"}};D.title="Formula";D.desc="Compute safe formula";D.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.x=a:a=this.properties.x;null!=b?this.properties.y=b:b=this.properties.y;a=math.eval(this.properties.formula,
{x:a,y:b,T:this.graph.globaltime});this.setOutputData(0,a)};D.prototype.onDrawBackground=function(){this.outputs[0].label=this.properties.formula};D.prototype.onGetOutputs=function(){return[["A-B","number"],["A*B","number"],["A/B","number"]]};w.registerNodeType("math/formula",D)}x.title="Vec2->XY";x.desc="vector 2 to components";x.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]))};w.registerNodeType("math3d/vec2-to-xyz",x);y.title=
"XY->Vec2";y.desc="components to vector2";y.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var c=this._data;c[0]=a;c[1]=b;this.setOutputData(0,c)};w.registerNodeType("math3d/xy-to-vec2",y);z.title="Vec3->XYZ";z.desc="vector 3 to components";z.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]),this.setOutputData(2,a[2]))};w.registerNodeType("math3d/vec3-to-xyz",
z);B.title="XYZ->Vec3";B.desc="components to vector3";B.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var c=this.getInputData(2);null==c&&(c=this.properties.z);var d=this._data;d[0]=a;d[1]=b;d[2]=c;this.setOutputData(0,d)};w.registerNodeType("math3d/xyz-to-vec3",B);A.title="Vec4->XYZW";A.desc="vector 4 to components";A.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,
a[0]),this.setOutputData(1,a[1]),this.setOutputData(2,a[2]),this.setOutputData(3,a[3]))};w.registerNodeType("math3d/vec4-to-xyzw",A);C.title="XYZW->Vec4";C.desc="components to vector4";C.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var c=this.getInputData(2);null==c&&(c=this.properties.z);var d=this.getInputData(3);null==d&&(d=this.properties.w);var e=this._data;e[0]=a;e[1]=b;e[2]=c;e[3]=d;this.setOutputData(0,
e)};w.registerNodeType("math3d/xyzw-to-vec4",C);r.glMatrix&&(r=function(){this.addOutput("quat","quat");this.properties={x:0,y:0,z:0,w:1};this._value=quat.create()},r.title="Quaternion",r.desc="quaternion",r.prototype.onExecute=function(){this._value[0]=this.properties.x;this._value[1]=this.properties.y;this._value[2]=this.properties.z;this._value[3]=this.properties.w;this.setOutputData(0,this._value)},w.registerNodeType("math3d/quaternion",r),r=function(){this.addInputs([["degrees","number"],["axis",
...
if(null!=a){var b=this.getInputData(1);if(null!=b){var c=this.properties.factor;null!=this.getInputData(2)&&(c=this.getInputData(2));a=quat.slerp(this._value,a,b,c);this.setOutputData(0,a)}}},w.registerNodeType("math3d/quat-slerp",r))})(this);
...
a.name&&this.show()};p.prototype.show=function(){showElement&&this.frame&&showElement(this.frame)};m.registerNodeType("graphics/frame",p);q.title="Image fade";q.desc="Fades between images";q.widgets=[{name:"resizeA",text:"Resize to A",type:"button"},{name:"resizeB",text:"Resize to B",type:"button"}];q.prototype.onAdded=function(){this.createCanvas();var d=this.canvas.getContext("2d");d.fillStyle="#000";d.fillRect(0,0,this.properties.width,this.properties.height)};q.prototype.createCanvas=function(){this.canvas=
document.createElement("canvas");this.canvas.width=this.properties.width;this.canvas.height=this.properties.height};q.prototype.onExecute=function(){var d=this.canvas.getContext("2d");this.canvas.width=this.canvas.width;var a=this.getInputData(0);null!=a&&d.drawImage(a,0,0,this.canvas.width,this.canvas.height);a=this.getInputData(2);null==a?a=this.properties.fade:this.properties.fade=a;d.globalAlpha=a;a=this.getInputData(1);null!=a&&d.drawImage(a,0,0,this.canvas.width,this.canvas.height);d.globalAlpha=
1;this.setOutputData(0,this.canvas);this.setDirtyCanvas(!0)};m.registerNodeType("graphics/imagefade",q);s.title="Crop";s.desc="Crop Image";s.prototype.onAdded=function(){this.createCanvas()};s.prototype.createCanvas=function(){this.canvas=document.createElement("canvas");this.canvas.width=this.properties.width;this.canvas.height=this.properties.height};s.prototype.onExecute=function(){var d=this.getInputData(0);d&&(d.width?(this.canvas.getContext("2d").drawImage(d,-this.properties.x,-this.properties.y,
...
u.prototype.onPropertyChanged=function(d,a){this.properties[d]=a;"url"==d&&""!=a&&this.loadVideo(a);return!0};u.prototype.play=function(){this._video&&this._video.play()};u.prototype.playPause=function(){this._video&&(this._video.paused?this.play():this.pause())};u.prototype.stop=function(){this._video&&(this._video.pause(),this._video.currentTime=0)};u.prototype.pause=function(){this._video&&(this.trace("Video paused"),this._video.pause())};u.prototype.onWidget=function(d,a){};m.registerNodeType("graphics/video",
u);l.title="Webcam";l.desc="Webcam image";l.prototype.openStream=function(){function d(b){console.log("Webcam rejected",b);a._webcam_stream=!1;a.box_color="red"}navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia;window.URL=window.URL||window.webkitURL;if(navigator.getUserMedia){this._waiting_confirmation=!0;navigator.getUserMedia({video:!0},this.streamReady.bind(this),d);var a=this}};l.prototype.onRemoved=function(){this._webcam_stream&&
(this._webcam_stream.stop(),this._video=this._webcam_stream=null)};l.prototype.streamReady=function(d){this._webcam_stream=d;var a=this._video;a||(a=document.createElement("video"),a.autoplay=!0,a.src=window.URL.createObjectURL(d),this._video=a,a.onloadedmetadata=function(a){console.log(a)})};l.prototype.onExecute=function(){null!=this._webcam_stream||this._waiting_confirmation||this.openStream();this._video&&this._video.videoWidth&&(this._video.width=this._video.videoWidth,this._video.height=this._video.videoHeight,
this.setOutputData(0,this._video))};l.prototype.getExtraMenuOptions=function(d){var a=this;return[{content:a.properties.show?"Hide Frame":"Show Frame",callback:function(){a.properties.show=!a.properties.show}}]};l.prototype.onDrawBackground=function(d){this.flags.collapsed||20>=this.size[1]||!this.properties.show||!this._video||(d.save(),d.drawImage(this._video,0,0,this.size[0],this.size[1]),d.restore())};m.registerNodeType("graphics/webcam",l)})(this);
...
new GL.Texture(b,c,{type:d,format:gl.RGBA,filter:gl.LINEAR}));var e=this._shader;e||(e=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,s.pixel_shader));var k=this.getInputData(1);k?(this.properties.scale[0]=k[0],this.properties.scale[1]=k[1]):k=this.properties.scale;var g=this.getInputData(2);g?(this.properties.offset[0]=g[0],this.properties.offset[1]=g[1]):g=this.properties.offset;this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a.bind(0);var b=Mesh.getScreenQuad();
e.uniforms({u_texture:0,u_scale:k,u_offset:g}).draw(b)});this.setOutputData(0,this._tex)}};s.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform vec2 u_scale;\n\t\t\tuniform vec2 u_offset;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tuv = uv / u_scale - u_offset;\n\t\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t\t}\n\t\t\t";g.registerNodeType("texture/scaleOffset",
...
g.registerNodeType("texture/channelsTexture",c);var n=function(){this.addInput("A","color");this.addInput("B","color");this.addOutput("Texture","Texture");this.properties={angle:0,scale:1,A:[0,0,0],B:[1,1,1],texture_size:32};n._shader||(n._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,n.pixel_shader));this._uniforms={u_angle:0,u_colorA:vec3.create(),u_colorB:vec3.create()}};n.title="Gradient";n.desc="Generates a gradient";n["@A"]={type:"color"};n["@B"]={type:"color"};n["@texture_size"]={type:"enum",
values:[32,64,128,256,512]};n.prototype.onExecute=function(){gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var a=GL.Mesh.getScreenQuad(),b=n._shader,c=this.getInputData(0);c||(c=this.properties.A);var d=this.getInputData(1);d||(d=this.properties.B);for(var e=2;e<this.inputs.length;e++){var f=this.inputs[e],k=this.getInputData(e);void 0!==k&&(this.properties[f.name]=k)}var g=this._uniforms;this._uniforms.u_angle=this.properties.angle*DEG2RAD;this._uniforms.u_scale=this.properties.scale;vec3.copy(g.u_colorA,
c);vec3.copy(g.u_colorB,d);c=parseInt(this.properties.texture_size);this._tex&&this._tex.width==c||(this._tex=new GL.Texture(c,c,{format:gl.RGB,filter:gl.LINEAR}));this._tex.drawTo(function(){b.uniforms(g).draw(a)});this.setOutputData(0,this._tex)};n.prototype.onGetInputs=function(){return[["angle","number"],["scale","number"]]};n.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float u_angle;\n\t\t\tuniform float u_scale;\n\t\t\tuniform vec3 u_colorA;\n\t\t\tuniform vec3 u_colorB;\n\t\t\t\n\t\t\tvec2 rotate(vec2 v, float angle)\n\t\t\t{\n\t\t\t\tvec2 result;\n\t\t\t\tfloat _cos = cos(angle);\n\t\t\t\tfloat _sin = sin(angle);\n\t\t\t\tresult.x = v.x * _cos - v.y * _sin;\n\t\t\t\tresult.y = v.x * _sin + v.y * _cos;\n\t\t\t\treturn result;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tfloat f = (rotate(u_scale * (v_coord - vec2(0.5)), u_angle) + vec2(0.5)).x;\n\t\t\t\tvec3 color = mix(u_colorA,u_colorB,clamp(f,0.0,1.0));\n\t\t\t   gl_FragColor = vec4(color,1.0);\n\t\t\t}\n\t\t\t";
g.registerNodeType("texture/gradient",n);var h=function(){this.addInput("A","Texture");this.addInput("B","Texture");this.addInput("Mixer","Texture");this.addOutput("Texture","Texture");this.properties={precision:f.DEFAULT};h._shader||(h._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,h.pixel_shader))};h.title="Mix";h.desc="Generates a texture mixing two textures";h.widgets_info={precision:{widget:"combo",values:f.MODE_VALUES}};h.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===
f.PASS_THROUGH)this.setOutputData(0,a);else{var b=this.getInputData(1),c=this.getInputData(2);if(a&&b&&c){this._tex=f.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var d=Mesh.getScreenQuad(),e=h._shader;this._tex.drawTo(function(){a.bind(0);b.bind(1);c.bind(2);e.uniforms({u_textureA:0,u_textureB:1,u_textureMix:2}).draw(d)});this.setOutputData(0,this._tex)}}};h.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_textureA;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tuniform sampler2D u_textureMix;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t   gl_FragColor = mix( texture2D(u_textureA, v_coord), texture2D(u_textureB, v_coord), texture2D(u_textureMix, v_coord) );\n\t\t\t}\n\t\t\t";
g.registerNodeType("texture/mix",h);var t=function(){this.addInput("Tex.","Texture");this.addOutput("Edges","Texture");this.properties={invert:!0,threshold:!1,factor:1,precision:f.DEFAULT};t._shader||(t._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,t.pixel_shader))};t.title="Edges";t.desc="Detects edges";t.widgets_info={precision:{widget:"combo",values:f.MODE_VALUES}};t.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);if(this.properties.precision===f.PASS_THROUGH)this.setOutputData(0,
a);else if(a){this._tex=f.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var b=Mesh.getScreenQuad(),c=t._shader,d=this.properties.invert,e=this.properties.factor,k=this.properties.threshold?1:0;this._tex.drawTo(function(){a.bind(0);c.uniforms({u_texture:0,u_isize:[1/a.width,1/a.height],u_factor:e,u_threshold:k,u_invert:d?1:0}).draw(b)});this.setOutputData(0,this._tex)}}};t.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_isize;\n\t\t\tuniform int u_invert;\n\t\t\tuniform float u_factor;\n\t\t\tuniform float u_threshold;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 center = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 up = texture2D(u_texture, v_coord + u_isize * vec2(0.0,1.0) );\n\t\t\t\tvec4 down = texture2D(u_texture, v_coord + u_isize * vec2(0.0,-1.0) );\n\t\t\t\tvec4 left = texture2D(u_texture, v_coord + u_isize * vec2(1.0,0.0) );\n\t\t\t\tvec4 right = texture2D(u_texture, v_coord + u_isize * vec2(-1.0,0.0) );\n\t\t\t\tvec4 diff = abs(center - up) + abs(center - down) + abs(center - left) + abs(center - right);\n\t\t\t\tdiff *= u_factor;\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tdiff.xyz = vec3(1.0) - diff.xyz;\n\t\t\t\tif( u_threshold == 0.0 )\n\t\t\t\t\tgl_FragColor = vec4( diff.xyz, center.a );\n\t\t\t\telse\n\t\t\t\t\tgl_FragColor = vec4( diff.x > 0.5 ? 1.0 : 0.0, diff.y > 0.5 ? 1.0 : 0.0, diff.z > 0.5 ? 1.0 : 0.0, center.a );\n\t\t\t}\n\t\t\t";
g.registerNodeType("texture/edges",t);var k=function(){this.addInput("Texture","Texture");this.addInput("Distance","number");this.addInput("Range","number");this.addOutput("Texture","Texture");this.properties={distance:100,range:50,only_depth:!1,high_precision:!1};this._uniforms={u_texture:0,u_distance:100,u_range:50,u_camera_planes:null}};k.title="Depth Range";k.desc="Generates a texture with a depth range";k.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);
...
(d=this.getInputData(2),this.properties.range=d);c.u_distance=b;c.u_range=d;gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var e=Mesh.getScreenQuad();k._shader||(k._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,k.pixel_shader),k._shader_onlydepth=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,k.pixel_shader,{ONLY_DEPTH:""}));var f=this.properties.only_depth?k._shader_onlydepth:k._shader,b=null,b=a.near_far_planes?a.near_far_planes:window.LS&&LS.Renderer._main_camera?LS.Renderer._main_camera._uniforms.u_camera_planes:
[0.1,1E3];c.u_camera_planes=b;this._temp_texture.drawTo(function(){a.bind(0);f.uniforms(c).draw(e)});this._temp_texture.near_far_planes=b;this.setOutputData(0,this._temp_texture)}}};k.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform float u_distance;\n\t\t\tuniform float u_range;\n\t\t\t\n\t\t\tfloat LinearDepth()\n\t\t\t{\n\t\t\t\tfloat zNear = u_camera_planes.x;\n\t\t\t\tfloat zFar = u_camera_planes.y;\n\t\t\t\tfloat depth = texture2D(u_texture, v_coord).x;\n\t\t\t\tdepth = depth * 2.0 - 1.0;\n\t\t\t\treturn zNear * (depth + 1.0) / (zFar + zNear - depth * (zFar - zNear));\n\t\t\t}\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat depth = LinearDepth();\n\t\t\t\t#ifdef ONLY_DEPTH\n\t\t\t\t   gl_FragColor = vec4(depth);\n\t\t\t\t#else\n\t\t\t\t\tfloat diff = abs(depth * u_camera_planes.y - u_distance);\n\t\t\t\t\tfloat dof = 1.0;\n\t\t\t\t\tif(diff <= u_range)\n\t\t\t\t\t\tdof = diff / u_range;\n\t\t\t\t   gl_FragColor = vec4(dof);\n\t\t\t\t#endif\n\t\t\t}\n\t\t\t";
g.registerNodeType("texture/depth_range",k);var v=function(){this.addInput("Texture","Texture");this.addInput("Iterations","number");this.addInput("Intensity","number");this.addOutput("Blurred","Texture");this.properties={intensity:1,iterations:1,preserve_aspect:!1,scale:[1,1],precision:f.DEFAULT}};v.title="Blur";v.desc="Blur a texture";v.widgets_info={precision:{widget:"combo",values:f.MODE_VALUES}};v.max_iterations=20;v.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0)){var b=
this._final_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._final_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var c=this.properties.iterations;this.isInputConnected(1)&&(c=this.getInputData(1),this.properties.iterations=c);c=Math.min(Math.floor(c),v.max_iterations);if(0==c)this.setOutputData(0,a);else{var d=this.properties.intensity;this.isInputConnected(2)&&(d=this.getInputData(2),this.properties.intensity=d);var e=g.camera_aspect;
e||void 0===window.gl||(e=gl.canvas.height/gl.canvas.width);e||(e=1);var e=this.properties.preserve_aspect?e:1,f=this.properties.scale||[1,1];a.applyBlur(e*f[0],f[1],d,b);for(a=1;a<c;++a)b.applyBlur(e*f[0]*(a+1),f[1]*(a+1),d);this.setOutputData(0,b)}}};g.registerNodeType("texture/blur",v);var x=function(){this.addInput("in","Texture");this.addInput("dirt","Texture");this.addOutput("out","Texture");this.addOutput("glow","Texture");this.properties={enabled:!0,intensity:1,persistence:0.99,iterations:16,
...
wrap:gl.CLAMP_TO_EDGE},e=f.getTextureType(this.properties.precision,a),k=this._uniforms,g=this._textures,h=x._cut_shader;h||(h=x._cut_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,x.cut_pixel_shader));gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);k.u_threshold=this.getInputOrProperty("threshold");var l=g[0]=GL.Texture.getTemporary(b,c,d);a.blit(l,h.uniforms(k));var m=l,n=this.getInputOrProperty("iterations"),n=Math.clamp(n,1,16)|0,p=k.u_texel_size,v=this.getInputOrProperty("intensity");k.u_intensity=
1;k.u_delta=this.properties.scale;h=x._shader;h||(h=x._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,x.scale_pixel_shader));for(var q=1;q<n;q++){b>>=1;1<(c|0)&&(c>>=1);if(2>b)break;l=g[q]=GL.Texture.getTemporary(b,c,d);p[0]=1/m.width;p[1]=1/m.height;m.blit(l,h.uniforms(k));m=l}this.isOutputConnected(2)&&(b=this._average_texture,b&&b.type==a.type&&b.format==a.format||(b=this._average_texture=new GL.Texture(1,1,{type:a.type,format:a.format,filter:gl.LINEAR})),p[0]=1/m.width,p[1]=1/m.height,k.u_intensity=
v,k.u_delta=1,m.blit(b,h.uniforms(k)),this.setOutputData(2,b));gl.enable(gl.BLEND);gl.blendFunc(gl.ONE,gl.ONE);k.u_intensity=this.getInputOrProperty("persistence");k.u_delta=0.5;for(q-=2;0<=q;q--)l=g[q],g[q]=null,p[0]=1/m.width,p[1]=1/m.height,m.blit(l,h.uniforms(k)),GL.Texture.releaseTemporary(m),m=l;gl.disable(gl.BLEND);this.isOutputConnected(1)&&(g=this._glow_texture,g&&g.width==a.width&&g.height==a.height&&g.type==e&&g.format==a.format||(g=this._glow_texture=new GL.Texture(a.width,a.height,{type:e,
format:a.format,filter:gl.LINEAR})),m.blit(g),this.setOutputData(1,g));if(this.isOutputConnected(0)){g=this._final_texture;g&&g.width==a.width&&g.height==a.height&&g.type==e&&g.format==a.format||(g=this._final_texture=new GL.Texture(a.width,a.height,{type:e,format:a.format,filter:gl.LINEAR}));var s=this.getInputData(1),u=this.getInputOrProperty("dirt_factor");k.u_intensity=v;h=s?x._dirt_final_shader:x._final_shader;h||(h=s?x._dirt_final_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,x.final_pixel_shader,
{USE_DIRT:""}):x._final_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,x.final_pixel_shader));g.drawTo(function(){a.bind(0);m.bind(1);s&&(h.setUniform("u_dirt_factor",u),h.setUniform("u_dirt_texture",s.bind(2)));h.toViewport(k)});this.setOutputData(0,g)}GL.Texture.releaseTemporary(m)}};x.cut_pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_threshold;\n\t\tvoid main() {\n\t\t\tgl_FragColor = max( texture2D( u_texture, v_coord ) - vec4( u_threshold ), vec4(0.0) );\n\t\t}";
...
this.properties.aberration=g);var l=this.properties.distortion;this.isInputConnected(2)&&(l=this.getInputData(2),this.properties.distortion=l);var m=this.properties.blur;this.isInputConnected(3)&&(m=this.getInputData(3),this.properties.blur=m);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var d=Mesh.getScreenQuad(),a=f._shader;this._tex.drawTo(function(){e.bind(0);a.uniforms({u_texture:0,u_aberration:g,u_distortion:l,u_blur:m}).draw(d)});this.setOutputData(0,this._tex)}};f.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform float u_aberration;\n\t\t\tuniform float u_distortion;\n\t\t\tuniform float u_blur;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 coord = v_coord;\n\t\t\t\tfloat dist = distance(vec2(0.5), coord);\n\t\t\t\tvec2 dist_coord = coord - vec2(0.5);\n\t\t\t\tfloat percent = 1.0 + ((0.5 - dist) / 0.5) * u_distortion;\n\t\t\t\tdist_coord *= percent;\n\t\t\t\tcoord = dist_coord + vec2(0.5);\n\t\t\t\tvec4 color = texture2D(u_texture,coord, u_blur * dist);\n\t\t\t\tcolor.r = texture2D(u_texture,vec2(0.5) + dist_coord * (1.0+0.01*u_aberration), u_blur * dist ).r;\n\t\t\t\tcolor.b = texture2D(u_texture,vec2(0.5) + dist_coord * (1.0-0.01*u_aberration), u_blur * dist ).b;\n\t\t\t\tgl_FragColor = color;\n\t\t\t}\n\t\t\t";
...
if(f&&l&&this.properties.shape){g||(g=f);var m=LGraphTexture.getTexture(this.properties.shape);if(m){var d=this.properties.threshold;this.isInputConnected(3)&&(d=this.getInputData(3),this.properties.threshold=d);var a=gl.UNSIGNED_BYTE;this.properties.high_precision&&(a=gl.half_float_ext?gl.HALF_FLOAT_OES:gl.FLOAT);this._temp_texture&&this._temp_texture.type==a&&this._temp_texture.width==f.width&&this._temp_texture.height==f.height||(this._temp_texture=new GL.Texture(f.width,f.height,{type:a,format:gl.RGBA,
filter:gl.LINEAR}));var b=e._first_shader;b||(b=e._first_shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,e._first_pixel_shader));var c=e._second_shader;c||(c=e._second_shader=new GL.Shader(e._second_vertex_shader,e._second_pixel_shader));var n=this._points_mesh;n&&n._width==f.width&&n._height==f.height&&2==n._spacing||(n=this.createPointsMesh(f.width,f.height,2));var h=Mesh.getScreenQuad(),p=this.properties.size,k=this.properties.alpha;gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);this._temp_texture.drawTo(function(){f.bind(0);
g.bind(1);l.bind(2);b.uniforms({u_texture:0,u_texture_blur:1,u_mask:2,u_texsize:[f.width,f.height]}).draw(h)});this._temp_texture.drawTo(function(){gl.enable(gl.BLEND);gl.blendFunc(gl.ONE,gl.ONE);f.bind(0);m.bind(3);c.uniforms({u_texture:0,u_mask:2,u_shape:3,u_alpha:k,u_threshold:d,u_pointSize:p,u_itexsize:[1/f.width,1/f.height]}).draw(n,gl.POINTS)});this.setOutputData(0,this._temp_texture)}}else this.setOutputData(0,f)};e.prototype.createPointsMesh=function(e,f,g){for(var m=Math.round(e/g),d=Math.round(f/
g),a=new Float32Array(m*d*2),b=-1,c=2/e*g,n=2/f*g,h=0;h<d;++h){for(var p=-1,k=0;k<m;++k){var v=h*m*2+2*k;a[v]=p;a[v+1]=b;p+=c}b+=n}this._points_mesh=GL.Mesh.load({vertices2D:a});this._points_mesh._width=e;this._points_mesh._height=f;this._points_mesh._spacing=g;return this._points_mesh};e._first_pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_texture_blur;\n\t\t\tuniform sampler2D u_mask;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 blurred_color = texture2D(u_texture_blur, v_coord);\n\t\t\t\tfloat mask = texture2D(u_mask, v_coord).x;\n\t\t\t   gl_FragColor = mix(color, blurred_color, mask);\n\t\t\t}\n\t\t\t";
...
LGraphTexture.getTargetTexture(e,this._tex,this.properties.precision);var f=this.properties.value1;this.isInputConnected(1)&&(f=this.getInputData(1),this.properties.value1=f);var g=this.properties.value2;this.isInputConnected(2)&&(g=this.getInputData(2),this.properties.value2=g);var m=this.properties.fx,d=p.shaders[m];if(!d){var a=p["pixel_shader_"+m];if(!a)return;d=p.shaders[m]=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,a)}gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var b=Mesh.getScreenQuad();
camera_planes=r.LS&&LS.Renderer._current_camera?[LS.Renderer._current_camera.near,LS.Renderer._current_camera.far]:[1,100];var c=null;"noise"==m&&(c=LGraphTexture.getNoiseTexture());this._tex.drawTo(function(){e.bind(0);"noise"==m&&c.bind(1);d.uniforms({u_texture:0,u_noise:1,u_size:[e.width,e.height],u_rand:[Math.random(),Math.random()],u_value1:f,u_value2:g,u_camera_planes:camera_planes}).draw(b)});this.setOutputData(0,this._tex)}}};p.pixel_shader_halftone="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform vec2 u_size;\n\t\t\tuniform float u_value1;\n\t\t\tuniform float u_value2;\n\t\t\t\n\t\t\tfloat pattern() {\n\t\t\t\tfloat s = sin(u_value1 * 3.1415), c = cos(u_value1 * 3.1415);\n\t\t\t\tvec2 tex = v_coord * u_size.xy;\n\t\t\t\tvec2 point = vec2(\n\t\t\t\t   c * tex.x - s * tex.y ,\n\t\t\t\t   s * tex.x + c * tex.y \n\t\t\t\t) * u_value2;\n\t\t\t\treturn (sin(point.x) * sin(point.y)) * 4.0;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat average = (color.r + color.g + color.b) / 3.0;\n\t\t\t\tgl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);\n\t\t\t}\n";
...
var f=this.properties.intensity;this.isInputConnected(1)&&(f=this.getInputData(1),this.properties.intensity=f);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var g=Mesh.getScreenQuad(),m=q._shader,d=this.properties.invert;this._tex.drawTo(function(){e.bind(0);m.uniforms({u_texture:0,u_intensity:f,u_isize:[1/e.width,1/e.height],u_invert:d?1:0}).draw(g)});this.setOutputData(0,this._tex)}};q.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_intensity;\n\t\t\tuniform int u_invert;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat luminance = 1.0 - length( v_coord - vec2(0.5) ) * 1.414;\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tluminance = 1.0 - luminance;\n\t\t\t\tluminance = mix(1.0, luminance, u_intensity);\n\t\t\t   gl_FragColor = vec4( luminance * color.xyz, color.a);\n\t\t\t}\n\t\t\t";
g.registerNodeType("fx/vigneting",q);r.LGraphFXVigneting=q}})(this);
(function(r){function g(d){this.cmd=this.channel=0;d?this.setup(d):this.data=[0,0,0]}function f(d,a){navigator.requestMIDIAccess?(this.on_ready=d,this.state={note:[],cc:[]},navigator.requestMIDIAccess().then(this.onMIDISuccess.bind(this),this.onMIDIFailure.bind(this))):(this.error="not suppoorted",a?a("Not supported"):console.error("MIDI NOT SUPPORTED, enable by chrome://flags"))}function e(){this.addOutput("on_midi",m.EVENT);this.addOutput("out","midi");this.properties={port:0};this._current_midi_event=
this._last_midi_event=null;var d=this;new f(function(a){d._midi=a;if(d._waiting)d.onStart();d._waiting=!1})}function p(){this.addInput("send",m.EVENT);this.properties={port:0};var d=this;new f(function(a){d._midi=a})}function q(){this.addInput("on_midi",m.EVENT);this._str="";this.size=[200,40]}function s(){this.properties={channel:-1,cmd:-1,min_value:-1,max_value:-1};this.addInput("in",m.EVENT);this.addOutput("on_midi",m.EVENT)}function u(){this.properties={channel:0,cmd:"CC",value1:1,value2:1};this.addInput("send",
m.EVENT);this.addInput("assign",m.EVENT);this.addOutput("on_midi",m.EVENT)}function l(){this.properties={cc:1,value:0};this.addOutput("value","number")}var m=r.LiteGraph;g.prototype.setup=function(d){this.data=d;this.status=d=d[0];var a=d&240;this.cmd=240<=d?d:a;this.cmd==g.NOTEON&&0==this.velocity&&(this.cmd=g.NOTEOFF);this.cmd_str=g.commands[this.cmd]||"";if(a>=g.NOTEON||a<=g.NOTEOFF)this.channel=d&15};Object.defineProperty(g.prototype,"velocity",{get:function(){return this.cmd==g.NOTEON?this.data[2]:
...
this._last_midi_event,a=0;a<this.outputs.length;++a){var b=null;switch(this.outputs[a].name){case "midi":b=this._midi;break;case "last_midi":b=d;break;default:continue}this.setOutputData(a,b)}};e.prototype.onGetOutputs=function(){return[["last_midi","midi"],["on_midi",m.EVENT],["on_noteon",m.EVENT],["on_noteoff",m.EVENT],["on_cc",m.EVENT],["on_pc",m.EVENT],["on_pitchbend",m.EVENT]]};m.registerNodeType("midi/input",e);p.MIDIInterface=f;p.title="MIDI Output";p.desc="Sends MIDI to output channel";p.prototype.getPropertyInfo=
function(d){if(this._midi&&"port"==d){d={};for(var a=0;a<this._midi.output_ports.size;++a){var b=this._midi.output_ports.get(a);d[a]=a+".- "+b.name+" version:"+b.version}return{type:"enum",values:d}}};p.prototype.onAction=function(d,a){console.log(a);this._midi&&("send"==d&&this._midi.sendMIDI(this.port,a),this.trigger("midi",a))};p.prototype.onGetInputs=function(){return[["send",m.ACTION]]};p.prototype.onGetOutputs=function(){return[["on_midi",m.EVENT]]};m.registerNodeType("midi/output",p);q.title=
"MIDI Show";q.desc="Shows MIDI in the graph";q.prototype.onAction=function(d,a){a&&(this._str=a.constructor===g?a.toString():"???")};q.prototype.onDrawForeground=function(d){this._str&&(d.font="30px Arial",d.fillText(this._str,10,0.8*this.size[1]))};q.prototype.onGetInputs=function(){return[["in",m.ACTION]]};q.prototype.onGetOutputs=function(){return[["on_midi",m.EVENT]]};m.registerNodeType("midi/show",q);s.title="MIDI Filter";s.desc="Filters MIDI messages";s.prototype.onAction=function(d,a){!a||
a.constructor!==g||-1!=this.properties.channel&&a.channel!=this.properties.channel||-1!=this.properties.cmd&&a.cmd!=this.properties.cmd||-1!=this.properties.min_value&&a.data[1]<this.properties.min_value||-1!=this.properties.max_value&&a.data[1]>this.properties.max_value||this.trigger("on_midi",a)};m.registerNodeType("midi/filter",s);u.title="MIDIEvent";u.desc="Create a MIDI Event";u.prototype.onAction=function(d,a){"assign"==d?(this.properties.channel=a.channel,this.properties.cmd=a.cmd,this.properties.value1=
...
function(d,a){"cmd"==d&&(this.properties.cmd=g.computeCommandFromString(a))};u.prototype.onGetOutputs=function(){return[["midi","midi"],["on_midi",m.EVENT],["command","number"],["note","number"],["velocity","number"],["cc","number"],["cc_value","number"],["pitch","number"],["pitchbend","number"]]};m.registerNodeType("midi/event",u);l.title="MIDICC";l.desc="gets a Controller Change";l.prototype.onExecute=function(){f.input&&(this.properties.value=f.input.state.cc[this.properties.cc]);this.setOutputData(0,
this.properties.value)};m.registerNodeType("midi/cc",l)})(this);
...
(console.warn("ScriptProcessorNode deprecated"),this.audionode=a.createGain());this.processCode();c._bypass_function||(c._bypass_function=this.audionode.onaudioprocess);this.addInput("in","audio");this.addOutput("out","audio")}function n(){this.audionode=t.getAudioContext().destination;this.addInput("in","audio")}var h=r.LiteGraph,t={};r.LGAudio=t;t.getAudioContext=function(){if(!this._audio_context){window.AudioContext=window.AudioContext||window.webkitAudioContext;if(!window.AudioContext)return console.error("AudioContext not supported by browser"),
...
h=a.graph.getNodeById(d.target_id),d=h.getAudioNodeInInputSlot?h.getAudioNodeInInputSlot(d.target_slot):h.audionode;b?t.connect(f,d):t.disconnect(f,d)}};t.onConnectionsChange=function(a,b,c,d){if(a==h.OUTPUT&&(a=null,d&&(a=this.graph.getNodeById(d.target_id)),a)){var e=null,e=this.getAudioNodeInOutputSlot?this.getAudioNodeInOutputSlot(b):this.audionode;b=null;b=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(d.target_slot):a.audionode;c?t.connect(e,b):t.disconnect(e,b)}};t.createAudioNodeWrapper=
...
null!=b.link&&"audio"!=b.type&&(b=this.getInputData(a),void 0!==b&&(1==a?this.audionode1.gain.value=b:3==a&&(this.audionode2.gain.value=b)))}};t.createAudioNodeWrapper(u);u.title="Mixer";u.desc="Audio mixer";h.registerNodeType("audio/mixer",u);t.createAudioNodeWrapper(l);l.prototype.onExecute=function(){var a=this.getInputData(1);void 0!==a&&(this.audionode.delayTime.value=a)};l.title="Delay";l.desc="Audio delay";h.registerNodeType("audio/delay",l);m.prototype.onExecute=function(){if(this.inputs&&
this.inputs.length)for(var a=1;a<this.inputs.length;++a){var b=this.inputs[a];if(null!=b.link){var c=this.getInputData(a);void 0!==c&&(this.audionode[b.name].value=c)}}};m.prototype.onGetInputs=function(){return[["frequency","number"],["detune","number"],["Q","number"]]};t.createAudioNodeWrapper(m);m.title="BiquadFilter";m.desc="Audio filter";h.registerNodeType("audio/biquadfilter",m);d.prototype.onStart=function(){this.audionode.started||(this.audionode.started=!0,this.audionode.start())};d.prototype.onStop=
