...
{x:a,y:b,T:this.graph.globaltime});this.setOutputData(0,a)};z.prototype.onDrawBackground=function(){this.outputs[0].label=this.properties.formula};z.prototype.onGetOutputs=function(){return[["A-B","number"],["A*B","number"],["A/B","number"]]};v.registerNodeType("math/formula",z)}D.title="Vec2->XY";D.desc="vector 2 to components";D.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]))};v.registerNodeType("math3d/vec2-to-xyz",D);w.title=
"XY->Vec2";w.desc="components to vector2";w.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var c=this._data;c[0]=a;c[1]=b;this.setOutputData(0,c)};v.registerNodeType("math3d/xy-to-vec2",w);y.title="Vec3->XYZ";y.desc="vector 3 to components";y.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]),this.setOutputData(2,a[2]))};v.registerNodeType("math3d/vec3-to-xyz",
...
parseInt(a);this.createCanvas();return!0};s.registerNodeType("graphics/cropImage",q);r.title="Video";r.desc="Video playback";r.widgets=[{name:"play",text:"PLAY",type:"minibutton"},{name:"stop",text:"STOP",type:"minibutton"},{name:"demo",text:"Demo video",type:"button"},{name:"mute",text:"Mute video",type:"button"}];r.prototype.onExecute=function(){if(this.properties.url&&(this.properties.url!=this._video_url&&this.loadVideo(this.properties.url),this._video&&0!=this._video.width)){var c=this.getInputData(0);
c&&0<=c&&1>=c&&(this._video.currentTime=c*this._video.duration,this._video.pause());this._video.dirty=!0;this.setOutputData(0,this._video);this.setOutputData(1,this._video.currentTime);this.setOutputData(2,this._video.duration);this.setDirtyCanvas(!0)}};r.prototype.onStart=function(){this.play()};r.prototype.onStop=function(){this.stop()};r.prototype.loadVideo=function(c){this._video_url=c;this.properties.use_proxy&&"http"==c.substr(0,4)&&s.proxy&&(c=s.proxy+c.substr(c.indexOf(":")+3));this._video=
document.createElement("video");this._video.src=c;this._video.type="type=video/mp4";this._video.muted=!0;this._video.autoplay=!0;var a=this;this._video.addEventListener("loadedmetadata",function(b){a.trace("Duration: "+this.duration+" seconds");a.trace("Size: "+this.videoWidth+","+this.videoHeight);a.setDirtyCanvas(!0);this.width=this.videoWidth;this.height=this.videoHeight});this._video.addEventListener("progress",function(a){});this._video.addEventListener("error",function(b){console.log("Error loading video: "+
...
r.prototype.onPropertyChanged=function(c,a){this.properties[c]=a;"url"==c&&""!=a&&this.loadVideo(a);return!0};r.prototype.play=function(){this._video&&this._video.play()};r.prototype.playPause=function(){this._video&&(this._video.paused?this.play():this.pause())};r.prototype.stop=function(){this._video&&(this._video.pause(),this._video.currentTime=0)};r.prototype.pause=function(){this._video&&(this.trace("Video paused"),this._video.pause())};r.prototype.onWidget=function(c,a){};s.registerNodeType("graphics/video",
r);l.title="Webcam";l.desc="Webcam image";l.prototype.openStream=function(){function c(b){console.log("Webcam rejected",b);a._webcam_stream=!1;a.box_color="red"}navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia;window.URL=window.URL||window.webkitURL;if(navigator.getUserMedia){this._waiting_confirmation=!0;navigator.getUserMedia({video:!0},this.streamReady.bind(this),c);var a=this}};l.prototype.onRemoved=function(){this._webcam_stream&&
(this._webcam_stream.stop(),this._video=this._webcam_stream=null)};l.prototype.streamReady=function(c){this._webcam_stream=c;var a=this._video;a||(a=document.createElement("video"),a.autoplay=!0,a.src=window.URL.createObjectURL(c),this._video=a,a.onloadedmetadata=function(a){console.log(a)})};l.prototype.onExecute=function(){null!=this._webcam_stream||this._waiting_confirmation||this.openStream();this._video&&this._video.videoWidth&&(this._video.width=this._video.videoWidth,this._video.height=this._video.videoHeight,
this.setOutputData(0,this._video))};l.prototype.getExtraMenuOptions=function(c){var a=this;return[{content:a.properties.show?"Hide Frame":"Show Frame",callback:function(){a.properties.show=!a.properties.show}}]};l.prototype.onDrawBackground=function(c){this.flags.collapsed||20>=this.size[1]||!this.properties.show||!this._video||(c.save(),c.drawImage(this._video,0,0,this.size[0],this.size[1]),c.restore())};s.registerNodeType("graphics/webcam",l)})(this);
(function(u){var g=u.LiteGraph;u.LGraphTexture=null;if("undefined"!=typeof GL){var e=function(){this.addOutput("Texture","Texture");this.properties={name:"",filter:!0};this.size=[e.image_preview_size,e.image_preview_size]};u.LGraphTexture=e;e.title="Texture";e.desc="Texture";e.widgets_info={name:{widget:"texture"},filter:{widget:"checkbox"}};e.loadTextureCallback=null;e.image_preview_size=256;e.PASS_THROUGH=1;e.COPY=2;e.LOW=3;e.HIGH=4;e.REUSE=5;e.DEFAULT=2;e.MODE_VALUES={"pass through":e.PASS_THROUGH,
copy:e.COPY,low:e.LOW,high:e.HIGH,reuse:e.REUSE,"default":e.DEFAULT};e.getTexturesContainer=function(){return gl.textures};e.loadTexture=function(a,b){b=b||{};var c=a;"http://"==c.substr(0,7)&&g.proxy&&(c=g.proxy+c.substr(7));return e.getTexturesContainer()[a]=GL.Texture.fromURL(c,b)};e.getTexture=function(a){var b=this.getTexturesContainer();if(!b)throw"Cannot load texture, container of textures not found";b=b[a];return!b&&a&&":"!=a[0]?this.loadTexture(a):b};e.getTargetTexture=function(a,b,c){if(!a)throw"LGraphTexture.getTargetTexture expects a reference texture";
...
d&&this._tex.height==f||(this._tex=new GL.Texture(d,f,{type:b,format:gl.RGBA,filter:gl.LINEAR}));this._tex.drawTo(function(){a.uniforms(g).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._tex)}}};q.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float time;\n\t";g.registerNodeType("texture/shader",q);var r=function(){this.addInput("in","Texture");this.addInput("scale","vec2");this.addInput("offset","vec2");this.addOutput("out","Texture");this.properties=
{offset:vec2.fromValues(0,0),scale:vec2.fromValues(1,1),precision:e.DEFAULT}};r.widgets_info={precision:{widget:"combo",values:e.MODE_VALUES}};r.title="Scale/Offset";r.desc="Applies an scaling and offseting";r.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0)&&a)if(this.properties.precision===e.PASS_THROUGH)this.setOutputData(0,a);else{var b=a.width,c=a.height,d=this.precision===e.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT;this.precision===e.DEFAULT&&(d=a.type);
this._tex&&this._tex.width==b&&this._tex.height==c&&this._tex.type==d||(this._tex=new GL.Texture(b,c,{type:d,format:gl.RGBA,filter:gl.LINEAR}));var f=this._shader;f||(f=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,r.pixel_shader));var k=this.getInputData(1);k?(this.properties.scale[0]=k[0],this.properties.scale[1]=k[1]):k=this.properties.scale;var g=this.getInputData(2);g?(this.properties.offset[0]=g[0],this.properties.offset[1]=g[1]):g=this.properties.offset;this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);
gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a.bind(0);var b=Mesh.getScreenQuad();f.uniforms({u_texture:0,u_scale:k,u_offset:g}).draw(b)});this.setOutputData(0,this._tex)}};r.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform vec2 u_scale;\n\t\t\tuniform vec2 u_offset;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tuv = uv / u_scale - u_offset;\n\t\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t\t}\n\t\t\t";
g.registerNodeType("texture/scaleOffset",r);var l=function(){this.addInput("in","Texture");this.addInput("warp","Texture");this.addInput("factor","number");this.addOutput("out","Texture");this.properties={factor:0.01,precision:e.DEFAULT}};l.widgets_info={precision:{widget:"combo",values:e.MODE_VALUES}};l.title="Warp";l.desc="Texture warp operation";l.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===e.PASS_THROUGH)this.setOutputData(0,
a);else{var b=this.getInputData(1),c=512,d=512;a?(c=a.width,d=a.height):b&&(c=b.width,d=b.height);this._tex=a||this._tex?e.getTargetTexture(a||this._tex,this._tex,this.properties.precision):new GL.Texture(c,d,{type:this.precision===e.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT,format:gl.RGBA,filter:gl.LINEAR});var f=this._shader;f||(f=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,l.pixel_shader));var k=this.getInputData(2);null!=k?this.properties.factor=k:k=parseFloat(this.properties.factor);this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);
gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a&&a.bind(0);b&&b.bind(1);var c=Mesh.getScreenQuad();f.uniforms({u_texture:0,u_textureB:1,u_factor:k}).draw(c)});this.setOutputData(0,this._tex)}};l.pixel_shader="precision highp float;\n\t\t\t\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform float u_factor;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec2 uv = v_coord;\n\t\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor;\n\t\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t\t}\n\t\t\t";
...
wrap:gl.CLAMP_TO_EDGE},f=e.getTextureType(this.properties.precision,a),k=this._uniforms,g=this._textures,h=w._cut_shader;h||(h=w._cut_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,w.cut_pixel_shader));gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);k.u_threshold=this.getInputOrProperty("threshold");var l=g[0]=GL.Texture.getTemporary(b,c,d);a.blit(l,h.uniforms(k));var m=l,n=this.getInputOrProperty("iterations"),n=Math.clamp(n,1,16)|0,p=k.u_texel_size,t=this.getInputOrProperty("intensity");k.u_intensity=
1;k.u_delta=this.properties.scale;h=w._shader;h||(h=w._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,w.scale_pixel_shader));for(var q=1;q<n;q++){b>>=1;1<(c|0)&&(c>>=1);if(2>b)break;l=g[q]=GL.Texture.getTemporary(b,c,d);p[0]=1/m.width;p[1]=1/m.height;m.blit(l,h.uniforms(k));m=l}this.isOutputConnected(2)&&(b=this._average_texture,b&&b.type==a.type&&b.format==a.format||(b=this._average_texture=new GL.Texture(1,1,{type:a.type,format:a.format,filter:gl.LINEAR})),p[0]=1/m.width,p[1]=1/m.height,k.u_intensity=
...
case g.PROGRAMCHANGE:c+="PC "+this.data[1];break;case g.PITCHBEND:c+="PITCHBEND "+this.getPitchBend();break;case g.KEYPRESSURE:c+="KEYPRESS "+this.data[1]}return c};g.prototype.toHexString=function(){for(var c="",a=0;a<this.data.length;a++)c+=this.data[a].toString(16)+" "};g.NOTEOFF=128;g.NOTEON=144;g.KEYPRESSURE=160;g.CONTROLLERCHANGE=176;g.PROGRAMCHANGE=192;g.CHANNELPRESSURE=208;g.PITCHBEND=224;g.TIMETICK=248;g.commands={128:"note off",144:"note on",160:"key pressure",176:"controller change",192:"program change",
208:"channel pressure",224:"pitch bend",240:"system",242:"Song pos",243:"Song select",246:"Tune request",248:"time tick",250:"Start Song",251:"Continue Song",252:"Stop Song",254:"Sensing",255:"Reset"};e.input=null;e.MIDIEvent=g;e.prototype.onMIDISuccess=function(c){console.log("MIDI ready!");console.log(c);this.midi=c;this.updatePorts();if(this.on_ready)this.on_ready(this)};e.prototype.updatePorts=function(){var c=this.midi;this.input_ports=c.inputs;for(var a=0,b=this.input_ports.values(),d=b.next();d&&
!1===d.done;)d=d.value,console.log("Input port [type:'"+d.type+"'] id:'"+d.id+"' manufacturer:'"+d.manufacturer+"' name:'"+d.name+"' version:'"+d.version+"'"),a++,d=b.next();this.num_input_ports=a;a=0;this.output_ports=c.outputs;b=this.output_ports.values();for(d=b.next();d&&!1===d.done;)d=d.value,console.log("Output port [type:'"+d.type+"'] id:'"+d.id+"' manufacturer:'"+d.manufacturer+"' name:'"+d.name+"' version:'"+d.version+"'"),a++,d=b.next();this.num_output_ports=a};e.prototype.onMIDIFailure=
...
1;g<this.outputs.length;++g)this.setOutputData(g,this._last_data[g])}};g.prototype.createSocket=function(){var e=this,g=this.properties.url;"ws"!=g.substr(0,2)&&(g="ws://"+g);this._ws=new WebSocket(g);this._ws.onopen=function(){console.log("ready");e.boxcolor="#8E8"};this._ws.onmessage=function(g){var h=JSON.parse(g.data);h.room&&h.room!=this.properties.room||(1==g.data.type?e.triggerSlot(0,h):e._last_data[g.data.channel||0]=h.data)};this._ws.onerror=function(g){console.log("couldnt connect to websocket");
e.boxcolor="#E88"};this._ws.onclose=function(g){console.log("connection closed");e.boxcolor="#000"}};g.prototype.send=function(e){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send(JSON.stringify({type:1,msg:e}))};g.prototype.onAction=function(e,g){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send({type:1,room:this.properties.room,action:e,data:g})};g.prototype.onGetInputs=function(){return[["in",0]]};g.prototype.onGetOutputs=function(){return[["out",0]]};h.registerNodeType("network/websocket",
g);e.title="SillyClient";e.desc="Connects to SillyServer to broadcast messages";e.prototype.onPropertyChanged=function(e,g){var h=this.properties.url+"/"+this.properties.room;this._server&&this._final_url!=h&&(this._server.connect(this.properties.url,this.properties.room),this._final_url=h)};e.prototype.onExecute=function(){if(this._server&&this._server.is_connected){for(var e=this.properties.save_bandwidth,g=1;g<this.inputs.length;++g){var h=this.getInputData(g);null==h||e&&this._last_input_data[g]==
h||(this._server.sendMessage({type:0,channel:g,data:h}),this._last_input_data[g]=h)}for(g=1;g<this.outputs.length;++g)this.setOutputData(g,this._last_output_data[g])}};e.prototype.createSocket=function(){var e=this;"undefined"==typeof SillyClient?(this._error||console.error("SillyClient node cannot be used, you must include SillyServer.js"),this._error=!0):(this._server=new SillyClient,this._server.on_ready=function(){console.log("ready");e.boxcolor="#8E8"},this._server.on_message=function(g,h){var r=
null;try{r=JSON.parse(h)}catch(l){return}1==r.type?e.triggerSlot(0,r):e._last_output_data[r.channel||0]=r.data},this._server.on_error=function(g){console.log("couldnt connect to websocket");e.boxcolor="#E88"},this._server.on_close=function(g){console.log("connection closed");e.boxcolor="#000"},this.properties.url&&this.properties.room&&(this._server.connect(this.properties.url,this.properties.room),this._final_url=this.properties.url+"/"+this.properties.room))};e.prototype.send=function(e){this._server&&
this._server.is_connected&&this._server.sendMessage({type:1,data:e})};e.prototype.onAction=function(e,g){this._server&&this._server.is_connected&&this._server.sendMessage({type:1,action:e,data:g})};e.prototype.onGetInputs=function(){return[["in",0]]};e.prototype.onGetOutputs=function(){return[["out",0]]};h.registerNodeType("network/sillyclient",e)})(this);
