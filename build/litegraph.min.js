(function(v){function c(a){e.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function q(a,b,d,x,e,c){this.id=a;this.type=b;this.origin_id=d;this.origin_slot=x;this.target_id=e;this.target_slot=c;this._data=null;this._pos=new Float32Array(2)}function g(a){this._ctor(a)}function l(a){this._ctor(a)}function r(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=0.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
this.visible_links=[];b&&b.attachCanvas(this);this.setCanvas(a);this.clear();d.skip_render||this.startRendering();this.autoresize=d.autoresize}function y(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function s(a,b,d,x,e,c){return d<a&&d+e>a&&x<b&&x+c>b?!0:!1}function u(a,b){var d=a[0]+a[2],x=a[1]+a[3],e=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>e||d<b[0]||x<b[1]?!1:!0}function z(a,b){function d(a){var d=parseInt(e.style.top);e.style.top=(d+a.deltaY*b.scroll_speed).toFixed()+
...
b&&b!=a.name_in_graph&&(a.name_in_graph?a.graph.renameOutput(a.name_in_graph,b):a.graph.addOutput(b,a.properties.type),a.name_widget.value=b,a.name_in_graph=b)},enumerable:!0});Object.defineProperty(this.properties,"type",{get:function(){return a.inputs[0].type},set:function(b){if("action"==b||"event"==b)b=m.ACTION;a.inputs[0].type=b;a.name_in_graph&&a.graph.changeOutputType(a.name_in_graph,a.inputs[0].type);a.type_widget.value=b||""},enumerable:!0});this.name_widget=this.addWidget("text","Name",
...
"object");this._result={};var a=this;this.addWidget("button","clear","",function(){a._result={}});this.size=this.computeSize()}function e(){this.size=[60,30];this.addInput("in");this.addOutput("out");this.properties={varname:"myname",global:!1};this.value=null}function w(){this.size=[60,30];this.addInput("data",0);this.addInput("download",m.ACTION);this.properties={filename:"data.json"};this.value=null;var a=this;this.addWidget("button","Download","",function(b){a.value&&a.downloadAsFile()})}function k(){this.size=
[60,30];this.addInput("value",0,{label:""});this.value=0}function n(){this.addInput("in",0);this.addOutput("out",0);this.size=[40,30]}function D(){this.mode=m.ON_EVENT;this.size=[80,30];this.addProperty("msg","");this.addInput("log",m.EVENT);this.addInput("msg",0)}function h(){this.mode=m.ON_EVENT;this.addProperty("msg","");this.addInput("",m.EVENT);var a=this;this.widget=this.addWidget("text","Text","",function(b){a.properties.msg=b});this.widgets_up=!0;this.size=[200,30]}function t(){this.size=
[60,30];this.addProperty("onExecute","return A;");this.addInput("A","");this.addInput("B","");this.addOutput("out","");this._func=null;this.data={}}var m=v.LiteGraph;c.title="Time";c.desc="Time";c.prototype.onExecute=function(){this.setOutputData(0,1E3*this.graph.globaltime);this.setOutputData(1,this.graph.globaltime)};m.registerNodeType("basic/time",c);q.title="Subgraph";q.desc="Graph inside a node";q.title_color="#334";q.prototype.onGetInputs=function(){return[["enabled","boolean"]]};q.prototype.onDrawTitle=
function(a){if(!this.flags.collapsed){a.fillStyle="#555";var b=m.NODE_TITLE_HEIGHT,d=this.size[0]-b;a.fillRect(d,-b,b,b);a.fillStyle="#333";a.beginPath();a.moveTo(d+0.2*b,0.6*-b);a.lineTo(d+0.8*b,0.6*-b);a.lineTo(d+0.5*b,0.3*-b);a.fill()}};q.prototype.onDblClick=function(a,b,d){var e=this;setTimeout(function(){d.openSubgraph(e.subgraph)},10)};q.prototype.onMouseDown=function(a,b,d){if(!this.flags.collapsed&&b[0]>this.size[0]-m.NODE_TITLE_HEIGHT&&0>b[1]){var e=this;setTimeout(function(){d.openSubgraph(e.subgraph)},
...
function(a){var b=this;return[{content:"Open",callback:function(){a.openSubgraph(b.subgraph)}}]};q.prototype.onResize=function(a){a[1]+=20};q.prototype.serialize=function(){var a=LGraphNode.prototype.serialize.call(this);a.subgraph=this.subgraph.serialize();return a};q.prototype.clone=function(){var a=m.createNode(this.type),b=this.serialize();delete b.id;delete b.inputs;delete b.outputs;a.configure(b);return a};m.Subgraph=q;m.registerNodeType("graph/subgraph",q);g.title="Input";g.desc="Input of the graph";
g.prototype.onConfigure=function(){this.updateType()};g.prototype.updateType=function(){var a=this.properties.type;this.type_widget.value=a;"number"==a?(this.value_widget.type="number",this.value_widget.value=0):"bool"==a?(this.value_widget.type="toggle",this.value_widget.value=!0):"string"==a?(this.value_widget.type="text",this.value_widget.value=""):(this.value_widget.type=null,this.value_widget.value=null);this.properties.value=this.value_widget.value};g.prototype.onPropertyChanged=function(a,
b){if("name"==a){if(""==b||b==this.name_in_graph||"enabled"==b)return!1;this.graph&&(this.name_in_graph?this.graph.renameInput(this.name_in_graph,b):this.graph.addInput(b,this.properties.type));this.name_in_graph=this.name_widget.value=b}else"type"==a&&this.updateType(b||"")};g.prototype.getTitle=function(){return this.flags.collapsed?this.properties.name:this.title};g.prototype.onAction=function(a,b){this.properties.type==m.EVENT&&this.triggerSlot(0,b)};g.prototype.onExecute=function(){var a=this.graph.inputs[this.properties.name];
a||this.setOutputData(0,this.properties.value);this.setOutputData(0,void 0===a.value?this.properties.value:a.value)};g.prototype.onRemoved=function(){this.name_in_graph&&this.graph.removeInput(this.name_in_graph)};m.GraphInput=g;m.registerNodeType("graph/input",g);l.title="Output";l.desc="Output of the graph";l.prototype.onExecute=function(){this._value=this.getInputData(0);this.graph.setOutputData(this.properties.name,this._value)};l.prototype.onAction=function(a,b){this.properties.type==m.ACTION&&
this.graph.trigger(this.properties.name,b)};l.prototype.onRemoved=function(){this.name_in_graph&&this.graph.removeOutput(this.name_in_graph)};l.prototype.getTitle=function(){return this.flags.collapsed?this.properties.name:this.title};m.GraphOutput=l;m.registerNodeType("graph/output",l);r.title="Const Number";r.desc="Constant number";r.prototype.onExecute=function(){this.setOutputData(0,parseFloat(this.properties.value))};r.prototype.getTitle=function(){return this.flags.collapsed?this.properties.value:
this.title};r.prototype.setValue=function(a){this.properties.value=a};r.prototype.onDrawBackground=function(a){this.outputs[0].label=this.properties.value.toFixed(3)};m.registerNodeType("basic/const",r);f.title="Const String";f.desc="Constant string";f.prototype.setValue=function(a){this.properties.value=a};f.prototype.onPropertyChanged=function(a,b){this.widget.value=b};f.prototype.getTitle=r.prototype.getTitle;f.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};m.registerNodeType("basic/string",
f);y.title="Const Data";y.desc="Constant Data";y.prototype.setValue=function(a){this.properties.value=a;this.onPropertyChanged("value",a)};y.prototype.onPropertyChanged=function(a,b){this.widget.value=b;if(null!=b&&""!=b)try{this._value=JSON.parse(b),this.boxcolor="#AEA"}catch(d){this.boxcolor="red"}};y.prototype.onExecute=function(){this.setOutputData(0,this._value)};m.registerNodeType("basic/data",y);s.title="Object property";s.desc="Outputs the property of an object";s.prototype.setValue=function(a){this.properties.value=
a;this.widget.value=a};s.prototype.getTitle=function(){return this.flags.collapsed?"in."+this.properties.value:this.title};s.prototype.onPropertyChanged=function(a,b){this.widget.value=b};s.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a[this.properties.value])};m.registerNodeType("basic/object_property",s);u.title="Object keys";u.desc="Outputs an array with the keys of an object";u.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,
Object.keys(a))};m.registerNodeType("basic/object_keys",u);z.title="Merge Objects";z.desc="Creates an object copying properties from others";z.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1),d=this._result;if(a)for(var e in a)d[e]=a[e];if(b)for(e in b)d[e]=b[e];this.setOutputData(0,d)};m.registerNodeType("basic/merge_objects",z);e.title="Variable";e.desc="store/read variable value";e.prototype.onExecute=function(){this.value=this.getInputData(0);this.graph&&(this.graph.vars[this.properties.varname]=
this.value);this.properties.global&&(v[this.properties.varname]=this.value);this.setOutputData(0,this.value)};e.prototype.getTitle=function(){return this.properties.varname};m.registerNodeType("basic/variable",e);w.title="Download";w.desc="Download some data";w.prototype.downloadAsFile=function(){if(null!=this.value){var a=null,a=this.value.constructor===String?this.value:JSON.stringify(this.value),a=new Blob([a]),b=URL.createObjectURL(a),a=document.createElement("a");a.setAttribute("href",b);a.setAttribute("download",
this.properties.filename);a.style.display="none";document.body.appendChild(a);a.click();document.body.removeChild(a);setTimeout(function(){URL.revokeObjectURL(b)},6E4)}};w.prototype.onAction=function(a,b){var d=this;setTimeout(function(){d.downloadAsFile()},100)};w.prototype.onExecute=function(){this.inputs[0]&&(this.value=this.getInputData(0))};w.prototype.getTitle=function(){return this.flags.collapsed?this.properties.filename:this.title};m.registerNodeType("basic/download",w);k.title="Watch";k.desc=
...
m.registerNodeType("basic/watch",k);n.title="Cast";n.desc="Allows to connect different types";n.prototype.onExecute=function(){this.setOutputData(0,this.getInputData(0))};m.registerNodeType("basic/cast",n);D.title="Console";D.desc="Show value inside the console";D.prototype.onAction=function(a,b){"log"==a?console.log(b):"warn"==a?console.warn(b):"error"==a&&console.error(b)};D.prototype.onExecute=function(){var a=this.getInputData(1);null!==a&&(this.properties.msg=a);console.log(a)};D.prototype.onGetInputs=
function(){return[["log",m.ACTION],["warn",m.ACTION],["error",m.ACTION]]};m.registerNodeType("basic/console",D);h.title="Alert";h.desc="Show an alert window";h.color="#510";h.prototype.onConfigure=function(a){this.widget.value=a.properties.msg};h.prototype.onAction=function(a,b){var d=this.properties.msg;setTimeout(function(){alert(d)},10)};m.registerNodeType("basic/alert",h);t.prototype.onConfigure=function(a){a.properties.onExecute&&m.allow_scripts?this.compileCode(a.properties.onExecute):console.warn("Script not compiled, LiteGraph.allow_scripts is false")};
...
b.indexOf(d[e])){console.warn("invalid script");return}try{this._func=new Function("A","B","C","DATA","node",a)}catch(c){console.error("Error parsing script"),console.error(c)}}};t.prototype.onExecute=function(){if(this._func)try{var a=this.getInputData(0),b=this.getInputData(1),d=this.getInputData(2);this.setOutputData(0,this._func(a,b,d,this.data,this))}catch(e){console.error("Error in script"),console.error(e)}};t.prototype.onGetOutputs=function(){return[["C",""]]};m.registerNodeType("basic/script",
t)})(this);
(function(v){function c(){this.size=[60,30];this.addInput("event",u.ACTION)}function q(){this.size=[60,30];this.addInput("in","");this.addOutput("true",u.EVENT);this.addOutput("change",u.EVENT);this.was_true=!1}function g(){this.addInput("",u.ACTION);this.addInput("",u.ACTION);this.addInput("",u.ACTION);this.addInput("",u.ACTION);this.addInput("",u.ACTION);this.addInput("",u.ACTION);this.addOutput("",u.EVENT);this.addOutput("",u.EVENT);this.addOutput("",u.EVENT);this.addOutput("",u.EVENT);this.addOutput("",
u.EVENT);this.addOutput("",u.EVENT);this.size=[120,30];this.flags={horizontal:!0,render_box:!1}}function l(){this.size=[60,30];this.addInput("event",u.ACTION);this.addOutput("event",u.EVENT);this.properties={equal_to:"",has_property:"",property_equal_to:""}}function r(){this.addInput("inc",u.ACTION);this.addInput("dec",u.ACTION);this.addInput("reset",u.ACTION);this.addOutput("change",u.EVENT);this.addOutput("num","number");this.num=0}function f(){this.size=[60,30];this.addProperty("time_in_ms",1E3);
...
(function(v){function c(){this.addOutput("",z.EVENT);this.addOutput("","boolean");this.addProperty("text","click me");this.addProperty("font_size",30);this.addProperty("message","");this.size=[164,84];this.clicked=!1}function q(){this.addInput("","boolean");this.addInput("e",z.ACTION);this.addOutput("v","boolean");this.addOutput("e",z.EVENT);this.properties={font:"",value:!1};this.size=[160,44]}function g(){this.addOutput("","number");this.size=[80,60];this.properties={min:-1E3,max:1E3,value:1,step:1};
this.old_y=-1;this._precision=this._remainder=0;this.mouse_captured=!1}function l(){this.addOutput("","number");this.size=[64,84];this.properties={min:0,max:1,value:0.5,color:"#7AF",precision:2};this.value=-1}function r(){this.addOutput("","number");this.properties={value:0.5,min:0,max:1,text:"V"};var c=this;this.size=[140,40];this.slider=this.addWidget("slider","V",this.properties.value,function(f){c.properties.value=f},this.properties);this.widgets_up=!0}function f(){this.size=[160,26];this.addOutput("",
"number");this.properties={color:"#7AF",min:0,max:1,value:0.5};this.value=-1}function y(){this.size=[160,26];this.addInput("","number");this.properties={min:0,max:1,value:0,color:"#AAF"}}function s(){this.addInputs("",0);this.properties={value:"...",font:"Arial",fontsize:18,color:"#AAA",align:"left",glowSize:0,decimals:1}}function u(){this.size=[200,100];this.properties={borderColor:"#ffffff",bgcolorTop:"#f0f0f0",bgcolorBottom:"#e0e0e0",shadowSize:2,borderRadius:3}}var z=v.LiteGraph;c.title="Button";
...
function(c){if(!this.flags.collapsed){var f=0.5*this.size[1],k=0.8*this.size[1];c.font=this.properties.font||(0.8*f).toFixed(0)+"px Arial";var n=c.measureText(this.title).width,n=0.5*(this.size[0]-(n+f));c.fillStyle="#AAA";c.fillRect(n,k-f,f,f);c.fillStyle=this.properties.value?"#AEF":"#000";c.fillRect(n+0.25*f,k-f+0.25*f,0.5*f,0.5*f);c.textAlign="left";c.fillStyle="#AAA";c.fillText(this.title,1.2*f+n,0.85*k);c.textAlign="left"}};q.prototype.onAction=function(c){this.properties.value=!this.properties.value;
this.trigger("e",this.properties.value)};q.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.properties.value=c);this.setOutputData(0,this.properties.value)};q.prototype.onMouseDown=function(c,f){if(1<f[0]&&1<f[1]&&f[0]<this.size[0]-2&&f[1]<this.size[1]-2)return this.properties.value=!this.properties.value,this.graph._version++,this.trigger("e",this.properties.value),!0};z.registerNodeType("widget/toggle",q);g.title="Number";g.desc="Widget to select number value";g.pixels_threshold=
10;g.markers_color="#666";g.prototype.onDrawForeground=function(c){var f=0.5*this.size[0],k=this.size[1];30<k?(c.fillStyle=g.markers_color,c.beginPath(),c.moveTo(f,0.1*k),c.lineTo(f+0.1*k,0.2*k),c.lineTo(f+-0.1*k,0.2*k),c.fill(),c.beginPath(),c.moveTo(f,0.9*k),c.lineTo(f+0.1*k,0.8*k),c.lineTo(f+-0.1*k,0.8*k),c.fill(),c.font=(0.7*k).toFixed(1)+"px Arial"):c.font=(0.8*k).toFixed(1)+"px Arial";c.textAlign="center";c.font=(0.7*k).toFixed(1)+"px Arial";c.fillStyle="#EEE";c.fillText(this.properties.value.toFixed(this._precision),
f,0.75*k)};g.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};g.prototype.onPropertyChanged=function(c,f){var k=(this.properties.step+"").split(".");this._precision=1<k.length?k[1].length:0};g.prototype.onMouseDown=function(c,f){if(!(0>f[1]))return this.old_y=c.canvasY,this.captureInput(!0),this.mouse_captured=!0};g.prototype.onMouseMove=function(c){if(this.mouse_captured){var f=this.old_y-c.canvasY;c.shiftKey&&(f*=10);if(c.metaKey||c.altKey)f*=0.1;this.old_y=c.canvasY;
c=this._remainder+f/g.pixels_threshold;this._remainder=c%1;c=Math.clamp(this.properties.value+(c|0)*this.properties.step,this.properties.min,this.properties.max);this.properties.value=c;this.graph._version++;this.setDirtyCanvas(!0)}};g.prototype.onMouseUp=function(c,f){200>c.click_time&&(this.properties.value=Math.clamp(this.properties.value+(f[1]>0.5*this.size[1]?-1:1)*this.properties.step,this.properties.min,this.properties.max),this.graph._version++,this.setDirtyCanvas(!0));this.mouse_captured&&
(this.mouse_captured=!1,this.captureInput(!1))};z.registerNodeType("widget/number",g);l.title="Knob";l.desc="Circular controller";l.size=[80,100];l.prototype.onDrawForeground=function(c){if(!this.flags.collapsed){-1==this.value&&(this.value=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min));var f=0.5*this.size[0],k=0.5*this.size[1],n=0.5*Math.min(this.size[0],this.size[1])-5;c.globalAlpha=1;c.save();c.translate(f,k);c.rotate(0.75*Math.PI);c.fillStyle="rgba(0,0,0,0.5)";
c.beginPath();c.moveTo(0,0);c.arc(0,0,n,0,1.5*Math.PI);c.fill();c.strokeStyle="black";c.fillStyle=this.properties.color;c.lineWidth=2;c.beginPath();c.moveTo(0,0);c.arc(0,0,n-4,0,1.5*Math.PI*Math.max(0.01,this.value));c.closePath();c.fill();c.lineWidth=1;c.globalAlpha=1;c.restore();c.fillStyle="black";c.beginPath();c.arc(f,k,0.75*n,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":this.properties.color;c.beginPath();var g=this.value*Math.PI*1.5+0.75*Math.PI;c.arc(f+Math.cos(g)*n*0.65,k+Math.sin(g)*
n*0.65,0.05*n,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":"#AAA";c.font=Math.floor(0.5*n)+"px Arial";c.textAlign="center";c.fillText(this.properties.value.toFixed(this.properties.precision),f,k+0.15*n)}};l.prototype.onExecute=function(){this.setOutputData(0,this.properties.value);this.boxcolor=z.colorToString([this.value,this.value,this.value])};l.prototype.onMouseDown=function(c){this.center=[0.5*this.size[0],0.5*this.size[1]+20];this.radius=0.5*this.size[0];if(20>c.canvasY-this.pos[1]||
...
l.prototype.onMouseUp=function(c){this.oldmouse&&(this.oldmouse=null,this.captureInput(!1))};l.prototype.onPropertyChanged=function(c,f){if("min"==c||"max"==c||"value"==c)return this.properties[c]=parseFloat(f),!0};z.registerNodeType("widget/knob",l);r.title="Inner Slider";r.prototype.onPropertyChanged=function(c,f){"value"==c&&(this.slider.value=f)};r.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};z.registerNodeType("widget/internal_slider",r);f.title="H.Slider";f.desc=
...
(function(v){function c(){this.addOutput("left_x_axis","number");this.addOutput("left_y_axis","number");this.addOutput("button_pressed",q.EVENT);this.properties={gamepad_index:0,threshold:0.1};this._left_axis=new Float32Array(2);this._right_axis=new Float32Array(2);this._triggers=new Float32Array(2);this._previous_buttons=new Uint8Array(17);this._current_buttons=new Uint8Array(17)}var q=v.LiteGraph;c.title="Gamepad";c.desc="gets the input of the gamepad";c.CENTER=0;c.LEFT=1;c.RIGHT=2;c.UP=4;c.DOWN=
8;c.zero=new Float32Array(2);c.buttons="a b x y lb rb lt rt back start ls rs home".split(" ");c.prototype.onExecute=function(){var g=this.getGamepad(),l=this.properties.threshold||0;g&&(this._left_axis[0]=Math.abs(g.xbox.axes.lx)>l?g.xbox.axes.lx:0,this._left_axis[1]=Math.abs(g.xbox.axes.ly)>l?g.xbox.axes.ly:0,this._right_axis[0]=Math.abs(g.xbox.axes.rx)>l?g.xbox.axes.rx:0,this._right_axis[1]=Math.abs(g.xbox.axes.ry)>l?g.xbox.axes.ry:0,this._triggers[0]=Math.abs(g.xbox.axes.ltrigger)>l?g.xbox.axes.ltrigger:
0,this._triggers[1]=Math.abs(g.xbox.axes.rtrigger)>l?g.xbox.axes.rtrigger:0);if(this.outputs)for(l=0;l<this.outputs.length;l++){var r=this.outputs[l];if(r.links&&r.links.length){var f=null;if(g)switch(r.name){case "left_axis":f=this._left_axis;break;case "right_axis":f=this._right_axis;break;case "left_x_axis":f=this._left_axis[0];break;case "left_y_axis":f=this._left_axis[1];break;case "right_x_axis":f=this._right_axis[0];break;case "right_y_axis":f=this._right_axis[1];break;case "trigger_left":f=
this._triggers[0];break;case "trigger_right":f=this._triggers[1];break;case "a_button":f=g.xbox.buttons.a?1:0;break;case "b_button":f=g.xbox.buttons.b?1:0;break;case "x_button":f=g.xbox.buttons.x?1:0;break;case "y_button":f=g.xbox.buttons.y?1:0;break;case "lb_button":f=g.xbox.buttons.lb?1:0;break;case "rb_button":f=g.xbox.buttons.rb?1:0;break;case "ls_button":f=g.xbox.buttons.ls?1:0;break;case "rs_button":f=g.xbox.buttons.rs?1:0;break;case "hat_left":f=g.xbox.hatmap&c.LEFT;break;case "hat_right":f=
g.xbox.hatmap&c.RIGHT;break;case "hat_up":f=g.xbox.hatmap&c.UP;break;case "hat_down":f=g.xbox.hatmap&c.DOWN;break;case "hat":f=g.xbox.hatmap;break;case "start_button":f=g.xbox.buttons.start?1:0;break;case "back_button":f=g.xbox.buttons.back?1:0;break;case "button_pressed":for(r=0;r<this._current_buttons.length;++r)this._current_buttons[r]&&!this._previous_buttons[r]&&this.triggerSlot(l,c.buttons[r])}else switch(r.name){case "button_pressed":break;case "left_axis":case "right_axis":f=c.zero;break;
default:f=0}this.setOutputData(l,f)}}};c.mapping={a:0,b:1,x:2,y:3,lb:4,rb:5,lt:6,rt:7,back:8,start:9,ls:10,rs:11};c.mapping_array="a b x y lb rb lt rt back start ls rs".split(" ");c.prototype.getGamepad=function(){var g=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!g)return null;var l=g.call(navigator),g=null;this._previous_buttons.set(this._current_buttons);for(g=this.properties.gamepad_index;4>g;g++)if(l[g]){g=l[g];l=this.xbox_mapping;l||(l=this.xbox_mapping={axes:[],
buttons:{},hat:"",hatmap:c.CENTER});l.axes.lx=g.axes[0];l.axes.ly=g.axes[1];l.axes.rx=g.axes[2];l.axes.ry=g.axes[3];l.axes.ltrigger=g.buttons[6].value;l.axes.rtrigger=g.buttons[7].value;l.hat="";l.hatmap=c.CENTER;for(var r=0;r<g.buttons.length;r++)if(this._current_buttons[r]=g.buttons[r].pressed,12>r)l.buttons[c.mapping_array[r]]=g.buttons[r].pressed,g.buttons[r].was_pressed&&this.trigger(c.mapping_array[r]+"_button_event");else switch(r){case 12:g.buttons[r].pressed&&(l.hat+="up",l.hatmap|=c.UP);
break;case 13:g.buttons[r].pressed&&(l.hat+="down",l.hatmap|=c.DOWN);break;case 14:g.buttons[r].pressed&&(l.hat+="left",l.hatmap|=c.LEFT);break;case 15:g.buttons[r].pressed&&(l.hat+="right",l.hatmap|=c.RIGHT);break;case 16:l.buttons.home=g.buttons[r].pressed}g.xbox=l;return g}};c.prototype.onDrawBackground=function(c){if(!this.flags.collapsed){var l=this._left_axis,r=this._right_axis;c.strokeStyle="#88A";c.strokeRect(0.5*(l[0]+1)*this.size[0]-4,0.5*(l[1]+1)*this.size[1]-4,8,8);c.strokeStyle="#8A8";
c.strokeRect(0.5*(r[0]+1)*this.size[0]-4,0.5*(r[1]+1)*this.size[1]-4,8,8);l=this.size[1]/this._current_buttons.length;c.fillStyle="#AEB";for(r=0;r<this._current_buttons.length;++r)this._current_buttons[r]&&c.fillRect(0,l*r,6,l)}};c.prototype.onGetOutputs=function(){return[["left_axis","vec2"],["right_axis","vec2"],["left_x_axis","number"],["left_y_axis","number"],["right_x_axis","number"],["right_y_axis","number"],["trigger_left","number"],["trigger_right","number"],["a_button","number"],["b_button",
...
(function(v){function c(){this.addInput("in","*");this.size=[80,30]}function q(){this.addInput("in");this.addOutput("out");this.size=[80,30]}function g(){this.addInput("in");this.addOutput("out")}function l(){this.addInput("in","number",{locked:!0});this.addOutput("out","number",{locked:!0});this.addProperty("in",0);this.addProperty("in_min",0);this.addProperty("in_max",1);this.addProperty("out_min",0);this.addProperty("out_max",1);this.size=[80,30]}function r(){this.addOutput("value","number");this.addProperty("min",
0);this.addProperty("max",1);this.size=[80,30]}function f(){this.addInput("in","number");this.addOutput("out","number");this.addProperty("min",0);this.addProperty("max",1);this.addProperty("smooth",!0);this.size=[90,30]}function y(){this.addOutput("out","number");this.addProperty("min_time",1);this.addProperty("max_time",2);this.addProperty("duration",0.2);this.size=[90,30];this._blink_time=this._remaining_time=0}function s(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,
30];this.addProperty("min",0);this.addProperty("max",1)}function u(){this.properties={f:0.5};this.addInput("A","number");this.addInput("B","number");this.addOutput("out","number")}function z(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,30]}function e(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,30]}function w(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,30]}function k(){this.addInput("in","number");this.addOutput("out",
...
"number");this.addOutput("out","number");this.addProperty("factor",0.1);this.size=[80,30];this._value=null}function m(){this.addInput("A","number");this.addInput("B","number");this.addOutput("=","number");this.addProperty("A",1);this.addProperty("B",1);this.addProperty("OP","+","enum",{values:m.values})}function a(){this.addInput("A","number");this.addInput("B","number");this.addOutput("A==B","boolean");this.addOutput("A!=B","boolean");this.addProperty("A",0);this.addProperty("B",0)}function b(){this.addInput("A",
...
["out_min","number"],["out_max","number"]]};C.registerNodeType("math/range",l);r.title="Rand";r.desc="Random number";r.prototype.onExecute=function(){if(this.inputs)for(var a=0;a<this.inputs.length;a++){var b=this.inputs[a],d=this.getInputData(a);void 0!==d&&(this.properties[b.name]=d)}a=this.properties.min;b=this.properties.max;this._last_v=Math.random()*(b-a)+a;this.setOutputData(0,this._last_v)};r.prototype.onDrawBackground=function(a){this.outputs[0].label=(this._last_v||0).toFixed(3)};r.prototype.onGetInputs=
function(){return[["min","number"],["max","number"]]};C.registerNodeType("math/rand",r);f.title="Noise";f.desc="Random number with temporal continuity";f.data=null;f.getValue=function(a,b){if(!f.data){f.data=new Float32Array(1024);for(var d=0;d<f.data.length;++d)f.data[d]=Math.random()}a%=1024;0>a&&(a+=1024);var c=Math.floor(a);a-=c;d=f.data[c];c=f.data[1023==c?0:c+1];b&&(a=a*a*a*(a*(6*a-15)+10));return d*(1-a)+c*a};f.prototype.onExecute=function(){var a=this.getInputData(0)||0,a=f.getValue(a,this.properties.smooth),
...
"";this.isInputConnected(0)&&(a+="clamp({{0}},"+this.properties.min+","+this.properties.max+")");return a};C.registerNodeType("math/clamp",s);u.title="Lerp";u.desc="Linear Interpolation";u.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.getInputData(1);null==b&&(b=0);var d=this.properties.f,c=this.getInputData(2);void 0!==c&&(d=c);this.setOutputData(0,a*(1-d)+b*d)};u.prototype.onGetInputs=function(){return[["f","number"]]};C.registerNodeType("math/lerp",u);z.title=
"Abs";z.desc="Absolute";z.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,Math.abs(a))};C.registerNodeType("math/abs",z);e.title="Floor";e.desc="Floor number to remove fractional part";e.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,Math.floor(a))};C.registerNodeType("math/floor",e);w.title="Frac";w.desc="Returns fractional part";w.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,
a%1)};C.registerNodeType("math/frac",w);k.title="Smoothstep";k.desc="Smoothstep";k.prototype.onExecute=function(){var a=this.getInputData(0);if(void 0!==a){var b=this.properties.A,a=Math.clamp((a-b)/(this.properties.B-b),0,1);this.setOutputData(0,a*a*(3-2*a))}};C.registerNodeType("math/smoothstep",k);n.title="Scale";n.desc="v * factor";n.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a*this.properties.factor)};C.registerNodeType("math/scale",n);D.title="Gate";
D.desc="if v is true, then outputs A, otherwise B";D.prototype.onExecute=function(){var a=this.getInputData(0);this.setOutputData(0,this.getInputData(a?1:2))};C.registerNodeType("math/gate",D);h.title="Average";h.desc="Average Filter";h.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this._values.length;this._values[this._current%b]=a;this._current+=1;this._current>b&&(this._current=0);for(var d=a=0;d<b;++d)a+=this._values[d];this.setOutputData(0,a/b)};h.prototype.onPropertyChanged=
function(a,b){1>b&&(b=1);this.properties.samples=Math.round(b);var d=this._values;this._values=new Float32Array(this.properties.samples);d.length<=this._values.length?this._values.set(d):this._values.set(d.subarray(0,this._values.length))};C.registerNodeType("math/average",h);t.title="TendTo";t.desc="moves the output value always closer to the input";t.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.properties.factor;this._value=null==this._value?a:this._value*
(1-b)+a*b;this.setOutputData(0,this._value)};C.registerNodeType("math/tendTo",t);m.values="+ - * / % ^ max min".split(" ");m.title="Operation";m.desc="Easy math operators";m["@OP"]={type:"enum",title:"operation",values:m.values};m.size=[100,60];m.prototype.getTitle=function(){return"max"==this.properties.OP||"min"==this.properties.OP?this.properties.OP+"(A,B)":"A "+this.properties.OP+" B"};m.prototype.setValue=function(a){"string"==typeof a&&(a=parseFloat(a));this.properties.value=a};m.prototype.onExecute=
function(){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.A=a:a=this.properties.A;null!=b?this.properties.B=b:b=this.properties.B;var d=0;switch(this.properties.OP){case "+":d=a+b;break;case "-":d=a-b;break;case "x":case "X":case "*":d=a*b;break;case "/":d=a/b;break;case "%":d=a%b;break;case "^":d=Math.pow(a,b);break;case "max":d=Math.max(a,b);break;case "min":d=Math.min(a,b);break;default:console.warn("Unknown operation: "+this.properties.OP)}this.setOutputData(0,d)};m.prototype.onDrawBackground=
function(a){this.flags.collapsed||(a.font="40px Arial",a.fillStyle="#666",a.textAlign="center",a.fillText(this.properties.OP,0.5*this.size[0],0.5*(this.size[1]+C.NODE_TITLE_HEIGHT)),a.textAlign="left")};C.registerNodeType("math/operation",m);C.registerSearchboxExtra("math/operation","MAX",{properties:{OP:"max"},title:"MAX()"});C.registerSearchboxExtra("math/operation","MIN",{properties:{OP:"min"},title:"MIN()"});a.title="Compare";a.desc="compares between two values";a.prototype.onExecute=function(){var a=
...
for(var d=0,e=this.outputs.length;d<e;++d){var h;switch(this.outputs[d].name){case "sin":h=Math.sin(a);break;case "cos":h=Math.cos(a);break;case "tan":h=Math.tan(a);break;case "asin":h=Math.asin(a);break;case "acos":h=Math.acos(a);break;case "atan":h=Math.atan(a)}this.setOutputData(d,b*h+c)}};x.prototype.onGetInputs=function(){return[["v","number"],["amplitude","number"],["offset","number"]]};x.prototype.onGetOutputs=function(){return[["sin","number"],["cos","number"],["tan","number"],["asin","number"],
["acos","number"],["atan","number"]]};C.registerNodeType("math/trigonometry",x);C.registerSearchboxExtra("math/trigonometry","SIN()",{outputs:[["sin","number"]],title:"SIN()"});C.registerSearchboxExtra("math/trigonometry","COS()",{outputs:[["cos","number"]],title:"COS()"});C.registerSearchboxExtra("math/trigonometry","TAN()",{outputs:[["tan","number"]],title:"TAN()"});p.title="Formula";p.desc="Compute formula";p.size=[160,100];h.prototype.onPropertyChanged=function(a,b){"formula"==a&&(this.code_widget.value=
...
if(null!=b){var d=this.properties.factor;null!=this.getInputData(2)&&(d=this.getInputData(2));a=quat.slerp(this._value,a,b,d);this.setOutputData(0,a)}}},C.registerNodeType("math3d/quat-slerp",v))})(this);
(function(v){function c(){this.addInput("A","number,vec3");this.addInput("B","number,vec3");this.addOutput("=","vec3");this.addProperty("OP","+","enum",{values:c.values});this._result=vec3.create()}function q(){this.addInput("in","vec3");this.addInput("f","number");this.addOutput("out","vec3");this.properties={f:1};this._data=new Float32Array(3)}function g(){this.addInput("in","vec3");this.addOutput("out","number")}function l(){this.addInput("in","vec3");this.addOutput("out","vec3");this._data=new Float32Array(3)}
function r(){this.addInput("A","vec3");this.addInput("B","vec3");this.addInput("f","vec3");this.addOutput("out","vec3");this.properties={f:0.5};this._data=new Float32Array(3)}function f(){this.addInput("A","vec3");this.addInput("B","vec3");this.addOutput("out","number")}var y=v.LiteGraph;c.values="+ - * / % ^ max min".split(" ");c.title="Operation";c.desc="Easy math 3D operators";c["@OP"]={type:"enum",title:"operation",values:c.values};c.size=[100,60];c.prototype.getTitle=function(){return"max"==
...
"center",c.fillText(this.properties.OP,0.5*this.size[0],0.5*(this.size[1]+y.NODE_TITLE_HEIGHT)),c.textAlign="left")};y.registerNodeType("math3d/operation",c);q.title="vec3_scale";q.desc="scales the components of a vec3";q.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null==f&&(f=this.properties.f);var g=this._data;g[0]=c[0]*f;g[1]=c[1]*f;g[2]=c[2]*f;this.setOutputData(0,g)}};y.registerNodeType("math3d/vec3-scale",q);g.title="vec3_length";g.desc="returns the module of a vector";
g.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(c=Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),this.setOutputData(0,c))};y.registerNodeType("math3d/vec3-length",g);l.title="vec3_normalize";l.desc="returns the vector normalized";l.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),g=this._data;g[0]=c[0]/f;g[1]=c[1]/f;g[2]=c[2]/f;this.setOutputData(0,g)}};y.registerNodeType("math3d/vec3-normalize",l);r.title="vec3_lerp";
r.desc="returns the interpolated vector";r.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);if(null!=f){var g=this.getInputOrProperty("f"),e=this._data;e[0]=c[0]*(1-g)+f[0]*g;e[1]=c[1]*(1-g)+f[1]*g;e[2]=c[2]*(1-g)+f[2]*g;this.setOutputData(0,e)}}};y.registerNodeType("math3d/vec3-lerp",r);f.title="vec3_dot";f.desc="returns the dot product";f.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null!=f&&this.setOutputData(0,
c[0]*f[0]+c[1]*f[1]+c[2]*f[2])}};y.registerNodeType("math3d/vec3-dot",f);v.glMatrix?(v=function(){this.addOutput("quat","quat");this.properties={x:0,y:0,z:0,w:1,normalize:!1};this._value=quat.create()},v.title="Quaternion",v.desc="quaternion",v.prototype.onExecute=function(){this._value[0]=this.getInputOrProperty("x");this._value[1]=this.getInputOrProperty("y");this._value[2]=this.getInputOrProperty("z");this._value[3]=this.getInputOrProperty("w");this.properties.normalize&&quat.normalize(this._value,
this._value);this.setOutputData(0,this._value)},v.prototype.onGetInputs=function(){return[["x","number"],["y","number"],["z","number"],["w","number"]]},y.registerNodeType("math3d/quaternion",v),v=function(){this.addInputs([["degrees","number"],["axis","vec3"]]);this.addOutput("quat","quat");this.properties={angle:90,axis:vec3.fromValues(0,1,0)};this._value=quat.create()},v.title="Rotation",v.desc="quaternion rotation",v.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.angle);
var f=this.getInputData(1);null==f&&(f=this.properties.axis);c=quat.setAxisAngle(this._value,f,0.0174532925*c);this.setOutputData(0,c)},y.registerNodeType("math3d/rotation",v),v=function(){this.addInputs([["vec3","vec3"],["quat","quat"]]);this.addOutput("result","vec3");this.properties={vec:[0,0,1]}},v.title="Rot. Vec3",v.desc="rotate a point",v.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.vec);var f=this.getInputData(1);null==f?this.setOutputData(c):this.setOutputData(0,
vec3.transformQuat(vec3.create(),c,f))},y.registerNodeType("math3d/rotate_vec3",v),v=function(){this.addInputs([["A","quat"],["B","quat"]]);this.addOutput("A*B","quat");this._value=quat.create()},v.title="Mult. Quat",v.desc="rotate quaternion",v.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null!=f&&(c=quat.multiply(this._value,c,f),this.setOutputData(0,c))}},y.registerNodeType("math3d/mult-quat",v),v=function(){this.addInputs([["A","quat"],["B",
"quat"],["factor","number"]]);this.addOutput("slerp","quat");this.addProperty("factor",0.5);this._value=quat.create()},v.title="Quat Slerp",v.desc="quaternion spherical interpolation",v.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);if(null!=f){var g=this.properties.factor;null!=this.getInputData(2)&&(g=this.getInputData(2));c=quat.slerp(this._value,c,f,g);this.setOutputData(0,c)}}},y.registerNodeType("math3d/quat-slerp",v),v=function(){this.addInput("vec3",
"vec3");this.addOutput("remap","vec3");this.addOutput("clamped","vec3");this.properties={clamp:!0,range_min:[-1,-1,0],range_max:[1,1,0],target_min:[-1,-1,0],target_max:[1,1,0]};this._value=vec3.create();this._clamped=vec3.create()},v.title="Remap Range",v.desc="remap a 3D range",v.prototype.onExecute=function(){var c=this.getInputData(0);c&&this._value.set(c);for(var c=this.properties.range_min,f=this.properties.range_max,g=this.properties.target_min,e=this.properties.target_max,l=0;3>l;++l){var k=
f[l]-c[l];this._clamped[l]=Math.clamp(this._value[l],c[l],f[l]);0==k?this._value[l]=0.5*(g[l]+e[l]):(k=(this._value[l]-c[l])/k,this.properties.clamp&&(k=Math.clamp(k,0,1)),this._value[l]=g[l]+k*(e[l]-g[l]))}this.setOutputData(0,this._value);this.setOutputData(1,this._clamped)},y.registerNodeType("math3d/remap_range",v)):console.warn("No glmatrix found, some Math3D nodes may not work")})(this);
(function(v){function c(c,l){return c==l}function q(c){return null!=c&&c.constructor===String?c.toUpperCase():c}v=v.LiteGraph;v.wrapFunctionAsNode("string/toString",c,["*"],"String");v.wrapFunctionAsNode("string/compare",c,["String","String"],"Boolean");v.wrapFunctionAsNode("string/concatenate",function(c,l){return void 0===c?l:void 0===l?c:c+l},["String","String"],"String");v.wrapFunctionAsNode("string/contains",function(c,l){return void 0===c||void 0===l?!1:-1!=c.indexOf(l)},["String","String"],
"Boolean");v.wrapFunctionAsNode("string/toUpperCase",q,["String"],"String");v.wrapFunctionAsNode("string/split",q,["String","String"],"Array");v.wrapFunctionAsNode("string/toFixed",function(c){return null!=c&&c.constructor===Number?c.toFixed(this.properties.precision):c},["Number"],"String",{precision:0})})(this);
(function(v){function c(){this.addInput("sel","number");this.addInput("A");this.addInput("B");this.addInput("C");this.addInput("D");this.addOutput("out");this.selected=0}function q(){this.properties={sequence:"A,B,C"};this.addInput("index","number");this.addInput("seq");this.addOutput("out");this.index=0;this.values=this.properties.sequence.split(",")}var g=v.LiteGraph;c.title="Selector";c.desc="selects an output";c.prototype.onDrawBackground=function(c){if(!this.flags.collapsed){c.fillStyle="#AFB";
var r=(this.selected+1)*g.NODE_SLOT_HEIGHT+6;c.beginPath();c.moveTo(50,r);c.lineTo(50,r+g.NODE_SLOT_HEIGHT);c.lineTo(34,r+0.5*g.NODE_SLOT_HEIGHT);c.fill()}};c.prototype.onExecute=function(){var c=this.getInputData(0);if(null==c||c.constructor!==Number)c=0;this.selected=c=Math.round(c)%(this.inputs.length-1);c=this.getInputData(c+1);void 0!==c&&this.setOutputData(0,c)};c.prototype.onGetInputs=function(){return[["E",0],["F",0],["G",0],["H",0]]};g.registerNodeType("logic/selector",c);q.title="Sequence";
q.desc="select one element from a sequence from a string";q.prototype.onPropertyChanged=function(c,g){"sequence"==c&&(this.values=g.split(","))};q.prototype.onExecute=function(){var c=this.getInputData(1);c&&c!=this.current_sequence&&(this.values=c.split(","),this.current_sequence=c);c=this.getInputData(0);null==c&&(c=0);this.index=c=Math.round(c)%this.values.length;this.setOutputData(0,this.values[c])};g.registerNodeType("logic/sequence",q)})(this);
(function(v){function c(){this.addInput("A","Number");this.addInput("B","Number");this.addInput("C","Number");this.addInput("D","Number");this.values=[[],[],[],[]];this.properties={scale:2}}function q(){this.addOutput("frame","image");this.properties={url:""}}function g(){this.addInput("f","number");this.addOutput("Color","color");this.properties={colorA:"#444444",colorB:"#44AAFF",colorC:"#44FFAA",colorD:"#FFFFFF"}}function l(){this.addInput("","image,canvas");this.size=[200,200]}function r(){this.addInputs([["img1",
"image"],["img2","image"],["fade","number"]]);this.addOutput("","image");this.properties={fade:0.5,width:512,height:512}}function f(){this.addInput("","image");this.addOutput("","image");this.properties={width:256,height:256,x:0,y:0,scale:1};this.size=[50,20]}function y(){this.addInput("clear",w.ACTION);this.addOutput("","canvas");this.properties={width:512,height:512,autoclear:!0};this.canvas=document.createElement("canvas");this.ctx=this.canvas.getContext("2d")}function s(){this.addInput("canvas",
...
function e(){this.addOutput("Webcam","image");this.properties={facingMode:"user"};this.boxcolor="black";this.frame=0}var w=v.LiteGraph;c.title="Plot";c.desc="Plots data over time";c.colors=["#FFF","#F99","#9F9","#99F"];c.prototype.onExecute=function(c){if(!this.flags.collapsed){c=this.size;for(var e=0;4>e;++e){var f=this.getInputData(e);if(null!=f){var h=this.values[e];h.push(f);h.length>c[0]&&h.shift()}}}};c.prototype.onDrawBackground=function(e){if(!this.flags.collapsed){var f=this.size,g=0.5*f[1]/
this.properties.scale,h=c.colors,l=0.5*f[1];e.fillStyle="#000";e.fillRect(0,0,f[0],f[1]);e.strokeStyle="#555";e.beginPath();e.moveTo(0,l);e.lineTo(f[0],l);e.stroke();if(this.inputs)for(var m=0;4>m;++m){var a=this.values[m];if(this.inputs[m]&&this.inputs[m].link){e.strokeStyle=h[m];e.beginPath();var b=a[0]*g*-1+l;e.moveTo(0,Math.clamp(b,0,f[1]));for(var d=1;d<a.length&&d<f[0];++d)b=a[d]*g*-1+l,e.lineTo(d,Math.clamp(b,0,f[1]));e.stroke()}}}};w.registerNodeType("graphics/plot",c);q.title="Image";q.desc=
...
function(){var c=this.canvas.getContext("2d");this.canvas.width=this.canvas.width;var e=this.getInputData(0);null!=e&&c.drawImage(e,0,0,this.canvas.width,this.canvas.height);e=this.getInputData(2);null==e?e=this.properties.fade:this.properties.fade=e;c.globalAlpha=e;e=this.getInputData(1);null!=e&&c.drawImage(e,0,0,this.canvas.width,this.canvas.height);c.globalAlpha=1;this.setOutputData(0,this.canvas);this.setDirtyCanvas(!0)};w.registerNodeType("graphics/imagefade",r);f.title="Crop";f.desc="Crop Image";
...
function(c){this.flags.collapsed||this.canvas&&c.drawImage(this.canvas,0,0,this.canvas.width,this.canvas.height,0,0,this.size[0],this.size[1])};f.prototype.onPropertyChanged=function(c,e){this.properties[c]=e;"scale"==c?(this.properties[c]=parseFloat(e),0==this.properties[c]&&(this.trace("Error in scale"),this.properties[c]=1)):this.properties[c]=parseInt(e);this.createCanvas();return!0};w.registerNodeType("graphics/cropImage",f);y.title="Canvas";y.desc="Canvas to render stuff";y.prototype.onExecute=
function(){var c=this.canvas,e=this.properties.width|0,f=this.properties.height|0;c.width!=e&&(c.width=e);c.height!=f&&(c.height=f);this.properties.autoclear&&this.ctx.clearRect(0,0,c.width,c.height);this.setOutputData(0,c)};y.prototype.onAction=function(c,e){"clear"==c&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)};w.registerNodeType("graphics/canvas",y);s.title="DrawImage";s.desc="Draws image into a canvas";s.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var e=
this.getInputOrProperty("img");if(e){var f=this.getInputOrProperty("x"),h=this.getInputOrProperty("y");c.getContext("2d").drawImage(e,f,h)}}};w.registerNodeType("graphics/drawImage",s);u.title="DrawRectangle";u.desc="Draws rectangle in canvas";u.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var e=this.getInputOrProperty("x"),f=this.getInputOrProperty("y"),h=this.getInputOrProperty("w"),g=this.getInputOrProperty("h");c.getContext("2d").fillRect(e,f,h,g)}};w.registerNodeType("graphics/drawRectangle",
...
this._tex.type==b&&this._tex.width==e&&this._tex.height==f||(this._tex=new GL.Texture(e,f,{type:b,format:gl.RGBA,filter:gl.LINEAR}));this._tex.drawTo(function(){a.uniforms(k).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._tex)}}},r.pixel_shader="precision highp float;\n\t\t\n\t\tvarying vec2 v_coord;\n\t\tuniform float time;\n",E.registerNodeType("texture/shader",r),f.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},f.title="Scale/Offset",f.desc="Applies an scaling and offseting",
...
s.gamma_pixel_shader="precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_igamma;\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t   gl_FragColor = color;\n\t\t}\n\t\t",E.registerNodeType("texture/toviewport",s),u.title="Copy",u.desc="Copy Texture",u.widgets_info={size:{widget:"combo",values:[0,32,64,128,256,512,1024,2048]},precision:{widget:"combo",
...
null,m=[],a={type:f,format:a.format},f=vec2.create(),n={u_offset:f};this._texture&&GL.Texture.releaseTemporary(this._texture);for(var l=0;l<h;++l){f[0]=1/d;f[1]=1/e;d=d>>1||0;e=e>>1||0;g=GL.Texture.getTemporary(d,e,a);m.push(g);k.setParameter(GL.TEXTURE_MAG_FILTER,GL.NEAREST);k.copyTo(g,b,n);if(1==d&&1==e)break;k=g}this._texture=m.pop();for(l=0;l<m.length;++l)GL.Texture.releaseTemporary(m[l]);this.properties.generate_mipmaps&&(this._texture.bind(0),gl.generateMipmap(this._texture.texture_type),this._texture.unbind(0));
...
(c=this.getInputData(1),this.properties.iterations=c);c=Math.min(Math.floor(c),K.max_iterations);if(0==c)this.setOutputData(0,a);else{var d=this.properties.intensity;this.isInputConnected(2)&&(d=this.getInputData(2),this.properties.intensity=d);var e=E.camera_aspect;e||void 0===window.gl||(e=gl.canvas.height/gl.canvas.width);e||(e=1);var e=this.properties.preserve_aspect?e:1,f=this.properties.scale||[1,1];a.applyBlur(e*f[0],f[1],d,b);for(a=1;a<c;++a)b.applyBlur(e*f[0]*(a+1),f[1]*(a+1),d);this.setOutputData(0,
...
b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var d=this.getInputData(1);null==d&&(d=this.properties.average_lum);var e=this._uniforms,f=null;d.constructor===Number?(this.properties.average_lum=d,e.u_average_lum=this.properties.average_lum,f=B._shader,f||(f=B._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,B.pixel_shader))):d.constructor===GL.Texture&&(e.u_average_texture=d.bind(1),f=B._shader_texture,
f||(f=B._shader_texture=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,B.pixel_shader,{AVG_TEXTURE:""})));e.u_lumwhite2=this.properties.lum_white*this.properties.lum_white;e.u_scale=this.properties.scale;e.u_igamma=1/this.properties.gamma;gl.disable(gl.DEPTH_TEST);b.drawTo(function(){a.bind(0);f.uniforms(e).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._temp_texture)}},B.pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_scale;\n\t\t#ifdef AVG_TEXTURE\n\t\t\tuniform sampler2D u_average_texture;\n\t\t#else\n\t\t\tuniform float u_average_lum;\n\t\t#endif\n\t\tuniform float u_lumwhite2;\n\t\tuniform float u_igamma;\n\t\tvec3 RGB2xyY (vec3 rgb)\n\t\t{\n\t\t\t const mat3 RGB2XYZ = mat3(0.4124, 0.3576, 0.1805,\n\t\t\t\t\t\t\t\t\t   0.2126, 0.7152, 0.0722,\n\t\t\t\t\t\t\t\t\t   0.0193, 0.1192, 0.9505);\n\t\t\tvec3 XYZ = RGB2XYZ * rgb;\n\t\t\t\n\t\t\tfloat f = (XYZ.x + XYZ.y + XYZ.z);\n\t\t\treturn vec3(XYZ.x / f,\n\t\t\t\t\t\tXYZ.y / f,\n\t\t\t\t\t\tXYZ.y);\n\t\t}\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\t\t\tvec3 rgb = color.xyz;\n\t\t\tfloat average_lum = 0.0;\n\t\t\t#ifdef AVG_TEXTURE\n\t\t\t\tvec3 pixel = texture2D(u_average_texture,vec2(0.5)).xyz;\n\t\t\t\taverage_lum = (pixel.x + pixel.y + pixel.z) / 3.0;\n\t\t\t#else\n\t\t\t\taverage_lum = u_average_lum;\n\t\t\t#endif\n\t\t\t//Ld - this part of the code is the same for both versions\n\t\t\tfloat lum = dot(rgb, vec3(0.2126, 0.7152, 0.0722));\n\t\t\tfloat L = (u_scale / average_lum) * lum;\n\t\t\tfloat Ld = (L * (1.0 + L / u_lumwhite2)) / (1.0 + L);\n\t\t\t//first\n\t\t\t//vec3 xyY = RGB2xyY(rgb);\n\t\t\t//xyY.z *= Ld;\n\t\t\t//rgb = xyYtoRGB(xyY);\n\t\t\t//second\n\t\t\trgb = (rgb / lum) * Ld;\n\t\t\trgb = pow( rgb, vec3( u_igamma ) );\n\t\t\tgl_FragColor = vec4( rgb, color.a );\n\t\t}",
...
for(f=0;f<m;++f)for(g=0;g<m;++g)l=3*f+3*g*m,h[l]=(f/m-0.5)*e*2,h[l+1]=0,h[l+2]=(g/m-0.5)*e*2;h=new Float32Array(h.subarray(0,m*m*3))}else if(g==c.SPHERE){var m=Math.floor(Math.sqrt(f)),a=vec3.create();for(f=0;f<m;++f)for(g=0;g<m;++g)l=3*f+3*g*m,polarToCartesian(a,f/m*2*Math.PI,2*(g/m-0.5)*Math.PI,e),h[l]=a[0],h[l+1]=a[1],h[l+2]=a[2];h=new Float32Array(h.subarray(0,m*m*3))}else{if(g==c.CIRCLE)for(f=0;f<m;f+=3)g=f/m*Math.PI*2,h[f]=Math.cos(g)*e,h[f+1]=0,h[f+2]=Math.sin(g)*e}else if(g==c.RECTANGLE)for(f=
0;f<m;f+=3)h[f]=(Math.random()-0.5)*e*2,h[f+1]=0,h[f+2]=(Math.random()-0.5)*e*2;else if(g==c.CUBE)for(f=0;f<m;f+=3)h[f]=(Math.random()-0.5)*e*2,h[f+1]=(Math.random()-0.5)*e*2,h[f+2]=(Math.random()-0.5)*e*2;else if(g==c.SPHERE)for(f=0;f<m;f+=3){var a=Math.random(),b=Math.random();g=2*Math.cos(2*Math.PI*a)*Math.sqrt(b*(1-b));l=1-2*b;a=2*Math.sin(2*Math.PI*a)*Math.sqrt(b*(1-b));h[f]=g*e;h[f+1]=l*e;h[f+2]=a*e}else if(g==c.HEMISPHERE)for(f=0;f<m;f+=3)a=Math.random(),b=Math.random(),g=Math.cos(2*Math.PI*
a)*Math.sqrt(1-b*b),l=b,a=Math.sin(2*Math.PI*a)*Math.sqrt(1-b*b),h[f]=g*e,h[f+1]=l*e,h[f+2]=a*e;else if(g==c.CIRCLE)for(f=0;f<m;f+=3)a=Math.random(),b=Math.random(),g=Math.cos(2*Math.PI*a)*Math.sqrt(1-b*b),a=Math.sin(2*Math.PI*a)*Math.sqrt(1-b*b),h[f]=g*e,h[f+1]=0,h[f+2]=a*e;else if(g==c.INSIDE_SPHERE)for(f=0;f<m;f+=3){l=Math.random();g=Math.random();b=2*l*Math.PI;a=Math.acos(2*g-1);g=Math.cbrt(Math.random())*e;l=Math.sin(b);var b=Math.cos(b),d=Math.sin(a),a=Math.cos(a);h[f]=g*d*b;h[f+1]=g*d*l;h[f+
...
0;h<m.length;h+=3)g[0]=m[h],g[1]=m[h+1],g[2]=m[h+2],e(g,h/3,f),m[h]=g[0],m[h+1]=g[1],m[h+2]=g[2];this.geometry.vertices=m}this.setOutputData(0,this.geometry)}else this.setOutputData(0,c)};y.registerNodeType("geometry/eval",g);l.title="connect points";l.desc="adds indices between near points";l.prototype.onPropertyChanged=function(c,e){this.must_update=!0};l.prototype.onExecute=function(){var c=this.getInputData(0);if(c){if(this.geometry_id!=c._id||this.version!=c._version||this.must_update){this.must_update=
!1;this.geometry_id=c._id;this.version=c._version;this.geometry={};for(var e in c)this.geometry[e]=c[e];this.geometry._id=1E5*Math.random()|0;this.geometry._version=this.my_version++;var c=c.vertices,f=c.length,h=this.properties.min_dist,g=this.properties.max_dist,m=this.properties.probability,a=this.properties.max_connections,b=[];for(e=0;e<f;e+=3)for(var d=c[e],l=c[e+1],p=c[e+2],r=0,s=e+3;s<f;s+=3){var q=c[s],u=c[s+1],y=c[s+2],q=Math.sqrt((d-q)*(d-q)+(l-u)*(l-u)+(p-y)*(p-y));if(!(q>g||q<h||1>m&&
m<Math.random())&&(b.push(e/3,s/3),r+=1,a&&r>a))break}this.geometry.indices=this.indices=new Uint32Array(b)}this.indices&&this.indices.length?(this.geometry.indices=this.indices,this.setOutputData(0,this.geometry)):this.setOutputData(0,null)}};y.registerNodeType("geometry/connectPoints",l);"undefined"!=typeof GL&&(r.title="render",r.desc="renders a geometry",r.PRIMITIVE_VALUES={points:GL.POINTS,lines:GL.LINES,line_loop:GL.LINE_LOOP,line_strip:GL.LINE_STRIP,triangles:GL.TRIANGLES,triangle_fan:GL.TRIANGLE_FAN,
...
l),e=new Float32Array(r*q*2),w=-1,k=2/c*l,n=2/g*l,v=0;v<q;++v){for(var h=-1,t=0;t<r;++t){var m=v*r*2+2*t;e[m]=h;e[m+1]=w;h+=k}w+=n}this._points_mesh=GL.Mesh.load({vertices2D:e});this._points_mesh._width=c;this._points_mesh._height=g;this._points_mesh._spacing=l;return this._points_mesh};g._first_pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_texture_blur;\n\t\t\tuniform sampler2D u_mask;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 blurred_color = texture2D(u_texture_blur, v_coord);\n\t\t\t\tfloat mask = texture2D(u_mask, v_coord).x;\n\t\t\t   gl_FragColor = mix(color, blurred_color, mask);\n\t\t\t}\n\t\t\t";
...
g._second_pixel_shader="precision highp float;\n\t\t\tvarying vec4 v_color;\n\t\t\tuniform sampler2D u_shape;\n\t\t\tuniform float u_alpha;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D( u_shape, gl_PointCoord );\n\t\t\t\tcolor *= v_color * u_alpha;\n\t\t\t\tgl_FragColor = color;\n\t\t\t}\n";c.registerNodeType("fx/bokeh",g);v.LGraphFXBokeh=g;var l=function(){this.addInput("Texture","Texture");this.addInput("value1","number");this.addInput("value2","number");this.addOutput("Texture",
...
LGraphTexture.getTargetTexture(c,this._tex,this.properties.precision);var g=this.properties.value1;this.isInputConnected(1)&&(g=this.getInputData(1),this.properties.value1=g);var r=this.properties.value2;this.isInputConnected(2)&&(r=this.getInputData(2),this.properties.value2=r);var q=this.properties.fx,z=l.shaders[q];if(!z){var e=l["pixel_shader_"+q];if(!e)return;z=l.shaders[q]=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,e)}gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var w=Mesh.getScreenQuad(),
k;k=v.LS&&LS.Renderer._current_camera?[LS.Renderer._current_camera.near,LS.Renderer._current_camera.far]:[1,100];var n=null;"noise"==q&&(n=LGraphTexture.getNoiseTexture());this._tex.drawTo(function(){c.bind(0);"noise"==q&&n.bind(1);z.uniforms({u_texture:0,u_noise:1,u_size:[c.width,c.height],u_rand:[Math.random(),Math.random()],u_value1:g,u_value2:r,u_camera_planes:k}).draw(w)});this.setOutputData(0,this._tex)}}};l.pixel_shader_halftone="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform vec2 u_size;\n\t\t\tuniform float u_value1;\n\t\t\tuniform float u_value2;\n\t\t\t\n\t\t\tfloat pattern() {\n\t\t\t\tfloat s = sin(u_value1 * 3.1415), c = cos(u_value1 * 3.1415);\n\t\t\t\tvec2 tex = v_coord * u_size.xy;\n\t\t\t\tvec2 point = vec2(\n\t\t\t\t   c * tex.x - s * tex.y ,\n\t\t\t\t   s * tex.x + c * tex.y \n\t\t\t\t) * u_value2;\n\t\t\t\treturn (sin(point.x) * sin(point.y)) * 4.0;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat average = (color.r + color.g + color.b) / 3.0;\n\t\t\t\tgl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);\n\t\t\t}\n";
...
l.pixel_shader_gamma="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_value1;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat gamma = 1.0 / u_value1;\n\t\t\t\tgl_FragColor = vec4( pow( color.xyz, vec3(gamma) ), color.a );\n\t\t\t}\n";c.registerNodeType("fx/generic",l);v.LGraphFXGeneric=l;var r=function(){this.addInput("Tex.","Texture");this.addInput("intensity","number");this.addOutput("Texture",
...
var g=this.properties.intensity;this.isInputConnected(1)&&(g=this.getInputData(1),this.properties.intensity=g);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var l=Mesh.getScreenQuad(),q=r._shader,v=this.properties.invert;this._tex.drawTo(function(){c.bind(0);q.uniforms({u_texture:0,u_intensity:g,u_isize:[1/c.width,1/c.height],u_invert:v?1:0}).draw(l)});this.setOutputData(0,this._tex)}};r.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_intensity;\n\t\t\tuniform int u_invert;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat luminance = 1.0 - length( v_coord - vec2(0.5) ) * 1.414;\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tluminance = 1.0 - luminance;\n\t\t\t\tluminance = mix(1.0, luminance, u_intensity);\n\t\t\t   gl_FragColor = vec4( luminance * color.xyz, color.a);\n\t\t\t}\n\t\t\t";
c.registerNodeType("fx/vigneting",r);v.LGraphFXVigneting=r}})(this);
(function(v){function c(c){this.cmd=this.channel=0;this.data=new Uint32Array(3);c&&this.setup(c)}function q(c,e){navigator.requestMIDIAccess?(this.on_ready=c,this.state={note:[],cc:[]},navigator.requestMIDIAccess().then(this.onMIDISuccess.bind(this),this.onMIDIFailure.bind(this))):(this.error="not suppoorted",e?e("Not supported"):console.error("MIDI NOT SUPPORTED, enable by chrome://flags"))}function g(){this.addOutput("on_midi",n.EVENT);this.addOutput("out","midi");this.properties={port:0};this._current_midi_event=
this._last_midi_event=null;this.boxcolor="#AAA";this._last_time=0;var c=this;new q(function(e){c._midi=e;if(c._waiting)c.onStart();c._waiting=!1})}function l(){this.addInput("send",n.EVENT);this.properties={port:0};var c=this;new q(function(e){c._midi=e})}function r(){this.addInput("on_midi",n.EVENT);this._str="";this.size=[200,40]}function f(){this.properties={channel:-1,cmd:-1,min_value:-1,max_value:-1};var c=this;this._learning=!1;this.addWidget("button","Learn","",function(){c._learning=!0;c.boxcolor=
"#FA3"});this.addInput("in",n.EVENT);this.addOutput("on_midi",n.EVENT);this.boxcolor="#AAA"}function y(){this.properties={channel:0,cmd:144,value1:1,value2:1};this.addInput("send",n.EVENT);this.addInput("assign",n.EVENT);this.addOutput("on_midi",n.EVENT);this.midi_event=new c;this.gate=!1}function s(){this.properties={cc:1,value:0};this.addOutput("value","number")}function u(){this.addInput("generate",n.ACTION);this.addInput("scale","string");this.addInput("octave","number");this.addOutput("note",
n.EVENT);this.properties={notes:"A,A#,B,C,C#,D,D#,E,F,F#,G,G#",octave:2,duration:0.5,mode:"sequence"};this.notes_pitches=u.processScale(this.properties.notes);this.sequence_index=0}function z(){this.properties={amount:0};this.addInput("in",n.ACTION);this.addInput("amount","number");this.addOutput("out",n.EVENT);this.midi_event=new c}function e(){this.properties={scale:"A,A#,B,C,C#,D,D#,E,F,F#,G,G#"};this.addInput("note",n.ACTION);this.addInput("scale","string");this.addOutput("out",n.EVENT);this.valid_notes=
Array(12);this.offset_notes=Array(12);this.processScale(this.properties.scale)}function w(){this.properties={volume:0.5,duration:1};this.addInput("note",n.ACTION);this.addInput("volume","number");this.addInput("duration","number");this.addOutput("note",n.EVENT);"undefined"==typeof AudioSynth?(console.error("Audiosynth.js not included, LGMidiPlay requires that library"),this.boxcolor="red"):this.instrument=(this.synth=new AudioSynth).createInstrument("piano")}function k(){this.properties={num_octaves:2,
start_octave:2};this.addInput("note",n.ACTION);this.addInput("reset",n.ACTION);this.addOutput("note",n.EVENT);this.size=[400,100];this.keys=[];this._last_key=-1}var n=v.LiteGraph;n.MIDIEvent=c;c.prototype.fromJSON=function(c){this.setup(c.data)};c.prototype.setup=function(e){var f=e;e.constructor===Object&&(f=e.data);this.data.set(f);this.status=e=f[0];f=e&240;this.cmd=240<=e?e:f;this.cmd==c.NOTEON&&0==this.velocity&&(this.cmd=c.NOTEOFF);this.cmd_str=c.commands[this.cmd]||"";if(f>=c.NOTEON||f<=c.NOTEOFF)this.channel=
...
g.desc="Reads MIDI from a input port";g.color="#243";g.prototype.getPropertyInfo=function(c){if(this._midi&&"port"==c){c={};for(var e=0;e<this._midi.input_ports.size;++e){var f=this._midi.input_ports.get("input-"+e);c[e]=e+".- "+f.name+" version:"+f.version}return{type:"enum",values:c}}};g.prototype.onStart=function(){this._midi?this._midi.openInputPort(this.properties.port,this.onMIDIEvent.bind(this)):this._waiting=!0};g.prototype.onMIDIEvent=function(e,f){this._last_midi_event=f;this.boxcolor="#AFA";
this._last_time=n.getTime();this.trigger("on_midi",f);f.cmd==c.NOTEON?this.trigger("on_noteon",f):f.cmd==c.NOTEOFF?this.trigger("on_noteoff",f):f.cmd==c.CONTROLLERCHANGE?this.trigger("on_cc",f):f.cmd==c.PROGRAMCHANGE?this.trigger("on_pc",f):f.cmd==c.PITCHBEND&&this.trigger("on_pitchbend",f)};g.prototype.onDrawBackground=function(c){this.boxcolor="#AAA";if(!this.flags.collapsed&&this._last_midi_event){c.fillStyle="white";var e=n.getTime(),e=1-Math.max(0,0.001*(e-this._last_time));if(0<e){var f=c.globalAlpha;
c.globalAlpha*=e;c.font="12px Tahoma";c.fillText(this._last_midi_event.toString(),2,0.5*this.size[1]+3);c.globalAlpha=f}}};g.prototype.onExecute=function(){if(this.outputs)for(var c=this._last_midi_event,e=0;e<this.outputs.length;++e){var f=null;switch(this.outputs[e].name){case "midi":f=this._midi;break;case "last_midi":f=c;break;default:continue}this.setOutputData(e,f)}};g.prototype.onGetOutputs=function(){return[["last_midi","midi"],["on_midi",n.EVENT],["on_noteon",n.EVENT],["on_noteoff",n.EVENT],
["on_cc",n.EVENT],["on_pc",n.EVENT],["on_pitchbend",n.EVENT]]};n.registerNodeType("midi/input",g);l.MIDIInterface=q;l.title="MIDI Output";l.desc="Sends MIDI to output channel";l.color="#243";l.prototype.getPropertyInfo=function(c){if(this._midi&&"port"==c){c={};for(var e=0;e<this._midi.output_ports.size;++e){var f=this._midi.output_ports.get(e);c[e]=e+".- "+f.name+" version:"+f.version}return{type:"enum",values:c}}};l.prototype.onAction=function(c,e){this._midi&&("send"==c&&this._midi.sendMIDI(this.port,
e),this.trigger("midi",e))};l.prototype.onGetInputs=function(){return[["send",n.ACTION]]};l.prototype.onGetOutputs=function(){return[["on_midi",n.EVENT]]};n.registerNodeType("midi/output",l);r.title="MIDI Show";r.desc="Shows MIDI in the graph";r.color="#243";r.prototype.getTitle=function(){return this.flags.collapsed?this._str:this.title};r.prototype.onAction=function(e,f){f&&(this._str=f.constructor===c?f.toString():"???")};r.prototype.onDrawForeground=function(c){this._str&&!this.flags.collapsed&&
(c.font="30px Arial",c.fillText(this._str,10,0.8*this.size[1]))};r.prototype.onGetInputs=function(){return[["in",n.ACTION]]};r.prototype.onGetOutputs=function(){return[["on_midi",n.EVENT]]};n.registerNodeType("midi/show",r);f.title="MIDI Filter";f.desc="Filters MIDI messages";f.color="#243";f["@cmd"]={type:"enum",title:"Command",values:c.commands_reversed};f.prototype.getTitle=function(){var e=null,e=-1==this.properties.cmd?"Nothing":c.commands_short[this.properties.cmd]||"Unknown";-1!=this.properties.min_value&&
...
y.prototype.onGetInputs=function(){return[["note","number"]]};y.prototype.onGetOutputs=function(){return[["midi","midi"],["on_midi",n.EVENT],["command","number"],["note","number"],["velocity","number"],["cc","number"],["cc_value","number"],["pitch","number"],["gate","bool"],["pitchbend","number"]]};n.registerNodeType("midi/event",y);s.title="MIDICC";s.desc="gets a Controller Change";s.color="#243";s.prototype.onExecute=function(){q.input&&(this.properties.value=q.input.state.cc[this.properties.cc]);
this.setOutputData(0,this.properties.value)};n.registerNodeType("midi/cc",s);u.title="MIDI Generator";u.desc="Generates a random MIDI note";u.color="#243";u.processScale=function(e){e=e.split(",");for(var f=0;f<e.length;++f){var g=e[f];e[f]=2==g.length&&"#"!=g[1]||2<g.length?-n.MIDIEvent.NoteStringToPitch(g):c.note_to_index[g]||0}return e};u.prototype.onPropertyChanged=function(c,e){"notes"==c&&(this.notes_pitches=u.processScale(e))};u.prototype.onExecute=function(){var c=this.getInputData(2);null!=
...
this.processScale(c)};n.registerNodeType("midi/quantize",e);w.title="MIDI Play";w.desc="Plays a MIDI note";w.color="#243";w.prototype.onAction=function(e,f){if(f&&f.constructor===c){if(this.instrument&&f.data[0]==c.NOTEON){var g=f.note;if(!g||"undefined"==g||g.constructor!==String)return;this.instrument.play(g,f.octave,this.properties.duration,this.properties.volume)}this.trigger("note",f)}};w.prototype.onExecute=function(){var c=this.getInputData(1);null!=c&&(this.properties.volume=c);c=this.getInputData(2);
null!=c&&(this.properties.duration=c)};n.registerNodeType("midi/play",w);k.title="MIDI Keys";k.desc="Keyboard to play notes";k.color="#243";k.keys=[{x:0,w:1,h:1,t:0},{x:0.75,w:0.5,h:0.6,t:1},{x:1,w:1,h:1,t:0},{x:1.75,w:0.5,h:0.6,t:1},{x:2,w:1,h:1,t:0},{x:2.75,w:0.5,h:0.6,t:1},{x:3,w:1,h:1,t:0},{x:4,w:1,h:1,t:0},{x:4.75,w:0.5,h:0.6,t:1},{x:5,w:1,h:1,t:0},{x:5.75,w:0.5,h:0.6,t:1},{x:6,w:1,h:1,t:0}];k.prototype.onDrawForeground=function(c){if(!this.flags.collapsed){var e=12*this.properties.num_octaves;
...
0;c<a.inputs.length;++c){var e=a.graph.links[a.inputs[c].link];if(e){var f=a.graph.getNodeById(e.origin_id),g=null,g=f.getAudioNodeInOutputSlot?f.getAudioNodeInOutputSlot(e.origin_slot):f.audionode,e=null,e=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(c):a.audionode;b?m.connect(g,e):m.disconnect(g,e)}}if(a.outputs)for(c=0;c<a.outputs.length;++c)for(var f=a.outputs[c],h=0;h<f.links.length;++h)if(e=a.graph.links[f.links[h]]){var g=a.getAudioNodeInOutputSlot?a.getAudioNodeInOutputSlot(c):a.audionode,
l=a.graph.getNodeById(e.target_id),e=l.getAudioNodeInInputSlot?l.getAudioNodeInInputSlot(e.target_slot):l.audionode;b?m.connect(g,e):m.disconnect(g,e)}};m.onConnectionsChange=function(a,b,c,e){if(a==t.OUTPUT&&(a=null,e&&(a=this.graph.getNodeById(e.target_id)),a)){var f=null,f=this.getAudioNodeInOutputSlot?this.getAudioNodeInOutputSlot(b):this.audionode;b=null;b=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(e.target_slot):a.audionode;c?m.connect(f,b):m.disconnect(f,b)}};m.createAudioNodeWrapper=
function(a){var b=a.prototype.onPropertyChanged;a.prototype.onPropertyChanged=function(a,c){b&&b.call(this,a,c);this.audionode&&void 0!==this.audionode[a]&&(void 0!==this.audionode[a].value?this.audionode[a].value=c:this.audionode[a]=c)};a.prototype.onConnectionsChange=m.onConnectionsChange};m.cached_audios={};m.loadSound=function(a,b,c){function e(a){console.log("Audio loading sample error:",a);c&&c(a)}if(m.cached_audios[a]&&-1==a.indexOf("blob:"))b&&b(m.cached_audios[a]);else{m.onProcessAudioURL&&
(a=m.onProcessAudioURL(a));var f=new XMLHttpRequest;f.open("GET",a,!0);f.responseType="arraybuffer";var g=m.getAudioContext();f.onload=function(){console.log("AudioSource loaded");g.decodeAudioData(f.response,function(c){console.log("AudioSource decoded");m.cached_audios[a]=c;b&&b(c)},e)};f.send();return f}};c["@src"]={widget:"resource"};c.supported_extensions=["wav","ogg","mp3"];c.prototype.onAdded=function(a){if(a.status===LGraph.STATUS_RUNNING)this.onStart()};c.prototype.onStart=function(){this._audiobuffer&&
...
if(navigator.mediaDevices){this._waiting_confirmation=!0;navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(this.streamReady.bind(this))["catch"](a);var b=this}else console.log("getUserMedia() is not supported in your browser, use chrome and enable WebRTC from about://flags")};q.prototype.streamReady=function(a){this._media_stream=a;this.audiosource_node&&this.audiosource_node.disconnect(this.audionode);this.audiosource_node=m.getAudioContext().createMediaStreamSource(a);this.audiosource_node.graphnode=
...
0)};q.prototype.onPropertyChanged=function(a,b){"gain"==a&&(this.audionode.gain.value=b)};q.prototype.onConnectionsChange=m.onConnectionsChange;q.prototype.onGetInputs=function(){return[["playbackRate","number"],["Play",t.ACTION],["Stop",t.ACTION]]};q.title="MediaSource";q.desc="Plays microphone";t.registerNodeType("audio/media_source",q);g.prototype.onPropertyChanged=function(a,b){this.audionode[a]=b};g.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.audionode.frequencyBinCount;
...
0;a<this.inputs.length;++a){var b=this.inputs[a];if(null!=b.link){var c=this.getInputData(a);void 0!==c&&(this.audionode[b.name].value=c)}}};w.prototype.onGetInputs=function(){return[["frequency","number"],["detune","number"],["type","string"]]};m.createAudioNodeWrapper(w);w.title="Oscillator";w.desc="Oscillator";t.registerNodeType("audio/oscillator",w);k.prototype.onExecute=function(){this._last_buffer=this.getInputData(0);var a=this.getInputData(1);void 0!==a&&(this.properties.mark=a);this.setDirtyCanvas(!0,
!1)};k.prototype.onDrawForeground=function(a){if(this._last_buffer){var b=this._last_buffer,c=b.length/this.size[0],e=this.size[1];a.fillStyle="black";a.fillRect(0,0,this.size[0],this.size[1]);a.strokeStyle="white";a.beginPath();var f=0;if(this.properties.continuous){a.moveTo(f,e);for(var g=0;g<b.length;g+=c)a.lineTo(f,e-b[g|0]/255*e),f++}else for(g=0;g<b.length;g+=c)a.moveTo(f+0.5,e),a.lineTo(f+0.5,e-b[g|0]/255*e),f++;a.stroke();0<=this.properties.mark&&(b=m.getAudioContext().sampleRate/b.length,
...
b.getChannelData(c),f=a.getChannelData(c),g=0;g<b.length;g++)f[g]=e[g]}};m.createAudioNodeWrapper(D);D.title="Script";D.desc="apply script to signal";t.registerNodeType("audio/script",D);h.title="Destination";h.desc="Audio output";t.registerNodeType("audio/destination",h)})(this);
(function(v){function c(){this.size=[60,20];this.addInput("send",g.ACTION);this.addOutput("received",g.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"",room:"lgraph",only_send_changes:!0};this._ws=null;this._last_sent_data=[];this._last_received_data=[]}function q(){this.room_widget=this.addWidget("text","Room","lgraph",this.setRoom.bind(this));this.addWidget("button","Reconnect",null,this.connectSocket.bind(this));this.addInput("send",g.ACTION);this.addOutput("received",
g.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"tamats.com:55000",room:"lgraph",only_send_changes:!0};this._server=null;this.connectSocket();this._last_sent_data=[];this._last_received_data=[];"undefined"==typeof SillyClient&&console.warn("remember to add SillyClient.js to your project: https://tamats.com/projects/sillyserver/src/sillyclient.js")}var g=v.LiteGraph;c.title="WebSocket";c.desc="Send data through a websocket";c.prototype.onPropertyChanged=function(c,g){"url"==
c&&this.connectSocket()};c.prototype.onExecute=function(){!this._ws&&this.properties.url&&this.connectSocket();if(this._ws&&this._ws.readyState==WebSocket.OPEN){for(var c=this.properties.room,g=this.properties.only_send_changes,f=1;f<this.inputs.length;++f){var q=this.getInputData(f);if(null!=q){var s;try{s=JSON.stringify({type:0,room:c,channel:f,data:q})}catch(u){continue}g&&this._last_sent_data[f]==s||(this._last_sent_data[f]=s,this._ws.send(s))}}for(f=1;f<this.outputs.length;++f)this.setOutputData(f,
this._last_received_data[f]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};c.prototype.connectSocket=function(){var c=this,r=this.properties.url;"ws"!=r.substr(0,2)&&(r="ws://"+r);this._ws=new WebSocket(r);this._ws.onopen=function(){console.log("ready");c.boxcolor="#6C6"};this._ws.onmessage=function(f){c.boxcolor="#AFA";var r=JSON.parse(f.data);if(!r.room||r.room==this.properties.room)if(1==f.data.type)if(r.data.object_class&&g[r.data.object_class]){f=null;try{f=new g[r.data.object_class](r.data),
c.triggerSlot(0,f)}catch(q){}}else c.triggerSlot(0,r.data);else c._last_received_data[f.data.channel||0]=r.data};this._ws.onerror=function(f){console.log("couldnt connect to websocket");c.boxcolor="#E88"};this._ws.onclose=function(f){console.log("connection closed");c.boxcolor="#000"}};c.prototype.send=function(c){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send(JSON.stringify({type:1,msg:c}))};c.prototype.onAction=function(c,g){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send({type:1,
room:this.properties.room,action:c,data:g})};c.prototype.onGetInputs=function(){return[["in",0]]};c.prototype.onGetOutputs=function(){return[["out",0]]};g.registerNodeType("network/websocket",c);q.title="SillyClient";q.desc="Connects to SillyServer to broadcast messages";q.prototype.onPropertyChanged=function(c,g){"room"==c&&(this.room_widget.value=g);this.connectSocket()};q.prototype.setRoom=function(c){this.properties.room=c;this.room_widget.value=c;this.connectSocket()};q.prototype.onDrawForeground=
function(){for(var c=1;c<this.inputs.length;++c){var g=this.inputs[c];g.label="in_"+c}for(c=1;c<this.outputs.length;++c)g=this.outputs[c],g.label="out_"+c};q.prototype.onExecute=function(){if(this._server&&this._server.is_connected){for(var c=this.properties.only_send_changes,g=1;g<this.inputs.length;++g){var f=this.getInputData(g),q=this._last_sent_data[g];if(null!=f){if(c){var s=!0;if(f&&f.length&&q&&q.length==f.length&&f.constructor!==String)for(var u=0;u<f.length;++u){if(q[u]!=f[u]){s=!1;break}}else this._last_sent_data[g]!=
f&&(s=!1);if(s)continue}this._server.sendMessage({type:0,channel:g,data:f});if(f.length&&f.constructor!==String)if(this._last_sent_data[g])for(this._last_sent_data[g].length=f.length,u=0;u<f.length;++u)this._last_sent_data[g][u]=f[u];else this._last_sent_data[g]=f.constructor===Array?f.concat():new f.constructor(f);else this._last_sent_data[g]=f}}for(g=1;g<this.outputs.length;++g)this.setOutputData(g,this._last_received_data[g]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};q.prototype.connectSocket=
function(){var c=this;if("undefined"==typeof SillyClient)this._error||console.error("SillyClient node cannot be used, you must include SillyServer.js"),this._error=!0;else if(this._server=new SillyClient,this._server.on_ready=function(){console.log("ready");c.boxcolor="#6C6"},this._server.on_message=function(f,r){var q=null;try{q=JSON.parse(r)}catch(u){return}if(1==q.type)if(q.data.object_class&&g[q.data.object_class]){var v=null;try{v=new g[q.data.object_class](q.data),c.triggerSlot(0,v)}catch(e){return}}else c.triggerSlot(0,
...
q.prototype.send=function(c){this._server&&this._server.is_connected&&this._server.sendMessage({type:1,data:c})};q.prototype.onAction=function(c,g){this._server&&this._server.is_connected&&this._server.sendMessage({type:1,action:c,data:g})};q.prototype.onGetInputs=function(){return[["in",0]]};q.prototype.onGetOutputs=function(){return[["out",0]]};g.registerNodeType("network/sillyclient",q)})(this);
