(function(u){function c(a){e.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function r(a,b,d,x,e,c){this.id=a;this.type=b;this.origin_id=d;this.origin_slot=x;this.target_id=e;this.target_slot=c;this._data=null;this._pos=new Float32Array(2)}function f(a){this._ctor(a)}function h(a){this._ctor(a)}function q(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=0.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
!0;this.render_execution_order=!1;this.render_link_tooltip=this.render_title_colored=!0;this.links_render_mode=e.SPLINE_LINK;this.canvas_mouse=[0,0];this.onDrawLinkTooltip=this.onDrawOverlay=this.onDrawForeground=this.onDrawBackground=this.onMouse=this.onSearchBoxSelection=this.onSearchBox=null;this.connections_width=3;this.round_radius=8;this.over_link_center=this.node_widget=this.current_node=null;this.last_mouse_position=[0,0];this.visible_area=this.ds.visible_area;this.visible_links=[];b&&b.attachCanvas(this);
this.setCanvas(a);this.clear();d.skip_render||this.startRendering();this.autoresize=d.autoresize}function y(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function s(a,b,d,x,e,c){return d<a&&d+e>a&&x<b&&x+c>b?!0:!1}function w(a,b){var d=a[0]+a[2],x=a[1]+a[3],e=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>e||d<b[0]||x<b[1]?!1:!0}function z(a,b){function d(a){var d=parseInt(e.style.top);e.style.top=(d+a.deltaY*b.scroll_speed).toFixed()+"px";a.preventDefault();return!0}this.options=
b=b||{};var x=this;b.parentMenu&&(b.parentMenu.constructor!==this.constructor?(console.error("parentMenu must be of class ContextMenu, ignoring it"),b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));b.event&&b.event.constructor!==MouseEvent&&b.event.constructor!==CustomEvent&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it."),b.event=null);var e=document.createElement("div");e.className=
"litegraph litecontextmenu litemenubar-panel";b.className&&(e.className+=" "+b.className);e.style.minWidth=100;e.style.minHeight=100;e.style.pointerEvents="none";setTimeout(function(){e.style.pointerEvents="auto"},100);e.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);e.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);e.addEventListener("mousedown",function(a){if(2==a.button)return x.close(),a.preventDefault(),!0},!0);b.scroll_speed||
(b.scroll_speed=0.1);e.addEventListener("wheel",d,!0);e.addEventListener("mousewheel",d,!0);this.root=e;if(b.title){var c=document.createElement("div");c.className="litemenu-title";c.innerHTML=b.title;e.appendChild(c)}var c=0,A;for(A in a){var g=a.constructor==Array?a[A]:A;null!=g&&g.constructor!==String&&(g=void 0===g.content?String(g):g.content);this.addItem(g,a[A],b);c++}e.addEventListener("mouseleave",function(a){x.lock||(e.closing_timer&&clearTimeout(e.closing_timer),e.closing_timer=setTimeout(x.close.bind(x,
a),500))});e.addEventListener("mouseenter",function(a){e.closing_timer&&clearTimeout(e.closing_timer)});A=document;b.event&&(A=b.event.target.ownerDocument);A||(A=document);A.body.appendChild(e);c=b.left||0;A=b.top||0;if(b.event){c=b.event.clientX-10;A=b.event.clientY-10;b.title&&(A-=20);b.parentMenu&&(c=b.parentMenu.root.getBoundingClientRect(),c=c.left+c.width);var g=document.body.getBoundingClientRect(),k=e.getBoundingClientRect();c>g.width-k.width-10&&(c=g.width-k.width-10);A>g.height-k.height-
10&&(A=g.height-k.height-10)}e.style.left=c+"px";e.style.top=A+"px";b.scale&&(e.style.transform="scale("+b.scale+")")}var e=u.LiteGraph={VERSION:0.4,CANVAS_GRID_SIZE:10,NODE_TITLE_HEIGHT:30,NODE_TITLE_TEXT_Y:20,NODE_SLOT_HEIGHT:20,NODE_WIDGET_HEIGHT:20,NODE_WIDTH:140,NODE_MIN_WIDTH:50,NODE_COLLAPSED_RADIUS:10,NODE_COLLAPSED_WIDTH:80,NODE_TITLE_COLOR:"#999",NODE_TEXT_SIZE:14,NODE_TEXT_COLOR:"#AAA",NODE_SUBTEXT_SIZE:12,NODE_DEFAULT_COLOR:"#333",NODE_DEFAULT_BGCOLOR:"#353535",NODE_DEFAULT_BOXCOLOR:"#666",
NODE_DEFAULT_SHAPE:"box",DEFAULT_SHADOW_COLOR:"rgba(0,0,0,0.5)",DEFAULT_GROUP_FONT:24,WIDGET_BGCOLOR:"#222",WIDGET_OUTLINE_COLOR:"#666",WIDGET_TEXT_COLOR:"#DDD",WIDGET_SECONDARY_TEXT_COLOR:"#999",LINK_COLOR:"#9A9",EVENT_LINK_COLOR:"#A86",CONNECTING_LINK_COLOR:"#AFA",MAX_NUMBER_OF_NODES:1E3,DEFAULT_POSITION:[100,100],VALID_SHAPES:["default","box","round","card"],BOX_SHAPE:1,ROUND_SHAPE:2,CIRCLE_SHAPE:3,CARD_SHAPE:4,ARROW_SHAPE:5,INPUT:1,OUTPUT:2,EVENT:-1,ACTION:-1,ALWAYS:0,ON_EVENT:1,NEVER:2,ON_TRIGGER:3,
UP:1,DOWN:2,LEFT:3,RIGHT:4,CENTER:5,STRAIGHT_LINK:0,LINEAR_LINK:1,SPLINE_LINK:2,NORMAL_TITLE:0,NO_TITLE:1,TRANSPARENT_TITLE:2,AUTOHIDE_TITLE:3,proxy:null,node_images_path:"",debug:!1,catch_exceptions:!0,throw_errors:!0,allow_scripts:!1,registered_node_types:{},node_types_by_file_extension:{},Nodes:{},searchbox_extras:{},registerNodeType:function(a,b){if(!b.prototype)throw"Cannot register a simple object, it must be a class with a prototype";b.type=a;e.debug&&console.log("Node registered: "+a);a.split("/");
var d=b.name,x=a.lastIndexOf("/");b.category=a.substr(0,x);b.title||(b.title=d);if(b.prototype)for(var p in f.prototype)b.prototype[p]||(b.prototype[p]=f.prototype[p]);Object.hasOwnProperty(b.prototype,"shape")||Object.defineProperty(b.prototype,"shape",{set:function(a){switch(a){case "default":delete this._shape;break;case "box":this._shape=e.BOX_SHAPE;break;case "round":this._shape=e.ROUND_SHAPE;break;case "circle":this._shape=e.CIRCLE_SHAPE;break;case "card":this._shape=e.CARD_SHAPE;break;default:this._shape=
a}},get:function(a){return this._shape},enumerable:!0});(x=this.registered_node_types[a])&&console.log("replacing node type: "+a);this.registered_node_types[a]=b;b.constructor.name&&(this.Nodes[d]=b);if(e.onNodeTypeRegistered)e.onNodeTypeRegistered(a,b);if(x&&e.onNodeTypeReplaced)e.onNodeTypeReplaced(a,b,x);b.prototype.onPropertyChange&&console.warn("LiteGraph node class "+a+" has onPropertyChange method, it must be called onPropertyChanged with d at the end");if(b.supported_extensions)for(p in b.supported_extensions)this.node_types_by_file_extension[b.supported_extensions[p].toLowerCase()]=
b},wrapFunctionAsNode:function(a,b,d,x,p){for(var c=Array(b.length),A="",g=e.getParameterNames(b),k=0;k<g.length;++k)A+="this.addInput('"+g[k]+"',"+(d&&d[k]?"'"+d[k]+"'":"0")+");\n";A+="this.addOutput('out',"+(x?"'"+x+"'":0)+");\n";p&&(A+="this.properties = "+JSON.stringify(p)+";\n");d=Function(A);d.title=a.split("/").pop();d.desc="Generated from "+b.name;d.prototype.onExecute=function(){for(var a=0;a<c.length;++a)c[a]=this.getInputData(a);a=b.apply(this,c);this.setOutputData(0,a)};this.registerNodeType(a,
d)},addNodeMethod:function(a,b){f.prototype[a]=b;for(var d in this.registered_node_types){var e=this.registered_node_types[d];e.prototype[a]&&(e.prototype["_"+a]=e.prototype[a]);e.prototype[a]=b}},createNode:function(a,b,d){var x=this.registered_node_types[a];if(!x)return e.debug&&console.log('GraphNode type "'+a+'" not registered.'),null;b=b||x.title||a;var p=null;if(e.catch_exceptions)try{p=new x(b)}catch(c){return console.error(c),null}else p=new x(b);p.type=a;!p.title&&b&&(p.title=b);p.properties||
...
c.prototype.runStep=function(a,b,d){a=a||1;var x=e.getTime();this.globaltime=0.001*(x-this.starttime);var p=this._nodes_executable?this._nodes_executable:this._nodes;if(p){d=d||p.length;if(b){for(var c=0;c<a;c++){for(var A=0;A<d;++A){var g=p[A];if(g.mode==e.ALWAYS&&g.onExecute)g.onExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(c=0;c<a;c++){for(A=0;A<d;++A)if(g=p[A],g.mode==e.ALWAYS&&g.onExecute)g.onExecute();
this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute();this.errors_in_execution=!1}catch(k){this.errors_in_execution=!0;if(e.throw_errors)throw k;e.debug&&console.log("Error during execution: "+k);this.stop()}a=e.getTime();x=a-x;0==x&&(x=1);this.execution_time=0.001*x;this.globaltime+=0.001*x;this.iteration+=1;this.elapsed_time=0.001*(a-this.last_update_time);this.last_update_time=a}};c.prototype.updateExecutionOrder=function(){this._nodes_in_order=
this.computeExecutionOrder(!1);this._nodes_executable=[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};c.prototype.computeExecutionOrder=function(a,b){for(var d=[],x=[],p={},c={},A={},g=0,k=this._nodes.length;g<k;++g){var m=this._nodes[g];if(!a||m.onExecute){p[m.id]=m;var l=0;if(m.inputs)for(var t=0,B=m.inputs.length;t<B;t++)m.inputs[t]&&null!=m.inputs[t].link&&(l+=1);0==l?(x.push(m),b&&(m._level=1)):(b&&(m._level=
0),A[m.id]=l)}}for(;0!=x.length;)if(m=x.shift(),d.push(m),delete p[m.id],m.outputs)for(g=0;g<m.outputs.length;g++)if(k=m.outputs[g],null!=k&&null!=k.links&&0!=k.links.length)for(t=0;t<k.links.length;t++)(l=this.links[k.links[t]])&&!c[l.id]&&(B=this.getNodeById(l.target_id),null==B?c[l.id]=!0:(b&&(!B._level||B._level<=m._level)&&(B._level=m._level+1),c[l.id]=!0,A[B.id]-=1,0==A[B.id]&&x.push(B)));for(g in p)d.push(p[g]);d.length!=this._nodes.length&&e.debug&&console.warn("something went wrong, nodes missing");
k=d.length;for(g=0;g<k;++g)d[g].order=g;d=d.sort(function(a,b){var d=a.constructor.priority||a.priority||0,e=b.constructor.priority||b.priority||0;return d==e?a.order-b.order:d-e});for(g=0;g<k;++g)d[g].order=g;return d};c.prototype.getAncestors=function(a){for(var b=[],d=[a],e={};d.length;){var p=d.shift();if(p.inputs){e[p.id]||p==a||(e[p.id]=!0,b.push(p));for(var c=0;c<p.inputs.length;++c){var g=p.getInputNode(c);g&&-1==b.indexOf(g)&&d.push(g)}}}b.sort(function(a,b){return a.order-b.order});return b};
c.prototype.arrange=function(a){a=a||40;for(var b=this.computeExecutionOrder(!1,!0),d=[],e=0;e<b.length;++e){var p=b[e],c=p._level||1;d[c]||(d[c]=[]);d[c].push(p)}b=a;for(e=0;e<d.length;++e)if(c=d[e]){for(var g=100,k=a,m=0;m<c.length;++m)p=c[m],p.pos[0]=b,p.pos[1]=k,p.size[0]>g&&(g=p.size[0]),k+=p.size[1]+a;b+=g+a}this.setDirtyCanvas(!0,!0)};c.prototype.getTime=function(){return this.globaltime};c.prototype.getFixedTime=function(){return this.fixedtime};c.prototype.getElapsedTime=function(){return this.elapsed_time};
c.prototype.sendEventToAllNodes=function(a,b,d){d=d||e.ALWAYS;var x=this._nodes_in_order?this._nodes_in_order:this._nodes;if(x)for(var p=0,c=x.length;p<c;++p){var g=x[p];if(g.constructor===e.Subgraph&&"onExecute"!=a)g.mode==d&&g.sendEventToAllNodes(a,b,d);else if(g[a]&&g.mode==d)if(void 0===b)g[a]();else if(b&&b.constructor===Array)g[a].apply(g,b);else g[a](b)}};c.prototype.sendActionToCanvas=function(a,b){if(this.list_of_graphcanvas)for(var d=0;d<this.list_of_graphcanvas.length;++d){var e=this.list_of_graphcanvas[d];
...
c.prototype.setDirtyCanvas=function(a,b){this.sendActionToCanvas("setDirty",[a,b])};c.prototype.removeLink=function(a){if(a=this.links[a]){var b=this.getNodeById(a.target_id);b&&b.disconnectInput(a.target_slot)}};c.prototype.serialize=function(){for(var a=[],b=0,d=this._nodes.length;b<d;++b)a.push(this._nodes[b].serialize());d=[];for(b in this.links){var x=this.links[b];if(!x.serialize){console.warn("weird LLink bug, link info is not a LLink but a regular object");var p=new r;for(b in x)p[b]=x[b];
x=this.links[b]=p}d.push(x.serialize())}x=[];for(b=0;b<this._groups.length;++b)x.push(this._groups[b].serialize());return{last_node_id:this.last_node_id,last_link_id:this.last_link_id,nodes:a,links:d,groups:x,config:this.config,version:e.VERSION}};c.prototype.configure=function(a,b){if(a){b||this.clear();var d=a.nodes;if(a.links&&a.links.constructor===Array){for(var x=[],p=0;p<a.links.length;++p){var c=a.links[p],g=new r;g.configure(c);x[g.id]=g}a.links=x}for(p in a)this[p]=a[p];x=!1;this._nodes=
[];if(d){p=0;for(c=d.length;p<c;++p){var g=d[p],k=e.createNode(g.type,g.title);k||(e.debug&&console.log("Node not found or has errors: "+g.type),k=new f,k.last_serialization=g,x=k.has_errors=!0);k.id=g.id;this.add(k,!0)}p=0;for(c=d.length;p<c;++p)g=d[p],(k=this.getNodeById(g.id))&&k.configure(g)}this._groups.length=0;if(a.groups)for(p=0;p<a.groups.length;++p)d=new e.LGraphGroup,d.configure(a.groups[p]),this.add(d);this.updateExecutionOrder();this._version++;this.setDirtyCanvas(!0,!0);return x}};c.prototype.load=
...
this.type=a.type,this.origin_id=a.origin_id,this.origin_slot=a.origin_slot,this.target_id=a.target_id,this.target_slot=a.target_slot)};r.prototype.serialize=function(){return[this.id,this.origin_id,this.origin_slot,this.target_id,this.target_slot,this.type]};e.LLink=r;u.LGraphNode=e.LGraphNode=f;f.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[e.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=
a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};f.prototype.configure=function(a){this.graph&&this.graph._version++;for(var b in a)if("properties"==b)for(var d in a.properties){if(this.properties[d]=a.properties[d],this.onPropertyChanged)this.onPropertyChanged(d,a.properties[d])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?
...
x,p)}}if(a.widgets_values&&this.widgets)for(d=0;d<a.widgets_values.length;++d)this.widgets[d]&&(this.widgets[d].value=a.widgets_values[d]);if(this.onConfigure)this.onConfigure(a)};f.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,size:this.size,flags:e.cloneObject(this.flags),order:this.order,mode:this.mode};if(this.constructor===f&&this.last_serialization)return this.last_serialization;this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;
...
console.warn("node onSerialize shouldnt return anything, data should be stored in the object pass in the first parameter");return a};f.prototype.clone=function(){var a=e.createNode(this.type);if(!a)return null;var b=e.cloneObject(this.serialize());if(b.inputs)for(var d=0;d<b.inputs.length;++d)b.inputs[d].link=null;if(b.outputs)for(d=0;d<b.outputs.length;++d)b.outputs[d].links&&(b.outputs[d].links.length=0);delete b.id;a.configure(b);return a};f.prototype.toString=function(){return JSON.stringify(this.serialize())};
f.prototype.getTitle=function(){return this.title||this.constructor.title};f.prototype.setProperty=function(a,b){this.properties||(this.properties={});if(b!==this.properties[a]){var d=this.properties[a];this.properties[a]=b;this.onPropertyChanged&&!1===this.onPropertyChanged(a,b)&&(this.properties[a]=d)}};f.prototype.setOutputData=function(a,b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var d=this.outputs[a];if(d&&(d._data=b,this.outputs[a].links))for(d=0;d<this.outputs[a].links.length;d++)this.graph.links[this.outputs[a].links[d]].data=
b}};f.prototype.setOutputDataType=function(a,b){if(this.outputs&&!(-1==a||a>=this.outputs.length)){var d=this.outputs[a];if(d&&(d.type=b,this.outputs[a].links))for(d=0;d<this.outputs[a].links.length;d++)this.graph.links[this.outputs[a].links[d]].type=b}};f.prototype.getInputData=function(a,b){if(this.inputs&&!(a>=this.inputs.length||null==this.inputs[a].link)){var d=this.graph.links[this.inputs[a].link];if(!d)return null;if(!b)return d.data;var e=this.graph.getNodeById(d.origin_id);if(!e)return d.data;
if(e.updateOutputData)e.updateOutputData(d.origin_slot);else if(e.onExecute)e.onExecute();return d.data}};f.prototype.getInputDataType=function(a){if(!this.inputs||a>=this.inputs.length||null==this.inputs[a].link)return null;a=this.graph.links[this.inputs[a].link];if(!a)return null;var b=this.graph.getNodeById(a.origin_id);return b?(a=b.outputs[a.origin_slot])?a.type:null:a.type};f.prototype.getInputDataByName=function(a,b){var d=this.findInputSlot(a);return-1==d?null:this.getInputData(d,b)};f.prototype.isInputConnected=
function(a){return this.inputs?a<this.inputs.length&&null!=this.inputs[a].link:!1};f.prototype.getInputInfo=function(a){return this.inputs?a<this.inputs.length?this.inputs[a]:null:null};f.prototype.getInputNode=function(a){if(!this.inputs||a>=this.inputs.length)return null;a=this.inputs[a];return a&&null!==a.link?(a=this.graph.links[a.link])?this.graph.getNodeById(a.origin_id):null:null};f.prototype.getInputOrProperty=function(a){if(!this.inputs||!this.inputs.length)return this.properties?this.properties[a]:
null;for(var b=0,d=this.inputs.length;b<d;++b){var e=this.inputs[b];if(a==e.name&&null!=e.link&&(e=this.graph.links[e.link]))return e.data}return this.properties[a]};f.prototype.getOutputData=function(a){return!this.outputs||a>=this.outputs.length?null:this.outputs[a]._data};f.prototype.getOutputInfo=function(a){return this.outputs?a<this.outputs.length?this.outputs[a]:null:null};f.prototype.isOutputConnected=function(a){return this.outputs?a<this.outputs.length&&this.outputs[a].links&&this.outputs[a].links.length:
!1};f.prototype.isAnyOutputConnected=function(){if(!this.outputs)return!1;for(var a=0;a<this.outputs.length;++a)if(this.outputs[a].links&&this.outputs[a].links.length)return!0;return!1};f.prototype.getOutputNodes=function(a){if(!this.outputs||0==this.outputs.length||a>=this.outputs.length)return null;a=this.outputs[a];if(!a.links||0==a.links.length)return null;for(var b=[],d=0;d<a.links.length;d++){var e=this.graph.links[a.links[d]];e&&(e=this.graph.getNodeById(e.target_id))&&b.push(e)}return b};
f.prototype.trigger=function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=e.getTime());for(var d=0;d<this.outputs.length;++d){var x=this.outputs[d];!x||x.type!==e.EVENT||a&&x.name!=a||this.triggerSlot(d,b)}}};f.prototype.triggerSlot=function(a,b,d){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=e.getTime());for(var x=0;x<a.length;++x){var p=a[x];if(null==d||d==p){var c=this.graph.links[a[x]];if(c&&(c._last_time=
e.getTime(),p=this.graph.getNodeById(c.target_id)))if(c=p.inputs[c.target_slot],p.onAction)p.onAction(c.name,b);else if(p.mode===e.ON_TRIGGER&&p.onExecute)p.onExecute(b)}}}};f.prototype.clearTriggeredSlot=function(a,b){if(this.outputs){var d=this.outputs[a];if(d&&(d=d.links)&&d.length)for(var e=0;e<d.length;++e){var p=d[e];if(null==b||b==p)if(p=this.graph.links[d[e]])p._last_time=0}}};f.prototype.addProperty=function(a,b,d,e){d={name:a,type:d,default_value:b};if(e)for(var p in e)d[p]=e[p];this.properties_info||
(this.properties_info=[]);this.properties_info.push(d);this.properties||(this.properties={});this.properties[a]=b;return d};f.prototype.addOutput=function(a,b,d){a={name:a,type:b,links:null};if(d)for(var e in d)a[e]=d[e];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);this.size=this.computeSize();this.setDirtyCanvas(!0,!0);return a};f.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var d=a[b],e={name:d[0],type:d[1],link:null};if(a[2])for(var p in d[2])e[p]=
d[2][p];this.outputs||(this.outputs=[]);this.outputs.push(e);if(this.onOutputAdded)this.onOutputAdded(e)}this.size=this.computeSize();this.setDirtyCanvas(!0,!0)};f.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);for(var b=a;b<this.outputs.length;++b)if(this.outputs[b]&&this.outputs[b].links)for(var d=this.outputs[b].links,e=0;e<d.length;++e){var p=this.graph.links[d[e]];p&&(p.origin_slot-=1)}this.size=this.computeSize();if(this.onOutputRemoved)this.onOutputRemoved(a);
this.setDirtyCanvas(!0,!0)};f.prototype.addInput=function(a,b,d){a={name:a,type:b||0,link:null};if(d)for(var e in d)a[e]=d[e];this.inputs||(this.inputs=[]);this.inputs.push(a);this.size=this.computeSize();if(this.onInputAdded)this.onInputAdded(a);this.setDirtyCanvas(!0,!0);return a};f.prototype.addInputs=function(a){for(var b=0;b<a.length;++b){var d=a[b],e={name:d[0],type:d[1],link:null};if(a[2])for(var p in d[2])e[p]=d[2][p];this.inputs||(this.inputs=[]);this.inputs.push(e);if(this.onInputAdded)this.onInputAdded(e)}this.size=
this.computeSize();this.setDirtyCanvas(!0,!0)};f.prototype.removeInput=function(a){this.disconnectInput(a);this.inputs.splice(a,1);for(var b=a;b<this.inputs.length;++b)if(this.inputs[b]){var d=this.graph.links[this.inputs[b].link];d&&(d.target_slot-=1)}this.size=this.computeSize();if(this.onInputRemoved)this.onInputRemoved(a);this.setDirtyCanvas(!0,!0)};f.prototype.addConnection=function(a,b,d,e){a={name:a,type:b,pos:d,direction:e,links:null};this.connections.push(a);return a};f.prototype.computeSize=
function(a,b){function d(a){return a?g*a.length*0.6:0}if(this.constructor.size)return this.constructor.size.concat();var c=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1),p=b||new Float32Array([0,0]),c=Math.max(c,1),g=e.NODE_TEXT_SIZE;p[1]=(this.constructor.slot_start_y||0)+c*e.NODE_SLOT_HEIGHT;c=0;this.widgets&&this.widgets.length&&(c=this.widgets.length*(e.NODE_WIDGET_HEIGHT+4)+8);p[1]=this.widgets_up?Math.max(p[1],c):p[1]+c;var c=d(this.title),k=0,m=0;if(this.inputs)for(var l=
0,t=this.inputs.length;l<t;++l){var n=this.inputs[l],n=n.label||n.name||"",n=d(n);k<n&&(k=n)}if(this.outputs)for(l=0,t=this.outputs.length;l<t;++l)n=this.outputs[l],n=n.label||n.name||"",n=d(n),m<n&&(m=n);p[0]=Math.max(k+m+10,c);p[0]=Math.max(p[0],e.NODE_WIDTH);this.widgets&&this.widgets.length&&(p[0]=Math.max(p[0],1.5*e.NODE_WIDTH));if(this.onResize)this.onResize(p);this.constructor.min_height&&p[1]<this.constructor.min_height&&(p[1]=this.constructor.min_height);p[1]+=6;return p};f.prototype.addWidget=
function(a,b,d,e,p){this.widgets||(this.widgets=[]);b={type:a.toLowerCase(),name:b,value:d,callback:e,options:p||{}};void 0!==b.options.y&&(b.y=b.options.y);e||console.warn("LiteGraph addWidget(...) without a callback");if("combo"==a&&!b.options.values)throw"LiteGraph addWidget('combo',...) requires to pass values in options: { values:['red','blue'] }";this.widgets.push(b);this.size=this.computeSize();return b};f.prototype.addCustomWidget=function(a){this.widgets||(this.widgets=[]);this.widgets.push(a);
return a};f.prototype.getBounding=function(a){a=a||new Float32Array(4);a[0]=this.pos[0]-4;a[1]=this.pos[1]-e.NODE_TITLE_HEIGHT;a[2]=this.size[0]+4;a[3]=this.size[1]+e.NODE_TITLE_HEIGHT;if(this.onBounding)this.onBounding(a);return a};f.prototype.isPointInside=function(a,b,d,c){d=d||0;var p=this.graph&&this.graph.isLive()?0:e.NODE_TITLE_HEIGHT;c&&(p=0);if(this.flags&&this.flags.collapsed){if(s(a,b,this.pos[0]-d,this.pos[1]-e.NODE_TITLE_HEIGHT-d,(this._collapsed_width||e.NODE_COLLAPSED_WIDTH)+2*d,e.NODE_TITLE_HEIGHT+
2*d))return!0}else if(this.pos[0]-4-d<a&&this.pos[0]+this.size[0]+4+d>a&&this.pos[1]-p-d<b&&this.pos[1]+this.size[1]+d>b)return!0;return!1};f.prototype.getSlotInPosition=function(a,b){var d=new Float32Array(2);if(this.inputs)for(var e=0,p=this.inputs.length;e<p;++e){var c=this.inputs[e];this.getConnectionPos(!0,e,d);if(s(a,b,d[0]-10,d[1]-5,20,10))return{input:c,slot:e,link_pos:d}}if(this.outputs)for(e=0,p=this.outputs.length;e<p;++e)if(c=this.outputs[e],this.getConnectionPos(!1,e,d),s(a,b,d[0]-10,
d[1]-5,20,10))return{output:c,slot:e,link_pos:d};return null};f.prototype.findInputSlot=function(a){if(!this.inputs)return-1;for(var b=0,d=this.inputs.length;b<d;++b)if(a==this.inputs[b].name)return b;return-1};f.prototype.findOutputSlot=function(a){if(!this.outputs)return-1;for(var b=0,d=this.outputs.length;b<d;++b)if(a==this.outputs[b].name)return b;return-1};f.prototype.connect=function(a,b,d){d=d||0;if(!this.graph)return console.log("Connect: Error, node doesn't belong to any graph. Nodes must be added first to a graph before connecting them."),
...
e.EVENT)return null;if(!b.inputs||d>=b.inputs.length)return e.debug&&console.log("Connect: Error, slot number not found"),null}null!=b.inputs[d].link&&b.disconnectInput(d);var c=this.outputs[a];if(b.onConnectInput&&!1===b.onConnectInput(d,c.type,c))return null;var p=b.inputs[d],g=null;if(e.isValidConnection(c.type,p.type)){g=new r(++this.graph.last_link_id,p.type,this.id,a,b.id,d);this.graph.links[g.id]=g;null==c.links&&(c.links=[]);c.links.push(g.id);b.inputs[d].link=g.id;this.graph&&this.graph._version++;
if(this.onConnectionsChange)this.onConnectionsChange(e.OUTPUT,a,!0,g,c);if(b.onConnectionsChange)b.onConnectionsChange(e.INPUT,d,!0,g,p);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(e.INPUT,b,d,this,a),this.graph.onNodeConnectionChange(e.OUTPUT,this,a,b,d))}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this,g);return g};f.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return e.debug&&console.log("Connect: Error, no slot of name "+
a),!1}else if(!this.outputs||a>=this.outputs.length)return e.debug&&console.log("Connect: Error, slot number not found"),!1;var d=this.outputs[a];if(!d||!d.links||0==d.links.length)return!1;if(b){b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Target Node not found";for(var c=0,p=d.links.length;c<p;c++){var g=d.links[c],k=this.graph.links[g];if(k.target_id==b.id){d.links.splice(c,1);var m=b.inputs[k.target_slot];m.link=null;delete this.graph.links[g];this.graph&&this.graph._version++;
if(b.onConnectionsChange)b.onConnectionsChange(e.INPUT,k.target_slot,!1,k,m);if(this.onConnectionsChange)this.onConnectionsChange(e.OUTPUT,a,!1,k,d);if(this.graph&&this.graph.onNodeConnectionChange)this.graph.onNodeConnectionChange(e.OUTPUT,this,a);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(e.OUTPUT,this,a),this.graph.onNodeConnectionChange(e.INPUT,b,k.target_slot));break}}}else{c=0;for(p=d.links.length;c<p;c++)if(g=d.links[c],k=this.graph.links[g]){b=this.graph.getNodeById(k.target_id);
this.graph&&this.graph._version++;if(b){m=b.inputs[k.target_slot];m.link=null;if(b.onConnectionsChange)b.onConnectionsChange(e.INPUT,k.target_slot,!1,k,m);if(this.graph&&this.graph.onNodeConnectionChange)this.graph.onNodeConnectionChange(e.INPUT,b,k.target_slot)}delete this.graph.links[g];if(this.onConnectionsChange)this.onConnectionsChange(e.OUTPUT,a,!1,k,d);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(e.OUTPUT,this,a),this.graph.onNodeConnectionChange(e.INPUT,
b,k.target_slot))}d.links=null}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};f.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return e.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||a>=this.inputs.length)return e.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var d=this.inputs[a].link;this.inputs[a].link=null;var c=this.graph.links[d];if(c){var p=
this.graph.getNodeById(c.origin_id);if(!p)return!1;var g=p.outputs[c.origin_slot];if(!g||!g.links||0==g.links.length)return!1;for(var k=0,m=g.links.length;k<m;k++)if(g.links[k]==d){g.links.splice(k,1);break}delete this.graph.links[d];this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(e.INPUT,a,!1,c,b);if(p.onConnectionsChange)p.onConnectionsChange(e.OUTPUT,k,!1,c,g);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(e.OUTPUT,p,k),
this.graph.onNodeConnectionChange(e.INPUT,this,a))}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};f.prototype.getConnectionPos=function(a,b,d){d=d||new Float32Array(2);var c=0;a&&this.inputs&&(c=this.inputs.length);!a&&this.outputs&&(c=this.outputs.length);var p=0.5*e.NODE_SLOT_HEIGHT;if(this.flags.collapsed)return b=this._collapsed_width||e.NODE_COLLAPSED_WIDTH,this.horizontal?(d[0]=this.pos[0]+0.5*b,d[1]=a?this.pos[1]-e.NODE_TITLE_HEIGHT:this.pos[1]):(d[0]=a?this.pos[0]:
...
enumerable:!0})};h.prototype.configure=function(a){this.title=a.title;this._bounding.set(a.bounding);this.color=a.color;this.font=a.font};h.prototype.serialize=function(){var a=this._bounding;return{title:this.title,bounding:[Math.round(a[0]),Math.round(a[1]),Math.round(a[2]),Math.round(a[3])],color:this.color,font:this.font}};h.prototype.move=function(a,b,d){this._pos[0]+=a;this._pos[1]+=b;if(!d)for(d=0;d<this._nodes.length;++d){var e=this._nodes[d];e.pos[0]+=a;e.pos[1]+=b}};h.prototype.recomputeInsideNodes=
function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),d=0;d<a.length;++d){var e=a[d];e.getBounding(b);w(this._bounding,b)&&this._nodes.push(e)}};h.prototype.isPointInside=f.prototype.isPointInside;h.prototype.setDirtyCanvas=f.prototype.setDirtyCanvas;e.DragAndScale=q;q.prototype.bindEvents=function(a){this.last_mouse=new Float32Array(2);this._binded_mouse_callback=this.onMouse.bind(this);a.addEventListener("mousedown",this._binded_mouse_callback);a.addEventListener("mousemove",
this._binded_mouse_callback);a.addEventListener("mousewheel",this._binded_mouse_callback,!1);a.addEventListener("wheel",this._binded_mouse_callback,!1)};q.prototype.computeVisibleArea=function(){if(this.element){var a=-this.offset[0],b=-this.offset[1],d=a+this.element.width/this.scale,e=b+this.element.height/this.scale;this.visible_area[0]=a;this.visible_area[1]=b;this.visible_area[2]=d-a;this.visible_area[3]=e-b}else this.visible_area[0]=this.visible_area[1]=this.visible_area[2]=this.visible_area[3]=
0};q.prototype.onMouse=function(a){if(this.enabled){var b=this.element,d=b.getBoundingClientRect(),e=a.clientX-d.left,d=a.clientY-d.top;a.canvasx=e;a.canvasy=d;a.dragging=this.dragging;var c=!1;this.onmouse&&(c=this.onmouse(a));if("mousedown"==a.type)this.dragging=!0,b.removeEventListener("mousemove",this._binded_mouse_callback),document.body.addEventListener("mousemove",this._binded_mouse_callback),document.body.addEventListener("mouseup",this._binded_mouse_callback);else if("mousemove"==a.type)c||
...
1);var e=this.convertCanvasToOffset(b),d=[e[0]-d[0],e[1]-d[1]];this.offset[0]+=d[0];this.offset[1]+=d[1];if(this.onredraw)this.onredraw(this)}}};q.prototype.changeDeltaScale=function(a,b){this.changeScale(this.scale*a,b)};q.prototype.reset=function(){this.scale=1;this.offset[0]=0;this.offset[1]=0};u.LGraphCanvas=e.LGraphCanvas=l;l.link_type_colors={"-1":e.EVENT_LINK_COLOR,number:"#AAA",node:"#DCA"};l.gradients={};l.prototype.clear=function(){this.fps=this.render_time=this.last_draw_time=this.frame=
...
this.graph.detachCanvas(this):(a.attachCanvas(this),this.setDirty(!0,!0)))};l.prototype.openSubgraph=function(a){if(!a)throw"graph cannot be null";if(this.graph==a)throw"graph cannot be the same";this.clear();this.graph&&(this._graph_stack||(this._graph_stack=[]),this._graph_stack.push(this.graph));a.attachCanvas(this);this.setDirty(!0,!0)};l.prototype.closeSubgraph=function(){if(this._graph_stack&&0!=this._graph_stack.length){var a=this.graph._subgraph_node,b=this._graph_stack.pop();this.selected_nodes=
{};this.highlighted_links={};b.attachCanvas(this);this.setDirty(!0,!0);a&&(this.centerOnNode(a),this.selectNodes([a]))}};l.prototype.getCurrentGraph=function(){return this.graph};l.prototype.setCanvas=function(a,b){if(a&&a.constructor===String&&(a=document.getElementById(a),!a))throw"Error creating LiteGraph canvas: Canvas not found";if(a!==this.canvas&&(!a&&this.canvas&&(b||this.unbindEvents()),this.canvas=a,this.ds.element=a)){a.className+=" lgraphcanvas";a.data=this;a.tabindex="1";this.bgcanvas=
...
this.canvas.removeEventListener("touchstart",this.touchHandler);this.canvas.removeEventListener("touchmove",this.touchHandler);this.canvas.removeEventListener("touchend",this.touchHandler);this.canvas.removeEventListener("touchcancel",this.touchHandler);this._ondrop_callback=this._key_callback=this._mousewheel_callback=this._mousedown_callback=null;this._events_binded=!1}else console.warn("LGraphCanvas: no events binded")};l.getFileExtension=function(a){var b=a.indexOf("?");-1!=b&&(a=a.substr(0,b));
b=a.lastIndexOf(".");return-1==b?"":a.substr(b+1).toLowerCase()};l.prototype.enableWebGL=function(){if(void 0===typeof GL)throw"litegl.js must be included to use a WebGL canvas";if(void 0===typeof enableWebGLCanvas)throw"webglCanvas.js must be included to use this feature";this.gl=this.ctx=enableWebGLCanvas(this.canvas);this.ctx.webgl=!0;this.bgcanvas=this.canvas;this.bgctx=this.gl;this.canvas.webgl_enabled=!0};l.prototype.setDirty=function(a,b){a&&(this.dirty_canvas=!0);b&&(this.dirty_bgcanvas=!0)};
l.prototype.getCanvasWindow=function(){if(!this.canvas)return window;var a=this.canvas.ownerDocument;return a.defaultView||a.parentWindow};l.prototype.startRendering=function(){function a(){this.pause_rendering||this.draw();var b=this.getCanvasWindow();this.is_rendering&&b.requestAnimationFrame(a.bind(this))}this.is_rendering||(this.is_rendering=!0,a.call(this))};l.prototype.stopRendering=function(){this.is_rendering=!1};l.prototype.processMouseDown=function(a){if(this.graph){this.adjustMouseEvent(a);
...
a.which){a.ctrlKey&&(this.dragging_rectangle=new Float32Array(4),this.dragging_rectangle[0]=a.canvasX,this.dragging_rectangle[1]=a.canvasY,this.dragging_rectangle[2]=1,this.dragging_rectangle[3]=1,c=!0);var g=!1;if(d&&this.allow_interaction&&!c&&!this.read_only){this.live_mode||d.flags.pinned||this.bringToFront(d);if(!this.connecting_node&&!d.flags.collapsed&&!this.live_mode)if(!c&&!1!==d.resizable&&s(a.canvasX,a.canvasY,d.pos[0]+d.size[0]-5,d.pos[1]+d.size[1]-5,10,10))this.resizing_node=d,this.canvas.style.cursor=
"se-resize",c=!0;else{if(d.outputs)for(var k=0,m=d.outputs.length;k<m;++k){var t=d.outputs[k],n=d.getConnectionPos(!1,k);if(s(a.canvasX,a.canvasY,n[0]-15,n[1]-10,30,20)){this.connecting_node=d;this.connecting_output=t;this.connecting_pos=d.getConnectionPos(!1,k);this.connecting_slot=k;a.shiftKey&&d.disconnectOutput(k);if(p){if(d.onOutputDblClick)d.onOutputDblClick(k,a)}else if(d.onOutputClick)d.onOutputClick(k,a);c=!0;break}}if(d.inputs)for(k=0,m=d.inputs.length;k<m;++k)if(t=d.inputs[k],n=d.getConnectionPos(!0,
k),s(a.canvasX,a.canvasY,n[0]-15,n[1]-10,30,20)){if(p){if(d.onInputDblClick)d.onInputDblClick(k,a)}else if(d.onInputClick)d.onInputClick(k,a);if(null!==t.link){c=this.graph.links[t.link];d.disconnectInput(k);if(this.allow_reconnect_links||a.shiftKey)this.connecting_node=this.graph._nodes_by_id[c.origin_id],this.connecting_slot=c.origin_slot,this.connecting_output=this.connecting_node.outputs[this.connecting_slot],this.connecting_pos=this.connecting_node.getConnectionPos(!1,this.connecting_slot);c=
this.dirty_bgcanvas=!0}}}if(!c){k=!1;if(m=this.processNodeWidgets(d,this.canvas_mouse,a))k=!0,this.node_widget=[d,m];if(p&&this.selected_nodes[d.id]){if(d.onDblClick)d.onDblClick(a,[a.canvasX-d.pos[0],a.canvasY-d.pos[1]],this);this.processNodeDblClicked(d);k=!0}d.onMouseDown&&d.onMouseDown(a,[a.canvasX-d.pos[0],a.canvasY-d.pos[1]],this)?k=!0:this.live_mode&&(k=g=!0);k||(this.allow_dragnodes&&(this.node_dragged=d),this.selected_nodes[d.id]||this.processNodeSelected(d,a));this.dirty_canvas=!0}}else{if(!this.read_only)for(k=
0;k<this.visible_links.length;++k)if(d=this.visible_links[k],(g=d._pos)&&!(a.canvasX<g[0]-4||a.canvasX>g[0]+4||a.canvasY<g[1]-4||a.canvasY>g[1]+4)){this.showLinkMenu(d,a);break}this.selected_group=this.graph.getGroupOnPos(a.canvasX,a.canvasY);this.selected_group_resizing=!1;this.selected_group&&!this.read_only&&(a.ctrlKey&&(this.dragging_rectangle=null),10>y([a.canvasX,a.canvasY],[this.selected_group.pos[0]+this.selected_group.size[0],this.selected_group.pos[1]+this.selected_group.size[1]])*this.ds.scale?
this.selected_group_resizing=!0:this.selected_group.recomputeInsideNodes());p&&!this.read_only&&this.showSearchBox(a);g=!0}!c&&g&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&(this.read_only||this.processContextMenu(d,a));this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=e.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&
...
this.node_over.onMouseLeave)this.node_over.onMouseLeave(a);this.node_over=null;this.dirty_canvas=!0}if(c){if(!c.mouseOver&&(c.mouseOver=!0,this.node_over=c,this.dirty_canvas=!0,c.onMouseEnter))c.onMouseEnter(a);if(c.onMouseMove)c.onMouseMove(a,[a.canvasX-c.pos[0],a.canvasY-c.pos[1]],this);if(this.connecting_node&&(p=this._highlight_input||[0,0],!this.isOverNodeBox(c,a.canvasX,a.canvasY))){var g=this.isOverNodeInput(c,a.canvasX,a.canvasY,p);-1!=g&&c.inputs[g]?e.isValidConnection(this.connecting_output.type,
c.inputs[g].type)&&(this._highlight_input=p):this._highlight_input=null}this.canvas&&(s(a.canvasX,a.canvasY,c.pos[0]+c.size[0]-5,c.pos[1]+c.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor="crosshair")}else{p=null;for(b=0;b<this.visible_links.length;++b){var g=this.visible_links[b],k=g._pos;if(k&&!(a.canvasX<k[0]-4||a.canvasX>k[0]+4||a.canvasY<k[1]-4||a.canvasY>k[1]+4)){p=g;break}}p!=this.over_link_center&&(this.over_link_center=p,this.dirty_canvas=!0);this.canvas&&(this.canvas.style.cursor=
...
var c=Math.abs(this.dragging_rectangle[2]),p=Math.abs(this.dragging_rectangle[3]),g=0>this.dragging_rectangle[3]?this.dragging_rectangle[1]-p:this.dragging_rectangle[1];this.dragging_rectangle[0]=0>this.dragging_rectangle[2]?this.dragging_rectangle[0]-c:this.dragging_rectangle[0];this.dragging_rectangle[1]=g;this.dragging_rectangle[2]=c;this.dragging_rectangle[3]=p;p=[];for(g=0;g<b.length;++g)c=b[g],c.getBounding(d),w(this.dragging_rectangle,d)&&p.push(c);p.length&&this.selectNodes(p)}this.dragging_rectangle=
...
null!=a.wheelDeltaY?a.wheelDeltaY:-60*a.detail;this.adjustMouseEvent(a);var d=this.ds.scale;0<b?d*=1.1:0>b&&(d*=1/1.1);this.ds.changeScale(d,[a.localX,a.localY]);this.graph.change();a.preventDefault();return!1}};l.prototype.isOverNodeBox=function(a,b,d){var c=e.NODE_TITLE_HEIGHT;return s(b,d,a.pos[0]+2,a.pos[1]+2-c,c-4,c-4)?!0:!1};l.prototype.isOverNodeInput=function(a,b,d,e){if(a.inputs)for(var c=0,g=a.inputs.length;c<g;++c){var k=a.getConnectionPos(!0,c),m=!1;if(m=a.horizontal?s(b,d,k[0]-5,k[1]-
10,10,20):s(b,d,k[0]-10,k[1]-5,40,10))return e&&(e[0]=k[0],e[1]=k[1]),c}return-1};l.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==a.keyCode&&(b=this.dragging_canvas=!0),65==a.keyCode&&a.ctrlKey&&(this.selectNodes(),b=!0),"KeyC"==a.code&&(a.metaKey||a.ctrlKey)&&!a.shiftKey&&this.selected_nodes&&(this.copyToClipboard(),b=!0),"KeyV"!=a.code||!a.metaKey&&!a.ctrlKey||a.shiftKey||this.pasteFromClipboard(),46!=a.keyCode&&8!=a.keyCode||
"input"==a.target.localName||"textarea"==a.target.localName||(this.deleteSelectedNodes(),b=!0),this.selected_nodes)for(var d in this.selected_nodes)if(this.selected_nodes[d].onKeyDown)this.selected_nodes[d].onKeyDown(a)}else if("keyup"==a.type&&(32==a.keyCode&&(this.dragging_canvas=!1),this.selected_nodes))for(d in this.selected_nodes)if(this.selected_nodes[d].onKeyUp)this.selected_nodes[d].onKeyUp(a);this.graph.change();if(b)return a.preventDefault(),a.stopImmediatePropagation(),!1}}};l.prototype.copyToClipboard=
function(){var a={nodes:[],links:[]},b=0,d=[],e;for(e in this.selected_nodes){var c=this.selected_nodes[e];c._relative_id=b;d.push(c);b+=1}for(e=0;e<d.length;++e)if(c=d[e],a.nodes.push(c.clone().serialize()),c.inputs&&c.inputs.length)for(b=0;b<c.inputs.length;++b){var g=c.inputs[b];if(g&&null!=g.link&&(g=this.graph.links[g.link])){var k=this.graph.getNodeById(g.origin_id);k&&this.selected_nodes[k.id]&&a.links.push([k._relative_id,b,c._relative_id,g.target_slot])}}localStorage.setItem("litegrapheditor_clipboard",
JSON.stringify(a))};l.prototype.pasteFromClipboard=function(){var a=localStorage.getItem("litegrapheditor_clipboard");if(a){for(var a=JSON.parse(a),b=[],d=0;d<a.nodes.length;++d){var c=a.nodes[d],p=e.createNode(c.type);p&&(p.configure(c),p.pos[0]+=5,p.pos[1]+=5,this.graph.add(p),b.push(p))}for(d=0;d<a.links.length;++d)c=a.links[d],b[c[0]].connect(c[1],b[c[2]],c[3]);this.selectNodes(b)}};l.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=[a.canvasX,a.canvasY],d=this.graph.getNodeOnPos(b[0],
b[1]);if(d){if((d.onDropFile||d.onDropData)&&(b=a.dataTransfer.files)&&b.length)for(var e=0;e<b.length;e++){var c=a.dataTransfer.files[0],g=c.name;l.getFileExtension(g);if(d.onDropFile)d.onDropFile(c);if(d.onDropData){var k=new FileReader;k.onload=function(a){d.onDropData(a.target.result,g,c)};var m=c.type.split("/")[0];"text"==m||""==m?k.readAsText(c):"image"==m?k.readAsDataURL(c):k.readAsArrayBuffer(c)}}return d.onDropItem&&d.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;
...
l.prototype.processNodeSelected=function(a,b){this.selectNode(a,b&&b.shiftKey);if(this.onNodeSelected)this.onNodeSelected(a)};l.prototype.processNodeDeselected=function(a){this.deselectNode(a);if(this.onNodeDeselected)this.onNodeDeselected(a)};l.prototype.selectNode=function(a,b){null==a?this.deselectAllNodes():this.selectNodes([a],b)};l.prototype.selectNodes=function(a,b){b||this.deselectAllNodes();a=a||this.graph._nodes;for(var d=0;d<a.length;++d){var e=a[d];if(!e.is_selected){if(!e.is_selected&&
e.onSelected)e.onSelected();e.is_selected=!0;this.selected_nodes[e.id]=e;if(e.inputs)for(var c=0;c<e.inputs.length;++c)this.highlighted_links[e.inputs[c].link]=!0;if(e.outputs)for(c=0;c<e.outputs.length;++c){var g=e.outputs[c];if(g.links)for(var k=0;k<g.links.length;++k)this.highlighted_links[g.links[k]]=!0}}}this.setDirty(!0)};l.prototype.deselectNode=function(a){if(a.is_selected){if(a.onDeselected)a.onDeselected();a.is_selected=!1;if(a.inputs)for(var b=0;b<a.inputs.length;++b)delete this.highlighted_links[a.inputs[b].link];
if(a.outputs)for(b=0;b<a.outputs.length;++b){var d=a.outputs[b];if(d.links)for(var e=0;e<d.links.length;++e)delete this.highlighted_links[d.links[e]]}}};l.prototype.deselectAllNodes=function(){if(this.graph){for(var a=this.graph._nodes,b=0,d=a.length;b<d;++b){var e=a[b];if(e.is_selected){if(e.onDeselected)e.onDeselected();e.is_selected=!1}}this.selected_nodes={};this.current_node=null;this.highlighted_links={};this.setDirty(!0)}};l.prototype.deleteSelectedNodes=function(){for(var a in this.selected_nodes)this.graph.remove(this.selected_nodes[a]);
this.selected_nodes={};this.current_node=null;this.highlighted_links={};this.setDirty(!0)};l.prototype.centerOnNode=function(a){this.ds.offset[0]=-a.pos[0]-0.5*a.size[0]+0.5*this.canvas.width/this.ds.scale;this.ds.offset[1]=-a.pos[1]-0.5*a.size[1]+0.5*this.canvas.height/this.ds.scale;this.setDirty(!0,!0)};l.prototype.adjustMouseEvent=function(a){if(this.canvas){var b=this.canvas.getBoundingClientRect();a.localX=a.clientX-b.left;a.localY=a.clientY-b.top}else a.localX=a.clientX,a.localY=a.clientY;a.deltaX=
...
b)};l.prototype.convertEventToCanvasOffset=function(a){var b=this.canvas.getBoundingClientRect();return this.convertCanvasToOffset([a.clientX-b.left,a.clientY-b.top])};l.prototype.bringToFront=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.push(a))};l.prototype.sendToBack=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.unshift(a))};var v=new Float32Array(4);l.prototype.computeVisibleNodes=
function(a,b){var d=b||[];d.length=0;a=a||this.graph._nodes;for(var e=0,c=a.length;e<c;++e){var g=a[e];(!this.live_mode||g.onDrawBackground||g.onDrawForeground)&&w(this.visible_area,g.getBounding(v))&&d.push(g)}return d};l.prototype.draw=function(a,b){if(this.canvas){var d=e.getTime();this.render_time=0.001*(d-this.last_draw_time);this.last_draw_time=d;this.graph&&this.ds.computeVisibleArea();(this.dirty_bgcanvas||b||this.always_render_background||this.graph&&this.graph._last_trigger_time&&1E3>d-
this.graph._last_trigger_time)&&this.drawBackCanvas();(this.dirty_canvas||a)&&this.drawFrontCanvas();this.fps=this.render_time?1/this.render_time:0;this.frame+=1}};l.prototype.drawFrontCanvas=function(){this.dirty_canvas=!1;this.ctx||(this.ctx=this.bgcanvas.getContext("2d"));var a=this.ctx;if(a){a.start2D&&a.start2D();var b=this.canvas;a.restore();a.setTransform(1,0,0,1,0,0);this.dirty_area&&(a.save(),a.beginPath(),a.rect(this.dirty_area[0],this.dirty_area[1],this.dirty_area[2],this.dirty_area[3]),
...
b.restore()}b.finish&&b.finish();this.dirty_bgcanvas=!1;this.dirty_canvas=!0};var k=new Float32Array(2);l.prototype.drawNode=function(a,b){this.current_node=a;var d=a.color||a.constructor.color||e.NODE_DEFAULT_COLOR,c=a.bgcolor||a.constructor.bgcolor||e.NODE_DEFAULT_BGCOLOR;if(this.live_mode){if(!a.flags.collapsed&&(b.shadowColor="transparent",a.onDrawForeground))a.onDrawForeground(b,this,this.canvas)}else{var p=this.editor_alpha;b.globalAlpha=p;this.render_shadows?(b.shadowColor=e.DEFAULT_SHADOW_COLOR,
b.shadowOffsetX=2*this.ds.scale,b.shadowOffsetY=2*this.ds.scale,b.shadowBlur=3*this.ds.scale):b.shadowColor="transparent";if(!a.flags.collapsed||!a.onDrawCollapsed||!0!=a.onDrawCollapsed(b,this)){var g=a._shape||e.BOX_SHAPE;k.set(a.size);var m=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var l=a.getTitle?a.getTitle():a.title;null!=l&&(a._collapsed_width=Math.min(a.size[0],b.measureText(l).width+2*e.NODE_TITLE_HEIGHT),k[0]=a._collapsed_width,k[1]=0)}a.clip_area&&(b.save(),b.beginPath(),
g==e.BOX_SHAPE?b.rect(0,0,k[0],k[1]):g==e.ROUND_SHAPE?b.roundRect(0,0,k[0],k[1],10):g==e.CIRCLE_SHAPE&&b.arc(0.5*k[0],0.5*k[1],0.5*k[0],0,2*Math.PI),b.clip());a.has_errors&&(c="red");this.drawNodeShape(a,b,k,d,c,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=m?"center":"left";b.font=this.inner_text_font;c=0.6<this.ds.scale;g=this.connecting_output;b.lineWidth=1;var l=0,t=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(d=
0;d<a.inputs.length;d++){var n=a.inputs[d];b.globalAlpha=p;this.connecting_node&&!e.isValidConnection(n.type,g.type)&&(b.globalAlpha=0.4*p);b.fillStyle=null!=n.link?n.color_on||this.default_connection_color.input_on:n.color_off||this.default_connection_color.input_off;var h=a.getConnectionPos(!0,d,t);h[0]-=a.pos[0];h[1]-=a.pos[1];l<h[1]+0.5*e.NODE_SLOT_HEIGHT&&(l=h[1]+0.5*e.NODE_SLOT_HEIGHT);b.beginPath();n.type===e.EVENT||n.shape===e.BOX_SHAPE?m?b.rect(h[0]-5+0.5,h[1]-8+0.5,10,14):b.rect(h[0]-6+
0.5,h[1]-5+0.5,14,10):n.shape===e.ARROW_SHAPE?(b.moveTo(h[0]+8,h[1]+0.5),b.lineTo(h[0]-4,h[1]+6+0.5),b.lineTo(h[0]-4,h[1]-6+0.5),b.closePath()):b.arc(h[0],h[1],4,0,2*Math.PI);b.fill();if(c){var f=null!=n.label?n.label:n.name;f&&(b.fillStyle=e.NODE_TEXT_COLOR,m||n.dir==e.UP?b.fillText(f,h[0],h[1]-10):b.fillText(f,h[0]+10,h[1]+5))}}this.connecting_node&&(b.globalAlpha=0.4*p);b.textAlign=m?"center":"right";b.strokeStyle="black";if(a.outputs)for(d=0;d<a.outputs.length;d++)if(n=a.outputs[d],h=a.getConnectionPos(!1,
d,t),h[0]-=a.pos[0],h[1]-=a.pos[1],l<h[1]+0.5*e.NODE_SLOT_HEIGHT&&(l=h[1]+0.5*e.NODE_SLOT_HEIGHT),b.fillStyle=n.links&&n.links.length?n.color_on||this.default_connection_color.output_on:n.color_off||this.default_connection_color.output_off,b.beginPath(),n.type===e.EVENT||n.shape===e.BOX_SHAPE?m?b.rect(h[0]-5+0.5,h[1]-8+0.5,10,14):b.rect(h[0]-6+0.5,h[1]-5+0.5,14,10):n.shape===e.ARROW_SHAPE?(b.moveTo(h[0]+8,h[1]+0.5),b.lineTo(h[0]-4,h[1]+6+0.5),b.lineTo(h[0]-4,h[1]-6+0.5),b.closePath()):b.arc(h[0],
h[1],4,0,2*Math.PI),b.fill(),b.stroke(),c&&(f=null!=n.label?n.label:n.name))b.fillStyle=e.NODE_TEXT_COLOR,m||n.dir==e.DOWN?b.fillText(f,h[0],h[1]-8):b.fillText(f,h[0]-10,h[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){if(m||a.widgets_up)l=2;this.drawNodeWidgets(a,l,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){p=c=null;if(a.inputs)for(d=0;d<a.inputs.length;d++)if(n=a.inputs[d],null!=n.link){c=n;break}if(a.outputs)for(d=0;d<a.outputs.length;d++)n=
a.outputs[d],n.links&&n.links.length&&(p=n);c&&(d=0,c=-0.5*e.NODE_TITLE_HEIGHT,m&&(d=0.5*a._collapsed_width,c=-e.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),n.type===e.EVENT||n.shape===e.BOX_SHAPE?b.rect(d-7+0.5,c-4,14,8):n.shape===e.ARROW_SHAPE?(b.moveTo(d+8,c),b.lineTo(d+-4,c-4),b.lineTo(d+-4,c+4),b.closePath()):b.arc(d,c,4,0,2*Math.PI),b.fill());p&&(d=a._collapsed_width,c=-0.5*e.NODE_TITLE_HEIGHT,m&&(d=0.5*a._collapsed_width,c=0),b.fillStyle="#686",b.strokeStyle="black",b.beginPath(),n.type===
e.EVENT||n.shape===e.BOX_SHAPE?b.rect(d-7+0.5,c-4,14,8):n.shape===e.ARROW_SHAPE?(b.moveTo(d+6,c),b.lineTo(d-6,c-4),b.lineTo(d-6,c+4),b.closePath()):b.arc(d,c,4,0,2*Math.PI),b.fill())}a.clip_area&&b.restore();b.globalAlpha=1}}};l.prototype.drawLinkTooltip=function(a,b){var d=b._pos;a.fillStyle="black";a.beginPath();a.arc(d[0],d[1],3,0,2*Math.PI);a.fill();if(null!=b.data&&(!this.onDrawLinkTooltip||!0!=this.onDrawLinkTooltip(a,b,this))){var e=b.data,c=null,c=e.constructor===Number?e.toFixed(2):e.constructor===
...
var m=new Float32Array(4);l.prototype.drawNodeShape=function(a,b,d,c,p,g,k){b.strokeStyle=c;b.fillStyle=p;p=e.NODE_TITLE_HEIGHT;var n=0.5>this.ds.scale,t=a._shape||a.constructor.shape||e.ROUND_SHAPE,h=a.constructor.title_mode,f=!0;h==e.TRANSPARENT_TITLE?f=!1:h==e.AUTOHIDE_TITLE&&k&&(f=!0);m[0]=0;m[1]=f?-p:0;m[2]=d[0]+1;m[3]=f?d[1]+p:d[1];k=b.globalAlpha;b.beginPath();t==e.BOX_SHAPE||n?b.fillRect(m[0],m[1],m[2],m[3]):t==e.ROUND_SHAPE||t==e.CARD_SHAPE?b.roundRect(m[0],m[1],m[2],m[3],this.round_radius,
t==e.CARD_SHAPE?0:this.round_radius):t==e.CIRCLE_SHAPE&&b.arc(0.5*d[0],0.5*d[1],0.5*d[0],0,2*Math.PI);b.fill();a.flags.collapsed||(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,m[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas);if(f||h==e.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,p,d,this.ds.scale,c);else if(h!=e.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){f=a.constructor.title_color||
c;a.flags.collapsed&&(b.shadowColor=e.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var s=l.gradients[f];s||(s=l.gradients[f]=b.createLinearGradient(0,0,400,0),s.addColorStop(0,f),s.addColorStop(1,"#000"));b.fillStyle=s}else b.fillStyle=f;b.beginPath();t==e.BOX_SHAPE||n?b.rect(0,-p,d[0]+1,p):t!=e.ROUND_SHAPE&&t!=e.CARD_SHAPE||b.roundRect(0,-p,d[0]+1,p,this.round_radius,a.flags.collapsed?this.round_radius:0);b.fill();b.shadowColor="transparent"}if(a.onDrawTitleBox)a.onDrawTitleBox(b,p,d,this.ds.scale);
else t==e.ROUND_SHAPE||t==e.CIRCLE_SHAPE||t==e.CARD_SHAPE?(n&&(b.fillStyle="black",b.beginPath(),b.arc(0.5*p,-0.5*p,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||e.NODE_DEFAULT_BOXCOLOR,b.beginPath(),b.arc(0.5*p,-0.5*p,5,0,2*Math.PI),b.fill()):(n&&(b.fillStyle="black",b.fillRect(0.5*(p-10)-1,-0.5*(p+10)-1,12,12)),b.fillStyle=a.boxcolor||e.NODE_DEFAULT_BOXCOLOR,b.fillRect(0.5*(p-10),-0.5*(p+10),10,10));b.globalAlpha=k;if(a.onDrawTitleText)a.onDrawTitleText(b,p,d,this.ds.scale,this.title_text_font,
g);!n&&(b.font=this.title_text_font,n=a.getTitle())&&(b.fillStyle=g?"white":a.constructor.title_text_color||this.node_title_color,a.flags.collapsed?(b.textAlign="center",k=b.measureText(n),b.fillText(n,p+0.5*k.width,e.NODE_TITLE_TEXT_Y-p),b.textAlign="left"):(b.textAlign="left",b.fillText(n,p,e.NODE_TITLE_TEXT_Y-p)));if(a.onDrawTitle)a.onDrawTitle(b)}if(g){if(a.onBounding)a.onBounding(m);h==e.TRANSPARENT_TITLE&&(m[1]-=p,m[3]+=p);b.lineWidth=1;b.globalAlpha=0.8;b.beginPath();t==e.BOX_SHAPE?b.rect(-6+
m[0],-6+m[1],12+m[2],12+m[3]):t==e.ROUND_SHAPE||t==e.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+m[0],-6+m[1],12+m[2],12+m[3],2*this.round_radius):t==e.CARD_SHAPE?b.roundRect(-6+m[0],-6+m[1],12+m[2],12+m[3],2*this.round_radius,2):t==e.CIRCLE_SHAPE&&b.arc(0.5*d[0],0.5*d[1],0.5*d[0]+6,0,2*Math.PI);b.strokeStyle="#FFF";b.stroke();b.strokeStyle=c;b.globalAlpha=1}};var D=new Float32Array(4),g=new Float32Array(4),t=new Float32Array(2),n=new Float32Array(2);l.prototype.drawConnections=function(a){var b=
e.getTime(),d=this.visible_area;D[0]=d[0]-20;D[1]=d[1]-20;D[2]=d[2]+40;D[3]=d[3]+40;a.lineWidth=this.connections_width;a.fillStyle="#AAA";a.strokeStyle="#AAA";a.globalAlpha=this.editor_alpha;for(var d=this.graph._nodes,c=0,p=d.length;c<p;++c){var k=d[c];if(k.inputs&&k.inputs.length)for(var m=0;m<k.inputs.length;++m){var l=k.inputs[m];if(l&&null!=l.link&&(l=this.graph.links[l.link])){var h=this.graph.getNodeById(l.origin_id);if(null!=h){var f=l.origin_slot,s=null,s=-1==f?[h.pos[0]+10,h.pos[1]+10]:
h.getConnectionPos(!1,f,t),v=k.getConnectionPos(!0,m,n);g[0]=s[0];g[1]=s[1];g[2]=v[0]-s[0];g[3]=v[1]-s[1];0>g[2]&&(g[0]+=g[2],g[2]=Math.abs(g[2]));0>g[3]&&(g[1]+=g[3],g[3]=Math.abs(g[3]));if(w(g,D)){var B=h.outputs[f],f=k.inputs[m];if(B&&f&&(h=B.dir||(h.horizontal?e.DOWN:e.RIGHT),f=f.dir||(k.horizontal?e.UP:e.LEFT),this.renderLink(a,s,v,l,!1,0,null,h,f),l&&l._last_time&&1E3>b-l._last_time)){var B=2-0.002*(b-l._last_time),J=a.globalAlpha;a.globalAlpha=J*B;this.renderLink(a,s,v,l,!0,B,"white",h,f);
a.globalAlpha=J}}}}}}a.globalAlpha=1};l.prototype.renderLink=function(a,b,d,c,p,g,k,m,n,t){c&&this.visible_links.push(c);!k&&c&&(k=c.color||l.link_type_colors[c.type]);k||(k=this.default_link_color);null!=c&&this.highlighted_links[c.id]&&(k="#FFF");m=m||e.RIGHT;n=n||e.LEFT;var h=y(b,d);this.render_connections_border&&0.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";t=t||1;1<t&&(a.lineWidth=0.5);a.beginPath();for(var f=0;f<t;f+=1){var B=5*(f-0.5*(t-1));if(this.links_render_mode==
e.SPLINE_LINK){a.moveTo(b[0],b[1]+B);var s=0,v=0,q=0,w=0;switch(m){case e.LEFT:s=-0.25*h;break;case e.RIGHT:s=0.25*h;break;case e.UP:v=-0.25*h;break;case e.DOWN:v=0.25*h}switch(n){case e.LEFT:q=-0.25*h;break;case e.RIGHT:q=0.25*h;break;case e.UP:w=-0.25*h;break;case e.DOWN:w=0.25*h}a.bezierCurveTo(b[0]+s,b[1]+v+B,d[0]+q,d[1]+w+B,d[0],d[1]+B)}else if(this.links_render_mode==e.LINEAR_LINK){a.moveTo(b[0],b[1]+B);w=q=v=s=0;switch(m){case e.LEFT:s=-1;break;case e.RIGHT:s=1;break;case e.UP:v=-1;break;case e.DOWN:v=
1}switch(n){case e.LEFT:q=-1;break;case e.RIGHT:q=1;break;case e.UP:w=-1;break;case e.DOWN:w=1}a.lineTo(b[0]+15*s,b[1]+15*v+B);a.lineTo(d[0]+15*q,d[1]+15*w+B);a.lineTo(d[0],d[1]+B)}else if(this.links_render_mode==e.STRAIGHT_LINK)a.moveTo(b[0],b[1]),B=b[0],s=b[1],v=d[0],q=d[1],m==e.RIGHT?B+=10:s+=10,n==e.LEFT?v-=10:q-=10,a.lineTo(B,s),a.lineTo(0.5*(B+v),s),a.lineTo(0.5*(B+v),q),a.lineTo(v,q),a.lineTo(d[0],d[1]);else return}this.render_connections_border&&0.6<this.ds.scale&&!p&&(a.strokeStyle="rgba(0,0,0,0.5)",
a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=k;a.stroke();p=this.computeConnectionPoint(b,d,0.5,m,n);c&&c._pos&&(c._pos[0]=p[0],c._pos[1]=p[1]);0.6<=this.ds.scale&&this.highquality_render&&n!=e.CENTER&&(this.render_connection_arrows&&(f=this.computeConnectionPoint(b,d,0.25,m,n),c=this.computeConnectionPoint(b,d,0.26,m,n),t=this.computeConnectionPoint(b,d,0.75,m,n),h=this.computeConnectionPoint(b,d,0.76,m,n),s=B=0,this.render_curved_connections?(B=-Math.atan2(c[0]-f[0],
c[1]-f[1]),s=-Math.atan2(h[0]-t[0],h[1]-t[1])):s=B=d[1]>b[1]?0:Math.PI,a.save(),a.translate(f[0],f[1]),a.rotate(B),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(t[0],t[1]),a.rotate(s),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(p[0],p[1],5,0,2*Math.PI),a.fill());if(g)for(a.fillStyle=k,f=0;5>f;++f)g=(0.001*e.getTime()+0.2*f)%1,p=this.computeConnectionPoint(b,d,g,m,n),a.beginPath(),a.arc(p[0],
p[1],5,0,2*Math.PI),a.fill()};l.prototype.computeConnectionPoint=function(a,b,d,c,p){c=c||e.RIGHT;p=p||e.LEFT;var g=y(a,b),k=[a[0],a[1]],m=[b[0],b[1]];switch(c){case e.LEFT:k[0]+=-0.25*g;break;case e.RIGHT:k[0]+=0.25*g;break;case e.UP:k[1]+=-0.25*g;break;case e.DOWN:k[1]+=0.25*g}switch(p){case e.LEFT:m[0]+=-0.25*g;break;case e.RIGHT:m[0]+=0.25*g;break;case e.UP:m[1]+=-0.25*g;break;case e.DOWN:m[1]+=0.25*g}c=(1-d)*(1-d)*(1-d);p=3*(1-d)*(1-d)*d;g=3*(1-d)*d*d;d*=d*d;return[c*a[0]+p*k[0]+g*m[0]+d*b[0],
c*a[1]+p*k[1]+g*m[1]+d*b[1]]};l.prototype.drawExecutionOrder=function(a){a.shadowColor="transparent";a.globalAlpha=0.25;a.textAlign="center";a.strokeStyle="white";a.globalAlpha=0.75;for(var b=this.visible_nodes,d=0;d<b.length;++d){var c=b[d];a.fillStyle="black";a.fillRect(c.pos[0]-e.NODE_TITLE_HEIGHT,c.pos[1]-e.NODE_TITLE_HEIGHT,e.NODE_TITLE_HEIGHT,e.NODE_TITLE_HEIGHT);0==c.order&&a.strokeRect(c.pos[0]-e.NODE_TITLE_HEIGHT+0.5,c.pos[1]-e.NODE_TITLE_HEIGHT+0.5,e.NODE_TITLE_HEIGHT,e.NODE_TITLE_HEIGHT);
a.fillStyle="#FFF";a.fillText(c.order,c.pos[0]+-0.5*e.NODE_TITLE_HEIGHT,c.pos[1]-6)}a.globalAlpha=1};l.prototype.drawNodeWidgets=function(a,b,d,c){if(!a.widgets||!a.widgets.length)return 0;var g=a.size[0],k=a.widgets;b+=2;var m=e.NODE_WIDGET_HEIGHT,l=0.5<this.ds.scale;d.save();d.globalAlpha=this.editor_alpha;for(var n=e.WIDGET_OUTLINE_COLOR,t=e.WIDGET_BGCOLOR,h=e.WIDGET_TEXT_COLOR,f=e.WIDGET_SECONDARY_TEXT_COLOR,B=0;B<k.length;++B){var s=k[B],v=b;s.y&&(v=s.y);s.last_y=v;d.strokeStyle=n;d.fillStyle=
"#222";d.textAlign="left";switch(s.type){case "button":s.clicked&&(d.fillStyle="#AAA",s.clicked=!1,this.dirty_canvas=!0);d.fillRect(15,v,g-30,m);d.strokeRect(15,v,g-30,m);l&&(d.textAlign="center",d.fillStyle=h,d.fillText(s.name,0.5*g,v+0.7*m));break;case "toggle":d.textAlign="left";d.strokeStyle=n;d.fillStyle=t;d.beginPath();d.roundRect(15,b,g-30,m,0.5*m);d.fill();d.stroke();d.fillStyle=s.value?"#89A":"#333";d.beginPath();d.arc(g-30,v+0.5*m,0.36*m,0,2*Math.PI);d.fill();l&&(d.fillStyle=f,null!=s.name&&
d.fillText(s.name,30,v+0.7*m),d.fillStyle=s.value?h:f,d.textAlign="right",d.fillText(s.value?s.options.on||"true":s.options.off||"false",g-40,v+0.7*m));break;case "slider":d.fillStyle=t;d.fillRect(15,v,g-30,m);var q=s.options.max-s.options.min,w=(s.value-s.options.min)/q;d.fillStyle=c==s?"#89A":"#678";d.fillRect(15,v,w*(g-30),m);d.strokeRect(15,v,g-30,m);s.marker&&(q=(s.marker-s.options.min)/q,d.fillStyle="#AA9",d.fillRect(15+q*(g-30),v,2,m));l&&(d.textAlign="center",d.fillStyle=h,d.fillText(s.name+
"  "+Number(s.value).toFixed(3),0.5*g,v+0.7*m));break;case "number":case "combo":d.textAlign="left";d.strokeStyle=n;d.fillStyle=t;d.beginPath();d.roundRect(15,b,g-30,m,0.5*m);d.fill();d.stroke();l&&(d.fillStyle=h,d.beginPath(),d.moveTo(31,b+5),d.lineTo(21,b+0.5*m),d.lineTo(31,b+m-5),d.moveTo(g-15-16,b+5),d.lineTo(g-15-6,b+0.5*m),d.lineTo(g-15-16,b+m-5),d.fill(),d.fillStyle=f,d.fillText(s.name,35,v+0.7*m),d.fillStyle=h,d.textAlign="right","number"==s.type?d.fillText(Number(s.value).toFixed(void 0!==
s.options.precision?s.options.precision:3),g-30-20,v+0.7*m):d.fillText(s.value,g-30-20,v+0.7*m));break;case "string":case "text":d.textAlign="left";d.strokeStyle=n;d.fillStyle=t;d.beginPath();d.roundRect(15,b,g-30,m,0.5*m);d.fill();d.stroke();l&&(d.fillStyle=f,null!=s.name&&d.fillText(s.name,30,v+0.7*m),d.fillStyle=h,d.textAlign="right",d.fillText(s.value,g-30,v+0.7*m));break;default:s.draw&&s.draw(d,a,s,v,m)}b+=m+4}d.restore()};l.prototype.processNodeWidgets=function(a,b,d,c){function g(e,c){e.value=
c;e.property&&void 0!==a.properties[e.property]&&(a.properties[e.property]=c);e.callback&&e.callback(e.value,n,a,b,d)}if(!a.widgets||!a.widgets.length)return null;for(var k=b[0]-a.pos[0],m=b[1]-a.pos[1],l=a.size[0],n=this,t=this.getCanvasWindow(),h=0;h<a.widgets.length;++h){var f=a.widgets[h];if(f==c||6<k&&k<l-12&&m>f.last_y&&m<f.last_y+e.NODE_WIDGET_HEIGHT){switch(f.type){case "button":if("mousemove"===d.type)break;f.callback&&setTimeout(function(){f.callback(f,n,a,b)},20);this.dirty_canvas=f.clicked=
!0;break;case "slider":t=Math.clamp((k-10)/(l-20),0,1);f.value=f.options.min+(f.options.max-f.options.min)*t;f.callback&&setTimeout(function(){g(f,f.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":if("mousemove"==d.type&&"number"==f.type)f.value+=0.1*d.deltaX*(f.options.step||1),null!=f.options.min&&f.value<f.options.min&&(f.value=f.options.min),null!=f.options.max&&f.value>f.options.max&&(f.value=f.options.max);else if("mousedown"==d.type)if((c=f.options.values)&&c.constructor===
Function&&(c=f.options.values(f,a)),k=40>k?-1:k>l-40?1:0,"number"==f.type)f.value+=0.1*k*(f.options.step||1),null!=f.options.min&&f.value<f.options.min&&(f.value=f.options.min),null!=f.options.max&&f.value>f.options.max&&(f.value=f.options.max);else if(k)t=c.indexOf(f.value)+k,t>=c.length&&(t=0),0>t&&(t=c.length-1),f.value=c[t];else{new e.ContextMenu(c,{scale:Math.max(1,this.ds.scale),event:d,className:"dark",callback:B.bind(f)},t);var B=function(a,b,d){this.value=a;g(this,a);n.dirty_canvas=!0;return!1}}setTimeout(function(){g(this,
this.value)}.bind(f),20);this.dirty_canvas=!0;break;case "toggle":"mousedown"==d.type&&(f.value=!f.value,f.callback&&setTimeout(function(){g(f,f.value)},20));break;case "string":case "text":"mousedown"==d.type&&this.prompt("Value",f.value,function(a){this.value=a;g(this,a)}.bind(f),d);break;default:f.mouse&&f.mouse(ctx,d,[k,m],a)}return f}}return null};l.prototype.drawGroups=function(a,b){if(this.graph){var d=this.graph._groups;b.save();b.globalAlpha=0.5*this.editor_alpha;for(var c=0;c<d.length;++c){var g=
d[c];if(w(this.visible_area,g._bounding)){b.fillStyle=g.color||"#335";b.strokeStyle=g.color||"#335";var k=g._pos,m=g._size;b.globalAlpha=0.25*this.editor_alpha;b.beginPath();b.rect(k[0]+0.5,k[1]+0.5,m[0],m[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(k[0]+m[0],k[1]+m[1]);b.lineTo(k[0]+m[0]-10,k[1]+m[1]);b.lineTo(k[0]+m[0],k[1]+m[1]-10);b.fill();m=g.font_size||e.DEFAULT_GROUP_FONT_SIZE;b.font=m+"px Arial";b.fillText(g.title,k[0]+4,k[1]+m)}}b.restore()}};l.prototype.adjustNodesSize=
function(){for(var a=this.graph._nodes,b=0;b<a.length;++b)a[b].size=a[b].computeSize();this.setDirty(!0,!0)};l.prototype.resize=function(a,b){if(!a&&!b){var d=this.canvas.parentNode;a=d.offsetWidth;b=d.offsetHeight}if(this.canvas.width!=a||this.canvas.height!=b)this.canvas.width=a,this.canvas.height=b,this.bgcanvas.width=this.canvas.width,this.bgcanvas.height=this.canvas.height,this.setDirty(!0,!0)};l.prototype.switchLiveMode=function(a){if(a){var b=this,d=this.live_mode?1.1:0.9;this.live_mode&&(this.live_mode=
!1,this.editor_alpha=0.1);var e=setInterval(function(){b.editor_alpha*=d;b.dirty_canvas=!0;b.dirty_bgcanvas=!0;1>d&&0.01>b.editor_alpha&&(clearInterval(e),1>d&&(b.live_mode=!0));1<d&&0.99<b.editor_alpha&&(clearInterval(e),b.editor_alpha=1)},1)}else this.live_mode=!this.live_mode,this.dirty_bgcanvas=this.dirty_canvas=!0};l.prototype.onNodeSelectionChange=function(a){};l.prototype.touchHandler=function(a){var b=a.changedTouches[0],d="";switch(a.type){case "touchstart":d="mousedown";break;case "touchmove":d=
"mousemove";break;case "touchend":d="mouseup";break;default:return}var e=this.getCanvasWindow(),c=e.document.createEvent("MouseEvent");c.initMouseEvent(d,!0,!0,e,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,!1,!1,!1,0,null);b.target.dispatchEvent(c);a.preventDefault()};l.onGroupAdd=function(a,b,d){a=l.active_canvas;a.getCanvasWindow();b=new e.LGraphGroup;b.pos=a.convertEventToCanvasOffset(d);a.graph.add(b)};l.onMenuAdd=function(a,b,d,c){function g(a,b){var d=c.getFirstEvent(),p=e.createNode(a.value);
p&&(p.pos=k.convertEventToCanvasOffset(d),k.graph.add(p))}var k=l.active_canvas,m=k.getCanvasWindow();a=e.getNodeTypesCategories(k.filter);b=[];for(var n in a)a[n]&&b.push({value:a[n],content:a[n],has_submenu:!0});var f=new e.ContextMenu(b,{event:d,callback:function(a,b,d){a=e.getNodeTypesInCategory(a.value,k.filter);b=[];for(var c in a)a[c].skip_list||b.push({content:a[c].title,value:a[c].type});new e.ContextMenu(b,{event:d,callback:g,parentMenu:f},m);return!1},parentMenu:c},m);return!1};l.onMenuCollapseAll=
function(){};l.onMenuNodeEdit=function(){};l.showMenuNodeOptionalInputs=function(a,b,d,c,g){function k(a,b,d){g&&(a.callback&&a.callback.call(m,g,a,b,d),a.value&&(g.addInput(a.value[0],a.value[1],a.value[2]),g.setDirtyCanvas(!0,!0)))}if(g){var m=this;a=l.active_canvas.getCanvasWindow();b=g.optional_inputs;g.onGetInputs&&(b=g.onGetInputs());var n=[];if(b)for(var f in b){var t=b[f];if(t){var h=t[0];t[2]&&t[2].label&&(h=t[2].label);h={content:h,value:t};t[1]==e.ACTION&&(h.className="event");n.push(h)}else n.push(null)}this.onMenuNodeInputs&&
(n=this.onMenuNodeInputs(n));if(n.length)return new e.ContextMenu(n,{event:d,callback:k,parentMenu:c,node:g},a),!1}};l.showMenuNodeOptionalOutputs=function(a,b,d,c,g){function k(a,b,d){if(g&&(a.callback&&a.callback.call(m,g,a,b,d),a.value))if(d=a.value[1],!d||d.constructor!==Object&&d.constructor!==Array)g.addOutput(a.value[0],a.value[1],a.value[2]),g.setDirtyCanvas(!0,!0);else{a=[];for(var n in d)a.push({content:n,value:d[n]});new e.ContextMenu(a,{event:b,callback:k,parentMenu:c,node:g});return!1}}
if(g){var m=this;a=l.active_canvas.getCanvasWindow();b=g.optional_outputs;g.onGetOutputs&&(b=g.onGetOutputs());var n=[];if(b)for(var f in b){var t=b[f];if(!t)n.push(null);else if(!g.flags||!g.flags.skip_repeated_outputs||-1==g.findOutputSlot(t[0])){var h=t[0];t[2]&&t[2].label&&(h=t[2].label);h={content:h,value:t};t[1]==e.EVENT&&(h.className="event");n.push(h)}}this.onMenuNodeOutputs&&(n=this.onMenuNodeOutputs(n));if(n.length)return new e.ContextMenu(n,{event:d,callback:k,parentMenu:c,node:g},a),!1}};
l.onShowMenuNodeProperties=function(a,b,d,c,g){function k(a,b,d,e){g&&(b=this.getBoundingClientRect(),m.showEditPropertyValue(g,a.value,{position:[b.left,b.top]}))}if(g&&g.properties){var m=l.active_canvas;b=m.getCanvasWindow();var n=[],f;for(f in g.properties)a=void 0!==g.properties[f]?g.properties[f]:" ",a=l.decodeHTML(a),n.push({content:"<span class='property_name'>"+f+"</span><span class='property_value'>"+a+"</span>",value:f});if(n.length)return new e.ContextMenu(n,{event:d,callback:k,parentMenu:c,
allow_html:!0,node:g},b),!1}};l.decodeHTML=function(a){var b=document.createElement("div");b.innerText=a;return b.innerHTML};l.onResizeNode=function(a,b,d,e,c){c&&(c.size=c.computeSize(),c.setDirtyCanvas(!0,!0))};l.prototype.showLinkMenu=function(a,b){var d=this;console.log(a.data);new e.ContextMenu(["Delete"],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b){switch(b){case "Delete":d.graph.removeLink(a.id)}}});return!1};l.onShowPropertyEditor=function(a,b,d,e,c){function g(){var b=
n.value;"Number"==a.type?b=Number(b):"Boolean"==a.type&&(b=Boolean(b));c[k]=b;m.parentNode&&m.parentNode.removeChild(m);c.setDirtyCanvas(!0,!0)}var k=a.property||"title";b=c[k];var m=document.createElement("div");m.className="graphdialog";m.innerHTML="<span class='name'></span><input autofocus type='text' class='value'/><button>OK</button>";m.querySelector(".name").innerText=k;var n=m.querySelector("input");n&&(n.value=b,n.addEventListener("blur",function(a){this.focus()}),n.addEventListener("keydown",
function(a){13==a.keyCode&&(g(),a.preventDefault(),a.stopPropagation())}));b=l.active_canvas.canvas;d=b.getBoundingClientRect();var f=e=-20;d&&(e-=d.left,f-=d.top);event?(m.style.left=event.clientX+e+"px",m.style.top=event.clientY+f+"px"):(m.style.left=0.5*b.width+e+"px",m.style.top=0.5*b.height+f+"px");m.querySelector("button").addEventListener("click",g);b.parentNode.appendChild(m)};l.prototype.prompt=function(a,b,d,e){var c=this;a=a||"";var g=!1,k=document.createElement("div");k.className="graphdialog rounded";
k.innerHTML="<span class='name'></span> <input autofocus type='text' class='value'/><button class='rounded'>OK</button>";k.close=function(){c.prompt_box=null;k.parentNode&&k.parentNode.removeChild(k)};1<this.ds.scale&&(k.style.transform="scale("+this.ds.scale+")");k.addEventListener("mouseleave",function(a){g||k.close()});c.prompt_box&&c.prompt_box.close();c.prompt_box=k;k.querySelector(".name").innerText=a;k.querySelector(".value").value=b;var m=k.querySelector("input");m.addEventListener("keydown",
function(a){g=!0;if(27==a.keyCode)k.close();else if(13==a.keyCode)d&&d(this.value),k.close();else return;a.preventDefault();a.stopPropagation()});k.querySelector("button").addEventListener("click",function(a){d&&d(m.value);c.setDirty(!0);k.close()});a=l.active_canvas.canvas;b=a.getBoundingClientRect();var n=-20,f=-20;b&&(n-=b.left,f-=b.top);e?(k.style.left=e.clientX+n+"px",k.style.top=e.clientY+f+"px"):(k.style.left=0.5*a.width+n+"px",k.style.top=0.5*a.height+f+"px");a.parentNode.appendChild(k);setTimeout(function(){m.focus()},
10);return k};l.search_limit=-1;l.prototype.showSearchBox=function(a){function b(b){if(b)if(g.onSearchBoxSelection)g.onSearchBoxSelection(b,a,B);else{var d=e.searchbox_extras[b.toLowerCase()];d&&(b=d.type);if(b=e.createNode(b))b.pos=B.convertEventToCanvasOffset(a),B.graph.add(b);if(d&&d.data){if(d.data.properties)for(var c in d.data.properties)b.addProperty(c,d.data.properties[c]);if(d.data.inputs)for(c in b.inputs=[],d.data.inputs)b.addOutput(d.data.inputs[c][0],d.data.inputs[c][1]);if(d.data.outputs)for(c in b.outputs=
[],d.data.outputs)b.addOutput(d.data.outputs[c][0],d.data.outputs[c][1]);d.data.title&&(b.title=d.data.title);d.data.json&&b.configure(d.data.json)}}k.close()}function d(a){var b=h;h&&h.classList.remove("selected");h?(h=a?h.nextSibling:h.previousSibling)||(h=b):h=a?n.childNodes[0]:n.childNodes[n.childNodes.length];h&&(h.classList.add("selected"),h.scrollIntoView())}function c(){function a(d,e){var c=document.createElement("div");f||(f=d);c.innerText=d;c.dataset.type=escape(d);c.className="litegraph lite-search-item";
e&&(c.className+=" "+e);c.addEventListener("click",function(a){b(unescape(this.dataset.type))});n.appendChild(c)}t=null;var d=s.value;f=null;n.innerHTML="";if(d)if(g.onSearchBox){var k=g.onSearchBox(n,d,B);if(k)for(var m=0;m<k.length;++m)a(k[m])}else{k=0;d=d.toLowerCase();for(m in e.searchbox_extras){var h=e.searchbox_extras[m];if(-1!==h.desc.toLowerCase().indexOf(d)&&(a(h.desc,"searchbox_extra"),-1!==l.search_limit&&k++>l.search_limit))break}if(Array.prototype.filter)for(h=Object.keys(e.registered_node_types).filter(function(a){return-1!==
a.toLowerCase().indexOf(d)}),m=0;m<h.length&&!(a(h[m]),-1!==l.search_limit&&k++>l.search_limit);m++);else for(m in e.registered_node_types)if(-1!=m.indexOf(d)&&(a(m),-1!==l.search_limit&&k++>l.search_limit))break}}var g=this,k=document.createElement("div");k.className="litegraph litesearchbox graphdialog rounded";k.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";k.close=function(){g.search_box=null;document.body.focus();setTimeout(function(){g.canvas.focus()},
20);k.parentNode&&k.parentNode.removeChild(k)};var m=null;1<this.ds.scale&&(k.style.transform="scale("+this.ds.scale+")");k.addEventListener("mouseenter",function(a){m&&(clearTimeout(m),m=null)});k.addEventListener("mouseleave",function(a){m=setTimeout(function(){k.close()},500)});g.search_box&&g.search_box.close();g.search_box=k;var n=k.querySelector(".helper"),f=null,t=null,h=null,s=k.querySelector("input");s&&(s.addEventListener("blur",function(a){this.focus()}),s.addEventListener("keydown",function(a){if(38==
a.keyCode)d(!1);else if(40==a.keyCode)d(!0);else if(27==a.keyCode)k.close();else if(13==a.keyCode)h?b(h.innerHTML):f?b(f):k.close();else{t&&clearInterval(t);t=setTimeout(c,10);return}a.preventDefault();a.stopPropagation()}));var B=l.active_canvas,v=B.canvas,q=v.getBoundingClientRect(),w=-20,z=-20;q&&(w-=q.left,z-=q.top);a?(k.style.left=a.clientX+w+"px",k.style.top=a.clientY+z+"px"):(k.style.left=0.5*v.width+w+"px",k.style.top=0.5*v.height+z+"px");v.parentNode.appendChild(k);s.focus();return k};l.prototype.showEditPropertyValue=
function(a,b,d){function e(){c(h.value)}function c(d){"number"==typeof a.properties[b]&&(d=Number(d));"array"==g&&(d=d.split(",").map(Number));a.properties[b]=d;a._graph&&a._graph._version++;if(a.onPropertyChanged)a.onPropertyChanged(b,d);l.close();a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){d=d||{};var g="string";null!==a.properties[b]&&(g=typeof a.properties[b]);"object"==g&&a.properties[b].length&&(g="array");var k=null;a.getPropertyInfo&&(k=a.getPropertyInfo(b));if(a.properties_info)for(var m=
0;m<a.properties_info.length;++m)if(a.properties_info[m].name==b){k=a.properties_info[m];break}void 0!==k&&null!==k&&k.type&&(g=k.type);var n="";if("string"==g||"number"==g||"array"==g)n="<input autofocus type='text' class='value'/>";else if("enum"==g&&k.values){n="<select autofocus type='text' class='value'>";for(m in k.values)var f=k.values.constructor===Array?k.values[m]:m,n=n+("<option value='"+f+"' "+(f==a.properties[b]?"selected":"")+">"+k.values[m]+"</option>");n+="</select>"}else if("boolean"==
g)n="<input autofocus type='checkbox' class='value' "+(a.properties[b]?"checked":"")+"/>";else{console.warn("unknown type: "+g);return}var l=this.createDialog("<span class='name'>"+b+"</span>"+n+"<button>OK</button>",d);if("enum"==g&&k.values){var h=l.querySelector("select");h.addEventListener("change",function(a){c(a.target.value)})}else if("boolean"==g)(h=l.querySelector("input"))&&h.addEventListener("click",function(a){c(!!h.checked)});else if(h=l.querySelector("input"))h.addEventListener("blur",
function(a){this.focus()}),h.value=void 0!==a.properties[b]?a.properties[b]:"",h.addEventListener("keydown",function(a){13==a.keyCode&&(e(),a.preventDefault(),a.stopPropagation())});l.querySelector("button").addEventListener("click",e)}};l.prototype.createDialog=function(a,b){b=b||{};var d=document.createElement("div");d.className="graphdialog";d.innerHTML=a;var e=this.canvas.getBoundingClientRect(),c=-20,g=-20;e&&(c-=e.left,g-=e.top);b.position?(c+=b.position[0],g+=b.position[1]):b.event?(c+=b.event.clientX,
g+=b.event.clientY):(c+=0.5*this.canvas.width,g+=0.5*this.canvas.height);d.style.left=c+"px";d.style.top=g+"px";this.canvas.parentNode.appendChild(d);d.close=function(){this.parentNode&&this.parentNode.removeChild(this)};return d};l.onMenuNodeCollapse=function(a,b,d,e,c){c.collapse()};l.onMenuNodePin=function(a,b,d,e,c){c.pin()};l.onMenuNodeMode=function(a,b,d,c,g){new e.ContextMenu(["Always","On Event","On Trigger","Never"],{event:d,callback:function(a){if(g)switch(a){case "On Event":g.mode=e.ON_EVENT;
break;case "On Trigger":g.mode=e.ON_TRIGGER;break;case "Never":g.mode=e.NEVER;break;default:g.mode=e.ALWAYS}},parentMenu:c,node:g});return!1};l.onMenuNodeColors=function(a,b,d,c,g){if(!g)throw"no node for color";b=[];b.push({value:null,content:"<span style='display: block; padding-left: 4px;'>No color</span>"});for(var k in l.node_colors)a=l.node_colors[k],a={value:k,content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid "+a.color+"; background-color:"+a.bgcolor+
"'>"+k+"</span>"},b.push(a);new e.ContextMenu(b,{event:d,callback:function(a){g&&((a=a.value?l.node_colors[a.value]:null)?g.constructor===e.LGraphGroup?g.color=a.groupcolor:(g.color=a.color,g.bgcolor=a.bgcolor):(delete g.color,delete g.bgcolor),g.setDirtyCanvas(!0,!0))},parentMenu:c,node:g});return!1};l.onMenuNodeShapes=function(a,b,d,c,g){if(!g)throw"no node passed";new e.ContextMenu(e.VALID_SHAPES,{event:d,callback:function(a){g&&(g.shape=a,g.setDirtyCanvas(!0))},parentMenu:c,node:g});return!1};
l.onMenuNodeRemove=function(a,b,d,c,e){if(!e)throw"no node passed";!1!==e.removable&&(e.graph.remove(e),e.setDirtyCanvas(!0,!0))};l.onMenuNodeClone=function(a,b,d,e,c){!1!=c.clonable&&(a=c.clone())&&(a.pos=[c.pos[0]+5,c.pos[1]+5],c.graph.add(a),c.setDirtyCanvas(!0,!0))};l.node_colors={red:{color:"#322",bgcolor:"#533",groupcolor:"#A88"},brown:{color:"#332922",bgcolor:"#593930",groupcolor:"#b06634"},green:{color:"#232",bgcolor:"#353",groupcolor:"#8A8"},blue:{color:"#223",bgcolor:"#335",groupcolor:"#88A"},
pale_blue:{color:"#2a363b",bgcolor:"#3f5159",groupcolor:"#3f789e"},cyan:{color:"#233",bgcolor:"#355",groupcolor:"#8AA"},purple:{color:"#323",bgcolor:"#535",groupcolor:"#a1309b"},yellow:{color:"#432",bgcolor:"#653",groupcolor:"#b58b2a"},black:{color:"#222",bgcolor:"#000",groupcolor:"#444"}};l.prototype.getCanvasMenuOptions=function(){var a=null;this.getMenuOptions?a=this.getMenuOptions():(a=[{content:"Add Node",has_submenu:!0,callback:l.onMenuAdd},{content:"Add Group",callback:l.onGroupAdd}],this._graph_stack&&
0<this._graph_stack.length&&a.push(null,{content:"Close subgraph",callback:this.closeSubgraph.bind(this)}));if(this.getExtraMenuOptions){var b=this.getExtraMenuOptions(this,a);b&&(a=a.concat(b))}return a};l.prototype.getNodeMenuOptions=function(a){var b=null,b=a.getMenuOptions?a.getMenuOptions(this):[{content:"Inputs",has_submenu:!0,disabled:!0,callback:l.showMenuNodeOptionalInputs},{content:"Outputs",has_submenu:!0,disabled:!0,callback:l.showMenuNodeOptionalOutputs},null,{content:"Properties",has_submenu:!0,
callback:l.onShowMenuNodeProperties},null,{content:"Title",callback:l.onShowPropertyEditor},{content:"Mode",has_submenu:!0,callback:l.onMenuNodeMode},{content:"Resize",callback:l.onResizeNode},{content:"Collapse",callback:l.onMenuNodeCollapse},{content:"Pin",callback:l.onMenuNodePin},{content:"Colors",has_submenu:!0,callback:l.onMenuNodeColors},{content:"Shapes",has_submenu:!0,callback:l.onMenuNodeShapes},null];if(a.onGetInputs){var d=a.onGetInputs();d&&d.length&&(b[0].disabled=!1)}a.onGetOutputs&&
(d=a.onGetOutputs())&&d.length&&(b[1].disabled=!1);a.getExtraMenuOptions&&(d=a.getExtraMenuOptions(this))&&(d.push(null),b=d.concat(b));!1!==a.clonable&&b.push({content:"Clone",callback:l.onMenuNodeClone});!1!==a.removable&&b.push(null,{content:"Remove",callback:l.onMenuNodeRemove});if(a.graph&&a.graph.onGetNodeMenuOptions)a.graph.onGetNodeMenuOptions(b,a);return b};l.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:l.onShowPropertyEditor},{content:"Color",has_submenu:!0,
callback:l.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:l.onShowPropertyEditor},null,{content:"Remove",callback:l.onMenuNodeRemove}]};l.prototype.processContextMenu=function(a,b){var d=this,c=l.active_canvas.getCanvasWindow(),g=null,k={event:b,callback:function(b,c,e){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?a.removeInput(b.slot):b.output&&a.removeOutput(b.slot);else if("Disconnect Links"==b.content)b=b.slot,b.output?a.disconnectOutput(b.slot):b.input&&
a.disconnectInput(b.slot);else if("Rename Slot"==b.content){b=b.slot;var g=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),k=d.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",c),m=k.querySelector("input");m&&g&&(m.value=g.label||"");k.querySelector("button").addEventListener("click",function(a){m.value&&(g&&(g.label=m.value),d.setDirty(!0));k.close()})}},extra:a};a&&(k.title=a.type);var m=null;a&&(m=a.getSlotInPosition(b.canvasX,b.canvasY),l.active_node=
a);if(m){g=[];m&&m.output&&m.output.links&&m.output.links.length&&g.push({content:"Disconnect Links",slot:m});var n=m.input||m.output;g.push(n.locked?"Cannot remove":{content:"Remove Slot",slot:m});g.push(n.nameLocked?"Cannot rename":{content:"Rename Slot",slot:m});k.title=(m.input?m.input.type:m.output.type)||"*";m.input&&m.input.type==e.ACTION&&(k.title="Action");m.output&&m.output.type==e.EVENT&&(k.title="Event")}else a?g=this.getNodeMenuOptions(a):(g=this.getCanvasMenuOptions(),(m=this.graph.getGroupOnPos(b.canvasX,
b.canvasY))&&g.push(null,{content:"Edit Group",has_submenu:!0,submenu:{title:"Group",extra:m,options:this.getGroupMenuOptions(m)}}));g&&new e.ContextMenu(g,k,c)};this.CanvasRenderingContext2D&&(CanvasRenderingContext2D.prototype.roundRect=function(a,b,d,c,e,g){void 0===e&&(e=5);void 0===g&&(g=e);this.moveTo(a+e,b);this.lineTo(a+d-e,b);this.quadraticCurveTo(a+d,b,a+d,b+e);this.lineTo(a+d,b+c-g);this.quadraticCurveTo(a+d,b+c,a+d-g,b+c);this.lineTo(a+g,b+c);this.quadraticCurveTo(a,b+c,a,b+c-g);this.lineTo(a,
b+e);this.quadraticCurveTo(a,b,a+e,b)});e.compareObjects=function(a,b){for(var d in a)if(a[d]!=b[d])return!1;return!0};e.distance=y;e.colorToString=function(a){return"rgba("+Math.round(255*a[0]).toFixed()+","+Math.round(255*a[1]).toFixed()+","+Math.round(255*a[2]).toFixed()+","+(4==a.length?a[3].toFixed(2):"1.0")+")"};e.isInsideRectangle=s;e.growBounding=function(a,b,d){b<a[0]?a[0]=b:b>a[2]&&(a[2]=b);d<a[1]?a[1]=d:d>a[3]&&(a[3]=d)};e.isInsideBounding=function(a,b){return a[0]<b[0][0]||a[1]<b[0][1]||
a[0]>b[1][0]||a[1]>b[1][1]?!1:!0};e.overlapBounding=w;e.hex2num=function(a){"#"==a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();for(var b=Array(3),d=0,c,e,g=0;6>g;g+=2)c="0123456789ABCDEF".indexOf(a.charAt(g)),e="0123456789ABCDEF".indexOf(a.charAt(g+1)),b[d]=16*c+e,d++;return b};e.num2hex=function(a){for(var b="#",d,c,e=0;3>e;e++)d=a[e]/16,c=a[e]%16,b+="0123456789ABCDEF".charAt(d)+"0123456789ABCDEF".charAt(c);return b};z.prototype.addItem=function(a,b,d){function c(a){var b=this.value;b&&b.has_submenu&&
e.call(this,a)}function e(a){var b=this.value,c=!0;g.current_submenu&&g.current_submenu.close(a);if(d.callback){var k=d.callback.call(this,b,d,a,g,d.node);!0===k&&(c=!1)}if(b&&(b.callback&&!d.ignore_item_callbacks&&!0!==b.disabled&&(k=b.callback.call(this,b,d,a,g,d.extra),!0===k&&(c=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new g.constructor(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:g,ignore_item_callbacks:b.submenu.ignore_item_callbacks,
title:b.submenu.title,extra:b.submenu.extra,autoopen:d.autoopen});c=!1}c&&!g.lock&&g.close()}var g=this;d=d||{};var k=document.createElement("div");k.className="litemenu-entry submenu";var m=!1;if(null===b)k.classList.add("separator");else{k.innerHTML=b&&b.title?b.title:a;if(k.value=b)b.disabled&&(m=!0,k.classList.add("disabled")),(b.submenu||b.has_submenu)&&k.classList.add("has_submenu");"function"==typeof b?(k.dataset.value=a,k.onclick_callback=b):k.dataset.value=b;b.className&&(k.className+=" "+
b.className)}this.root.appendChild(k);m||k.addEventListener("click",e);d.autoopen&&k.addEventListener("mouseenter",c);return k};z.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!z.isCursorOverElement(a,this.parentMenu.root)&&z.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&
...
(function(u){function c(){this.addOutput("in ms","number");this.addOutput("in sec","number")}function r(){this.size=[140,80];this.properties={enabled:!0};this.enabled=!0;this.subgraph=new LGraph;this.subgraph._subgraph_node=this;this.subgraph._is_subgraph=!0;this.subgraph.onTrigger=this.onSubgraphTrigger.bind(this);this.subgraph.onInputAdded=this.onSubgraphNewInput.bind(this);this.subgraph.onInputRenamed=this.onSubgraphRenamedInput.bind(this);this.subgraph.onInputTypeChanged=this.onSubgraphTypeChangeInput.bind(this);
...
[60,30];this.addInput("value",0,{label:""});this.value=0}function m(){this.addInput("in",0);this.addOutput("out",0);this.size=[40,30]}function D(){this.mode=n.ON_EVENT;this.size=[80,30];this.addProperty("msg","");this.addInput("log",n.EVENT);this.addInput("msg",0)}function g(){this.mode=n.ON_EVENT;this.addProperty("msg","");this.addInput("",n.EVENT);var a=this;this.widget=this.addWidget("text","Text","",function(b){a.properties.msg=b});this.widgets_up=!0;this.size=[200,30]}function t(){this.size=
[60,30];this.addProperty("onExecute","return A;");this.addInput("A","");this.addInput("B","");this.addOutput("out","");this._func=null;this.data={}}var n=u.LiteGraph;c.title="Time";c.desc="Time";c.prototype.onExecute=function(){this.setOutputData(0,1E3*this.graph.globaltime);this.setOutputData(1,this.graph.globaltime)};n.registerNodeType("basic/time",c);r.title="Subgraph";r.desc="Graph inside a node";r.title_color="#334";r.prototype.onGetInputs=function(){return[["enabled","boolean"]]};r.prototype.onDrawTitle=
function(a){if(!this.flags.collapsed){a.fillStyle="#555";var b=n.NODE_TITLE_HEIGHT,d=this.size[0]-b;a.fillRect(d,-b,b,b);a.fillStyle="#333";a.beginPath();a.moveTo(d+0.2*b,0.6*-b);a.lineTo(d+0.8*b,0.6*-b);a.lineTo(d+0.5*b,0.3*-b);a.fill()}};r.prototype.onDblClick=function(a,b,d){var e=this;setTimeout(function(){d.openSubgraph(e.subgraph)},10)};r.prototype.onMouseDown=function(a,b,d){if(!this.flags.collapsed&&b[0]>this.size[0]-n.NODE_TITLE_HEIGHT&&0>b[1]){var e=this;setTimeout(function(){d.openSubgraph(e.subgraph)},
...
function(a){var b=this;return[{content:"Open",callback:function(){a.openSubgraph(b.subgraph)}}]};r.prototype.onResize=function(a){a[1]+=20};r.prototype.serialize=function(){var a=LGraphNode.prototype.serialize.call(this);a.subgraph=this.subgraph.serialize();return a};r.prototype.clone=function(){var a=n.createNode(this.type),b=this.serialize();delete b.id;delete b.inputs;delete b.outputs;a.configure(b);return a};n.Subgraph=r;n.registerNodeType("graph/subgraph",r);f.title="Input";f.desc="Input of the graph";
...
n.registerNodeType("basic/watch",k);m.title="Cast";m.desc="Allows to connect different types";m.prototype.onExecute=function(){this.setOutputData(0,this.getInputData(0))};n.registerNodeType("basic/cast",m);D.title="Console";D.desc="Show value inside the console";D.prototype.onAction=function(a,b){"log"==a?console.log(b):"warn"==a?console.warn(b):"error"==a&&console.error(b)};D.prototype.onExecute=function(){var a=this.getInputData(1);null!==a&&(this.properties.msg=a);console.log(a)};D.prototype.onGetInputs=
function(){return[["log",n.ACTION],["warn",n.ACTION],["error",n.ACTION]]};n.registerNodeType("basic/console",D);g.title="Alert";g.desc="Show an alert window";g.color="#510";g.prototype.onConfigure=function(a){this.widget.value=a.properties.msg};g.prototype.onAction=function(a,b){var d=this.properties.msg;setTimeout(function(){alert(d)},10)};n.registerNodeType("basic/alert",g);t.prototype.onConfigure=function(a){a.properties.onExecute&&n.allow_scripts?this.compileCode(a.properties.onExecute):console.warn("Script not compiled, LiteGraph.allow_scripts is false")};
...
b.indexOf(d[e])){console.warn("invalid script");return}try{this._func=new Function("A","B","C","DATA","node",a)}catch(c){console.error("Error parsing script"),console.error(c)}}};t.prototype.onExecute=function(){if(this._func)try{var a=this.getInputData(0),b=this.getInputData(1),d=this.getInputData(2);this.setOutputData(0,this._func(a,b,d,this.data,this))}catch(e){console.error("Error in script"),console.error(e)}};t.prototype.onGetOutputs=function(){return[["C",""]]};n.registerNodeType("basic/script",
t)})(this);
(function(u){function c(){this.size=[60,30];this.addInput("event",w.ACTION)}function r(){this.size=[60,30];this.addInput("in","");this.addOutput("true",w.EVENT);this.addOutput("change",w.EVENT);this.was_true=!1}function f(){this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addInput("",w.ACTION);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",w.EVENT);this.addOutput("",
w.EVENT);this.addOutput("",w.EVENT);this.size=[120,30];this.flags={horizontal:!0,render_box:!1}}function h(){this.size=[60,30];this.addInput("event",w.ACTION);this.addOutput("event",w.EVENT);this.properties={equal_to:"",has_property:"",property_equal_to:""}}function q(){this.addInput("inc",w.ACTION);this.addInput("dec",w.ACTION);this.addInput("reset",w.ACTION);this.addOutput("change",w.EVENT);this.addOutput("num","number");this.num=0}function l(){this.size=[60,30];this.addProperty("time_in_ms",1E3);
this.addInput("event",w.ACTION);this.addOutput("on_time",w.EVENT);this._pending=[]}function y(){this.addProperty("interval",1E3);this.addProperty("event","tick");this.addOutput("on_tick",w.EVENT);this.time=0;this.last_interval=1E3;this.triggered=!1}function s(){this.addInput("data","");this.addInput("assign",w.ACTION);this.addOutput("data","");this._last_value=null;this.properties={data:null,serialize:!0};var c=this;this.addWidget("button","store","",function(){c.properties.data=c._last_value})}var w=
u.LiteGraph;c.title="Log Event";c.desc="Log event in console";c.prototype.onAction=function(c,e){console.log(c,e)};w.registerNodeType("events/log",c);r.title="TriggerEvent";r.desc="Triggers event if value is true";r.prototype.onExecute=function(c,e){var f=this.getInputData(0);f&&this.triggerSlot(0,e);f&&!this.was_true&&this.triggerSlot(1,e);this.was_true=f};w.registerNodeType("events/trigger",r);f.title="Sequencer";f.desc="Trigger events when an event arrives";f.prototype.getTitle=function(){return""};
f.prototype.onAction=function(c,e){if(this.outputs)for(var f=0;f<this.outputs.length;++f)this.triggerSlot(f,e)};w.registerNodeType("events/sequencer",f);h.title="Filter Event";h.desc="Blocks events that do not match the filter";h.prototype.onAction=function(c,e){if(null!=e&&(!this.properties.equal_to||this.properties.equal_to==e)){if(this.properties.has_property){var f=e[this.properties.has_property];if(null==f||this.properties.property_equal_to&&this.properties.property_equal_to!=f)return}this.triggerSlot(0,
e)}};w.registerNodeType("events/filter",h);q.title="Counter";q.desc="Counts events";q.prototype.getTitle=function(){return this.flags.collapsed?String(this.num):this.title};q.prototype.onAction=function(c,e){var f=this.num;"inc"==c?this.num+=1:"dec"==c?this.num-=1:"reset"==c&&(this.num=0);this.num!=f&&this.trigger("change",this.num)};q.prototype.onDrawBackground=function(c){this.flags.collapsed||(c.fillStyle="#AAA",c.font="20px Arial",c.textAlign="center",c.fillText(this.num,0.5*this.size[0],0.5*
this.size[1]))};q.prototype.onExecute=function(){this.setOutputData(1,this.num)};w.registerNodeType("events/counter",q);l.title="Delay";l.desc="Delays one event";l.prototype.onAction=function(c,e){var f=this.properties.time_in_ms;0>=f?this.trigger(null,e):this._pending.push([f,e])};l.prototype.onExecute=function(){var c=1E3*this.graph.elapsed_time;this.isInputConnected(1)&&(this.properties.time_in_ms=this.getInputData(1));for(var e=0;e<this._pending.length;++e){var f=this._pending[e];f[0]-=c;0<f[0]||
(this._pending.splice(e,1),--e,this.trigger(null,f[1]))}};l.prototype.onGetInputs=function(){return[["event",w.ACTION],["time_in_ms","number"]]};w.registerNodeType("events/delay",l);y.title="Timer";y.desc="Sends an event every N milliseconds";y.prototype.onStart=function(){this.time=0};y.prototype.getTitle=function(){return"Timer: "+this.last_interval.toString()+"ms"};y.on_color="#AAA";y.off_color="#222";y.prototype.onDrawBackground=function(){this.boxcolor=this.triggered?y.on_color:y.off_color;this.triggered=
...
"number"]]};y.prototype.onGetOutputs=function(){return[["tick","boolean"]]};w.registerNodeType("events/timer",y);s.title="Data Store";s.desc="Stores data and only changes when event is received";s.prototype.onExecute=function(){this._last_value=this.getInputData(0);this.setOutputData(0,this.properties.data)};s.prototype.onAction=function(c,e){this.properties.data=this._last_value};s.prototype.onSerialize=function(c){null!=c.data&&(!1==this.properties.serialize||c.data.constructor!==String&&c.data.constructor!==
Number&&c.data.constructor!==Boolean&&c.data.constructor!==Array&&c.data.constructor!==Object)&&(c.data=null)};w.registerNodeType("basic/data_store",s)})(this);
(function(u){function c(){this.addOutput("",z.EVENT);this.addOutput("","boolean");this.addProperty("text","click me");this.addProperty("font_size",30);this.addProperty("message","");this.size=[164,84];this.clicked=!1}function r(){this.addInput("","boolean");this.addInput("e",z.ACTION);this.addOutput("v","boolean");this.addOutput("e",z.EVENT);this.properties={font:"",value:!1};this.size=[160,44]}function f(){this.addOutput("","number");this.size=[80,60];this.properties={min:-1E3,max:1E3,value:1,step:1};
this.old_y=-1;this._precision=this._remainder=0;this.mouse_captured=!1}function h(){this.addOutput("","number");this.size=[64,84];this.properties={min:0,max:1,value:0.5,color:"#7AF",precision:2};this.value=-1}function q(){this.addOutput("","number");this.properties={value:0.5,min:0,max:1,text:"V"};var c=this;this.size=[140,40];this.slider=this.addWidget("slider","V",this.properties.value,function(f){c.properties.value=f},this.properties);this.widgets_up=!0}function l(){this.size=[160,26];this.addOutput("",
"number");this.properties={color:"#7AF",min:0,max:1,value:0.5};this.value=-1}function y(){this.size=[160,26];this.addInput("","number");this.properties={min:0,max:1,value:0,color:"#AAF"}}function s(){this.addInputs("",0);this.properties={value:"...",font:"Arial",fontsize:18,color:"#AAA",align:"left",glowSize:0,decimals:1}}function w(){this.size=[200,100];this.properties={borderColor:"#ffffff",bgcolorTop:"#f0f0f0",bgcolorBottom:"#e0e0e0",shadowSize:2,borderRadius:3}}var z=u.LiteGraph;c.title="Button";
...
this.trigger("e",this.properties.value)};r.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(this.properties.value=c);this.setOutputData(0,this.properties.value)};r.prototype.onMouseDown=function(c,f){if(1<f[0]&&1<f[1]&&f[0]<this.size[0]-2&&f[1]<this.size[1]-2)return this.properties.value=!this.properties.value,this.graph._version++,this.trigger("e",this.properties.value),!0};z.registerNodeType("widget/toggle",r);f.title="Number";f.desc="Widget to select number value";f.pixels_threshold=
10;f.markers_color="#666";f.prototype.onDrawForeground=function(c){var h=0.5*this.size[0],k=this.size[1];30<k?(c.fillStyle=f.markers_color,c.beginPath(),c.moveTo(h,0.1*k),c.lineTo(h+0.1*k,0.2*k),c.lineTo(h+-0.1*k,0.2*k),c.fill(),c.beginPath(),c.moveTo(h,0.9*k),c.lineTo(h+0.1*k,0.8*k),c.lineTo(h+-0.1*k,0.8*k),c.fill(),c.font=(0.7*k).toFixed(1)+"px Arial"):c.font=(0.8*k).toFixed(1)+"px Arial";c.textAlign="center";c.font=(0.7*k).toFixed(1)+"px Arial";c.fillStyle="#EEE";c.fillText(this.properties.value.toFixed(this._precision),
h,0.75*k)};f.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};f.prototype.onPropertyChanged=function(c,f){var k=(this.properties.step+"").split(".");this._precision=1<k.length?k[1].length:0};f.prototype.onMouseDown=function(c,f){if(!(0>f[1]))return this.old_y=c.canvasY,this.captureInput(!0),this.mouse_captured=!0};f.prototype.onMouseMove=function(c){if(this.mouse_captured){var h=this.old_y-c.canvasY;c.shiftKey&&(h*=10);if(c.metaKey||c.altKey)h*=0.1;this.old_y=c.canvasY;
c=this._remainder+h/f.pixels_threshold;this._remainder=c%1;c=Math.clamp(this.properties.value+(c|0)*this.properties.step,this.properties.min,this.properties.max);this.properties.value=c;this.graph._version++;this.setDirtyCanvas(!0)}};f.prototype.onMouseUp=function(c,f){200>c.click_time&&(this.properties.value=Math.clamp(this.properties.value+(f[1]>0.5*this.size[1]?-1:1)*this.properties.step,this.properties.min,this.properties.max),this.graph._version++,this.setDirtyCanvas(!0));this.mouse_captured&&
(this.mouse_captured=!1,this.captureInput(!1))};z.registerNodeType("widget/number",f);h.title="Knob";h.desc="Circular controller";h.size=[80,100];h.prototype.onDrawForeground=function(c){if(!this.flags.collapsed){-1==this.value&&(this.value=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min));var f=0.5*this.size[0],k=0.5*this.size[1],m=0.5*Math.min(this.size[0],this.size[1])-5;c.globalAlpha=1;c.save();c.translate(f,k);c.rotate(0.75*Math.PI);c.fillStyle="rgba(0,0,0,0.5)";
c.beginPath();c.moveTo(0,0);c.arc(0,0,m,0,1.5*Math.PI);c.fill();c.strokeStyle="black";c.fillStyle=this.properties.color;c.lineWidth=2;c.beginPath();c.moveTo(0,0);c.arc(0,0,m-4,0,1.5*Math.PI*Math.max(0.01,this.value));c.closePath();c.fill();c.lineWidth=1;c.globalAlpha=1;c.restore();c.fillStyle="black";c.beginPath();c.arc(f,k,0.75*m,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":this.properties.color;c.beginPath();var h=this.value*Math.PI*1.5+0.75*Math.PI;c.arc(f+Math.cos(h)*m*0.65,k+Math.sin(h)*
m*0.65,0.05*m,0,2*Math.PI,!0);c.fill();c.fillStyle=this.mouseOver?"white":"#AAA";c.font=Math.floor(0.5*m)+"px Arial";c.textAlign="center";c.fillText(this.properties.value.toFixed(this.properties.precision),f,k+0.15*m)}};h.prototype.onExecute=function(){this.setOutputData(0,this.properties.value);this.boxcolor=z.colorToString([this.value,this.value,this.value])};h.prototype.onMouseDown=function(c){this.center=[0.5*this.size[0],0.5*this.size[1]+20];this.radius=0.5*this.size[0];if(20>c.canvasY-this.pos[1]||
...
h.prototype.onMouseUp=function(c){this.oldmouse&&(this.oldmouse=null,this.captureInput(!1))};h.prototype.onPropertyChanged=function(c,f){if("min"==c||"max"==c||"value"==c)return this.properties[c]=parseFloat(f),!0};z.registerNodeType("widget/knob",h);q.title="Inner Slider";q.prototype.onPropertyChanged=function(c,f){"value"==c&&(this.slider.value=f)};q.prototype.onExecute=function(){this.setOutputData(0,this.properties.value)};z.registerNodeType("widget/internal_slider",q);l.title="H.Slider";l.desc=
"Linear slider controller";l.prototype.onDrawForeground=function(c){-1==this.value&&(this.value=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min));c.globalAlpha=1;c.lineWidth=1;c.fillStyle="#000";c.fillRect(2,2,this.size[0]-4,this.size[1]-4);c.fillStyle=this.properties.color;c.beginPath();c.rect(4,4,(this.size[0]-8)*this.value,this.size[1]-8);c.fill()};l.prototype.onExecute=function(){this.properties.value=this.properties.min+(this.properties.max-this.properties.min)*
this.value;this.setOutputData(0,this.properties.value);this.boxcolor=z.colorToString([this.value,this.value,this.value])};l.prototype.onMouseDown=function(c){if(0>c.canvasY-this.pos[1])return!1;this.oldmouse=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];this.captureInput(!0);return!0};l.prototype.onMouseMove=function(c){if(this.oldmouse){c=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];var f=this.value,f=f+(c[0]-this.oldmouse[0])/this.size[0];1<f?f=1:0>f&&(f=0);this.value=f;this.oldmouse=c;this.setDirtyCanvas(!0)}};
l.prototype.onMouseUp=function(c){this.oldmouse=null;this.captureInput(!1)};l.prototype.onMouseLeave=function(c){};z.registerNodeType("widget/hslider",l);y.title="Progress";y.desc="Shows data in linear progress";y.prototype.onExecute=function(){var c=this.getInputData(0);void 0!=c&&(this.properties.value=c)};y.prototype.onDrawForeground=function(c){c.lineWidth=1;c.fillStyle=this.properties.color;var f=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min),f=Math.min(1,
...
s);w.title="Panel";w.desc="Non interactive panel";w.widgets=[{name:"update",text:"Update",type:"button"}];w.prototype.createGradient=function(c){""==this.properties.bgcolorTop||""==this.properties.bgcolorBottom?this.lineargradient=0:(this.lineargradient=c.createLinearGradient(0,0,0,this.size[1]),this.lineargradient.addColorStop(0,this.properties.bgcolorTop),this.lineargradient.addColorStop(1,this.properties.bgcolorBottom))};w.prototype.onDrawForeground=function(c){this.flags.collapsed||(null==this.lineargradient&&
this.createGradient(c),this.lineargradient&&(c.lineWidth=1,c.strokeStyle=this.properties.borderColor,c.fillStyle=this.lineargradient,this.properties.shadowSize?(c.shadowColor="#000",c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=this.properties.shadowSize):c.shadowColor="transparent",c.roundRect(0,0,this.size[0]-1,this.size[1]-1,this.properties.shadowSize),c.fill(),c.shadowColor="transparent",c.stroke()))};z.registerNodeType("widget/panel",w)})(this);
(function(u){function c(){this.addOutput("left_x_axis","number");this.addOutput("left_y_axis","number");this.addOutput("button_pressed",r.EVENT);this.properties={gamepad_index:0,threshold:0.1};this._left_axis=new Float32Array(2);this._right_axis=new Float32Array(2);this._triggers=new Float32Array(2);this._previous_buttons=new Uint8Array(17);this._current_buttons=new Uint8Array(17)}var r=u.LiteGraph;c.title="Gamepad";c.desc="gets the input of the gamepad";c.CENTER=0;c.LEFT=1;c.RIGHT=2;c.UP=4;c.DOWN=
8;c.zero=new Float32Array(2);c.buttons="a b x y lb rb lt rt back start ls rs home".split(" ");c.prototype.onExecute=function(){var f=this.getGamepad(),h=this.properties.threshold||0;f&&(this._left_axis[0]=Math.abs(f.xbox.axes.lx)>h?f.xbox.axes.lx:0,this._left_axis[1]=Math.abs(f.xbox.axes.ly)>h?f.xbox.axes.ly:0,this._right_axis[0]=Math.abs(f.xbox.axes.rx)>h?f.xbox.axes.rx:0,this._right_axis[1]=Math.abs(f.xbox.axes.ry)>h?f.xbox.axes.ry:0,this._triggers[0]=Math.abs(f.xbox.axes.ltrigger)>h?f.xbox.axes.ltrigger:
0,this._triggers[1]=Math.abs(f.xbox.axes.rtrigger)>h?f.xbox.axes.rtrigger:0);if(this.outputs)for(h=0;h<this.outputs.length;h++){var q=this.outputs[h];if(q.links&&q.links.length){var l=null;if(f)switch(q.name){case "left_axis":l=this._left_axis;break;case "right_axis":l=this._right_axis;break;case "left_x_axis":l=this._left_axis[0];break;case "left_y_axis":l=this._left_axis[1];break;case "right_x_axis":l=this._right_axis[0];break;case "right_y_axis":l=this._right_axis[1];break;case "trigger_left":l=
this._triggers[0];break;case "trigger_right":l=this._triggers[1];break;case "a_button":l=f.xbox.buttons.a?1:0;break;case "b_button":l=f.xbox.buttons.b?1:0;break;case "x_button":l=f.xbox.buttons.x?1:0;break;case "y_button":l=f.xbox.buttons.y?1:0;break;case "lb_button":l=f.xbox.buttons.lb?1:0;break;case "rb_button":l=f.xbox.buttons.rb?1:0;break;case "ls_button":l=f.xbox.buttons.ls?1:0;break;case "rs_button":l=f.xbox.buttons.rs?1:0;break;case "hat_left":l=f.xbox.hatmap&c.LEFT;break;case "hat_right":l=
f.xbox.hatmap&c.RIGHT;break;case "hat_up":l=f.xbox.hatmap&c.UP;break;case "hat_down":l=f.xbox.hatmap&c.DOWN;break;case "hat":l=f.xbox.hatmap;break;case "start_button":l=f.xbox.buttons.start?1:0;break;case "back_button":l=f.xbox.buttons.back?1:0;break;case "button_pressed":for(q=0;q<this._current_buttons.length;++q)this._current_buttons[q]&&!this._previous_buttons[q]&&this.triggerSlot(h,c.buttons[q])}else switch(q.name){case "button_pressed":break;case "left_axis":case "right_axis":l=c.zero;break;
default:l=0}this.setOutputData(h,l)}}};c.mapping={a:0,b:1,x:2,y:3,lb:4,rb:5,lt:6,rt:7,back:8,start:9,ls:10,rs:11};c.mapping_array="a b x y lb rb lt rt back start ls rs".split(" ");c.prototype.getGamepad=function(){var f=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!f)return null;var h=f.call(navigator),f=null;this._previous_buttons.set(this._current_buttons);for(f=this.properties.gamepad_index;4>f;f++)if(h[f]){f=h[f];h=this.xbox_mapping;h||(h=this.xbox_mapping={axes:[],
buttons:{},hat:"",hatmap:c.CENTER});h.axes.lx=f.axes[0];h.axes.ly=f.axes[1];h.axes.rx=f.axes[2];h.axes.ry=f.axes[3];h.axes.ltrigger=f.buttons[6].value;h.axes.rtrigger=f.buttons[7].value;h.hat="";h.hatmap=c.CENTER;for(var q=0;q<f.buttons.length;q++)if(this._current_buttons[q]=f.buttons[q].pressed,12>q)h.buttons[c.mapping_array[q]]=f.buttons[q].pressed,f.buttons[q].was_pressed&&this.trigger(c.mapping_array[q]+"_button_event");else switch(q){case 12:f.buttons[q].pressed&&(h.hat+="up",h.hatmap|=c.UP);
break;case 13:f.buttons[q].pressed&&(h.hat+="down",h.hatmap|=c.DOWN);break;case 14:f.buttons[q].pressed&&(h.hat+="left",h.hatmap|=c.LEFT);break;case 15:f.buttons[q].pressed&&(h.hat+="right",h.hatmap|=c.RIGHT);break;case 16:h.buttons.home=f.buttons[q].pressed}f.xbox=h;return f}};c.prototype.onDrawBackground=function(c){if(!this.flags.collapsed){var h=this._left_axis,q=this._right_axis;c.strokeStyle="#88A";c.strokeRect(0.5*(h[0]+1)*this.size[0]-4,0.5*(h[1]+1)*this.size[1]-4,8,8);c.strokeStyle="#8A8";
c.strokeRect(0.5*(q[0]+1)*this.size[0]-4,0.5*(q[1]+1)*this.size[1]-4,8,8);h=this.size[1]/this._current_buttons.length;c.fillStyle="#AEB";for(q=0;q<this._current_buttons.length;++q)this._current_buttons[q]&&c.fillRect(0,h*q,6,h)}};c.prototype.onGetOutputs=function(){return[["left_axis","vec2"],["right_axis","vec2"],["left_x_axis","number"],["left_y_axis","number"],["right_x_axis","number"],["right_y_axis","number"],["trigger_left","number"],["trigger_right","number"],["a_button","number"],["b_button",
...
(function(u){function c(){this.addInput("in","*");this.size=[80,30]}function r(){this.addInput("in");this.addOutput("out");this.size=[80,30]}function f(){this.addInput("in");this.addOutput("out")}function h(){this.addInput("in","number",{locked:!0});this.addOutput("out","number",{locked:!0});this.addProperty("in",0);this.addProperty("in_min",0);this.addProperty("in_max",1);this.addProperty("out_min",0);this.addProperty("out_max",1);this.size=[80,30]}function q(){this.addOutput("value","number");this.addProperty("min",
0);this.addProperty("max",1);this.size=[80,30]}function l(){this.addInput("in","number");this.addOutput("out","number");this.addProperty("min",0);this.addProperty("max",1);this.addProperty("smooth",!0);this.size=[90,30]}function y(){this.addOutput("out","number");this.addProperty("min_time",1);this.addProperty("max_time",2);this.addProperty("duration",0.2);this.size=[90,30];this._blink_time=this._remaining_time=0}function s(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,
...
"nodes/imgs/icon-sin.png"}function p(){this.addInput("x","number");this.addInput("y","number");this.addOutput("","number");this.properties={x:1,y:1,formula:"x+y"};this.code_widget=this.addWidget("text","F(x,y)",this.properties.formula,function(a,b,d){d.properties.formula=a});this.addWidget("toggle","allow",C.allow_scripts,function(a){C.allow_scripts=a});this._func=null}function K(){this.addInput("vec2","vec2");this.addOutput("x","number");this.addOutput("y","number")}function A(){this.addInputs([["x",
...
this.addOutput("z","number");this.addOutput("w","number")}function I(){this.addInputs([["x","number"],["y","number"],["z","number"],["w","number"]]);this.addOutput("vec4","vec4");this.properties={x:0,y:0,z:0,w:0};this._data=new Float32Array(4)}var C=u.LiteGraph;c.title="Converter";c.desc="type A to type B";c.prototype.onExecute=function(){var a=this.getInputData(0);if(null!=a&&this.outputs)for(var b=0;b<this.outputs.length;b++){var d=this.outputs[b];if(d.links&&d.links.length){var c=null;switch(d.name){case "number":c=
a.length?a[0]:parseFloat(a);break;case "vec2":case "vec3":case "vec4":c=1;switch(d.name){case "vec2":c=2;break;case "vec3":c=3;break;case "vec4":c=4}c=new Float32Array(c);if(a.length)for(d=0;d<a.length&&d<c.length;d++)c[d]=a[d];else c[0]=parseFloat(a)}this.setOutputData(b,c)}}};c.prototype.onGetOutputs=function(){return[["number","number"],["vec2","vec2"],["vec3","vec3"],["vec4","vec4"]]};C.registerNodeType("math/converter",c);r.title="Bypass";r.desc="removes the type";r.prototype.onExecute=function(){var a=
this.getInputData(0);this.setOutputData(0,a)};C.registerNodeType("math/bypass",r);f.title="to Number";f.desc="Cast to number";f.prototype.onExecute=function(){var a=this.getInputData(0);this.setOutputData(0,Number(a))};C.registerNodeType("math/to_number",f);h.title="Range";h.desc="Convert a number from one range to another";h.prototype.getTitle=function(){return this.flags.collapsed?(this._last_v||0).toFixed(2):this.title};h.prototype.onExecute=function(){if(this.inputs)for(var a=0;a<this.inputs.length;a++){var b=
this.inputs[a],d=this.getInputData(a);void 0!==d&&(this.properties[b.name]=d)}d=this.properties["in"];if(void 0===d||null===d||d.constructor!==Number)d=0;a=this.properties.in_min;b=this.properties.out_min;this._last_v=(d-a)/(this.properties.in_max-a)*(this.properties.out_max-b)+b;this.setOutputData(0,this._last_v)};h.prototype.onDrawBackground=function(a){this.outputs[0].label=this._last_v?this._last_v.toFixed(3):"?"};h.prototype.onGetInputs=function(){return[["in_min","number"],["in_max","number"],
["out_min","number"],["out_max","number"]]};C.registerNodeType("math/range",h);q.title="Rand";q.desc="Random number";q.prototype.onExecute=function(){if(this.inputs)for(var a=0;a<this.inputs.length;a++){var b=this.inputs[a],d=this.getInputData(a);void 0!==d&&(this.properties[b.name]=d)}a=this.properties.min;b=this.properties.max;this._last_v=Math.random()*(b-a)+a;this.setOutputData(0,this._last_v)};q.prototype.onDrawBackground=function(a){this.outputs[0].label=(this._last_v||0).toFixed(3)};q.prototype.onGetInputs=
function(){return[["min","number"],["max","number"]]};C.registerNodeType("math/rand",q);l.title="Noise";l.desc="Random number with temporal continuity";l.data=null;l.getValue=function(a,b){if(!l.data){l.data=new Float32Array(1024);for(var d=0;d<l.data.length;++d)l.data[d]=Math.random()}a%=1024;0>a&&(a+=1024);var c=Math.floor(a);a-=c;d=l.data[c];c=l.data[1023==c?0:c+1];b&&(a=a*a*a*(a*(6*a-15)+10));return d*(1-a)+c*a};l.prototype.onExecute=function(){var a=this.getInputData(0)||0,a=l.getValue(a,this.properties.smooth),
b=this.properties.min;this._last_v=a*(this.properties.max-b)+b;this.setOutputData(0,this._last_v)};l.prototype.onDrawBackground=function(a){this.outputs[0].label=(this._last_v||0).toFixed(3)};C.registerNodeType("math/noise",l);y.title="Spikes";y.desc="spike every random time";y.prototype.onExecute=function(){var a=this.graph.elapsed_time;this._remaining_time-=a;this._blink_time-=a;a=0;0<this._blink_time&&(a=1/(Math.pow(this._blink_time/this.properties.duration*8-4,4)+1));0>this._remaining_time?(this._remaining_time=
Math.random()*(this.properties.max_time-this.properties.min_time)+this.properties.min_time,this._blink_time=this.properties.duration,this.boxcolor="#FFF"):this.boxcolor="#000";this.setOutputData(0,a)};C.registerNodeType("math/spikes",y);s.title="Clamp";s.desc="Clamp number between min and max";s.filter="shader";s.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(a=Math.max(this.properties.min,a),a=Math.min(this.properties.max,a),this.setOutputData(0,a))};s.prototype.getCode=function(a){a=
"";this.isInputConnected(0)&&(a+="clamp({{0}},"+this.properties.min+","+this.properties.max+")");return a};C.registerNodeType("math/clamp",s);w.title="Lerp";w.desc="Linear Interpolation";w.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.getInputData(1);null==b&&(b=0);var d=this.properties.f,c=this.getInputData(2);void 0!==c&&(d=c);this.setOutputData(0,a*(1-d)+b*d)};w.prototype.onGetInputs=function(){return[["f","number"]]};C.registerNodeType("math/lerp",w);z.title=
"Abs";z.desc="Absolute";z.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,Math.abs(a))};C.registerNodeType("math/abs",z);e.title="Floor";e.desc="Floor number to remove fractional part";e.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,Math.floor(a))};C.registerNodeType("math/floor",e);v.title="Frac";v.desc="Returns fractional part";v.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,
a%1)};C.registerNodeType("math/frac",v);k.title="Smoothstep";k.desc="Smoothstep";k.prototype.onExecute=function(){var a=this.getInputData(0);if(void 0!==a){var b=this.properties.A,a=Math.clamp((a-b)/(this.properties.B-b),0,1);this.setOutputData(0,a*a*(3-2*a))}};C.registerNodeType("math/smoothstep",k);m.title="Scale";m.desc="v * factor";m.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a*this.properties.factor)};C.registerNodeType("math/scale",m);D.title="Gate";
D.desc="if v is true, then outputs A, otherwise B";D.prototype.onExecute=function(){var a=this.getInputData(0);this.setOutputData(0,this.getInputData(a?1:2))};C.registerNodeType("math/gate",D);g.title="Average";g.desc="Average Filter";g.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this._values.length;this._values[this._current%b]=a;this._current+=1;this._current>b&&(this._current=0);for(var d=a=0;d<b;++d)a+=this._values[d];this.setOutputData(0,a/b)};g.prototype.onPropertyChanged=
function(a,b){1>b&&(b=1);this.properties.samples=Math.round(b);var d=this._values;this._values=new Float32Array(this.properties.samples);d.length<=this._values.length?this._values.set(d):this._values.set(d.subarray(0,this._values.length))};C.registerNodeType("math/average",g);t.title="TendTo";t.desc="moves the output value always closer to the input";t.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.properties.factor;this._value=null==this._value?a:this._value*
(1-b)+a*b;this.setOutputData(0,this._value)};C.registerNodeType("math/tendTo",t);n.values="+ - * / % ^ max min".split(" ");n.title="Operation";n.desc="Easy math operators";n["@OP"]={type:"enum",title:"operation",values:n.values};n.size=[100,60];n.prototype.getTitle=function(){return"max"==this.properties.OP||"min"==this.properties.OP?this.properties.OP+"(A,B)":"A "+this.properties.OP+" B"};n.prototype.setValue=function(a){"string"==typeof a&&(a=parseFloat(a));this.properties.value=a};n.prototype.onExecute=
...
function(a){this.flags.collapsed||(a.font="40px Arial",a.fillStyle="#666",a.textAlign="center",a.fillText(this.properties.OP,0.5*this.size[0],0.5*(this.size[1]+C.NODE_TITLE_HEIGHT)),a.textAlign="left")};C.registerNodeType("math/operation",n);C.registerSearchboxExtra("math/operation","MAX",{properties:{OP:"max"},title:"MAX()"});C.registerSearchboxExtra("math/operation","MIN",{properties:{OP:"min"},title:"MIN()"});a.title="Compare";a.desc="compares between two values";a.prototype.onExecute=function(){var a=
this.getInputData(0),b=this.getInputData(1);void 0!==a?this.properties.A=a:a=this.properties.A;void 0!==b?this.properties.B=b:b=this.properties.B;for(var d=0,c=this.outputs.length;d<c;++d){var e=this.outputs[d];if(e.links&&e.links.length){var g;switch(e.name){case "A==B":g=a==b;break;case "A!=B":g=a!=b;break;case "A>B":g=a>b;break;case "A<B":g=a<b;break;case "A<=B":g=a<=b;break;case "A>=B":g=a>=b}this.setOutputData(d,g)}}};a.prototype.onGetOutputs=function(){return[["A==B","boolean"],["A!=B","boolean"],
["A>B","boolean"],["A<B","boolean"],["A>=B","boolean"],["A<=B","boolean"]]};C.registerNodeType("math/compare",a);C.registerSearchboxExtra("math/compare","==",{outputs:[["A==B","boolean"]],title:"A==B"});C.registerSearchboxExtra("math/compare","!=",{outputs:[["A!=B","boolean"]],title:"A!=B"});C.registerSearchboxExtra("math/compare",">",{outputs:[["A>B","boolean"]],title:"A>B"});C.registerSearchboxExtra("math/compare","<",{outputs:[["A<B","boolean"]],title:"A<B"});C.registerSearchboxExtra("math/compare",
...
void 0===b?b=this.properties.B:this.properties.B=b;var d=!0;switch(this.properties.OP){case ">":d=a>b;break;case "<":d=a<b;break;case "==":d=a==b;break;case "!=":d=a!=b;break;case "<=":d=a<=b;break;case ">=":d=a>=b;break;case "||":d=a||b;break;case "&&":d=a&&b}this.setOutputData(0,d);this.setOutputData(1,!d)};C.registerNodeType("math/condition",b);d.title="Accumulate";d.desc="Increments a value every time";d.prototype.onExecute=function(){null===this.properties.value&&(this.properties.value=0);var a=
this.getInputData(0);this.properties.value=null!==a?this.properties.value+a:this.properties.value+this.properties.increment;this.setOutputData(0,this.properties.value)};C.registerNodeType("math/accumulate",d);x.title="Trigonometry";x.desc="Sin Cos Tan";x.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=0);var b=this.properties.amplitude,d=this.findInputSlot("amplitude");-1!=d&&(b=this.getInputData(d));var c=this.properties.offset,d=this.findInputSlot("offset");-1!=d&&(c=this.getInputData(d));
for(var d=0,e=this.outputs.length;d<e;++d){var g;switch(this.outputs[d].name){case "sin":g=Math.sin(a);break;case "cos":g=Math.cos(a);break;case "tan":g=Math.tan(a);break;case "asin":g=Math.asin(a);break;case "acos":g=Math.acos(a);break;case "atan":g=Math.atan(a)}this.setOutputData(d,b*g+c)}};x.prototype.onGetInputs=function(){return[["v","number"],["amplitude","number"],["offset","number"]]};x.prototype.onGetOutputs=function(){return[["sin","number"],["cos","number"],["tan","number"],["asin","number"],
["acos","number"],["atan","number"]]};C.registerNodeType("math/trigonometry",x);C.registerSearchboxExtra("math/trigonometry","SIN()",{outputs:[["sin","number"]],title:"SIN()"});C.registerSearchboxExtra("math/trigonometry","COS()",{outputs:[["cos","number"]],title:"COS()"});C.registerSearchboxExtra("math/trigonometry","TAN()",{outputs:[["tan","number"]],title:"TAN()"});p.title="Formula";p.desc="Compute formula";p.size=[160,100];g.prototype.onPropertyChanged=function(a,b){"formula"==a&&(this.code_widget.value=
b)};p.prototype.onExecute=function(){if(C.allow_scripts){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.x=a:a=this.properties.x;null!=b?this.properties.y=b:b=this.properties.y;var d;try{this._func&&this._func_code==this.properties.formula||(this._func=new Function("x","y","TIME","return "+this.properties.formula),this._func_code=this.properties.formula),d=this._func(a,b,this.graph.globaltime),this.boxcolor=null}catch(c){this.boxcolor="red"}this.setOutputData(0,d)}};p.prototype.getTitle=
function(){return this._func_code||"Formula"};p.prototype.onDrawBackground=function(){var a=this.properties.formula;this.outputs&&this.outputs.length&&(this.outputs[0].label=a)};C.registerNodeType("math/formula",p);K.title="Vec2->XY";K.desc="vector 2 to components";K.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]))};C.registerNodeType("math3d/vec2-to-xy",K);A.title="XY->Vec2";A.desc="components to vector2";A.prototype.onExecute=
function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var d=this._data;d[0]=a;d[1]=b;this.setOutputData(0,d)};C.registerNodeType("math3d/xy-to-vec2",A);G.title="Vec3->XYZ";G.desc="vector 3 to components";G.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]),this.setOutputData(2,a[2]))};C.registerNodeType("math3d/vec3-to-xyz",G);H.title="XYZ->Vec3";H.desc="components to vector3";
H.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var d=this.getInputData(2);null==d&&(d=this.properties.z);var c=this._data;c[0]=a;c[1]=b;c[2]=d;this.setOutputData(0,c)};C.registerNodeType("math3d/xyz-to-vec3",H);F.title="Vec4->XYZW";F.desc="vector 4 to components";F.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]),this.setOutputData(2,
a[2]),this.setOutputData(3,a[3]))};C.registerNodeType("math3d/vec4-to-xyzw",F);I.title="XYZW->Vec4";I.desc="components to vector4";I.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.x);var b=this.getInputData(1);null==b&&(b=this.properties.y);var d=this.getInputData(2);null==d&&(d=this.properties.z);var c=this.getInputData(3);null==c&&(c=this.properties.w);var e=this._data;e[0]=a;e[1]=b;e[2]=d;e[3]=c;this.setOutputData(0,e)};C.registerNodeType("math3d/xyzw-to-vec4",
I);u.glMatrix&&(u=function(){this.addOutput("quat","quat");this.properties={x:0,y:0,z:0,w:1};this._value=quat.create()},u.title="Quaternion",u.desc="quaternion",u.prototype.onExecute=function(){this._value[0]=this.properties.x;this._value[1]=this.properties.y;this._value[2]=this.properties.z;this._value[3]=this.properties.w;this.setOutputData(0,this._value)},C.registerNodeType("math3d/quaternion",u),u=function(){this.addInputs([["degrees","number"],["axis","vec3"]]);this.addOutput("quat","quat");
this.properties={angle:90,axis:vec3.fromValues(0,1,0)};this._value=quat.create()},u.title="Rotation",u.desc="quaternion rotation",u.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.angle);var b=this.getInputData(1);null==b&&(b=this.properties.axis);a=quat.setAxisAngle(this._value,b,0.0174532925*a);this.setOutputData(0,a)},C.registerNodeType("math3d/rotation",u),u=function(){this.addInputs([["vec3","vec3"],["quat","quat"]]);this.addOutput("result","vec3");this.properties=
{vec:[0,0,1]}},u.title="Rot. Vec3",u.desc="rotate a point",u.prototype.onExecute=function(){var a=this.getInputData(0);null==a&&(a=this.properties.vec);var b=this.getInputData(1);null==b?this.setOutputData(a):this.setOutputData(0,vec3.transformQuat(vec3.create(),a,b))},C.registerNodeType("math3d/rotate_vec3",u),u=function(){this.addInputs([["A","quat"],["B","quat"]]);this.addOutput("A*B","quat");this._value=quat.create()},u.title="Mult. Quat",u.desc="rotate quaternion",u.prototype.onExecute=function(){var a=
this.getInputData(0);if(null!=a){var b=this.getInputData(1);null!=b&&(a=quat.multiply(this._value,a,b),this.setOutputData(0,a))}},C.registerNodeType("math3d/mult-quat",u),u=function(){this.addInputs([["A","quat"],["B","quat"],["factor","number"]]);this.addOutput("slerp","quat");this.addProperty("factor",0.5);this._value=quat.create()},u.title="Quat Slerp",u.desc="quaternion spherical interpolation",u.prototype.onExecute=function(){var a=this.getInputData(0);if(null!=a){var b=this.getInputData(1);
if(null!=b){var d=this.properties.factor;null!=this.getInputData(2)&&(d=this.getInputData(2));a=quat.slerp(this._value,a,b,d);this.setOutputData(0,a)}}},C.registerNodeType("math3d/quat-slerp",u))})(this);
(function(u){function c(){this.addInput("A","number,vec3");this.addInput("B","number,vec3");this.addOutput("=","vec3");this.addProperty("OP","+","enum",{values:c.values});this._result=vec3.create()}function r(){this.addInput("in","vec3");this.addInput("f","number");this.addOutput("out","vec3");this.properties={f:1};this._data=new Float32Array(3)}function f(){this.addInput("in","vec3");this.addOutput("out","number")}function h(){this.addInput("in","vec3");this.addOutput("out","vec3");this._data=new Float32Array(3)}
function q(){this.addInput("A","vec3");this.addInput("B","vec3");this.addInput("f","vec3");this.addOutput("out","vec3");this.properties={f:0.5};this._data=new Float32Array(3)}function l(){this.addInput("A","vec3");this.addInput("B","vec3");this.addOutput("out","number")}var y=u.LiteGraph;c.values="+ - * / % ^ max min".split(" ");c.title="Operation";c.desc="Easy math 3D operators";c["@OP"]={type:"enum",title:"operation",values:c.values};c.size=[100,60];c.prototype.getTitle=function(){return"max"==
this.properties.OP||"min"==this.properties.OP?this.properties.OP+"(A,B)":"A "+this.properties.OP+" B"};c.prototype.onExecute=function(){var c=this.getInputData(0),f=this.getInputData(1);if(null!=c&&null!=f){c.constructor===Number&&(c=[c,c,c]);f.constructor===Number&&(f=[f,f,f]);var h=this._result;switch(this.properties.OP){case "+":h=vec3.add(h,c,f);break;case "-":h=vec3.sub(h,c,f);break;case "x":case "X":case "*":h=vec3.mul(h,c,f);break;case "/":h=vec3.div(h,c,f);break;case "%":h[0]=c[0]%f[0];h[1]=
c[1]%f[1];h[2]=c[2]%f[2];break;case "^":h[0]=Math.pow(c[0],f[0]);h[1]=Math.pow(c[1],f[1]);h[2]=Math.pow(c[2],f[2]);break;case "max":h[0]=Math.max(c[0],f[0]);h[1]=Math.max(c[1],f[1]);h[2]=Math.max(c[2],f[2]);break;case "min":h[0]=Math.min(c[0],f[0]);h[1]=Math.min(c[1],f[1]);h[2]=Math.min(c[2],f[2]);break;default:console.warn("Unknown operation: "+this.properties.OP)}this.setOutputData(0,h)}};c.prototype.onDrawBackground=function(c){this.flags.collapsed||(c.font="40px Arial",c.fillStyle="#666",c.textAlign=
"center",c.fillText(this.properties.OP,0.5*this.size[0],0.5*(this.size[1]+y.NODE_TITLE_HEIGHT)),c.textAlign="left")};y.registerNodeType("math3d/operation",c);r.title="vec3_scale";r.desc="scales the components of a vec3";r.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null==f&&(f=this.properties.f);var h=this._data;h[0]=c[0]*f;h[1]=c[1]*f;h[2]=c[2]*f;this.setOutputData(0,h)}};y.registerNodeType("math3d/vec3-scale",r);f.title="vec3_length";f.desc="returns the module of a vector";
f.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&(c=Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),this.setOutputData(0,c))};y.registerNodeType("math3d/vec3-length",f);h.title="vec3_normalize";h.desc="returns the vector normalized";h.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),h=this._data;h[0]=c[0]/f;h[1]=c[1]/f;h[2]=c[2]/f;this.setOutputData(0,h)}};y.registerNodeType("math3d/vec3-normalize",h);q.title="vec3_lerp";
q.desc="returns the interpolated vector";q.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);if(null!=f){var h=this.getInputOrProperty("f"),e=this._data;e[0]=c[0]*(1-h)+f[0]*h;e[1]=c[1]*(1-h)+f[1]*h;e[2]=c[2]*(1-h)+f[2]*h;this.setOutputData(0,e)}}};y.registerNodeType("math3d/vec3-lerp",q);l.title="vec3_dot";l.desc="returns the dot product";l.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null!=f&&this.setOutputData(0,
c[0]*f[0]+c[1]*f[1]+c[2]*f[2])}};y.registerNodeType("math3d/vec3-dot",l);u.glMatrix?(u=function(){this.addOutput("quat","quat");this.properties={x:0,y:0,z:0,w:1,normalize:!1};this._value=quat.create()},u.title="Quaternion",u.desc="quaternion",u.prototype.onExecute=function(){this._value[0]=this.getInputOrProperty("x");this._value[1]=this.getInputOrProperty("y");this._value[2]=this.getInputOrProperty("z");this._value[3]=this.getInputOrProperty("w");this.properties.normalize&&quat.normalize(this._value,
this._value);this.setOutputData(0,this._value)},u.prototype.onGetInputs=function(){return[["x","number"],["y","number"],["z","number"],["w","number"]]},y.registerNodeType("math3d/quaternion",u),u=function(){this.addInputs([["degrees","number"],["axis","vec3"]]);this.addOutput("quat","quat");this.properties={angle:90,axis:vec3.fromValues(0,1,0)};this._value=quat.create()},u.title="Rotation",u.desc="quaternion rotation",u.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.angle);
var f=this.getInputData(1);null==f&&(f=this.properties.axis);c=quat.setAxisAngle(this._value,f,0.0174532925*c);this.setOutputData(0,c)},y.registerNodeType("math3d/rotation",u),u=function(){this.addInputs([["vec3","vec3"],["quat","quat"]]);this.addOutput("result","vec3");this.properties={vec:[0,0,1]}},u.title="Rot. Vec3",u.desc="rotate a point",u.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.vec);var f=this.getInputData(1);null==f?this.setOutputData(c):this.setOutputData(0,
vec3.transformQuat(vec3.create(),c,f))},y.registerNodeType("math3d/rotate_vec3",u),u=function(){this.addInputs([["A","quat"],["B","quat"]]);this.addOutput("A*B","quat");this._value=quat.create()},u.title="Mult. Quat",u.desc="rotate quaternion",u.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);null!=f&&(c=quat.multiply(this._value,c,f),this.setOutputData(0,c))}},y.registerNodeType("math3d/mult-quat",u),u=function(){this.addInputs([["A","quat"],["B",
"quat"],["factor","number"]]);this.addOutput("slerp","quat");this.addProperty("factor",0.5);this._value=quat.create()},u.title="Quat Slerp",u.desc="quaternion spherical interpolation",u.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var f=this.getInputData(1);if(null!=f){var h=this.properties.factor;null!=this.getInputData(2)&&(h=this.getInputData(2));c=quat.slerp(this._value,c,f,h);this.setOutputData(0,c)}}},y.registerNodeType("math3d/quat-slerp",u),u=function(){this.addInput("vec3",
"vec3");this.addOutput("remap","vec3");this.addOutput("clamped","vec3");this.properties={clamp:!0,range_min:[-1,-1,0],range_max:[1,1,0],target_min:[-1,-1,0],target_max:[1,1,0]};this._value=vec3.create();this._clamped=vec3.create()},u.title="Remap Range",u.desc="remap a 3D range",u.prototype.onExecute=function(){var c=this.getInputData(0);c&&this._value.set(c);for(var c=this.properties.range_min,f=this.properties.range_max,h=this.properties.target_min,e=this.properties.target_max,l=0;3>l;++l){var k=
f[l]-c[l];this._clamped[l]=Math.clamp(this._value[l],c[l],f[l]);0==k?this._value[l]=0.5*(h[l]+e[l]):(k=(this._value[l]-c[l])/k,this.properties.clamp&&(k=Math.clamp(k,0,1)),this._value[l]=h[l]+k*(e[l]-h[l]))}this.setOutputData(0,this._value);this.setOutputData(1,this._clamped)},y.registerNodeType("math3d/remap_range",u)):console.warn("No glmatrix found, some Math3D nodes may not work")})(this);
(function(u){function c(c,h){return c==h}function r(c){return null!=c&&c.constructor===String?c.toUpperCase():c}u=u.LiteGraph;u.wrapFunctionAsNode("string/toString",c,["*"],"String");u.wrapFunctionAsNode("string/compare",c,["String","String"],"Boolean");u.wrapFunctionAsNode("string/concatenate",function(c,h){return void 0===c?h:void 0===h?c:c+h},["String","String"],"String");u.wrapFunctionAsNode("string/contains",function(c,h){return void 0===c||void 0===h?!1:-1!=c.indexOf(h)},["String","String"],
"Boolean");u.wrapFunctionAsNode("string/toUpperCase",r,["String"],"String");u.wrapFunctionAsNode("string/split",r,["String","String"],"Array");u.wrapFunctionAsNode("string/toFixed",function(c){return null!=c&&c.constructor===Number?c.toFixed(this.properties.precision):c},["Number"],"String",{precision:0})})(this);
(function(u){function c(){this.addInput("sel","number");this.addInput("A");this.addInput("B");this.addInput("C");this.addInput("D");this.addOutput("out");this.selected=0}function r(){this.properties={sequence:"A,B,C"};this.addInput("index","number");this.addInput("seq");this.addOutput("out");this.index=0;this.values=this.properties.sequence.split(",")}var f=u.LiteGraph;c.title="Selector";c.desc="selects an output";c.prototype.onDrawBackground=function(c){if(!this.flags.collapsed){c.fillStyle="#AFB";
var q=(this.selected+1)*f.NODE_SLOT_HEIGHT+6;c.beginPath();c.moveTo(50,q);c.lineTo(50,q+f.NODE_SLOT_HEIGHT);c.lineTo(34,q+0.5*f.NODE_SLOT_HEIGHT);c.fill()}};c.prototype.onExecute=function(){var c=this.getInputData(0);if(null==c||c.constructor!==Number)c=0;this.selected=c=Math.round(c)%(this.inputs.length-1);c=this.getInputData(c+1);void 0!==c&&this.setOutputData(0,c)};c.prototype.onGetInputs=function(){return[["E",0],["F",0],["G",0],["H",0]]};f.registerNodeType("logic/selector",c);r.title="Sequence";
r.desc="select one element from a sequence from a string";r.prototype.onPropertyChanged=function(c,f){"sequence"==c&&(this.values=f.split(","))};r.prototype.onExecute=function(){var c=this.getInputData(1);c&&c!=this.current_sequence&&(this.values=c.split(","),this.current_sequence=c);c=this.getInputData(0);null==c&&(c=0);this.index=c=Math.round(c)%this.values.length;this.setOutputData(0,this.values[c])};f.registerNodeType("logic/sequence",r)})(this);
(function(u){function c(){this.addInput("A","Number");this.addInput("B","Number");this.addInput("C","Number");this.addInput("D","Number");this.values=[[],[],[],[]];this.properties={scale:2}}function r(){this.addOutput("frame","image");this.properties={url:""}}function f(){this.addInput("f","number");this.addOutput("Color","color");this.properties={colorA:"#444444",colorB:"#44AAFF",colorC:"#44FFAA",colorD:"#FFFFFF"}}function h(){this.addInput("","image,canvas");this.size=[200,200]}function q(){this.addInputs([["img1",
...
function e(){this.addOutput("Webcam","image");this.properties={facingMode:"user"};this.boxcolor="black";this.frame=0}var v=u.LiteGraph;c.title="Plot";c.desc="Plots data over time";c.colors=["#FFF","#F99","#9F9","#99F"];c.prototype.onExecute=function(c){if(!this.flags.collapsed){c=this.size;for(var e=0;4>e;++e){var f=this.getInputData(e);if(null!=f){var g=this.values[e];g.push(f);g.length>c[0]&&g.shift()}}}};c.prototype.onDrawBackground=function(e){if(!this.flags.collapsed){var m=this.size,f=0.5*m[1]/
this.properties.scale,g=c.colors,h=0.5*m[1];e.fillStyle="#000";e.fillRect(0,0,m[0],m[1]);e.strokeStyle="#555";e.beginPath();e.moveTo(0,h);e.lineTo(m[0],h);e.stroke();if(this.inputs)for(var n=0;4>n;++n){var a=this.values[n];if(this.inputs[n]&&this.inputs[n].link){e.strokeStyle=g[n];e.beginPath();var b=a[0]*f*-1+h;e.moveTo(0,Math.clamp(b,0,m[1]));for(var d=1;d<a.length&&d<m[0];++d)b=a[d]*f*-1+h,e.lineTo(d,Math.clamp(b,0,m[1]));e.stroke()}}}};v.registerNodeType("graphics/plot",c);r.title="Image";r.desc=
...
this.getInputOrProperty("img");if(e){var f=this.getInputOrProperty("x"),g=this.getInputOrProperty("y");c.getContext("2d").drawImage(e,f,g)}}};v.registerNodeType("graphics/drawImage",s);w.title="DrawRectangle";w.desc="Draws rectangle in canvas";w.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var e=this.getInputOrProperty("x"),f=this.getInputOrProperty("y"),g=this.getInputOrProperty("w"),h=this.getInputOrProperty("h");c.getContext("2d").fillRect(e,f,g,h)}};v.registerNodeType("graphics/drawRectangle",
w);z.title="Video";z.desc="Video playback";z.widgets=[{name:"play",text:"PLAY",type:"minibutton"},{name:"stop",text:"STOP",type:"minibutton"},{name:"demo",text:"Demo video",type:"button"},{name:"mute",text:"Mute video",type:"button"}];z.prototype.onExecute=function(){if(this.properties.url&&(this.properties.url!=this._video_url&&this.loadVideo(this.properties.url),this._video&&0!=this._video.width)){var c=this.getInputData(0);c&&0<=c&&1>=c&&(this._video.currentTime=c*this._video.duration,this._video.pause());
...
"number");this.addOutput("Texture","Texture");this.help="<p>pixelcode must be vec3, uvcode must be vec2, is optional</p>\t\t<p><strong>uv:</strong> tex. coords</p><p><strong>color:</strong> texture <strong>colorB:</strong> textureB</p><p><strong>time:</strong> scene time <strong>value:</strong> input value</p><p>For multiline you must type: result = ...</p>";this.properties={value:1,pixelcode:"color + colorB * value",uvcode:"",precision:c.DEFAULT};this.has_error=!1}function q(){this.addOutput("out",
...
g=0;g<this.inputs.length;++g){var f=this.getInputInfo(g);f&&(d[f.name]&&!e[f.name]?e[f.name]=!0:(this.removeInput(g),g--))}for(g in d)if(f=c.uniformInfo[g],null!==f.loc&&"time"!=g){d="number";if(this._shader.samplers[g])d="texture";else switch(f.size){case 1:d="number";break;case 2:d="vec2";break;case 3:d="vec3";break;case 4:d="vec4";break;case 9:d="mat3";break;case 16:d="mat4";break;default:continue}f=this.findInputSlot(g);-1==f?this.addInput(g,d):(e=this.getInputInfo(f),e)?e.type!=d&&(this.removeInput(f,
d),this.addInput(g,d)):this.addInput(g,d)}}}},q.prototype.getShader=function(){if(this._shader&&this._shader_code==this.properties.code)return this._shader;this._shader_code=this.properties.code;if(this._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,q.pixel_shader+this.properties.code))this.boxcolor="green";else return this.boxcolor="red",null;return this._shader},q.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getShader();if(a){var b=0,d=null;if(this.inputs)for(var e=
0;e<this.inputs.length;++e){var g=this.getInputInfo(e),f=this.getInputData(e);null!=f&&(f.constructor===GL.Texture&&(f.bind(b),d||(d=f),f=b,b++),a.setUniform(g.name,f))}var k=this._uniforms,b=c.getTextureType(this.properties.precision,d),e=this.properties.width|0,g=this.properties.height|0;0==e&&(e=d?d.width:gl.canvas.width);0==g&&(g=d?d.height:gl.canvas.height);k.texSize[0]=e;k.texSize[1]=g;k.time=this.graph.getTime();k.u_value=this.properties.u_value;k.u_color.set(this.properties.u_color);this._tex&&
this._tex.type==b&&this._tex.width==e&&this._tex.height==g||(this._tex=new GL.Texture(e,g,{type:b,format:gl.RGBA,filter:gl.LINEAR}));this._tex.drawTo(function(){a.uniforms(k).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._tex)}}},q.pixel_shader="precision highp float;\n\t\t\n\t\tvarying vec2 v_coord;\n\t\tuniform float time;\n",E.registerNodeType("texture/shader",q),l.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},l.title="Scale/Offset",l.desc="Applies an scaling and offseting",
l.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0)&&a)if(this.properties.precision===c.PASS_THROUGH)this.setOutputData(0,a);else{var b=a.width,d=a.height,e=this.precision===c.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT;this.precision===c.DEFAULT&&(e=a.type);this._tex&&this._tex.width==b&&this._tex.height==d&&this._tex.type==e||(this._tex=new GL.Texture(b,d,{type:e,format:gl.RGBA,filter:gl.LINEAR}));var g=this._shader;g||(g=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,
l.pixel_shader));var f=this.getInputData(1);f?(this.properties.scale[0]=f[0],this.properties.scale[1]=f[1]):f=this.properties.scale;var k=this.getInputData(2);k?(this.properties.offset[0]=k[0],this.properties.offset[1]=k[1]):k=this.properties.offset;this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);a.bind(0);var b=Mesh.getScreenQuad();g.uniforms({u_texture:0,u_scale:f,u_offset:k}).draw(b)});this.setOutputData(0,this._tex)}},l.pixel_shader="precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv = uv / u_scale - u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t",
E.registerNodeType("texture/scaleOffset",l),y.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},y.title="Warp",y.desc="Texture warp operation",y.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===c.PASS_THROUGH)this.setOutputData(0,a);else{var b=this.getInputData(1),d=512,e=512;a?(d=a.width,e=a.height):b&&(d=b.width,e=b.height);this._tex=a||this._tex?c.getTargetTexture(a||this._tex,this._tex,this.properties.precision):
new GL.Texture(d,e,{type:this.precision===c.LOW?gl.UNSIGNED_BYTE:gl.HIGH_PRECISION_FORMAT,format:gl.RGBA,filter:gl.LINEAR});var g=this._shader;g||(g=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,y.pixel_shader));d=this.getInputData(2);null!=d?this.properties.factor=d:d=parseFloat(this.properties.factor);var f=this._uniforms;f.u_factor=d;f.u_scale.set(this.properties.scale);f.u_offset.set(this.properties.offset);this._tex.drawTo(function(){gl.disable(gl.DEPTH_TEST);gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);
a&&a.bind(0);b&&b.bind(1);var c=Mesh.getScreenQuad();g.uniforms(f).draw(c)});this.setOutputData(0,this._tex)}},y.pixel_shader="precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_factor;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor * u_scale + u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t",
E.registerNodeType("texture/warp",y),s.title="to Viewport",s.desc="Texture to viewport",s.prototype.onExecute=function(){var a=this.getInputData(0);if(a){this.properties.disable_alpha?gl.disable(gl.BLEND):(gl.enable(gl.BLEND),this.properties.additive?gl.blendFunc(gl.SRC_ALPHA,gl.ONE):gl.blendFunc(gl.SRC_ALPHA,gl.ONE_MINUS_SRC_ALPHA));gl.disable(gl.DEPTH_TEST);var b=this.properties.gamma||1;this.isInputConnected(1)&&(b=this.getInputData(1));a.setParameter(gl.TEXTURE_MAG_FILTER,this.properties.filter?
gl.LINEAR:gl.NEAREST);if(this.properties.antialiasing){s._shader||(s._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,s.aa_pixel_shader));gl.getViewport();var c=Mesh.getScreenQuad();a.bind(0);s._shader.uniforms({u_texture:0,uViewportSize:[a.width,a.height],u_igamma:1/b,inverseVP:[1/a.width,1/a.height]}).draw(c)}else 1!=b?(s._gamma_shader||(s._gamma_shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,s.gamma_pixel_shader)),a.toViewport(s._gamma_shader,{u_texture:0,u_igamma:1/b})):a.toViewport()}},
s.prototype.onGetInputs=function(){return[["gamma","number"]]},s.aa_pixel_shader="precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform vec2 uViewportSize;\n\t\tuniform vec2 inverseVP;\n\t\tuniform float u_igamma;\n\t\t#define FXAA_REDUCE_MIN   (1.0/ 128.0)\n\t\t#define FXAA_REDUCE_MUL   (1.0 / 8.0)\n\t\t#define FXAA_SPAN_MAX     8.0\n\t\t\n\t\t/* from mitsuhiko/webgl-meincraft based on the code on geeks3d.com */\n\t\tvec4 applyFXAA(sampler2D tex, vec2 fragCoord)\n\t\t{\n\t\t\tvec4 color = vec4(0.0);\n\t\t\t/*vec2 inverseVP = vec2(1.0 / uViewportSize.x, 1.0 / uViewportSize.y);*/\n\t\t\tvec3 rgbNW = texture2D(tex, (fragCoord + vec2(-1.0, -1.0)) * inverseVP).xyz;\n\t\t\tvec3 rgbNE = texture2D(tex, (fragCoord + vec2(1.0, -1.0)) * inverseVP).xyz;\n\t\t\tvec3 rgbSW = texture2D(tex, (fragCoord + vec2(-1.0, 1.0)) * inverseVP).xyz;\n\t\t\tvec3 rgbSE = texture2D(tex, (fragCoord + vec2(1.0, 1.0)) * inverseVP).xyz;\n\t\t\tvec3 rgbM  = texture2D(tex, fragCoord  * inverseVP).xyz;\n\t\t\tvec3 luma = vec3(0.299, 0.587, 0.114);\n\t\t\tfloat lumaNW = dot(rgbNW, luma);\n\t\t\tfloat lumaNE = dot(rgbNE, luma);\n\t\t\tfloat lumaSW = dot(rgbSW, luma);\n\t\t\tfloat lumaSE = dot(rgbSE, luma);\n\t\t\tfloat lumaM  = dot(rgbM,  luma);\n\t\t\tfloat lumaMin = min(lumaM, min(min(lumaNW, lumaNE), min(lumaSW, lumaSE)));\n\t\t\tfloat lumaMax = max(lumaM, max(max(lumaNW, lumaNE), max(lumaSW, lumaSE)));\n\t\t\t\n\t\t\tvec2 dir;\n\t\t\tdir.x = -((lumaNW + lumaNE) - (lumaSW + lumaSE));\n\t\t\tdir.y =  ((lumaNW + lumaSW) - (lumaNE + lumaSE));\n\t\t\t\n\t\t\tfloat dirReduce = max((lumaNW + lumaNE + lumaSW + lumaSE) * (0.25 * FXAA_REDUCE_MUL), FXAA_REDUCE_MIN);\n\t\t\t\n\t\t\tfloat rcpDirMin = 1.0 / (min(abs(dir.x), abs(dir.y)) + dirReduce);\n\t\t\tdir = min(vec2(FXAA_SPAN_MAX, FXAA_SPAN_MAX), max(vec2(-FXAA_SPAN_MAX, -FXAA_SPAN_MAX), dir * rcpDirMin)) * inverseVP;\n\t\t\t\n\t\t\tvec3 rgbA = 0.5 * (texture2D(tex, fragCoord * inverseVP + dir * (1.0 / 3.0 - 0.5)).xyz + \n\t\t\t\ttexture2D(tex, fragCoord * inverseVP + dir * (2.0 / 3.0 - 0.5)).xyz);\n\t\t\tvec3 rgbB = rgbA * 0.5 + 0.25 * (texture2D(tex, fragCoord * inverseVP + dir * -0.5).xyz + \n\t\t\t\ttexture2D(tex, fragCoord * inverseVP + dir * 0.5).xyz);\n\t\t\t\n\t\t\t//return vec4(rgbA,1.0);\n\t\t\tfloat lumaB = dot(rgbB, luma);\n\t\t\tif ((lumaB < lumaMin) || (lumaB > lumaMax))\n\t\t\t\tcolor = vec4(rgbA, 1.0);\n\t\t\telse\n\t\t\t\tcolor = vec4(rgbB, 1.0);\n\t\t\tif(u_igamma != 1.0)\n\t\t\t\tcolor.xyz = pow( color.xyz, vec3(u_igamma) );\n\t\t\treturn color;\n\t\t}\n\t\t\n\t\tvoid main() {\n\t\t   gl_FragColor = applyFXAA( u_texture, v_coord * uViewportSize) ;\n\t\t}\n\t\t",
...
a)&&(this._tex_color.set(a),this._tex.fill(a));this.setOutputData(0,this._tex)},a.prototype.onGetInputs=function(){return[["RGB","vec3"],["RGBA","vec4"],["R","number"],["G","number"],["B","number"],["A","number"]]},E.registerNodeType("texture/color",a),b.title="Gradient",b.desc="Generates a gradient",b["@A"]={type:"color"},b["@B"]={type:"color"},b["@texture_size"]={type:"enum",values:[32,64,128,256,512]},b.prototype.onExecute=function(){gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var a=GL.Mesh.getScreenQuad(),
c=b._shader,d=this.getInputData(0);d||(d=this.properties.A);var e=this.getInputData(1);e||(e=this.properties.B);for(var g=2;g<this.inputs.length;g++){var f=this.inputs[g],k=this.getInputData(g);void 0!==k&&(this.properties[f.name]=k)}var m=this._uniforms;this._uniforms.u_angle=this.properties.angle*DEG2RAD;this._uniforms.u_scale=this.properties.scale;vec3.copy(m.u_colorA,d);vec3.copy(m.u_colorB,e);d=parseInt(this.properties.texture_size);this._tex&&this._tex.width==d||(this._tex=new GL.Texture(d,
d,{format:gl.RGB,filter:gl.LINEAR}));this._tex.drawTo(function(){c.uniforms(m).draw(a)});this.setOutputData(0,this._tex)},b.prototype.onGetInputs=function(){return[["angle","number"],["scale","number"]]},b.pixel_shader="precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_angle;\n\t\tuniform float u_scale;\n\t\tuniform vec3 u_colorA;\n\t\tuniform vec3 u_colorB;\n\t\t\n\t\tvec2 rotate(vec2 v, float angle)\n\t\t{\n\t\t\tvec2 result;\n\t\t\tfloat _cos = cos(angle);\n\t\t\tfloat _sin = sin(angle);\n\t\t\tresult.x = v.x * _cos - v.y * _sin;\n\t\t\tresult.y = v.x * _sin + v.y * _cos;\n\t\t\treturn result;\n\t\t}\n\t\tvoid main() {\n\t\t\tfloat f = (rotate(u_scale * (v_coord - vec2(0.5)), u_angle) + vec2(0.5)).x;\n\t\t\tvec3 color = mix(u_colorA,u_colorB,clamp(f,0.0,1.0));\n\t\t   gl_FragColor = vec4(color,1.0);\n\t\t}\n\t\t",
E.registerNodeType("texture/gradient",b),d.title="Mix",d.desc="Generates a texture mixing two textures",d.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},d.prototype.onExecute=function(){var a=this.getInputData(0);if(this.isOutputConnected(0))if(this.properties.precision===c.PASS_THROUGH)this.setOutputData(0,a);else{var b=this.getInputData(1);if(a&&b){var e=this.getInputData(2),g=this.getInputData(3);this._tex=c.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);
gl.disable(gl.DEPTH_TEST);var f=Mesh.getScreenQuad(),k=null,m=this._uniforms;e?(k=d._shader_tex,k||(k=d._shader_tex=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,d.pixel_shader,{MIX_TEX:""}))):(k=d._shader_factor,k||(k=d._shader_factor=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,d.pixel_shader)),g=null==g?this.properties.factor:g,m.u_mix.set([g,g,g,g]));this._tex.drawTo(function(){a.bind(0);b.bind(1);e&&e.bind(2);k.uniforms(m).draw(f)});this.setOutputData(0,this._tex)}}},d.prototype.onGetInputs=function(){return[["factor",
"number"]]},d.pixel_shader="precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_textureA;\n\t\tuniform sampler2D u_textureB;\n\t\t#ifdef MIX_TEX\n\t\t\tuniform sampler2D u_textureMix;\n\t\t#else\n\t\t\tuniform vec4 u_mix;\n\t\t#endif\n\t\t\n\t\tvoid main() {\n\t\t\t#ifdef MIX_TEX\n\t\t\t   vec4 f = texture2D(u_textureMix, v_coord);\n\t\t\t#else\n\t\t\t   vec4 f = u_mix;\n\t\t\t#endif\n\t\t   gl_FragColor = mix( texture2D(u_textureA, v_coord), texture2D(u_textureB, v_coord), f );\n\t\t}\n\t\t",
E.registerNodeType("texture/mix",d),x.title="Edges",x.desc="Detects edges",x.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},x.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);if(this.properties.precision===c.PASS_THROUGH)this.setOutputData(0,a);else if(a){this._tex=c.getTargetTexture(a,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var b=Mesh.getScreenQuad(),d=x._shader,e=this.properties.invert,g=this.properties.factor,
f=this.properties.threshold?1:0;this._tex.drawTo(function(){a.bind(0);d.uniforms({u_texture:0,u_isize:[1/a.width,1/a.height],u_factor:g,u_threshold:f,u_invert:e?1:0}).draw(b)});this.setOutputData(0,this._tex)}}},x.pixel_shader="precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform vec2 u_isize;\n\t\tuniform int u_invert;\n\t\tuniform float u_factor;\n\t\tuniform float u_threshold;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 center = texture2D(u_texture, v_coord);\n\t\t\tvec4 up = texture2D(u_texture, v_coord + u_isize * vec2(0.0,1.0) );\n\t\t\tvec4 down = texture2D(u_texture, v_coord + u_isize * vec2(0.0,-1.0) );\n\t\t\tvec4 left = texture2D(u_texture, v_coord + u_isize * vec2(1.0,0.0) );\n\t\t\tvec4 right = texture2D(u_texture, v_coord + u_isize * vec2(-1.0,0.0) );\n\t\t\tvec4 diff = abs(center - up) + abs(center - down) + abs(center - left) + abs(center - right);\n\t\t\tdiff *= u_factor;\n\t\t\tif(u_invert == 1)\n\t\t\t\tdiff.xyz = vec3(1.0) - diff.xyz;\n\t\t\tif( u_threshold == 0.0 )\n\t\t\t\tgl_FragColor = vec4( diff.xyz, center.a );\n\t\t\telse\n\t\t\t\tgl_FragColor = vec4( diff.x > 0.5 ? 1.0 : 0.0, diff.y > 0.5 ? 1.0 : 0.0, diff.z > 0.5 ? 1.0 : 0.0, center.a );\n\t\t}\n\t\t",
...
(c=this.getInputData(1),this.properties.iterations=c);c=Math.min(Math.floor(c),K.max_iterations);if(0==c)this.setOutputData(0,a);else{var d=this.properties.intensity;this.isInputConnected(2)&&(d=this.getInputData(2),this.properties.intensity=d);var e=E.camera_aspect;e||void 0===window.gl||(e=gl.canvas.height/gl.canvas.width);e||(e=1);var e=this.properties.preserve_aspect?e:1,g=this.properties.scale||[1,1];a.applyBlur(e*g[0],g[1],d,b);for(a=1;a<c;++a)b.applyBlur(e*g[0]*(a+1),g[1]*(a+1),d);this.setOutputData(0,
b)}}},E.registerNodeType("texture/blur",K),A.title="Glow",A.desc="Filters a texture giving it a glow effect",A.weights=new Float32Array([0.5,0.4,0.3,0.2]),A.widgets_info={iterations:{type:"number",min:0,max:16,step:1,precision:0},threshold:{type:"number",min:0,max:10,step:0.01,precision:2},precision:{widget:"combo",values:c.MODE_VALUES}},A.prototype.onGetInputs=function(){return[["enabled","boolean"],["threshold","number"],["intensity","number"],["persistence","number"],["iterations","number"],["dirt_factor",
"number"]]},A.prototype.onGetOutputs=function(){return[["average","Texture"]]},A.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isAnyOutputConnected())if(this.properties.precision===c.PASS_THROUGH||!1===this.getInputOrProperty("enabled"))this.setOutputData(0,a);else{var b=a.width,d=a.height,e={format:a.format,type:a.type,minFilter:GL.LINEAR,magFilter:GL.LINEAR,wrap:gl.CLAMP_TO_EDGE},g=c.getTextureType(this.properties.precision,a),f=this._uniforms,k=this._textures,m=A._cut_shader;
m||(m=A._cut_shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,A.cut_pixel_shader));gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);f.u_threshold=this.getInputOrProperty("threshold");var h=k[0]=GL.Texture.getTemporary(b,d,e);a.blit(h,m.uniforms(f));var n=h,l=this.getInputOrProperty("iterations"),l=Math.clamp(l,1,16)|0,t=f.u_texel_size,p=this.getInputOrProperty("intensity");f.u_intensity=1;f.u_delta=this.properties.scale;m=A._shader;m||(m=A._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,A.scale_pixel_shader));
for(var q=1;q<l;q++){b>>=1;1<(d|0)&&(d>>=1);if(2>b)break;h=k[q]=GL.Texture.getTemporary(b,d,e);t[0]=1/n.width;t[1]=1/n.height;n.blit(h,m.uniforms(f));n=h}this.isOutputConnected(2)&&(b=this._average_texture,b&&b.type==a.type&&b.format==a.format||(b=this._average_texture=new GL.Texture(1,1,{type:a.type,format:a.format,filter:gl.LINEAR})),t[0]=1/n.width,t[1]=1/n.height,f.u_intensity=p,f.u_delta=1,n.blit(b,m.uniforms(f)),this.setOutputData(2,b));gl.enable(gl.BLEND);gl.blendFunc(gl.ONE,gl.ONE);f.u_intensity=
...
this._video_texture);this.setOutputData(0,this._video_texture);for(a=1;a<this.outputs.length;++a)if(this.outputs[a])switch(this.outputs[a].name){case "width":this.setOutputData(a,this._video.videoWidth);break;case "height":this.setOutputData(a,this._video.videoHeight)}}},F.prototype.onGetOutputs=function(){return[["width","number"],["height","number"],["stream_ready",E.EVENT],["stream_closed",E.EVENT],["stream_error",E.EVENT]]},E.registerNodeType("texture/webcam",F),I.title="Lens FX",I.desc="distortion and chromatic aberration",
...
filter:gl.LINEAR}));var d=I._shader;d||(d=I._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,I.pixel_shader));var e=this.getInputData(1);null==e&&(e=this.properties.factor);var g=this._uniforms;g.u_factor=e;gl.disable(gl.DEPTH_TEST);b.drawTo(function(){a.bind(0);d.uniforms(g).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,b)}},I.pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_factor;\n\t\tvec2 barrelDistortion(vec2 coord, float amt) {\n\t\t\tvec2 cc = coord - 0.5;\n\t\t\tfloat dist = dot(cc, cc);\n\t\t\treturn coord + cc * dist * amt;\n\t\t}\n\t\t\n\t\tfloat sat( float t )\n\t\t{\n\t\t\treturn clamp( t, 0.0, 1.0 );\n\t\t}\n\t\t\n\t\tfloat linterp( float t ) {\n\t\t\treturn sat( 1.0 - abs( 2.0*t - 1.0 ) );\n\t\t}\n\t\t\n\t\tfloat remap( float t, float a, float b ) {\n\t\t\treturn sat( (t - a) / (b - a) );\n\t\t}\n\t\t\n\t\tvec4 spectrum_offset( float t ) {\n\t\t\tvec4 ret;\n\t\t\tfloat lo = step(t,0.5);\n\t\t\tfloat hi = 1.0-lo;\n\t\t\tfloat w = linterp( remap( t, 1.0/6.0, 5.0/6.0 ) );\n\t\t\tret = vec4(lo,1.0,hi, 1.) * vec4(1.0-w, w, 1.0-w, 1.);\n\t\t\n\t\t\treturn pow( ret, vec4(1.0/2.2) );\n\t\t}\n\t\t\n\t\tconst float max_distort = 2.2;\n\t\tconst int num_iter = 12;\n\t\tconst float reci_num_iter_f = 1.0 / float(num_iter);\n\t\t\n\t\tvoid main()\n\t\t{\t\n\t\t\tvec2 uv=v_coord;\n\t\t\tvec4 sumcol = vec4(0.0);\n\t\t\tvec4 sumw = vec4(0.0);\t\n\t\t\tfor ( int i=0; i<num_iter;++i )\n\t\t\t{\n\t\t\t\tfloat t = float(i) * reci_num_iter_f;\n\t\t\t\tvec4 w = spectrum_offset( t );\n\t\t\t\tsumw += w;\n\t\t\t\tsumcol += w * texture2D( u_texture, barrelDistortion(uv, .6 * max_distort*t * u_factor ) );\n\t\t\t}\n\t\t\tgl_FragColor = sumcol / sumw;\n\t\t}",
E.registerNodeType("texture/lensfx",I),C.title="Exposition",C.desc="Controls texture exposition",C.widgets_info={exposition:{widget:"slider",min:0,max:3},precision:{widget:"combo",values:c.MODE_VALUES}},C.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0)){var b=this._temp_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var c=C._shader;c||(c=
C._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,C.pixel_shader));var d=this.getInputData(1);null!=d&&(this.properties.exposition=d);var e=this._uniforms;b.drawTo(function(){gl.disable(gl.DEPTH_TEST);a.bind(0);c.uniforms(e).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,b)}},C.pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_exposition;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\t\t\tgl_FragColor = vec4( color.xyz * u_exposition, color.a );\n\t\t}",
E.registerNodeType("texture/exposition",C),B.title="Tone Mapping",B.desc="Applies Tone Mapping to convert from high to low",B.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES}},B.prototype.onGetInputs=function(){return[["enabled","boolean"]]},B.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0))if(this.properties.precision===c.PASS_THROUGH||!1===this.getInputOrProperty("enabled"))this.setOutputData(0,a);else{var b=this._temp_texture;b&&b.width==a.width&&
b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var d=this.getInputData(1);null==d&&(d=this.properties.average_lum);var e=this._uniforms,g=null;d.constructor===Number?(this.properties.average_lum=d,e.u_average_lum=this.properties.average_lum,g=B._shader,g||(g=B._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,B.pixel_shader))):d.constructor===GL.Texture&&(e.u_average_texture=d.bind(1),g=B._shader_texture,
g||(g=B._shader_texture=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,B.pixel_shader,{AVG_TEXTURE:""})));e.u_lumwhite2=this.properties.lum_white*this.properties.lum_white;e.u_scale=this.properties.scale;e.u_igamma=1/this.properties.gamma;gl.disable(gl.DEPTH_TEST);b.drawTo(function(){a.bind(0);g.uniforms(e).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,this._temp_texture)}},B.pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_scale;\n\t\t#ifdef AVG_TEXTURE\n\t\t\tuniform sampler2D u_average_texture;\n\t\t#else\n\t\t\tuniform float u_average_lum;\n\t\t#endif\n\t\tuniform float u_lumwhite2;\n\t\tuniform float u_igamma;\n\t\tvec3 RGB2xyY (vec3 rgb)\n\t\t{\n\t\t\t const mat3 RGB2XYZ = mat3(0.4124, 0.3576, 0.1805,\n\t\t\t\t\t\t\t\t\t   0.2126, 0.7152, 0.0722,\n\t\t\t\t\t\t\t\t\t   0.0193, 0.1192, 0.9505);\n\t\t\tvec3 XYZ = RGB2XYZ * rgb;\n\t\t\t\n\t\t\tfloat f = (XYZ.x + XYZ.y + XYZ.z);\n\t\t\treturn vec3(XYZ.x / f,\n\t\t\t\t\t\tXYZ.y / f,\n\t\t\t\t\t\tXYZ.y);\n\t\t}\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\t\t\tvec3 rgb = color.xyz;\n\t\t\tfloat average_lum = 0.0;\n\t\t\t#ifdef AVG_TEXTURE\n\t\t\t\tvec3 pixel = texture2D(u_average_texture,vec2(0.5)).xyz;\n\t\t\t\taverage_lum = (pixel.x + pixel.y + pixel.z) / 3.0;\n\t\t\t#else\n\t\t\t\taverage_lum = u_average_lum;\n\t\t\t#endif\n\t\t\t//Ld - this part of the code is the same for both versions\n\t\t\tfloat lum = dot(rgb, vec3(0.2126, 0.7152, 0.0722));\n\t\t\tfloat L = (u_scale / average_lum) * lum;\n\t\t\tfloat Ld = (L * (1.0 + L / u_lumwhite2)) / (1.0 + L);\n\t\t\t//first\n\t\t\t//vec3 xyY = RGB2xyY(rgb);\n\t\t\t//xyY.z *= Ld;\n\t\t\t//rgb = xyYtoRGB(xyY);\n\t\t\t//second\n\t\t\trgb = (rgb / lum) * Ld;\n\t\t\trgb = pow( rgb, vec3( u_igamma ) );\n\t\t\tgl_FragColor = vec4( rgb, color.a );\n\t\t}",
E.registerNodeType("texture/tonemapping",B),J.title="Perlin",J.desc="Generates a perlin noise texture",J.widgets_info={precision:{widget:"combo",values:c.MODE_VALUES},width:{type:"Number",precision:0,step:1},height:{type:"Number",precision:0,step:1},octaves:{type:"Number",precision:0,step:1,min:1,max:50}},J.prototype.onGetInputs=function(){return[["seed","Number"],["persistence","Number"],["octaves","Number"],["scale","Number"],["amplitude","Number"],["offset","vec2"]]},J.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=
this.properties.width|0,b=this.properties.height|0;0==a&&(a=gl.viewport_data[2]);0==b&&(b=gl.viewport_data[3]);var d=c.getTextureType(this.properties.precision),e=this._texture;e&&e.width==a&&e.height==b&&e.type==d||(e=this._texture=new GL.Texture(a,b,{type:d,format:gl.RGB,filter:gl.LINEAR}));var g=this.getInputOrProperty("persistence"),f=this.getInputOrProperty("octaves"),k=this.getInputOrProperty("offset"),m=this.getInputOrProperty("scale"),h=this.getInputOrProperty("amplitude"),n=this.getInputOrProperty("seed"),
d=""+a+b+d+g+f+m+n+k[0]+k[1]+h;if(d!=this._key){this._key=d;var l=this._uniforms;l.u_persistence=g;l.u_octaves=f;l.u_offset.set(k);l.u_scale=m;l.u_amplitude=h;l.u_seed=128*n;l.u_viewport[0]=a;l.u_viewport[1]=b;var t=J._shader;t||(t=J._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,J.pixel_shader));gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);e.drawTo(function(){t.uniforms(l).draw(GL.Mesh.getScreenQuad())})}this.setOutputData(0,e)}},J.pixel_shader="precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform vec2 u_offset;\n\t\tuniform float u_scale;\n\t\tuniform float u_persistence;\n\t\tuniform int u_octaves;\n\t\tuniform float u_amplitude;\n\t\tuniform vec2 u_viewport;\n\t\tuniform float u_seed;\n\t\t#define M_PI 3.14159265358979323846\n\t\t\n\t\tfloat rand(vec2 c){\treturn fract(sin(dot(c.xy ,vec2( 12.9898 + u_seed,78.233 + u_seed))) * 43758.5453); }\n\t\t\n\t\tfloat noise(vec2 p, float freq ){\n\t\t\tfloat unit = u_viewport.x/freq;\n\t\t\tvec2 ij = floor(p/unit);\n\t\t\tvec2 xy = mod(p,unit)/unit;\n\t\t\t//xy = 3.*xy*xy-2.*xy*xy*xy;\n\t\t\txy = .5*(1.-cos(M_PI*xy));\n\t\t\tfloat a = rand((ij+vec2(0.,0.)));\n\t\t\tfloat b = rand((ij+vec2(1.,0.)));\n\t\t\tfloat c = rand((ij+vec2(0.,1.)));\n\t\t\tfloat d = rand((ij+vec2(1.,1.)));\n\t\t\tfloat x1 = mix(a, b, xy.x);\n\t\t\tfloat x2 = mix(c, d, xy.x);\n\t\t\treturn mix(x1, x2, xy.y);\n\t\t}\n\t\t\n\t\tfloat pNoise(vec2 p, int res){\n\t\t\tfloat persistance = u_persistence;\n\t\t\tfloat n = 0.;\n\t\t\tfloat normK = 0.;\n\t\t\tfloat f = 4.;\n\t\t\tfloat amp = 1.0;\n\t\t\tint iCount = 0;\n\t\t\tfor (int i = 0; i<50; i++){\n\t\t\t\tn+=amp*noise(p, f);\n\t\t\t\tf*=2.;\n\t\t\t\tnormK+=amp;\n\t\t\t\tamp*=persistance;\n\t\t\t\tif (iCount >= res)\n\t\t\t\t\tbreak;\n\t\t\t\tiCount++;\n\t\t\t}\n\t\t\tfloat nf = n/normK;\n\t\t\treturn nf*nf*nf*nf;\n\t\t}\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord * u_scale * u_viewport + u_offset * u_scale;\n\t\t\tvec4 color = vec4( pNoise( uv, u_octaves ) * u_amplitude );\n\t\t\tgl_FragColor = color;\n\t\t}",
...
for(f=0;f<n;++f)for(h=0;h<n;++h)l=3*f+3*h*n,g[l]=(f/n-0.5)*e*2,g[l+1]=0,g[l+2]=(h/n-0.5)*e*2;g=new Float32Array(g.subarray(0,n*n*3))}else if(h==c.SPHERE){var n=Math.floor(Math.sqrt(f)),a=vec3.create();for(f=0;f<n;++f)for(h=0;h<n;++h)l=3*f+3*h*n,polarToCartesian(a,f/n*2*Math.PI,2*(h/n-0.5)*Math.PI,e),g[l]=a[0],g[l+1]=a[1],g[l+2]=a[2];g=new Float32Array(g.subarray(0,n*n*3))}else{if(h==c.CIRCLE)for(f=0;f<n;f+=3)h=f/n*Math.PI*2,g[f]=Math.cos(h)*e,g[f+1]=0,g[f+2]=Math.sin(h)*e}else if(h==c.RECTANGLE)for(f=
0;f<n;f+=3)g[f]=(Math.random()-0.5)*e*2,g[f+1]=0,g[f+2]=(Math.random()-0.5)*e*2;else if(h==c.CUBE)for(f=0;f<n;f+=3)g[f]=(Math.random()-0.5)*e*2,g[f+1]=(Math.random()-0.5)*e*2,g[f+2]=(Math.random()-0.5)*e*2;else if(h==c.SPHERE)for(f=0;f<n;f+=3){var a=Math.random(),b=Math.random();h=2*Math.cos(2*Math.PI*a)*Math.sqrt(b*(1-b));l=1-2*b;a=2*Math.sin(2*Math.PI*a)*Math.sqrt(b*(1-b));g[f]=h*e;g[f+1]=l*e;g[f+2]=a*e}else if(h==c.HEMISPHERE)for(f=0;f<n;f+=3)a=Math.random(),b=Math.random(),h=Math.cos(2*Math.PI*
a)*Math.sqrt(1-b*b),l=b,a=Math.sin(2*Math.PI*a)*Math.sqrt(1-b*b),g[f]=h*e,g[f+1]=l*e,g[f+2]=a*e;else if(h==c.CIRCLE)for(f=0;f<n;f+=3)a=Math.random(),b=Math.random(),h=Math.cos(2*Math.PI*a)*Math.sqrt(1-b*b),a=Math.sin(2*Math.PI*a)*Math.sqrt(1-b*b),g[f]=h*e,g[f+1]=0,g[f+2]=a*e;else if(h==c.INSIDE_SPHERE)for(f=0;f<n;f+=3){l=Math.random();h=Math.random();b=2*l*Math.PI;a=Math.acos(2*h-1);h=Math.cbrt(Math.random())*e;l=Math.sin(b);var b=Math.cos(b),d=Math.sin(a),a=Math.cos(a);g[f]=h*d*b;g[f+1]=h*d*l;g[f+
2]=h*a}else console.warn("wrong mode in LGraphPoints3D");return g};c.prototype.updatePoints=function(){var e=this.properties.num_points|0;1>e&&(e=1);this.points.length!=3*e&&(this.points=new Float32Array(3*e));this.points=c.generatePoints(this.properties.radius,e,this.properties.mode,this.points,this.properties.regular);this.version++};y.registerNodeType("geometry/points3D",c);r.title="to geometry";r.desc="converts a mesh to geometry";r.prototype.onExecute=function(){var c=this.getInputData(0);if(c){if(c!=
...
0;g<l.length;g+=3)h[0]=l[g],h[1]=l[g+1],h[2]=l[g+2],e(h,g/3,f),l[g]=h[0],l[g+1]=h[1],l[g+2]=h[2];this.geometry.vertices=l}this.setOutputData(0,this.geometry)}else this.setOutputData(0,c)};y.registerNodeType("geometry/eval",f);h.title="connect points";h.desc="adds indices between near points";h.prototype.onPropertyChanged=function(c,e){this.must_update=!0};h.prototype.onExecute=function(){var c=this.getInputData(0);if(c){if(this.geometry_id!=c._id||this.version!=c._version||this.must_update){this.must_update=
!1;this.geometry_id=c._id;this.version=c._version;this.geometry={};for(var e in c)this.geometry[e]=c[e];this.geometry._id=1E5*Math.random()|0;this.geometry._version=this.my_version++;var c=c.vertices,f=c.length,g=this.properties.min_dist,h=this.properties.max_dist,l=this.properties.probability,a=this.properties.max_connections,b=[];for(e=0;e<f;e+=3)for(var d=c[e],q=c[e+1],p=c[e+2],s=0,r=e+3;r<f;r+=3){var w=c[r],y=c[r+1],v=c[r+2],w=Math.sqrt((d-w)*(d-w)+(q-y)*(q-y)+(p-v)*(p-v));if(!(w>h||w<g||1>l&&
l<Math.random())&&(b.push(e/3,r/3),s+=1,a&&s>a))break}this.geometry.indices=this.indices=new Uint32Array(b)}this.indices&&this.indices.length?(this.geometry.indices=this.indices,this.setOutputData(0,this.geometry)):this.setOutputData(0,null)}};y.registerNodeType("geometry/connectPoints",h);"undefined"!=typeof GL&&(q.title="render",q.desc="renders a geometry",q.PRIMITIVE_VALUES={points:GL.POINTS,lines:GL.LINES,line_loop:GL.LINE_LOOP,line_strip:GL.LINE_STRIP,triangles:GL.TRIANGLES,triangle_fan:GL.TRIANGLE_FAN,
...
h),e=new Float32Array(q*r*2),v=-1,k=2/c*h,m=2/f*h,u=0;u<r;++u){for(var g=-1,t=0;t<q;++t){var n=u*q*2+2*t;e[n]=g;e[n+1]=v;g+=k}v+=m}this._points_mesh=GL.Mesh.load({vertices2D:e});this._points_mesh._width=c;this._points_mesh._height=f;this._points_mesh._spacing=h;return this._points_mesh};f._first_pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_texture_blur;\n\t\t\tuniform sampler2D u_mask;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 blurred_color = texture2D(u_texture_blur, v_coord);\n\t\t\t\tfloat mask = texture2D(u_mask, v_coord).x;\n\t\t\t   gl_FragColor = mix(color, blurred_color, mask);\n\t\t\t}\n\t\t\t";
...
f._second_pixel_shader="precision highp float;\n\t\t\tvarying vec4 v_color;\n\t\t\tuniform sampler2D u_shape;\n\t\t\tuniform float u_alpha;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D( u_shape, gl_PointCoord );\n\t\t\t\tcolor *= v_color * u_alpha;\n\t\t\t\tgl_FragColor = color;\n\t\t\t}\n";c.registerNodeType("fx/bokeh",f);u.LGraphFXBokeh=f;var h=function(){this.addInput("Texture","Texture");this.addInput("value1","number");this.addInput("value2","number");this.addOutput("Texture",
"Texture");this.properties={fx:"halftone",value1:1,value2:1,precision:LGraphTexture.DEFAULT}};h.title="FX";h.desc="applies an FX from a list";h.widgets_info={fx:{widget:"combo",values:["halftone","pixelate","lowpalette","noise","gamma"]},precision:{widget:"combo",values:LGraphTexture.MODE_VALUES}};h.shaders={};h.prototype.onExecute=function(){if(this.isOutputConnected(0)){var c=this.getInputData(0);if(this.properties.precision===LGraphTexture.PASS_THROUGH)this.setOutputData(0,c);else if(c){this._tex=
LGraphTexture.getTargetTexture(c,this._tex,this.properties.precision);var f=this.properties.value1;this.isInputConnected(1)&&(f=this.getInputData(1),this.properties.value1=f);var q=this.properties.value2;this.isInputConnected(2)&&(q=this.getInputData(2),this.properties.value2=q);var r=this.properties.fx,z=h.shaders[r];if(!z){var e=h["pixel_shader_"+r];if(!e)return;z=h.shaders[r]=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,e)}gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var v=Mesh.getScreenQuad(),
k;k=u.LS&&LS.Renderer._current_camera?[LS.Renderer._current_camera.near,LS.Renderer._current_camera.far]:[1,100];var m=null;"noise"==r&&(m=LGraphTexture.getNoiseTexture());this._tex.drawTo(function(){c.bind(0);"noise"==r&&m.bind(1);z.uniforms({u_texture:0,u_noise:1,u_size:[c.width,c.height],u_rand:[Math.random(),Math.random()],u_value1:f,u_value2:q,u_camera_planes:k}).draw(v)});this.setOutputData(0,this._tex)}}};h.pixel_shader_halftone="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform vec2 u_size;\n\t\t\tuniform float u_value1;\n\t\t\tuniform float u_value2;\n\t\t\t\n\t\t\tfloat pattern() {\n\t\t\t\tfloat s = sin(u_value1 * 3.1415), c = cos(u_value1 * 3.1415);\n\t\t\t\tvec2 tex = v_coord * u_size.xy;\n\t\t\t\tvec2 point = vec2(\n\t\t\t\t   c * tex.x - s * tex.y ,\n\t\t\t\t   s * tex.x + c * tex.y \n\t\t\t\t) * u_value2;\n\t\t\t\treturn (sin(point.x) * sin(point.y)) * 4.0;\n\t\t\t}\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat average = (color.r + color.g + color.b) / 3.0;\n\t\t\t\tgl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);\n\t\t\t}\n";
...
h.pixel_shader_gamma="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_value1;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tfloat gamma = 1.0 / u_value1;\n\t\t\t\tgl_FragColor = vec4( pow( color.xyz, vec3(gamma) ), color.a );\n\t\t\t}\n";c.registerNodeType("fx/generic",h);u.LGraphFXGeneric=h;var q=function(){this.addInput("Tex.","Texture");this.addInput("intensity","number");this.addOutput("Texture",
"Texture");this.properties={intensity:1,invert:!1,precision:LGraphTexture.DEFAULT};q._shader||(q._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,q.pixel_shader))};q.title="Vigneting";q.desc="Vigneting";q.widgets_info={precision:{widget:"combo",values:LGraphTexture.MODE_VALUES}};q.prototype.onExecute=function(){var c=this.getInputData(0);if(this.properties.precision===LGraphTexture.PASS_THROUGH)this.setOutputData(0,c);else if(c){this._tex=LGraphTexture.getTargetTexture(c,this._tex,this.properties.precision);
var f=this.properties.intensity;this.isInputConnected(1)&&(f=this.getInputData(1),this.properties.intensity=f);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var h=Mesh.getScreenQuad(),r=q._shader,u=this.properties.invert;this._tex.drawTo(function(){c.bind(0);r.uniforms({u_texture:0,u_intensity:f,u_isize:[1/c.width,1/c.height],u_invert:u?1:0}).draw(h)});this.setOutputData(0,this._tex)}};q.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_intensity;\n\t\t\tuniform int u_invert;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat luminance = 1.0 - length( v_coord - vec2(0.5) ) * 1.414;\n\t\t\t\tvec4 color = texture2D(u_texture, v_coord);\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tluminance = 1.0 - luminance;\n\t\t\t\tluminance = mix(1.0, luminance, u_intensity);\n\t\t\t   gl_FragColor = vec4( luminance * color.xyz, color.a);\n\t\t\t}\n\t\t\t";
c.registerNodeType("fx/vigneting",q);u.LGraphFXVigneting=q}})(this);
(function(u){function c(c){this.cmd=this.channel=0;this.data=new Uint32Array(3);c&&this.setup(c)}function r(c,e){navigator.requestMIDIAccess?(this.on_ready=c,this.state={note:[],cc:[]},navigator.requestMIDIAccess().then(this.onMIDISuccess.bind(this),this.onMIDIFailure.bind(this))):(this.error="not suppoorted",e?e("Not supported"):console.error("MIDI NOT SUPPORTED, enable by chrome://flags"))}function f(){this.addOutput("on_midi",m.EVENT);this.addOutput("out","midi");this.properties={port:0};this._current_midi_event=
this._last_midi_event=null;this.boxcolor="#AAA";this._last_time=0;var c=this;new r(function(e){c._midi=e;if(c._waiting)c.onStart();c._waiting=!1})}function h(){this.addInput("send",m.EVENT);this.properties={port:0};var c=this;new r(function(e){c._midi=e})}function q(){this.addInput("on_midi",m.EVENT);this._str="";this.size=[200,40]}function l(){this.properties={channel:-1,cmd:-1,min_value:-1,max_value:-1};var c=this;this._learning=!1;this.addWidget("button","Learn","",function(){c._learning=!0;c.boxcolor=
"#FA3"});this.addInput("in",m.EVENT);this.addOutput("on_midi",m.EVENT);this.boxcolor="#AAA"}function y(){this.properties={channel:0,cmd:144,value1:1,value2:1};this.addInput("send",m.EVENT);this.addInput("assign",m.EVENT);this.addOutput("on_midi",m.EVENT);this.midi_event=new c;this.gate=!1}function s(){this.properties={cc:1,value:0};this.addOutput("value","number")}function w(){this.addInput("generate",m.ACTION);this.addInput("scale","string");this.addInput("octave","number");this.addOutput("note",
m.EVENT);this.properties={notes:"A,A#,B,C,C#,D,D#,E,F,F#,G,G#",octave:2,duration:0.5,mode:"sequence"};this.notes_pitches=w.processScale(this.properties.notes);this.sequence_index=0}function z(){this.properties={amount:0};this.addInput("in",m.ACTION);this.addInput("amount","number");this.addOutput("out",m.EVENT);this.midi_event=new c}function e(){this.properties={scale:"A,A#,B,C,C#,D,D#,E,F,F#,G,G#"};this.addInput("note",m.ACTION);this.addInput("scale","string");this.addOutput("out",m.EVENT);this.valid_notes=
...
224:"pitch bend",240:"system",242:"Song pos",243:"Song select",246:"Tune request",248:"time tick",250:"Start Song",251:"Continue Song",252:"Stop Song",254:"Sensing",255:"Reset"};c.commands_short={128:"NOTEOFF",144:"NOTEOFF",160:"KEYP",176:"CC",192:"PC",208:"CP",224:"PB",240:"SYS",242:"POS",243:"SELECT",246:"TUNEREQ",248:"TT",250:"START",251:"CONTINUE",252:"STOP",254:"SENS",255:"RESET"};c.commands_reversed={};for(var D in c.commands)c.commands_reversed[c.commands[D]]=D;r.input=null;r.MIDIEvent=c;r.prototype.onMIDISuccess=
...
for(a=f.next();a&&!1===a.done;)a=a.value,console.log("Output port [type:'"+a.type+"'] id:'"+a.id+"' manufacturer:'"+a.manufacturer+"' name:'"+a.name+"' version:'"+a.version+"'"),e++,a=f.next();this.num_output_ports=e};r.prototype.onMIDIFailure=function(c){console.error("Failed to get MIDI access - "+c)};r.prototype.openInputPort=function(e,f){var h=this.input_ports.get("input-"+e);if(!h)return!1;r.input=this;var a=this;h.onmidimessage=function(b){var d=new c(b.data);a.updateState(d);f&&f(b.data,d);
if(r.on_message)r.on_message(b.data,d)};console.log("port open: ",h);return!0};r.parseMsg=function(c){};r.prototype.updateState=function(e){switch(e.cmd){case c.NOTEON:this.state.note[e.value1|0]=e.value2;break;case c.NOTEOFF:this.state.note[e.value1|0]=0;break;case c.CONTROLLERCHANGE:this.state.cc[e.getCC()]=e.getCCValue()}};r.prototype.sendMIDI=function(e,f){if(f){var h=this.output_ports.get("output-"+e);h&&(r.output=this,f.constructor===c?h.send(f.data):h.send(f))}};f.MIDIInterface=r;f.title="MIDI Input";
...
["on_cc",m.EVENT],["on_pc",m.EVENT],["on_pitchbend",m.EVENT]]};m.registerNodeType("midi/input",f);h.MIDIInterface=r;h.title="MIDI Output";h.desc="Sends MIDI to output channel";h.color="#243";h.prototype.getPropertyInfo=function(c){if(this._midi&&"port"==c){c={};for(var e=0;e<this._midi.output_ports.size;++e){var f=this._midi.output_ports.get(e);c[e]=e+".- "+f.name+" version:"+f.version}return{type:"enum",values:c}}};h.prototype.onAction=function(c,e){this._midi&&("send"==c&&this._midi.sendMIDI(this.port,
e),this.trigger("midi",e))};h.prototype.onGetInputs=function(){return[["send",m.ACTION]]};h.prototype.onGetOutputs=function(){return[["on_midi",m.EVENT]]};m.registerNodeType("midi/output",h);q.title="MIDI Show";q.desc="Shows MIDI in the graph";q.color="#243";q.prototype.getTitle=function(){return this.flags.collapsed?this._str:this.title};q.prototype.onAction=function(e,f){f&&(this._str=f.constructor===c?f.toString():"???")};q.prototype.onDrawForeground=function(c){this._str&&!this.flags.collapsed&&
(c.font="30px Arial",c.fillText(this._str,10,0.8*this.size[1]))};q.prototype.onGetInputs=function(){return[["in",m.ACTION]]};q.prototype.onGetOutputs=function(){return[["on_midi",m.EVENT]]};m.registerNodeType("midi/show",q);l.title="MIDI Filter";l.desc="Filters MIDI messages";l.color="#243";l["@cmd"]={type:"enum",title:"Command",values:c.commands_reversed};l.prototype.getTitle=function(){var e=null,e=-1==this.properties.cmd?"Nothing":c.commands_short[this.properties.cmd]||"Unknown";-1!=this.properties.min_value&&
-1!=this.properties.max_value&&(e+=" "+(this.properties.min_value==this.properties.max_value?this.properties.max_value:this.properties.min_value+".."+this.properties.max_value));return"Filter: "+e};l.prototype.onPropertyChanged=function(e,f){if("cmd"==e){var h=Number(f);isNaN(h)&&(h=c.commands[f]||0);this.properties.cmd=h}};l.prototype.onAction=function(e,f){if(f&&f.constructor===c){if(this._learning)this._learning=!1,this.boxcolor="#AAA",this.properties.channel=f.channel,this.properties.cmd=f.cmd,
this.properties.min_value=this.properties.max_value=f.data[1];else if(-1!=this.properties.channel&&f.channel!=this.properties.channel||-1!=this.properties.cmd&&f.cmd!=this.properties.cmd||-1!=this.properties.min_value&&f.data[1]<this.properties.min_value||-1!=this.properties.max_value&&f.data[1]>this.properties.max_value)return;this.trigger("on_midi",f)}};m.registerNodeType("midi/filter",l);y.title="MIDIEvent";y.desc="Create a MIDI Event";y.color="#243";y.prototype.onAction=function(e,f){"assign"==
...
f))};y.prototype.onExecute=function(){var e=this.properties;if(this.inputs)for(var f=0;f<this.inputs.length;++f){var h=this.inputs[f];if(-1!=h.link)switch(h.name){case "note":h=this.getInputData(f),null!=h&&(h.constructor===String&&(h=c.NoteStringToPitch(h)),this.properties.value1=(h|0)%255)}}if(this.outputs)for(f=0;f<this.outputs.length;++f){switch(this.outputs[f].name){case "midi":h=new c;h.setup([e.cmd,e.value1,e.value2]);h.channel=e.channel;break;case "command":h=e.cmd;break;case "cc":h=e.value1;
break;case "cc_value":h=e.value2;break;case "note":h=e.cmd==c.NOTEON||e.cmd==c.NOTEOFF?e.value1:null;break;case "velocity":h=e.cmd==c.NOTEON?e.value2:null;break;case "pitch":h=e.cmd==c.NOTEON?c.computePitch(e.value1):null;break;case "pitchbend":h=e.cmd==c.PITCHBEND?c.computePitchBend(e.value1,e.value2):null;break;case "gate":h=this.gate;break;default:continue}null!==h&&this.setOutputData(f,h)}};y.prototype.onPropertyChanged=function(e,f){"cmd"==e&&(this.properties.cmd=c.computeCommandFromString(f))};
y.prototype.onGetInputs=function(){return[["note","number"]]};y.prototype.onGetOutputs=function(){return[["midi","midi"],["on_midi",m.EVENT],["command","number"],["note","number"],["velocity","number"],["cc","number"],["cc_value","number"],["pitch","number"],["gate","bool"],["pitchbend","number"]]};m.registerNodeType("midi/event",y);s.title="MIDICC";s.desc="gets a Controller Change";s.color="#243";s.prototype.onExecute=function(){r.input&&(this.properties.value=r.input.state.cc[this.properties.cc]);
this.setOutputData(0,this.properties.value)};m.registerNodeType("midi/cc",s);w.title="MIDI Generator";w.desc="Generates a random MIDI note";w.color="#243";w.processScale=function(e){e=e.split(",");for(var f=0;f<e.length;++f){var h=e[f];e[f]=2==h.length&&"#"!=h[1]||2<h.length?-m.MIDIEvent.NoteStringToPitch(h):c.note_to_index[h]||0}return e};w.prototype.onPropertyChanged=function(c,e){"notes"==c&&(this.notes_pitches=w.processScale(e))};w.prototype.onExecute=function(){var c=this.getInputData(2);null!=
c&&(this.properties.octave=c);if(c=this.getInputData(1))this.notes_pitches=w.processScale(c)};w.prototype.onAction=function(e,f){var h=0,a=this.notes_pitches.length,b=0;"sequence"==this.properties.mode?b=this.sequence_index=(this.sequence_index+1)%a:"random"==this.properties.mode&&(b=Math.floor(Math.random()*a));a=this.notes_pitches[b];h=0<=a?a+12*(this.properties.octave-1)+33:-a;f=new c;f.setup([c.NOTEON,h,10]);a=this.properties.duration||1;this.trigger("note",f);setTimeout(function(){var a=new c;
a.setup([c.NOTEOFF,h,0]);this.trigger("note",a)}.bind(this),1E3*a)};m.registerNodeType("midi/generator",w);z.title="MIDI Transpose";z.desc="Transpose a MIDI note";z.color="#243";z.prototype.onAction=function(e,f){f&&f.constructor===c&&(f.data[0]==c.NOTEON||f.data[0]==c.NOTEOFF?(this.midi_event=new c,this.midi_event.setup(f.data),this.midi_event.data[1]=Math.round(this.midi_event.data[1]+this.properties.amount),this.trigger("out",this.midi_event)):this.trigger("out",f))};z.prototype.onExecute=function(){var c=
this.getInputData(1);null!=c&&(this.properties.amount=c)};m.registerNodeType("midi/transpose",z);e.title="MIDI Quantize Pitch";e.desc="Transpose a MIDI note tp fit an scale";e.color="#243";e.prototype.onPropertyChanged=function(c,e){"scale"==c&&this.processScale(e)};e.prototype.processScale=function(c){this._current_scale=c;this.notes_pitches=w.processScale(c);for(c=0;12>c;++c)this.valid_notes[c]=-1!=this.notes_pitches.indexOf(c);for(c=0;12>c;++c)if(this.valid_notes[c])this.offset_notes[c]=0;else for(var e=
...
this.keys.length=e;var f=this.size[0]/(7*this.properties.num_octaves),a=this.size[1];c.globalAlpha=1;for(var b=0;2>b;b++)for(var d=0;d<e;++d){var h=k.keys[d%12];if(h.t==b){var l=7*Math.floor(d/12)*f+h.x*f;c.fillStyle=0==b?this.keys[d]?"#CCC":"white":this.keys[d]?"#333":"black";c.fillRect(l+1,0,f*h.w-2,a*h.h)}}}};k.prototype.getKeyIndex=function(c){for(var e=this.size[0]/(7*this.properties.num_octaves),f=this.size[1],a=1;0<=a;a--)for(var b=0;b<this.keys.length;++b){var d=k.keys[b%12];if(d.t==a){var h=
7*Math.floor(b/12)*e+d.x*e,l=e*d.w,d=f*d.h;if(!(c[0]<h||c[0]>h+l||c[1]>d))return b}}return-1};k.prototype.onAction=function(e,f){if("reset"==e)for(var h=0;h<this.keys.length;++h)this.keys[h]=!1;else f&&f.constructor===c&&(h=f.data[1]-(12*(this.properties.start_octave-1)+29),0<=h&&h<this.keys.length&&(f.data[0]==c.NOTEON?this.keys[h]=!0:f.data[0]==c.NOTEOFF&&(this.keys[h]=!1)),this.trigger("note",f))};k.prototype.onMouseDown=function(e,f){if(!(0>f[1])){var h=this.getKeyIndex(f);this.keys[h]=!0;this._last_key=
...
0;c<a.inputs.length;++c){var e=a.graph.links[a.inputs[c].link];if(e){var f=a.graph.getNodeById(e.origin_id),h=null,h=f.getAudioNodeInOutputSlot?f.getAudioNodeInOutputSlot(e.origin_slot):f.audionode,e=null,e=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(c):a.audionode;b?n.connect(h,e):n.disconnect(h,e)}}if(a.outputs)for(c=0;c<a.outputs.length;++c)for(var f=a.outputs[c],g=0;g<f.links.length;++g)if(e=a.graph.links[f.links[g]]){var h=a.getAudioNodeInOutputSlot?a.getAudioNodeInOutputSlot(c):a.audionode,
k=a.graph.getNodeById(e.target_id),e=k.getAudioNodeInInputSlot?k.getAudioNodeInInputSlot(e.target_slot):k.audionode;b?n.connect(h,e):n.disconnect(h,e)}};n.onConnectionsChange=function(a,b,c,e){if(a==t.OUTPUT&&(a=null,e&&(a=this.graph.getNodeById(e.target_id)),a)){var f=null,f=this.getAudioNodeInOutputSlot?this.getAudioNodeInOutputSlot(b):this.audionode;b=null;b=a.getAudioNodeInInputSlot?a.getAudioNodeInInputSlot(e.target_slot):a.audionode;c?n.connect(f,b):n.disconnect(f,b)}};n.createAudioNodeWrapper=
...
0)};r.prototype.onPropertyChanged=function(a,b){"gain"==a&&(this.audionode.gain.value=b)};r.prototype.onConnectionsChange=n.onConnectionsChange;r.prototype.onGetInputs=function(){return[["playbackRate","number"],["Play",t.ACTION],["Stop",t.ACTION]]};r.title="MediaSource";r.desc="Plays microphone";t.registerNodeType("audio/media_source",r);f.prototype.onPropertyChanged=function(a,b){this.audionode[a]=b};f.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.audionode.frequencyBinCount;
...
c)}};n.createAudioNodeWrapper(h);h.title="Gain";h.desc="Audio gain";t.registerNodeType("audio/gain",h);n.createAudioNodeWrapper(q);q.prototype.onRemove=function(){this._dropped_url&&URL.revokeObjectURL(this._dropped_url)};q.prototype.onPropertyChanged=function(a,b){"impulse_src"==a?this.loadImpulse(b):"normalize"==a&&(this.audionode.normalize=b)};q.prototype.onDropFile=function(a){this._dropped_url&&URL.revokeObjectURL(this._dropped_url);this._dropped_url=URL.createObjectURL(a);this.properties.impulse_src=
this._dropped_url;this.loadImpulse(this._dropped_url)};q.prototype.loadImpulse=function(a){function b(a){c._impulse_buffer=a;c.audionode.buffer=a;console.log("Impulse signal set");c._loading_impulse=!1}var c=this;this._request&&(this._request.abort(),this._request=null);this._impulse_buffer=null;this._loading_impulse=!1;a&&(this._request=n.loadSound(a,b),this._loading_impulse=!0)};q.title="Convolver";q.desc="Convolves the signal (used for reverb)";t.registerNodeType("audio/convolver",q);n.createAudioNodeWrapper(l);
l.prototype.onExecute=function(){if(this.inputs&&this.inputs.length)for(var a=1;a<this.inputs.length;++a){var b=this.inputs[a];if(null!=b.link){var c=this.getInputData(a);void 0!==c&&(this.audionode[b.name].value=c)}}};l.prototype.onGetInputs=function(){return[["threshold","number"],["knee","number"],["ratio","number"],["reduction","number"],["attack","number"],["release","number"]]};l.title="DynamicsCompressor";l.desc="Dynamics Compressor";t.registerNodeType("audio/dynamicsCompressor",l);y.prototype.onExecute=
...
1;a<this.inputs.length;++a){var b=this.inputs[a];null!=b.link&&"audio"!=b.type&&(b=this.getInputData(a),void 0!==b&&(1==a?this.audionode1.gain.value=b:3==a&&(this.audionode2.gain.value=b)))}};n.createAudioNodeWrapper(s);s.title="Mixer";s.desc="Audio mixer";t.registerNodeType("audio/mixer",s);w.prototype.onExecute=function(){var a=n.getAudioContext().currentTime,b=this.audionode.gain,c=this.getInputData(1),e=this.getInputOrProperty("A"),f=this.getInputOrProperty("D"),h=this.getInputOrProperty("S"),
g=this.getInputOrProperty("R");!this.gate&&c?(b.cancelScheduledValues(0),b.setValueAtTime(0,a),b.linearRampToValueAtTime(1,a+e),b.linearRampToValueAtTime(h,a+e+f)):this.gate&&!c&&(b.cancelScheduledValues(0),b.setValueAtTime(b.value,a),b.linearRampToValueAtTime(0,a+g));this.gate=c};w.prototype.onGetInputs=function(){return[["A","number"],["D","number"],["S","number"],["R","number"]]};n.createAudioNodeWrapper(w);w.title="ADSR";w.desc="Audio envelope";t.registerNodeType("audio/adsr",w);n.createAudioNodeWrapper(z);
...
!1)};k.prototype.onDrawForeground=function(a){if(this._last_buffer){var b=this._last_buffer,c=b.length/this.size[0],e=this.size[1];a.fillStyle="black";a.fillRect(0,0,this.size[0],this.size[1]);a.strokeStyle="white";a.beginPath();var f=0;if(this.properties.continuous){a.moveTo(f,e);for(var h=0;h<b.length;h+=c)a.lineTo(f,e-b[h|0]/255*e),f++}else for(h=0;h<b.length;h+=c)a.moveTo(f+0.5,e),a.lineTo(f+0.5,e-b[h|0]/255*e),f++;a.stroke();0<=this.properties.mark&&(b=n.getAudioContext().sampleRate/b.length,
...
b.getChannelData(c),f=a.getChannelData(c),h=0;h<b.length;h++)f[h]=e[h]}};n.createAudioNodeWrapper(D);D.title="Script";D.desc="apply script to signal";t.registerNodeType("audio/script",D);g.title="Destination";g.desc="Audio output";t.registerNodeType("audio/destination",g)})(this);
(function(u){function c(){this.size=[60,20];this.addInput("send",f.ACTION);this.addOutput("received",f.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"",room:"lgraph",only_send_changes:!0};this._ws=null;this._last_sent_data=[];this._last_received_data=[]}function r(){this.room_widget=this.addWidget("text","Room","lgraph",this.setRoom.bind(this));this.addWidget("button","Reconnect",null,this.connectSocket.bind(this));this.addInput("send",f.ACTION);this.addOutput("received",
f.EVENT);this.addInput("in",0);this.addOutput("out",0);this.properties={url:"tamats.com:55000",room:"lgraph",only_send_changes:!0};this._server=null;this.connectSocket();this._last_sent_data=[];this._last_received_data=[]}var f=u.LiteGraph;c.title="WebSocket";c.desc="Send data through a websocket";c.prototype.onPropertyChanged=function(c,f){"url"==c&&this.connectSocket()};c.prototype.onExecute=function(){!this._ws&&this.properties.url&&this.connectSocket();if(this._ws&&this._ws.readyState==WebSocket.OPEN){for(var c=
this.properties.room,f=this.properties.only_send_changes,l=1;l<this.inputs.length;++l){var r=this.getInputData(l);if(null!=r){var s;try{s=JSON.stringify({type:0,room:c,channel:l,data:r})}catch(u){continue}f&&this._last_sent_data[l]==s||(this._last_sent_data[l]=s,this._ws.send(s))}}for(l=1;l<this.outputs.length;++l)this.setOutputData(l,this._last_received_data[l]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};c.prototype.connectSocket=function(){var c=this,q=this.properties.url;"ws"!=q.substr(0,
2)&&(q="ws://"+q);this._ws=new WebSocket(q);this._ws.onopen=function(){console.log("ready");c.boxcolor="#6C6"};this._ws.onmessage=function(l){c.boxcolor="#AFA";var q=JSON.parse(l.data);if(!q.room||q.room==this.properties.room)if(1==l.data.type)if(q.data.object_class&&f[q.data.object_class]){l=null;try{l=new f[q.data.object_class](q.data),c.triggerSlot(0,l)}catch(r){}}else c.triggerSlot(0,q.data);else c._last_received_data[l.data.channel||0]=q.data};this._ws.onerror=function(f){console.log("couldnt connect to websocket");
c.boxcolor="#E88"};this._ws.onclose=function(f){console.log("connection closed");c.boxcolor="#000"}};c.prototype.send=function(c){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send(JSON.stringify({type:1,msg:c}))};c.prototype.onAction=function(c,f){this._ws&&this._ws.readyState==WebSocket.OPEN&&this._ws.send({type:1,room:this.properties.room,action:c,data:f})};c.prototype.onGetInputs=function(){return[["in",0]]};c.prototype.onGetOutputs=function(){return[["out",0]]};f.registerNodeType("network/websocket",
c);r.title="SillyClient";r.desc="Connects to SillyServer to broadcast messages";r.prototype.onPropertyChanged=function(c,f){"room"==c&&(this.room_widget.value=f);this.connectSocket()};r.prototype.setRoom=function(c){this.properties.room=c;this.room_widget.value=c;this.connectSocket()};r.prototype.onDrawForeground=function(){for(var c=1;c<this.inputs.length;++c){var f=this.inputs[c];f.label="in_"+c}for(c=1;c<this.outputs.length;++c)f=this.outputs[c],f.label="out_"+c};r.prototype.onExecute=function(){if(this._server&&
this._server.is_connected){for(var c=this.properties.only_send_changes,f=1;f<this.inputs.length;++f){var l=this.getInputData(f);null==l||c&&this._last_sent_data[f]==l||(this._server.sendMessage({type:0,channel:f,data:l}),this._last_sent_data[f]=l)}for(f=1;f<this.outputs.length;++f)this.setOutputData(f,this._last_received_data[f]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};r.prototype.connectSocket=function(){var c=this;if("undefined"==typeof SillyClient)this._error||console.error("SillyClient node cannot be used, you must include SillyServer.js"),
this._error=!0;else if(this._server=new SillyClient,this._server.on_ready=function(){console.log("ready");c.boxcolor="#6C6"},this._server.on_message=function(l,q){var r=null;try{r=JSON.parse(q)}catch(u){return}if(1==r.type)if(r.data.object_class&&f[r.data.object_class]){var z=null;try{z=new f[r.data.object_class](r.data),c.triggerSlot(0,z)}catch(e){return}}else c.triggerSlot(0,r.data);else c._last_received_data[r.channel||0]=r.data;c.boxcolor="#AFA"},this._server.on_error=function(f){console.log("couldnt connect to websocket");
c.boxcolor="#E88"},this._server.on_close=function(f){console.log("connection closed");c.boxcolor="#000"},this.properties.url&&this.properties.room){try{this._server.connect(this.properties.url,this.properties.room)}catch(q){console.error("SillyServer error: "+q);this._server=null;return}this._final_url=this.properties.url+"/"+this.properties.room}};r.prototype.send=function(c){this._server&&this._server.is_connected&&this._server.sendMessage({type:1,data:c})};r.prototype.onAction=function(c,f){this._server&&
this._server.is_connected&&this._server.sendMessage({type:1,action:c,data:f})};r.prototype.onGetInputs=function(){return[["in",0]]};r.prototype.onGetOutputs=function(){return[["out",0]]};f.registerNodeType("network/sillyclient",r)})(this);
