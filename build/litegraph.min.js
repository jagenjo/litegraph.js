...
!0;this.render_execution_order=!1;this.render_title_colored=!0;this.links_render_mode=c.SPLINE_LINK;this.canvas_mouse=[0,0];this.onDrawOverlay=this.onDrawForeground=this.onDrawBackground=this.onMouse=this.onSearchBoxSelection=this.onSearchBox=null;this.connections_width=3;this.round_radius=8;this.node_widget=this.current_node=null;this.last_mouse_position=[0,0];this.visible_area=this.ds.visible_area;this.visible_links=[];b&&b.attachCanvas(this);this.setCanvas(a);this.clear();e.skip_render||this.startRendering();
this.autoresize=e.autoresize}function y(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function B(a,b,e,s,l,c){return e<a&&e+l>a&&s<b&&s+c>b?!0:!1}function A(a,b){var e=a[0]+a[2],s=a[1]+a[3],l=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>l||e<b[0]||s<b[1]?!1:!0}function z(a,b){function e(a){var e=parseInt(l.style.top);l.style.top=(e+a.deltaY*b.scroll_speed).toFixed()+"px";a.preventDefault();return!0}this.options=b=b||{};var s=this;b.parentMenu&&(b.parentMenu.constructor!==this.constructor?
(console.error("parentMenu must be of class ContextMenu, ignoring it"),b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));b.event&&b.event.constructor!==MouseEvent&&b.event.constructor!==CustomEvent&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it."),b.event=null);var l=document.createElement("div");l.className="litegraph litecontextmenu litemenubar-panel";b.className&&(l.className+=" "+
b.className);l.style.minWidth=100;l.style.minHeight=100;l.style.pointerEvents="none";setTimeout(function(){l.style.pointerEvents="auto"},100);l.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);l.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);l.addEventListener("mousedown",function(a){if(2==a.button)return s.close(),a.preventDefault(),!0},!0);b.scroll_speed||(b.scroll_speed=0.1);l.addEventListener("wheel",e,!0);l.addEventListener("mousewheel",
e,!0);this.root=l;if(b.title){var c=document.createElement("div");c.className="litemenu-title";c.innerHTML=b.title;l.appendChild(c)}var c=0,g;for(g in a){var d=a.constructor==Array?a[g]:g;null!=d&&d.constructor!==String&&(d=void 0===d.content?String(d):d.content);this.addItem(d,a[g],b);c++}l.addEventListener("mouseleave",function(a){s.lock||(l.closing_timer&&clearTimeout(l.closing_timer),l.closing_timer=setTimeout(s.close.bind(s,a),500))});l.addEventListener("mouseenter",function(a){l.closing_timer&&
...
new FileReader;k.onload=function(a){e.onDropData(a.target.result,d,g)};var m=g.type.split("/")[0];"text"==m||""==m?k.readAsText(g):"image"==m?k.readAsDataURL(g):k.readAsArrayBuffer(g)}}return e.onDropItem&&e.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;this.onDropItem&&(b=this.onDropItem(event));b||this.checkDropItem(a)};f.prototype.checkDropItem=function(a){if(a.dataTransfer.files.length){var b=a.dataTransfer.files[0],e=f.getFileExtension(b.name).toLowerCase();if(e=c.node_types_by_file_extension[e])if(e=
c.createNode(e.type),e.pos=[a.canvasX,a.canvasY],this.graph.add(e),e.onDropFile)e.onDropFile(b)}};f.prototype.processNodeDblClicked=function(a){if(this.onShowNodePanel)this.onShowNodePanel(a);if(this.onNodeDblClicked)this.onNodeDblClicked(a);this.setDirty(!0)};f.prototype.processNodeSelected=function(a,b){this.selectNode(a,b&&b.shiftKey);if(this.onNodeSelected)this.onNodeSelected(a)};f.prototype.processNodeDeselected=function(a){this.deselectNode(a);if(this.onNodeDeselected)this.onNodeDeselected(a)};
f.prototype.selectNode=function(a,b){null==a?this.deselectAllNodes():this.selectNodes([a],b)};f.prototype.selectNodes=function(a,b){b||this.deselectAllNodes();a=a||this.graph._nodes;for(var e=0;e<a.length;++e){var c=a[e];if(!c.is_selected){if(!c.is_selected&&c.onSelected)c.onSelected();c.is_selected=!0;this.selected_nodes[c.id]=c;if(c.inputs)for(var g=0;g<c.inputs.length;++g)this.highlighted_links[c.inputs[g].link]=!0;if(c.outputs)for(g=0;g<c.outputs.length;++g){var d=c.outputs[g];if(d.links)for(var f=
0;f<d.links.length;++f)this.highlighted_links[d.links[f]]=!0}}}this.setDirty(!0)};f.prototype.deselectNode=function(a){if(a.is_selected){if(a.onDeselected)a.onDeselected();a.is_selected=!1;if(a.inputs)for(var b=0;b<a.inputs.length;++b)delete this.highlighted_links[a.inputs[b].link];if(a.outputs)for(b=0;b<a.outputs.length;++b){var e=a.outputs[b];if(e.links)for(var c=0;c<e.links.length;++c)delete this.highlighted_links[e.links[c]]}}};f.prototype.deselectAllNodes=function(){if(this.graph){for(var a=
this.graph._nodes,b=0,e=a.length;b<e;++b){var c=a[b];if(c.is_selected){if(c.onDeselected)c.onDeselected();c.is_selected=!1}}this.selected_nodes={};this.current_node=null;this.highlighted_links={};this.setDirty(!0)}};f.prototype.deleteSelectedNodes=function(){for(var a in this.selected_nodes)this.graph.remove(this.selected_nodes[a]);this.selected_nodes={};this.current_node=null;this.highlighted_links={};this.setDirty(!0)};f.prototype.centerOnNode=function(a){this.ds.offset[0]=-a.pos[0]-0.5*a.size[0]+
...
b.left,a.clientY-b.top])};f.prototype.bringToFront=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.push(a))};f.prototype.sendToBack=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.unshift(a))};var x=new Float32Array(4);f.prototype.computeVisibleNodes=function(a,b){var e=b||[];e.length=0;a=a||this.graph._nodes;for(var c=0,g=a.length;c<g;++c){var d=a[c];(!this.live_mode||d.onDrawBackground||
d.onDrawForeground)&&A(this.visible_area,d.getBounding(x))&&e.push(d)}return e};f.prototype.draw=function(a,b){if(this.canvas){var e=c.getTime();this.render_time=0.001*(e-this.last_draw_time);this.last_draw_time=e;this.graph&&this.ds.computeVisibleArea();(this.dirty_bgcanvas||b||this.always_render_background||this.graph&&this.graph._last_trigger_time&&1E3>e-this.graph._last_trigger_time)&&this.drawBackCanvas();(this.dirty_canvas||a)&&this.drawFrontCanvas();this.fps=this.render_time?1/this.render_time:
...
b,e){b=b||0;e=e||0;a.save();a.translate(b,e);a.font="10px Arial";a.fillStyle="#888";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,5,26),a.fillText("N: "+this.graph._nodes.length+" ["+this.visible_nodes.length+"]",5,39),a.fillText("V: "+this.graph._version,5,52),a.fillText("FPS:"+this.fps.toFixed(2),5,65)):a.fillText("No graph selected",5,13);a.restore()};f.prototype.drawBackCanvas=function(){var a=this.bgcanvas;if(a.width!=this.canvas.width||
a.height!=this.canvas.height)a.width=this.canvas.width,a.height=this.canvas.height;this.bgctx||(this.bgctx=this.bgcanvas.getContext("2d"));var b=this.bgctx;b.start&&b.start();this.clear_background&&b.clearRect(0,0,a.width,a.height);if(this._graph_stack&&this._graph_stack.length){b.save();var e=this.graph._subgraph_node;b.strokeStyle=e.bgcolor;b.lineWidth=10;b.strokeRect(1,1,a.width-2,a.height-2);b.lineWidth=1;b.font="40px Arial";b.textAlign="center";b.fillStyle=e.bgcolor||"#AAA";for(var c="",g=1;g<
this._graph_stack.length;++g)c+=this._graph_stack[g]._subgraph_node.getTitle()+" >> ";b.fillText(c+e.getTitle(),0.5*a.width,40);b.restore()}e=!1;this.onRenderBackground&&(e=this.onRenderBackground(a,b));b.restore();b.setTransform(1,0,0,1,0,0);this.visible_links.length=0;if(this.graph){b.save();this.ds.toCanvasContext(b);if(this.background_image&&0.5<this.ds.scale&&!e){b.globalAlpha=this.zoom_modify_alpha?(1-0.5/this.ds.scale)*this.editor_alpha:this.editor_alpha;b.imageSmoothingEnabled=b.mozImageSmoothingEnabled=
b.imageSmoothingEnabled=!1;if(!this._bg_img||this._bg_img.name!=this.background_image){this._bg_img=new Image;this._bg_img.name=this.background_image;this._bg_img.src=this.background_image;var d=this;this._bg_img.onload=function(){d.draw(!0,!0)}}e=null;null==this._pattern&&0<this._bg_img.width?(e=b.createPattern(this._bg_img,"repeat"),this._pattern_img=this._bg_img,this._pattern=e):e=this._pattern;e&&(b.fillStyle=e,b.fillRect(this.visible_area[0],this.visible_area[1],this.visible_area[2],this.visible_area[3]),
...
has_submenu:!0,callback:f.onMenuNodeMode},{content:"Resize",callback:f.onResizeNode},{content:"Collapse",callback:f.onMenuNodeCollapse},{content:"Pin",callback:f.onMenuNodePin},{content:"Colors",has_submenu:!0,callback:f.onMenuNodeColors},{content:"Shapes",has_submenu:!0,callback:f.onMenuNodeShapes},null];if(a.onGetInputs){var e=a.onGetInputs();e&&e.length&&(b[0].disabled=!1)}a.onGetOutputs&&(e=a.onGetOutputs())&&e.length&&(b[1].disabled=!1);a.getExtraMenuOptions&&(e=a.getExtraMenuOptions(this))&&
(e.push(null),b=e.concat(b));!1!==a.clonable&&b.push({content:"Clone",callback:f.onMenuNodeClone});!1!==a.removable&&b.push(null,{content:"Remove",callback:f.onMenuNodeRemove});if(a.graph&&a.graph.onGetNodeMenuOptions)a.graph.onGetNodeMenuOptions(b,a);return b};f.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:f.onShowPropertyEditor},{content:"Color",has_submenu:!0,callback:f.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:f.onShowPropertyEditor},
null,{content:"Remove",callback:f.onMenuNodeRemove}]};f.prototype.processContextMenu=function(a,b){var e=this,g=f.active_canvas.getCanvasWindow(),d=null,k={event:b,callback:function(b,c,g){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?a.removeInput(b.slot):b.output&&a.removeOutput(b.slot);else if("Disconnect Links"==b.content)b=b.slot,b.output?a.disconnectOutput(b.slot):b.input&&a.disconnectInput(b.slot);else if("Rename Slot"==b.content){b=b.slot;var d=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),
D=e.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",c),k=D.querySelector("input");k&&d&&(k.value=d.label||"");D.querySelector("button").addEventListener("click",function(a){k.value&&(d&&(d.label=k.value),e.setDirty(!0));D.close()})}},extra:a},m=null;a&&(m=a.getSlotInPosition(b.canvasX,b.canvasY),f.active_node=a);if(m){d=[];m&&m.output&&m.output.links&&m.output.links.length&&d.push({content:"Disconnect Links",slot:m});var r=m.input||m.output;d.push(r.locked?
...
d&&new c.ContextMenu(d,k,g)};this.CanvasRenderingContext2D&&(CanvasRenderingContext2D.prototype.roundRect=function(a,b,e,c,g,d){void 0===g&&(g=5);void 0===d&&(d=g);this.moveTo(a+g,b);this.lineTo(a+e-g,b);this.quadraticCurveTo(a+e,b,a+e,b+g);this.lineTo(a+e,b+c-d);this.quadraticCurveTo(a+e,b+c,a+e-d,b+c);this.lineTo(a+d,b+c);this.quadraticCurveTo(a,b+c,a,b+c-d);this.lineTo(a,b+g);this.quadraticCurveTo(a,b,a+g,b)});c.compareObjects=function(a,b){for(var e in a)if(a[e]!=b[e])return!1;return!0};c.distance=
y;c.colorToString=function(a){return"rgba("+Math.round(255*a[0]).toFixed()+","+Math.round(255*a[1]).toFixed()+","+Math.round(255*a[2]).toFixed()+","+(4==a.length?a[3].toFixed(2):"1.0")+")"};c.isInsideRectangle=B;c.growBounding=function(a,b,e){b<a[0]?a[0]=b:b>a[2]&&(a[2]=b);e<a[1]?a[1]=e:e>a[3]&&(a[3]=e)};c.isInsideBounding=function(a,b){return a[0]<b[0][0]||a[1]<b[0][1]||a[0]>b[1][0]||a[1]>b[1][1]?!1:!0};c.overlapBounding=A;c.hex2num=function(a){"#"==a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();
for(var b=Array(3),e=0,c,g,d=0;6>d;d+=2)c="0123456789ABCDEF".indexOf(a.charAt(d)),g="0123456789ABCDEF".indexOf(a.charAt(d+1)),b[e]=16*c+g,e++;return b};c.num2hex=function(a){for(var b="#",e,c,g=0;3>g;g++)e=a[g]/16,c=a[g]%16,b+="0123456789ABCDEF".charAt(e)+"0123456789ABCDEF".charAt(c);return b};z.prototype.addItem=function(a,b,e){function c(a){var b=this.value;b&&b.has_submenu&&g.call(this,a)}function g(a){var b=this.value,c=!0;d.current_submenu&&d.current_submenu.close(a);if(e.callback){var k=e.callback.call(this,
b,e,a,d,e.node);!0===k&&(c=!1)}if(b&&(b.callback&&!e.ignore_item_callbacks&&!0!==b.disabled&&(k=b.callback.call(this,b,e,a,d,e.extra),!0===k&&(c=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new d.constructor(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:d,ignore_item_callbacks:b.submenu.ignore_item_callbacks,title:b.submenu.title,extra:b.submenu.extra,autoopen:e.autoopen});c=!1}c&&!d.lock&&d.close()}var d=this;e=e||{};var k=document.createElement("div");
k.className="litemenu-entry submenu";var f=!1;if(null===b)k.classList.add("separator");else{k.innerHTML=b&&b.title?b.title:a;if(k.value=b)b.disabled&&(f=!0,k.classList.add("disabled")),(b.submenu||b.has_submenu)&&k.classList.add("has_submenu");"function"==typeof b?(k.dataset.value=a,k.onclick_callback=b):k.dataset.value=b;b.className&&(k.className+=" "+b.className)}this.root.appendChild(k);f||k.addEventListener("click",g);e.autoopen&&k.addEventListener("mouseenter",c);return k};z.prototype.close=
...
!0,!0,e);g.srcElement=c;a.dispatchEvent?a.dispatchEvent(g):a.__events&&a.__events.dispatchEvent(g);return g};z.prototype.getTopMenu=function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};z.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};z.isCursorOverElement=function(a,b){var e=a.clientX,c=a.clientY,g=b.getBoundingClientRect();return g?c>g.top&&c<g.top+g.height&&e>g.left&&e<g.left+g.width?!0:
!1:!1};c.ContextMenu=z;c.closeAllContextMenus=function(a){a=a||window;a=a.document.querySelectorAll(".litecontextmenu");if(a.length){for(var b=[],e=0;e<a.length;e++)b.push(a[e]);for(e in b)b[e].close?b[e].close():b[e].parentNode&&b[e].parentNode.removeChild(b[e])}};c.extendClass=function(a,b){for(var e in b)a.hasOwnProperty(e)||(a[e]=b[e]);if(b.prototype)for(e in b.prototype)b.prototype.hasOwnProperty(e)&&!a.prototype.hasOwnProperty(e)&&(b.prototype.__lookupGetter__(e)?a.prototype.__defineGetter__(e,
...
this.size=[140,30];this._value=null}function B(){this.addInput("obj","");this.addOutput("","");this.addProperty("value","");this.widget=this.addWidget("text","prop.","",this.setValue.bind(this));this.widgets_up=!0;this.size=[140,30];this._value=null}function A(){this.size=[60,20];this.addInput("value",0,{label:""});this.value=0}function z(){this.addInput("in",0);this.addOutput("out",0);this.size=[40,20]}function c(){this.mode=m.ON_EVENT;this.size=[80,30];this.addProperty("msg","");this.addInput("log",
m.EVENT);this.addInput("msg",0)}function x(){this.mode=m.ON_EVENT;this.addProperty("msg","");this.addInput("",m.EVENT);var c=this;this.widget=this.addWidget("text","Text","",function(g){c.properties.msg=g});this.widgets_up=!0;this.size=[200,30]}function k(){this.size=[60,20];this.addProperty("onExecute","return A;");this.addInput("A","");this.addInput("B","");this.addOutput("out","");this._func=null;this.data={}}var m=v.LiteGraph;d.title="Time";d.desc="Time";d.prototype.onExecute=function(){this.setOutputData(0,
1E3*this.graph.globaltime);this.setOutputData(1,this.graph.globaltime)};m.registerNodeType("basic/time",d);h.title="Subgraph";h.desc="Graph inside a node";h.title_color="#334";h.prototype.onGetInputs=function(){return[["enabled","boolean"]]};h.prototype.onDrawTitle=function(c){if(!this.flags.collapsed){c.fillStyle="#555";var g=m.NODE_TITLE_HEIGHT,d=this.size[0]-g;c.fillRect(d,-g,g,g);c.fillStyle="#333";c.beginPath();c.moveTo(d+0.2*g,0.6*-g);c.lineTo(d+0.8*g,0.6*-g);c.lineTo(d+0.5*g,0.3*-g);c.fill()}};
h.prototype.onDblClick=function(c,g,d){var k=this;setTimeout(function(){d.openSubgraph(k.subgraph)},10)};h.prototype.onMouseDown=function(c,g,d){if(!this.flags.collapsed&&g[0]>this.size[0]-m.NODE_TITLE_HEIGHT&&0>g[1]){var k=this;setTimeout(function(){d.openSubgraph(k.subgraph)},10)}};h.prototype.onAction=function(c,g){this.subgraph.onAction(c,g)};h.prototype.onExecute=function(){if(this.enabled=this.getInputOrProperty("enabled")){if(this.inputs)for(var c=0;c<this.inputs.length;c++){var g=this.inputs[c],
...
c;this.widget.value=c};B.prototype.getTitle=function(){return this.flags.collapsed?"in."+this.properties.value:this.title};B.prototype.onPropertyChanged=function(c,g){this.widget.value=g};B.prototype.onExecute=function(){var c=this.getInputData(0);null!=c&&this.setOutputData(0,c[this.properties.value])};m.registerNodeType("basic/object_property",B);A.title="Watch";A.desc="Show value of input";A.prototype.onExecute=function(){this.inputs[0]&&(this.value=this.getInputData(0))};A.prototype.getTitle=
...
this.value;this.setOutputData(0,this.properties.value);this.boxcolor=z.colorToString([this.value,this.value,this.value])};f.prototype.onMouseDown=function(c){if(0>c.canvasY-this.pos[1])return!1;this.oldmouse=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];this.captureInput(!0);return!0};f.prototype.onMouseMove=function(c){if(this.oldmouse){c=[c.canvasX-this.pos[0],c.canvasY-this.pos[1]];var d=this.value,d=d+(c[0]-this.oldmouse[0])/this.size[0];1<d?d=1:0>d&&(d=0);this.value=d;this.oldmouse=c;this.setDirtyCanvas(!0)}};
f.prototype.onMouseUp=function(c){this.oldmouse=null;this.captureInput(!1)};f.prototype.onMouseLeave=function(c){};z.registerNodeType("widget/hslider",f);y.title="Progress";y.desc="Shows data in linear progress";y.prototype.onExecute=function(){var c=this.getInputData(0);void 0!=c&&(this.properties.value=c)};y.prototype.onDrawForeground=function(c){c.lineWidth=1;c.fillStyle=this.properties.color;var d=(this.properties.value-this.properties.min)/(this.properties.max-this.properties.min),d=Math.min(1,
d),d=Math.max(0,d);c.fillRect(2,2,(this.size[0]-4)*d,this.size[1]-4)};z.registerNodeType("widget/progress",y);B.title="Text";B.desc="Shows the input value";B.widgets=[{name:"resize",text:"Resize box",type:"button"},{name:"led_text",text:"LED",type:"minibutton"},{name:"normal_text",text:"Normal",type:"minibutton"}];B.prototype.onDrawForeground=function(c){c.fillStyle=this.properties.color;var d=this.properties.value;this.properties.glowSize?(c.shadowColor=this.properties.color,c.shadowOffsetX=0,c.shadowOffsetY=
0,c.shadowBlur=this.properties.glowSize):c.shadowColor="transparent";var k=this.properties.fontsize;c.textAlign=this.properties.align;c.font=k.toString()+"px "+this.properties.font;this.str="number"==typeof d?d.toFixed(this.properties.decimals):d;if("string"==typeof this.str){var d=this.str.split("\\n"),f;for(f in d)c.fillText(d[f],"left"==this.properties.align?15:this.size[0]-15,-0.15*k+k*(parseInt(f)+1))}c.shadowColor="transparent";this.last_ctx=c;c.textAlign="left"};B.prototype.onExecute=function(){var c=
this.getInputData(0);null!=c&&(this.properties.value=c)};B.prototype.resize=function(){if(this.last_ctx){var c=this.str.split("\\n");this.last_ctx.font=this.properties.fontsize+"px "+this.properties.font;var d=0,k;for(k in c){var f=this.last_ctx.measureText(c[k]).width;d<f&&(d=f)}this.size[0]=d+20;this.size[1]=4+c.length*this.properties.fontsize;this.setDirtyCanvas(!0)}};B.prototype.onPropertyChanged=function(c,d){this.properties[c]=d;this.str="number"==typeof d?d.toFixed(3):d;return!0};z.registerNodeType("widget/text",
...
(function(v){function d(){this.addOutput("left_x_axis","number");this.addOutput("left_y_axis","number");this.addOutput("button_pressed",h.EVENT);this.properties={gamepad_index:0,threshold:0.1};this._left_axis=new Float32Array(2);this._right_axis=new Float32Array(2);this._triggers=new Float32Array(2);this._previous_buttons=new Uint8Array(17);this._current_buttons=new Uint8Array(17)}var h=v.LiteGraph;d.title="Gamepad";d.desc="gets the input of the gamepad";d.CENTER=0;d.LEFT=1;d.RIGHT=2;d.UP=4;d.DOWN=
8;d.zero=new Float32Array(2);d.buttons="a b x y lb rb lt rt back start ls rs home".split(" ");d.prototype.onExecute=function(){var h=this.getGamepad(),n=this.properties.threshold||0;h&&(this._left_axis[0]=Math.abs(h.xbox.axes.lx)>n?h.xbox.axes.lx:0,this._left_axis[1]=Math.abs(h.xbox.axes.ly)>n?h.xbox.axes.ly:0,this._right_axis[0]=Math.abs(h.xbox.axes.rx)>n?h.xbox.axes.rx:0,this._right_axis[1]=Math.abs(h.xbox.axes.ry)>n?h.xbox.axes.ry:0,this._triggers[0]=Math.abs(h.xbox.axes.ltrigger)>n?h.xbox.axes.ltrigger:
0,this._triggers[1]=Math.abs(h.xbox.axes.rtrigger)>n?h.xbox.axes.rtrigger:0);if(this.outputs)for(n=0;n<this.outputs.length;n++){var t=this.outputs[n];if(t.links&&t.links.length){var f=null;if(h)switch(t.name){case "left_axis":f=this._left_axis;break;case "right_axis":f=this._right_axis;break;case "left_x_axis":f=this._left_axis[0];break;case "left_y_axis":f=this._left_axis[1];break;case "right_x_axis":f=this._right_axis[0];break;case "right_y_axis":f=this._right_axis[1];break;case "trigger_left":f=
...
h.xbox.hatmap&d.RIGHT;break;case "hat_up":f=h.xbox.hatmap&d.UP;break;case "hat_down":f=h.xbox.hatmap&d.DOWN;break;case "hat":f=h.xbox.hatmap;break;case "start_button":f=h.xbox.buttons.start?1:0;break;case "back_button":f=h.xbox.buttons.back?1:0;break;case "button_pressed":for(t=0;t<this._current_buttons.length;++t)this._current_buttons[t]&&!this._previous_buttons[t]&&this.triggerSlot(n,d.buttons[t])}else switch(t.name){case "button_pressed":break;case "left_axis":case "right_axis":f=d.zero;break;
default:f=0}this.setOutputData(n,f)}}};d.prototype.getGamepad=function(){var h=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!h)return null;var n=h.call(navigator),h=null;this._previous_buttons.set(this._current_buttons);for(h=this.properties.gamepad_index;4>h;h++)if(n[h]){h=n[h];n=this.xbox_mapping;n||(n=this.xbox_mapping={axes:[],buttons:{},hat:"",hatmap:d.CENTER});n.axes.lx=h.axes[0];n.axes.ly=h.axes[1];n.axes.rx=h.axes[2];n.axes.ry=h.axes[3];n.axes.ltrigger=h.buttons[6].value;
n.axes.rtrigger=h.buttons[7].value;n.hat="";n.hatmap=d.CENTER;for(var t=0;t<h.buttons.length;t++)switch(this._current_buttons[t]=h.buttons[t].pressed,t){case 0:n.buttons.a=h.buttons[t].pressed;break;case 1:n.buttons.b=h.buttons[t].pressed;break;case 2:n.buttons.x=h.buttons[t].pressed;break;case 3:n.buttons.y=h.buttons[t].pressed;break;case 4:n.buttons.lb=h.buttons[t].pressed;break;case 5:n.buttons.rb=h.buttons[t].pressed;break;case 6:n.buttons.lt=h.buttons[t].pressed;break;case 7:n.buttons.rt=h.buttons[t].pressed;
break;case 8:n.buttons.back=h.buttons[t].pressed;break;case 9:n.buttons.start=h.buttons[t].pressed;break;case 10:n.buttons.ls=h.buttons[t].pressed;break;case 11:n.buttons.rs=h.buttons[t].pressed;break;case 12:h.buttons[t].pressed&&(n.hat+="up",n.hatmap|=d.UP);break;case 13:h.buttons[t].pressed&&(n.hat+="down",n.hatmap|=d.DOWN);break;case 14:h.buttons[t].pressed&&(n.hat+="left",n.hatmap|=d.LEFT);break;case 15:h.buttons[t].pressed&&(n.hat+="right",n.hatmap|=d.RIGHT);break;case 16:n.buttons.home=h.buttons[t].pressed}h.xbox=
...
Math.sqrt(c[0]*c[0]+c[1]*c[1]+c[2]*c[2]),f=this._data;f[0]=c[0]/d;f[1]=c[1]/d;f[2]=c[2]/d;this.setOutputData(0,f)}};x.registerNodeType("math3d/vec3-normalize",A);z.title="vec3_lerp";z.desc="returns the interpolated vector";z.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var d=this.getInputData(1);if(null!=d){var f=this.getInputOrProperty("f"),g=this._data;g[0]=c[0]*(1-f)+d[0]*f;g[1]=c[1]*(1-f)+d[1]*f;g[2]=c[2]*(1-f)+d[2]*f;this.setOutputData(0,g)}}};x.registerNodeType("math3d/vec3-lerp",
...
v.title="Rot. Vec3",v.desc="rotate a point",v.prototype.onExecute=function(){var c=this.getInputData(0);null==c&&(c=this.properties.vec);var d=this.getInputData(1);null==d?this.setOutputData(c):this.setOutputData(0,vec3.transformQuat(vec3.create(),c,d))},x.registerNodeType("math3d/rotate_vec3",v),v=function(){this.addInputs([["A","quat"],["B","quat"]]);this.addOutput("A*B","quat");this._value=quat.create()},v.title="Mult. Quat",v.desc="rotate quaternion",v.prototype.onExecute=function(){var c=this.getInputData(0);
if(null!=c){var d=this.getInputData(1);null!=d&&(c=quat.multiply(this._value,c,d),this.setOutputData(0,c))}},x.registerNodeType("math3d/mult-quat",v),v=function(){this.addInputs([["A","quat"],["B","quat"],["factor","number"]]);this.addOutput("slerp","quat");this.addProperty("factor",0.5);this._value=quat.create()},v.title="Quat Slerp",v.desc="quaternion spherical interpolation",v.prototype.onExecute=function(){var c=this.getInputData(0);if(null!=c){var d=this.getInputData(1);if(null!=d){var f=this.properties.factor;
...
0,0,this.canvas.width,this.canvas.height,0,0,this.size[0],this.size[1])};f.prototype.onPropertyChanged=function(c,d){this.properties[c]=d;"scale"==c?(this.properties[c]=parseFloat(d),0==this.properties[c]&&(this.trace("Error in scale"),this.properties[c]=1)):this.properties[c]=parseInt(d);this.createCanvas();return!0};x.registerNodeType("graphics/cropImage",f);y.title="Canvas";y.desc="Canvas to render stuff";y.prototype.onExecute=function(){var c=this.canvas,d=this.properties.width|0,f=this.properties.height|
0;c.width!=d&&(c.width=d);c.height!=f&&(c.height=f);this.properties.autoclear&&this.ctx.clearRect(0,0,c.width,c.height);this.setOutputData(0,c)};y.prototype.onAction=function(c,d){"clear"==c&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)};x.registerNodeType("graphics/canvas",y);B.title="DrawImage";B.desc="Draws image into a canvas";B.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var d=this.getInputOrProperty("img");if(d){var f=this.getInputOrProperty("x"),g=this.getInputOrProperty("y");
c.getContext("2d").drawImage(d,f,g)}}};x.registerNodeType("graphics/drawImage",B);A.title="DrawRectangle";A.desc="Draws rectangle in canvas";A.prototype.onExecute=function(){var c=this.getInputData(0);if(c){var d=this.getInputOrProperty("x"),f=this.getInputOrProperty("y"),g=this.getInputOrProperty("w"),h=this.getInputOrProperty("h");c.getContext("2d").fillRect(d,f,g,h)}};x.registerNodeType("graphics/drawRectangle",A);z.title="Video";z.desc="Video playback";z.widgets=[{name:"play",text:"PLAY",type:"minibutton"},
...
A.gamma_pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_igamma;\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t\t   gl_FragColor = color;\n\t\t\t}\n\t\t\t";d.registerNodeType("texture/toviewport",A);n=function(){this.addInput("Texture","Texture");this.addOutput("","Texture");this.properties={size:0,generate_mipmaps:!1,
...
format:gl.RGBA,minFilter:gl.LINEAR_MIPMAP_LINEAR,magFilter:gl.LINEAR})),a.copyTo(this._temp_pot2_texture),a=this._temp_pot2_texture,a.bind(0),gl.generateMipmap(GL.TEXTURE_2D),this._uniforms.u_mipmap_offset=9);var d=c._shader,g=this._uniforms;g.u_mipmap_offset=this.properties.mipmap_offset;gl.disable(gl.DEPTH_TEST);gl.disable(gl.BLEND);this._temp_texture.drawTo(function(){a.toViewport(d,g)});if(this.isOutputConnected(1)||this.isOutputConnected(2))if(e=this._temp_texture.getPixels()){var f=this._luminance,
b=this._temp_texture.type;f.set(e);b==gl.UNSIGNED_BYTE&&vec4.scale(f,f,1/255)}}};c.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tuniform mat4 u_samples_a;\n\t\t\tuniform mat4 u_samples_b;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_mipmap_offset;\n\t\t\tvarying vec2 v_coord;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = vec4(0.0);\n\t\t\t\t//random average\n\t\t\t\tfor(int i = 0; i < 4; ++i)\n\t\t\t\t\tfor(int j = 0; j < 4; ++j)\n\t\t\t\t\t{\n\t\t\t\t\t\tcolor += texture2D(u_texture, vec2( u_samples_a[i][j], u_samples_b[i][j] ), u_mipmap_offset );\n\t\t\t\t\t\tcolor += texture2D(u_texture, vec2( 1.0 - u_samples_a[i][j], 1.0 - u_samples_b[i][j] ), u_mipmap_offset );\n\t\t\t\t\t}\n\t\t\t   gl_FragColor = color * 0.03125;\n\t\t\t}\n\t\t\t";
...
m.pixel_shader))};m.widgets_info={texture:{widget:"texture"},precision:{widget:"combo",values:h.MODE_VALUES}};m.title="LUT";m.desc="Apply LUT to Texture";m.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);if(this.properties.precision===h.PASS_THROUGH||!1===this.properties.enabled)this.setOutputData(0,a);else if(a){var b=this.getInputData(1);b||(b=h.getTexture(this.properties.texture));if(b){b.bind(0);gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_MIN_FILTER,gl.LINEAR);
gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_WRAP_S,gl.CLAMP_TO_EDGE);gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_WRAP_T,gl.CLAMP_TO_EDGE);gl.bindTexture(gl.TEXTURE_2D,null);var c=this.properties.intensity;this.isInputConnected(2)&&(this.properties.intensity=c=this.getInputData(2));this._tex=h.getTargetTexture(a,this._tex,this.properties.precision);this._tex.drawTo(function(){b.bind(1);a.toViewport(m._shader,{u_texture:0,u_textureB:1,u_amount:c})});this.setOutputData(0,this._tex)}else this.setOutputData(0,
a)}}};m.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform sampler2D u_textureB;\n\t\t\tuniform float u_amount;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\t lowp vec4 textureColor = clamp( texture2D(u_texture, v_coord), vec4(0.0), vec4(1.0) );\n\t\t\t\t mediump float blueColor = textureColor.b * 63.0;\n\t\t\t\t mediump vec2 quad1;\n\t\t\t\t quad1.y = floor(floor(blueColor) / 8.0);\n\t\t\t\t quad1.x = floor(blueColor) - (quad1.y * 8.0);\n\t\t\t\t mediump vec2 quad2;\n\t\t\t\t quad2.y = floor(ceil(blueColor) / 8.0);\n\t\t\t\t quad2.x = ceil(blueColor) - (quad2.y * 8.0);\n\t\t\t\t highp vec2 texPos1;\n\t\t\t\t texPos1.x = (quad1.x * 0.125) + 0.5/512.0 + ((0.125 - 1.0/512.0) * textureColor.r);\n\t\t\t\t texPos1.y = 1.0 - ((quad1.y * 0.125) + 0.5/512.0 + ((0.125 - 1.0/512.0) * textureColor.g));\n\t\t\t\t highp vec2 texPos2;\n\t\t\t\t texPos2.x = (quad2.x * 0.125) + 0.5/512.0 + ((0.125 - 1.0/512.0) * textureColor.r);\n\t\t\t\t texPos2.y = 1.0 - ((quad2.y * 0.125) + 0.5/512.0 + ((0.125 - 1.0/512.0) * textureColor.g));\n\t\t\t\t lowp vec4 newColor1 = texture2D(u_textureB, texPos1);\n\t\t\t\t lowp vec4 newColor2 = texture2D(u_textureB, texPos2);\n\t\t\t\t lowp vec4 newColor = mix(newColor1, newColor2, fract(blueColor));\n\t\t\t\t gl_FragColor = vec4( mix( textureColor.rgb, newColor.rgb, u_amount), textureColor.w);\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/LUT",m);var r=function(){this.addInput("Texture","Texture");this.addOutput("R","Texture");this.addOutput("G","Texture");this.addOutput("B","Texture");this.addOutput("A","Texture");this.properties={use_luminance:!0};r._shader||(r._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,r.pixel_shader))};r.title="Texture to Channels";r.desc="Split texture channels";r.prototype.onExecute=function(){var a=this.getInputData(0);if(a){this._channels||(this._channels=Array(4));for(var b=
...
b);else if(b){this._tex=h.getTargetTexture(b,this._tex,this.properties.precision);gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var c=Mesh.getScreenQuad(),e=a._shader,d=this.properties.invert,g=this.properties.factor,f=this.properties.threshold?1:0;this._tex.drawTo(function(){b.bind(0);e.uniforms({u_texture:0,u_isize:[1/b.width,1/b.height],u_factor:g,u_threshold:f,u_invert:d?1:0}).draw(c)});this.setOutputData(0,this._tex)}}};a.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_isize;\n\t\t\tuniform int u_invert;\n\t\t\tuniform float u_factor;\n\t\t\tuniform float u_threshold;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 center = texture2D(u_texture, v_coord);\n\t\t\t\tvec4 up = texture2D(u_texture, v_coord + u_isize * vec2(0.0,1.0) );\n\t\t\t\tvec4 down = texture2D(u_texture, v_coord + u_isize * vec2(0.0,-1.0) );\n\t\t\t\tvec4 left = texture2D(u_texture, v_coord + u_isize * vec2(1.0,0.0) );\n\t\t\t\tvec4 right = texture2D(u_texture, v_coord + u_isize * vec2(-1.0,0.0) );\n\t\t\t\tvec4 diff = abs(center - up) + abs(center - down) + abs(center - left) + abs(center - right);\n\t\t\t\tdiff *= u_factor;\n\t\t\t\tif(u_invert == 1)\n\t\t\t\t\tdiff.xyz = vec3(1.0) - diff.xyz;\n\t\t\t\tif( u_threshold == 0.0 )\n\t\t\t\t\tgl_FragColor = vec4( diff.xyz, center.a );\n\t\t\t\telse\n\t\t\t\t\tgl_FragColor = vec4( diff.x > 0.5 ? 1.0 : 0.0, diff.y > 0.5 ? 1.0 : 0.0, diff.z > 0.5 ? 1.0 : 0.0, center.a );\n\t\t\t}\n\t\t\t";
d.registerNodeType("texture/edges",a);var b=function(){this.addInput("Texture","Texture");this.addInput("Distance","number");this.addInput("Range","number");this.addOutput("Texture","Texture");this.properties={distance:100,range:50,only_depth:!1,high_precision:!1};this._uniforms={u_texture:0,u_distance:100,u_range:50,u_camera_planes:null}};b.title="Depth Range";b.desc="Generates a texture with a depth range";b.prototype.onExecute=function(){if(this.isOutputConnected(0)){var a=this.getInputData(0);
if(a){var c=gl.UNSIGNED_BYTE;this.properties.high_precision&&(c=gl.half_float_ext?gl.HALF_FLOAT_OES:gl.FLOAT);this._temp_texture&&this._temp_texture.type==c&&this._temp_texture.width==a.width&&this._temp_texture.height==a.height||(this._temp_texture=new GL.Texture(a.width,a.height,{type:c,format:gl.RGBA,filter:gl.LINEAR}));var e=this._uniforms,c=this.properties.distance;this.isInputConnected(1)&&(c=this.getInputData(1),this.properties.distance=c);var d=this.properties.range;this.isInputConnected(2)&&
(d=this.getInputData(2),this.properties.range=d);e.u_distance=c;e.u_range=d;gl.disable(gl.BLEND);gl.disable(gl.DEPTH_TEST);var g=Mesh.getScreenQuad();b._shader||(b._shader=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,b.pixel_shader),b._shader_onlydepth=new GL.Shader(Shader.SCREEN_VERTEX_SHADER,b.pixel_shader,{ONLY_DEPTH:""}));var f=this.properties.only_depth?b._shader_onlydepth:b._shader,c=null,c=a.near_far_planes?a.near_far_planes:window.LS&&LS.Renderer._main_camera?LS.Renderer._main_camera._uniforms.u_camera_planes:
[0.1,1E3];e.u_camera_planes=c;this._temp_texture.drawTo(function(){a.bind(0);f.uniforms(e).draw(g)});this._temp_texture.near_far_planes=c;this.setOutputData(0,this._temp_texture)}}};b.pixel_shader="precision highp float;\n\t\t\tprecision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform vec2 u_camera_planes;\n\t\t\tuniform float u_distance;\n\t\t\tuniform float u_range;\n\t\t\t\n\t\t\tfloat LinearDepth()\n\t\t\t{\n\t\t\t\tfloat zNear = u_camera_planes.x;\n\t\t\t\tfloat zFar = u_camera_planes.y;\n\t\t\t\tfloat depth = texture2D(u_texture, v_coord).x;\n\t\t\t\tdepth = depth * 2.0 - 1.0;\n\t\t\t\treturn zNear * (depth + 1.0) / (zFar + zNear - depth * (zFar - zNear));\n\t\t\t}\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tfloat depth = LinearDepth();\n\t\t\t\t#ifdef ONLY_DEPTH\n\t\t\t\t   gl_FragColor = vec4(depth);\n\t\t\t\t#else\n\t\t\t\t\tfloat diff = abs(depth * u_camera_planes.y - u_distance);\n\t\t\t\t\tfloat dof = 1.0;\n\t\t\t\t\tif(diff <= u_range)\n\t\t\t\t\t\tdof = diff / u_range;\n\t\t\t\t   gl_FragColor = vec4(dof);\n\t\t\t\t#endif\n\t\t\t}\n\t\t\t";
...
function(){return[["enabled","boolean"]]};I.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0))if(this.properties.precision===h.PASS_THROUGH||!1===this.getInputOrProperty("enabled"))this.setOutputData(0,a);else{var b=this._temp_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var c=I._shader;c||(c=I._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,
I.pixel_shader));var e=this.getInputData(1);null==e&&(e=this.properties.factor);var d=this._uniforms;d.u_factor=e;gl.disable(gl.DEPTH_TEST);b.drawTo(function(){a.bind(0);c.uniforms(d).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,b)}};I.pixel_shader="precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_factor;\n\t\t\tvec2 barrelDistortion(vec2 coord, float amt) {\n\t\t\t\tvec2 cc = coord - 0.5;\n\t\t\t\tfloat dist = dot(cc, cc);\n\t\t\t\treturn coord + cc * dist * amt;\n\t\t\t}\n\t\t\t\n\t\t\tfloat sat( float t )\n\t\t\t{\n\t\t\t\treturn clamp( t, 0.0, 1.0 );\n\t\t\t}\n\t\t\t\n\t\t\tfloat linterp( float t ) {\n\t\t\t\treturn sat( 1.0 - abs( 2.0*t - 1.0 ) );\n\t\t\t}\n\t\t\t\n\t\t\tfloat remap( float t, float a, float b ) {\n\t\t\t\treturn sat( (t - a) / (b - a) );\n\t\t\t}\n\t\t\t\n\t\t\tvec4 spectrum_offset( float t ) {\n\t\t\t\tvec4 ret;\n\t\t\t\tfloat lo = step(t,0.5);\n\t\t\t\tfloat hi = 1.0-lo;\n\t\t\t\tfloat w = linterp( remap( t, 1.0/6.0, 5.0/6.0 ) );\n\t\t\t\tret = vec4(lo,1.0,hi, 1.) * vec4(1.0-w, w, 1.0-w, 1.);\n\t\t\t\n\t\t\t\treturn pow( ret, vec4(1.0/2.2) );\n\t\t\t}\n\t\t\t\n\t\t\tconst float max_distort = 2.2;\n\t\t\tconst int num_iter = 12;\n\t\t\tconst float reci_num_iter_f = 1.0 / float(num_iter);\n\t\t\t\n\t\t\tvoid main()\n\t\t\t{\t\n\t\t\t\tvec2 uv=v_coord;\n\t\t\t\tvec4 sumcol = vec4(0.0);\n\t\t\t\tvec4 sumw = vec4(0.0);\t\n\t\t\t\tfor ( int i=0; i<num_iter;++i )\n\t\t\t\t{\n\t\t\t\t\tfloat t = float(i) * reci_num_iter_f;\n\t\t\t\t\tvec4 w = spectrum_offset( t );\n\t\t\t\t\tsumw += w;\n\t\t\t\t\tsumcol += w * texture2D( u_texture, barrelDistortion(uv, .6 * max_distort*t * u_factor ) );\n\t\t\t\t}\n\t\t\t\tgl_FragColor = sumcol / sumw;\n\t\t\t}";
d.registerNodeType("texture/lensfx",I);var J=function(){this.addInput("in","Texture");this.addInput("exp","number");this.addOutput("out","Texture");this.properties={exposition:1,precision:h.LOW};this._uniforms={u_texture:0,u_exposition:1}};J.title="Exposition";J.desc="Controls texture exposition";J.widgets_info={exposition:{widget:"slider",min:0,max:3},precision:{widget:"combo",values:h.MODE_VALUES}};J.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&this.isOutputConnected(0)){var b=
this._temp_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var c=J._shader;c||(c=J._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,J.pixel_shader));var e=this.getInputData(1);null!=e&&(this.properties.exposition=e);var d=this._uniforms;b.drawTo(function(){gl.disable(gl.DEPTH_TEST);a.bind(0);c.uniforms(d).draw(GL.Mesh.getScreenQuad())});this.setOutputData(0,b)}};J.pixel_shader=
"precision highp float;\n\t\t\tvarying vec2 v_coord;\n\t\t\tuniform sampler2D u_texture;\n\t\t\tuniform float u_exposition;\n\t\t\t\n\t\t\tvoid main() {\n\t\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\t\t\t\tgl_FragColor = vec4( color.xyz * u_exposition, color.a );\n\t\t\t}";d.registerNodeType("texture/exposition",J);var G=function(){this.addInput("in","Texture");this.addInput("avg","number,Texture");this.addOutput("out","Texture");this.properties={enabled:!0,scale:1,gamma:1,average_lum:1,
...
a);else{var b=this._temp_texture;b&&b.width==a.width&&b.height==a.height&&b.type==a.type||(b=this._temp_texture=new GL.Texture(a.width,a.height,{type:a.type,format:gl.RGBA,filter:gl.LINEAR}));var c=this.getInputData(1);null==c&&(c=this.properties.average_lum);var e=this._uniforms,d=null;c.constructor===Number?(this.properties.average_lum=c,e.u_average_lum=this.properties.average_lum,d=G._shader,d||(d=G._shader=new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER,G.pixel_shader))):c.constructor===GL.Texture&&
...
(h=Number(c[2]))):1<c.length&&(h=Number(c[1]));c=d.note_to_index[f];return null==c?null:12*(h-1)+c+21};d.prototype.toString=function(){var c=""+this.channel+". ";switch(this.cmd){case d.NOTEON:c+="NOTEON "+d.toNoteString(this.data[1]);break;case d.NOTEOFF:c+="NOTEOFF "+d.toNoteString(this.data[1]);break;case d.CONTROLLERCHANGE:c+="CC "+this.data[1]+" "+this.data[2];break;case d.PROGRAMCHANGE:c+="PC "+this.data[1];break;case d.PITCHBEND:c+="PITCHBEND "+this.getPitchBend();break;case d.KEYPRESSURE:c+=
...
this.properties.min_value=this.properties.max_value=f.data[1];else if(-1!=this.properties.channel&&f.channel!=this.properties.channel||-1!=this.properties.cmd&&f.cmd!=this.properties.cmd||-1!=this.properties.min_value&&f.data[1]<this.properties.min_value||-1!=this.properties.max_value&&f.data[1]>this.properties.max_value)return;this.trigger("on_midi",f)}};m.registerNodeType("midi/filter",f);y.title="MIDIEvent";y.desc="Create a MIDI Event";y.color="#243";y.prototype.onAction=function(c,f){"assign"==
...
f))};y.prototype.onExecute=function(){var c=this.properties;if(this.inputs)for(var f=0;f<this.inputs.length;++f){var h=this.inputs[f];if(-1!=h.link)switch(h.name){case "note":h=this.getInputData(f),null!=h&&(h.constructor===String&&(h=d.NoteStringToPitch(h)),this.properties.value1=(h|0)%255)}}if(this.outputs)for(f=0;f<this.outputs.length;++f){switch(this.outputs[f].name){case "midi":h=new d;h.setup([c.cmd,c.value1,c.value2]);h.channel=c.channel;break;case "command":h=c.cmd;break;case "cc":h=c.value1;
break;case "cc_value":h=c.value2;break;case "note":h=c.cmd==d.NOTEON||c.cmd==d.NOTEOFF?c.value1:null;break;case "velocity":h=c.cmd==d.NOTEON?c.value2:null;break;case "pitch":h=c.cmd==d.NOTEON?d.computePitch(c.value1):null;break;case "pitchbend":h=c.cmd==d.PITCHBEND?d.computePitchBend(c.value1,c.value2):null;break;case "gate":h=this.gate;break;default:continue}null!==h&&this.setOutputData(f,h)}};y.prototype.onPropertyChanged=function(c,f){"cmd"==c&&(this.properties.cmd=d.computeCommandFromString(f))};
y.prototype.onGetInputs=function(){return[["note","number"]]};y.prototype.onGetOutputs=function(){return[["midi","midi"],["on_midi",m.EVENT],["command","number"],["note","number"],["velocity","number"],["cc","number"],["cc_value","number"],["pitch","number"],["gate","bool"],["pitchbend","number"]]};m.registerNodeType("midi/event",y);B.title="MIDICC";B.desc="gets a Controller Change";B.color="#243";B.prototype.onExecute=function(){h.input&&(this.properties.value=h.input.state.cc[this.properties.cc]);
this.setOutputData(0,this.properties.value)};m.registerNodeType("midi/cc",B);A.title="MIDI Generator";A.desc="Generates a random MIDI note";A.color="#243";A.processScale=function(c){c=c.split(",");for(var f=0;f<c.length;++f){var h=c[f];c[f]=2==h.length&&"#"!=h[1]||2<h.length?-m.MIDIEvent.NoteStringToPitch(h):d.note_to_index[h]||0}return c};A.prototype.onPropertyChanged=function(c,d){"notes"==c&&(this.notes_pitches=A.processScale(d))};A.prototype.onExecute=function(){var c=this.getInputData(2);null!=
c&&(this.properties.octave=c);if(c=this.getInputData(1))this.notes_pitches=A.processScale(c)};A.prototype.onAction=function(c,f){var h=0,a=this.notes_pitches.length,b=0;"sequence"==this.properties.mode?b=this.sequence_index=(this.sequence_index+1)%a:"random"==this.properties.mode&&(b=Math.floor(Math.random()*a));a=this.notes_pitches[b];h=0<=a?a+12*(this.properties.octave-1)+33:-a;f=new d;f.setup([d.NOTEON,h,10]);a=this.properties.duration||1;this.trigger("note",f);setTimeout(function(){var a=new d;
a.setup([d.NOTEOFF,h,0]);this.trigger("note",a)}.bind(this),1E3*a)};m.registerNodeType("midi/generator",A);z.title="MIDI Transpose";z.desc="Transpose a MIDI note";z.color="#243";z.prototype.onAction=function(c,f){f&&f.constructor===d&&(f.data[0]==d.NOTEON||f.data[0]==d.NOTEOFF?(this.midi_event=new d,this.midi_event.setup(f.data),this.midi_event.data[1]=Math.round(this.midi_event.data[1]+this.properties.amount),this.trigger("out",this.midi_event)):this.trigger("out",f))};z.prototype.onExecute=function(){var c=
this.getInputData(1);null!=c&&(this.properties.amount=c)};m.registerNodeType("midi/transpose",z);c.title="MIDI Quantize Pitch";c.desc="Transpose a MIDI note tp fit an scale";c.color="#243";c.prototype.onPropertyChanged=function(c,d){"scale"==c&&this.processScale(d)};c.prototype.processScale=function(c){this._current_scale=c;this.notes_pitches=A.processScale(c);for(c=0;12>c;++c)this.valid_notes[c]=-1!=this.notes_pitches.indexOf(c);for(c=0;12>c;++c)if(this.valid_notes[c])this.offset_notes[c]=0;else for(var d=
...
this.processScale(c)};m.registerNodeType("midi/quantize",c);x.title="MIDI Play";x.desc="Plays a MIDI note";x.color="#243";x.prototype.onAction=function(c,f){if(f&&f.constructor===d){if(this.instrument&&f.data[0]==d.NOTEON){var h=f.note;if(!h||"undefined"==h||h.constructor!==String)return;this.instrument.play(h,f.octave,this.properties.duration,this.properties.volume)}this.trigger("note",f)}};x.prototype.onExecute=function(){var c=this.getInputData(1);null!=c&&(this.properties.volume=c);c=this.getInputData(2);
null!=c&&(this.properties.duration=c)};m.registerNodeType("midi/play",x);k.title="MIDI Keys";k.desc="Keyboard to play notes";k.color="#243";k.keys=[{x:0,w:1,h:1,t:0},{x:0.75,w:0.5,h:0.6,t:1},{x:1,w:1,h:1,t:0},{x:1.75,w:0.5,h:0.6,t:1},{x:2,w:1,h:1,t:0},{x:2.75,w:0.5,h:0.6,t:1},{x:3,w:1,h:1,t:0},{x:4,w:1,h:1,t:0},{x:4.75,w:0.5,h:0.6,t:1},{x:5,w:1,h:1,t:0},{x:5.75,w:0.5,h:0.6,t:1},{x:6,w:1,h:1,t:0}];k.prototype.onDrawForeground=function(c){if(!this.flags.collapsed){var d=12*this.properties.num_octaves;
this.keys.length=d;var f=this.size[0]/(7*this.properties.num_octaves),a=this.size[1];c.globalAlpha=1;for(var b=0;2>b;b++)for(var e=0;e<d;++e){var h=k.keys[e%12];if(h.t==b){var l=7*Math.floor(e/12)*f+h.x*f;c.fillStyle=0==b?this.keys[e]?"#CCC":"white":this.keys[e]?"#333":"black";c.fillRect(l+1,0,f*h.w-2,a*h.h)}}}};k.prototype.getKeyIndex=function(c){for(var d=this.size[0]/(7*this.properties.num_octaves),f=this.size[1],a=1;0<=a;a--)for(var b=0;b<this.keys.length;++b){var e=k.keys[b%12];if(e.t==a){var h=
7*Math.floor(b/12)*d+e.x*d,l=d*e.w,e=f*e.h;if(!(c[0]<h||c[0]>h+l||c[1]>e))return b}}return-1};k.prototype.onAction=function(c,f){if("reset"==c)for(var h=0;h<this.keys.length;++h)this.keys[h]=!1;else f&&f.constructor===d&&(h=f.data[1]-(12*(this.properties.start_octave-1)+29),0<=h&&h<this.keys.length&&(f.data[0]==d.NOTEON?this.keys[h]=!0:f.data[0]==d.NOTEOFF&&(this.keys[h]=!1)),this.trigger("note",f))};k.prototype.onMouseDown=function(c,f){if(!(0>f[1])){var h=this.getKeyIndex(f);this.keys[h]=!0;this._last_key=
