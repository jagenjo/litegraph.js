...
this.links[b];c.push([g.id,g.origin_id,g.origin_slot,g.target_id,g.target_slot])}return{iteration:this.iteration,frame:this.frame,last_node_id:this.last_node_id,last_link_id:this.last_link_id,links:c,config:this.config,nodes:a}};LGraph.prototype.configure=function(a,b){b||this.clear();var c=a.nodes;if(a.links&&a.links.constructor===Array){for(var g={},l=0;l<a.links.length;++l){var d=a.links[l];g[d[0]]={id:d[0],origin_id:d[1],origin_slot:d[2],target_id:d[3],target_slot:d[4]}}a.links=g}for(l in a)this[l]=
a[l];g=!1;this._nodes=[];l=0;for(d=c.length;l<d;++l){var e=c[l],f=k.createNode(e.type,e.title);f?(f.id=e.id,this.add(f,!0)):(k.debug&&console.log("Node not found: "+e.type),g=!0)}l=0;for(d=c.length;l<d;++l)e=c[l],(f=this.getNodeById(e.id))&&f.configure(e);this.updateExecutionOrder();this.setDirtyCanvas(!0,!0);return g};LGraph.prototype.load=function(a){var b=this,c=new XMLHttpRequest;c.open("GET",a,!0);c.send(null);c.onload=function(a){200!==c.status?console.error("Error loading graph:",c.status,
c.response):(a=JSON.parse(c.response),b.configure(a))};c.onerror=function(a){console.error("Error loading graph:",a)}};LGraph.prototype.onNodeTrace=function(a,b,c){};e.LGraphNode=k.LGraphNode=function(a){this._ctor()};LGraphNode.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[k.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>!a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});
this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.data=null;this.flags={}};LGraphNode.prototype.configure=function(a){for(var b in a)if("console"!=b)if("properties"==b)for(var c in a.properties){if(this.properties[c]=a.properties[c],this.onPropertyChanged)this.onPropertyChanged(c,a.properties[c])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?this[b].configure(a[b]):this[b]=k.cloneObject(a[b],this[b]):this[b]=
a[b]);if(this.onConnectionsChange){if(this.inputs)for(var g=0;g<this.inputs.length;++g){c=this.inputs[g];var l=this.graph.links[c.link];this.onConnectionsChange(k.INPUT,g,!0,l,c)}if(this.outputs)for(g=0;g<this.outputs.length;++g)if(c=this.outputs[g],c.links)for(b=0;b<c.links.length;++b)l=this.graph.links[c.links[b]],this.onConnectionsChange(k.OUTPUT,g,!0,l,c)}for(g in this.inputs)c=this.inputs[g],c.link&&c.link.length&&(l=c.link,"object"==typeof l&&(c.link=l[0],this.graph.links[l[0]]={id:l[0],origin_id:l[1],
origin_slot:l[2],target_id:l[3],target_slot:l[4]}));for(g in this.outputs)if(c=this.outputs[g],c.links&&0!=c.links.length)for(b in c.links)l=c.links[b],"object"==typeof l&&(c.links[b]=l[0]);if(this.onConfigure)this.onConfigure(a)};LGraphNode.prototype.serialize=function(){if(this.outputs)for(var a=0;a<this.outputs.length;a++)delete this.outputs[a]._data;a={id:this.id,title:this.title,type:this.type,pos:this.pos,size:this.size,data:this.data,flags:k.cloneObject(this.flags),inputs:this.inputs,outputs:this.outputs,
mode:this.mode};this.properties&&(a.properties=k.cloneObject(this.properties));a.type||(a.type=this.constructor.type);this.color&&(a.color=this.color);this.bgcolor&&(a.bgcolor=this.bgcolor);this.boxcolor&&(a.boxcolor=this.boxcolor);this.shape&&(a.shape=this.shape);if(this.onSerialize)this.onSerialize(a);return a};LGraphNode.prototype.clone=function(){var a=k.createNode(this.type),b=k.cloneObject(this.serialize());if(b.inputs)for(var c=0;c<b.inputs.length;++c)b.inputs[c].link=null;if(b.outputs)for(c=
...
b}};LGraphNode.prototype.getInputData=function(a,b){if(this.inputs&&!(a>=this.inputs.length||null==this.inputs[a].link)){var c=this.graph.links[this.inputs[a].link];if(!b)return c.data;var g=this.graph.getNodeById(c.origin_id);if(!g)return c.data;if(g.updateOutputData)g.updateOutputData(c.origin_slot);else if(g.onExecute)g.onExecute();return c.data}};LGraphNode.prototype.isInputConnected=function(a){return this.inputs?a<this.inputs.length&&null!=this.inputs[a].link:!1};LGraphNode.prototype.getInputInfo=
...
function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=k.getTime());for(var c=0;c<this.outputs.length;++c){var g=this.outputs[c];if(!(g.type!==k.EVENT||a&&g.name!=a)&&(g=g.links)&&g.length)for(var l=0;l<g.length;++l){var d=this.graph.links[g[l]];if(d){var e=this.graph.getNodeById(d.target_id);if(e)if(d._last_time=k.getTime(),d=e.inputs[d.target_slot],e.onAction)e.onAction(d.name,b);else if(e.mode===k.ON_TRIGGER&&e.onExecute)e.onExecute(b)}}}}};LGraphNode.prototype.addProperty=
function(a,b,c,g){c={name:a,type:c,default_value:b};if(g)for(var l in g)c[l]=g[l];this.properties_info||(this.properties_info=[]);this.properties_info.push(c);this.properties||(this.properties={});this.properties[a]=b;return c};LGraphNode.prototype.addOutput=function(a,b,c){a={name:a,type:b,links:null};if(c)for(var g in c)a[g]=c[g];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);this.size=this.computeSize();return a};LGraphNode.prototype.addOutputs=
function(a){for(var b=0;b<a.length;++b){var c=a[b],g={name:c[0],type:c[1],link:null};if(a[2])for(var l in c[2])g[l]=c[2][l];this.outputs||(this.outputs=[]);this.outputs.push(g);if(this.onOutputAdded)this.onOutputAdded(g)}this.size=this.computeSize()};LGraphNode.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);this.size=this.computeSize();if(this.onOutputRemoved)this.onOutputRemoved(a)};LGraphNode.prototype.addInput=function(a,b,c){a={name:a,type:b||0,link:null};
if(c)for(var g in c)a[g]=c[g];this.inputs||(this.inputs=[]);this.inputs.push(a);this.size=this.computeSize();if(this.onInputAdded)this.onInputAdded(a);return a};LGraphNode.prototype.addInputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],g={name:c[0],type:c[1],link:null};if(a[2])for(var l in c[2])g[l]=c[2][l];this.inputs||(this.inputs=[]);this.inputs.push(g);if(this.onInputAdded)this.onInputAdded(g)}this.size=this.computeSize()};LGraphNode.prototype.removeInput=function(a){this.disconnectInput(a);
this.inputs.splice(a,1);this.size=this.computeSize();if(this.onInputRemoved)this.onInputRemoved(a)};LGraphNode.prototype.addConnection=function(a,b,c,g){a={name:a,type:b,pos:c,direction:g,links:null};this.connections.push(a);return a};LGraphNode.prototype.computeSize=function(a,b){function c(a){return a?d*a.length*0.6:0}var g=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1),l=b||new Float32Array([0,0]),g=Math.max(g,1);l[1]=14*g+6;var d=14,g=c(this.title),e=0,f=0;if(this.inputs)for(var h=
0,n=this.inputs.length;h<n;++h){var q=this.inputs[h],q=q.label||q.name||"",q=c(q);e<q&&(e=q)}if(this.outputs)for(h=0,n=this.outputs.length;h<n;++h)q=this.outputs[h],q=q.label||q.name||"",q=c(q),f<q&&(f=q);l[0]=Math.max(e+f+10,g);l[0]=Math.max(l[0],k.NODE_WIDTH);return l};LGraphNode.prototype.getBounding=function(){return new Float32Array([this.pos[0]-4,this.pos[1]-k.NODE_TITLE_HEIGHT,this.pos[0]+this.size[0]+4,this.pos[1]+this.size[1]+LGraph.NODE_TITLE_HEIGHT])};LGraphNode.prototype.isPointInsideNode=
function(a,b,c){c=c||0;var g=this.graph&&this.graph.isLive()?0:20;if(this.flags.collapsed){if(f(a,b,this.pos[0]-c,this.pos[1]-k.NODE_TITLE_HEIGHT-c,k.NODE_COLLAPSED_WIDTH+2*c,k.NODE_TITLE_HEIGHT+2*c))return!0}else if(this.pos[0]-4-c<a&&this.pos[0]+this.size[0]+4+c>a&&this.pos[1]-g-c<b&&this.pos[1]+this.size[1]+c>b)return!0;return!1};LGraphNode.prototype.getSlotInPosition=function(a,b){if(this.inputs)for(var c=0,g=this.inputs.length;c<g;++c){var l=this.inputs[c],d=this.getConnectionPos(!0,c);if(f(a,
b,d[0]-10,d[1]-5,20,10))return{input:l,slot:c,link_pos:d,locked:l.locked}}if(this.outputs)for(c=0,g=this.outputs.length;c<g;++c)if(l=this.outputs[c],d=this.getConnectionPos(!1,c),f(a,b,d[0]-10,d[1]-5,20,10))return{output:l,slot:c,link_pos:d,locked:l.locked};return null};LGraphNode.prototype.findInputSlot=function(a){if(!this.inputs)return-1;for(var b=0,c=this.inputs.length;b<c;++b)if(a==this.inputs[b].name)return b;return-1};LGraphNode.prototype.findOutputSlot=function(a){if(!this.outputs)return-1;
for(var b=0,c=this.outputs.length;b<c;++b)if(a==this.outputs[b].name)return b;return-1};LGraphNode.prototype.connect=function(a,b,c){c=c||0;if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return k.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),!1;b&&b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Node not found";if(b==this)return!1;if(c.constructor===
String){if(c=b.findInputSlot(c),-1==c)return k.debug&&console.log("Connect: Error, no slot of name "+c),!1}else{if(c===k.EVENT)return!1;if(!b.inputs||c>=b.inputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),!1}null!=b.inputs[c].link&&b.disconnectInput(c);this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);var g=this.outputs[a];if(b.onConnectInput&&!1===b.onConnectInput(c,g.type,g))return!1;var l=b.inputs[c];if(k.isValidConnection(g.type,l.type)){var d={id:this.graph.last_link_id++,
type:l.type,origin_id:this.id,origin_slot:a,target_id:b.id,target_slot:c};this.graph.links[d.id]=d;null==g.links&&(g.links=[]);g.links.push(d.id);b.inputs[c].link=d.id;if(this.onConnectionsChange)this.onConnectionsChange(k.OUTPUT,a,!0,d,g);if(b.onConnectionsChange)b.onConnectionsChange(k.INPUT,c,!0,d,l)}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};LGraphNode.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return k.debug&&
console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),!1;var c=this.outputs[a];if(!c.links||0==c.links.length)return!1;if(b){b.constructor===Number&&(b=this.graph.getNodeById(b));if(!b)throw"Target Node not found";for(var g=0,l=c.links.length;g<l;g++){var d=c.links[g],e=this.graph.links[d];if(e.target_id==b.id){c.links.splice(g,1);var f=b.inputs[e.target_slot];f.link=null;delete this.graph.links[d];
if(b.onConnectionsChange)b.onConnectionsChange(k.INPUT,e.target_slot,!1,e,f);if(this.onConnectionsChange)this.onConnectionsChange(k.OUTPUT,a,!1,e,c);break}}}else{g=0;for(l=c.links.length;g<l;g++){d=c.links[g];e=this.graph.links[d];b=this.graph.getNodeById(e.target_id);f=null;b&&(f=b.inputs[e.target_slot],f.link=null);delete this.graph.links[d];if(b.onConnectionsChange)b.onConnectionsChange(k.INPUT,e.target_slot,!1,e,f);if(this.onConnectionsChange)this.onConnectionsChange(k.OUTPUT,a,!1,e,c)}c.links=
null}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};LGraphNode.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return k.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||a>=this.inputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var c=this.inputs[a].link;this.inputs[a].link=null;var g=this.graph.links[c];if(g){var l=this.graph.getNodeById(g.origin_id);
if(!l)return!1;var d=l.outputs[g.origin_slot];if(!d||!d.links||0==d.links.length)return!1;for(var e=0,f=d.links.length;e<f;e++)if(c=d.links[e],g.target_id==this.id){d.links.splice(e,1);break}delete this.graph.links[c];if(this.onConnectionsChange)this.onConnectionsChange(k.INPUT,a,!1,g,b);if(l.onConnectionsChange)l.onConnectionsChange(k.OUTPUT,e,!1,g,d)}this.setDirtyCanvas(!1,!0);this.graph.connectionChange(this);return!0};LGraphNode.prototype.getConnectionPos=function(a,b){return this.flags.collapsed?
a?[this.pos[0],this.pos[1]-0.5*k.NODE_TITLE_HEIGHT]:[this.pos[0]+k.NODE_COLLAPSED_WIDTH,this.pos[1]-0.5*k.NODE_TITLE_HEIGHT]:a&&-1==b?[this.pos[0]+10,this.pos[1]+10]:a&&this.inputs.length>b&&this.inputs[b].pos?[this.pos[0]+this.inputs[b].pos[0],this.pos[1]+this.inputs[b].pos[1]]:!a&&this.outputs.length>b&&this.outputs[b].pos?[this.pos[0]+this.outputs[b].pos[0],this.pos[1]+this.outputs[b].pos[1]]:a?[this.pos[0],this.pos[1]+10+b*k.NODE_SLOT_HEIGHT]:[this.pos[0]+this.size[0]+1,this.pos[1]+10+b*k.NODE_SLOT_HEIGHT]};
...
a.localName)throw"Element supplied for LGraphCanvas must be a <canvas> element, you passed a "+a.localName;throw"This browser doesnt support Canvas";}null==(this.ctx=a.getContext("2d"))&&(console.warn("This canvas seems to be WebGL, enabling WebGL renderer"),this.enableWebGL());this._mousemove_callback=this.processMouseMove.bind(this);this._mouseup_callback=this.processMouseUp.bind(this);b||this.bindEvents()}};LGraphCanvas.prototype._doNothing=function(a){a.preventDefault();return!1};LGraphCanvas.prototype._doReturnTrue=
function(a){a.preventDefault();return!0};LGraphCanvas.prototype.bindEvents=function(){if(this._events_binded)console.warn("LGraphCanvas: events already binded");else{var a=this.canvas;this._mousedown_callback=this.processMouseDown.bind(this);this._mousewheel_callback=this.processMouseWheel.bind(this);a.addEventListener("mousedown",this._mousedown_callback,!0);a.addEventListener("mousemove",this._mousemove_callback);a.addEventListener("mousewheel",this._mousewheel_callback,!1);a.addEventListener("contextmenu",
this._doNothing);a.addEventListener("DOMMouseScroll",this._mousewheel_callback,!1);a.addEventListener("touchstart",this.touchHandler,!0);a.addEventListener("touchmove",this.touchHandler,!0);a.addEventListener("touchend",this.touchHandler,!0);a.addEventListener("touchcancel",this.touchHandler,!0);this._key_callback=this.processKey.bind(this);a.addEventListener("keydown",this._key_callback);a.addEventListener("keyup",this._key_callback);this._ondrop_callback=this.processDrop.bind(this);a.addEventListener("dragover",
...
this.touchHandler),this._ondrop_callback=this._key_callback=this._mousewheel_callback=this._mousedown_callback=null,this._events_binded=!1):console.warn("LGraphCanvas: no events binded")};LGraphCanvas.getFileExtension=function(a){var b=a.indexOf("?");-1!=b&&(a=a.substr(0,b));b=a.lastIndexOf(".");return-1==b?"":a.substr(b+1).toLowerCase()};LGraphCanvas.prototype.enableWebGL=function(){if(void 0===typeof GL)throw"litegl.js must be included to use a WebGL canvas";if(void 0===typeof enableWebGLCanvas)throw"webglCanvas.js must be included to use this feature";
this.gl=this.ctx=enableWebGLCanvas(this.canvas);this.ctx.webgl=!0;this.bgcanvas=this.canvas;this.bgctx=this.gl};LGraphCanvas.prototype.setDirty=function(a,b){a&&(this.dirty_canvas=!0);b&&(this.dirty_bgcanvas=!0)};LGraphCanvas.prototype.getCanvasWindow=function(){if(!this.canvas)return window;var a=this.canvas.ownerDocument;return a.defaultView||a.parentWindow};LGraphCanvas.prototype.startRendering=function(){function a(){this.pause_rendering||this.draw();var b=this.getCanvasWindow();this.is_rendering&&
b.requestAnimationFrame(a.bind(this))}this.is_rendering||(this.is_rendering=!0,a.call(this))};LGraphCanvas.prototype.stopRendering=function(){this.is_rendering=!1};LGraphCanvas.prototype.processMouseDown=function(a){if(this.graph){this.adjustMouseEvent(a);var b=this.getCanvasWindow();LGraphCanvas.active_canvas=this;this.canvas.removeEventListener("mousemove",this._mousemove_callback);b.document.addEventListener("mousemove",this._mousemove_callback,!0);b.document.addEventListener("mouseup",this._mouseup_callback,
!0);var c=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes);k.closeAllContextMenus(b);if(1==a.which){if(!(a.shiftKey||c&&this.selected_nodes[c.id])){var g=[],l;for(l in this.selected_nodes)this.selected_nodes[l]!=c&&g.push(this.selected_nodes[l]);for(l in g)this.processNodeDeselected(g[l])}g=!1;if(c&&this.allow_interaction){this.live_mode||c.flags.pinned||this.bringToFront(c);var d=!1;if(!this.connecting_node&&!c.flags.collapsed&&!this.live_mode){if(c.outputs){l=0;for(var e=c.outputs.length;l<
e;++l){var h=c.outputs[l],n=c.getConnectionPos(!1,l);if(f(a.canvasX,a.canvasY,n[0]-10,n[1]-5,20,10)){this.connecting_node=c;this.connecting_output=h;this.connecting_pos=c.getConnectionPos(!1,l);this.connecting_slot=l;d=!0;break}}}if(c.inputs)for(l=0,e=c.inputs.length;l<e;++l)h=c.inputs[l],n=c.getConnectionPos(!0,l),f(a.canvasX,a.canvasY,n[0]-10,n[1]-5,20,10)&&null!==h.link&&(c.disconnectInput(l),d=this.dirty_bgcanvas=!0);!d&&f(a.canvasX,a.canvasY,c.pos[0]+c.size[0]-5,c.pos[1]+c.size[1]-5,5,5)&&(this.resizing_node=
c,this.canvas.style.cursor="se-resize",d=!0)}!d&&f(a.canvasX,a.canvasY,c.pos[0],c.pos[1]-k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT)&&(c.collapse(),d=!0);if(!d){l=!1;if(300>k.getTime()-this.last_mouseclick&&this.selected_nodes[c.id]){if(c.onDblClick)c.onDblClick(a);this.processNodeDblClicked(c);l=!0}c.onMouseDown&&c.onMouseDown(a,[a.canvasX-c.pos[0],a.canvasY-c.pos[1]])?l=!0:this.live_mode&&(l=g=!0);l||(this.allow_dragnodes&&(this.node_dragged=c),this.selected_nodes[c.id]||this.processNodeSelected(c,
a));this.dirty_canvas=!0}}else g=!0;g&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&this.processContextMenu(c,a);this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=k.getTime();this.canvas_mouse=[a.canvasX,a.canvasY];this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&a.preventDefault();a.stopPropagation();if(this.onMouseDown)this.onMouseDown(a);
...
a.which?(this.dirty_canvas=!0,this.dragging_canvas=!1):3==a.which&&(this.dirty_canvas=!0,this.dragging_canvas=!1);this.graph.change();a.stopPropagation();a.preventDefault();return!1}};LGraphCanvas.prototype.processMouseWheel=function(a){if(this.graph&&this.allow_dragcanvas){var b=null!=a.wheelDeltaY?a.wheelDeltaY:-60*a.detail;this.adjustMouseEvent(a);var c=this.scale;0<b?c*=1.1:0>b&&(c*=1/1.1);this.setZoom(c,[a.localX,a.localY]);this.graph.change();a.preventDefault();return!1}};LGraphCanvas.prototype.isOverNodeBox=
function(a,b,c){var g=k.NODE_TITLE_HEIGHT;return f(b,c,a.pos[0]+2,a.pos[1]+2-g,g-4,g-4)?!0:!1};LGraphCanvas.prototype.isOverNodeInput=function(a,b,c,g){if(a.inputs)for(var l=0,d=a.inputs.length;l<d;++l){var e=a.getConnectionPos(!0,l);if(f(b,c,e[0]-10,e[1]-5,20,10))return g&&(g[0]=e[0],g[1]=e[1]),l}return-1};LGraphCanvas.prototype.processKey=function(a){if(this.graph){var b=!1;if("keydown"==a.type){65==a.keyCode&&a.ctrlKey&&(this.selectAllNodes(),b=!0);if(46==a.keyCode||8==a.keyCode)this.deleteSelectedNodes(),
b=!0;if(this.selected_nodes)for(var c in this.selected_nodes)if(this.selected_nodes[c].onKeyDown)this.selected_nodes[c].onKeyDown(a)}else if("keyup"==a.type&&this.selected_nodes)for(c in this.selected_nodes)if(this.selected_nodes[c].onKeyUp)this.selected_nodes[c].onKeyUp(a);this.graph.change();if(b)return a.preventDefault(),!1}};LGraphCanvas.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=[a.canvasX,a.canvasY],c=this.graph.getNodeOnPos(b[0],b[1]);if(c){if((c.onDropFile||
c.onDropData)&&(b=a.dataTransfer.files)&&b.length)for(var g=0;g<b.length;g++){var l=a.dataTransfer.files[0],d=l.name;LGraphCanvas.getFileExtension(d);if(c.onDropFile)c.onDropFile(l);if(c.onDropData){var e=new FileReader;e.onload=function(a){c.onDropData(a.target.result,d,l)};var f=l.type.split("/")[0];"text"==f||""==f?e.readAsText(l):"image"==f?e.readAsDataURL(l):e.readAsArrayBuffer(l)}}return c.onDropItem&&c.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;this.onDropItem&&(b=
this.onDropItem(event));b||this.checkDropItem(a)};LGraphCanvas.prototype.checkDropItem=function(a){if(a.dataTransfer.files.length){var b=a.dataTransfer.files[0],c=LGraphCanvas.getFileExtension(b.name).toLowerCase();if(c=k.node_types_by_file_extension[c])if(c=k.createNode(c.type),c.pos=[a.canvasX,a.canvasY],this.graph.add(c),c.onDropFile)c.onDropFile(b)}};LGraphCanvas.prototype.processNodeSelected=function(a,b){a.selected=!0;if(a.onSelected)a.onSelected();b&&b.shiftKey||(this.selected_nodes={});this.selected_nodes[a.id]=
a;this.dirty_canvas=!0;if(this.onNodeSelected)this.onNodeSelected(a)};LGraphCanvas.prototype.processNodeDeselected=function(a){a.selected=!1;if(a.onDeselected)a.onDeselected();delete this.selected_nodes[a.id];if(this.onNodeDeselected)this.onNodeDeselected(a);this.dirty_canvas=!0};LGraphCanvas.prototype.processNodeDblClicked=function(a){if(this.onShowNodePanel)this.onShowNodePanel(a);if(this.onNodeDblClicked)this.onNodeDblClicked(a);this.setDirty(!0)};LGraphCanvas.prototype.selectNode=function(a){this.deselectAllNodes();
if(a){if(!a.selected&&a.onSelected)a.onSelected();a.selected=!0;this.selected_nodes[a.id]=a;this.setDirty(!0)}};LGraphCanvas.prototype.selectAllNodes=function(){for(var a=0;a<this.graph._nodes.length;++a){var b=this.graph._nodes[a];if(!b.selected&&b.onSelected)b.onSelected();b.selected=!0;this.selected_nodes[this.graph._nodes[a].id]=b}this.setDirty(!0)};LGraphCanvas.prototype.deselectAllNodes=function(){for(var a in this.selected_nodes){var b=this.selected_nodes;if(b.onDeselected)b.onDeselected();
b.selected=!1}this.selected_nodes={};this.setDirty(!0)};LGraphCanvas.prototype.deleteSelectedNodes=function(){for(var a in this.selected_nodes)this.graph.remove(this.selected_nodes[a]);this.selected_nodes={};this.setDirty(!0)};LGraphCanvas.prototype.centerOnNode=function(a){this.offset[0]=-a.pos[0]-0.5*a.size[0]+0.5*this.canvas.width/this.scale;this.offset[1]=-a.pos[1]-0.5*a.size[1]+0.5*this.canvas.height/this.scale;this.setDirty(!0,!0)};LGraphCanvas.prototype.adjustMouseEvent=function(a){var b=this.canvas.getBoundingClientRect();
a.localX=a.pageX-b.left;a.localY=a.pageY-b.top;a.canvasX=a.localX/this.scale-this.offset[0];a.canvasY=a.localY/this.scale-this.offset[1]};LGraphCanvas.prototype.setZoom=function(a,b){b||(b=[0.5*this.canvas.width,0.5*this.canvas.height]);var c=this.convertOffsetToCanvas(b);this.scale=a;this.scale>this.max_zoom?this.scale=this.max_zoom:this.scale<this.min_zoom&&(this.scale=this.min_zoom);var g=this.convertOffsetToCanvas(b),c=[g[0]-c[0],g[1]-c[1]];this.offset[0]+=c[0];this.offset[1]+=c[1];this.dirty_bgcanvas=
...
-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.push(a))};LGraphCanvas.prototype.sendToBack=function(a){var b=this.graph._nodes.indexOf(a);-1!=b&&(this.graph._nodes.splice(b,1),this.graph._nodes.unshift(a))};LGraphCanvas.prototype.computeVisibleNodes=function(){for(var a=[],b=0,c=this.graph._nodes.length;b<c;++b){var g=this.graph._nodes[b];(!this.live_mode||g.onDrawBackground||g.onDrawForeground)&&h(this.visible_area,g.getBounding())&&a.push(g)}return a};LGraphCanvas.prototype.draw=function(a,
b){if(this.canvas){var c=k.getTime();this.render_time=0.001*(c-this.last_draw_time);this.last_draw_time=c;if(this.graph){var g=[-this.offset[0],-this.offset[1]],l=[g[0]+this.canvas.width/this.scale,g[1]+this.canvas.height/this.scale];this.visible_area=new Float32Array([g[0],g[1],l[0],l[1]])}(this.dirty_bgcanvas||b||this.always_render_background||this.graph&&this.graph._last_trigger_time&&1E3>c-this.graph._last_trigger_time)&&this.drawBackCanvas();(this.dirty_canvas||a)&&this.drawFrontCanvas();this.fps=
this.render_time?1/this.render_time:0;this.frame+=1}};LGraphCanvas.prototype.drawFrontCanvas=function(){this.ctx||(this.ctx=this.bgcanvas.getContext("2d"));var a=this.ctx;if(a){a.start2D&&a.start2D();var b=this.canvas;a.restore();a.setTransform(1,0,0,1,0,0);this.dirty_area&&(a.save(),a.beginPath(),a.rect(this.dirty_area[0],this.dirty_area[1],this.dirty_area[2],this.dirty_area[3]),a.clip());this.clear_background&&a.clearRect(0,0,b.width,b.height);this.bgcanvas==this.canvas?this.drawBackCanvas():a.drawImage(this.bgcanvas,
0,0);if(this.onRender)this.onRender(b,a);this.show_info&&this.renderInfo(a);if(this.graph){a.save();a.scale(this.scale,this.scale);a.translate(this.offset[0],this.offset[1]);this.visible_nodes=b=this.computeVisibleNodes();for(var c=0;c<b.length;++c){var g=b[c];a.save();a.translate(g.pos[0],g.pos[1]);this.drawNode(g,a);a.restore()}this.graph.config.links_ontop&&(this.live_mode||this.drawConnections(a));if(null!=this.connecting_pos){a.lineWidth=this.connections_width;b=null;switch(this.connecting_output.type){case k.EVENT:b=
"#F85";break;default:b="#AFA"}this.renderLink(a,this.connecting_pos,[this.canvas_mouse[0],this.canvas_mouse[1]],null,!1,null,b);a.beginPath();this.connecting_output.type===k.EVENT?a.rect(this.connecting_pos[0]-6+0.5,this.connecting_pos[1]-5+0.5,14,10):a.arc(this.connecting_pos[0],this.connecting_pos[1],4,0,2*Math.PI);a.fill();a.fillStyle="#ffcc00";this._highlight_input&&(a.beginPath(),a.arc(this._highlight_input[0],this._highlight_input[1],6,0,2*Math.PI),a.fill())}a.restore()}this.dirty_area&&a.restore();
a.finish2D&&a.finish2D();this.dirty_canvas=!1}};LGraphCanvas.prototype.renderInfo=function(a,b,c){b=b||0;c=c||0;a.save();a.translate(b,c);a.font="10px Arial";a.fillStyle="#888";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,5,26),a.fillText("F: "+this.frame,5,39),a.fillText("FPS:"+this.fps.toFixed(2),5,52)):a.fillText("No graph selected",5,13);a.restore()};LGraphCanvas.prototype.drawBackCanvas=function(){var a=this.bgcanvas;if(a.width!=
this.canvas.width||a.height!=this.canvas.height)a.width=this.canvas.width,a.height=this.canvas.height;this.bgctx||(this.bgctx=this.bgcanvas.getContext("2d"));var b=this.bgctx;b.start&&b.start();this.clear_background&&b.clearRect(0,0,a.width,a.height);b.restore();b.setTransform(1,0,0,1,0,0);if(this.graph){b.save();b.scale(this.scale,this.scale);b.translate(this.offset[0],this.offset[1]);if(this.background_image&&0.5<this.scale){b.globalAlpha=(1-0.5/this.scale)*this.editor_alpha;b.imageSmoothingEnabled=
b.mozImageSmoothingEnabled=b.imageSmoothingEnabled=!1;if(!this._bg_img||this._bg_img.name!=this.background_image){this._bg_img=new Image;this._bg_img.name=this.background_image;this._bg_img.src=this.background_image;var c=this;this._bg_img.onload=function(){c.draw(!0,!0)}}var g=null;null==this._pattern&&0<this._bg_img.width?(g=b.createPattern(this._bg_img,"repeat"),this._pattern_img=this._bg_img,this._pattern=g):g=this._pattern;g&&(b.fillStyle=g,b.fillRect(this.visible_area[0],this.visible_area[1],
...
"rgba(0,0,0,0)";b.restore()}b.finish&&b.finish();this.dirty_bgcanvas=!1;this.dirty_canvas=!0};LGraphCanvas.prototype.drawNode=function(a,b){var c=a.color||k.NODE_DEFAULT_COLOR,g=!0;if(a.flags.skip_title_render||a.graph.isLive())g=!1;a.mouseOver&&(g=!0);a.selected||(this.render_shadows?(b.shadowColor="rgba(0,0,0,0.5)",b.shadowOffsetX=2,b.shadowOffsetY=2,b.shadowBlur=3):b.shadowColor="transparent");if(this.live_mode){if(!a.flags.collapsed&&(b.shadowColor="transparent",a.onDrawForeground))a.onDrawForeground(b)}else{var l=
this.editor_alpha;b.globalAlpha=l;var d=a.shape||"box",e=new Float32Array(a.size);a.flags.collapsed&&(e[0]=k.NODE_COLLAPSED_WIDTH,e[1]=0);a.flags.clip_area&&(b.save(),"box"==d?(b.beginPath(),b.rect(0,0,e[0],e[1])):"round"==d?b.roundRect(0,0,e[0],e[1],10):"circle"==d&&(b.beginPath(),b.arc(0.5*e[0],0.5*e[1],0.5*e[0],0,2*Math.PI)),b.clip());this.drawNodeShape(a,b,e,c,a.bgcolor,!g,a.selected);b.shadowColor="transparent";b.textAlign="left";b.font=this.inner_text_font;g=0.6<this.scale;d=this.connecting_output;
if(!a.flags.collapsed){if(a.inputs)for(e=0;e<a.inputs.length;e++){var f=a.inputs[e];b.globalAlpha=l;this.connecting_node&&k.isValidConnection(f.type&&d.type)&&(b.globalAlpha=0.4*l);b.fillStyle=null!=f.link?"#7F7":"#AAA";var h=a.getConnectionPos(!0,e);h[0]-=a.pos[0];h[1]-=a.pos[1];b.beginPath();f.type===k.EVENT?b.rect(h[0]-6+0.5,h[1]-5+0.5,14,10):b.arc(h[0],h[1],4,0,2*Math.PI);b.fill();g&&(f=null!=f.label?f.label:f.name)&&(b.fillStyle=c,b.fillText(f,h[0]+10,h[1]+5))}this.connecting_node&&(b.globalAlpha=
0.4*l);b.lineWidth=1;b.textAlign="right";b.strokeStyle="black";if(a.outputs)for(e=0;e<a.outputs.length;e++)if(f=a.outputs[e],h=a.getConnectionPos(!1,e),h[0]-=a.pos[0],h[1]-=a.pos[1],b.fillStyle=f.links&&f.links.length?"#7F7":"#AAA",b.beginPath(),f.type===k.EVENT?b.rect(h[0]-6+0.5,h[1]-5+0.5,14,10):b.arc(h[0],h[1],4,0,2*Math.PI),b.fill(),b.stroke(),g&&(f=null!=f.label?f.label:f.name))b.fillStyle=c,b.fillText(f,h[0]-10,h[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.onDrawForeground)a.onDrawForeground(b)}a.flags.clip_area&&
b.restore();b.globalAlpha=1}};LGraphCanvas.prototype.drawNodeShape=function(a,b,c,g,l,d,e){b.strokeStyle=g||k.NODE_DEFAULT_COLOR;b.fillStyle=l||k.NODE_DEFAULT_BGCOLOR;l=k.NODE_TITLE_HEIGHT;var f=a.shape||"box";"box"==f?(b.beginPath(),b.rect(0,d?0:-l,c[0]+1,d?c[1]:c[1]+l),b.fill(),b.shadowColor="transparent",e&&(b.strokeStyle="#CCC",b.strokeRect(-0.5,d?-0.5:-l+-0.5,c[0]+2,d?c[1]+2:c[1]+l+2-1),b.strokeStyle=g)):"round"==a.shape?(b.roundRect(0,d?0:-l,c[0],d?c[1]:c[1]+l,10),b.fill()):"circle"==a.shape&&
(b.beginPath(),b.arc(0.5*c[0],0.5*c[1],0.5*c[0],0,2*Math.PI),b.fill());b.shadowColor="transparent";a.bgImage&&a.bgImage.width&&b.drawImage(a.bgImage,0.5*(c[0]-a.bgImage.width),0.5*(c[1]-a.bgImage.height));a.bgImageUrl&&!a.bgImage&&(a.bgImage=a.loadImage(a.bgImageUrl));if(a.onDrawBackground)a.onDrawBackground(b);d||(b.fillStyle=g||k.NODE_DEFAULT_COLOR,g=b.globalAlpha,b.globalAlpha=0.5*g,"box"==f?(b.beginPath(),b.rect(0,-l,c[0]+1,l),b.fill()):"round"==f&&(b.roundRect(0,-l,c[0],l,10,0),b.fill()),b.fillStyle=
a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.beginPath(),"round"==f?b.arc(0.5*l,-0.5*l,0.5*(l-6),0,2*Math.PI):b.rect(3,-l+3,l-6,l-6),b.fill(),b.globalAlpha=g,b.font=this.title_text_font,(a=a.getTitle())&&0.5<this.scale&&(b.fillStyle=k.NODE_TITLE_COLOR,b.fillText(a,16,13-l)))};LGraphCanvas.prototype.drawNodeCollapsed=function(a,b,c,g){b.strokeStyle=c||k.NODE_DEFAULT_COLOR;b.fillStyle=g||k.NODE_DEFAULT_BGCOLOR;c=k.NODE_COLLAPSED_RADIUS;g=a.shape||"box";"circle"==g?(b.beginPath(),b.arc(0.5*a.size[0],0.5*a.size[1],
c,0,2*Math.PI),b.fill(),b.shadowColor="rgba(0,0,0,0)",b.stroke(),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.beginPath(),b.arc(0.5*a.size[0],0.5*a.size[1],0.5*c,0,2*Math.PI)):"round"==g?(b.beginPath(),b.roundRect(0.5*a.size[0]-c,0.5*a.size[1]-c,2*c,2*c,5),b.fill(),b.shadowColor="rgba(0,0,0,0)",b.stroke(),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.beginPath(),b.roundRect(0.5*a.size[0]-0.5*c,0.5*a.size[1]-0.5*c,c,c,2)):(b.beginPath(),b.rect(0,0,a.size[0],2*c),b.fill(),b.shadowColor="rgba(0,0,0,0)",
b.stroke(),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.beginPath(),b.rect(0.5*c,0.5*c,c,c));b.fill()};LGraphCanvas.prototype.drawConnections=function(a){var b=k.getTime();a.lineWidth=this.connections_width;a.fillStyle="#AAA";a.strokeStyle="#AAA";a.globalAlpha=this.editor_alpha;for(var c=0,g=this.graph._nodes.length;c<g;++c){var l=this.graph._nodes[c];if(l.inputs&&l.inputs.length)for(var d=0;d<l.inputs.length;++d){var e=l.inputs[d];if(e&&null!=e.link&&(e=this.graph.links[e.link])){var f=this.graph.getNodeById(e.origin_id);
if(null!=f){var h=e.origin_slot,n=null,n=-1==h?[f.pos[0]+10,f.pos[1]+10]:f.getConnectionPos(!1,h);this.renderLink(a,n,l.getConnectionPos(!0,d),e);e&&e._last_time&&1E3>b-e._last_time&&(f=2-0.002*(b-e._last_time),h="rgba(255,255,255, "+f.toFixed(2)+")",this.renderLink(a,n,l.getConnectionPos(!0,d),e,!0,f,h))}}}}a.globalAlpha=1};LGraphCanvas.prototype.renderLink=function(a,b,c,g,l,e,f){if(this.highquality_render){var h=d(b,c);this.render_connections_border&&0.6<this.scale&&(a.lineWidth=this.connections_width+
4);!f&&g&&(f=LGraphCanvas.link_type_colors[g.type]);f||(f=this.default_link_color);a.beginPath();this.render_curved_connections?(a.moveTo(b[0],b[1]),a.bezierCurveTo(b[0]+0.25*h,b[1],c[0]-0.25*h,c[1],c[0],c[1])):(a.moveTo(b[0]+10,b[1]),a.lineTo(0.5*(b[0]+10+(c[0]-10)),b[1]),a.lineTo(0.5*(b[0]+10+(c[0]-10)),c[1]),a.lineTo(c[0]-10,c[1]));this.render_connections_border&&0.6<this.scale&&!l&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=f;a.stroke();
this.render_connection_arrows&&0.6<=this.scale&&this.render_connection_arrows&&0.6<this.scale&&(g=this.computeConnectionPoint(b,c,0.5),l=this.computeConnectionPoint(b,c,0.51),f=0,f=this.render_curved_connections?-Math.atan2(l[0]-g[0],l[1]-g[1]):c[1]>b[1]?0:Math.PI,a.save(),a.translate(g[0],g[1]),a.rotate(f),a.beginPath(),a.moveTo(-5,-5),a.lineTo(0,5),a.lineTo(5,-5),a.fill(),a.restore());if(e)for(e=0;5>e;++e)g=(0.001*k.getTime()+0.2*e)%1,g=this.computeConnectionPoint(b,c,g),a.beginPath(),a.arc(g[0],
g[1],5,0,2*Math.PI),a.fill()}else a.beginPath(),a.moveTo(b[0],b[1]),a.lineTo(c[0],c[1]),a.stroke()};LGraphCanvas.prototype.computeConnectionPoint=function(a,b,c){var g=d(a,b),l=[a[0]+0.25*g,a[1]],g=[b[0]-0.25*g,b[1]],e=(1-c)*(1-c)*(1-c),f=3*(1-c)*(1-c)*c,h=3*(1-c)*c*c;c*=c*c;return[e*a[0]+f*l[0]+h*g[0]+c*b[0],e*a[1]+f*l[1]+h*g[1]+c*b[1]]};LGraphCanvas.prototype.resize=function(a,b){if(!a&&!b){var c=this.canvas.parentNode;a=c.offsetWidth;b=c.offsetHeight}if(this.canvas.width!=a||this.canvas.height!=
b)this.canvas.width=a,this.canvas.height=b,this.bgcanvas.width=this.canvas.width,this.bgcanvas.height=this.canvas.height,this.setDirty(!0,!0)};LGraphCanvas.prototype.switchLiveMode=function(a){if(a){var b=this,c=this.live_mode?1.1:0.9;this.live_mode&&(this.live_mode=!1,this.editor_alpha=0.1);var g=setInterval(function(){b.editor_alpha*=c;b.dirty_canvas=!0;b.dirty_bgcanvas=!0;1>c&&0.01>b.editor_alpha&&(clearInterval(g),1>c&&(b.live_mode=!0));1<c&&0.99<b.editor_alpha&&(clearInterval(g),b.editor_alpha=
1)},1)}else this.live_mode=!this.live_mode,this.dirty_bgcanvas=this.dirty_canvas=!0};LGraphCanvas.prototype.onNodeSelectionChange=function(a){};LGraphCanvas.prototype.touchHandler=function(a){var b=a.changedTouches[0],c="";switch(a.type){case "touchstart":c="mousedown";break;case "touchmove":c="mousemove";break;case "touchend":c="mouseup";break;default:return}var g=this.getCanvasWindow(),l=g.document.createEvent("MouseEvent");l.initMouseEvent(c,!0,!0,g,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,
!1,!1,!1,0,null);b.target.dispatchEvent(l);a.preventDefault()};LGraphCanvas.onMenuAdd=function(a,b,c,g){function l(a,b){var c=g.getFirstEvent(),l=k.createNode(a.value);l&&(l.pos=d.convertEventToCanvas(c),d.graph.add(l))}var d=LGraphCanvas.active_canvas,e=d.getCanvasWindow();a=k.getNodeTypesCategories();b=[];for(var f in a)a[f]&&b.push({value:a[f],content:a[f],has_submenu:!0});var h=new k.ContextMenu(b,{event:c,callback:function(a,b,c){a=k.getNodeTypesInCategory(a.value);b=[];for(var g in a)b.push({content:a[g].title,
value:a[g].type});new k.ContextMenu(b,{event:c,callback:l,parentMenu:h},e);return!1},parentMenu:g},e);return!1};LGraphCanvas.onMenuCollapseAll=function(){};LGraphCanvas.onMenuNodeEdit=function(){};LGraphCanvas.showMenuNodeOptionalInputs=function(a,b,c,g,l){function d(a,b,c){l&&(a.callback&&a.callback.call(e,l,a,b,c),a.value&&l.addInput(a.value[0],a.value[1],a.value[2]))}if(l){var e=this;a=LGraphCanvas.active_canvas.getCanvasWindow();b=l.optional_inputs;l.onGetInputs&&(b=l.onGetInputs());var f=[];
if(b)for(var h in b){var n=b[h];if(n){var q=n[0];n[2]&&n[2].label&&(q=n[2].label);f.push({content:q,value:n})}else f.push(null)}this.onMenuNodeInputs&&(f=this.onMenuNodeInputs(f));if(f.length)return new k.ContextMenu(f,{event:c,callback:d,parentMenu:g,node:l},a),!1}};LGraphCanvas.showMenuNodeOptionalOutputs=function(a,b,c,g,d){function e(a,b,c){if(d&&(a.callback&&a.callback.call(f,d,a,b,c),a.value))if(c=a.value[1],!c||c.constructor!==Object&&c.constructor!==Array)d.addOutput(a.value[0],a.value[1],
a.value[2]);else{a=[];for(var h in c)a.push({content:h,value:c[h]});new k.ContextMenu(a,{event:b,callback:e,parentMenu:g,node:d});return!1}}if(d){var f=this;a=LGraphCanvas.active_canvas.getCanvasWindow();b=d.optional_outputs;d.onGetOutputs&&(b=d.onGetOutputs());var h=[];if(b)for(var n in b){var p=b[n];if(!p)h.push(null);else if(-1==d.findOutputSlot(p[0])){var q=p[0];p[2]&&p[2].label&&(q=p[2].label);q={content:q,value:p};p[1]==k.EVENT&&(q.className="event");h.push(q)}}this.onMenuNodeOutputs&&(h=this.onMenuNodeOutputs(h));
if(h.length)return new k.ContextMenu(h,{event:c,callback:e,parentMenu:g,node:d},a),!1}};LGraphCanvas.onShowMenuNodeProperties=function(a,b,c,g,d){function e(a,b,c,g){d&&(b=this.getBoundingClientRect(),f.showEditPropertyValue(d,a.value,{position:[b.left,b.top]}))}if(d&&d.properties){var f=LGraphCanvas.active_canvas;b=f.getCanvasWindow();var h=[],n;for(n in d.properties)a=void 0!==d.properties[n]?d.properties[n]:" ",a=LGraphCanvas.decodeHTML(a),h.push({content:"<span class='property_name'>"+n+"</span><span class='property_value'>"+
a+"</span>",value:n});if(h.length)return new k.ContextMenu(h,{event:c,callback:e,parentMenu:g,allow_html:!0,node:d},b),!1}};LGraphCanvas.decodeHTML=function(a){var b=document.createElement("div");b.innerText=a;return b.innerHTML};LGraphCanvas.onResizeNode=function(a,b,c,g,d){d&&(d.size=d.computeSize(),d.setDirtyCanvas(!0,!0))};LGraphCanvas.onShowTitleEditor=function(a,b,c,g,d){function e(){d.title=h.value;f.parentNode.removeChild(f);d.setDirtyCanvas(!0,!0)}var f=document.createElement("div");f.className=
"graphdialog";f.innerHTML="<span class='name'>Title</span><input autofocus type='text' class='value'/><button>OK</button>";var h=f.querySelector("input");h&&(h.value=d.title,h.addEventListener("keydown",function(a){13==a.keyCode&&(e(),a.preventDefault(),a.stopPropagation())}));a=LGraphCanvas.active_canvas.canvas;b=a.getBoundingClientRect();g=c=-20;b&&(c-=b.left,g-=b.top);event?(f.style.left=event.pageX+c+"px",f.style.top=event.pageY+g+"px"):(f.style.left=0.5*a.width+c+"px",f.style.top=0.5*a.height+
g+"px");f.querySelector("button").addEventListener("click",e);a.parentNode.appendChild(f)};LGraphCanvas.prototype.showEditPropertyValue=function(a,b,c){function g(){d(v.value)}function d(c){"number"==typeof a.properties[b]&&(c=Number(c));a.properties[b]=c;if(a.onPropertyChanged)a.onPropertyChanged(b,c);q.parentNode.removeChild(q);a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){c=c||{};var e="string";null!==a.properties[b]&&(e=typeof a.properties[b]);var f=null;a.getPropertyInfo&&(f=a.getPropertyInfo(b));
if(a.properties_info)for(var h=0;h<a.properties_info.length;++h)if(a.properties_info[h].name==b){f=a.properties_info[h];break}void 0!==f&&null!==f&&f.type&&(e=f.type);var k="";if("string"==e||"number"==e)k="<input autofocus type='text' class='value'/>";else if("enum"==e&&f.values){k="<select autofocus type='text' class='value'>";for(h in f.values)var n=f.values.constructor===Array?f.values[h]:h,k=k+("<option value='"+n+"' "+(n==a.properties[b]?"selected":"")+">"+f.values[h]+"</option>");k+="</select>"}else"boolean"==
e&&(k="<input autofocus type='checkbox' class='value' "+(a.properties[b]?"checked":"")+"/>");var q=document.createElement("div");q.className="graphdialog";q.innerHTML="<span class='name'>"+b+"</span>"+k+"<button>OK</button>";if("enum"==e&&f.values){var v=q.querySelector("select");v.addEventListener("change",function(a){d(a.target.value)})}else if("boolean"==e)(v=q.querySelector("input"))&&v.addEventListener("click",function(a){d(!!v.checked)});else if(v=q.querySelector("input"))v.value=void 0!==a.properties[b]?
a.properties[b]:"",v.addEventListener("keydown",function(a){13==a.keyCode&&(g(),a.preventDefault(),a.stopPropagation())});e=this.canvas.getClientRects()[0];h=f=-20;e&&(f-=e.left,h-=e.top);c.position?(f+=c.position[0],h+=c.position[1]):c.event?(f+=c.event.pageX,h+=c.event.pageY):(f+=0.5*this.canvas.width,h+=0.5*this.canvas.height);q.style.left=f+"px";q.style.top=h+"px";q.querySelector("button").addEventListener("click",g);this.canvas.parentNode.appendChild(q)}};LGraphCanvas.onMenuNodeCollapse=function(a,
b,c,g,d){d.flags.collapsed=!d.flags.collapsed;d.setDirtyCanvas(!0,!0)};LGraphCanvas.onMenuNodePin=function(a,b,c,g,d){d.pin()};LGraphCanvas.onMenuNodeMode=function(a,b,c,g,d){new k.ContextMenu(["Always","On Event","Never"],{event:c,callback:function(a){if(d)switch(a){case "On Event":d.mode=k.ON_EVENT;break;case "Never":d.mode=k.NEVER;break;default:d.mode=k.ALWAYS}},parentMenu:prev_menu,node:d});return!1};LGraphCanvas.onMenuNodeColors=function(a,b,c,g,d){if(!d)throw"no node for color";b=[];for(var e in LGraphCanvas.node_colors)a=
LGraphCanvas.node_colors[e],a={value:e,content:"<span style='display: block; color:"+a.color+"; background-color:"+a.bgcolor+"'>"+e+"</span>"},b.push(a);new k.ContextMenu(b,{event:c,callback:function(a){d&&(a=LGraphCanvas.node_colors[a.value])&&(d.color=a.color,d.bgcolor=a.bgcolor,d.setDirtyCanvas(!0))},parentMenu:g,node:d});return!1};LGraphCanvas.onMenuNodeShapes=function(a,b,c,g,d){if(!d)throw"no node passed";new k.ContextMenu(["box","round"],{event:c,callback:function(a){d&&(d.shape=a,d.setDirtyCanvas(!0))},
parentMenu:g,node:d});return!1};LGraphCanvas.onMenuNodeRemove=function(a,b,c,g,d){if(!d)throw"no node passed";!1!=d.removable&&(d.graph.remove(d),d.setDirtyCanvas(!0,!0))};LGraphCanvas.onMenuNodeClone=function(a,b,c,g,d){!1!=d.clonable&&(a=d.clone())&&(a.pos=[d.pos[0]+5,d.pos[1]+5],d.graph.add(a),d.setDirtyCanvas(!0,!0))};LGraphCanvas.node_colors={red:{color:"#FAA",bgcolor:"#A44"},green:{color:"#AFA",bgcolor:"#4A4"},blue:{color:"#AAF",bgcolor:"#44A"},white:{color:"#FFF",bgcolor:"#AAA"}};LGraphCanvas.prototype.getCanvasMenuOptions=
...
(function(){function e(){this.size=[60,20];this.addProperty("time",1E3);this.addInput("event",LiteGraph.ACTION);this.addOutput("on_time",LiteGraph.EVENT);this._pending=[]}e.title="Delay";e.desc="Delays one event";e.prototype.onAction=function(d,e){this._pending.push([this.properties.time,e])};e.prototype.onExecute=function(){for(var d=1E3*this.graph.elapsed_time,e=0;e<this._pending.length;++e){var h=this._pending[e];h[0]-=d;0<h[0]||(this._pending.splice(e,1),--e,this.trigger(null,h[1]))}};e.prototype.onGetInputs=
...
a.fill(),a.shadowColor="transparent",a.stroke())};k.prototype.onWidget=function(a,b){"update"==b.name&&(this.lineargradient=null,this.setDirtyCanvas(!0))};LiteGraph.registerNodeType("widget/panel",k)})();
(function(){function e(){this.addOutput("left_x_axis","number");this.addOutput("left_y_axis","number");this.properties={}}e.title="Gamepad";e.desc="gets the input of the gamepad";e.prototype.onExecute=function(){var d=this.getGamepad();if(this.outputs)for(var e=0;e<this.outputs.length;e++){var h=this.outputs[e],n=null;if(d)switch(h.name){case "left_axis":n=[d.xbox.axes.lx,d.xbox.axes.ly];break;case "right_axis":n=[d.xbox.axes.rx,d.xbox.axes.ry];break;case "left_x_axis":n=d.xbox.axes.lx;break;case "left_y_axis":n=
d.xbox.axes.ly;break;case "right_x_axis":n=d.xbox.axes.rx;break;case "right_y_axis":n=d.xbox.axes.ry;break;case "trigger_left":n=d.xbox.axes.ltrigger;break;case "trigger_right":n=d.xbox.axes.rtrigger;break;case "a_button":n=d.xbox.buttons.a?1:0;break;case "b_button":n=d.xbox.buttons.b?1:0;break;case "x_button":n=d.xbox.buttons.x?1:0;break;case "y_button":n=d.xbox.buttons.y?1:0;break;case "lb_button":n=d.xbox.buttons.lb?1:0;break;case "rb_button":n=d.xbox.buttons.rb?1:0;break;case "ls_button":n=d.xbox.buttons.ls?
1:0;break;case "rs_button":n=d.xbox.buttons.rs?1:0;break;case "start_button":n=d.xbox.buttons.start?1:0;break;case "back_button":n=d.xbox.buttons.back?1:0}else switch(h.name){case "left_axis":case "right_axis":n=[0,0];break;default:n=0}this.setOutputData(e,n)}};e.prototype.getGamepad=function(){var d=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!d)return null;for(var e=d.call(navigator),d=null,h=0;4>h;h++)if(e[h]){d=e[h];e=this.xbox_mapping;e||(e=this.xbox_mapping=
{axes:[],buttons:{},hat:""});e.axes.lx=d.axes[0];e.axes.ly=d.axes[1];e.axes.rx=d.axes[2];e.axes.ry=d.axes[3];e.axes.ltrigger=d.buttons[6].value;e.axes.rtrigger=d.buttons[7].value;for(h=0;h<d.buttons.length;h++)switch(h){case 0:e.buttons.a=d.buttons[h].pressed;break;case 1:e.buttons.b=d.buttons[h].pressed;break;case 2:e.buttons.x=d.buttons[h].pressed;break;case 3:e.buttons.y=d.buttons[h].pressed;break;case 4:e.buttons.lb=d.buttons[h].pressed;break;case 5:e.buttons.rb=d.buttons[h].pressed;break;case 6:e.buttons.lt=
d.buttons[h].pressed;break;case 7:e.buttons.rt=d.buttons[h].pressed;break;case 8:e.buttons.back=d.buttons[h].pressed;break;case 9:e.buttons.start=d.buttons[h].pressed;break;case 10:e.buttons.ls=d.buttons[h].pressed;break;case 11:e.buttons.rs=d.buttons[h].pressed;break;case 12:d.buttons[h].pressed&&(e.hat+="up");break;case 13:d.buttons[h].pressed&&(e.hat+="down");break;case 14:d.buttons[h].pressed&&(e.hat+="left");break;case 15:d.buttons[h].pressed&&(e.hat+="right");break;case 16:e.buttons.home=d.buttons[h].pressed}d.xbox=
...
>>>>>>> 2cc2a410eb150720207034f5fb45b7bf8dd5b67d
