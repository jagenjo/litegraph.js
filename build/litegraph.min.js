...
(function(v) {
  ...
  m.prototype.computeSize = function(a, b) {
    ...
    if (this.widgets && this.widgets.length) {
      n = 0;
      for (p = this.widgets.length; n < p; ++n) {
  ...
  l.prototype.computeVisibleNodes = function(a, b) {
    ...
    for (var d = 0, h = a.length; d < h; ++d) {
      var f = a[d];
      (!this.live_mode || f.onDrawBackground || f.onDrawForeground) && w(this.visible_area, f.getBounding(C)) && b.push(f);
    }
    return b;
  };
  ...
  var G = new Float32Array(4), n = new Float32Array(4), p = new Float32Array(2), k = new Float32Array(2);
          ...
          if (g && null != g.link && (g = this.graph.links[g.link])) {
            ...
            if (null != m) {
              ...
              if (w(n, G)) {
                var q = m.outputs[r];
                r = c.inputs[l];
                if (q && r && (m = q.dir || (m.horizontal ? e.DOWN : e.RIGHT), r = r.dir || (c.horizontal ? e.UP : e.LEFT), this.renderLink(a, A, t, g, !1, 0, null, m, r), g && g._last_time && 1000 > b - g._last_time)) {
                  q = 2.0 - 0.002 * (b - g._last_time);
                  var M = a.globalAlpha;
                  a.globalAlpha = M * q;
                  this.renderLink(a, A, t, g, !0, q, "white", m, r);
                  a.globalAlpha = M;
                }
              }
            }
  ...
  l.prototype.renderLink = function(a, b, d, h, f, c, k, n, p, g) {
    ...
    for (var t = 0; t < g; t += 1) {
      ...
      if (this.links_render_mode == e.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + H, b[1] + r + m, d[0] + q, d[1] + I + m, d[0], d[1] + m);
      } else {
        if (this.links_render_mode == e.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * H, b[1] + 15 * r + m);
          a.lineTo(d[0] + 15 * q, d[1] + 15 * I + m);
          a.lineTo(d[0], d[1] + m);
        } else {
          if (this.links_render_mode == e.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), m = b[0], H = b[1], r = d[0], q = d[1], n == e.RIGHT ? m += 10 : H += 10, p == e.LEFT ? r -= 10 : q -= 10, a.lineTo(m, H), a.lineTo(0.5 * (m + r), H), a.lineTo(0.5 * (m + r), q), a.lineTo(r, q), a.lineTo(d[0], d[1]);
          } else {
            return;
          }
        }
  ...
  l.prototype.drawNodeWidgets = function(a, b, d, h) {
    ...
    for (var p = e.WIDGET_OUTLINE_COLOR, l = e.WIDGET_BGCOLOR, g = e.WIDGET_TEXT_COLOR, t = e.WIDGET_SECONDARY_TEXT_COLOR, m = 0; m < c.length; ++m) {
      var r = c[m], q = b;
      r.y && (q = r.y);
      r.last_y = q;
      d.strokeStyle = p;
      ...
      switch(r.type) {
        ...
        case "slider":
          d.fillStyle = l;
          d.fillRect(15, q, f - 30, k);
          var u = r.options.max - r.options.min, C = (r.value - r.options.min) / u;
          d.fillStyle = h == r ? "#89A" : "#678";
          d.fillRect(15, q, C * (f - 30), k);
          n && d.strokeRect(15, q, f - 30, k);
        ...
        case "combo":
          ...
          (u = r.value, r.options.values && (C = r.options.values, C.constructor === Function && (C = C()), C && C.constructor !== Array && (u = C[r.value])), d.fillText(u, f - 30 - 20, q + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
          ...
          break;
        default:
          r.draw && r.draw(d, a, f, q, k);
      }
      b += (r.computeSize ? r.computeSize(f)[1] : k) + 4;
      d.globalAlpha = this.editor_alpha;
    }
    d.restore();
    d.textAlign = "left";
  ...
  l.prototype.processNodeWidgets = function(a, b, d, c) {
    ...
    for (var h = b[0] - a.pos[0], k = b[1] - a.pos[1], n = a.size[0], p = this, l = this.getCanvasWindow(), g = 0; g < a.widgets.length; ++g) {
      var t = a.widgets[g];
      if (t && !t.disabled) {
        var m = t.computeSize ? t.computeSize(n)[1] : e.NODE_WIDGET_HEIGHT;
        if (t == c || 6 < h && h < n - 12 && k > t.last_y && k < t.last_y + m) {
          switch(t.type) {
            case "button":
              if ("mousemove" === d.type) {
                break;
            ...
            case "combo":
              ...
              if ("mousemove" == d.type && "number" == t.type) {
                ...
                if ("mousedown" == d.type) {
                  var r = t.options.values;
                  r && r.constructor === Function && (r = t.options.values(t, a));
                  var q = null;
                  "number" != t.type && (q = r.constructor === Array ? r : Object.keys(r));
                  h = 40 > h ? -1 : h > n - 40 ? 1 : 0;
                  if ("number" == t.type) {
                    ...
                    if (h) {
                      l = -1, l = r.constructor === Object ? q.indexOf(String(t.value)) + h : q.indexOf(t.value) + h, l >= q.length && (l = q.length - 1), 0 > l && (l = 0), t.value = r.constructor === Array ? r[l] : l;
                    } else {
                      var u = r != q ? Object.values(r) : r;
            ...
            case "text":
              ...
              break;
            default:
              t.mouse && (this.dirty_canvas = t.mouse(d, [h, k], a));
          }
          return t;
        }
      }
  ...
  l.prototype.drawGroups = function(a, b) {
    if (this.graph) {
      ...
      for (var d = 0; d < a.length; ++d) {
        var h = a[d];
        if (w(this.visible_area, h._bounding)) {
  ...
  l.prototype.prompt = function(a, b, d, c) {
    ...
    var n = -20, p = -20;
    b && (n -= b.left, p -= b.top);
    c ? (e.style.left = c.clientX + n + "px", e.style.top = c.clientY + p + "px") : (e.style.left = 0.5 * a.width + n + "px", e.style.top = 0.5 * a.height + p + "px");
  ...
  l.prototype.showSearchBox = function(a) {
        ...
        if (f.onSearchBox) {
          ...
          for (h in e.searchbox_extras) {
            ...
            if (-1 !== g.desc.toLowerCase().indexOf(d)) {
              var x = e.registered_node_types[g.type];
              if (!x || !x.filter || x.filter == p) {
    ...
    f.search_box = g;
    var r = g.querySelector(".helper"), t = null, q = null, u = null, C = g.querySelector("input");
  ...
  l.prototype.showEditPropertyValue = function(a, b, d) {
    ...
    if (a && void 0 !== a.properties[b]) {
      ...
      if ("enum" == k && e.values) {
        ...
        if ("boolean" == k) {
          (t = l.querySelector("input")) && t.addEventListener("click", function(a) {
            f(!!t.checked);
          });
        } else {
          if (t = l.querySelector("input")) {
...
(function(v) {
  ...
  B.prototype.getTitle = r.prototype.getTitle;
  B.prototype.onExecute = function() {
    this.setOutputData(0, this.properties.value);
  };
  B.prototype.setValue = r.prototype.setValue;
...
(function(v) {
  ...
  w.registerNodeType("events/timer", B);
  y.title = "Data Store";
...
(function(v) {
  ...
  A.registerNodeType("math3d/xyzw-to-vec4", K);
})(this);
(function(v) {
  function c() {
...
(function(v) {
  ...
  }, r.pixel_shader = "precision highp float;\n\r\n\n\r\nvarying vec2 v_coord;\n\r\nuniform float time; //time in seconds\n\r\nuniform vec2 texSize; //tex resolution\n\r\nuniform float u_value;\n\r\nuniform vec4 u_color;\n\n\r\nvoid main() {\n\r\n\tvec2 uv = v_coord;\n\r\n\tvec3 color = vec3(0.0);\n\r\n\t//your code here\n\r\n\tcolor.xy=uv;\n\n\r\n\tgl_FragColor = vec4(color, 1.0);\n\r\n}\n\r\n", F.registerNodeType("texture/shader", r), l.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, 
  ...
  values:[0, 32, 64, 128, 256, 512, 1024, 2048]}, precision:{widget:"combo", values:c.MODE_VALUES}}, w.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  F.registerNodeType("texture/LUT", u), G.title = "Texture to Channels", G.desc = "Split texture channels", G.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, F.registerNodeType("texture/webcam", J), K.title = "Lens FX", K.desc = "distortion and chromatic aberration", K.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, K.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  }, K.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH || !1 === this.getInputOrProperty("enabled")) {
        ...
        var d = K._shader;
        d || (d = K._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, K.pixel_shader));
  ...
  F.registerNodeType("texture/lensfx", K), A.title = "Curve", A.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
  ...
  }, t.pixel_shader = "precision highp float;\n\r\n\t\tvarying vec2 v_coord;\n\r\n\t\tuniform sampler2D u_texture;\n\r\n\t\tuniform float u_exposition;\n\r\n\t\t\n\r\n\t\tvoid main() {\n\r\n\t\t\tvec4 color = texture2D( u_texture, v_coord );\n\r\n\t\t\tgl_FragColor = vec4( color.xyz * u_exposition, color.a );\n\r\n\t\t}", F.registerNodeType("texture/exposition", t), L.title = "Tone Mapping", L.desc = "Applies Tone Mapping to convert from high to low", L.widgets_info = {precision:{widget:"combo", 
  values:c.MODE_VALUES}}, L.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  }, L.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH || !1 === this.getInputOrProperty("enabled")) {
        ...
        d.constructor === Number ? (this.properties.average_lum = d, k.u_average_lum = this.properties.average_lum, f = L._shader, f || (f = L._shader = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, L.pixel_shader))) : d.constructor === GL.Texture && (k.u_average_texture = d.bind(1), f = L._shader_texture, f || (f = L._shader_texture = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, L.pixel_shader, {AVG_TEXTURE:""})));
    ...
    g.prototype.onExecute = function() {
      ...
      if (c && r && this.properties.shape) {
        ...
        if (q) {
          ...
          var u = Mesh.getScreenQuad(), G = this.properties.size, n = this.properties.alpha;
          gl.disable(gl.DEPTH_TEST);
          gl.disable(gl.BLEND);
          this._temp_texture.drawTo(function() {
            c.bind(0);
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            q.bind(3);
            C.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:n, u_threshold:v, u_pointSize:G, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(D, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
      ...
      if (this.isOutputConnected(0)) {
        ...
        if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
          ...
          if (c) {
            ...
            var C = v.LS && LS.Renderer._current_camera ? [LS.Renderer._current_camera.near, LS.Renderer._current_camera.far] : [1, 100];
            var D = null;
            "noise" == q && (D = LGraphTexture.getNoiseTexture());
            this._tex.drawTo(function() {
              c.bind(0);
              "noise" == q && D.bind(1);
              E.uniforms({u_texture:0, u_noise:1, u_size:[c.width, c.height], u_rand:[Math.random(), Math.random()], u_value1:g, u_value2:r, u_camera_planes:C}).draw(e);
            });
            this.setOutputData(0, this._tex);
          }
        }
...
(function(v) {
  ...
  u.registerNodeType("midi/event", B);
  y.title = "MIDICC";
  ...
  u.registerNodeType("midi/play", C);
  D.title = "MIDI Keys";
