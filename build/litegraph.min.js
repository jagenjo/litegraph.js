...
$jscomp.polyfill = function(x, c, q, h) {
  if (c) {
    q = $jscomp.global;
    x = x.split(".");
    ...
    h = q[x];
    c = c(h);
    c != h && null != c && $jscomp.defineProperty(q, x, {configurable:!0, writable:!0, value:c});
  }
};
$jscomp.polyfill("Array.prototype.fill", function(x) {
  return x ? x : function(c, q, h) {
    var l = this.length || 0;
    ...
    h = Number(h);
    0 > h && (h = Math.max(0, l + h));
    for (q = Number(q || 0); q < h; q++) {
      this[q] = c;
    }
    return this;
  };
...
$jscomp.iteratorFromArray = function(x, c) {
  ...
  var q = 0, h = {next:function() {
    if (q < x.length) {
      var l = q++;
      return {value:c(l, x[l]), done:!1};
    }
    h.next = function() {
