...
d;b.fillStyle=e;e=k.NODE_TITLE_HEIGHT;var n=.5>this.ds.scale,r=a._shape||a.constructor.shape||k.ROUND_SHAPE,l=a.constructor.title_mode,u=!0;l==k.TRANSPARENT_TITLE?u=!1:l==k.AUTOHIDE_TITLE&&g&&(u=!0);A[0]=0;A[1]=u?-e:0;A[2]=c[0]+1;A[3]=u?c[1]+e:c[1];g=b.globalAlpha;b.beginPath();r==k.BOX_SHAPE||n?b.fillRect(A[0],A[1],A[2],A[3]):r==k.ROUND_SHAPE||r==k.CARD_SHAPE?b.roundRect(A[0],A[1],A[2],A[3],this.round_radius,r==k.CARD_SHAPE?0:this.round_radius):r==k.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0],0,
2*Math.PI);b.fill();a.flags.collapsed||(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,A[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas,this.graph_mouse);if(u||l==k.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,e,c,this.ds.scale,d);else if(l!=k.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){u=a.constructor.title_color||d;a.flags.collapsed&&(b.shadowColor=k.DEFAULT_SHADOW_COLOR);if(this.use_gradients){var p=
h.gradients[u];p||(p=h.gradients[u]=b.createLinearGradient(0,0,400,0),p.addColorStop(0,u),p.addColorStop(1,"#000"));b.fillStyle=p}else b.fillStyle=u;b.beginPath();r==k.BOX_SHAPE||n?b.rect(0,-e,c[0]+1,e):(r==k.ROUND_SHAPE||r==k.CARD_SHAPE)&&b.roundRect(0,-e,c[0]+1,e,this.round_radius,a.flags.collapsed?this.round_radius:0);b.fill();b.shadowColor="transparent"}if(a.onDrawTitleBox)a.onDrawTitleBox(b,e,c,this.ds.scale);else r==k.ROUND_SHAPE||r==k.CIRCLE_SHAPE||r==k.CARD_SHAPE?(n&&(b.fillStyle="black",
b.beginPath(),b.arc(.5*e,-.5*e,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,n?b.fillRect(.5*e-5,-.5*e-5,10,10):(b.beginPath(),b.arc(.5*e,-.5*e,5,0,2*Math.PI),b.fill())):(n&&(b.fillStyle="black",b.fillRect(.5*(e-10)-1,-.5*(e+10)-1,12,12)),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.fillRect(.5*(e-10),-.5*(e+10),10,10));b.globalAlpha=g;if(a.onDrawTitleText)a.onDrawTitleText(b,e,c,this.ds.scale,this.title_text_font,f);!n&&(b.font=this.title_text_font,g=String(a.getTitle()))&&
(b.fillStyle=f?k.NODE_SELECTED_TITLE_COLOR:a.constructor.title_text_color||this.node_title_color,a.flags.collapsed?(b.textAlign="left",b.measureText(g),b.fillText(g.substr(0,20),e,k.NODE_TITLE_TEXT_Y-e),b.textAlign="left"):(b.textAlign="left",b.fillText(g,e,k.NODE_TITLE_TEXT_Y-e)));a.flags.collapsed||!a.subgraph||a.skip_subgraph_button||(g=k.NODE_TITLE_HEIGHT,u=a.size[0]-g,p=k.isInsideRectangle(this.graph_mouse[0]-a.pos[0],this.graph_mouse[1]-a.pos[1],u+2,-g+2,g-4,g-4),b.fillStyle=p?"#888":"#555",
r==k.BOX_SHAPE||n?b.fillRect(u+2,-g+2,g-4,g-4):(b.beginPath(),b.roundRect(u+2,-g+2,g-4,g-4,4),b.fill()),b.fillStyle="#333",b.beginPath(),b.moveTo(u+.2*g,.6*-g),b.lineTo(u+.8*g,.6*-g),b.lineTo(u+.5*g,.3*-g),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(f){if(a.onBounding)a.onBounding(A);l==k.TRANSPARENT_TITLE&&(A[1]-=e,A[3]+=e);b.lineWidth=1;b.globalAlpha=.8;b.beginPath();r==k.BOX_SHAPE?b.rect(-6+A[0],-6+A[1],12+A[2],12+A[3]):r==k.ROUND_SHAPE||r==k.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+A[0],
-6+A[1],12+A[2],12+A[3],2*this.round_radius):r==k.CARD_SHAPE?b.roundRect(-6+A[0],-6+A[1],12+A[2],12+A[3],2*this.round_radius,2):r==k.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0]+6,0,2*Math.PI);b.strokeStyle=k.NODE_BOX_OUTLINE_COLOR;b.stroke();b.strokeStyle=d;b.globalAlpha=1}};var J=new Float32Array(4),D=new Float32Array(4),H=new Float32Array(2),F=new Float32Array(2);h.prototype.drawConnections=function(a){var b=k.getTime(),c=this.visible_area;J[0]=c[0]-20;J[1]=c[1]-20;J[2]=c[2]+40;J[3]=c[3]+40;a.lineWidth=
...
p[1]-u[1];0>D[2]&&(D[0]+=D[2],D[2]=Math.abs(D[2]));0>D[3]&&(D[1]+=D[3],D[3]=Math.abs(D[3]));if(B(D,J)){var z=r.outputs[h];h=f.inputs[g];if(z&&h&&(r=z.dir||(r.horizontal?k.DOWN:k.RIGHT),h=h.dir||(f.horizontal?k.UP:k.LEFT),this.renderLink(a,u,p,n,!1,0,null,r,h),n&&n._last_time&&1E3>b-n._last_time)){z=2-.002*(b-n._last_time);var l=a.globalAlpha;a.globalAlpha=l*z;this.renderLink(a,u,p,n,!0,z,"white",r,h);a.globalAlpha=l}}}}}}a.globalAlpha=1};h.prototype.renderLink=function(a,b,c,d,e,f,g,n,r,l){d&&this.visible_links.push(d);
!g&&d&&(g=d.color||h.link_type_colors[d.type]);g||(g=this.default_link_color);null!=d&&this.highlighted_links[d.id]&&(g="#FFF");n=n||k.RIGHT;r=r||k.LEFT;var u=E(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";l=l||1;1<l&&(a.lineWidth=.5);a.beginPath();for(var p=0;p<l;p+=1){var z=5*(p-.5*(l-1));if(this.links_render_mode==k.SPLINE_LINK){a.moveTo(b[0],b[1]+z);var y=0,t=0,m=0,K=0;switch(n){case k.LEFT:y=-.25*u;break;case k.RIGHT:y=.25*u;
break;case k.UP:t=-.25*u;break;case k.DOWN:t=.25*u}switch(r){case k.LEFT:m=-.25*u;break;case k.RIGHT:m=.25*u;break;case k.UP:K=-.25*u;break;case k.DOWN:K=.25*u}a.bezierCurveTo(b[0]+y,b[1]+t+z,c[0]+m,c[1]+K+z,c[0],c[1]+z)}else if(this.links_render_mode==k.LINEAR_LINK){a.moveTo(b[0],b[1]+z);K=m=t=y=0;switch(n){case k.LEFT:y=-1;break;case k.RIGHT:y=1;break;case k.UP:t=-1;break;case k.DOWN:t=1}switch(r){case k.LEFT:m=-1;break;case k.RIGHT:m=1;break;case k.UP:K=-1;break;case k.DOWN:K=1}a.lineTo(b[0]+15*
y,b[1]+15*t+z);a.lineTo(c[0]+15*m,c[1]+15*K+z);a.lineTo(c[0],c[1]+z)}else if(this.links_render_mode==k.STRAIGHT_LINK)a.moveTo(b[0],b[1]),z=b[0],y=b[1],t=c[0],m=c[1],n==k.RIGHT?z+=10:y+=10,r==k.LEFT?t-=10:m-=10,a.lineTo(z,y),a.lineTo(.5*(z+t),y),a.lineTo(.5*(z+t),m),a.lineTo(t,m),a.lineTo(c[0],c[1]);else return}this.render_connections_border&&.6<this.ds.scale&&!e&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;a.fillStyle=a.strokeStyle=g;a.stroke();e=this.computeConnectionPoint(b,
c,.5,n,r);d&&d._pos&&(d._pos[0]=e[0],d._pos[1]=e[1]);.6<=this.ds.scale&&this.highquality_render&&r!=k.CENTER&&(this.render_connection_arrows&&(p=this.computeConnectionPoint(b,c,.25,n,r),u=this.computeConnectionPoint(b,c,.26,n,r),d=this.computeConnectionPoint(b,c,.75,n,r),l=this.computeConnectionPoint(b,c,.76,n,r),this.render_curved_connections?(u=-Math.atan2(u[0]-p[0],u[1]-p[1]),l=-Math.atan2(l[0]-d[0],l[1]-d[1])):l=u=c[1]>b[1]?0:Math.PI,a.save(),a.translate(p[0],p[1]),a.rotate(u),a.beginPath(),a.moveTo(-5,
-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(d[0],d[1]),a.rotate(l),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill());if(f)for(a.fillStyle=g,p=0;5>p;++p)f=(.001*k.getTime()+.2*p)%1,e=this.computeConnectionPoint(b,c,f,n,r),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill()};h.prototype.computeConnectionPoint=function(a,b,c,d,e){d=d||k.RIGHT;e=e||k.LEFT;var f=E(a,b),g=[a[0],a[1]],n=
[b[0],b[1]];switch(d){case k.LEFT:g[0]+=-.25*f;break;case k.RIGHT:g[0]+=.25*f;break;case k.UP:g[1]+=-.25*f;break;case k.DOWN:g[1]+=.25*f}switch(e){case k.LEFT:n[0]+=-.25*f;break;case k.RIGHT:n[0]+=.25*f;break;case k.UP:n[1]+=-.25*f;break;case k.DOWN:n[1]+=.25*f}d=(1-c)*(1-c)*(1-c);e=3*(1-c)*(1-c)*c;f=3*(1-c)*c*c;c*=c*c;return[d*a[0]+e*g[0]+f*n[0]+c*b[0],d*a[1]+e*g[1]+f*n[1]+c*b[1]]};h.prototype.drawExecutionOrder=function(a){a.shadowColor="transparent";a.globalAlpha=.25;a.textAlign="center";a.strokeStyle=
"white";a.globalAlpha=.75;for(var b=this.visible_nodes,c=0;c<b.length;++c){var d=b[c];a.fillStyle="black";a.fillRect(d.pos[0]-k.NODE_TITLE_HEIGHT,d.pos[1]-k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT);0==d.order&&a.strokeRect(d.pos[0]-k.NODE_TITLE_HEIGHT+.5,d.pos[1]-k.NODE_TITLE_HEIGHT+.5,k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT);a.fillStyle="#FFF";a.fillText(d.order,d.pos[0]+-.5*k.NODE_TITLE_HEIGHT,d.pos[1]-6)}a.globalAlpha=1};h.prototype.drawNodeWidgets=function(a,b,c,d){if(!a.widgets||
...
new k.ContextMenu(w,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){m!=q&&(a=w.indexOf(a));this.value=a;e(this,a);r.dirty_canvas=!0;return!1}.bind(p)},h)}}else"mouseup"==c.type&&"number"==p.type&&(f=40>f?-1:f>t-40?1:0,200>c.click_time&&0==f&&this.prompt("Value",p.value,function(a){this.value=Number(a);e(this,this.value)}.bind(p),c));d!=p.value&&setTimeout(function(){e(this,this.value)}.bind(p),20);this.dirty_canvas=!0;break;case "toggle":"mousedown"==c.type&&(p.value=
...
for(var c=0;c<a.length;++c){var d=a[c];if(B(this.visible_area,d._bounding)){b.fillStyle=d.color||"#335";b.strokeStyle=d.color||"#335";var e=d._pos,f=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,f[0],f[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+f[0],e[1]+f[1]);b.lineTo(e[0]+f[0]-10,e[1]+f[1]);b.lineTo(e[0]+f[0],e[1]+f[1]-10);b.fill();f=d.font_size||k.DEFAULT_GROUP_FONT_SIZE;b.font=f+"px Arial";b.fillText(d.title,e[0]+4,e[1]+
...
e.onSearchBox(m,c,f);if(d)for(var n=0;n<d.length;++n)a(d[n])}else{d=function(a){var b=k.registered_node_types[a];return r&&b.filter!=r?!1:-1!==a.toLowerCase().indexOf(c)};var g=0;c=c.toLowerCase();var r=f.filter||f.graph.filter;for(n in k.searchbox_extras){var l=k.searchbox_extras[n];if(-1!==l.desc.toLowerCase().indexOf(c)){var t=k.registered_node_types[l.type];if(!t||t.filter==r)if(a(l.desc,"searchbox_extra"),-1!==h.search_limit&&g++>h.search_limit)break}}l=null;if(Array.prototype.filter)l=Object.keys(k.registered_node_types).filter(d);
else for(n in l=[],k.registered_node_types)d(n)&&l.push(n);for(n=0;n<l.length&&!(a(l[n]),-1!==h.search_limit&&g++>h.search_limit);n++);}}var e=this,f=h.active_canvas,g=f.canvas,n=g.ownerDocument||document,r=document.createElement("div");r.className="litegraph litesearchbox graphdialog rounded";r.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";r.close=function(){e.search_box=null;n.body.focus();n.body.style.overflow="";setTimeout(function(){e.canvas.focus()},
20);r.parentNode&&r.parentNode.removeChild(r)};var l=null;1<this.ds.scale&&(r.style.transform="scale("+this.ds.scale+")");r.addEventListener("mouseenter",function(a){l&&(clearTimeout(l),l=null)});r.addEventListener("mouseleave",function(a){l=setTimeout(function(){r.close()},500)});e.search_box&&e.search_box.close();e.search_box=r;var m=r.querySelector(".helper"),p=null,z=null,t=null,q=r.querySelector("input");q&&(q.addEventListener("blur",function(a){this.focus()}),q.addEventListener("keydown",function(a){if(38==
...
a.className="separator";d.content.appendChild(a)};d.addWidget=function(a,b,g,n,r){function e(a,b){console.log("change",a,b);n.callback&&n.callback(a,b);r&&r(a,b)}n=n||{};var f=String(g);a=a.toLowerCase();"number"==a&&(f=g.toFixed(3));var l=document.createElement("div");l.className="property";l.innerHTML="<span class='property_name'></span><span class='property_value'></span>";l.querySelector(".property_name").innerText=n.label||b;var z=l.querySelector(".property_value");z.innerText=f;l.dataset.property=
b;l.dataset.type=n.type||a;l.options=n;l.value=g;if("boolean"==a)l.classList.add("boolean"),g&&l.classList.add("bool-on"),l.addEventListener("click",function(){var a=this.dataset.property;this.value=!this.value;this.classList.toggle("bool-on");this.querySelector(".property_value").innerText=this.value?"true":"false";e(a,this.value)});else if("string"==a||"number"==a)z.setAttribute("contenteditable",!0),z.addEventListener("keydown",function(a){"Enter"==a.code&&(a.preventDefault(),this.blur())}),z.addEventListener("blur",
function(){var a=this.innerText,b=this.parentNode.dataset.property;"number"==this.parentNode.dataset.type&&(a=Number(a));e(b,a)});else if("enum"==a||"combo"==a)f=h.getPropertyPrintableValue(g,n.values),z.innerText=f,z.addEventListener("click",function(a){var b=this.parentNode.dataset.property,d=this;new k.ContextMenu(n.values||[],{event:a,className:"dark",callback:function(a,c,n){d.innerText=a;e(b,a);return!1}},c)});d.content.appendChild(l);return l};return d};h.getPropertyPrintableValue=function(a,
...
c.node&&(c.node.graph&&c.graph==this.graph||c.close())}};h.onMenuNodeCollapse=function(a,b,c,d,e){e.graph.beforeChange(e);e.collapse();e.graph.afterChange(e)};h.onMenuNodePin=function(a,b,c,d,e){e.pin()};h.onMenuNodeMode=function(a,b,c,d,e){new k.ContextMenu(["Always","On Event","On Trigger","Never"],{event:c,callback:function(a){if(e)switch(a){case "On Event":e.mode=k.ON_EVENT;break;case "On Trigger":e.mode=k.ON_TRIGGER;break;case "Never":e.mode=k.NEVER;break;default:e.mode=k.ALWAYS}},parentMenu:d,
node:e});return!1};h.onMenuNodeColors=function(a,b,c,d,e){if(!e)throw"no node for color";b=[];b.push({value:null,content:"<span style='display: block; padding-left: 4px;'>No color</span>"});for(var f in h.node_colors)a=h.node_colors[f],a={value:f,content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid "+a.color+"; background-color:"+a.bgcolor+"'>"+f+"</span>"},b.push(a);new k.ContextMenu(b,{event:c,callback:function(a){e&&((a=a.value?h.node_colors[a.value]:null)?
e.constructor===k.LGraphGroup?e.color=a.groupcolor:(e.color=a.color,e.bgcolor=a.bgcolor):(delete e.color,delete e.bgcolor),e.setDirtyCanvas(!0,!0))},parentMenu:d,node:e});return!1};h.onMenuNodeShapes=function(a,b,c,d,e){if(!e)throw"no node passed";new k.ContextMenu(k.VALID_SHAPES,{event:c,callback:function(a){e&&(e.graph.beforeChange(e),e.shape=a,e.graph.afterChange(e),e.setDirtyCanvas(!0))},parentMenu:d,node:e});return!1};h.onMenuNodeRemove=function(a,b,c,d,e){if(!e)throw"no node passed";!1!==e.removable&&
...
new f.constructor(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:f,ignore_item_callbacks:b.submenu.ignore_item_callbacks,title:b.submenu.title,extra:b.submenu.extra,autoopen:c.autoopen});d=!1}d&&!f.lock&&f.close()}var f=this;c=c||{};var g=document.createElement("div");g.className="litemenu-entry submenu";var n=!1;if(null===b)g.classList.add("separator");else{g.innerHTML=b&&b.title?b.title:a;if(g.value=b)b.disabled&&(n=!0,g.classList.add("disabled")),(b.submenu||b.has_submenu)&&
g.classList.add("has_submenu");"function"==typeof b?(g.dataset.value=a,g.onclick_callback=b):g.dataset.value=b;b.className&&(g.className+=" "+b.className)}this.root.appendChild(g);n||g.addEventListener("click",e);c.autoopen&&g.addEventListener("mouseenter",d);return g};x.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!x.isCursorOverElement(a,
this.parentMenu.root)&&x.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&clearTimeout(this.root.closing_timer)};x.trigger=function(a,b,c,d){var e=document.createEvent("CustomEvent");e.initCustomEvent(b,!0,!0,c);e.srcElement=d;a.dispatchEvent?a.dispatchEvent(e):a.__events&&a.__events.dispatchEvent(e);return e};x.prototype.getTopMenu=function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};x.prototype.getFirstEvent=
function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};x.isCursorOverElement=function(a,b){var c=a.clientX;a=a.clientY;return(b=b.getBoundingClientRect())?a>b.top&&a<b.top+b.height&&c>b.left&&c<b.left+b.width?!0:!1:!1};k.ContextMenu=x;k.closeAllContextMenus=function(a){a=a||window;a=a.document.querySelectorAll(".litecontextmenu");if(a.length){for(var b=[],c=0;c<a.length;c++)b.push(a[c]);for(c=0;c<b.length;c++)b[c].close?b[c].close():b[c].parentNode&&
b[c].parentNode.removeChild(b[c])}};k.extendClass=function(a,b){for(var c in b)a.hasOwnProperty(c)||(a[c]=b[c]);if(b.prototype)for(c in b.prototype)b.prototype.hasOwnProperty(c)&&!a.prototype.hasOwnProperty(c)&&(b.prototype.__lookupGetter__(c)?a.prototype.__defineGetter__(c,b.prototype.__lookupGetter__(c)):a.prototype[c]=b.prototype[c],b.prototype.__lookupSetter__(c)&&a.prototype.__defineSetter__(c,b.prototype.__lookupSetter__(c)))};I.sampleCurve=function(a,b){if(b){for(var c=0;c<b.length-1;++c){var d=
