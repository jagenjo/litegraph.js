...
(function(x){function m(a){f.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function t(a,b,c,e,d,g){this.id=a;this.type=b;this.origin_id=c;this.origin_slot=e;this.target_id=d;this.target_slot=g;this._data=null;this._pos=new Float32Array(2)}function l(a){this._ctor(a)}function w(a){this._ctor(a)}function z(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
this.setCanvas(a,c.skip_events);this.clear();c.skip_render||this.startRendering();this.autoresize=c.autoresize}function D(a,b){return Math.sqrt((b[0]-a[0])*(b[0]-a[0])+(b[1]-a[1])*(b[1]-a[1]))}function C(a,b,c,e,d,g){return c<a&&c+d>a&&e<b&&e+g>b?!0:!1}function A(a,b){var c=a[0]+a[2],e=a[1]+a[3],d=b[1]+b[3];return a[0]>b[0]+b[2]||a[1]>d||c<b[0]||e<b[1]?!1:!0}function E(a,b){function c(a){var c=parseInt(g.style.top);g.style.top=(c+a.deltaY*b.scroll_speed).toFixed()+"px";a.preventDefault();return!0}
...
var g=document.createElement("div");g.className="litegraph litecontextmenu litemenubar-panel";b.className&&(g.className+=" "+b.className);g.style.minWidth=100;g.style.minHeight=100;g.style.pointerEvents="none";setTimeout(function(){g.style.pointerEvents="auto"},100);f.pointerListenerAdd(g,"up",function(a){a.preventDefault();return!0},!0);g.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);f.pointerListenerAdd(g,"down",function(a){if(2==a.button)return e.close(),
a.preventDefault(),!0},!0);b.scroll_speed||(b.scroll_speed=.1);g.addEventListener("wheel",c,!0);g.addEventListener("mousewheel",c,!0);this.root=g;b.title&&(d=document.createElement("div"),d.className="litemenu-title",d.innerHTML=b.title,g.appendChild(d));for(var k=d=0;k<a.length;k++){var n=a.constructor==Array?a[k]:k;null!=n&&n.constructor!==String&&(n=void 0===n.content?String(n):n.content);this.addItem(n,a[k],b);d++}f.pointerListenerAdd(g,"enter",function(a){g.closing_timer&&clearTimeout(g.closing_timer)});
a=document;b.event&&(a=b.event.target.ownerDocument);a||(a=document);a.fullscreenElement?a.fullscreenElement.appendChild(g):a.body.appendChild(g);d=b.left||0;a=b.top||0;b.event&&(d=b.event.clientX-10,a=b.event.clientY-10,b.title&&(a-=20),b.parentMenu&&(d=b.parentMenu.root.getBoundingClientRect(),d=d.left+d.width),k=document.body.getBoundingClientRect(),n=g.getBoundingClientRect(),0==k.height&&console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"),k.width&&d>
k.width-n.width-10&&(d=k.width-n.width-10),k.height&&a>k.height-n.height-10&&(a=k.height-n.height-10));g.style.left=d+"px";g.style.top=a+"px";b.scale&&(g.style.transform="scale("+b.scale+")")}function G(a){this.points=a;this.nearest=this.selected=-1;this.size=null;this.must_update=!0;this.margin=5}var f=x.LiteGraph={VERSION:.4,CANVAS_GRID_SIZE:10,NODE_TITLE_HEIGHT:30,NODE_TITLE_TEXT_Y:20,NODE_SLOT_HEIGHT:20,NODE_WIDGET_HEIGHT:20,NODE_WIDTH:140,NODE_MIN_WIDTH:50,NODE_COLLAPSED_RADIUS:10,NODE_COLLAPSED_WIDTH:80,
...
a).constructor.type;b="string"==typeof b?b.split(","):b==this.EVENT||b==this.ACTION?["_event_"]:["*"];for(var e=0;e<b.length;++e){var d=b[e];""===d&&(d="*");var g=c?"registered_slot_out_types":"registered_slot_in_types";"undefined"==typeof this[g][d]&&(this[g][d]={nodes:[]});this[g][d].nodes.push(a);c?this.slot_types_out.includes(d.toLowerCase())||(this.slot_types_out.push(d.toLowerCase()),this.slot_types_out.sort()):this.slot_types_in.includes(d.toLowerCase())||(this.slot_types_in.push(d.toLowerCase()),
this.slot_types_in.sort())}},wrapFunctionAsNode:function(a,b,c,e,d){for(var g=Array(b.length),k="",n=f.getParameterNames(b),p=0;p<n.length;++p)k+="this.addInput('"+n[p]+"',"+(c&&c[p]?"'"+c[p]+"'":"0")+");\n";k+="this.addOutput('out',"+(e?"'"+e+"'":0)+");\n";d&&(k+="this.properties = "+JSON.stringify(d)+";\n");c=Function(k);c.title=a.split("/").pop();c.desc="Generated from "+b.name;c.prototype.onExecute=function(){for(var a=0;a<g.length;++a)g[a]=this.getInputData(a);a=b.apply(this,g);this.setOutputData(0,
...
null;b=b||e.title||a;var d=null;if(f.catch_exceptions)try{d=new e(b)}catch(k){return console.error(k),null}else d=new e(b);d.type=a;!d.title&&b&&(d.title=b);d.properties||(d.properties={});d.properties_info||(d.properties_info=[]);d.flags||(d.flags={});d.size||(d.size=d.computeSize());d.pos||(d.pos=f.DEFAULT_POSITION.concat());d.mode||(d.mode=f.ALWAYS);if(c)for(var g in c)d[g]=c[g];if(d.onNodeCreated)d.onNodeCreated();return d},getNodeType:function(a){return this.registered_node_types[a]},getNodeTypesInCategory:function(a,
...
b.runStep(1,!b.catch_errors);if(b.onAfterStep)b.onAfterStep()},a)}};m.prototype.stop=function(){if(this.status!=m.STATUS_STOPPED){this.status=m.STATUS_STOPPED;if(this.onStopEvent)this.onStopEvent();null!=this.execution_timer_id&&(-1!=this.execution_timer_id&&clearInterval(this.execution_timer_id),this.execution_timer_id=null);this.sendEventToAllNodes("onStop")}};m.prototype.runStep=function(a,b,c){a=a||1;var e=f.getTime();this.globaltime=.001*(e-this.starttime);var d=this._nodes_executable?this._nodes_executable:
this._nodes;if(d){c=c||d.length;if(b){for(var g=0;g<a;g++){for(var k=0;k<c;++k){var n=d[k];n.mode==f.ALWAYS&&n.onExecute&&n.doExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(g=0;g<a;g++){for(k=0;k<c;++k)if(n=d[k],n.mode==f.ALWAYS&&n.onExecute)n.onExecute();this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute();this.errors_in_execution=
...
[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};m.prototype.computeExecutionOrder=function(a,b){for(var c=[],e=[],d={},g={},k={},n=0,p=this._nodes.length;n<p;++n){var r=this._nodes[n];if(!a||r.onExecute){d[r.id]=r;var u=0;if(r.inputs)for(var q=0,y=r.inputs.length;q<y;q++)r.inputs[q]&&null!=r.inputs[q].link&&(u+=1);0==u?(e.push(r),b&&(r._level=1)):(b&&(r._level=0),k[r.id]=u)}}for(;0!=e.length;)if(r=e.shift(),
c.push(r),delete d[r.id],r.outputs)for(n=0;n<r.outputs.length;n++)if(a=r.outputs[n],null!=a&&null!=a.links&&0!=a.links.length)for(q=0;q<a.links.length;q++)(p=this.links[a.links[q]])&&!g[p.id]&&(u=this.getNodeById(p.target_id),null==u?g[p.id]=!0:(b&&(!u._level||u._level<=r._level)&&(u._level=r._level+1),g[p.id]=!0,--k[u.id],0==k[u.id]&&e.push(u)));for(n in d)c.push(d[n]);c.length!=this._nodes.length&&f.debug&&console.warn("something went wrong, nodes missing");p=c.length;for(n=0;n<p;++n)c[n].order=
n;c=c.sort(function(a,b){var c=a.constructor.priority||a.priority||0,d=b.constructor.priority||b.priority||0;return c==d?a.order-b.order:c-d});for(n=0;n<p;++n)c[n].order=n;return c};m.prototype.getAncestors=function(a){for(var b=[],c=[a],e={};c.length;){var d=c.shift();if(d.inputs){e[d.id]||d==a||(e[d.id]=!0,b.push(d));for(var g=0;g<d.inputs.length;++g){var f=d.getInputNode(g);f&&-1==b.indexOf(f)&&c.push(f)}}}b.sort(function(a,b){return a.order-b.order});return b};m.prototype.arrange=function(a){a=
a||100;for(var b=this.computeExecutionOrder(!1,!0),c=[],e=0;e<b.length;++e){var d=b[e],g=d._level||1;c[g]||(c[g]=[]);c[g].push(d)}b=a;for(e=0;e<c.length;++e)if(g=c[e]){for(var k=100,n=a+f.NODE_TITLE_HEIGHT,p=0;p<g.length;++p)d=g[p],d.pos[0]=b,d.pos[1]=n,d.size[0]>k&&(k=d.size[0]),n+=d.size[1]+a+f.NODE_TITLE_HEIGHT;b+=k+a}this.setDirtyCanvas(!0,!0)};m.prototype.getTime=function(){return this.globaltime};m.prototype.getFixedTime=function(){return this.fixedtime};m.prototype.getElapsedTime=function(){return this.elapsed_time};
m.prototype.sendEventToAllNodes=function(a,b,c){c=c||f.ALWAYS;var e=this._nodes_in_order?this._nodes_in_order:this._nodes;if(e)for(var d=0,g=e.length;d<g;++d){var k=e[d];if(k.constructor===f.Subgraph&&"onExecute"!=a)k.mode==c&&k.sendEventToAllNodes(a,b,c);else if(k[a]&&k.mode==c)if(void 0===b)k[a]();else if(b&&b.constructor===Array)k[a].apply(k,b);else k[a](b)}};m.prototype.sendActionToCanvas=function(a,b){if(this.list_of_graphcanvas)for(var c=0;c<this.list_of_graphcanvas.length;++c){var e=this.list_of_graphcanvas[c];
e[a]&&e[a].apply(e,b)}};m.prototype.add=function(a,b){if(a)if(a.constructor===w)this._groups.push(a),this.setDirtyCanvas(!0),this.change(),a.graph=this,this._version++;else{-1!=a.id&&null!=this._nodes_by_id[a.id]&&(console.warn("LiteGraph: there is already a node with this ID, changing it"),a.id=++this.last_node_id);if(this._nodes.length>=f.MAX_NUMBER_OF_NODES)throw"LiteGraph: max number of nodes in a graph reached";null==a.id||-1==a.id?a.id=++this.last_node_id:this.last_node_id<a.id&&(this.last_node_id=
...
b=this._nodes.indexOf(a);-1!=b&&this._nodes.splice(b,1);delete this._nodes_by_id[a.id];if(this.onNodeRemoved)this.onNodeRemoved(a);this.sendActionToCanvas("checkPanels");this.setDirtyCanvas(!0,!0);this.afterChange();this.change();this.updateExecutionOrder()}};m.prototype.getNodeById=function(a){return null==a?null:this._nodes_by_id[a]};m.prototype.findNodesByClass=function(a,b){b=b||[];for(var c=b.length=0,e=this._nodes.length;c<e;++c)this._nodes[c].constructor===a&&b.push(this._nodes[c]);return b};
...
function(a,b,c,e){c=c||this._nodes;for(var d=c.length-1;0<=d;d--){var g=c[d];if(g.isPointInside(a,b,e))return g}return null};m.prototype.getGroupOnPos=function(a,b){for(var c=this._groups.length-1;0<=c;c--){var e=this._groups[c];if(e.isPointInside(a,b,2,!0))return e}return null};m.prototype.checkNodeTypes=function(){for(var a=0;a<this._nodes.length;a++){var b=this._nodes[a];if(b.constructor!=f.registered_node_types[b.type]){console.log("node being replaced by newer version: "+b.type);var c=f.createNode(b.type);
this._nodes[a]=c;c.configure(b.serialize());c.graph=this;this._nodes_by_id[c.id]=c;b.inputs&&(c.inputs=b.inputs.concat());b.outputs&&(c.outputs=b.outputs.concat())}}this.updateExecutionOrder()};m.prototype.onAction=function(a,b,c){this._input_nodes=this.findNodesByClass(f.GraphInput,this._input_nodes);for(var e=0;e<this._input_nodes.length;++e){var d=this._input_nodes[e];if(d.properties.name==a){d.actionDo(a,b,c);break}}};m.prototype.trigger=function(a,b){if(this.onTrigger)this.onTrigger(a,b)};m.prototype.addInput=
...
c=!1;this._nodes=[];if(b){e=0;for(d=b.length;e<d;++e){g=b[e];var k=f.createNode(g.type,g.title);k||(f.debug&&console.log("Node not found or has errors: "+g.type),k=new l,k.last_serialization=g,c=k.has_errors=!0);k.id=g.id;this.add(k,!0)}e=0;for(d=b.length;e<d;++e)g=b[e],(k=this.getNodeById(g.id))&&k.configure(g)}this._groups.length=0;if(a.groups)for(e=0;e<a.groups.length;++e)b=new f.LGraphGroup,b.configure(a.groups[e]),this.add(b);this.updateExecutionOrder();this.extra=a.extra||{};if(this.onConfigure)this.onConfigure(a);
this._version++;this.setDirtyCanvas(!0,!0);return c}};m.prototype.load=function(a,b){var c=this;if(a.constructor===File||a.constructor===Blob){var e=new FileReader;e.addEventListener("load",function(a){a=JSON.parse(a.target.result);c.configure(a);b&&b()});e.readAsText(a)}else{var d=new XMLHttpRequest;d.open("GET",a,!0);d.send(null);d.onload=function(a){200!==d.status?console.error("Error loading graph:",d.status,d.response):(a=JSON.parse(d.response),c.configure(a),b&&b())};d.onerror=function(a){console.error("Error loading graph:",
...
this.graph.getNodeById(a.origin_id):null:null};l.prototype.getInputOrProperty=function(a){if(!this.inputs||!this.inputs.length)return this.properties?this.properties[a]:null;for(var b=0,c=this.inputs.length;b<c;++b){var e=this.inputs[b];if(a==e.name&&null!=e.link&&(e=this.graph.links[e.link]))return e.data}return this.properties[a]};l.prototype.getOutputData=function(a){return!this.outputs||a>=this.outputs.length?null:this.outputs[a]._data};l.prototype.getOutputInfo=function(a){return this.outputs?
...
if(!a.links||0==a.links.length)return null;for(var b=[],c=0;c<a.links.length;c++){var e=this.graph.links[a.links[c]];e&&(e=this.graph.getNodeById(e.target_id))&&b.push(e)}return b};l.prototype.addOnTriggerInput=function(){var a=this.findInputSlot("onTrigger");return-1==a?(this.addInput("onTrigger",f.EVENT,{optional:!0,nameLocked:!0}),this.findInputSlot("onTrigger")):a};l.prototype.addOnExecutedOutput=function(){var a=this.findOutputSlot("onExecuted");return-1==a?(this.addOutput("onExecuted",f.ACTION,
...
"_"+Math.floor(9999*Math.random())),this.graph.nodes_actioning[this.id]=a?a:"actioning",this.onAction(a,b,c),this.graph.nodes_actioning[this.id]=!1,c&&c.action_call&&(this.action_call=c.action_call,this.graph.nodes_executedAction[this.id]=c.action_call));this.action_triggered=2;if(this.onAfterExecuteNode)this.onAfterExecuteNode(b,c)};l.prototype.trigger=function(a,b,c){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=f.getTime());for(var e=0;e<this.outputs.length;++e){var d=
this.outputs[e];!d||d.type!==f.EVENT||a&&d.name!=a||this.triggerSlot(e,b,null,c)}}};l.prototype.triggerSlot=function(a,b,c,e){e=e||{};if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=f.getTime());for(var d=0;d<a.length;++d){var g=a[d];if(null==c||c==g){var k=this.graph.links[a[d]];k&&(k._last_time=f.getTime(),g=this.graph.getNodeById(k.target_id))&&(g.mode===f.ON_TRIGGER?(e.action_call||(e.action_call=this.id+"_trigg_"+Math.floor(9999*Math.random())),
g.onExecute&&g.doExecute(b,e)):g.onAction&&(e.action_call||(e.action_call=this.id+"_act_"+Math.floor(9999*Math.random())),k=g.inputs[k.target_slot],g.actionDo(k.name,b,e)))}}}};l.prototype.clearTriggeredSlot=function(a,b){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length)for(var c=0;c<a.length;++c){var e=a[c];if(null==b||b==e)if(e=this.graph.links[a[c]])e._last_time=0}};l.prototype.setSize=function(a){this.size=a;if(this.onResize)this.onResize(this.size)};l.prototype.addProperty=function(a,
b,c,e){c={name:a,type:c,default_value:b};if(e)for(var d in e)c[d]=e[d];this.properties_info||(this.properties_info=[]);this.properties_info.push(c);this.properties||(this.properties={});this.properties[a]=b;return c};l.prototype.addOutput=function(a,b,c){a={name:a,type:b,links:null};if(c)for(var e in c)a[e]=c[e];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);f.auto_load_slot_types&&f.registerNodeAndSlotType(this,b,!0);this.setSize(this.computeSize());
this.setDirtyCanvas(!0,!0);return a};l.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],e={name:c[0],type:c[1],link:null};if(a[2])for(var d in c[2])e[d]=c[2][d];this.outputs||(this.outputs=[]);this.outputs.push(e);if(this.onOutputAdded)this.onOutputAdded(e);f.auto_load_slot_types&&f.registerNodeAndSlotType(this,c[1],!0)}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);for(var b=
a;b<this.outputs.length;++b)if(this.outputs[b]&&this.outputs[b].links)for(var c=this.outputs[b].links,e=0;e<c.length;++e){var d=this.graph.links[c[e]];d&&--d.origin_slot}this.setSize(this.computeSize());if(this.onOutputRemoved)this.onOutputRemoved(a);this.setDirtyCanvas(!0,!0)};l.prototype.addInput=function(a,b,c){b=b||0;a={name:a,type:b,link:null};if(c)for(var e in c)a[e]=c[e];this.inputs||(this.inputs=[]);this.inputs.push(a);this.setSize(this.computeSize());if(this.onInputAdded)this.onInputAdded(a);
f.registerNodeAndSlotType(this,b);this.setDirtyCanvas(!0,!0);return a};l.prototype.addInputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],e={name:c[0],type:c[1],link:null};if(a[2])for(var d in c[2])e[d]=c[2][d];this.inputs||(this.inputs=[]);this.inputs.push(e);if(this.onInputAdded)this.onInputAdded(e);f.registerNodeAndSlotType(this,c[1])}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeInput=function(a){this.disconnectInput(a);for(var b=this.inputs.splice(a,1),
c=a;c<this.inputs.length;++c)if(this.inputs[c]){var e=this.graph.links[this.inputs[c].link];e&&--e.target_slot}this.setSize(this.computeSize());if(this.onInputRemoved)this.onInputRemoved(a,b[0]);this.setDirtyCanvas(!0,!0)};l.prototype.addConnection=function(a,b,c,e){a={name:a,type:b,pos:c,direction:e,links:null};this.connections.push(a);return a};l.prototype.computeSize=function(a){function b(a){return a?e*a.length*.6:0}if(this.constructor.size)return this.constructor.size.concat();var c=Math.max(this.inputs?
this.inputs.length:1,this.outputs?this.outputs.length:1);a=a||new Float32Array([0,0]);c=Math.max(c,1);var e=f.NODE_TEXT_SIZE,d=b(this.title),g=0,k=0;if(this.inputs)for(var n=0,p=this.inputs.length;n<p;++n){var r=this.inputs[n];r=r.label||r.name||"";r=b(r);g<r&&(g=r)}if(this.outputs)for(n=0,p=this.outputs.length;n<p;++n)r=this.outputs[n],r=r.label||r.name||"",r=b(r),k<r&&(k=r);a[0]=Math.max(g+k+10,d);a[0]=Math.max(a[0],f.NODE_WIDTH);this.widgets&&this.widgets.length&&(a[0]=Math.max(a[0],1.5*f.NODE_WIDTH));
...
null;if(this.properties_info)for(var c=0;c<this.properties_info.length;++c)if(this.properties_info[c].name==a){b=this.properties_info[c];break}this.constructor["@"+a]&&(b=this.constructor["@"+a]);this.constructor.widgets_info&&this.constructor.widgets_info[a]&&(b=this.constructor.widgets_info[a]);!b&&this.onGetPropertyInfo&&(b=this.onGetPropertyInfo(a));b||(b={});b.type||(b.type=typeof this.properties[a]);"combo"==b.widget&&(b.type="enum");return b};l.prototype.addWidget=function(a,b,c,e,d){this.widgets||
(this.widgets=[]);!d&&e&&e.constructor===Object&&(d=e,e=null);d&&d.constructor===String&&(d={property:d});e&&e.constructor===String&&(d||(d={}),d.property=e,e=null);e&&e.constructor!==Function&&(console.warn("addWidget: callback must be a function"),e=null);b={type:a.toLowerCase(),name:b,value:c,callback:e,options:d||{}};void 0!==b.options.y&&(b.y=b.options.y);e||b.options.callback||b.options.property||console.warn("LiteGraph addWidget(...) without a callback or property assigned");if("combo"==a&&
...
if(!b)return!1;var c=this.inputs[a].link;if(null!=c){this.inputs[a].link=null;var e=this.graph.links[c];if(e){var d=this.graph.getNodeById(e.origin_id);if(!d)return!1;var g=d.outputs[e.origin_slot];if(!g||!g.links||0==g.links.length)return!1;for(var k=0,n=g.links.length;k<n;k++)if(g.links[k]==c){g.links.splice(k,1);break}delete this.graph.links[c];this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(f.INPUT,a,!1,e,b);if(d.onConnectionsChange)d.onConnectionsChange(f.OUTPUT,
k,!1,e,g);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(f.OUTPUT,d,k),this.graph.onNodeConnectionChange(f.INPUT,this,a))}}this.setDirtyCanvas(!1,!0);this.graph&&this.graph.connectionChange(this);return!0};l.prototype.getConnectionPos=function(a,b,c){c=c||new Float32Array(2);var e=0;a&&this.inputs&&(e=this.inputs.length);!a&&this.outputs&&(e=this.outputs.length);var d=.5*f.NODE_SLOT_HEIGHT;if(this.flags.collapsed)return b=this._collapsed_width||f.NODE_COLLAPSED_WIDTH,
this.horizontal?(c[0]=this.pos[0]+.5*b,c[1]=a?this.pos[1]-f.NODE_TITLE_HEIGHT:this.pos[1]):(c[0]=a?this.pos[0]:this.pos[0]+b,c[1]=this.pos[1]-.5*f.NODE_TITLE_HEIGHT),c;if(a&&-1==b)return c[0]=this.pos[0]+.5*f.NODE_TITLE_HEIGHT,c[1]=this.pos[1]+.5*f.NODE_TITLE_HEIGHT,c;if(a&&e>b&&this.inputs[b].pos)return c[0]=this.pos[0]+this.inputs[b].pos[0],c[1]=this.pos[1]+this.inputs[b].pos[1],c;if(!a&&e>b&&this.outputs[b].pos)return c[0]=this.pos[0]+this.outputs[b].pos[0],c[1]=this.pos[1]+this.outputs[b].pos[1],
c;if(this.horizontal)return c[0]=this.pos[0]+this.size[0]/e*(b+.5),c[1]=a?this.pos[1]-f.NODE_TITLE_HEIGHT:this.pos[1]+this.size[1],c;c[0]=a?this.pos[0]+d:this.pos[0]+this.size[0]+1-d;c[1]=this.pos[1]+(b+.7)*f.NODE_SLOT_HEIGHT+(this.constructor.slot_start_y||0);return c};l.prototype.alignToGrid=function(){this.pos[0]=f.CANVAS_GRID_SIZE*Math.round(this.pos[0]/f.CANVAS_GRID_SIZE);this.pos[1]=f.CANVAS_GRID_SIZE*Math.round(this.pos[1]/f.CANVAS_GRID_SIZE)};l.prototype.trace=function(a){this.console||(this.console=
...
if(this.graph){this.adjustMouseEvent(a);var b=this.getCanvasWindow();h.active_canvas=this;var c=this,e=a.clientX,d=a.clientY;this.ds.viewport=this.viewport;e=!this.viewport||this.viewport&&e>=this.viewport[0]&&e<this.viewport[0]+this.viewport[2]&&d>=this.viewport[1]&&d<this.viewport[1]+this.viewport[3];this.options.skip_events||(f.pointerListenerRemove(this.canvas,"move",this._mousemove_callback),f.pointerListenerAdd(b.document,"move",this._mousemove_callback,!0),f.pointerListenerAdd(b.document,"up",
...
if(!this.onMouse||1!=this.onMouse(a)){if(1!=a.which||this.pointer_is_double)if(2==a.which){if(f.middle_click_slot_add_default_node&&g&&this.allow_interaction&&!e&&!this.read_only&&!this.connecting_node&&!g.flags.collapsed&&!this.live_mode){d=e=k=!1;if(g.outputs)for(u=0,n=g.outputs.length;u<n;++u)if(p=g.outputs[u],r=g.getConnectionPos(!1,u),C(a.canvasX,a.canvasY,r[0]-15,r[1]-10,30,20)){k=p;e=u;d=!0;break}if(g.inputs)for(u=0,n=g.inputs.length;u<n;++u)if(p=g.inputs[u],r=g.getConnectionPos(!0,u),C(a.canvasX,
a.canvasY,r[0]-15,r[1]-10,30,20)){k=p;e=u;d=!1;break}k&&!1!==e&&(u=.5-(e+1)/(d?g.outputs.length:g.inputs.length),k=g.getBounding(),this.createDefaultNodeForSlot({nodeFrom:d?g:null,slotFrom:d?e:null,nodeTo:d?null:g,slotTo:d?null:e,position:[d?k[0]+k[2]:k[0],a.canvasY-80],nodeType:"AUTO",posAdd:[d?30:-30,130*-u],posSizeFix:[d?0:-1,0]}))}}else 3!=a.which&&!this.pointer_is_double||!this.allow_interaction||e||this.read_only||(g&&(Object.keys(this.selected_nodes).length&&(this.selected_nodes[g.id]||a.shiftKey||
a.ctrlKey||a.metaKey)?this.selected_nodes[g.id]||this.selectNodes([g],!0):this.selectNodes([g])),this.processContextMenu(g,a));else{a.ctrlKey&&(this.dragging_rectangle=new Float32Array(4),this.dragging_rectangle[0]=a.canvasX,this.dragging_rectangle[1]=a.canvasY,this.dragging_rectangle[2]=1,this.dragging_rectangle[3]=1,e=!0);f.alt_drag_do_clone_nodes&&a.altKey&&g&&this.allow_interaction&&!e&&!this.read_only&&(cloned=g.clone())&&(cloned.pos[0]+=5,cloned.pos[1]+=5,this.graph.add(cloned,!1,{doCalcSize:!1}),
g=cloned,e=!0,u||(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=g),this.selected_nodes[g.id]||this.processNodeSelected(g,a)));var k=!1;if(g&&this.allow_interaction&&!e&&!this.read_only){this.live_mode||g.flags.pinned||this.bringToFront(g);if(!this.connecting_node&&!g.flags.collapsed&&!this.live_mode)if(!e&&!1!==g.resizable&&C(a.canvasX,a.canvasY,g.pos[0]+g.size[0]-5,g.pos[1]+g.size[1]-5,10,10))this.graph.beforeChange(),this.resizing_node=g,this.canvas.style.cursor="se-resize",
e=!0;else{if(g.outputs){u=0;for(var n=g.outputs.length;u<n;++u){var p=g.outputs[u],r=g.getConnectionPos(!1,u);if(C(a.canvasX,a.canvasY,r[0]-15,r[1]-10,30,20)){this.connecting_node=g;this.connecting_output=p;this.connecting_output.slot_index=u;this.connecting_pos=g.getConnectionPos(!1,u);this.connecting_slot=u;f.shift_click_do_break_link_from&&a.shiftKey&&g.disconnectOutput(u);if(d){if(g.onOutputDblClick)g.onOutputDblClick(u,a)}else if(g.onOutputClick)g.onOutputClick(u,a);e=!0;break}}}if(g.inputs)for(u=
0,n=g.inputs.length;u<n;++u)if(p=g.inputs[u],r=g.getConnectionPos(!0,u),C(a.canvasX,a.canvasY,r[0]-15,r[1]-10,30,20)){if(d){if(g.onInputDblClick)g.onInputDblClick(u,a)}else if(g.onInputClick)g.onInputClick(u,a);null!==p.link&&(r=this.graph.links[p.link],f.click_do_break_link_to&&(g.disconnectInput(u),e=this.dirty_bgcanvas=!0),this.allow_reconnect_links||a.shiftKey)&&(f.click_do_break_link_to||g.disconnectInput(u),this.connecting_node=this.graph._nodes_by_id[r.origin_id],this.connecting_slot=r.origin_slot,
this.connecting_output=this.connecting_node.outputs[this.connecting_slot],this.connecting_pos=this.connecting_node.getConnectionPos(!1,this.connecting_slot),e=this.dirty_bgcanvas=!0);e||(this.connecting_node=g,this.connecting_input=p,this.connecting_input.slot_index=u,this.connecting_pos=g.getConnectionPos(!0,u),this.connecting_slot=u,e=this.dirty_bgcanvas=!0)}}if(!e){var u=!1;n=[a.canvasX-g.pos[0],a.canvasY-g.pos[1]];if(r=this.processNodeWidgets(g,this.graph_mouse,a))u=!0,this.node_widget=[g,r];
if(d&&this.selected_nodes[g.id]){if(g.onDblClick)g.onDblClick(a,n,this);this.processNodeDblClicked(g);u=!0}g.onMouseDown&&g.onMouseDown(a,n,this)?u=!0:(g.subgraph&&!g.skip_subgraph_button&&!g.flags.collapsed&&n[0]>g.size[0]-f.NODE_TITLE_HEIGHT&&0>n[1]&&(c=this,setTimeout(function(){c.openSubgraph(g.subgraph)},10)),this.live_mode&&(u=k=!0));u||(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=g),this.selected_nodes[g.id]||this.processNodeSelected(g,a));this.dirty_canvas=!0}}else if(!e){if(!this.read_only)for(u=
0;u<this.visible_links.length;++u)if(k=this.visible_links[u],n=k._pos,!(!n||a.canvasX<n[0]-4||a.canvasX>n[0]+4||a.canvasY<n[1]-4||a.canvasY>n[1]+4)){this.showLinkMenu(k,a);this.over_link_center=null;break}this.selected_group=this.graph.getGroupOnPos(a.canvasX,a.canvasY);this.selected_group_resizing=!1;this.selected_group&&!this.read_only&&(a.ctrlKey&&(this.dragging_rectangle=null),10>D([a.canvasX,a.canvasY],[this.selected_group.pos[0]+this.selected_group.size[0],this.selected_group.pos[1]+this.selected_group.size[1]])*
this.ds.scale?this.selected_group_resizing=!0:this.selected_group.recomputeInsideNodes());d&&!this.read_only&&this.allow_searchbox&&(this.showSearchBox(a),a.preventDefault(),a.stopPropagation());k=!0}!e&&k&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}this.last_mouse[0]=a.clientX;this.last_mouse[1]=a.clientY;this.last_mouseclick=f.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&
...
this._highlight_input||[0,0],!this.isOverNodeBox(e,a.canvasX,a.canvasY)){var g=this.isOverNodeInput(e,a.canvasX,a.canvasY,d);if(-1!=g&&e.inputs[g]){var k=e.inputs[g].type;f.isValidConnection(this.connecting_output.type,k)&&(this._highlight_input=d,this._highlight_input_slot=e.inputs[g])}else this._highlight_input_slot=this._highlight_input=null}}else this.connecting_input&&(d=this._highlight_output||[0,0],this.isOverNodeBox(e,a.canvasX,a.canvasY)||(g=this.isOverNodeOutput(e,a.canvasX,a.canvasY,d),
-1!=g&&e.outputs[g]?(k=e.outputs[g].type,f.isValidConnection(this.connecting_input.type,k)&&(this._highlight_output=d)):this._highlight_output=null));this.canvas&&(C(a.canvasX,a.canvasY,e.pos[0]+e.size[0]-5,e.pos[1]+e.size[1]-5,5,5)?this.canvas.style.cursor="se-resize":this.canvas.style.cursor="crosshair")}else{d=null;for(b=0;b<this.visible_links.length;++b)if(g=this.visible_links[b],k=g._pos,!(!k||a.canvasX<k[0]-4||a.canvasX>k[0]+4||a.canvasY<k[1]-4||a.canvasY>k[1]+4)){d=g;break}d!=this.over_link_center&&
...
a.canvasY,this.visible_nodes);if(this.dragging_rectangle){if(this.graph){b=this.graph._nodes;var e=new Float32Array(4),d=Math.abs(this.dragging_rectangle[2]),g=Math.abs(this.dragging_rectangle[3]),k=0>this.dragging_rectangle[3]?this.dragging_rectangle[1]-g:this.dragging_rectangle[1];this.dragging_rectangle[0]=0>this.dragging_rectangle[2]?this.dragging_rectangle[0]-d:this.dragging_rectangle[0];this.dragging_rectangle[1]=k;this.dragging_rectangle[2]=d;this.dragging_rectangle[3]=g;if(!c||10<d&&10<g){c=
[];for(d=0;d<b.length;++d)g=b[d],g.getBounding(e),A(this.dragging_rectangle,e)&&c.push(g);c.length&&this.selectNodes(c,a.shiftKey)}else this.selectNodes([c],a.shiftKey||a.ctrlKey)}this.dragging_rectangle=null}else if(this.connecting_node)this.dirty_bgcanvas=this.dirty_canvas=!0,b=(this.connecting_output||this.connecting_input).type,c?this.connecting_output?(e=this.isOverNodeInput(c,a.canvasX,a.canvasY),-1!=e?this.connecting_node.connect(this.connecting_slot,c,e):this.connecting_node.connectByType(this.connecting_slot,
c,b)):this.connecting_input&&(e=this.isOverNodeOutput(c,a.canvasX,a.canvasY),-1!=e?c.connect(e,this.connecting_node,this.connecting_slot):this.connecting_node.connectByTypeOutput(this.connecting_slot,c,b)):f.release_link_on_empty_shows_menu&&(a.shiftKey&&this.allow_searchbox?this.connecting_output?this.showSearchBox(a,{node_from:this.connecting_node,slot_from:this.connecting_output,type_filter_in:this.connecting_output.type}):this.connecting_input&&this.showSearchBox(a,{node_to:this.connecting_node,
...
if(!this.viewport||this.viewport&&c>=this.viewport[0]&&c<this.viewport[0]+this.viewport[2]&&e>=this.viewport[1]&&e<this.viewport[1]+this.viewport[3])return c=this.ds.scale,0<b?c*=1.1:0>b&&(c*=1/1.1),this.ds.changeScale(c,[a.clientX,a.clientY]),this.graph.change(),a.preventDefault(),!1}};h.prototype.isOverNodeBox=function(a,b,c){var e=f.NODE_TITLE_HEIGHT;return C(b,c,a.pos[0]+2,a.pos[1]+2-e,e-4,e-4)?!0:!1};h.prototype.isOverNodeInput=function(a,b,c,e){if(a.inputs)for(var d=0,g=a.inputs.length;d<g;++d){var f=
a.getConnectionPos(!0,d);if(a.horizontal?C(b,c,f[0]-5,f[1]-10,10,20):C(b,c,f[0]-10,f[1]-5,40,10))return e&&(e[0]=f[0],e[1]=f[1]),d}return-1};h.prototype.isOverNodeOutput=function(a,b,c,e){if(a.outputs)for(var d=0,g=a.outputs.length;d<g;++d){var f=a.getConnectionPos(!1,d);if(a.horizontal?C(b,c,f[0]-5,f[1]-10,10,20):C(b,c,f[0]-10,f[1]-5,40,10))return e&&(e[0]=f[0],e[1]=f[1]),d}return-1};h.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==
...
"Cond.",this.properties.OP,{property:"OP",values:a.values});this.size=[80,60]}function b(){this.addInput("in",0);this.addInput("cond","boolean");this.addOutput("true",0);this.addOutput("false",0);this.size=[80,60]}function c(){this.addInput("inc","number");this.addOutput("total","number");this.addProperty("increment",1);this.addProperty("value",0)}function e(){this.addInput("v","number");this.addOutput("sin","number");this.addProperty("amplitude",1);this.addProperty("offset",0);this.bgImageUrl="nodes/imgs/icon-sin.png"}
function d(){this.addInput("x","number");this.addInput("y","number");this.addOutput("","number");this.properties={x:1,y:1,formula:"x+y"};this.code_widget=this.addWidget("text","F(x,y)",this.properties.formula,function(a,b,c){c.properties.formula=a});this.addWidget("toggle","allow",q.allow_scripts,function(a){q.allow_scripts=a});this._func=null}function g(){this.addInput("vec2","vec2");this.addOutput("x","number");this.addOutput("y","number")}function k(){this.addInputs([["x","number"],["y","number"]]);
...
var d=this.properties.offset;c=this.findInputSlot("offset");-1!=c&&(d=this.getInputData(c));c=0;for(var e=this.outputs.length;c<e;++c){switch(this.outputs[c].name){case "sin":var f=Math.sin(a);break;case "cos":f=Math.cos(a);break;case "tan":f=Math.tan(a);break;case "asin":f=Math.asin(a);break;case "acos":f=Math.acos(a);break;case "atan":f=Math.atan(a)}this.setOutputData(c,b*f+d)}};e.prototype.onGetInputs=function(){return[["v","number"],["amplitude","number"],["offset","number"]]};e.prototype.onGetOutputs=
function(){return[["sin","number"],["cos","number"],["tan","number"],["asin","number"],["acos","number"],["atan","number"]]};q.registerNodeType("math/trigonometry",e);q.registerSearchboxExtra("math/trigonometry","SIN()",{outputs:[["sin","number"]],title:"SIN()"});q.registerSearchboxExtra("math/trigonometry","COS()",{outputs:[["cos","number"]],title:"COS()"});q.registerSearchboxExtra("math/trigonometry","TAN()",{outputs:[["tan","number"]],title:"TAN()"});d.title="Formula";d.desc="Compute formula";
d.size=[160,100];K.prototype.onPropertyChanged=function(a,b){"formula"==a&&(this.code_widget.value=b)};d.prototype.onExecute=function(){if(q.allow_scripts){var a=this.getInputData(0),b=this.getInputData(1);null!=a?this.properties.x=a:a=this.properties.x;null!=b?this.properties.y=b:b=this.properties.y;try{this._func&&this._func_code==this.properties.formula||(this._func=new Function("x","y","TIME","return "+this.properties.formula),this._func_code=this.properties.formula);var c=this._func(a,b,this.graph.globaltime);
this.boxcolor=null}catch(N){this.boxcolor="red"}this.setOutputData(0,c)}};d.prototype.getTitle=function(){return this._func_code||"Formula"};d.prototype.onDrawBackground=function(){var a=this.properties.formula;this.outputs&&this.outputs.length&&(this.outputs[0].label=a)};q.registerNodeType("math/formula",d);g.title="Vec2->XY";g.desc="vector 2 to components";g.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&(this.setOutputData(0,a[0]),this.setOutputData(1,a[1]))};q.registerNodeType("math3d/vec2-to-xy",
