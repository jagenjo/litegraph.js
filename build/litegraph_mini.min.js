...
$jscomp.polyfill("String.prototype.startsWith",function(v){return v?v:function(m,q){var l=$jscomp.checkStringArgs(this,m,"startsWith");m+="";var t=l.length,w=m.length;q=Math.max(0,Math.min(q|0,l.length));for(var h=0;h<w&&q<t;)if(l[q++]!=m[h++])return!1;return h>=w}},"es6","es3");$jscomp.findInternal=function(v,m,q){v instanceof String&&(v=String(v));for(var l=v.length,t=0;t<l;t++){var w=v[t];if(m.call(q,w,t,v))return{i:t,v:w}}return{i:-1,v:void 0}};
...
(function(v){function m(a){k.debug&&console.log("Graph created");this.list_of_graphcanvas=null;this.clear();a&&this.configure(a)}function q(a,b,c,d,e,f){this.id=a;this.type=b;this.origin_id=c;this.origin_slot=d;this.target_id=e;this.target_slot=f;this._data=null;this._pos=new Float32Array(2)}function l(a){this._ctor(a)}function t(a){this._ctor(a)}function w(a,b){this.offset=new Float32Array([0,0]);this.scale=1;this.max_scale=10;this.min_scale=.1;this.onredraw=null;this.enabled=!0;this.last_mouse=
...
Nodes:{},Globals:{},searchbox_extras:{},auto_sort_node_types:!1,registerNodeType:function(a,b){if(!b.prototype)throw"Cannot register a simple object, it must be a class with a prototype";b.type=a;k.debug&&console.log("Node registered: "+a);a.split("/");var c=b.name,d=a.lastIndexOf("/");b.category=a.substr(0,d);b.title||(b.title=c);if(b.prototype)for(var e in l.prototype)b.prototype[e]||(b.prototype[e]=l.prototype[e]);if(d=this.registered_node_types[a])console.log("replacing node type: "+a);else if(Object.hasOwnProperty(b.prototype,
"shape")||Object.defineProperty(b.prototype,"shape",{set:function(a){switch(a){case "default":delete this._shape;break;case "box":this._shape=k.BOX_SHAPE;break;case "round":this._shape=k.ROUND_SHAPE;break;case "circle":this._shape=k.CIRCLE_SHAPE;break;case "card":this._shape=k.CARD_SHAPE;break;default:this._shape=a}},get:function(a){return this._shape},enumerable:!0,configurable:!0}),b.prototype.onPropertyChange&&console.warn("LiteGraph node class "+a+" has onPropertyChange method, it must be called onPropertyChanged with d at the end"),
...
function(a){if(this.list_of_graphcanvas){var b=this.list_of_graphcanvas.indexOf(a);-1!=b&&(a.graph=null,this.list_of_graphcanvas.splice(b,1))}};m.prototype.start=function(a){if(this.status!=m.STATUS_RUNNING){this.status=m.STATUS_RUNNING;if(this.onPlayEvent)this.onPlayEvent();this.sendEventToAllNodes("onStart");this.last_update_time=this.starttime=k.getTime();a=a||0;var b=this;if(0==a&&"undefined"!=typeof window&&window.requestAnimationFrame){var c=function(){if(-1==b.execution_timer_id){window.requestAnimationFrame(c);
...
this.execution_timer_id=null);this.sendEventToAllNodes("onStop")}};m.prototype.runStep=function(a,b,c){a=a||1;var d=k.getTime();this.globaltime=.001*(d-this.starttime);var e=this._nodes_executable?this._nodes_executable:this._nodes;if(e){c=c||e.length;if(b){for(var f=0;f<a;f++){for(var g=0;g<c;++g){var n=e[g];if(n.mode==k.ALWAYS&&n.onExecute)n.onExecute()}this.fixedtime+=this.fixedtime_lapse;if(this.onExecuteStep)this.onExecuteStep()}if(this.onAfterExecute)this.onAfterExecute()}else try{for(f=0;f<
...
a)}}};m.prototype.onNodeTrace=function(a,b,c){};q.prototype.configure=function(a){a.constructor===Array?(this.id=a[0],this.origin_id=a[1],this.origin_slot=a[2],this.target_id=a[3],this.target_slot=a[4],this.type=a[5]):(this.id=a.id,this.type=a.type,this.origin_id=a.origin_id,this.origin_slot=a.origin_slot,this.target_id=a.target_id,this.target_slot=a.target_slot)};q.prototype.serialize=function(){return[this.id,this.origin_id,this.origin_slot,this.target_id,this.target_slot,this.type]};k.LLink=q;
v.LGraphNode=k.LGraphNode=l;l.prototype._ctor=function(a){this.title=a||"Unnamed";this.size=[k.NODE_WIDTH,60];this.graph=null;this._pos=new Float32Array(10,10);Object.defineProperty(this,"pos",{set:function(a){!a||2>a.length||(this._pos[0]=a[0],this._pos[1]=a[1])},get:function(){return this._pos},enumerable:!0});this.id=-1;this.type=null;this.inputs=[];this.outputs=[];this.connections=[];this.properties={};this.properties_info=[];this.flags={}};l.prototype.configure=function(a){this.graph&&this.graph._version++;
for(var b in a)if("properties"==b)for(var c in a.properties){if(this.properties[c]=a.properties[c],this.onPropertyChanged)this.onPropertyChanged(c,a.properties[c])}else null!=a[b]&&("object"==typeof a[b]?this[b]&&this[b].configure?this[b].configure(a[b]):this[b]=k.cloneObject(a[b],this[b]):this[b]=a[b]);a.title||(this.title=this.constructor.title);if(this.onConnectionsChange){if(this.inputs)for(c=0;c<this.inputs.length;++c){b=this.inputs[c];var d=this.graph?this.graph.links[b.link]:null;this.onConnectionsChange(k.INPUT,
c,!0,d,b)}if(this.outputs)for(c=0;c<this.outputs.length;++c){var e=this.outputs[c];if(e.links)for(b=0;b<e.links.length;++b)d=this.graph?this.graph.links[e.links[b]]:null,this.onConnectionsChange(k.OUTPUT,c,!0,d,e)}}if(this.widgets){for(c=0;c<this.widgets.length;++c)(b=this.widgets[c])&&b.options&&b.options.property&&this.properties[b.options.property]&&(b.value=JSON.parse(JSON.stringify(this.properties[b.options.property])));if(a.widgets_values)for(c=0;c<a.widgets_values.length;++c)this.widgets[c]&&
(this.widgets[c].value=a.widgets_values[c])}if(this.onConfigure)this.onConfigure(a)};l.prototype.serialize=function(){var a={id:this.id,type:this.type,pos:this.pos,size:this.size,flags:k.cloneObject(this.flags),order:this.order,mode:this.mode};if(this.constructor===l&&this.last_serialization)return this.last_serialization;this.inputs&&(a.inputs=this.inputs);if(this.outputs){for(var b=0;b<this.outputs.length;b++)delete this.outputs[b]._data;a.outputs=this.outputs}this.title&&this.title!=this.constructor.title&&
(a.title=this.title);this.properties&&(a.properties=k.cloneObject(this.properties));if(this.widgets&&this.serialize_widgets)for(a.widgets_values=[],b=0;b<this.widgets.length;++b)a.widgets_values[b]=this.widgets[b]?this.widgets[b].value:null;a.type||(a.type=this.constructor.type);this.color&&(a.color=this.color);this.bgcolor&&(a.bgcolor=this.bgcolor);this.boxcolor&&(a.boxcolor=this.boxcolor);this.shape&&(a.shape=this.shape);this.onSerialize&&this.onSerialize(a)&&console.warn("node onSerialize shouldnt return anything, data should be stored in the object pass in the first parameter");
return a};l.prototype.clone=function(){var a=k.createNode(this.type);if(!a)return null;var b=k.cloneObject(this.serialize());if(b.inputs)for(var c=0;c<b.inputs.length;++c)b.inputs[c].link=null;if(b.outputs)for(c=0;c<b.outputs.length;++c)b.outputs[c].links&&(b.outputs[c].links.length=0);delete b.id;a.configure(b);return a};l.prototype.toString=function(){return JSON.stringify(this.serialize())};l.prototype.getTitle=function(){return this.title||this.constructor.title};l.prototype.setProperty=function(a,
...
if(!a.links||0==a.links.length)return null;for(var b=[],c=0;c<a.links.length;c++){var d=this.graph.links[a.links[c]];d&&(d=this.graph.getNodeById(d.target_id))&&b.push(d)}return b};l.prototype.trigger=function(a,b){if(this.outputs&&this.outputs.length){this.graph&&(this.graph._last_trigger_time=k.getTime());for(var c=0;c<this.outputs.length;++c){var d=this.outputs[c];!d||d.type!==k.EVENT||a&&d.name!=a||this.triggerSlot(c,b)}}};l.prototype.triggerSlot=function(a,b,c){if(this.outputs&&(a=this.outputs[a])&&
(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=k.getTime());for(var d=0;d<a.length;++d){var e=a[d];if(null==c||c==e){var f=this.graph.links[a[d]];if(f&&(f._last_time=k.getTime(),e=this.graph.getNodeById(f.target_id)))if(f=e.inputs[f.target_slot],e.mode===k.ON_TRIGGER){if(e.onExecute)e.onExecute(b)}else if(e.onAction)e.onAction(f.name,b)}}}};l.prototype.clearTriggeredSlot=function(a,b){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length)for(var c=0;c<a.length;++c){var d=
...
0]);c=Math.max(c,1);var d=k.NODE_TEXT_SIZE,e=b(this.title),f=0,g=0;if(this.inputs)for(var n=0,r=this.inputs.length;n<r;++n){var h=this.inputs[n];h=h.label||h.name||"";h=b(h);f<h&&(f=h)}if(this.outputs)for(n=0,r=this.outputs.length;n<r;++n)h=this.outputs[n],h=h.label||h.name||"",h=b(h),g<h&&(g=h);a[0]=Math.max(f+g+10,e);a[0]=Math.max(a[0],k.NODE_WIDTH);this.widgets&&this.widgets.length&&(a[0]=Math.max(a[0],1.5*k.NODE_WIDTH));a[1]=(this.constructor.slot_start_y||0)+c*k.NODE_SLOT_HEIGHT;c=0;if(this.widgets&&
this.widgets.length){n=0;for(r=this.widgets.length;n<r;++n)c=this.widgets[n].computeSize?c+(this.widgets[n].computeSize(a[0])[1]+4):c+(k.NODE_WIDGET_HEIGHT+4);c+=8}a[1]=this.widgets_up?Math.max(a[1],c):null!=this.widgets_start_y?Math.max(a[1],c+this.widgets_start_y):a[1]+c;this.constructor.min_height&&a[1]<this.constructor.min_height&&(a[1]=this.constructor.min_height);a[1]+=6;return a};l.prototype.getPropertyInfo=function(a){var b=null;if(this.properties_info)for(var c=0;c<this.properties_info.length;++c)if(this.properties_info[c].name==
...
c;++b)if(a==this.outputs[b].name)return b;return-1};l.prototype.connect=function(a,b,c){c=c||0;if(!this.graph)return console.log("Connect: Error, node doesn't belong to any graph. Nodes must be added first to a graph before connecting them."),null;if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return k.debug&&console.log("Connect: Error, no slot of name "+a),null}else if(!this.outputs||a>=this.outputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),null;b&&
...
!1===b.onConnectInput(c,e.type,e,this,a))return null;var f=b.inputs[c],g=null;if(!k.isValidConnection(e.type,f.type))return this.setDirtyCanvas(!1,!0),d&&this.graph.connectionChange(this,g),null;d||this.graph.beforeChange();g=new q(++this.graph.last_link_id,f.type,this.id,a,b.id,c);this.graph.links[g.id]=g;null==e.links&&(e.links=[]);e.links.push(g.id);b.inputs[c].link=g.id;this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(k.OUTPUT,a,!0,g,e);if(b.onConnectionsChange)b.onConnectionsChange(k.INPUT,
c,!0,g,f);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(k.INPUT,b,c,this,a),this.graph.onNodeConnectionChange(k.OUTPUT,this,a,b,c));this.setDirtyCanvas(!1,!0);this.graph.afterChange();this.graph.connectionChange(this,g);return g};l.prototype.disconnectOutput=function(a,b){if(a.constructor===String){if(a=this.findOutputSlot(a),-1==a)return k.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.outputs||a>=this.outputs.length)return k.debug&&
...
!0);this.graph.connectionChange(this);return!0};l.prototype.disconnectInput=function(a){if(a.constructor===String){if(a=this.findInputSlot(a),-1==a)return k.debug&&console.log("Connect: Error, no slot of name "+a),!1}else if(!this.inputs||a>=this.inputs.length)return k.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var c=this.inputs[a].link;if(null!=c){this.inputs[a].link=null;var d=this.graph.links[c];if(d){var e=this.graph.getNodeById(d.origin_id);
if(!e)return!1;var f=e.outputs[d.origin_slot];if(!f||!f.links||0==f.links.length)return!1;for(var g=0,n=f.links.length;g<n;g++)if(f.links[g]==c){f.links.splice(g,1);break}delete this.graph.links[c];this.graph&&this.graph._version++;if(this.onConnectionsChange)this.onConnectionsChange(k.INPUT,a,!1,d,b);if(e.onConnectionsChange)e.onConnectionsChange(k.OUTPUT,g,!1,d,f);this.graph&&this.graph.onNodeConnectionChange&&(this.graph.onNodeConnectionChange(k.OUTPUT,e,g),this.graph.onNodeConnectionChange(k.INPUT,
this,a))}}this.setDirtyCanvas(!1,!0);this.graph&&this.graph.connectionChange(this);return!0};l.prototype.getConnectionPos=function(a,b,c){c=c||new Float32Array(2);var d=0;a&&this.inputs&&(d=this.inputs.length);!a&&this.outputs&&(d=this.outputs.length);var e=.5*k.NODE_SLOT_HEIGHT;if(this.flags.collapsed)return b=this._collapsed_width||k.NODE_COLLAPSED_WIDTH,this.horizontal?(c[0]=this.pos[0]+.5*b,c[1]=a?this.pos[1]-k.NODE_TITLE_HEIGHT:this.pos[1]):(c[0]=a?this.pos[0]:this.pos[0]+b,c[1]=this.pos[1]-
.5*k.NODE_TITLE_HEIGHT),c;if(a&&-1==b)return c[0]=this.pos[0]+.5*k.NODE_TITLE_HEIGHT,c[1]=this.pos[1]+.5*k.NODE_TITLE_HEIGHT,c;if(a&&d>b&&this.inputs[b].pos)return c[0]=this.pos[0]+this.inputs[b].pos[0],c[1]=this.pos[1]+this.inputs[b].pos[1],c;if(!a&&d>b&&this.outputs[b].pos)return c[0]=this.pos[0]+this.outputs[b].pos[0],c[1]=this.pos[1]+this.outputs[b].pos[1],c;if(this.horizontal)return c[0]=this.pos[0]+this.size[0]/d*(b+.5),c[1]=a?this.pos[1]-k.NODE_TITLE_HEIGHT:this.pos[1]+this.size[1],c;c[0]=
a?this.pos[0]+e:this.pos[0]+this.size[0]+1-e;c[1]=this.pos[1]+(b+.7)*k.NODE_SLOT_HEIGHT+(this.constructor.slot_start_y||0);return c};l.prototype.alignToGrid=function(){this.pos[0]=k.CANVAS_GRID_SIZE*Math.round(this.pos[0]/k.CANVAS_GRID_SIZE);this.pos[1]=k.CANVAS_GRID_SIZE*Math.round(this.pos[1]/k.CANVAS_GRID_SIZE)};l.prototype.trace=function(a){this.console||(this.console=[]);this.console.push(a);this.console.length>l.MAX_CONSOLE&&this.console.shift();if(this.graph.onNodeTrace)this.graph.onNodeTrace(this,
a)};l.prototype.setDirtyCanvas=function(a,b){this.graph&&this.graph.sendActionToCanvas("setDirty",[a,b])};l.prototype.loadImage=function(a){var b=new Image;b.src=k.node_images_path+a;b.ready=!1;var c=this;b.onload=function(){this.ready=!0;c.setDirtyCanvas(!0)};return b};l.prototype.captureInput=function(a){if(this.graph&&this.graph.list_of_graphcanvas)for(var b=this.graph.list_of_graphcanvas,c=0;c<b.length;++c){var d=b[c];if(a||d.node_capturing_input==this)d.node_capturing_input=a?this:null}};l.prototype.collapse=
function(a){this.graph._version++;if(!1!==this.constructor.collapsable||a)this.flags.collapsed=this.flags.collapsed?!1:!0,this.setDirtyCanvas(!0,!0)};l.prototype.pin=function(a){this.graph._version++;this.flags.pinned=void 0===a?!this.flags.pinned:a};l.prototype.localToScreen=function(a,b,c){return[(a+this.pos[0])*c.scale+c.offset[0],(b+this.pos[1])*c.scale+c.offset[1]]};v.LGraphGroup=k.LGraphGroup=t;t.prototype._ctor=function(a){this.title=a||"Group";this.font_size=24;this.color=h.node_colors.pale_blue?
...
function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),c=0;c<a.length;++c){var d=a[c];d.getBounding(b);B(this._bounding,b)&&this._nodes.push(d)}};t.prototype.isPointInside=l.prototype.isPointInside;t.prototype.setDirtyCanvas=l.prototype.setDirtyCanvas;k.DragAndScale=w;w.prototype.bindEvents=function(a){this.last_mouse=new Float32Array(2);this._binded_mouse_callback=this.onMouse.bind(this);a.addEventListener("mousedown",this._binded_mouse_callback);a.addEventListener("mousemove",
...
d&&!this.read_only&&this.allow_searchbox&&this.showSearchBox(a);g=!0}!e&&g&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&(this.read_only||this.processContextMenu(f,a));this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=k.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&a.preventDefault();
...
d>=this.viewport[1]&&d<this.viewport[1]+this.viewport[3])return c=this.ds.scale,0<b?c*=1.1:0>b&&(c*=1/1.1),this.ds.changeScale(c,[a.localX,a.localY]),this.graph.change(),a.preventDefault(),!1}};h.prototype.isOverNodeBox=function(a,b,c){var d=k.NODE_TITLE_HEIGHT;return C(b,c,a.pos[0]+2,a.pos[1]+2-d,d-4,d-4)?!0:!1};h.prototype.isOverNodeInput=function(a,b,c,d){if(a.inputs)for(var e=0,f=a.inputs.length;e<f;++e){var g=a.getConnectionPos(!0,e);if(a.horizontal?C(b,c,g[0]-5,g[1]-10,10,20):C(b,c,g[0]-10,
g[1]-5,40,10))return d&&(d[0]=g[0],d[1]=g[1]),e}return-1};h.prototype.processKey=function(a){if(this.graph){var b=!1;if("input"!=a.target.localName){if("keydown"==a.type){if(32==a.keyCode&&(b=this.dragging_canvas=!0),65==a.keyCode&&a.ctrlKey&&(this.selectNodes(),b=!0),"KeyC"==a.code&&(a.metaKey||a.ctrlKey)&&!a.shiftKey&&this.selected_nodes&&(this.copyToClipboard(),b=!0),"KeyV"!=a.code||!a.metaKey&&!a.ctrlKey||a.shiftKey||this.pasteFromClipboard(),46!=a.keyCode&&8!=a.keyCode||"input"==a.target.localName||
...
1),this.graph._nodes.unshift(a))};var L=new Float32Array(4);h.prototype.computeVisibleNodes=function(a,b){b=b||[];b.length=0;a=a||this.graph._nodes;for(var c=0,d=a.length;c<d;++c){var e=a[c];(!this.live_mode||e.onDrawBackground||e.onDrawForeground)&&B(this.visible_area,e.getBounding(L))&&b.push(e)}return b};h.prototype.draw=function(a,b){if(this.canvas&&0!=this.canvas.width&&0!=this.canvas.height){var c=k.getTime();this.render_time=.001*(c-this.last_draw_time);this.last_draw_time=c;this.graph&&this.ds.computeVisibleArea(this.viewport);
...
function(a){var b=this.graph,c=b._subgraph_node;c?(this.drawSubgraphPanelLeft(b,c,a),this.drawSubgraphPanelRight(b,c,a)):console.warn("subgraph without subnode")};h.prototype.drawSubgraphPanelLeft=function(a,b,c){var d=b.inputs?b.inputs.length:0,e=Math.floor(1.6*k.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(10,10,200,(d+1)*e+50,[8]);c.fill();c.globalAlpha=1;c.fillStyle="#888";c.font="14px Arial";c.textAlign="left";c.fillText("Graph Inputs",20,34);if(this.drawButton(180,
20,20,20,"X","#151515"))this.closeSubgraph();else{d=50;c.font="14px Arial";if(b.inputs)for(var f=0;f<b.inputs.length;++f){var g=b.inputs[f];if(!g.not_subgraph_input){if(this.drawButton(20,d+2,180,e-2)){var n=b.constructor.input_node_type||"graph/input";this.graph.beforeChange();var r=k.createNode(n);r?(a.add(r),this.block_click=!1,this.last_click_position=null,this.selectNodes([r]),this.node_dragged=r,this.dragging_canvas=!1,r.setProperty("name",g.name),r.setProperty("type",g.type),this.node_dragged.pos[0]=
this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",n)}c.fillStyle="#9C9";c.beginPath();c.arc(184,d+.5*e,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(g.name,30,d+.75*e);c.fillStyle="#777";c.fillText(g.type,130,d+.75*e);d+=e}}this.drawButton(20,d+2,180,e-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialog(b)}};h.prototype.drawSubgraphPanelRight=function(a,b,c){var d=b.outputs?b.outputs.length:0,e=
this.bgcanvas.width,f=Math.floor(1.6*k.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(e-200-10,10,200,(d+1)*f+50,[8]);c.fill();c.globalAlpha=1;c.fillStyle="#888";c.font="14px Arial";c.textAlign="left";d=c.measureText("Graph Outputs").width;c.fillText("Graph Outputs",e-d-20,34);if(this.drawButton(e-200,20,20,20,"X","#151515"))this.closeSubgraph();else{d=50;c.font="14px Arial";if(b.outputs)for(var g=0;g<b.outputs.length;++g){var n=b.outputs[g];if(!n.not_subgraph_input){if(this.drawButton(e-
200,d+2,180,f-2)){var r=b.constructor.output_node_type||"graph/output";this.graph.beforeChange();var h=k.createNode(r);h?(a.add(h),this.block_click=!1,this.last_click_position=null,this.selectNodes([h]),this.node_dragged=h,this.dragging_canvas=!1,h.setProperty("name",n.name),h.setProperty("type",n.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",r)}c.fillStyle="#9C9";c.beginPath();
c.arc(e-200+16,d+.5*f,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(n.name,e-200+30,d+.75*f);c.fillStyle="#777";c.fillText(n.type,e-200+130,d+.75*f);d+=f}}this.drawButton(e-200,d+2,180,f-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialogRight(b)}};h.prototype.drawButton=function(a,b,c,d,e,f,g,n){var r=this.ctx;f=f||k.NODE_DEFAULT_COLOR;g=g||"#555";n=n||k.NODE_TEXT_COLOR;var h=this.mouse,u=k.isInsideRectangle(h[0],h[1],a,b,c,d);h=(h=this.last_click_position)&&k.isInsideRectangle(h[0],
h[1],a,b,c,d);r.fillStyle=u?g:f;h&&(r.fillStyle="#AAA");r.beginPath();r.roundRect(a,b,c,d,[4]);r.fill();null!=e&&e.constructor==String&&(r.fillStyle=n,r.textAlign="center",r.font=(.65*d|0)+"px Arial",r.fillText(e,a+.5*c,b+.75*d),r.textAlign="left");a=h&&!this.block_click;h&&this.blockClick();return a};h.prototype.isAreaClicked=function(a,b,c,d,e){var f=this.mouse;k.isInsideRectangle(f[0],f[1],a,b,c,d);b=(a=(f=this.last_click_position)&&k.isInsideRectangle(f[0],f[1],a,b,c,d))&&!this.block_click;a&&
e&&this.blockClick();return b};h.prototype.renderInfo=function(a,b,c){b=b||10;c=c||this.canvas.height-80;a.save();a.translate(b,c);a.font="10px Arial";a.fillStyle="#888";a.textAlign="left";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,5,26),a.fillText("N: "+this.graph._nodes.length+" ["+this.visible_nodes.length+"]",5,39),a.fillText("V: "+this.graph._version,5,52),a.fillText("FPS:"+this.fps.toFixed(2),5,65)):a.fillText("No graph selected",
...
k.NODE_DEFAULT_COLOR,d=a.bgcolor||a.constructor.bgcolor||k.NODE_DEFAULT_BGCOLOR,e=.6>this.ds.scale;if(this.live_mode){if(!a.flags.collapsed&&(b.shadowColor="transparent",a.onDrawForeground))a.onDrawForeground(b,this,this.canvas)}else{var f=this.editor_alpha;b.globalAlpha=f;this.render_shadows&&!e?(b.shadowColor=k.DEFAULT_SHADOW_COLOR,b.shadowOffsetX=2*this.ds.scale,b.shadowOffsetY=2*this.ds.scale,b.shadowBlur=3*this.ds.scale):b.shadowColor="transparent";if(!a.flags.collapsed||!a.onDrawCollapsed||
1!=a.onDrawCollapsed(b,this)){var g=a._shape||k.BOX_SHAPE;G.set(a.size);var n=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var r=a.getTitle?a.getTitle():a.title;null!=r&&(a._collapsed_width=Math.min(a.size[0],b.measureText(r).width+2*k.NODE_TITLE_HEIGHT),G[0]=a._collapsed_width,G[1]=0)}a.clip_area&&(b.save(),b.beginPath(),g==k.BOX_SHAPE?b.rect(0,0,G[0],G[1]):g==k.ROUND_SHAPE?b.roundRect(0,0,G[0],G[1],[10]):g==k.CIRCLE_SHAPE&&b.arc(.5*G[0],.5*G[1],.5*G[0],0,2*Math.PI),b.clip());a.has_errors&&
(d="red");this.drawNodeShape(a,b,G,c,d,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=n?"center":"left";b.font=this.inner_text_font;d=!e;g=this.connecting_output;b.lineWidth=1;r=0;var h=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(c=0;c<a.inputs.length;c++){var u=a.inputs[c];b.globalAlpha=f;this.connecting_node&&!k.isValidConnection(u.type,g.type)&&(b.globalAlpha=.4*f);b.fillStyle=null!=u.link?u.color_on||
this.default_connection_color.input_on:u.color_off||this.default_connection_color.input_off;var p=a.getConnectionPos(!0,c,h);p[0]-=a.pos[0];p[1]-=a.pos[1];r<p[1]+.5*k.NODE_SLOT_HEIGHT&&(r=p[1]+.5*k.NODE_SLOT_HEIGHT);b.beginPath();u.type===k.EVENT||u.shape===k.BOX_SHAPE?n?b.rect(p[0]-5+.5,p[1]-8+.5,10,14):b.rect(p[0]-6+.5,p[1]-5+.5,14,10):u.shape===k.ARROW_SHAPE?(b.moveTo(p[0]+8,p[1]+.5),b.lineTo(p[0]-4,p[1]+6+.5),b.lineTo(p[0]-4,p[1]-6+.5),b.closePath()):e?b.rect(p[0]-4,p[1]-4,8,8):b.arc(p[0],p[1],
4,0,2*Math.PI);b.fill();if(d){var z=null!=u.label?u.label:u.name;z&&(b.fillStyle=k.NODE_TEXT_COLOR,n||u.dir==k.UP?b.fillText(z,p[0],p[1]-10):b.fillText(z,p[0]+10,p[1]+5))}}this.connecting_node&&(b.globalAlpha=.4*f);b.textAlign=n?"center":"right";b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(u=a.outputs[c],p=a.getConnectionPos(!1,c,h),p[0]-=a.pos[0],p[1]-=a.pos[1],r<p[1]+.5*k.NODE_SLOT_HEIGHT&&(r=p[1]+.5*k.NODE_SLOT_HEIGHT),b.fillStyle=u.links&&u.links.length?u.color_on||this.default_connection_color.output_on:
u.color_off||this.default_connection_color.output_off,b.beginPath(),u.type===k.EVENT||u.shape===k.BOX_SHAPE?n?b.rect(p[0]-5+.5,p[1]-8+.5,10,14):b.rect(p[0]-6+.5,p[1]-5+.5,14,10):u.shape===k.ARROW_SHAPE?(b.moveTo(p[0]+8,p[1]+.5),b.lineTo(p[0]-4,p[1]+6+.5),b.lineTo(p[0]-4,p[1]-6+.5),b.closePath()):e?b.rect(p[0]-4,p[1]-4,8,8):b.arc(p[0],p[1],4,0,2*Math.PI),b.fill(),e||b.stroke(),d&&(z=null!=u.label?u.label:u.name))b.fillStyle=k.NODE_TEXT_COLOR,n||u.dir==k.DOWN?b.fillText(z,p[0],p[1]-8):b.fillText(z,
p[0]-10,p[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){u=r;if(n||a.widgets_up)u=2;null!=a.widgets_start_y&&(u=a.widgets_start_y);this.drawNodeWidgets(a,u,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){e=f=null;if(a.inputs)for(c=0;c<a.inputs.length;c++)if(u=a.inputs[c],null!=u.link){f=u;break}if(a.outputs)for(c=0;c<a.outputs.length;c++)u=a.outputs[c],u.links&&u.links.length&&(e=u);f&&(f=0,c=-.5*k.NODE_TITLE_HEIGHT,n&&(f=.5*a._collapsed_width,
c=-k.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),u.type===k.EVENT||u.shape===k.BOX_SHAPE?b.rect(f-7+.5,c-4,14,8):u.shape===k.ARROW_SHAPE?(b.moveTo(f+8,c),b.lineTo(f+-4,c-4),b.lineTo(f+-4,c+4),b.closePath()):b.arc(f,c,4,0,2*Math.PI),b.fill());e&&(f=a._collapsed_width,c=-.5*k.NODE_TITLE_HEIGHT,n&&(f=.5*a._collapsed_width,c=0),b.fillStyle="#686",b.strokeStyle="black",b.beginPath(),u.type===k.EVENT||u.shape===k.BOX_SHAPE?b.rect(f-7+.5,c-4,14,8):u.shape===k.ARROW_SHAPE?(b.moveTo(f+6,c),b.lineTo(f-
...
d;b.fillStyle=e;e=k.NODE_TITLE_HEIGHT;var n=.5>this.ds.scale,r=a._shape||a.constructor.shape||k.ROUND_SHAPE,l=a.constructor.title_mode,u=!0;l==k.TRANSPARENT_TITLE?u=!1:l==k.AUTOHIDE_TITLE&&g&&(u=!0);A[0]=0;A[1]=u?-e:0;A[2]=c[0]+1;A[3]=u?c[1]+e:c[1];g=b.globalAlpha;b.beginPath();r==k.BOX_SHAPE||n?b.fillRect(A[0],A[1],A[2],A[3]):r==k.ROUND_SHAPE||r==k.CARD_SHAPE?b.roundRect(A[0],A[1],A[2],A[3],r==k.CARD_SHAPE?[this.round_radius,this.round_radius,0,0]:[this.round_radius]):r==k.CIRCLE_SHAPE&&b.arc(.5*
c[0],.5*c[1],.5*c[0],0,2*Math.PI);b.fill();!a.flags.collapsed&&u&&(b.shadowColor="transparent",b.fillStyle="rgba(0,0,0,0.2)",b.fillRect(0,-1,A[2],2));b.shadowColor="transparent";if(a.onDrawBackground)a.onDrawBackground(b,this,this.canvas,this.graph_mouse);if(u||l==k.TRANSPARENT_TITLE){if(a.onDrawTitleBar)a.onDrawTitleBar(b,e,c,this.ds.scale,d);else if(l!=k.TRANSPARENT_TITLE&&(a.constructor.title_color||this.render_title_colored)){u=a.constructor.title_color||d;a.flags.collapsed&&(b.shadowColor=k.DEFAULT_SHADOW_COLOR);
if(this.use_gradients){var p=h.gradients[u];p||(p=h.gradients[u]=b.createLinearGradient(0,0,400,0),p.addColorStop(0,u),p.addColorStop(1,"#000"));b.fillStyle=p}else b.fillStyle=u;b.beginPath();r==k.BOX_SHAPE||n?b.rect(0,-e,c[0]+1,e):(r==k.ROUND_SHAPE||r==k.CARD_SHAPE)&&b.roundRect(0,-e,c[0]+1,e,a.flags.collapsed?[this.round_radius]:[this.round_radius,this.round_radius,0,0]);b.fill();b.shadowColor="transparent"}if(a.onDrawTitleBox)a.onDrawTitleBox(b,e,c,this.ds.scale);else r==k.ROUND_SHAPE||r==k.CIRCLE_SHAPE||
r==k.CARD_SHAPE?(n&&(b.fillStyle="black",b.beginPath(),b.arc(.5*e,-.5*e,6,0,2*Math.PI),b.fill()),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,n?b.fillRect(.5*e-5,-.5*e-5,10,10):(b.beginPath(),b.arc(.5*e,-.5*e,5,0,2*Math.PI),b.fill())):(n&&(b.fillStyle="black",b.fillRect(.5*(e-10)-1,-.5*(e+10)-1,12,12)),b.fillStyle=a.boxcolor||k.NODE_DEFAULT_BOXCOLOR,b.fillRect(.5*(e-10),-.5*(e+10),10,10));b.globalAlpha=g;if(a.onDrawTitleText)a.onDrawTitleText(b,e,c,this.ds.scale,this.title_text_font,f);!n&&(b.font=
this.title_text_font,g=String(a.getTitle()))&&(b.fillStyle=f?k.NODE_SELECTED_TITLE_COLOR:a.constructor.title_text_color||this.node_title_color,a.flags.collapsed?(b.textAlign="left",b.measureText(g),b.fillText(g.substr(0,20),e,k.NODE_TITLE_TEXT_Y-e),b.textAlign="left"):(b.textAlign="left",b.fillText(g,e,k.NODE_TITLE_TEXT_Y-e)));a.flags.collapsed||!a.subgraph||a.skip_subgraph_button||(g=k.NODE_TITLE_HEIGHT,u=a.size[0]-g,p=k.isInsideRectangle(this.graph_mouse[0]-a.pos[0],this.graph_mouse[1]-a.pos[1],
u+2,-g+2,g-4,g-4),b.fillStyle=p?"#888":"#555",r==k.BOX_SHAPE||n?b.fillRect(u+2,-g+2,g-4,g-4):(b.beginPath(),b.roundRect(u+2,-g+2,g-4,g-4,[4]),b.fill()),b.fillStyle="#333",b.beginPath(),b.moveTo(u+.2*g,.6*-g),b.lineTo(u+.8*g,.6*-g),b.lineTo(u+.5*g,.3*-g),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(f){if(a.onBounding)a.onBounding(A);l==k.TRANSPARENT_TITLE&&(A[1]-=e,A[3]+=e);b.lineWidth=1;b.globalAlpha=.8;b.beginPath();r==k.BOX_SHAPE?b.rect(-6+A[0],-6+A[1],12+A[2],12+A[3]):r==k.ROUND_SHAPE||r==k.CARD_SHAPE&&
a.flags.collapsed?b.roundRect(-6+A[0],-6+A[1],12+A[2],12+A[3],[2*this.round_radius]):r==k.CARD_SHAPE?b.roundRect(-6+A[0],-6+A[1],12+A[2],12+A[3],[2*this.round_radius,2,2*this.round_radius,2]):r==k.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0]+6,0,2*Math.PI);b.strokeStyle=k.NODE_BOX_OUTLINE_COLOR;b.stroke();b.strokeStyle=d;b.globalAlpha=1}};var J=new Float32Array(4),D=new Float32Array(4),H=new Float32Array(2),F=new Float32Array(2);h.prototype.drawConnections=function(a){var b=k.getTime(),c=this.visible_area;
J[0]=c[0]-20;J[1]=c[1]-20;J[2]=c[2]+40;J[3]=c[3]+40;a.lineWidth=this.connections_width;a.fillStyle="#AAA";a.strokeStyle="#AAA";a.globalAlpha=this.editor_alpha;c=this.graph._nodes;for(var d=0,e=c.length;d<e;++d){var f=c[d];if(f.inputs&&f.inputs.length)for(var g=0;g<f.inputs.length;++g){var n=f.inputs[g];if(n&&null!=n.link&&(n=this.graph.links[n.link])){var r=this.graph.getNodeById(n.origin_id);if(null!=r){var h=n.origin_slot;var u=-1==h?[r.pos[0]+10,r.pos[1]+10]:r.getConnectionPos(!1,h,H);var p=f.getConnectionPos(!0,
g,F);D[0]=u[0];D[1]=u[1];D[2]=p[0]-u[0];D[3]=p[1]-u[1];0>D[2]&&(D[0]+=D[2],D[2]=Math.abs(D[2]));0>D[3]&&(D[1]+=D[3],D[3]=Math.abs(D[3]));if(B(D,J)){var z=r.outputs[h];h=f.inputs[g];if(z&&h&&(r=z.dir||(r.horizontal?k.DOWN:k.RIGHT),h=h.dir||(f.horizontal?k.UP:k.LEFT),this.renderLink(a,u,p,n,!1,0,null,r,h),n&&n._last_time&&1E3>b-n._last_time)){z=2-.002*(b-n._last_time);var l=a.globalAlpha;a.globalAlpha=l*z;this.renderLink(a,u,p,n,!0,z,"white",r,h);a.globalAlpha=l}}}}}}a.globalAlpha=1};h.prototype.renderLink=
function(a,b,c,d,e,f,g,n,r,l){d&&this.visible_links.push(d);!g&&d&&(g=d.color||h.link_type_colors[d.type]);g||(g=this.default_link_color);null!=d&&this.highlighted_links[d.id]&&(g="#FFF");n=n||k.RIGHT;r=r||k.LEFT;var u=E(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";l=l||1;1<l&&(a.lineWidth=.5);a.beginPath();for(var p=0;p<l;p+=1){var z=5*(p-.5*(l-1));if(this.links_render_mode==k.SPLINE_LINK){a.moveTo(b[0],b[1]+z);var y=0,t=0,m=0,K=
0;switch(n){case k.LEFT:y=-.25*u;break;case k.RIGHT:y=.25*u;break;case k.UP:t=-.25*u;break;case k.DOWN:t=.25*u}switch(r){case k.LEFT:m=-.25*u;break;case k.RIGHT:m=.25*u;break;case k.UP:K=-.25*u;break;case k.DOWN:K=.25*u}a.bezierCurveTo(b[0]+y,b[1]+t+z,c[0]+m,c[1]+K+z,c[0],c[1]+z)}else if(this.links_render_mode==k.LINEAR_LINK){a.moveTo(b[0],b[1]+z);K=m=t=y=0;switch(n){case k.LEFT:y=-1;break;case k.RIGHT:y=1;break;case k.UP:t=-1;break;case k.DOWN:t=1}switch(r){case k.LEFT:m=-1;break;case k.RIGHT:m=
1;break;case k.UP:K=-1;break;case k.DOWN:K=1}a.lineTo(b[0]+15*y,b[1]+15*t+z);a.lineTo(c[0]+15*m,c[1]+15*K+z);a.lineTo(c[0],c[1]+z)}else if(this.links_render_mode==k.STRAIGHT_LINK)a.moveTo(b[0],b[1]),z=b[0],y=b[1],t=c[0],m=c[1],n==k.RIGHT?z+=10:y+=10,r==k.LEFT?t-=10:m-=10,a.lineTo(z,y),a.lineTo(.5*(z+t),y),a.lineTo(.5*(z+t),m),a.lineTo(t,m),a.lineTo(c[0],c[1]);else return}this.render_connections_border&&.6<this.ds.scale&&!e&&(a.strokeStyle="rgba(0,0,0,0.5)",a.stroke());a.lineWidth=this.connections_width;
a.fillStyle=a.strokeStyle=g;a.stroke();e=this.computeConnectionPoint(b,c,.5,n,r);d&&d._pos&&(d._pos[0]=e[0],d._pos[1]=e[1]);.6<=this.ds.scale&&this.highquality_render&&r!=k.CENTER&&(this.render_connection_arrows&&(p=this.computeConnectionPoint(b,c,.25,n,r),u=this.computeConnectionPoint(b,c,.26,n,r),d=this.computeConnectionPoint(b,c,.75,n,r),l=this.computeConnectionPoint(b,c,.76,n,r),this.render_curved_connections?(u=-Math.atan2(u[0]-p[0],u[1]-p[1]),l=-Math.atan2(l[0]-d[0],l[1]-d[1])):l=u=c[1]>b[1]?
0:Math.PI,a.save(),a.translate(p[0],p[1]),a.rotate(u),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore(),a.save(),a.translate(d[0],d[1]),a.rotate(l),a.beginPath(),a.moveTo(-5,-3),a.lineTo(0,7),a.lineTo(5,-3),a.fill(),a.restore()),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill());if(f)for(a.fillStyle=g,p=0;5>p;++p)f=(.001*k.getTime()+.2*p)%1,e=this.computeConnectionPoint(b,c,f,n,r),a.beginPath(),a.arc(e[0],e[1],5,0,2*Math.PI),a.fill()};h.prototype.computeConnectionPoint=
...
"transparent";a.globalAlpha=.25;a.textAlign="center";a.strokeStyle="white";a.globalAlpha=.75;for(var b=this.visible_nodes,c=0;c<b.length;++c){var d=b[c];a.fillStyle="black";a.fillRect(d.pos[0]-k.NODE_TITLE_HEIGHT,d.pos[1]-k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT);0==d.order&&a.strokeRect(d.pos[0]-k.NODE_TITLE_HEIGHT+.5,d.pos[1]-k.NODE_TITLE_HEIGHT+.5,k.NODE_TITLE_HEIGHT,k.NODE_TITLE_HEIGHT);a.fillStyle="#FFF";a.fillText(d.order,d.pos[0]+-.5*k.NODE_TITLE_HEIGHT,d.pos[1]-6)}a.globalAlpha=
1};h.prototype.drawNodeWidgets=function(a,b,c,d){if(!a.widgets||!a.widgets.length)return 0;var e=a.size[0],f=a.widgets;b+=2;var g=k.NODE_WIDGET_HEIGHT,n=.5<this.ds.scale;c.save();c.globalAlpha=this.editor_alpha;for(var r=k.WIDGET_OUTLINE_COLOR,h=k.WIDGET_BGCOLOR,l=k.WIDGET_TEXT_COLOR,p=k.WIDGET_SECONDARY_TEXT_COLOR,z=0;z<f.length;++z){var y=f[z],t=b;y.y&&(t=y.y);y.last_y=t;c.strokeStyle=r;c.fillStyle="#222";c.textAlign="left";y.disabled&&(c.globalAlpha*=.5);var m=y.width||e;switch(y.type){case "button":y.clicked&&
(c.fillStyle="#AAA",y.clicked=!1,this.dirty_canvas=!0);c.fillRect(15,t,m-30,g);n&&!y.disabled&&c.strokeRect(15,t,m-30,g);n&&(c.textAlign="center",c.fillStyle=l,c.fillText(y.name,.5*m,t+.7*g));break;case "toggle":c.textAlign="left";c.strokeStyle=r;c.fillStyle=h;c.beginPath();n?c.roundRect(15,b,m-30,g,[.5*g]):c.rect(15,b,m-30,g);c.fill();n&&!y.disabled&&c.stroke();c.fillStyle=y.value?"#89A":"#333";c.beginPath();c.arc(m-30,t+.5*g,.36*g,0,2*Math.PI);c.fill();n&&(c.fillStyle=p,null!=y.name&&c.fillText(y.name,
30,t+.7*g),c.fillStyle=y.value?l:p,c.textAlign="right",c.fillText(y.value?y.options.on||"true":y.options.off||"false",m-40,t+.7*g));break;case "slider":c.fillStyle=h;c.fillRect(15,t,m-30,g);var q=y.options.max-y.options.min,w=(y.value-y.options.min)/q;c.fillStyle=d==y?"#89A":"#678";c.fillRect(15,t,w*(m-30),g);n&&!y.disabled&&c.strokeRect(15,t,m-30,g);y.marker&&(q=(y.marker-y.options.min)/q,c.fillStyle="#AA9",c.fillRect(15+q*(m-30),t,2,g));n&&(c.textAlign="center",c.fillStyle=l,c.fillText(y.name+"  "+
Number(y.value).toFixed(3),.5*m,t+.7*g));break;case "number":case "combo":c.textAlign="left";c.strokeStyle=r;c.fillStyle=h;c.beginPath();n?c.roundRect(15,b,m-30,g,[.5*g]):c.rect(15,b,m-30,g);c.fill();n&&(y.disabled||c.stroke(),c.fillStyle=l,y.disabled||(c.beginPath(),c.moveTo(31,b+5),c.lineTo(21,b+.5*g),c.lineTo(31,b+g-5),c.fill(),c.beginPath(),c.moveTo(m-15-16,b+5),c.lineTo(m-15-6,b+.5*g),c.lineTo(m-15-16,b+g-5),c.fill()),c.fillStyle=p,c.fillText(y.name,35,t+.7*g),c.fillStyle=l,c.textAlign="right",
"number"==y.type?c.fillText(Number(y.value).toFixed(void 0!==y.options.precision?y.options.precision:3),m-30-20,t+.7*g):(q=y.value,y.options.values&&(w=y.options.values,w.constructor===Function&&(w=w()),w&&w.constructor!==Array&&(q=w[y.value])),c.fillText(q,m-30-20,t+.7*g)));break;case "string":case "text":c.textAlign="left";c.strokeStyle=r;c.fillStyle=h;c.beginPath();n?c.roundRect(15,b,m-30,g,[.5*g]):c.rect(15,b,m-30,g);c.fill();n&&(y.disabled||c.stroke(),c.save(),c.beginPath(),c.rect(15,b,m-30,
g),c.clip(),c.fillStyle=p,null!=y.name&&c.fillText(y.name,30,t+.7*g),c.fillStyle=l,c.textAlign="right",c.fillText(String(y.value).substr(0,30),m-30,t+.7*g),c.restore());break;default:y.draw&&y.draw(c,a,m,t,g)}b+=(y.computeSize?y.computeSize(m)[1]:g)+4;c.globalAlpha=this.editor_alpha}c.restore();c.textAlign="left"};h.prototype.processNodeWidgets=function(a,b,c,d){function e(d,e){d.value=e;d.options&&d.options.property&&void 0!==a.properties[d.options.property]&&a.setProperty(d.options.property,e);
d.callback&&d.callback(d.value,r,a,b,c)}if(!a.widgets||!a.widgets.length)return null;for(var f=b[0]-a.pos[0],g=b[1]-a.pos[1],n=a.size[0],r=this,h=this.getCanvasWindow(),l=0;l<a.widgets.length;++l){var p=a.widgets[l];if(p&&!p.disabled){var z=p.computeSize?p.computeSize(n)[1]:k.NODE_WIDGET_HEIGHT,t=p.width||n;if(p==d||!(6>f||f>t-12||g<p.last_y||g>p.last_y+z||void 0===p.last_y)){d=p.value;switch(p.type){case "button":"mousedown"===c.type&&(p.callback&&setTimeout(function(){p.callback(p,r,a,b,c)},20),
this.dirty_canvas=p.clicked=!0);break;case "slider":h=Math.clamp((f-15)/(t-30),0,1);p.value=p.options.min+(p.options.max-p.options.min)*h;p.callback&&setTimeout(function(){e(p,p.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":d=p.value;if("mousemove"==c.type&&"number"==p.type)p.value+=.1*c.deltaX*(p.options.step||1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if("mousedown"==c.type){var m=
p.options.values;m&&m.constructor===Function&&(m=p.options.values(p,a));var q=null;"number"!=p.type&&(q=m.constructor===Array?m:Object.keys(m));f=40>f?-1:f>t-40?1:0;if("number"==p.type)p.value+=.1*f*(p.options.step||1),null!=p.options.min&&p.value<p.options.min&&(p.value=p.options.min),null!=p.options.max&&p.value>p.options.max&&(p.value=p.options.max);else if(f)h=-1,this.last_mouseclick=0,h=m.constructor===Object?q.indexOf(String(p.value))+f:q.indexOf(p.value)+f,h>=q.length&&(h=q.length-1),0>h&&
(h=0),p.value=m.constructor===Array?m[h]:h;else{var w=m!=q?Object.values(m):m;new k.ContextMenu(w,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){m!=q&&(a=w.indexOf(a));this.value=a;e(this,a);r.dirty_canvas=!0;return!1}.bind(p)},h)}}else"mouseup"==c.type&&"number"==p.type&&(f=40>f?-1:f>t-40?1:0,200>c.click_time&&0==f&&this.prompt("Value",p.value,function(a){this.value=Number(a);e(this,this.value)}.bind(p),c));d!=p.value&&setTimeout(function(){e(this,this.value)}.bind(p),
20);this.dirty_canvas=!0;break;case "toggle":"mousedown"==c.type&&(p.value=!p.value,setTimeout(function(){e(p,p.value)},20));break;case "string":case "text":"mousedown"==c.type&&this.prompt("Value",p.value,function(a){this.value=a;e(this,a)}.bind(p),c,p.options?p.options.multiline:!1);break;default:p.mouse&&(this.dirty_canvas=p.mouse(c,[f,g],a))}if(d!=p.value){if(a.onWidgetChanged)a.onWidgetChanged(p.name,p.value,d,p);a.graph._version++}return p}}}return null};h.prototype.drawGroups=function(a,b){if(this.graph){a=
this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var d=a[c];if(B(this.visible_area,d._bounding)){b.fillStyle=d.color||"#335";b.strokeStyle=d.color||"#335";var e=d._pos,f=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,f[0],f[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+f[0],e[1]+f[1]);b.lineTo(e[0]+f[0]-10,e[1]+f[1]);b.lineTo(e[0]+f[0],e[1]+f[1]-10);b.fill();f=d.font_size||k.DEFAULT_GROUP_FONT_SIZE;
b.font=f+"px Arial";b.fillText(d.title,e[0]+4,e[1]+f)}}b.restore()}};h.prototype.adjustNodesSize=function(){for(var a=this.graph._nodes,b=0;b<a.length;++b)a[b].size=a[b].computeSize();this.setDirty(!0,!0)};h.prototype.resize=function(a,b){a||b||(b=this.canvas.parentNode,a=b.offsetWidth,b=b.offsetHeight);if(this.canvas.width!=a||this.canvas.height!=b)this.canvas.width=a,this.canvas.height=b,this.bgcanvas.width=this.canvas.width,this.bgcanvas.height=this.canvas.height,this.setDirty(!0,!0)};h.prototype.switchLiveMode=
...
"scale("+this.ds.scale+")");n.addEventListener("mouseleave",function(a){g||n.close()});f.prompt_box&&f.prompt_box.close();f.prompt_box=n;n.querySelector(".name").innerText=a;var k=n.querySelector(".value");k.value=b;k.addEventListener("keydown",function(a){g=!0;if(27==a.keyCode)n.close();else if(13==a.keyCode&&"textarea"!=a.target.localName)c&&c(this.value),n.close();else return;a.preventDefault();a.stopPropagation()});n.querySelector("button").addEventListener("click",function(a){c&&c(k.value);f.setDirty(!0);
n.close()});a=h.active_canvas.canvas;b=a.getBoundingClientRect();var l=e=-20;b&&(e-=b.left,l-=b.top);d?(n.style.left=d.clientX+e+"px",n.style.top=d.clientY+l+"px"):(n.style.left=.5*a.width+e+"px",n.style.top=.5*a.height+l+"px");a.parentNode.appendChild(n);setTimeout(function(){k.focus()},10);return n};h.search_limit=-1;h.prototype.showSearchBox=function(a){function b(b){if(b)if(e.onSearchBoxSelection)e.onSearchBoxSelection(b,a,f);else{var c=k.searchbox_extras[b.toLowerCase()];c&&(b=c.type);f.graph.beforeChange();
if(b=k.createNode(b))b.pos=f.convertEventToCanvasOffset(a),f.graph.add(b);if(c&&c.data){if(c.data.properties)for(var d in c.data.properties)b.addProperty(d,c.data.properties[d]);if(c.data.inputs)for(d in b.inputs=[],c.data.inputs)b.addOutput(c.data.inputs[d][0],c.data.inputs[d][1]);if(c.data.outputs)for(d in b.outputs=[],c.data.outputs)b.addOutput(c.data.outputs[d][0],c.data.outputs[d][1]);c.data.title&&(b.title=c.data.title);c.data.json&&b.configure(c.data.json);f.graph.afterChange()}}r.close()}
function c(a){var b=m;m&&m.classList.remove("selected");m?(m=a?m.nextSibling:m.previousSibling)||(m=b):m=a?t.childNodes[0]:t.childNodes[t.childNodes.length];m&&(m.classList.add("selected"),m.scrollIntoView({block:"end",behavior:"smooth"}))}function d(){function a(a,c){var d=document.createElement("div");p||(p=a);d.innerText=a;d.dataset.type=escape(a);d.className="litegraph lite-search-item";c&&(d.className+=" "+c);d.addEventListener("click",function(a){b(unescape(this.dataset.type))});t.appendChild(d)}
z=null;var c=q.value;p=null;t.innerHTML="";if(c)if(e.onSearchBox){var d=e.onSearchBox(t,c,f);if(d)for(var n=0;n<d.length;++n)a(d[n])}else{d=function(a){var b=k.registered_node_types[a];return r&&b.filter!=r?!1:-1!==a.toLowerCase().indexOf(c)};var g=0;c=c.toLowerCase();var r=f.filter||f.graph.filter;for(n in k.searchbox_extras){var l=k.searchbox_extras[n];if(-1!==l.desc.toLowerCase().indexOf(c)){var m=k.registered_node_types[l.type];if(!m||m.filter==r)if(a(l.desc,"searchbox_extra"),-1!==h.search_limit&&
g++>h.search_limit)break}}l=null;if(Array.prototype.filter)l=Object.keys(k.registered_node_types).filter(d);else for(n in l=[],k.registered_node_types)d(n)&&l.push(n);for(n=0;n<l.length&&!(a(l[n]),-1!==h.search_limit&&g++>h.search_limit);n++);}}var e=this,f=h.active_canvas,g=f.canvas,n=g.ownerDocument||document,r=document.createElement("div");r.className="litegraph litesearchbox graphdialog rounded";r.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/><div class='helper'></div>";
...
return}else{n="<select autofocus type='text' class='value'>";for(var k in f.values){var h=k;f.values.constructor===Array&&(h=f.values[k]);n+="<option value='"+h+"' "+(h==a.properties[b]?"selected":"")+">"+f.values[k]+"</option>"}n+="</select>"}var l=this.createDialog("<span class='name'>"+(f.label?f.label:b)+"</span>"+n+"<button>OK</button>",c);if("enum"!=g&&"combo"!=g||!f.values)if("boolean"==g)(p=l.querySelector("input"))&&p.addEventListener("click",function(a){e(!!p.checked)});else{if(p=l.querySelector("input"))p.addEventListener("blur",
function(a){this.focus()}),h=void 0!==a.properties[b]?a.properties[b]:"","string"!==g&&(h=JSON.stringify(h)),p.value=h,p.addEventListener("keydown",function(a){13==a.keyCode&&(d(),a.preventDefault(),a.stopPropagation())})}else{var p=l.querySelector("select");p.addEventListener("change",function(a){e(a.target.value)})}l.querySelector("button").addEventListener("click",d);return l}};h.prototype.createDialog=function(a,b){b=b||{};var c=document.createElement("div");c.className="graphdialog";c.innerHTML=
...
!0})}b.addSeparator();if(a.onShowCustomPanelInfo)a.onShowCustomPanelInfo(b);b.addButton("Delete",function(){a.block_delete||(a.graph.remove(a),b.close())}).classList.add("delete")})();this.canvas.parentNode.appendChild(b)};h.prototype.showSubgraphPropertiesDialog=function(a){function b(){d.clear();if(a.inputs)for(var c=0;c<a.inputs.length;++c){var f=a.inputs[c];if(!f.not_subgraph_input){var g=d.addHTML("<button>&#10005;</button> <span class='bullet_icon'></span><span class='name'></span><span class='type'></span>",
...
d,e){e.graph.beforeChange(e);e.collapse();e.graph.afterChange(e)};h.onMenuNodePin=function(a,b,c,d,e){e.pin()};h.onMenuNodeMode=function(a,b,c,d,e){new k.ContextMenu(["Always","On Event","On Trigger","Never"],{event:c,callback:function(a){if(e)switch(a){case "On Event":e.mode=k.ON_EVENT;break;case "On Trigger":e.mode=k.ON_TRIGGER;break;case "Never":e.mode=k.NEVER;break;default:e.mode=k.ALWAYS}},parentMenu:d,node:e});return!1};h.onMenuNodeColors=function(a,b,c,d,e){if(!e)throw"no node for color";b=
[];b.push({value:null,content:"<span style='display: block; padding-left: 4px;'>No color</span>"});for(var f in h.node_colors)a=h.node_colors[f],a={value:f,content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid "+a.color+"; background-color:"+a.bgcolor+"'>"+f+"</span>"},b.push(a);new k.ContextMenu(b,{event:c,callback:function(a){e&&((a=a.value?h.node_colors[a.value]:null)?e.constructor===k.LGraphGroup?e.color=a.groupcolor:(e.color=a.color,e.bgcolor=a.bgcolor):
(delete e.color,delete e.bgcolor),e.setDirtyCanvas(!0,!0))},parentMenu:d,node:e});return!1};h.onMenuNodeShapes=function(a,b,c,d,e){if(!e)throw"no node passed";new k.ContextMenu(k.VALID_SHAPES,{event:c,callback:function(a){e&&(e.graph.beforeChange(e),e.shape=a,e.graph.afterChange(e),e.setDirtyCanvas(!0))},parentMenu:d,node:e});return!1};h.onMenuNodeRemove=function(a,b,c,d,e){if(!e)throw"no node passed";!1!==e.removable&&(a=e.graph,a.beforeChange(),a.remove(e),a.afterChange(),e.setDirtyCanvas(!0,!0))};
...
a);return b};h.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:h.onShowPropertyEditor},{content:"Color",has_submenu:!0,callback:h.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:h.onShowPropertyEditor},null,{content:"Remove",callback:h.onMenuNodeRemove}]};h.prototype.processContextMenu=function(a,b){var c=this,d=h.active_canvas.getCanvasWindow(),e=null,f={event:b,callback:function(b,d,e){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?
...
e);c.autoopen&&g.addEventListener("mouseenter",d);return g};x.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!x.isCursorOverElement(a,this.parentMenu.root)&&x.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&clearTimeout(this.root.closing_timer)};x.trigger=
function(a,b,c,d){var e=document.createEvent("CustomEvent");e.initCustomEvent(b,!0,!0,c);e.srcElement=d;a.dispatchEvent?a.dispatchEvent(e):a.__events&&a.__events.dispatchEvent(e);return e};x.prototype.getTopMenu=function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};x.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};x.isCursorOverElement=function(a,b){var c=a.clientX;a=a.clientY;return(b=b.getBoundingClientRect())?
a>b.top&&a<b.top+b.height&&c>b.left&&c<b.left+b.width?!0:!1:!1};k.ContextMenu=x;k.closeAllContextMenus=function(a){a=a||window;a=a.document.querySelectorAll(".litecontextmenu");if(a.length){for(var b=[],c=0;c<a.length;c++)b.push(a[c]);for(c=0;c<b.length;c++)b[c].close?b[c].close():b[c].parentNode&&b[c].parentNode.removeChild(b[c])}};k.extendClass=function(a,b){for(var c in b)a.hasOwnProperty(c)||(a[c]=b[c]);if(b.prototype)for(c in b.prototype)b.prototype.hasOwnProperty(c)&&!a.prototype.hasOwnProperty(c)&&
...
"#AEA"}catch(K){this.boxcolor="red"}};I.prototype.onExecute=function(){var a=this.getInputData(0);if(a&&a.length){this._value||(this._value=[]);this._value.length=a.length;for(var b=0;b<a.length;++b)this._value[b]=a[b]}this.setOutputData(0,this._value);this.setOutputData(1,this._value?this._value.length||0:0)};I.prototype.setValue=w.prototype.setValue;g.registerNodeType("basic/array",I);k.title="Set Array";k.desc="Sets index of array";k.prototype.onExecute=function(){var a=this.getInputData(0);if(a){var b=
this.getInputData(1);void 0!==b&&(this.properties.index&&(a[Math.floor(this.properties.index)]=b),this.setOutputData(0,a))}};g.registerNodeType("basic/set_array",k);L.title="Array[i]";L.desc="Returns an element from an array";L.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1);null==b&&(b=this.properties.index);null!=a&&null!=b&&this.setOutputData(0,a[Math.floor(Number(b))])};g.registerNodeType("basic/array[]",L);G.title="Table[row][col]";G.desc="Returns an element from a table";
G.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1),c=this.getInputData(2);null==b&&(b=this.properties.row);null==c&&(c=this.properties.column);null!=a&&null!=b&&null!=c&&((b=a[Math.floor(Number(b))])?this.setOutputData(0,b[Math.floor(Number(c))]):this.setOutputData(0,null))};g.registerNodeType("basic/table[][]",G);A.title="Object property";A.desc="Outputs the property of an object";A.prototype.setValue=function(a){this.properties.value=a;this.widget.value=a};A.prototype.getTitle=
...
J);D.title="Set Object";D.desc="Adds propertiesrty to object";D.prototype.onExecute=function(){var a=this.getInputData(0);if(a){var b=this.getInputData(1);void 0!==b&&(this.properties.property&&(a[this.properties.property]=b),this.setOutputData(0,a))}};g.registerNodeType("basic/set_object",D);H.title="Merge Objects";H.desc="Creates an object copying properties from others";H.prototype.onExecute=function(){var a=this.getInputData(0),b=this.getInputData(1),c=this._result;if(a)for(var d in a)c[d]=a[d];
if(b)for(d in b)c[d]=b[d];this.setOutputData(0,c)};g.registerNodeType("basic/merge_objects",H);F.title="Variable";F.desc="store/read variable value";F.LITEGRAPH=0;F.GRAPH=1;F.GLOBALSCOPE=2;F["@container"]={type:"enum",values:{litegraph:F.LITEGRAPH,graph:F.GRAPH,global:F.GLOBALSCOPE}};F.prototype.onExecute=function(){var a=this.getContainer();this.isInputConnected(0)?(this.value=this.getInputData(0),a[this.properties.varname]=this.value,this.setOutputData(0,this.value)):this.setOutputData(0,a[this.properties.varname])};
F.prototype.getContainer=function(){switch(this.properties.container){case F.GRAPH:return this.graph?this.graph.vars:{};case F.GLOBALSCOPE:return v;default:return g.Globals}};F.prototype.getTitle=function(){return this.properties.varname};g.registerNodeType("basic/variable",F);g.wrapFunctionAsNode("basic/length",function(a){return a&&null!=a.length?Number(a.length):0},[""],"number");a.title="Download";a.desc="Download some data";a.prototype.downloadAsFile=function(){if(null!=this.value){var a=null;
...
(function(v){function m(){this.size=[60,30];this.addInput("event",x.ACTION)}function q(){this.size=[60,30];this.addInput("if","");this.addOutput("true",x.EVENT);this.addOutput("change",x.EVENT);this.addOutput("false",x.EVENT);this.properties={only_on_change:!0};this.prev=0}function l(){this.addInput("",x.ACTION);this.addInput("",x.ACTION);this.addInput("",x.ACTION);this.addInput("",x.ACTION);this.addInput("",x.ACTION);this.addInput("",x.ACTION);this.addOutput("",x.EVENT);this.addOutput("",x.EVENT);
...
"");this.addInput("assign",x.ACTION);this.addOutput("data","");this._last_value=null;this.properties={data:null,serialize:!0};var h=this;this.addWidget("button","store","",function(){h.properties.data=h._last_value})}var x=v.LiteGraph;m.title="Log Event";m.desc="Log event in console";m.prototype.onAction=function(h,k){console.log(h,k)};x.registerNodeType("events/log",m);q.title="TriggerEvent";q.desc="Triggers event if input evaluates to true";q.prototype.onExecute=function(h,k){h=this.getInputData(0);
var l=h!=this.prev;0===this.prev&&(l=!1);var m=l&&this.properties.only_on_change||!l&&!this.properties.only_on_change;h&&m&&this.triggerSlot(0,k);!h&&m&&this.triggerSlot(2,k);l&&this.triggerSlot(1,k);this.prev=h};x.registerNodeType("events/trigger",q);l.title="Sequencer";l.desc="Trigger events when an event arrives";l.prototype.getTitle=function(){return""};l.prototype.onAction=function(h,k){if(this.outputs)for(h=0;h<this.outputs.length;++h)this.triggerSlot(h,k)};x.registerNodeType("events/sequencer",
l);t.title="Filter Event";t.desc="Blocks events that do not match the filter";t.prototype.onAction=function(h,k){if(null!=k&&(!this.properties.equal_to||this.properties.equal_to==k)){if(this.properties.has_property&&(h=k[this.properties.has_property],null==h||this.properties.property_equal_to&&this.properties.property_equal_to!=h))return;this.triggerSlot(0,k)}};x.registerNodeType("events/filter",t);w.title="Branch";w.desc="If condition is true, outputs triggers true, otherwise false";w.prototype.onExecute=
function(){this._value=this.getInputData(1)};w.prototype.onAction=function(h,k){this.triggerSlot(this._value?0:1)};x.registerNodeType("events/branch",w);h.title="Counter";h.desc="Counts events";h.prototype.getTitle=function(){return this.flags.collapsed?String(this.num):this.title};h.prototype.onAction=function(h,k){k=this.num;"inc"==h?this.num+=1:"dec"==h?--this.num:"reset"==h&&(this.num=0);this.num!=k&&this.trigger("change",this.num)};h.prototype.onDrawBackground=function(h){this.flags.collapsed||
(h.fillStyle="#AAA",h.font="20px Arial",h.textAlign="center",h.fillText(this.num,.5*this.size[0],.5*this.size[1]))};h.prototype.onExecute=function(){this.setOutputData(1,this.num)};x.registerNodeType("events/counter",h);E.title="Delay";E.desc="Delays one event";E.prototype.onAction=function(h,k){h=this.properties.time_in_ms;0>=h?this.trigger(null,k):this._pending.push([h,k])};E.prototype.onExecute=function(){var h=1E3*this.graph.elapsed_time;this.isInputConnected(1)&&(this.properties.time_in_ms=this.getInputData(1));
for(var k=0;k<this._pending.length;++k){var l=this._pending[k];l[0]-=h;0<l[0]||(this._pending.splice(k,1),--k,this.trigger(null,l[1]))}};E.prototype.onGetInputs=function(){return[["event",x.ACTION],["time_in_ms","number"]]};x.registerNodeType("events/delay",E);C.title="Timer";C.desc="Sends an event every N milliseconds";C.prototype.onStart=function(){this.time=0};C.prototype.getTitle=function(){return"Timer: "+this.last_interval.toString()+"ms"};C.on_color="#AAA";C.off_color="#222";C.prototype.onDrawBackground=
...
0,this._triggers[1]=Math.abs(l.xbox.axes.rtrigger)>t?l.xbox.axes.rtrigger:0);if(this.outputs)for(t=0;t<this.outputs.length;t++){var q=this.outputs[t];if(q.links&&q.links.length){var h=null;if(l)switch(q.name){case "left_axis":h=this._left_axis;break;case "right_axis":h=this._right_axis;break;case "left_x_axis":h=this._left_axis[0];break;case "left_y_axis":h=this._left_axis[1];break;case "right_x_axis":h=this._right_axis[0];break;case "right_y_axis":h=this._right_axis[1];break;case "trigger_left":h=
...
default:h=0}this.setOutputData(t,h)}}};m.mapping={a:0,b:1,x:2,y:3,lb:4,rb:5,lt:6,rt:7,back:8,start:9,ls:10,rs:11};m.mapping_array="a b x y lb rb lt rt back start ls rs".split(" ");m.prototype.getGamepad=function(){var l=navigator.getGamepads||navigator.webkitGetGamepads||navigator.mozGetGamepads;if(!l)return null;l=l.call(navigator);this._previous_buttons.set(this._current_buttons);for(var t=this.properties.gamepad_index;4>t;t++)if(l[t]){l=l[t];t=this.xbox_mapping;t||(t=this.xbox_mapping={axes:[],
...
"number");this.addOutput("out","number");this.size=[80,30]}function k(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,30]}function L(){this.addInput("in","number");this.addOutput("out","number");this.size=[80,30];this.properties={A:0,B:1}}function G(){this.addInput("in","number",{label:""});this.addOutput("out","number",{label:""});this.size=[80,30];this.addProperty("factor",1)}function A(){this.addInput("v","boolean");this.addInput("A");this.addInput("B");this.addOutput("out")}
...
this.getInputData(0);null!=a&&this.setOutputData(0,Math.floor(a))};p.registerNodeType("math/floor",I);k.title="Frac";k.desc="Returns fractional part";k.prototype.onExecute=function(){var a=this.getInputData(0);null!=a&&this.setOutputData(0,a%1)};p.registerNodeType("math/frac",k);L.title="Smoothstep";L.desc="Smoothstep";L.prototype.onExecute=function(){var a=this.getInputData(0);if(void 0!==a){var b=this.properties.A;a=Math.clamp((a-b)/(this.properties.B-b),0,1);this.setOutputData(0,a*a*(3-2*a))}};
...
l&&this.connectSocket()};m.prototype.onExecute=function(){!this._ws&&this.properties.url&&this.connectSocket();if(this._ws&&this._ws.readyState==WebSocket.OPEN){for(var l=this.properties.room,m=this.properties.only_send_changes,h=1;h<this.inputs.length;++h){var q=this.getInputData(h);if(null!=q){try{var v=JSON.stringify({type:0,room:l,channel:h,data:q})}catch(B){continue}m&&this._last_sent_data[h]==v||(this._last_sent_data[h]=v,this._ws.send(v))}}for(h=1;h<this.outputs.length;++h)this.setOutputData(h,
this._last_received_data[h]);"#AFA"==this.boxcolor&&(this.boxcolor="#6C6")}};m.prototype.connectSocket=function(){var m=this,q=this.properties.url;"ws"!=q.substr(0,2)&&(q="ws://"+q);this._ws=new WebSocket(q);this._ws.onopen=function(){console.log("ready");m.boxcolor="#6C6"};this._ws.onmessage=function(h){m.boxcolor="#AFA";h=JSON.parse(h.data);if(!h.room||h.room==m.properties.room)if(1==h.type)if(h.data.object_class&&l[h.data.object_class]){var t=null;try{t=new l[h.data.object_class](h.data),m.triggerSlot(0,
...
1;l<this.inputs.length;++l){var m=this.inputs[l];m.label="in_"+l}for(l=1;l<this.outputs.length;++l)m=this.outputs[l],m.label="out_"+l};q.prototype.onExecute=function(){if(this._server&&this._server.is_connected){for(var l=this.properties.only_send_changes,m=1;m<this.inputs.length;++m){var h=this.getInputData(m),q=this._last_sent_data[m];if(null!=h){if(l){var v=!0;if(h&&h.length&&q&&q.length==h.length&&h.constructor!==String)for(var B=0;B<h.length;++B){if(q[B]!=h[B]){v=!1;break}}else this._last_sent_data[m]!=
...
function(){var m=this;if("undefined"==typeof SillyClient)this._error||console.error("SillyClient node cannot be used, you must include SillyServer.js"),this._error=!0;else if(this._server=new SillyClient,this._server.on_ready=function(){console.log("ready");m.boxcolor="#6C6"},this._server.on_message=function(q,h){q=null;try{q=JSON.parse(h)}catch(E){return}if(1==q.type)if(q.data.object_class&&l[q.data.object_class]){h=null;try{h=new l[q.data.object_class](q.data),m.triggerSlot(0,h)}catch(E){return}}else m.triggerSlot(0,
