...
this.viewport[2]&&e>=this.viewport[1]&&e<this.viewport[1]+this.viewport[3];this.options.skip_events||(this.canvas.removeEventListener("mousemove",this._mousemove_callback),b.document.addEventListener("mousemove",this._mousemove_callback,!0),b.document.addEventListener("mouseup",this._mouseup_callback,!0));if(d){var f=this.graph.getNodeOnPos(a.canvasX,a.canvasY,this.visible_nodes,5);e=!1;d=300>k.getTime()-this.last_mouseclick;this.mouse[0]=a.localX;this.mouse[1]=a.localY;this.graph_mouse[0]=a.canvasX;
this.graph_mouse[1]=a.canvasY;this.last_click_position=[this.mouse[0],this.mouse[1]];this.canvas.focus();k.closeAllContextMenus(b);if(!this.onMouse||1!=this.onMouse(a)){if(1==a.which){a.ctrlKey&&(this.dragging_rectangle=new Float32Array(4),this.dragging_rectangle[0]=a.canvasX,this.dragging_rectangle[1]=a.canvasY,this.dragging_rectangle[2]=1,this.dragging_rectangle[3]=1,e=!0);var g=!1;if(f&&this.allow_interaction&&!e&&!this.read_only){this.live_mode||f.flags.pinned||this.bringToFront(f);if(!this.connecting_node&&
!f.flags.collapsed&&!this.live_mode)if(!e&&!1!==f.resizable&&C(a.canvasX,a.canvasY,f.pos[0]+f.size[0]-5,f.pos[1]+f.size[1]-5,10,10))this.graph.beforeChange(),this.resizing_node=f,this.canvas.style.cursor="se-resize",e=!0;else{if(f.outputs)for(var n=0,r=f.outputs.length;n<r;++n){var l=f.outputs[n],u=f.getConnectionPos(!1,n);if(C(a.canvasX,a.canvasY,u[0]-15,u[1]-10,30,20)){this.connecting_node=f;this.connecting_output=l;this.connecting_pos=f.getConnectionPos(!1,n);this.connecting_slot=n;a.shiftKey&&
f.disconnectOutput(n);if(d){if(f.onOutputDblClick)f.onOutputDblClick(n,a)}else if(f.onOutputClick)f.onOutputClick(n,a);e=!0;break}}if(f.inputs)for(n=0,r=f.inputs.length;n<r;++n)if(l=f.inputs[n],u=f.getConnectionPos(!0,n),C(a.canvasX,a.canvasY,u[0]-15,u[1]-10,30,20)){if(d){if(f.onInputDblClick)f.onInputDblClick(n,a)}else if(f.onInputClick)f.onInputClick(n,a);if(null!==l.link){e=this.graph.links[l.link];f.disconnectInput(n);if(this.allow_reconnect_links||a.shiftKey)this.connecting_node=this.graph._nodes_by_id[e.origin_id],
...
(f.subgraph&&!f.skip_subgraph_button&&!f.flags.collapsed&&r[0]>f.size[0]-k.NODE_TITLE_HEIGHT&&0>r[1]&&(c=this,setTimeout(function(){c.openSubgraph(f.subgraph)},10)),this.live_mode&&(n=g=!0));n||(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=f),this.selected_nodes[f.id]||this.processNodeSelected(f,a));this.dirty_canvas=!0}}else{if(!this.read_only)for(n=0;n<this.visible_links.length;++n)if(g=this.visible_links[n],r=g._pos,!(!r||a.canvasX<r[0]-4||a.canvasX>r[0]+4||a.canvasY<r[1]-
4||a.canvasY>r[1]+4)){this.showLinkMenu(g,a);this.over_link_center=null;break}this.selected_group=this.graph.getGroupOnPos(a.canvasX,a.canvasY);this.selected_group_resizing=!1;this.selected_group&&!this.read_only&&(a.ctrlKey&&(this.dragging_rectangle=null),10>E([a.canvasX,a.canvasY],[this.selected_group.pos[0]+this.selected_group.size[0],this.selected_group.pos[1]+this.selected_group.size[1]])*this.ds.scale?this.selected_group_resizing=!0:this.selected_group.recomputeInsideNodes());d&&!this.read_only&&
this.allow_searchbox&&this.showSearchBox(a);g=!0}!e&&g&&this.allow_dragcanvas&&(this.dragging_canvas=!0)}else 2!=a.which&&3==a.which&&(this.read_only||this.processContextMenu(f,a));this.last_mouse[0]=a.localX;this.last_mouse[1]=a.localY;this.last_mouseclick=k.getTime();this.last_mouse_dragging=!0;this.graph.change();(!b.document.activeElement||"input"!=b.document.activeElement.nodeName.toLowerCase()&&"textarea"!=b.document.activeElement.nodeName.toLowerCase())&&a.preventDefault();a.stopPropagation();
...
node:e});return!1}}if(e){var g=this;a=h.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var n=[];if(b)for(var r=0;r<b.length;r++){var l=b[r];if(!l)n.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(l[0])){var m=l[0];l[2]&&l[2].label&&(m=l[2].label);m={content:m,value:l};l[1]==k.EVENT&&(m.className="event");n.push(m)}}this.onMenuNodeOutputs&&(n=this.onMenuNodeOutputs(n));if(n.length)return new k.ContextMenu(n,{event:c,callback:f,
...
function c(a){var b=t;t&&t.classList.remove("selected");t?(t=a?t.nextSibling:t.previousSibling)||(t=b):t=a?m.childNodes[0]:m.childNodes[m.childNodes.length];t&&(t.classList.add("selected"),t.scrollIntoView({block:"end",behavior:"smooth"}))}function d(){function a(a,c){var d=document.createElement("div");p||(p=a);d.innerText=a;d.dataset.type=escape(a);d.className="litegraph lite-search-item";c&&(d.className+=" "+c);d.addEventListener("click",function(a){b(unescape(this.dataset.type))});m.appendChild(d)}
z=null;var c=q.value;p=null;m.innerHTML="";if(c)if(e.onSearchBox){var d=e.onSearchBox(m,c,f);if(d)for(var n=0;n<d.length;++n)a(d[n])}else{d=function(a){var b=k.registered_node_types[a];return r&&b.filter!=r?!1:-1!==a.toLowerCase().indexOf(c)};var g=0;c=c.toLowerCase();var r=f.filter||f.graph.filter;for(n in k.searchbox_extras){var l=k.searchbox_extras[n];if(-1!==l.desc.toLowerCase().indexOf(c)){var t=k.registered_node_types[l.type];if(!t||t.filter==r)if(a(l.desc,"searchbox_extra"),-1!==h.search_limit&&
...
r.close=function(){e.search_box=null;n.body.focus();n.body.style.overflow="";setTimeout(function(){e.canvas.focus()},20);r.parentNode&&r.parentNode.removeChild(r)};var l=null;1<this.ds.scale&&(r.style.transform="scale("+this.ds.scale+")");r.addEventListener("mouseenter",function(a){l&&(clearTimeout(l),l=null)});r.addEventListener("mouseleave",function(a){l=setTimeout(function(){r.close()},500)});e.search_box&&e.search_box.close();e.search_box=r;var m=r.querySelector(".helper"),p=null,z=null,t=null,
...
b=c.concat(b));!1!==a.clonable&&b.push({content:"Clone",callback:h.onMenuNodeClone});b.push(null,{content:"Remove",disabled:!(!1!==a.removable&&!a.block_delete),callback:h.onMenuNodeRemove});if(a.graph&&a.graph.onGetNodeMenuOptions)a.graph.onGetNodeMenuOptions(b,a);return b};h.prototype.getGroupMenuOptions=function(a){return[{content:"Title",callback:h.onShowPropertyEditor},{content:"Color",has_submenu:!0,callback:h.onMenuNodeColors},{content:"Font size",property:"font_size",type:"Number",callback:h.onShowPropertyEditor},
null,{content:"Remove",callback:h.onMenuNodeRemove}]};h.prototype.processContextMenu=function(a,b){var c=this,d=h.active_canvas.getCanvasWindow(),e=null,f={event:b,callback:function(b,d,e){if(b)if("Remove Slot"==b.content)b=b.slot,b.input?a.removeInput(b.slot):b.output&&a.removeOutput(b.slot);else if("Disconnect Links"==b.content)b=b.slot,b.output?a.disconnectOutput(b.slot):b.input&&a.disconnectInput(b.slot);else if("Rename Slot"==b.content){b=b.slot;var n=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),
f=c.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",d),g=f.querySelector("input");g&&n&&(g.value=n.label||"");f.querySelector("button").addEventListener("click",function(a){g.value&&(n&&(n.label=g.value),c.setDirty(!0));f.close()})}},extra:a};a&&(f.title=a.type);var g=null;a&&(g=a.getSlotInPosition(b.canvasX,b.canvasY),h.active_node=a);g?(e=[],a.getSlotMenuOptions?e=a.getSlotMenuOptions(g):(g&&g.output&&g.output.links&&g.output.links.length&&e.push({content:"Disconnect Links",
slot:g}),b=g.input||g.output,e.push(b.locked?"Cannot remove":{content:"Remove Slot",slot:g}),e.push(b.nameLocked?"Cannot rename":{content:"Rename Slot",slot:g})),f.title=(g.input?g.input.type:g.output.type)||"*",g.input&&g.input.type==k.ACTION&&(f.title="Action"),g.output&&g.output.type==k.EVENT&&(f.title="Event")):a?e=this.getNodeMenuOptions(a):(e=this.getCanvasMenuOptions(),(g=this.graph.getGroupOnPos(b.canvasX,b.canvasY))&&e.push(null,{content:"Edit Group",has_submenu:!0,submenu:{title:"Group",
extra:g,options:this.getGroupMenuOptions(g)}}));e&&new k.ContextMenu(e,f,d)};"undefined"!=typeof window&&window.CanvasRenderingContext2D&&!window.CanvasRenderingContext2D.prototype.roundRect&&(window.CanvasRenderingContext2D.prototype.roundRect=function(a,b,c,d,e,f){var g,n;if(0===e)this.rect(a,b,c,d);else{void 0===f&&(f=e);if(null!=e&&e.constructor===Array)if(1==e.length)var k=g=n=f=e[0];else if(2==e.length)k=f=e[0],g=n=e[1];else if(4==e.length)k=e[0],g=e[1],n=e[2],f=e[3];else return;else k=e||0,
g=e||0,n=f||0,f=f||0;this.moveTo(a+k,b);this.lineTo(a+c-g,b);this.quadraticCurveTo(a+c,b,a+c,b+g);this.lineTo(a+c,b+d-f);this.quadraticCurveTo(a+c,b+d,a+c-f,b+d);this.lineTo(a+f,b+d);this.quadraticCurveTo(a,b+d,a,b+d-n);this.lineTo(a,b+n);this.quadraticCurveTo(a,b,a+k,b)}});k.compareObjects=function(a,b){for(var c in a)if(a[c]!=b[c])return!1;return!0};k.distance=E;k.colorToString=function(a){return"rgba("+Math.round(255*a[0]).toFixed()+","+Math.round(255*a[1]).toFixed()+","+Math.round(255*a[2]).toFixed()+
","+(4==a.length?a[3].toFixed(2):"1.0")+")"};k.isInsideRectangle=C;k.growBounding=function(a,b,c){b<a[0]?a[0]=b:b>a[2]&&(a[2]=b);c<a[1]?a[1]=c:c>a[3]&&(a[3]=c)};k.isInsideBounding=function(a,b){return a[0]<b[0][0]||a[1]<b[0][1]||a[0]>b[1][0]||a[1]>b[1][1]?!1:!0};k.overlapBounding=B;k.hex2num=function(a){"#"==a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();for(var b=Array(3),c=0,d,e,f=0;6>f;f+=2)d="0123456789ABCDEF".indexOf(a.charAt(f)),e="0123456789ABCDEF".indexOf(a.charAt(f+1)),b[c]=16*d+e,c++;return b};
...
!0===e&&(d=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new f.constructor(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:f,ignore_item_callbacks:b.submenu.ignore_item_callbacks,title:b.submenu.title,extra:b.submenu.extra,autoopen:c.autoopen});d=!1}d&&!f.lock&&f.close()}var f=this;c=c||{};var g=document.createElement("div");g.className="litemenu-entry submenu";var n=!1;if(null===b)g.classList.add("separator");else{g.innerHTML=b&&b.title?b.title:
a;if(g.value=b)b.disabled&&(n=!0,g.classList.add("disabled")),(b.submenu||b.has_submenu)&&g.classList.add("has_submenu");"function"==typeof b?(g.dataset.value=a,g.onclick_callback=b):g.dataset.value=b;b.className&&(g.className+=" "+b.className)}this.root.appendChild(g);n||g.addEventListener("click",e);c.autoopen&&g.addEventListener("mouseenter",d);return g};x.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=
!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!x.isCursorOverElement(a,this.parentMenu.root)&&x.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&clearTimeout(this.root.closing_timer)};x.trigger=function(a,b,c,d){var e=document.createEvent("CustomEvent");e.initCustomEvent(b,!0,!0,c);e.srcElement=d;a.dispatchEvent?a.dispatchEvent(e):a.__events&&a.__events.dispatchEvent(e);return e};x.prototype.getTopMenu=
function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};x.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};x.isCursorOverElement=function(a,b){var c=a.clientX;a=a.clientY;return(b=b.getBoundingClientRect())?a>b.top&&a<b.top+b.height&&c>b.left&&c<b.left+b.width?!0:!1:!1};k.ContextMenu=x;k.closeAllContextMenus=function(a){a=a||window;a=a.document.querySelectorAll(".litecontextmenu");if(a.length){for(var b=
...
0;n<f.links.length&&(!(g=d.graph.links[f.links[n]])||b[g.target_id]);++n);}};g.Subgraph=q;g.registerNodeType("graph/subgraph",q);l.title="Input";l.desc="Input of the graph";l.prototype.onConfigure=function(){this.updateType()};l.prototype.updateType=function(){var a=this.properties.type;this.type_widget.value=a;this.outputs[0].type!=a&&(g.isValidConnection(this.outputs[0].type,a)||this.disconnectOutput(0),this.outputs[0].type=a);"number"==a?(this.value_widget.type="number",this.value_widget.value=
...
var l=h!=this.prev;0===this.prev&&(l=!1);var t=l&&this.properties.only_on_change||!l&&!this.properties.only_on_change;h&&t&&this.triggerSlot(0,k);!h&&t&&this.triggerSlot(2,k);l&&this.triggerSlot(1,k);this.prev=h};x.registerNodeType("events/trigger",q);l.title="Sequencer";l.desc="Trigger events when an event arrives";l.prototype.getTitle=function(){return""};l.prototype.onAction=function(h,k){if(this.outputs)for(h=0;h<this.outputs.length;++h)this.triggerSlot(h,k)};x.registerNodeType("events/sequencer",
...
break;case 13:l.buttons[q].pressed&&(t.hat+="down",t.hatmap|=m.DOWN);break;case 14:l.buttons[q].pressed&&(t.hat+="left",t.hatmap|=m.LEFT);break;case 15:l.buttons[q].pressed&&(t.hat+="right",t.hatmap|=m.RIGHT);break;case 16:t.buttons.home=l.buttons[q].pressed}l.xbox=t;return l}};m.prototype.onDrawBackground=function(l){if(!this.flags.collapsed){var t=this._left_axis,m=this._right_axis;l.strokeStyle="#88A";l.strokeRect(.5*(t[0]+1)*this.size[0]-4,.5*(t[1]+1)*this.size[1]-4,8,8);l.strokeStyle="#8A8";
l.strokeRect(.5*(m[0]+1)*this.size[0]-4,.5*(m[1]+1)*this.size[1]-4,8,8);t=this.size[1]/this._current_buttons.length;l.fillStyle="#AEB";for(m=0;m<this._current_buttons.length;++m)this._current_buttons[m]&&l.fillRect(0,t*m,6,t)}};m.prototype.onGetOutputs=function(){return[["left_axis","vec2"],["right_axis","vec2"],["left_x_axis","number"],["left_y_axis","number"],["right_x_axis","number"],["right_y_axis","number"],["trigger_left","number"],["trigger_right","number"],["a_button","number"],["b_button",
